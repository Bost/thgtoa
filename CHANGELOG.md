v1.0.9
- Re-Added Privacytools.io (along Privacyguide.org) as a good source of information and recommendations for various services/products/platforms within the guide.
...
- Fixed some mistakes in the cryptucurrency swapping section
