...
-   iPhones and iPads (IOS 13 and above)[^77]'[^78]

-   Samsung Phones (Android 10 and above)[^79]

-   MacBooks (macOS 10.15 and above)[^80]

Such devices will continue to broadcast identity information to nearby devices even when offline using Bluetooth Low-Energy[^81]. They do not have access to the devices directly (which are not connected to the internet) but instead use BLE to find them through other nearby devices[^82]. They are using peer-to-peer short-range Bluetooth communication to broadcast their status through nearby online devices.
...
-   The smartphone OS makers (Google/Apple for Android/IOs) also keep logs of IMEI/IMSI identifications tied to Google/Apple accounts and which user has been using them. They too can trace back the history of the phone and to which accounts it was tied in the past[^91].

-   Government agencies around the world interested in your phone number can and do use[^92] special devices called "IMSI catchers"[^93] like the Stingray[^94] or more recently the Nyxcell[^95]. These devices can impersonate (to spoof) a cell phone Antenna and force a specific IMSI (your phone) to connect to it to access the cell network. Once they do, they will be able to use various MITM[^96] (Man-In-The-Middle Attacks) that will allow them to:
...
Some commercial devices will keep a record of MAC addresses roaming around for various purposes such as road congestion[^99].
...
Operating systems have protections in place to randomize those addresses but are still subject to vulnerabilities[^100].
...
All modern CPUs[^101] are now integrating hidden management platforms such as the now infamous Intel Management Engine[^102] and the AMD Platform Security Processor[^103].
...
These have already been affected by several security vulnerabilities in the past[^104] that allowed malware to gain control of target systems. These are also accused by many privacy actors including the EFF and Libreboot of being a backdoor into any system[^105].

There are some not so straightforward ways[^106] to disable the Intel IME on some CPUs and you should do so if you can. For some AMD laptops, you can disable it within the BIOS settings by disabling PSP.
...
If you are feeling a bit more adventurous, you could install your own BIOS using Libreboot[^107] or Coreboot[^301] if your laptop supports it (be aware that Coreboot does contain some propriety code unlike its fork Libreboot).
...
-   IOS/Apple:
    ...
    -   Apple does claim[^108] that they anonymize this data using differential privacy[^109] but you will have to trust them on that.
...
The question is: Is there someone somewhere that would have both pieces of information available[^132] for correlation in a convenient database?

Have you heard of Edward Snowden[^133]? Now is the time to google him and read his book[^134]. Also read about XKEYSCORE[^135]'[^136], MUSCULAR[^137], SORM[^138], Tempora[^139] , and PRISM[^140].

See "We kill people based on Metadata"[^141] or this famous tweet from the IDF <https://twitter.com/idf/status/1125066395010699264> <sup>[[Archive.org]][88]</sup> <sup>[[Nitter]][89]</sup>.

See [Appendix N: Warning about smartphones and smart devices]

### Your Digital Fingerprint, Footprint, and Online Behavior:

This is the part where you should watch the documentary "The Social Dilemma"[^142] on Netflix as they cover this topic much better than anyone else IMHO.

This includes is the way you write (stylometry) [^143]'[^144], the way you behave[^145]'[^146]. The way you click. The way you browse. The fonts you use on your browser[^147]. Fingerprinting is being used to guess who someone is by the way that user is behaving. You might be using specific pedantic words or making specific spelling mistakes that could give you away using a simple Google search for similar features because you typed comparably on some Reddit post 5 years ago using a not so anonymous Reddit account[^148]. The words you type in a search engine alone can be used against you as the authorities now have warrants to find users who used specific keywords in search engines[^149].
...
All they need to achieve this in most cases is Javascript enabled in your browser (which is the case in most Browsers including Tor Browser by default). Even with Javascript disabled, there are still ways to fingerprint you[^150].
...
-   For example, as a basis of authentication, a user's typing speed, keystroke depressions, patterns of error (say accidentally hitting an "l" instead of a "k" on three out of every seven transactions) and mouse movements establish that person's unique pattern of behavior[^151]. Some commercial services such as TypingDNA (<https://www.typingdna.com/> <sup>[[Archive.org]][91]</sup>) even offer such analysis as a replacement for two-factor authentications.

-   This technology is also widely used in CAPTCHAS[^369] services to verify that you are "human" and can be used to fingerprint a user.
...
A real use and well-documented case of this was the arrest of the hacker Jeremy Hammond[^152] who shared over time several details about his past and was later discovered.

There are also a few cases involving OSINT at Bellingcat[^153]. Have a look at their very informative (but slightly outdated) toolkit here: <https://docs.google.com/spreadsheets/d/18rtqh8EG2q1xBo2cLNyhIDuK9jrPGwYr9DI2UncoqJQ/edit#gid=930747607> <sup>[[Archive.org]][97]</sup>
...
Even if you are not looking at the camera, they can still figure out who you are[^160], make out your emotions[^161], analyze your gait[^162]'[^163]'[^164], read your lips[^165], analyze the behavior of your eyes[^166], and probably guess your political affiliation[^167]'[^168].
...
-   Even if you never made a profile on those platforms, you still have one without even knowing it[^169]'[^170]'[^171]'[^172]'[^173].
...
Governments already know who you are because they have your ID/Passport/Driving License pictures and often added biometrics (Fingerprints) in their database. Those same governments are integrating those technologies (often provided by private companies such as the Israeli AnyVision[^174], Clearview AI[^175]'[^176], or NEC[^177]) in their CCTV networks to look for "persons of interest"[^178]. And some heavily surveilled states like China have implemented widespread use of Facial Recognition for various purposes[^179]'[^180] including possibly identifying ethnic minorities[^181]. A simple face recognition error by some algorithm can ruin your life[^182]'[^183].
...
The same goes with fingerprint authentication being mainstreamed by many smartphone makers to authenticate yourself. A simple picture where your fingers appear can be used to de-anonymize you[^184]'[^185]'[^186].

The same goes with your voice which can be analyzed for various purposes as shown in the recent Spotify patent[^187].

Even your iris can be used for identification in some places[^188].

We can safely imagine a near future where you will not be able to create accounts or sign in anywhere without providing unique biometrics (A suitable time to re-watch Gattaca[^189], Person of Interest[^190] , and Minority Report[^191]). And you can safely imagine how useful these large biometrics databases could be to some interested third parties.

In addition, all this information can also be used against you (if you are already de-anonymized) using deepfake[^192] by crafting false information (Pictures, Videos, Voice Recordings[^193]...) and have already been used for such purposes[^194]'[^195]. There are even commercial services for this readily available such as <https://www.respeecher.com/> <sup>[[Archive.org]][116]</sup> and <https://www.descript.com/overdub> <sup>[[Archive.org]][117]</sup>.

See this demo: <https://www.youtube.com/watch?v=t5yw5cR79VA> <sup>[[Invidious]][118]</sup>

At this time, there are a few steps[^196] you can use to mitigate (and only mitigate) face recognition when conducting sensitive activities where CCTV might be present:

-   Wear a facemask as they have been proven to defeat some face recognition technologies[^197] but not all[^198].
...
-   Consider wearing special sunglasses (expensive, unfortunately) called "Reflectacles" <https://www.reflectacles.com/> <sup>[[Archive.org]][119]</sup>. There was a small study showing their efficiency against IBM and Amazon facial recognition[^199].

-   All that might still be useless because of gait recognition mentioned earlier[^162] but there might be hope here if you have a 3D Printer: <https://gitlab.com/FG-01/fg-01> <sup>[[Archive.org]][120]</sup>
...
Phishing[^200] is a social engineering[^201] type of attack where an adversary could try to extract information from you by pretending or impersonating something/someone else.

A typical case is an adversary using a man-in-the-middle[^96] attack or a fake e-mail/call to ask for your credential for a service. This could for example be through e-mail or through impersonating financial services.
...
These could be simple pixel-sized images[^202] hidden in your e-mails that would call a remote server to try and get your IP address.

These could be exploiting a vulnerability in an outdated format or an outdated reader[^203]. Such exploits could then be used to compromise your system.
...
So, you are using Tor Browser or Brave Browser over Tor. You could be using those over a VPN for added security. But you should keep in mind that there are exploits[^204] (hacks) that could be known by an adversary (but unknown to the App/Browser provider). Such exploits could be used to compromise your system and reveal details to de-anonymize you such as your IP address or other details.

A real use case of this technique was the Freedom Hosting[^205] case in 2013 where the FBI inserted malware[^206] using a Firefox browser exploit on a Tor website. This exploit allowed them to reveal details of some users. More recently, there was the notable SolarWinds[^207] hack that breached several US government institutions by inserting malware into an official software update server.

In some countries, Malware is just mandatory and/or distributed by the state itself. This is the case for instance in China with WeChat[^208] which can then be used in combination with other data for state surveillance[^209].
...
To reflect these recommendations, this guide will therefore later guide you in the use of Virtualization (See [Appendix W: Virtualization][Appendix V1: Hardening your Browsers:]) so that even if your Browser/Apps get compromised by a skilled adversary, that adversary will find himself stuck in a sandbox[^210] without being able to access identifying information or compromise your system.

### Malicious USB devices:

There are readily available commercial and cheap "badUSB" [^211]devices that can take deploy malware, log your typing, geolocate you, listen to you or gain control of your laptop just by plugging them in. Here are some examples that you can already buy yourself:
...
Such devices can be implanted anywhere (charging cable, mouse, keyboard, USB key ...) by an adversary and can be used to track you or compromise your computer or smartphone. The most notable example of such attacks is probably Stuxnet[^212] in 2005.

While you could inspect a USB key physically, scan it with various utilities, check the various components to see if they are genuine, you will most likely never be able to discover complex malware embedded in genuine parts of a genuine USB key by a skilled adversary without advanced forensics equipment[^213].
...
Malware and backdoors can be embedded directly into your hardware components. Sometimes those backdoors are implemented by the manufacturer itself such as the IME in the case of Intel CPUs. And in other cases, such backdoors can be implemented by a third party that places itself between orders of new hardware and customer delivery[^214].

Such malware and backdoors can also be deployed by an adversary using software exploits. Many of those are called rootkits[^215] within the tech world. Usually, these types of malware are harder to detect and mitigate as they are implemented at a lower level than the userspace[^216] and often in the firmware[^217] of hardware components itself.

What is firmware? Firmware is a low-level operating system for devices. Each component in your computer probably has firmware including for instance your disk drives. The BIOS[^218]/UEFI[^219] system of your machine for instance is a type of firmware.
...
Such watermarks can be inserted by various products[^224]'[^225]'[^226]'[^227] using Steganography[^228] and can resist compression[^229] and re-encoding[^230]'[^231].

These watermarks are not easily detectable and could allow identification of the source despite all efforts.

In addition to watermarks, the camera used for filming (and therefore the device used for filming) a video can also be identified using various techniques such as lens identification[^232] which could lead to de-anonymization.
...
**Do not ever print in Color, usually, watermarks are not present without color toners/cartridges**[^234]**.**
...
Contrary to widespread belief, Crypto transactions (such as Bitcoin and Ethereum) are not anonymous[^235]. Most cryptocurrencies can be tracked accurately through various methods[^236]'[^237].
...
The main issue is not setting up a random Crypto wallet to receive some currency behind a VPN/Tor address (at this point, the wallet is anonymous). The issue is mainly when you want to convert Fiat money (Euros, Dollars ...) to Crypto and then when you want to cash in your Crypto. You will have few realistic options but to transfer those to an exchange (such as Coinbase/Kraken/Bitstamp/Binance). Those exchanges have known wallet addresses and will keep detailed logs (due to KYC[^238] financial regulations) and can then trace back those crypto transactions to you using the financial system[^239].

There are some cryptocurrencies with privacy/anonymity in mind like Monero but even those have some and warnings to consider[^240]'[^241].

Even if you use Mixers or Tumblers[^242] (services that specialize in "anonymizing" cryptocurrencies by "mixing them"), keep in mind this is only obfuscation[^243] and not actual anonymity[^244]. Not only are they only obfuscation but they could also put you in trouble as you might end up exchanging your crypto against "dirty" crypto that was used in various questionable contexts[^245].
...
There are specialized commercial forensics solutions available (Magnet Axiom[^246], Cellebrite Cloud[^247]) that will help an adversary analyze your cloud data with ease.
...
Your Browser and Device Fingerprints[^380] are set of properties/capabilities of your System/Browser. These are used on most websites for invisible user tracking but also to adapt the website user experience depending on their browser. For instance, websites will be able to provide a "mobile experience" if you are using a mobile browser or propose a specific language/geographic version depending on your fingerprint. Most of those techniques work with recent Browsers like Chromium-based[^248] browsers (such as Chrome/Edge) or Firefox[^249] unless taking specific measures.
...
Forensics techniques are now very advanced and can reveal a staggering amount of information from your devices even if they are encrypted[^250]. These techniques are widely used by law enforcement all over the world and should be considered.
...
And finally, here is this very instructive detailed paper on the current state of IOS/Android security from the John Hopkins University: https://securephones.io/main.html[^251].
...
And there are reasons[^252]'[^253]'[^254]'[^255] for that:
...
-   You should be wary of Apps/Services using a "modified" or proprietary cryptographic method[^256].

-   By default, you should not trust any "Roll your own crypto" until it was audited, peer-reviewed, vetted, and accepted by the cryptography community[^257]'[^258].

-   There is no such thing as "military-grade crypto"[^259]'[^260]'[^261].
...
-   File/Disk Encryption:
    ...
    -   Prefer:
        ...
        -   Hardware Accelerated[^263]: AES (Rijndael) 256 Bits with HMAC-SHA-2 or HMAC-SHA-3 (This is what Veracrypt, Bitlocker, Filevault 2, KeepassXC, and LUKS use by default). Prefer SHA-3.

        -   Non-Hardware Accelerated: Same as accelerated above or if available consider:

            -   ChaCha20[^264] or XChaCha20 (You can use ChaCha20 with Kryptor <https://www.kryptor.co.uk>, unfortunately, it is not available with Veracrypt).
...
-   Signing messages/files with PGP/GPG:
    ...
    -   Prefer ECDSA (ed25519)+ECDH (ec25519) or RSA 4096 Bits*
        ...
        -   **Consider a more modern**[^267] **alternative to PGP/GPG: Minisign <https://jedisct1.github.io/minisign/>** <sup>[[Archive.org]][162]</sup>
...
* **Warning: RSA and ED25519 are unfortunately not seen as "Quantum Resistant"**[^268] **and while they have not been broken yet, they probably will be broken someday into the future. It is just a matter of when rather than if RSA will ever be broken. So, these are preferred in those contexts due to the lack of a better possibility.**
...
Any of those providers can be forced to silently (without your knowing (using for example a court order with a gag order[^269] or a national security letter[^270]) log your activity to de-anonymize you. There have been several recent examples of those:

-   2021, ProtonMail, ProtonMail logged IP address of French activist after an order by Swiss authorities[^271].

-   2021, WindScribe, Servers were not encrypted as they should have been allowing MITM attacks by authorities[^272].

-   2021, DoubleVPN servers, logs, and account info seized by law enforcement[^273].

-   2021, The Germany-based mail provider Tutanota was forced to monitor specific accounts for 3 months[^274].

-   2020, The Germany-based mail provider Tutanota was forced to implement a backdoor to intercept and save copies of the unencrypted e-mails of one user[^275] (they did not decrypt the stored e-mail).

-   2017, PureVPN was forced to disclose information of one user to the FBI[^276].

-   2014, an EarthVPN user was arrested based on logs provider to the Dutch Police[^277].

-   2013, Secure E-Mail provider Lavabit shuts down after fighting a secret gag order[^278].

-   2011, HideMyAss user was de-anonymized, and logs were provided to the FBI[^279].

Some providers have implemented the use of a Warrant Canary[^280] that would allow their users to find out if they have been compromised by such orders, but this has not been tested yet as far as I know.

Finally, it is now well known that some companies might be sponsored front ends for some state adversaries (see the Crypto AG story[^281] and Omnisec story[^282]).
...
(Illustration: an excellent movie I highly recommend: Das Leben der Anderen[^283])

Many advanced techniques can be used by skilled adversaries[^284] to bypass your security measures provided they already know where your devices are. Many of those techniques are detailed here <https://cyber.bgu.ac.il/advanced-cyber/airgap> <sup>[[Archive.org]][167]</sup> (Air-Gap Research Page, Cyber-Security Research Center, Ben-Gurion University of the Negev, Israel) and include:
...
-   **Attacks that require no malware:**
    ...
    -   Observing a blank wall in a room from a distance to figure how many people are in a room and what they are doing[^285]. Publication with demonstration: <http://wallcamera.csail.mit.edu/> <sup>[[Archive.org]][184]</sup>

    -   Observing a reflective bag of snacks in a room from a distance to reconstruct the entire room[^286]. Publication with photographic examples: <https://arxiv.org/abs/2001.04642> <sup>[[Archive.org]][185]</sup>

    -   Measuring floor vibrations to identify individuals and determine their health condition and mood[^287]. Publication with demonstration: <https://engineering.cmu.edu/news-events/news/2020/02/17-mauraders-map.html> <sup>[[Archive.org]][186]</sup>

    -   Observing a light bulb from a distance to listen to the sound in the room[^288] **without any malware**: Demonstration: <https://www.youtube.com/watch?v=t32QvpfOHqw> <sup>[[Invidious]][187]</sup>. It should be noted that this type of attack is not new at all and there have been articles about such techniques as far back as 2013[^289] and that you can even buy devices to perform this yourself such as here: <http://www.gcomtech.com/ccp0-prodshow/laser-surveillance-laser-listening.html> <sup>[[Archive.org]][188]</sup>
...
**Realistically, this guide will be of little help against such adversaries as such malware could be implanted on the devices by a manufacturer, anyone in the middle**[^290]**, or by anyone with physical access to the air-gapped computer but there are still some ways to mitigate such techniques:**
...
Zero-Trust Security[^389] ("Never trust, always verify").
...
-   If you want system-wide plausible deniability[^309]'[^291] despite the risks[^292]'[^312], consider:
...
-   Check some data yourself here on the Tor Project OONI[^293] (Open Observatory of Network Interference) website: <https://explorer.ooni.org/>
...
This is the hardest part of the whole guide. It is a SPOF (Single Point of Failure). The places where you can still buy prepaid SIM cards without ID registration are getting increasingly limited due to various KYC type regulations[^294].
...
Some might be very efficient[^295] but many are gimmicky gadgets that offer no real protection[^296].
...
While the official Tor Browser is not yet available for iOS, there is an alternative called Onion Browser endorsed by the Tor Project[^297].
...
Tails[^298] stands for **The Amnesic Incognito Live System**. It is a bootable Live Operating System running from a USB key that is designed for leaving no traces and forcing all connections through the Tor network.
...
**WARNING: Tails is not always up to date with their bundled software. And not always up to date with the Tor Browser updates either. You should always make sure you are using the latest version of Tails and you should use extreme caution when using bundled apps within Tails that might be vulnerable to exploits and reveal your location**[^299]**.**
...
-   **Do not use hidden volumes on SSD drives as this is not supported/recommended by Veracrypt**[^300]**.**
...
If you can afford it, you might consider getting a Purism Librem laptop (<https://puri.sm> <sup>[[Archive.org]][249]</sup>) or System76 laptops (<https://system76.com/> <sup>[[Archive.org]][250]</sup>) while using Coreboot[^301] (where Intel ME is disabled from the factory).
...
-   AMD laptops could be more interesting as some provide the ability to disable AMD PSP (the AMD equivalent of Intel IME) from the BIOS/UEFI settings by default. And, because AFAIK, AMD PSP was audited and contrary to IME was not found to have any "evil" functionalities[^302]. However, if you are going for the Qubes OS Route consider Intel as they do not support AMD with their anti-evil-maid system[^303].
...
-   Disable Secure Boot if you intend to use QubesOS as they do not support it out of the box[^304]. Keep it on if you intend to use Linux/Windows.
...
So, what is Secure Boot[^305]? In short, it is a UEFI security feature designed to prevent your computer from booting an operating system from which the bootloader was not signed by specific keys stored in the UEFI firmware of your laptop.

When the operating system (or the Bootloader[^306]) supports it, you can store the keys of your bootloader in your UEFI firmware, and this will prevent booting up any unauthorized Operating System (such as a live OS USB or anything similar).
...
Here is a good cheap method to make your laptop tamper-proof using Nail Polish (with glitter) <https://mullvad.net/en/help/how-tamper-protect-laptop/> <sup>[[Archive.org]][259]</sup> [^307] (with pictures).
...
This route will make extensive use of Virtual Machines[^308], they will require a host OS to run the Virtualization software. You have three recommended choices in this part of the guide:
...
Linux is also not necessarily the best choice for anonymity depending on your threat model. This is because using Windows will allow us to **conveniently** use Plausible Deniability[^309] (aka Deniable Encryption[^310]) easily at the OS level. Windows is also unfortunately at the same time a privacy nightmare[^311] but is the only easy to set up option for using OS-wide plausible deniability. Windows telemetry and telemetry blocking are also widely documented which should mitigate many issues.

**So, what is Plausible Deniability?** You can cooperate with an adversary requesting access to your device/data without revealing your true secret. All this using Deniable Encryption[^312].

A soft lawful adversary could ask for your encrypted laptop password. At first, you could refuse to give out any password (using your "right to remain silent", "right not to incriminate yourself") but some countries are implementing laws[^313]'[^314] to exempt this from such rights (because terrorists and "think of the children"). In that case, you might have to reveal the password or face jail time in contempt of court. This is where plausible deniability will come into play.
...
Cold Boot attacks[^317] are trickier than the Evil Maid Attack but can be part of an Evil Maid attack as it requires an adversary to come into possession of your laptop while you are actively using your device or shortly afterward.

The idea is rather simple, as shown in this video[^318], an adversary could theoretically quickly boot your device on a special USB key that would copy the content of the RAM (the memory) of the device after you shut it down. If the USB ports are disabled or if they feel like they need more time, they could open it and "cool down" the memory using a spray or other chemicals (liquid nitrogen for instance) preventing the memory from decaying. They could then be able to copy its content for analysis. This memory dump could contain the key to decrypt your device. We will later apply a few principles to mitigate these.

In the case of Plausible Deniability, there have been some forensics studies[^319] about technically proving the presence of the hidden data with a simple forensic examination (without a Cold Boot/Evil Maid Attack) but these have been contested by other studies[^320] and by the maintainer of Veracrypt[^321] so I would not worry too much about those yet.
...
-   Windows ShellBags that are stored within the Windows Registry silently storing various histories of accessed volumes/files/folders[^323].

-   Windows Indexing keeping traces of the files present in your user folder by default[^324].

-   Recent lists (aka Jump Lists) in Windows and various apps keeping traces of recently accessed documents[^325].
...
-   Gatekeeper[^326] and XProtect keeping track of your download history in a local database and file attributes.
...
Forensics could[^320]'[^323] use all those leaks (see [Local Data Leaks and Forensics][Local Data Leaks and Forensics:]) to prove the existence of hidden data and defeat your attempts at using plausible deniability and to find out about your various sensitive activities.
...
There are several ways to achieve plausible deniability on Linux[^327] and it is possible to achieve. Here are some more details about some of the ways I would recommend. All these options require some higher level of skills at using Linux.
...
Veracrypt[^328] is the software I will recommend for full-disk encryption, file encryption, and plausible deniability. It is a fork of the well-known but deprecated and unmaintained TrueCrypt. It can be used for:
...
It is to my knowledge the only (convenient and usable by anyone) free, open-source, and openly audited[^329] encryption software that also provides plausible deniability for widespread use and it works with Windows Home Edition.
...
-   Enable the Veracrypt option to mount volumes as removable volumes (Settings > Preferences > Mount volume as removable media). This will prevent Windows from writing some logs about your mounts in the Event logs[^331] and prevent some local data leaks.
...
Unfortunately, this is not enough. With this setup, your Bitlocker key can just be stored as-is in the TPM chip of your computer. This is rather problematic as the key can be extracted in some cases with ease[^332]'[^333]'[^334]'[^335].

To mitigate this, we will have to enable a few more options as per the recommendations of Microsoft[^336]:
...
-   Route C: Plausible Deniability Encryption of your Operating system (you will have a "hidden OS" and a "decoy OS" running on the laptop):
    ...
    -   Cons:
        ...
        -   No use with an SSD drive due to the requirement of disabling Trim[^337] Operations[^338]. This will severely degrade the performance/health of your SSD drive over time.
...
-   To rescue disk[^339] or not rescue disk, well that is up to you. I recommend making one (just in case), just make sure to store it outside your encrypted drive (USB key for instance or wait and see the end of this guide for guidance on safe backups). This rescue disk will not store your passphrase and you will still need it to use it.

-   Wipe mode:

    -   If you have no sensitive data yet on this laptop, select None

    -   If you have sensitive data on an SSD, Trim alone should take care of it[^340] but I would recommend one pass (random data) just to be sure.
...
-   To rescue disk[^345] or not rescue disk, well that is up to you. I recommend making one (just in case), just make sure to store it outside your encrypted drive (USB key for instance or wait and see the end of this guide for guidance on safe backups). This rescue disk will not store your passphrase and you will still need it to use it.
...
**This solution however has one main drawback to consider: Interference with Tor Stream Isolation**[^349].
...
VPN/Proxy over Tor falls on the right-side[^350] meaning using a VPN/Proxy over Tor forces Tor to use one circuit for all activities instead of multiple circuits for each. This means that using a VPN/Proxy over Tor can reduce the effectiveness of Tor in some cases and should therefore be used only for some specific cases:
...
This route will use Virtualization and Whonix[^351] as part of the anonymization process. Whonix is a Linux distribution composed of two Virtual Machines:
...
Later, you will create and run several Virtual Machines within Virtualbox for your sensitive activities. Virtualbox provides a feature called "Snapshots"[^352] that allow for saving the state of a VM at any point in time. If for any reason later you want to go back to that state, you can restore that snapshot at any moment.
...
**It is also the only VM that will provide Stream Isolation pre-configured for most apps by default**[^356]**.**
...
You will need something to store your data (logins/passwords, identities, and TOTP[^357] information).

For this purpose, I strongly recommend KeePassXC because of its integrated TOTP feature. This is the ability to create entries for 2FA[^358] authentication with the authenticator feature.
...
**This way is not supported by the Whonix project**[^359] but I will go ahead and give this option anyway. IMHO this is helpful to prevent your Host OS from leaking any information while you are using the Whonix VMs.
...
Qubes OS is not a Linux distribution[^360] but a Xen distribution. It is different from Linux distributions because it will make extensive use of Virtualization and Compartmentalization so that any app will run in a different VM (Qube). As a bonus, Qubes OS integrates Whonix by default and allows for increased privacy and anonymity. It is highly recommended that you document yourself over Qubes OS principles before going this route. Here are some recommended resources:
...
Qubes is the best option in this guide for people who are more comfortable with Linux and tech in general. But it has some downsides such as the lack of OS-wide plausible deniability, its hardware requirements, and its hardware compatibility. While you can run this on 4GB of RAM as per their requirements[^361], the recommended RAM is 16GB. I would recommend against using Qubes OS if you have less than 8GB of RAM. If you want a comfortable experience, you should have 16GB, if you want a particularly enjoyable experience, you should have 24GB or 32GB.
...
**This solution however has one main drawback to consider: Interference with Tor Stream Isolation**[^362].
...
VPN/Proxy over Tor falls on the right-side[^363] meaning using a VPN/Proxy over Tor forces Tor to use one circuit for all activities instead of multiple circuits for each. This means that using a VPN/Proxy over Tor can reduce the effectiveness of Tor in some cases and should therefore be used only for some specific cases:
...
Basically, AppArmor[^365] is an application sandboxing system. By default, it is not enabled but supported by Qubes OS.
...
SELinux[^366] is similar to AppArmor. The differences between SELinux and AppArmor are technical details into which we will not get.
...
You will need something to store your data (logins/passwords, identities, and TOTP[^367] information).

For this purpose, I strongly recommend KeePassXC because of its integrated TOTP feature. This is the ability to create entries for 2FA[^368] authentication with the authenticator feature.
...
Captcha[^369] stands for "Completely Automated Public Turing test to tell Computers and Humans Apart" are Turing tests[^370] puzzles you need to complete before accessing a form/website. You will mostly encounter those provided by Google (reCAPTCHA service[^371]) and Cloudflare (hCaptcha[^372]). hCaptcha is used on 15% of the internet by their own metrics[^373].
...
If you often use VPNs or Tor, you will quickly encounter many captchas everywhere[^374]. Quite often when using Tor, even if you succeed in solving all the puzzles (sometimes dozens in a row), you will still be denied after solving the puzzles.

See <https://gitlab.torproject.org/legacy/trac/-/wikis/org/doc/ListOfServicesBlockingTor> <sup>[[Archive.org]][313]</sup>

While most people think those puzzles are only about solving a little puzzle, it is important to understand that it is much more complex, and that modern Captchas uses advanced machine learning and risk analysis algorithms to check if you are human[^375]:

-   They check your browser, cookies, and browsing history using Browser fingerprinting[^376].

-   They track your cursor movements (speed, accuracy) and use algorithms to decide if it is "human/organic".

-   They track your behavior before/during/after the tests to ensure you are "human"[^377].
...
Most platforms (including the privacy-oriented ones such as Signal/Telegram/ProtonMail will require a phone number to register, and most countries now make it mandatory to submit a proof of ID to register[^379].
...
Browser and Device[^380] Fingerprinting are usually integrated into the Captcha services but also in other various services.

Many platforms (like Google[^381]) will check your browser for various capabilities and settings and block Browsers they do not like. This is one of the reasons I recommend using Chromium-based Browsers such as Brave Browser over Tor Browser within this VM.
...
While this might seem innocent, this is obviously an ID verification and de-anonymization method. This is just indirectly relying on third-party financial KYC[^238] regulations.

This is for instance now the case on YouTube for some European Users[^382] but also used by services like Amazon that requires a valid payment method for creating an account.
...
This option is often presented as the "default one", hiding away the "Sign-in with e-mail and password" with clever Dark Patterns[^383] and unfortunately sometimes needed.
...
This guide will not cover this one (yet) as it is mainly used on financial platforms (that will be able to identify you with other means anyway) and some dating apps like Tinder[^384]. Unfortunately, this method is now also sometimes being used on Facebook[^385] and Instagram as part of their verification methods (tho I did not face it yet so far).
...
Recently even platforms such as PornHub decided to implement similar measures in the future[^386].
...
Some countries have even developed hotlines where you can report any subversive content[^387].
...
So what? Well instead of not trusting anyone or anything, I would advise to **"Trust but verify"**[^388] (or "Never trust, always verify" if you are more hardcore about it and want to apply Zero-Trust Security[^389]) instead.
...
This is the fun part where you will now create your identities from thin air. These identities do not exist but should be plausible and look "organic". They should ideally have a story, a "legend" (yes this is the real term for this[^390]).
...
-   **Always use TOTP 2FA (not SMS to prevent Sim Swapping attacks**[^393] **and to keep your identity working when your pre-paid card expires) using KeePassXC when available to secure your logins to various platforms.**
...
-   Whonix/Tails: Create/Edit a file ```/usr/local/etc/torrc.d/50_user.conf```[^394].

-   On Tor Browser: Edit the torrc file located at ```Browser/TorBrowser/Data/Tor```[^395].
...
-   Can you create accounts through Tor? Yes, but it is very difficult and their onion address[^396] will not help. In most cases, you'll just have a random error at sign-up and your account suspended after sign-in."
...
If your account gets suspended [^399] (this can happen on sign-up, after signing-up or after using it in some Google services), you can still get it unsuspended by submitting[^400] an appeal/verification (which will again require your Phone number and possibly an e-mail contact with Google support with the reason). **Suspension of the account does not disable the e-mail forwarding, but the suspended account will be deleted after a while.**
...
It is also possible that Google will require an ID check through indirect financial KYC or ID picture check if you try to access/publish mature content on their platform[^401].
...
LinkedIn will then require you to go through a verification process that will, unfortunately, require you to send an ID proof (identity card, passport, driver's license). This ID verification is processed by a company called Jumio[^402] that specializes in ID proofing. This is most likely a dead end as this would force you to develop some strong Photoshop skills.
...
They are recommended by Privacyguides.org[^403]. Their only apparent issue is that they do require (in most cases) a phone number or another e-mail address for registration (when you try to register from a VPN or Tor at least).

They claim they do not store/link the phone/e-mail associated with the registration but only store a hash that is not linked to the account[^404]. If their claim is true and the hash is not linked to your account, and that you followed my guide about the phone number, you should be reasonably safe from tracking.
...
This time you will need to submit an appeal using a form[^405], provide a good reason and wait for the appeal to be processed by Twitter. During that process, you may receive an e-mail (on ProtonMail) asking you to reply to a customer service ticket to prove that you do have access to your e-mail and that it is you. This will be directed toward your Gmail address but will arrive on your ProtonMail.
...
You are going to have to find a separate way to post there using at least seven proxies[^406] that are not known by 4chan blocking system (hint: Anonymous VPS using Monero is probably your best option).
...
End-to-end Encryption[^407] (aka e2ee) is a rather simple concept. It just means only you and your destination know each-others public encryption keys and no one in between that would be eavesdropping would be able to decrypt the communication.
...
Zero-Access Encryption[^409] at rest is used when you store data at some provider (let us say your chat history or chat backups) but this history or backup is encrypted on your side and cannot be read or decrypted by the provider hosting it.
...
Such a feature would have prevented important hacks such as the Cambridge Analytica scandal[^410] if it were implemented.
...
-   The Sealed Sender option[^411].

-   The Private Contact Discovery[^412].

-   The Private Group System[^413].
...
I will recommend these options in that order (as also recommend by Privacyguides.org[^414]'[^415] except for Session and Cwtch):
...
-   iOS:
    ...
    -   Due to the lack of any better option and while it is **normally not recommended**: Session Messenger: <https://getsession.org/> <sup>[[Archive.org]][466]</sup>. Why is it not recommended these days within the privacy community? Well, it is because they recently[^416] dropped two key security features from their protocol: Perfect Forward Secrecy and Deniability which are considered rather essential in most other apps. Yet Session has been audited[^417] with satisfactory results but that audit does not mention these changes. We also currently lack sufficient information on LokiNet (the Onion Routing Network used by Session) to endorse it. Session is still recommended by some like Techlore[^418].
...
If you must do so, you should take some steps because you cannot trust any organization to protect your anonymity[^420]. See [Appendix B1: Checklist of things to verify before sharing information][Appendix B1: Checklist of things to verify before sharing information:].

For this, I strongly recommend the use of SecureDrop[^421] (<https://securedrop.org/> <sup>[[Archive.org]][468]</sup>) which is an open-source project from the Freedom of the Press Foundation.
...
If you just want to save information (text), I will recommend the use of secure and private pastebins[^423]. Mostly I will stick to the ones recommended by PrivacyGuides.org (<https://privacyguides.org/providers/paste/> <sup>[[Archive.org]][477]</sup> ) :
...
So, the fact is that it is very unlikely[^429]'[^430] and difficult for a forensic examiner to be able to recover data from a Trimmed SSD but it is not completely impossible either[^431]'[^432]'[^433] if they are fast enough and have access to extensive equipment, skills, and motivation.
...
-   Easy options for less experienced users:
    ...
    -   Buy PartedMagic[^434] for 11$ and use it to erase any disk.
...
-   If your file system is APFS, you do not need to worry about Trim, it happens asynchronously as the OS writes data[^440] according to their documentation.
...
Unfortunately, Apple has removed the secure erase options from the trash bin even for HDD drives[^441]. So, you are left with using other tools:
...
Another option good tool IMHO to remove metadata from various documents is the open-source mat2 recommended by privacyguides.org[^442] (<https://0xacab.org/jvoisin/mat2> <sup>[[Archive.org]][516]</sup>) which you can use on Linux quite easily. I never managed to make it work properly within Windows due to various dependencies issues despite the provided instructions. It is however very straightforward to install and use on Linux.
...
Mat2 is also pre-installed on the Whonix Workstation VM[^443] and available on Tails by default[^444].
...
Lastly, you can also disable Gatekeeper altogether by issuing the following command in the terminal[^445]:
...
Windows Event logs will keep many various pieces of information that could contain traces of your activities such as the devices that were mounted (including Veracrypt NTFS volumes for instance[^331]), your network connections, app crash information, and various errors. It is always best to clean those up regularly. Do not do this on the Decoy OS.
...
As explained earlier, Shellbags are basically histories of accessed volumes/files on your computer. Remember that shellbags are exceptionally useful sources of information for forensics[^323] and you need to clean those. Especially if you mounted any "hidden volume" anywhere. Again, you should not do this on the Decoy OS:
...
-   Download and install PrivaZer from <https://privazer.com/en/download.php> <sup>[[Archive.org]][525]</sup>
    ...
    -   (If you did select Free Space cleaning) Within Clean Options **(Be careful with this option as it will erase all the free space on the selected partition, especially if you are running the decoy OS. Do not erase the free space or anything else on the second partition as you risk destroying your Hidden OS)**
        ...
        -   If you have an SSD drive:
            ...
            -   Secure Overwriting Tab: I would just pick Normal Deletion + Trim (Trim itself should be enough[^340]). Secure Deletion with Trim[^337] (1 pass) might be redundant and overkill here if you intend to overwrite the free space anyway.
...
DuckDuckGo does not store a cached version of pages[^446] and will instead forward you to a Google/Bing cached version if available.

In addition, DuckDuckGo source most of their searches from Bing (and not Google)[^447] and therefore removing the content from Bing should in time have it removed it from DuckDuckGo too.
...
A commonly used technique that combines the idea of a Dead Drop[^448] and Secure Communication Obfuscation[^449] through Steganography[^450] and/or Kleptography[^451] and has many names such as Koalang[^452] or "Talking Around" or even "Social Steganography". This technique is very old and still widely used nowadays by teenagers to bypass parental control. It is hiding in plain sight.
...
Wait, what is OPSEC? Well, OPSEC means Operations Security[^453]. The basic definition is: "OPSEC is the process of protecting individual pieces of data that could be grouped together to give the bigger picture ".
...
**"A lie can travel halfway around the world while the truth is putting on its shoes"**[^454]
...
As written earlier in this guide and as noted by PrivacyGuides.org[^455], Windows 10 is a privacy nightmare. And disabling everything during and after the installation using the settings available to you is not enough. The amount of telemetry data collected by Microsoft is staggering and could defeat your attempts at keeping secrets. You will need to download and use a couple of utilities to (hopefully) force Windows 10 into not sending data back to Microsoft.
...
This guide will **[only recommend]{.underline}** using Tor Browser within the host OS because it has the best protection by default. The only other acceptable option in my opinion would be to use Brave Browser with a Tor tab **but keep in mind that Brave themselves recommend the use of Tor Browser if you feel your safety depends on being anonymous**[^456]**: "If your personal safety depends on remaining anonymous, we highly recommend using Tor Browser instead of Brave Tor windows. ".**
...
-   The Windows USN journal which stores plenty of information[^457].

-   The Windows System Resource Usage Monitor (SRUM)[^458].

-   Various histories of various programs (such as the recent lists).

-   Various logs

-   The free (unallocated) space of your hard drive[^459].
...
Several utilities are recommended (like the old unmaintained DBAN[^460] or System Rescue CD (<https://www.system-rescue.org/> <sup>[[Archive.org]][585]</sup>)) for this but I will recommend the use of ShredOS.
...
Some might be very efficient[^461] but many are gimmicky gadgets.
...
**Use the manufacturer-provided tools to check and perform these operations** ... It is pretty much the only way to be sure it is not only supported but actually works. Some utilities can tell you whether it is supported or not like CrystalDiskInfo[^462] but will not actually check if it is working. See [Appendix J: Manufacturer tools for Wiping HDD and SSD drives][Appendix J: Manufacturer tools for Wiping HDD and SSD drives:].
...
According to Apple Documentation[^452], Trim is supported on APFS (asynchronously) and HFS+ (through period trim or first-aid).
...
-   **Again, do not take them with you unless it is absolutely necessary.** **If you really must,** you could consider powering it off and removing the battery or, if not possible, the use of a faraday cage[^463] bag to store your devices. There are many such faraday "signal blocking" bags available for sale and some of these have been studied[^464] for their effectiveness. If you cannot afford such bags, you can probably achieve a "decent result" with one or several sheets of aluminum foil (as shown in the previously linked study).

    -   Warning: consider that sensor data itself can also be reliably used to track you[^465]'[^466].
...
-   Wearing gloves while manipulating anything to avoid leaving fingerprints[^467] and touch DNA[^468].
...
-   Do not lick the envelope or the stamps[^469] if you use them to avoid leaving DNA traces.
...
So, what is OONI? OONI stands for Open Observatory of Network Interference and is a sub-project of the Tor Project[^293].
...
The problem is that your network providers will be able to see those tests and your attempts at connecting to various services if the network is monitored. The other issue is that there are solutions to prevent OONI from working properly[^470].
...
Usually, integrity checks[^471] are done using hashes of files (usually stored within checksum files). Older files could use CRC[^472], more recently MD5[^473] but those present several weaknesses (CRC, MD5[^474]) that make them unreliable for file integrity checks (which does not mean they are not still widely used in other contexts).

This is because they do not prevent Collision[^475] well enough and could allow an adversary to create a similar but malicious file that would still produce in the same CRC or MD5 hash despite having different content.

For this reason, it is usually recommended to use SHA-based[^476] hashes and the most used is probably the SHA-2[^477] based SHA256 for verifying file integrity. SHA is much more resistant to collisions[^478] than CRC and MD5. And collisions with SHA256 or SHA512 are rare and hard to compute for an adversary.
...
Integrity is one thing. Authenticity is another thing. This is a process where you can verify some information is authentic and from the expected source. This is usually done by signing information (using GPG[^481] for instance) using public-key cryptography[^482].
...
You might be asking yourself, what about Anti-Virus solutions? Well, no ... these are not perfect solutions against many modern malware and viruses using polymorphic code[^483]. But it does not mean they cannot help against less sophisticated and known attacks. It depends on how to use them as AV software can become an attack vector in itself.
...
Some will just argue against them broadly like Whonix[^484] but this topic is being discussed and disputed even at Whonix[^485] by other members of their community.
...
-   Yes, there are viruses and malware for Linux[^486]'[^487]'[^488]'[^489]'[^490]

-   Yes, there are viruses and malware for macOS[^498]'[^491][^492]'[^493][^494]
...
-   This practical cheat sheet from SANS: <https://digital-forensics.sans.org/media/analyzing-malicious-document-files.pdf> <sup>[[Archive.org]][671]</sup> (warning, many of those tools might be harder to use on Windows and you might consider using them from a Linux OS such as Tails, Whonix Workstation, or a Linux distribution of your choice as explained later in this guide. There are also other guides out there[^498] that might be of use).
...
There are plenty of methods you could use to bypass those restrictions locally. One of them would be to use portable apps[^499]. Those apps do not require installation on your system and can be run from a USB key or anywhere else.
...
**This is my recommended/preferred choice for a Browser within your guest VMs. This is not my recommended choice for a Browser within your Host OS where I strictly recommend Tor Browser as they recommend it themselves**[^500]**.**

Why Brave despite the controversies[^501]?
...
-   You will enjoy native ad-blocking where none is available in others by default without adding extensions[^502].

-   Performance is arguably better than Firefox[^503].

-   Brave is arguably better at fingerprinting resistance than others[^504].

-   Security of Chromium-based Browser is arguably better and more secure than Firefox[^505]'[^506]. Within the context of this guide, security should be privileged to prevent any vulnerability or exploit from gaining access to the VM.

-   Comparison of both by Mozilla: <https://www.mozilla.org/en-US/firefox/browsers/compare/brave/> <sup>[[Archive.org]][674]</sup>

-   Comparison of both by Techlore: <https://www.youtube.com/watch?v=qkJGF3syQy4> <sup>[[Invidious]][675]</sup>
...
-   Brave was found to be sending no identifiable telemetry compared to other browsers[^507].

## Ungoogled-Chromium:

**This browser is considered a security liability due to their systemic lagging on security patches**[^508]**.**
...
-   Better Security than Firefox as it is Chromium-based[^509]'[^510].

-   Better Performance than Firefox.

-   The whole traffic will be router through Tor anyway.

-   Can benefit from additional security using Microsoft Defender Application Guard (MDAG)[^511]. Note that this feature cannot be enabled in a Virtualbox VM unfortunately.
...
-   In addition to being out of the Chromium world, it is also completely out of the Google world (despite the Mozilla Foundation being almost entirely funded by Google[^512]).
...
Security (especially sandboxing) of Firefox is arguably weaker than Chromium-based browsers[^513].
...
-   Download and install Brave browser from <https://brave.com/download/> <sup>[[Archive.org]][676]</sup>
...
That's it and you should be pretty much covered. For full paranoia, you can also just "Block Scripts" to disable Javascript. Note that even disabling Javascript might not protect you fully[^514].

## Ungoogled-Chromium:

**This browser is considered a security liability due to their systemic lagging on security patches**[^515]**.**
...
1.  <https://wiki.archlinux.org/title/Firefox/Privacy> <sup>[[Archive.org]][677]</sup> **(most recommended)**

2.  <https://proprivacy.com/privacy-service/guides/firefox-privacy-security-guide> <sup>[[Archive.org]][678]</sup>
...
-   <https://chrisx.xyz/blog/yet-another-firefox-hardening-guide/> <sup>[[Archive.org]][679]</sup>

-   <https://ebin.city/~werwolf/posts/firefox-hardening-guide/> <sup>[[Archive.org]][680]</sup>

# Appendix W: Virtualization

So, you might ask yourself, what is Virtualization[^516]?
...
Bridges are special Tor entry nodes that are not listed on the Tor public directory. Some of those are running on people running the Snowflake Browser extension[^517] while others are running on various servers around the world. Most of those bridges are running some type of obfuscation method called obfs4[^518].

Here is the definition from the Tor Browser Manual[^519]: "obfs4 makes Tor traffic look random and prevents censors from finding bridges by Internet scanning. obfs4 bridges are less likely to be blocked than its predecessor, obfs3 bridges".
...
As per their definition from their manual[^520]: "meek transports make it look like you are browsing a major web site instead of using Tor. meek-azure makes it look like you are using a Microsoft web site". This is a type of "domain fronting" [^521].
...
-   Download and install Tor Browser according to the instructions from <https://www.torproject.org/download/> <sup>[[Archive.org]][683]</sup>
...
**(Optional and not recommended by the Tor Project, [this is a personal choice I made]{.underline})** If you are not using the "Safest" level, I will diverge from some but agree with others (for instance the Tails project and others[^522]) and will actually recommend some modifications of the default Tor Browser in the addition of two extensions:
...
Let's keep in mind that even 3 letters agencies recommend blocking ads for their internal users in order to improve security[^523].
...
**As explained in the disclaimer, If you feel extra paranoid,** you could consider using an additional conversion step using a different privacy/anonymity-focused cryptocurrency such as Zcash (<https://z.cash/> <sup>[[Archive.org]][687]</sup>).
...
2.  **Buying Zcash first option:**
    ...
    a.  Buy Zcash (see <https://z.cash/exchanges/> <sup>[[Archive.org]][688]</sup>)
...
You might want to consider the use of Wasabi (<https://wasabiwallet.io/> <sup>[[Archive.org]][689]</sup>) for your BTC transactions using their "CoinJoin feature"[^524] to further cover your tracks. This would mean swapping your Monero for BTC to a Wasabi Wallet instead of a normal Wallet. And then using that Wasabi Wallet for your BTC transactions using their CoinJoin feature.
...
-   Tor Project: <https://community.torproject.org/relay/community-resources/good-bad-isps/> <sup>[[Archive.org]][690]</sup>

-   PrivacyGuides.org: <https://privacyguides.org/providers/hosting/> <sup>[[Archive.org]][691]</sup>
...
My opinion (and the one of many[^525]'[^526]'[^527]'[^528]'[^529]'[^530]) is that passphrases are generally better than passwords. So instead of thinking of better passwords, forget them altogether and use passphrases instead (when possible). Or just use a password manager with very long passwords (such as KeePassXC, the preferred password manager in this guide).

The well-known shown-below XKCD <https://xkcd.com/936/> <sup>[[Archive.org]][692]</sup> is still valid despite some people disputing it (See <https://www.explainxkcd.com/wiki/index.php/936:_Password_Strength> <sup>[[Archive.org]][693]</sup>). Yes, it is quite old now and is a little bit outdated and might be misinterpreted. But generally, it is still valid and a good argument for using passphrases instead of passwords.

![][694]

(Illustration by Randall Munroe, xkcd.com, licensed under CC BY-NC 2.5)

Here are some recommendations (based on Wikipedia[^531]):
...
Watch this insightful video by Computerphile: <https://www.youtube.com/watch?v=3NjQ9b3pgIg> <sup>[[Invidious]][695]</sup>
...
I will not go into too many details. Just pick one from PrivacyGuides.org (<https://privacyguides.org/providers/search-engines> <sup>[[Archive.org]][696]</sup>).
...
-   The OxyMonster case (<https://arstechnica.com/tech-policy/2018/06/dark-web-vendor-oxymonster-turns-out-to-be-a-frenchman-with-luscious-beard/> <sup>[[Archive.org]][697]</sup>):
...
-   <https://www.whonix.org/wiki/Surfing_Posting_Blogging#Stylometry> <sup>[[Archive.org]][698]</sup>: Whonix documentation about stylometry.

-   <https://wikipedia.org/wiki/Forensic_linguistics> <sup>[[Wikiless]][699]</sup> <sup>[[Archive.org]][700]</sup>: Gives a brief rundown of the basics of forensic linguistics, not too informative.

-   <https://wikipedia.org/wiki/Writeprint> <sup>[[Wikiless]][701]</sup> <sup>[[Archive.org]][702]</sup>: Gives a brief and informative rundown of forensic linguistics applied to internet investigations.

-   <https://wikipedia.org/wiki/Stylometry> <sup>[[Wikiless]][703]</sup> <sup>[[Archive.org]][704]</sup>: Gives a brief overview of Stylometry.

-   <https://wikipedia.org/wiki/Content_similarity_detection> <sup>[[Wikiless]][705]</sup> <sup>[[Archive.org]][706]</sup>: I would recommend reading this, quite informative.

-   <https://wikipedia.org/wiki/Author_profiling> <sup>[[Wikiless]][707]</sup> <sup>[[Archive.org]][708]</sup>: Read through this as well if you are interested in this topic.

-   <https://wikipedia.org/wiki/Native-language_identification> <sup>[[Wikiless]][709]</sup> <sup>[[Archive.org]][710]</sup>: This is less important if you use a translator, but if you do not use a translator to communicate on forums that are not in your native language, consider giving this a quick read through.

-   <https://wikipedia.org/wiki/Computational_linguistics> <sup>[[Wikiless]][711]</sup> <sup>[[Archive.org]][712]</sup>: Only read through this if this topic is interesting to you.

-   <https://regmedia.co.uk/2017/09/27/gal_vallerius.pdf> <sup>[[Archive.org]][713]</sup>: Explains how authorities used forensic linguistics to help arrest OxyMonster (pages 13 -- 14).

-   <https://wikipedia.org/wiki/Ted_Kaczynski#After_publication> <sup>[[Wikiless]][714]</sup> <sup>[[Archive.org]][715]</sup>: May have an IQ of 167, but he was caught primarily based on forensic linguistics.

-   <https://i.blackhat.com/USA-19/Wednesday/us-19-Wixey-Im-Unique-Just-Like-You-Human-Side-Channels-And-Their-Implications-For-Security-And-Privacy.pdf> <sup>[[Archive.org]][716]</sup>: Explains how your writing style can be used to track you, I highly recommend reading through these slides, or watching the accompanying presentation on YouTube.

-   <https://media.defcon.org/DEF%20CON%2026/DEF%20CON%2026%20presentations/DEFCON-26-Matt-Wixey-Betrayed-by-the-Keyboard-Updated.pdf> <sup>[[Archive.org]][717]</sup>: Explains how your writing style can be used to track you, I highly recommend reading through these slides, or watching the accompanying presentation on YouTube, this is quite similar to the last presentation.

-   <https://i.blackhat.com/us-18/Wed-August-8/us-18-Wixey-Every-ROSE-Has-Its-Thorn-The-Dark-Art-Of-Remote-Online-Social-Engineering.pdf> <sup>[[Archive.org]][718]</sup>: This goes over how to potentially spot deception through the internet, and presents a checklist to see how trustworthy someone is. I would advise reading the slides or watching the presentation on YouTube.
...
-   For Reddit, use a LibReddit instance (<https://github.com/spikecodes/libreddit> <sup>[[Archive.org]][719]</sup>)

-   For Maps, consider using <https://www.openstreetmap.org>

-   For Translation, consider using a SimplyTranslate (<https://git.sr.ht/~metalune/simplytranslate_web> <sup>[[Archive.org]][720]</sup>) at <https://translate.metalune.xyz/>
...
-   Light Theme PDF: <https://anonymousplanet.org/guide.pdf> <sup>[[Mirror]][721]</sup> <sup>[[Archive.org]][722]</sup> <sup>[[Tor Mirror]][723]</sup>

-   Dark Theme PDF: <https://anonymousplanet.org/guide-dark.pdf> <sup>[[Mirror]][724]</sup> <sup>[[Archive.org]][725]</sup> <sup>[[Tor Mirror]][726]</sup>

-   OpenDocument Text (ODT) version at: <https://anonymousplanet.org/guide.odt> <sup>[[Mirror]][727]</sup> <sup>[[Archive.org]][728]</sup> <sup>[[Tor Mirror]][729]</sup>
...
If you want to compare the older version of the ODT format with a newer version, use the LibreWriter compare features as explained here: <https://help.libreoffice.org/7.1/en-US/text/shared/guide/redlining_doccompare.html> <sup>[[Archive.org]][730]</sup>
...
-   Have a look at this part of the Whonix documentation: <https://www.whonix.org/wiki/Surfing_Posting_Blogging#Anonymous_File_Sharing> <sup>[[Archive.org]][731]</sup>
...
First, please read this small introduction video to Monero: <https://www.youtube.com/watch?v=H33ggs7bh8M> <sup>[[Invidious]][732]</sup>

The anonymity of Monero depends on its crypto algorithms. If you do use Monero from a KYC Exchange. You can be almost certain that you are safe today. But you might not be in the long-term future if Monero algorithms are ever broken[^532] (think Quantum Computing). Do keep in mind that KYC regulations might force operators (such as Crypto Exchanges) to keep your financial records for up to 10 years and that you, therefore, need Monero algorithms to not be broken for the next 10 years as well.

You may want to watch this insightful video for more details: [**https://www.youtube.com/watch?v=j02QoI4ZlnU**][] <sup>[[Invidious]][733]</sup>

Also please consider reading: **<https://github.com/monero-project/monero/blob/master/docs/ANONYMITY_NETWORKS.md#privacy-limitations>** <sup>[[Archive.org]][734]</sup>
...
-   (My personal favorite) LINDDUN <https://www.linddun.org/> <sup>[[Archive.org]][735]</sup>

-   STRIDE <https://en.wikipedia.org/wiki/STRIDE_%28security%29> <sup>[[Wikiless]][736]</sup> <sup>[[Archive.org]][737]</sup>

-   PASTA <https://versprite.com/tag/pasta-threat-modeling/> <sup>[[Archive.org]][738]</sup>

And there are quite a few others too, see:

-   <https://insights.sei.cmu.edu/blog/threat-modeling-12-available-methods/> <sup>[[Archive.org]][739]</sup>

-   <https://www.geeksforgeeks.org/threat-modelling/> <sup>[[Archive.org]][740]</sup>

You can find some introduction on these on these projects:

-   Threat Modeling Manifesto: <https://www.threatmodelingmanifesto.org/> <sup>[[Archive.org]][741]</sup>

-   OWASP: <https://cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html> <sup>[[Archive.org]][742]</sup>
...
[^3]: Wikipedia, Don't be evil <https://en.wikipedia.org/wiki/Don%27t_be_evil> <sup>[[Wikiless]][744]</sup> <sup>[[Archive.org]][745]</sup>

[^4]: YouTube, <https://www.youtube.com/watch?v=6DGNZnfKYnU> <sup>[[Invidious]][746]</sup>

[^5]: Wikipedia, OSINT <https://en.wikipedia.org/wiki/Open-source_intelligence> <sup>[[Wikiless]][747]</sup> <sup>[[Archive.org]][748]</sup>

[^6]: YouTube Internet Historian Playlist, HWNDU <https://www.youtube.com/playlist?list=PLna1KTNJu3y09Tu70U6yPn28sekaNhOMY> <sup>[[Invidious]][749]</sup>

[^7]: Wikipedia, 4chan <https://en.wikipedia.org/wiki/4chan> <sup>[[Wikiless]][750]</sup> <sup>[[Archive.org]][751]</sup>

[^8]: PIA, See this good article on the matter <https://www.privateinternetaccess.com/blog/how-does-privacy-differ-from-anonymity-and-why-are-both-important/> <sup>[[Archive.org]][752]</sup> (disclaimer: this is not an endorsement or recommendation for this commercial service).
...
[^10]: This World of Ours, James Mickens <https://scholar.harvard.edu/files/mickens/files/thisworldofours.pdf> <sup>[[Archive.org]][753]</sup>

[^11]: XKCD, Security <https://xkcd.com/538/> <sup>[[Archive.org]][754]</sup>

[^12]: Wikipedia, Threat Model <https://en.wikipedia.org/wiki/Threat_model> <sup>[[Wikiless]][755]</sup> <sup>[[Archive.org]][756]</sup>

[^13]: Bellingcat <https://www.bellingcat.com/> <sup>[[Archive.org]][757]</sup>

[^14]: Wikipedia, Doxing <https://en.wikipedia.org/wiki/Doxing> <sup>[[Wikiless]][758]</sup> <sup>[[Archive.org]][759]</sup>

[^15]: YouTube, Internet Historian, The Bikelock Fugitive of Berkeley <https://www.youtube.com/watch?v=muoR8Td44UE> <sup>[[Invidious]][760]</sup>

[^16]: BBC News, Tor Mirror <https://www.bbc.com/news/technology-50150981> <sup>[[Archive.org]][761]</sup>

[^17]: GitHub, Real World Onion websites <https://github.com/alecmuffett/real-world-onion-sites> <sup>[[Archive.org]][762]</sup>

[^18]: Tor Project, Who Uses Tor <https://2019.www.torproject.org/about/torusers.html.en> <sup>[[Archive.org]][763]</sup>

[^19]: Whonix Documentation, The importance of Anonymity <https://www.whonix.org/wiki/Anonymity> <sup>[[Archive.org]][764]</sup>

[^20]: Geek Feminism, <https://geekfeminism.wikia.org/wiki/Who_is_harmed_by_a_%22Real_Names%22_policy%3F> <sup>[[Archive.org]][765]</sup>

[^21]: Tor Project, Tor Users <https://2019.www.torproject.org/about/torusers.html.en> <sup>[[Archive.org]][763]</sup>

[^22]: PrivacyHub, Internet Privacy in the Age of Surveillance <https://www.cyberghostvpn.com/privacyhub/internet-privacy-surveillance/> <sup>[[Archive.org]][766]</sup>

[^23]: PIA Blog, 50 Key Stats About Freedom of the Internet Around the World <https://www.privateinternetaccess.com/blog/internet-freedom-around-the-world-in-50-stats/> <sup>[[Archive.org]][767]</sup>

[^24]: Wikipedia, IANAL <https://en.wikipedia.org/wiki/IANAL> <sup>[[Wikiless]][768]</sup> <sup>[[Archive.org]][769]</sup>

[^25]: Wikipedia, Trust but verify <https://en.wikipedia.org/wiki/Trust,_but_verify> <sup>[[Wikiless]][770]</sup> <sup>[[Archive.org]][771]</sup>

[^26]: Wikipedia, IP Address, <https://en.wikipedia.org/wiki/IP_address> <sup>[[Wikiless]][772]</sup> <sup>[[Archive.org]][773]</sup>

[^27]: Wikipedia; Data Retention <https://en.wikipedia.org/wiki/Data_retention> <sup>[[Wikiless]][774]</sup> <sup>[[Archive.org]][775]</sup>

[^28]: Wikipedia, Tor Anonymity Network <https://en.wikipedia.org/wiki/Tor_(anonymity_network)> <sup>[[Wikiless]][776]</sup> <sup>[[Archive.org]][777]</sup>

[^29]: Wikipedia, VPN <https://en.wikipedia.org/wiki/Virtual_private_network> <sup>[[Wikiless]][778]</sup> <sup>[[Archive.org]][779]</sup>

[^30]: Ieee.org, Anonymity Trilemma: Strong Anonymity, Low Bandwidth Overhead, Low Latency - Choose Two <https://ieeexplore.ieee.org/document/8418599> <sup>[[Archive.org]][780]</sup>

[^31]: Wikipedia, DNS <https://en.wikipedia.org/wiki/Domain_Name_System> <sup>[[Wikiless]][781]</sup> <sup>[[Archive.org]][782]</sup>

[^32]: Wikipedia, DNS Blocking <https://en.wikipedia.org/wiki/DNS_blocking> <sup>[[Wikiless]][783]</sup> <sup>[[Archive.org]][784]</sup>

[^33]: CensoredPlanet <https://censoredplanet.org/> <sup>[[Archive.org]][785]</sup>

[^34]: ArXiv, Characterizing Smart Home IoT Traffic in the Wild <https://arxiv.org/pdf/2001.08288.pdf> <sup>[[Archive.org]][786]</sup>

[^35]: Labzilla.io, Your Smart TV is probably ignoring your Pi-Hole <https://labzilla.io/blog/force-dns-pihole> <sup>[[Archive.org]][787]</sup>

[^36]: Wikipedia, DNS over HTTPS: <https://en.wikipedia.org/wiki/DNS_over_HTTPS> <sup>[[Wikiless]][788]</sup> <sup>[[Archive.org]][789]</sup>

[^37]: Wikipedia, DNS over TLS, <https://en.wikipedia.org/wiki/DNS_over_TLS> <sup>[[Wikiless]][790]</sup> <sup>[[Archive.org]][791]</sup>

[^38]: Wikipedia, Pi-Hole <https://en.wikipedia.org/wiki/Pi-hole> <sup>[[Wikiless]][792]</sup> <sup>[[Archive.org]][793]</sup>

[^39]: Wikipedia, SNI <https://en.wikipedia.org/wiki/Server_Name_Indication> <sup>[[Wikiless]][794]</sup> <sup>[[Archive.org]][795]</sup>

[^40]: Wikipedia, ECH, <https://en.wikipedia.org/wiki/Server_Name_Indication#Encrypted_Client_Hello> <sup>[[Wikiless]][794]</sup> <sup>[[Archive.org]][795]</sup>

[^41]: Wikipedia, eSNI <https://en.wikipedia.org/wiki/Server_Name_Indication#Encrypted_Client_Hello> <sup>[[Wikiless]][794]</sup> <sup>[[Archive.org]][795]</sup>

[^42]: Usenix.org, On the Importance of Encrypted-SNI (ESNI) to Censorship Circumvention <https://www.usenix.org/system/files/foci19-paper_chai_0.pdf> <sup>[[Archive.org]][796]</sup>

[^43]: Wikipedia, CDN <https://en.wikipedia.org/wiki/Content_delivery_network> <sup>[[Wikiless]][797]</sup> <sup>[[Archive.org]][798]</sup>

[^44]: Cloudflare, Good-bye ESNI, hello ECH! <https://blog.cloudflare.com/encrypted-client-hello/> <sup>[[Archive.org]][799]</sup>

[^45]: ZDNET, Russia wants to ban the use of secure protocols such as TLS 1.3, DoH, DoT, ESNI <https://www.zdnet.com/article/russia-wants-to-ban-the-use-of-secure-protocols-such-as-tls-1-3-doh-dot-esni/> <sup>[[Archive.org]][800]</sup>

[^46]: ZDNET, China is now blocking all encrypted HTTPS traffic that uses TLS 1.3 and ESNI <https://www.zdnet.com/article/china-is-now-blocking-all-encrypted-https-traffic-using-tls-1-3-and-esni/> <sup>[[Archive.org]][801]</sup>

[^47]: Wikipedia, OCSP <https://en.wikipedia.org/wiki/Online_Certificate_Status_Protocol> <sup>[[Wikiless]][802]</sup> <sup>[[Archive.org]][803]</sup>

[^48]: Madaidans Insecurities, Why encrypted DNS is ineffective <https://madaidans-insecurities.github.io/encrypted-dns.html> <sup>[[Archive.org]][804]</sup>

[^49]: Wikipedia, OCSP Stapling <https://en.wikipedia.org/wiki/OCSP_stapling> <sup>[[Wikiless]][805]</sup> <sup>[[Archive.org]][806]</sup>

[^50]: Chromium Documentation, CRLSets <https://dev.chromium.org/Home/chromium-security/crlsets> <sup>[[Archive.org]][807]</sup>

[^51]: ZDNet, Chrome does certificate revocation better <https://www.zdnet.com/article/chrome-does-certificate-revocation-better/> <sup>[[Archive.org]][808]</sup>

[^52]: KUL, Encrypted DNS=⇒Privacy? A Traffic Analysis Perspective <https://www.esat.kuleuven.be/cosic/publications/article-3153.pdf> <sup>[[Archive.org]][809]</sup>

[^53]: ResearhGate, Oblivious DNS: Practical Privacy for DNS Queries <https://www.researchgate.net/publication/332893422_Oblivious_DNS_Practical_Privacy_for_DNS_Queries> <sup>[[Archive.org]][810]</sup>

[^54]: Nymity.ch, The Effect of DNS on Tor's Anonymity <https://nymity.ch/tor-dns/> <sup>[[Archive.org]][811]</sup>

[^55]: Wikipedia, RFID <https://en.wikipedia.org/wiki/Radio-frequency_identification> <sup>[[Wikiless]][56]</sup> <sup>[[Archive.org]][57]</sup>

[^56]: Wikipedia, NFC <https://en.wikipedia.org/wiki/Near-field_communication> <sup>[[Wikiless]][812]</sup> <sup>[[Archive.org]][813]</sup>

[^57]: Samsonite Online Shop, RFID accessories, <https://shop.samsonite.com/accessories/rfid-accessories/> <sup>[[Archive.org]][814]</sup>

[^58]: Google Android Help, Android Location Services <https://support.google.com/accounts/answer/3467281?hl=en> <sup>[[Archive.org]][815]</sup>

[^59]: Apple Support, Location Services and Privacy <https://support.apple.com/en-us/HT207056> <sup>[[Archive.org]][816]</sup>

[^60]: 2016 International Conference on Indoor Positioning and Indoor Navigation, Wi-Fi probes as digital crumbs for crowd localization <http://fly.isti.cnr.it/pub/papers/pdf/Wifi-probes-IPIN16.pdf> <sup>[[Archive.org]][817]</sup>

[^61]: Southeast University of Nanjing, Probe Request Based Device Identification Attack and Defense <https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7472341/> <sup>[[Archive.org]][818]</sup>

[^62]: Medium.com, The Perils of Probe Requests <https://medium.com/@brannondorsey/wi-fi-is-broken-3f6054210fa5> <sup>[[Archive.org]][819]</sup>

[^63]: State University of New York, Towards 3D Human Pose Construction Using Wi-Fi <https://cse.buffalo.edu/~lusu/papers/MobiCom2020.pdf> <sup>[[Archive.org]][820]</sup>

[^64]: Digi.Ninja, Jasager <https://digi.ninja/jasager/> <sup>[[Archive.org]][821]</sup>

[^65]: Hak5 Shop, Wi-Fi Pineapple <https://shop.hak5.org/products/wifi-pineapple> <sup>[[Archive.org]][822]</sup>

[^66]: Wikipedia, Deautentication Attack <https://en.wikipedia.org/wiki/Wi-Fi_deauthentication_attack> <sup>[[Wikiless]][823]</sup> <sup>[[Archive.org]][824]</sup>

[^67]: Wikipedia, Capture Portal <https://en.wikipedia.org/wiki/Captive_portal> <sup>[[Wikiless]][825]</sup> <sup>[[Archive.org]][826]</sup>

[^68]: HackerFactor Blog, Deanonymizing Tor Circuits <https://www.hackerfactor.com/blog/index.php?/archives/868-Deanonymizing-Tor-Circuits.html> <sup>[[Archive.org]][827]</sup>

[^69]: KU Leuven, Website Fingerprinting through Deep Learning <https://distrinet.cs.kuleuven.be/software/tor-wf-dl/> <sup>[[Archive.org]][828]</sup>

[^70]: KU Leuven, Deep Fingerprinting: Undermining Website Fingerprinting Defenses with Deep Learning <https://homes.esat.kuleuven.be/~mjuarezm/index_files/pdf/ccs18.pdf> <sup>[[Archive.org]][829]</sup>

[^71]: Internet Society, Website Fingerprinting at Internet Scale <https://www.internetsociety.org/sites/default/files/blogs-media/website-fingerprinting-internet-scale.pdf> <sup>[[Archive.org]][830]</sup>

[^72]: KU Leuven, A Critical Evaluation of Website Fingerprinting Attacks <https://www.esat.kuleuven.be/cosic/publications/article-2456.pdf> <sup>[[Archive.org]][831]</sup>

[^73]: DailyDot, How Tor helped catch the Harvard bomb threat suspect <https://www.dailydot.com/unclick/tor-harvard-bomb-suspect/> <sup>[[Archive.org]][832]</sup>

[^74]: ArsTechnica, How the NSA can break trillions of encrypted Web and VPN connections <https://arstechnica.com/information-technology/2015/10/how-the-nsa-can-break-trillions-of-encrypted-web-and-vpn-connections/> <sup>[[Archive.org]][833]</sup>

[^75]: ArsTechnica, Does Tor provide more benefit or harm? New paper says it depends <https://arstechnica.com/gadgets/2020/11/does-tor-provide-more-benefit-or-harm-new-paper-says-it-depends/> <sup>[[Archive.org]][834]</sup>

[^76]: ResearchGate, The potential harms of the Tor anonymity network cluster disproportionately in free countries <https://www.pnas.org/content/early/2020/11/24/2011893117> <sup>[[Archive.org]][835]</sup>

[^77]: CryptoEngineering, How does Apple (privately) find your offline devices? <https://blog.cryptographyengineering.com/2019/06/05/how-does-apple-privately-find-your-offline-devices/> <sup>[[Archive.org]][836]</sup>

[^78]: Apple Support <https://support.apple.com/en-us/HT210515> <sup>[[Archive.org]][837]</sup>

[^79]: XDA, Samsung's Find My Mobile app can locate Galaxy devices even when they're offline <https://www.xda-developers.com/samsung-find-my-mobile-app-locate-galaxy-devices-offline/> <sup>[[Archive.org]][838]</sup>

[^80]: Apple Support, If your Mac is lost or stolen <https://support.apple.com/en-us/HT204756> <sup>[[Archive.org]][839]</sup>

[^81]: Wikipedia, BLE <https://en.wikipedia.org/wiki/Bluetooth_Low_Energy> <sup>[[Wikiless]][840]</sup> <sup>[[Archive.org]][841]</sup>

[^82]: Cryptography Engineering Blog, How does Apple (privately) find your offline devices? <https://blog.cryptographyengineering.com/2019/06/05/how-does-apple-privately-find-your-offline-devices/> <sup>[[Archive.org]][836]</sup>

[^83]: Wikipedia, IMEI <https://en.wikipedia.org/wiki/International_Mobile_Equipment_Identity> <sup>[[Wikiless]][842]</sup> <sup>[[Archive.org]][843]</sup>

[^84]: Wikipedia, IMSI <https://en.wikipedia.org/wiki/International_mobile_subscriber_identity> <sup>[[Wikiless]][844]</sup> <sup>[[Archive.org]][845]</sup>

[^85]: Android Documentation, Device Identifiers <https://source.android.com/devices/tech/config/device-identifiers> <sup>[[Archive.org]][846]</sup>

[^86]: Google Privacy Policy, Look for IMEI <https://policies.google.com/privacy/embedded?hl=en-US> <sup>[[Archive.org]][847]</sup>

[^87]: Wikipedia, IMEI and the Law <https://en.wikipedia.org/wiki/International_Mobile_Equipment_Identity#IMEI_and_the_law> <sup>[[Wikiless]][842]</sup> <sup>[[Archive.org]][843]</sup>

[^88]: Bellingcat, The GRU Globetrotters: Mission London <https://www.bellingcat.com/news/uk-and-europe/2019/06/28/the-gru-globetrotters-mission-london/> <sup>[[Archive.org]][848]</sup>

[^89]: Bellingcat,"V" For "Vympel": FSB's Secretive Department "V" Behind Assassination Of Georgian Asylum Seeker In Germany <https://www.bellingcat.com/news/uk-and-europe/2020/02/17/v-like-vympel-fsbs-secretive-department-v-behind-assassination-of-zelimkhan-khangoshvili/> <sup>[[Archive.org]][849]</sup>

[^90]: Wikipedia, CCTV <https://en.wikipedia.org/wiki/Closed-circuit_television> <sup>[[Wikiless]][850]</sup> <sup>[[Archive.org]][851]</sup>

[^91]: Apple, Transparency Report, Device Requests <https://www.apple.com/legal/transparency/device-requests.html> <sup>[[Archive.org]][852]</sup>

[^92]: The Intercept, How Cops Can Secretly Track Your Phone <https://theintercept.com/2020/07/31/protests-surveillance-stingrays-dirtboxes-phone-tracking/> <sup>[[Tor Mirror]][853]</sup> <sup>[[Archive.org]][854]</sup>

[^93]: Wikipedia, IMSI Catcher <https://en.wikipedia.org/wiki/IMSI-catcher> <sup>[[Wikiless]][855]</sup> <sup>[[Archive.org]][856]</sup>

[^94]: Wikipedia, Stingray <https://en.wikipedia.org/wiki/Stingray_phone_tracker> <sup>[[Wikiless]][857]</sup> <sup>[[Archive.org]][858]</sup>

[^95]: Gizmodo, Cops Turn to Canadian Phone-Tracking Firm After Infamous 'Stingrays' Become 'Obsolete' <https://gizmodo.com/american-cops-turns-to-canadian-phone-tracking-firm-aft-1845442778> <sup>[[Archive.org]][859]</sup>

[^96]: Wikipedia, MITM <https://en.wikipedia.org/wiki/Man-in-the-middle_attack> <sup>[[Wikiless]][860]</sup> <sup>[[Archive.org]][861]</sup>

[^97]: Purism, Librem 5 <https://shop.puri.sm/shop/librem-5/> <sup>[[Archive.org]][862]</sup>

[^98]: Wikipedia, MAC Address <https://en.wikipedia.org/wiki/MAC_address> <sup>[[Wikiless]][863]</sup> <sup>[[Archive.org]][864]</sup>

[^99]: Acyclica Road Trend Product Sheet, <https://amsignalinc.com/data-sheets/Acyclica/Acyclica-RoadTrend-Product-Sheet.pdf> <sup>[[Archive.org]][865]</sup>

[^100]: ResearchGate, Tracking Anonymized Bluetooth Devices <https://www.researchgate.net/publication/334590931_Tracking_Anonymized_Bluetooth_Devices/fulltext/5d3308db92851cd04675a469/Tracking-Anonymized-Bluetooth-Devices.pdf> <sup>[[Archive.org]][866]</sup>

[^101]: Wikipedia, CPU <https://en.wikipedia.org/wiki/Central_processing_unit> <sup>[[Wikiless]][867]</sup> <sup>[[Archive.org]][868]</sup>

[^102]: Wikipedia, Intel Management Engine <https://en.wikipedia.org/wiki/Intel_Management_Engine> <sup>[[Wikiless]][869]</sup> <sup>[[Archive.org]][870]</sup>

[^103]: Wikipedia, AMD Platform Security Processor <https://en.wikipedia.org/wiki/AMD_Platform_Security_Processor> <sup>[[Wikiless]][871]</sup> <sup>[[Archive.org]][872]</sup>

[^104]: Wikipedia, IME, Security Vulnerabilities <https://en.wikipedia.org/wiki/Intel_Management_Engine#Security_vulnerabilities> <sup>[[Wikiless]][869]</sup> <sup>[[Archive.org]][870]</sup>

[^105]: Wikipedia, IME, Assertions that ME is a backdoor <https://en.wikipedia.org/wiki/Intel_Management_Engine#Assertions_that_ME_is_a_backdoor> <sup>[[Wikiless]][869]</sup> <sup>[[Archive.org]][870]</sup>

[^106]: Wikipedia, IME, Disabling the ME <https://en.wikipedia.org/wiki/Intel_Management_Engine#Disabling_the_ME> <sup>[[Wikiless]][869]</sup> <sup>[[Archive.org]][870]</sup>

[^107]: Libreboot, <https://libreboot.org/> <sup>[[Archive.org]][873]</sup>

[^108]: Apple, Differential Privacy White Paper <https://www.apple.com/privacy/docs/Differential_Privacy_Overview.pdf> <sup>[[Archive.org]][874]</sup>

[^109]: Wikipedia, Differential Privacy <https://en.wikipedia.org/wiki/Differential_privacy> <sup>[[Wikiless]][875]</sup> <sup>[[Archive.org]][876]</sup>

[^110]: Continuing Ed, The All-Seeing "i": Apple Just Declared War on Your Privacy <https://edwardsnowden.substack.com/p/all-seeing-i> <sup>[[Archive.org]][877]</sup>

[^111]: Trinity College Dublin, Mobile Handset Privacy: Measuring The Data iOS and Android Send to Apple And Google <https://www.scss.tcd.ie/doug.leith/apple_google.pdf> <sup>[[Archive.org]][81]</sup>

[^112]: Reuters, Exclusive: Apple dropped plan for encrypting backups after FBI complained -- sources <https://www.reuters.com/article/us-apple-fbi-icloud-exclusive-idUSKBN1ZK1CT> <sup>[[Archive.org]][878]</sup>

[^113]: ZDnet, I asked Apple for all my data. Here's what was sent back <https://www.zdnet.com/article/apple-data-collection-stored-request/> <sup>[[Archive.org]][879]</sup>

[^114]: De Correspondent, Here's how we found the names and addresses of soldiers and secret agents using a simple fitness app <https://decorrespondent.nl/8481/heres-how-we-found-the-names-and-addresses-of-soldiers-and-secret-agents-using-a-simple-fitness-app/412999257-6756ba27> <sup>[[Archive.org]][880]</sup>

[^115]: Website Planet, Report: Fitness Tracker Data Breach Exposed 61 Million Records and User Data Online <https://www.websiteplanet.com/blog/gethealth-leak-report/> <sup>[[Archive.org]][881]</sup>

[^116]: Wired, The Strava Heat Map and the End of Secrets <https://www.wired.com/story/strava-heat-map-military-bases-fitness-trackers-privacy/> <sup>[[Archive.org]][882]</sup>

[^117]: Bellingcat, How to Use and Interpret Data from Strava's Activity Map <https://www.bellingcat.com/resources/how-tos/2018/01/29/strava-interpretation-guide/> <sup>[[Archive.org]][883]</sup>

[^118]: The Guardian, Fitness tracking app Strava gives away location of secret US army bases <https://www.theguardian.com/world/2018/jan/28/fitness-tracking-app-gives-away-location-of-secret-us-army-bases> <sup>[[Archive.org]][884]</sup>

[^119]: Telegraph, Running app reveals locations of secret service agents in MI6 and GCHQ <https://www.telegraph.co.uk/technology/2018/07/08/running-app-exposes-mi6-gchq-workers-whereabouts/> <sup>[[Archive.org]][885]</sup>

[^120]: Washington Post, Alexa has been eavesdropping on you this whole time <https://www.washingtonpost.com/technology/2019/05/06/alexa-has-been-eavesdropping-you-this-whole-time/?itid=lk_interstitial_manual_59> <sup>[[Archive.org]][886]</sup>

[^121]: Washington Post, What does your car know about you? We hacked a Chevy to find out <https://www.washingtonpost.com/technology/2019/12/17/what-does-your-car-know-about-you-we-hacked-chevy-find-out/> <sup>[[Archive.org]][887]</sup>

[^122]: Using Metadata to find Paul Revere (<https://kieranhealy.org/blog/archives/2013/06/09/using-metadata-to-find-paul-revere/> <sup>[[Archive.org]][888]</sup>)

[^123]: Wikipedia, Google SensorVault, <https://en.wikipedia.org/wiki/Sensorvault> <sup>[[Wikiless]][889]</sup> <sup>[[Archive.org]][890]</sup>

[^124]: NRKBeta, My Phone Was Spying on Me, so I Tracked Down the Surveillants <https://nrkbeta.no/2020/12/03/my-phone-was-spying-on-me-so-i-tracked-down-the-surveillants/> <sup>[[Archive.org]][891]</sup>

[^125]: New York Times <https://www.nytimes.com/interactive/2019/12/19/opinion/location-tracking-cell-phone.html> <sup>[[Archive.org]][892]</sup>

[^126]: Sophos, Google data puts innocent man at the scene of a crime <https://nakedsecurity.sophos.com/2020/03/10/google-data-puts-innocent-man-at-the-scene-of-a-crime/> <sup>[[Archive.org]][893]</sup>

[^127]: Wikipedia, Geofence Warrant <https://en.wikipedia.org/wiki/Geo-fence_warrant> <sup>[[Wikiless]][894]</sup> <sup>[[Archive.org]][895]</sup>

[^128]: Vice.com, Military Unit That Conducts Drone Strikes Bought Location Data From Ordinary Apps <https://www.vice.com/en/article/y3g97x/location-data-apps-drone-strikes-iowa-national-guard> <sup>[[Archive.org]][896]</sup>

[^129]: TechCrunch, Google says geofence warrants make up one-quarter of all US demands <https://techcrunch.com/2021/08/19/google-geofence-warrants/> <sup>[[Archive.org]][897]</sup>

[^130]: TechDirt, Google Report Shows 'Reverse Warrants' Are Swiftly Becoming Law Enforcement's Go-To Investigative Tool <https://www.techdirt.com/articles/20210821/10494847401/google-report-shows-reverse-warrants-are-swiftly-becoming-law-enforcements-go-to-investigative-tool.shtml> <sup>[[Archive.org]][898]</sup>

[^131]: Vice.com, Here's the FBI's Internal Guide for Getting Data from AT&T, T-Mobile, Verizon <https://www.vice.com/en/article/m7vqkv/how-fbi-gets-phone-data-att-tmobile-verizon> <sup>[[Archive.org]][899]</sup>

[^132]: Wikipedia, Room 641A <https://en.wikipedia.org/wiki/Room_641A> <sup>[[Wikiless]][900]</sup> <sup>[[Archive.org]][901]</sup>

[^133]: Wikipedia, Edward Snowden <https://en.wikipedia.org/wiki/Edward_Snowden> <sup>[[Wikiless]][902]</sup> <sup>[[Archive.org]][903]</sup>

[^134]: Wikipedia, Permanent Record <https://en.wikipedia.org/wiki/Permanent_Record_(autobiography)> <sup>[[Wikiless]][563]</sup> <sup>[[Archive.org]][564]</sup>

[^135]: Wikipedia, XKEYSCORE <https://en.wikipedia.org/wiki/XKeyscore> <sup>[[Wikiless]][904]</sup> <sup>[[Archive.org]][905]</sup>

[^136]: ElectroSpaces, Danish military intelligence uses XKEYSCORE to tap cables in cooperation with the NSA <https://www.electrospaces.net/2020/10/danish-military-intelligence-uses.html> <sup>[[Archive.org]][906]</sup>

[^137]: Wikipedia, MUSCULAR <https://en.m.wikipedia.org/wiki/MUSCULAR_(surveillance_program)> <sup>[[Archive.org]][907]</sup>

[^138]: Wikipedia, SORM <https://en.wikipedia.org/wiki/SORM> <sup>[[Wikiless]][908]</sup> <sup>[[Archive.org]][909]</sup>

[^139]: Wikipedia, Tempora <https://en.wikipedia.org/wiki/Tempora> <sup>[[Wikiless]][910]</sup> <sup>[[Archive.org]][911]</sup>

[^140]: Wikipedia, PRISM <https://en.wikipedia.org/wiki/PRISM_(surveillance_program)> <sup>[[Wikiless]][912]</sup> <sup>[[Archive.org]][913]</sup>

[^141]: Justsecurity, General Hayden <https://www.justsecurity.org/10318/video-clip-director-nsa-cia-we-kill-people-based-metadata/> <sup>[[Archive.org]][914]</sup>

[^142]: IDMB, The Social Dilemma <https://www.imdb.com/title/tt11464826/> <sup>[[Archive.org]][915]</sup>

[^143]: ArsTechnica, How the way you type can shatter anonymity---even on Tor <https://arstechnica.com/information-technology/2015/07/how-the-way-you-type-can-shatter-anonymity-even-on-tor/> <sup>[[Archive.org]][916]</sup>

[^144]: Wikipedia, Stylometry <https://en.wikipedia.org/wiki/Stylometry> <sup>[[Wikiless]][703]</sup> <sup>[[Archive.org]][917]</sup>

[^145]: Paul Moore Blog, Behavioral Profiling: The password you can't change. <https://paul.reviews/behavioral-profiling-the-password-you-cant-change/> <sup>[[Archive.org]][918]</sup>

[^146]: Wikipedia, Sentiment Analysis, <https://en.wikipedia.org/wiki/Sentiment_analysis> <sup>[[Wikiless]][919]</sup> <sup>[[Archive.org]][920]</sup>

[^147]: EFF CoverYourTracks, <https://coveryourtracks.eff.org/> <sup>[[Archive.org]][921]</sup>

[^148]: Berkeley.edu, On the Feasibility of Internet-Scale Author Identification <https://people.eecs.berkeley.edu/~dawnsong/papers/2012%20On%20the%20Feasibility%20of%20Internet-Scale%20Author%20Identification.pdf> <sup>[[Archive.org]][922]</sup>

[^149]: Forbes, Exclusive: Government Secretly Orders Google To Identify Anyone Who Searched A Sexual Assault Victim's Name, Address And Telephone Number [https://www.forbes.com/sites/thomasbrewster/2021/10/04/google-keyword-warrants-give-us-government-data-on-search-users][] <sup>[[Archive.org]][923]</sup>

[^150]: FingerprintJS, Demo: Disabling JavaScript Won't Save You from Fingerprinting <https://fingerprintjs.com/blog/disabling-javascript-wont-stop-fingerprinting/> <sup>[[Archive.org]][924]</sup>

[^151]: SecuredTouch Blog, Behavioral Biometrics 101: Behavioral Biometrics vs. Behavioral Analytics <https://blog.securedtouch.com/behavioral-biometrics-101-an-in-depth-look-at-behavioral-biometrics-vs-behavioral-analytics> <sup>[[Archive.org]][925]</sup>

[^152]: ArsTechnica, Stakeout: how the FBI tracked and busted a Chicago Anon <https://arstechnica.com/tech-policy/2012/03/stakeout-how-the-fbi-tracked-and-busted-a-chicago-anon/> <sup>[[Archive.org]][926]</sup>

[^153]: Bellingcat MH17 - Russian GRU Commander 'Orion' Identified as Oleg Ivannikov <https://www.bellingcat.com/news/uk-and-europe/2018/05/25/mh17-russian-gru-commander-orion-identified-oleg-ivannikov/> <sup>[[Archive.org]][927]</sup>

[^154]: Facebook Research, Deepface <https://research.fb.com/publications/deepface-closing-the-gap-to-human-level-performance-in-face-verification/> <sup>[[Archive.org]][928]</sup>

[^155]: Privacy News Online, Putting the "face" in Facebook: how Mark Zuckerberg is building a world without public anonymity <https://www.privateinternetaccess.com/blog/putting-face-facebook-mark-zuckerberg-building-world-without-public-anonymity/> <sup>[[Archive.org]][929]</sup>

[^156]: CNBC, "Facebook has mapped populations in 23 countries as it explores satellites to expand internet" <https://www.cnbc.com/2017/09/01/facebook-has-mapped-human-population-building-internet-in-space.html> <sup>[[Archive.org]][930]</sup>

[^157]: MIT Technology Review, This is how we lost control of our faces, <https://www.technologyreview.com/2021/02/05/1017388/ai-deep-learning-facial-recognition-data-history/> <sup>[[Archive.org]][931]</sup>

[^158]: Bellingcat, Shadow of a Doubt: Crowdsourcing Time Verification of the MH17 Missile Launch Photo <https://www.bellingcat.com/resources/case-studies/2015/08/07/shadow-of-a-doubt/> <sup>[[Archive.org]][932]</sup>

[^159]: Brown Institute, Open-Source Investigation, <https://brown.columbia.edu/open-source-investigation/> <sup>[[Archive.org]][933]</sup>

[^160]: NewScientist, Facebook can recognize you in photos even if you're not looking <https://www.newscientist.com/article/dn27761-facebook-can-recognise-you-in-photos-even-if-youre-not-looking/> <sup>[[Archive.org]][934]</sup>

[^161]: Google Patent, Techniques for emotion detection and content delivery <https://patents.google.com/patent/US20150242679> <sup>[[Archive.org]][935]</sup>

[^162]: APNews, Chinese 'gait recognition' tech IDs people by how they walk <https://apnews.com/article/bf75dd1c26c947b7826d270a16e2658a> <sup>[[Archive.org]][936]</sup>

[^163]: The Sun, New CCTV technology could now identify you just by the WAY you walk and your body shape <https://www.thesun.co.uk/news/7684204/cctv-technology-identify-body-shape-way-walk/> <sup>[[Archive.org]][937]</sup>

[^164]: City Security Magazine, Gait recognition: a useful identification tool <https://citysecuritymagazine.com/security-management/gait-recognition-identification-tool/> <sup>[[Archive.org]][938]</sup>

[^165]: Vice.com, Tech Companies Are Training AI to Read Your Lips <https://www.vice.com/en/article/bvzvdw/tech-companies-are-training-ai-to-read-your-lips> <sup>[[Archive.org]][939]</sup>

[^166]: New Atlas, Eye tracking can reveal an unbelievable amount of information about you <https://newatlas.com/science/science/eye-tracking-privacy/> <sup>[[Archive.org]][940]</sup>

[^167]: TechCrunch, Facial recognition reveals political party in troubling new research <https://techcrunch.com/2021/01/13/facial-recognition-reveals-political-party-in-troubling-new-research/> <sup>[[Archive.org]][941]</sup>

[^168]: Nature.com, Facial recognition technology can expose political orientation from naturalistic facial images <https://www.nature.com/articles/s41598-020-79310-1> <sup>[[Archive.org]][111]</sup>

[^169]: Slate <https://slate.com/technology/2018/04/facebook-collects-data-on-non-facebook-users-if-they-want-to-delete-it-they-have-to-sign-up.html> <sup>[[Archive.org]][942]</sup>

[^170]: The Conversation <https://theconversation.com/shadow-profiles-facebook-knows-about-you-even-if-youre-not-on-facebook-94804> <sup>[[Archive.org]][943]</sup>

[^171]: The Verge <https://www.theverge.com/2018/4/11/17225482/facebook-shadow-profiles-zuckerberg-congress-data-privacy> <sup>[[Archive.org]][944]</sup>

[^172]: ZDNET <https://www.zdnet.com/article/anger-mounts-after-facebooks-shadow-profiles-leak-in-bug/> <sup>[[Archive.org]][945]</sup>

[^173]: CNET <https://www.cnet.com/news/shadow-profiles-facebook-has-information-you-didnt-hand-over/> <sup>[[Archive.org]][946]</sup>

[^174]: Anyvision <https://www.anyvision.co/> <sup>[[Archive.org]][947]</sup>

[^175]: BuzzFeed.news, Surveillance Nation <https://www.buzzfeednews.com/article/ryanmac/clearview-ai-local-police-facial-recognition> <sup>[[Archive.org]][948]</sup>

[^176]: Wired, Clearview AI Has New Tools to Identify You in Photos <https://www.wired.com/story/clearview-ai-new-tools-identify-you-photos/> <sup>[[Archive.org]][949]</sup>

[^177]: NEC, Neoface <https://www.nec.com/en/global/solutions/biometrics/face/neofacewatch.html> <sup>[[Archive.org]][950]</sup>

[^178]: The Guardian, Met police deploy live facial recognition technology <https://www.theguardian.com/uk-news/2020/feb/11/met-police-deploy-live-facial-recognition-technology> <sup>[[Archive.org]][951]</sup>

[^179]: YouTube, The Economist, China: facial recognition and state control <https://www.youtube.com/watch?v=lH2gMNrUuEY> <sup>[[Invidious]][952]</sup>

[^180]: CNN, Want your unemployment benefits? You may have to submit to facial recognition first <https://edition.cnn.com/2021/07/23/tech/idme-unemployment-facial-recognition/index.html> <sup>[[Archive.org]][953]</sup>

[^181]: Washington Post, Huawei tested AI software that could recognize Uighur minorities and alert police, report says <https://www.washingtonpost.com/technology/2020/12/08/huawei-tested-ai-software-that-could-recognize-uighur-minorities-alert-police-report-says/> <sup>[[Archive.org]][954]</sup>

[^182]: The Intercept, How a Facial Recognition Mismatch Can Ruin Your Life <https://theintercept.com/2016/10/13/how-a-facial-recognition-mismatch-can-ruin-your-life/> <sup>[[Tor Mirror]][955]</sup> <sup>[[Archive.org]][956]</sup>

[^183]: Vice, Facial Recognition Failures Are Locking People Out of Unemployment Systems <https://www.vice.com/en/article/5dbywn/facial-recognition-failures-are-locking-people-out-of-unemployment-systems> <sup>[[Archive.org]][957]</sup>

[^184]: BBC, WhatsApp photo drug dealer caught by 'groundbreaking' work <https://www.bbc.com/news/uk-wales-43711477> <sup>[[Archive.org]][958]</sup>

[^185]: CNN, Drug dealer jailed after sharing a photo of cheese that included his fingerprints <https://edition.cnn.com/2021/05/25/uk/drug-dealer-cheese-sentenced-scli-gbr-intl/index.html> <sup>[[Archive.org]][959]</sup>

[^186]: Vice.com, Cops Got a Drug Dealer's Fingerprints From Photos of His Hand on WhatsApp <https://www.vice.com/en/article/evqk9e/photo-of-fingerprints-used-to-arrest-drug-dealers> <sup>[[Archive.org]][960]</sup>

[^187]: JUSTIA Patent, Identification of taste attributes from an audio signal <https://patents.justia.com/patent/10891948> <sup>[[Archive.org]][961]</sup>

[^188]: PYMNTS, Iris Scan Serves As Traveler ID At Dubai Airport <https://www.pymnts.com/news/biometrics/2021/iris-scan-traveler-identification-dubai-airport/> <sup>[[Archive.org]][962]</sup>

[^189]: IMDB, Gattaca 1997, <https://www.imdb.com/title/tt0119177/> <sup>[[Archive.org]][963]</sup>

[^190]: IMDB, Person of Interest 2011 <https://www.imdb.com/title/tt1839578> <sup>[[Archive.org]][964]</sup>

[^191]: IMDB, Minority Report 2002, <https://www.imdb.com/title/tt0181689> <sup>[[Archive.org]][965]</sup>

[^192]: Wikipedia, Deepfake <https://en.wikipedia.org/wiki/Deepfake> <sup>[[Wikiless]][966]</sup> <sup>[[Archive.org]][967]</sup>

[^193]: Econotimes, Deepfake Voice Technology: The Good. The Bad. The Future <https://www.econotimes.com/Deepfake-Voice-Technology-The-Good-The-Bad-The-Future-1601278> <sup>[[Archive.org]][968]</sup>

[^194]: Wikipedia, Deepfake Events <https://en.wikipedia.org/wiki/Deepfake#Example_events> <sup>[[Wikiless]][966]</sup> <sup>[[Archive.org]][967]</sup>

[^195]: Forbes, A Voice Deepfake Was Used To Scam A CEO Out Of $243,000 <https://www.forbes.com/sites/jessedamiani/2019/09/03/a-voice-deepfake-was-used-to-scam-a-ceo-out-of-243000/> <sup>[[Archive.org]][969]</sup>

[^196]: Joseph Steinberg, How To Prevent Facial Recognition Technology From Identifying You <https://josephsteinberg.com/how-to-prevent-facial-recognition-technology-from-identifying-you/> <sup>[[Archive.org]][970]</sup>

[^197]: NIST, Face recognition accuracy with masks using pre-COVID-19 algorithms <https://nvlpubs.nist.gov/nistpubs/ir/2020/NIST.IR.8311.pdf> <sup>[[Archive.org]][971]</sup>

[^198]: BBC, Facial recognition identifies people wearing masks <https://www.bbc.com/news/technology-55573802> <sup>[[Archive.org]][972]</sup>

[^199]: University of Wisconsin, Exploring Reflectacles As Anti-Surveillance Glasses and for Adversarial Machine Learning in Computer Vision <http://diglib.uwgb.edu/digital/api/collection/p17003coll4/id/71/download> <sup>[[Archive.org]][973]</sup>

[^200]: Wikipedia, Phishing <https://en.wikipedia.org/wiki/Phishing> <sup>[[Wikiless]][974]</sup> <sup>[[Archive.org]][975]</sup>

[^201]: Wikipedia, Social Engineering <https://en.wikipedia.org/wiki/Social_engineering_(security)> <sup>[[Wikiless]][976]</sup> <sup>[[Archive.org]][977]</sup>

[^202]: BBC, Spy pixels in emails have become endemic <https://www.bbc.com/news/technology-56071437> <sup>[[Archive.org]][978]</sup>

[^203]: Vice, Facebook Helped the FBI Hack a Child Predator <https://www.vice.com/en/article/v7gd9b/facebook-helped-fbi-hack-child-predator-buster-hernandez> <sup>[[Archive.org]][670]</sup>

[^204]: Wikipedia, Exploit <https://en.wikipedia.org/wiki/Exploit_(computer_security)> <sup>[[Wikiless]][979]</sup> <sup>[[Archive.org]][980]</sup>

[^205]: Wikipedia, Freedom Hosting <https://en.wikipedia.org/wiki/Freedom_Hosting> <sup>[[Wikiless]][981]</sup> <sup>[[Archive.org]][982]</sup>

[^206]: Wired, 2013 FBI Admits It Controlled Tor Servers Behind Mass Malware Attack <https://www.wired.com/2013/09/freedom-hosting-fbi/> <sup>[[Archive.org]][983]</sup>

[^207]: Wikipedia, 2020 United States federal government data breach <https://en.wikipedia.org/wiki/2020_United_States_federal_government_data_breach> <sup>[[Wikiless]][984]</sup> <sup>[[Archive.org]][985]</sup>

[^208]: BBC, China social media: WeChat and the Surveillance State <https://www.bbc.com/news/blogs-china-blog-48552907> <sup>[[Archive.org]][986]</sup>

[^209]: The Intercept, Revealed: Massive Chinese Police Database <https://theintercept.com/2021/01/29/china-uyghur-muslim-surveillance-police/> <sup>[[Tor Mirror]][987]</sup> <sup>[[Archive.org]][988]</sup>

[^210]: Wikipedia, Sandbox <https://en.wikipedia.org/wiki/Sandbox_(computer_security)> <sup>[[Wikiless]][989]</sup> <sup>[[Archive.org]][990]</sup>

[^211]: Wired, Why the Security of USB Is Fundamentally Broken <https://www.wired.com/2014/07/usb-security/> <sup>[[Archive.org]][991]</sup>

[^212]: Wikipedia, Stuxnet <https://en.wikipedia.org/wiki/Stuxnet> <sup>[[Wikiless]][992]</sup> <sup>[[Archive.org]][993]</sup>

[^213]: Superuser.com, How do I safely investigate a USB stick found in the parking lot at work? <https://superuser.com/questions/1206321/how-do-i-safely-investigate-a-usb-stick-found-in-the-parking-lot-at-work> <sup>[[Archive.org]][994]</sup>

[^214]: The Guardian, Glenn Greenwald: how the NSA tampers with US-made internet routers <https://www.theguardian.com/books/2014/may/12/glenn-greenwald-nsa-tampers-us-internet-routers-snowden> <sup>[[Archive.org]][995]</sup>

[^215]: Wikipedia, Rootkit <https://en.wikipedia.org/wiki/Rootkit> <sup>[[Wikiless]][996]</sup> <sup>[[Archive.org]][997]</sup>

[^216]: Wikipedia, Userspace <https://en.wikipedia.org/wiki/User_space> <sup>[[Wikiless]][998]</sup> <sup>[[Archive.org]][999]</sup>

[^217]: Wikipedia, Firmware <https://en.wikipedia.org/wiki/Firmware> <sup>[[Wikiless]][1000]</sup> <sup>[[Archive.org]][1001]</sup>

[^218]: Wikipedia, BIOS <https://en.wikipedia.org/wiki/BIOS> <sup>[[Wikiless]][1002]</sup> <sup>[[Archive.org]][1003]</sup>

[^219]: Wikipedia, UEFI <https://en.wikipedia.org/wiki/Unified_Extensible_Firmware_Interface> <sup>[[Wikiless]][1004]</sup> <sup>[[Archive.org]][1005]</sup>

[^220]: Bellingcat, Joseph Mifsud: Rush for the EXIF <https://www.bellingcat.com/news/americas/2018/10/26/joseph-mifsud-rush-exif/> <sup>[[Archive.org]][1006]</sup>

[^221]: Zoom Support, Adding a watermark <https://support.zoom.us/hc/en-us/articles/209605273-Adding-a-Watermark> <sup>[[Archive.org]][1007]</sup>

[^222]: Zoom Support, Audio Watermark <https://support.zoom.us/hc/en-us/articles/360021839031-Audio-Watermark> <sup>[[Archive.org]][1008]</sup>

[^223]: CreativeCloud Extension, IMATAG <https://exchange.adobe.com/creativecloud.details.101789.imatag-invisible-watermark-and-image-monitoring.html> <sup>[[Archive.org]][1009]</sup>

[^224]: NexGuard, <https://dtv.nagra.com/nexguard-forensic-watermarking> <sup>[[Archive.org]][1010]</sup>

[^225]: Vobile Solutions, <https://www.vobilegroup.com/> <sup>[[Archive.org]][1011]</sup>

[^226]: Cinavia, <https://www.cinavia.com/languages/english/pages/technology.html> <sup>[[Archive.org]][1012]</sup>

[^227]: Imatag, <https://www.imatag.com/> <sup>[[Archive.org]][1013]</sup>

[^228]: Wikipedia, Steganography <https://en.wikipedia.org/wiki/Steganography> <sup>[[Wikiless]][1014]</sup> <sup>[[Archive.org]][1015]</sup>

[^229]: IEEExplore, A JPEG compression resistant steganography scheme for raster graphics images <https://ieeexplore.ieee.org/document/4428921> <sup>[[Archive.org]][1016]</sup>

[^230]: ScienceDirect, Robust audio watermarking using perceptual masking <https://www.sciencedirect.com/science/article/abs/pii/S0165168498000140> <sup>[[Archive.org]][1017]</sup>

[^231]: IEEExplore, Spread-spectrum watermarking of audio signals <https://ieeexplore.ieee.org/abstract/document/1188746> <sup>[[Archive.org]][1018]</sup>

[^232]: Google Scholar, source camera identification <https://scholar.google.com/scholar?q=source+camera+identification> <sup>[[Archive.org]][1019]</sup>

[^233]: Wikipedia, Printing Steganography <https://en.wikipedia.org/wiki/Machine_Identification_Code> <sup>[[Wikiless]][1020]</sup> <sup>[[Archive.org]][1021]</sup>

[^234]: MIT, SeeingYellow, <http://seeingyellow.com/> <sup>[[Archive.org]][1022]</sup>

[^235]: arXiv, An Analysis of Anonymity in the Bitcoin System <https://arxiv.org/abs/1107.4524> <sup>[[Archive.org]][1023]</sup>

[^236]: Bellingcat, How To Track Illegal Funding Campaigns Via Cryptocurrency, <https://www.bellingcat.com/resources/how-tos/2019/03/26/how-to-track-illegal-funding-campaigns-via-cryptocurrency/> <sup>[[Archive.org]][1024]</sup>

[^237]: CoinDesk, Leaked Slides Show How Chainalysis Flags Crypto Suspects for Cops <https://www.coindesk.com/business/2021/09/21/leaked-slides-show-how-chainalysis-flags-crypto-suspects-for-cops/> <sup>[[Archive.org]][1025]</sup>

[^238]: Wikipedia, KYC <https://en.wikipedia.org/wiki/Know_your_customer> <sup>[[Wikiless]][1026]</sup> <sup>[[Archive.org]][1027]</sup>

[^239]: arXiv.org, Probing the Mystery of Cryptocurrency Theft: An Investigation into Methods for Taint Analysis <https://arxiv.org/pdf/1906.05754.pdf> <sup>[[Archive.org]][1028]</sup>

[^240]: YouTube, Breaking Monero <https://www.youtube.com/watch?v=WOyC6OB6ezA&list=PLsSYUeVwrHBnAUre2G_LYDsdo-tD0ov-y> <sup>[[Invidious]][1029]</sup>

[^241]: Monero, Monero vs Princeton Researchers, <https://monero.org/monero-vs-princeton-researchers/> <sup>[[Archive.org]][1030]</sup>

[^242]: Wikipedia, Cryptocurrency Tumbler <https://en.wikipedia.org/wiki/Cryptocurrency_tumbler> <sup>[[Wikiless]][1031]</sup> <sup>[[Archive.org]][1032]</sup>

[^243]: Wikipedia, Security Through Obscurity <https://en.wikipedia.org/wiki/Security_through_obscurity> <sup>[[Wikiless]][1033]</sup> <sup>[[Archive.org]][1034]</sup>

[^244]: ArXiv, Tracking Mixed Bitcoins, <https://arxiv.org/abs/2009.14007> <sup>[[Archive.org]][1035]</sup>

[^245]: SSRN, The Cryptocurrency Tumblers: Risks, Legality and Oversight <https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3080361> <sup>[[Archive.org]][1036]</sup>

[^246]: Magnet Forensics, Magnet AXIOM <https://www.magnetforensics.com/products/magnet-axiom/cloud/> <sup>[[Archive.org]][1037]</sup>

[^247]: Cellebrite, Unlock cloud-based evidence to solve the case sooner <https://www.cellebrite.com/en/ufed-cloud/> <sup>[[Archive.org]][1038]</sup>

[^248]: Chromium Documentation, Technical analysis of client identification mechanisms <https://sites.google.com/a/chromium.org/dev/Home/chromium-security/client-identification-mechanisms#TOC-Machine-specific-characteristics> <sup>[[Archive.org]][1039]</sup>

[^249]: Mozilla Wiki, Fingerprinting <https://wiki.mozilla.org/Fingerprinting> <sup>[[Archive.org]][1040]</sup>

[^250]: Grayshirt, <https://www.grayshift.com/> <sup>[[Archive.org]][1041]</sup>

[^251]: Securephones.io, Data Security on Mobile Devices: Current State of the Art, Open Problems, and Proposed Solutions <https://securephones.io/main.pdf> <sup>[[Archive.org]][1042]</sup>

[^252]: Loup-Vaillant.fr, Rolling Your Own Crypto <https://loup-vaillant.fr/articles/rolling-your-own-crypto> <sup>[[Archive.org]][1043]</sup>

[^253]: Dhole Moments, Crackpot Cryptography and Security Theater <https://soatok.blog/2021/02/09/crackpot-cryptography-and-security-theater/> <sup>[[Archive.org]][1044]</sup>

[^254]: Vice.com, Why You Don't Roll Your Own Crypto <https://www.vice.com/en/article/wnx8nq/why-you-dont-roll-your-own-crypto> <sup>[[Archive.org]][1045]</sup>

[^255]: arXiv, MIT, You Really Shouldn't Roll Your Own Crypto: An Empirical Study of Vulnerabilities in Cryptographic Libraries <https://arxiv.org/pdf/2107.04940.pdf> <sup>[[Archive.org]][1046]</sup>

[^256]: YouTube, Great Crypto Failures <https://www.youtube.com/watch?v=loy84K3AJ5Q> <sup>[[Invidious]][1047]</sup>

[^257]: Cryptography Dispatches, The Most Backdoor-Looking Bug I've Ever Seen <https://buttondown.email/cryptography-dispatches/archive/cryptography-dispatches-the-most-backdoor-looking/> <sup>[[Archive.org]][164]</sup>

[^258]: Citizenlab.ca, Move Fast and Roll Your Own Crypto <https://citizenlab.ca/2020/04/move-fast-roll-your-own-crypto-a-quick-look-at-the-confidentiality-of-zoom-meetings/> <sup>[[Archive.org]][1048]</sup>

[^259]: Jack Poon, The myth of military grade encryption <https://medium.com/@atcipher/the-myth-of-military-grade-encryption-292313ae6369> <sup>[[Archive.org]][1049]</sup>

[^260]: Congruent Labs, Stop calling it "Military-Grade Encryption" <https://blog.congruentlabs.co/military-grade-encryption/> <sup>[[Archive.org]][1050]</sup>

[^261]: IronCoreLabs Blog, "Military Grade Encryption" <https://blog.ironcorelabs.com/military-grade-encryption-69aae0145588> <sup>[[Archive.org]][1051]</sup>

[^262]: Wikipedia, BLAKE2, <https://en.wikipedia.org/wiki/BLAKE_(hash_function)#BLAKE2> <sup>[[Wikiless]][1052]</sup> <sup>[[Archive.org]][1053]</sup>

[^263]: Wikipedia, AES Instruction Set, <https://en.wikipedia.org/wiki/AES_instruction_set> <sup>[[Wikiless]][1054]</sup> <sup>[[Archive.org]][1055]</sup>

[^264]: Wikipedia, ChaCha Variants, <https://en.wikipedia.org/wiki/Salsa20#ChaCha_variant> <sup>[[Wikiless]][1056]</sup> <sup>[[Archive.org]][1057]</sup>

[^265]: Wikipedia, Serpent, <https://en.wikipedia.org/wiki/Serpent_(cipher)> <sup>[[Wikiless]][1058]</sup> <sup>[[Archive.org]][1059]</sup>

[^266]: Wikipedia, TwoFish, <https://en.wikipedia.org/wiki/Twofish> <sup>[[Wikiless]][1060]</sup> <sup>[[Archive.org]][1061]</sup>

[^267]: Lacatora, The PGP Problem <https://latacora.singles/2019/07/16/the-pgp-problem.html> <sup>[[Archive.org]][1062]</sup>

[^268]: Wikipedia, Shor's Algorithm, <https://en.wikipedia.org/wiki/Shor%27s_algorithm> <sup>[[Wikiless]][1063]</sup> <sup>[[Archive.org]][1064]</sup>

[^269]: Wikipedia, Gag Order, <https://en.wikipedia.org/wiki/Gag_order> <sup>[[Wikiless]][1065]</sup> <sup>[[Archive.org]][1066]</sup>

[^270]: Wikipedia, National Security Letter <https://en.wikipedia.org/wiki/National_security_letter> <sup>[[Wikiless]][1067]</sup> <sup>[[Archive.org]][1068]</sup>

[^271]: TechCrunch, ProtonMail logged IP address of French activist after order by Swiss authorities <https://techcrunch.com/2021/09/06/protonmail-logged-ip-address-of-french-activist-after-order-by-swiss-authorities/> <sup>[[Archive.org]][1069]</sup>

[^272]: ArsTechnica, VPN servers seized by Ukrainian authorities weren't encrypted <https://arstechnica.com/gadgets/2021/07/vpn-servers-seized-by-ukrainian-authorities-werent-encrypted/> <sup>[[Archive.org]][1070]</sup>

[^273]: BleepingComputer, DoubleVPN servers, logs, and account info seized by law enforcement <https://www.bleepingcomputer.com/news/security/doublevpn-servers-logs-and-account-info-seized-by-law-enforcement/> <sup>[[Archive.org]][1071]</sup>

[^274]: CyberScoop, Court rules encrypted email provider Tutanota must monitor messages in blackmail case <https://www.cyberscoop.com/court-rules-encrypted-email-tutanota-monitor-messages/> <sup>[[Archive.org]][1072]</sup>

[^275]: Heise Online (German), <https://www.heise.de/news/Gericht-zwingt-Mailprovider-Tutanota-zu-Ueberwachungsfunktion-4972460.html> <sup>[[Archive.org]][1073]</sup>

[^276]: PCMag, Did PureVPN Cross a Line When It Disclosed User Information? <https://www.pcmag.com/opinions/did-purevpn-cross-a-line-when-it-disclosed-user-information> <sup>[[Archive.org]][1074]</sup>

[^277]: Internet Archive, Wipeyourdata, "No logs" EarthVPN user arrested after police finds logs <https://archive.is/XNuVw#selection-230.0-230.1> <sup>[[Archive.org]][1075]</sup>

[^278]: Wikipedia, Lavabit Suspension and Gag order, <https://en.wikipedia.org/wiki/Lavabit#Suspension_and_gag_order> <sup>[[Wikiless]][1076]</sup> <sup>[[Archive.org]][1077]</sup>

[^279]: Internet Archive, Invisibler, What Everybody Ought to Know About HideMyAss <https://archive.is/ag9w4#selection-136.0-136.1>

[^280]: Wikipedia, Warrant Canary <https://en.wikipedia.org/wiki/Warrant_canary> <sup>[[Wikiless]][1078]</sup> <sup>[[Archive.org]][1079]</sup>

[^281]: Washington Post, The intelligence coup of the century <https://www.washingtonpost.com/graphics/2020/world/national-security/cia-crypto-encryption-machines-espionage/> <sup>[[Archive.org]][1080]</sup>

[^282]: Swissinfo.ch, Second Swiss firm allegedly sold encrypted spying devices <https://www.swissinfo.ch/eng/second-swiss-firm-allegedly-sold-encrypted-spying-devices/46186432> <sup>[[Archive.org]][1081]</sup>

[^283]: Wikipedia, Das Leben der Anderen <https://en.wikipedia.org/wiki/The_Lives_of_Others> <sup>[[Wikiless]][1082]</sup> <sup>[[Archive.org]][1083]</sup>

[^284]: Wired, Mind the Gap: This Researcher Steals Data With Noise, Light, and Magnets <https://www.wired.com/story/air-gap-researcher-mordechai-guri/> <sup>[[Archive.org]][1084]</sup>

[^285]: Scientific American, A Blank Wall Can Show How Many People Are in a Room and What They're Doing <https://www.scientificamerican.com/article/a-blank-wall-can-show-how-many-people-are-in-a-room-and-what-theyre-doing/> <sup>[[Archive.org]][1085]</sup>

[^286]: Scientific American, A Shiny Snack Bag's Reflections Can Reconstruct the Room around It <https://www.scientificamerican.com/article/a-shiny-snack-bags-reflections-can-reconstruct-the-room-around-it/> <sup>[[Archive.org]][1086]</sup>

[^287]: Scientific American, Footstep Sensors Identify People by Gait <https://www.scientificamerican.com/article/footstep-sensors-identify-people-by-gait/> <sup>[[Archive.org]][1087]</sup>

[^288]: Ben Nassi, Lamphone, <https://www.nassiben.com/lamphone> <sup>[[Archive.org]][1088]</sup>

[^289]: The Guardian, Laser spying: is it really practical? <https://www.theguardian.com/world/2013/aug/22/gchq-warned-laser-spying-guardian-offices> <sup>[[Archive.org]][1089]</sup>

[^290]: ArsTechnica, Photos of an NSA "upgrade" factory show Cisco router getting implant <https://arstechnica.com/tech-policy/2014/05/photos-of-an-nsa-upgrade-factory-show-cisco-router-getting-implant/> <sup>[[Archive.org]][1090]</sup>

[^291]: Wikipedia, Rubber-hose Cryptanalysis https://en.wikipedia.org/wiki/Rubber-hose_cryptanalysis

[^292]: Defuse.ca, TrueCrypt's Plausible Deniability is Theoretically Useless <https://defuse.ca/truecrypt-plausible-deniability-useless-by-game-theory.htm> <sup>[[Archive.org]][244]</sup>

[^293]: Wikipedia, OONI, <https://en.wikipedia.org/wiki/OONI> <sup>[[Wikiless]][1091]</sup> <sup>[[Archive.org]][1092]</sup>

[^294]: Privacy International, Timeline of SIM Card Registration Laws <https://privacyinternational.org/long-read/3018/timeline-sim-card-registration-laws> <sup>[[Archive.org]][1093]</sup>

[^295]: NYTimes, Lost Passwords Lock Millionaires Out of Their Bitcoin Fortunes <https://www.nytimes.com/2021/01/12/technology/bitcoin-passwords-wallets-fortunes.html> <sup>[[Archive.org]][1094]</sup>

[^296]: Usenix.org, Shedding too much Light on a Microcontroller's Firmware Protection <https://www.usenix.org/system/files/conference/woot17/woot17-paper-obermaier.pdf> <sup>[[Archive.org]][1095]</sup>

[^297]: TorProject.org, Can I run Tor Browser on an iOS device? <https://support.torproject.org/tormobile/tormobile-3/> <sup>[[Archive.org]][1096]</sup>

[^298]: Wikipedia, Tails, <https://en.wikipedia.org/wiki/Tails_(operating_system)> <sup>[[Wikiless]][1097]</sup> <sup>[[Archive.org]][1098]</sup>

[^299]: Vice.com, Facebook Helped the FBI Hack a Child Predator <https://www.vice.com/en/article/v7gd9b/facebook-helped-fbi-hack-child-predator-buster-hernandez> <sup>[[Archive.org]][670]</sup>

[^300]: Veracrypt Documentation, Trim Operations <https://www.veracrypt.fr/en/Trim%20Operation.html> <sup>[[Archive.org]][1099]</sup>

[^301]: Coreboot, <https://www.coreboot.org/> <sup>[[Archive.org]][1100]</sup>

[^302]: YouTube, 36C3 - Uncover, Understand, Own - Regaining Control Over Your AMD CPU <https://www.youtube.com/watch?v=bKH5nGLgi08&t=2834s> <sup>[[Invidious]][74]</sup>

[^303]: Qubes OS, Anti-Evil Maid, <https://github.com/QubesOS/qubes-antievilmaid> <sup>[[Archive.org]][270]</sup>

[^304]: QubesOS FAQ, <https://www.qubes-os.org/faq/#is-secure-boot-supported> <sup>[[Archive.org]][368]</sup>

[^305]: Wikipedia, Secure Boot, <https://en.wikipedia.org/wiki/Unified_Extensible_Firmware_Interface#Secure_boot> <sup>[[Wikiless]][1004]</sup> <sup>[[Archive.org]][1005]</sup>

[^306]: Wikipedia, Booting <https://en.wikipedia.org/wiki/Booting> <sup>[[Wikiless]][1101]</sup> <sup>[[Archive.org]][1102]</sup>

[^307]: Wired <https://www.wired.com/2013/12/better-data-security-nail-polish/> <sup>[[Archive.org]][1103]</sup>

[^308]: Wikipedia, Virtual Machine <https://en.wikipedia.org/wiki/Virtual_machine> <sup>[[Wikiless]][1104]</sup> <sup>[[Archive.org]][1105]</sup>

[^309]: Wikipedia, Plausible Deniability <https://en.wikipedia.org/wiki/Plausible_deniability> <sup>[[Wikiless]][1106]</sup> <sup>[[Archive.org]][1107]</sup>

[^310]: Wikipedia, Deniable Encryption <https://en.wikipedia.org/wiki/Deniable_encryption> <sup>[[Wikiless]][1108]</sup> <sup>[[Archive.org]][1109]</sup>

[^311]: PrivacyGuides.org, Don't use Windows 10 - It's a privacy nightmare <https://privacyguides.org/operating-systems/#win10> <sup>[[Archive.org]][1110]</sup>

[^312]: Wikipedia, Deniable Encryption <https://en.wikipedia.org/wiki/Deniable_encryption> <sup>[[Wikiless]][1108]</sup> <sup>[[Archive.org]][1109]</sup>

[^313]: Wikipedia, Key Disclosure Laws <https://en.wikipedia.org/wiki/Key_disclosure_law> <sup>[[Wikiless]][550]</sup> <sup>[[Archive.org]][551]</sup>

[^314]: GP Digital, World map of encryption laws and policies <https://www.gp-digital.org/world-map-of-encryption/> <sup>[[Archive.org]][552]</sup>

[^315]: Wikipedia, Bitlocker <https://en.wikipedia.org/wiki/BitLocker> <sup>[[Wikiless]][1111]</sup> <sup>[[Archive.org]][1112]</sup>

[^316]: Wikipedia, Evil Maid Attack <https://en.wikipedia.org/wiki/Evil_maid_attack> <sup>[[Wikiless]][1113]</sup> <sup>[[Archive.org]][1114]</sup>

[^317]: Wikipedia, Cold Boot Attack <https://en.wikipedia.org/wiki/Cold_boot_attack> <sup>[[Wikiless]][1115]</sup> <sup>[[Archive.org]][1116]</sup>

[^318]: CITP 2008 (<https://www.youtube.com/watch?v=JDaicPIgn9U>) <sup>[[Invidious]][1117]</sup>

[^319]: ResearchGate, Defeating Plausible Deniability of VeraCrypt Hidden Operating Systems <https://www.researchgate.net/publication/318155607_Defeating_Plausible_Deniability_of_VeraCrypt_Hidden_Operating_Systems> <sup>[[Archive.org]][1118]</sup>

[^320]: SANS.org, Mission Implausible: Defeating Plausible Deniability with Digital Forensics <https://www.sans.org/reading-room/whitepapers/forensics/mission-implausible-defeating-plausible-deniability-digital-forensics-39500> <sup>[[Archive.org]][1119]</sup>

[^321]: SourceForge, Veracrypt Forum <https://sourceforge.net/p/veracrypt/discussion/technical/thread/53f33faf/> <sup>[[Archive.org]][1120]</sup>

[^322]: Microsoft, BitLocker Countermeasures <https://docs.microsoft.com/en-us/windows/security/information-protection/bitlocker/bitlocker-countermeasures> <sup>[[Archive.org]][1121]</sup>

[^323]: SANS, Windows ShellBag Forensics in-depth <https://www.sans.org/reading-room/whitepapers/forensics/windows-shellbag-forensics-in-depth-34545> <sup>[[Archive.org]][1122]</sup>

[^324]: University of York, Forensic data recovery from the Windows Search Database <https://eprints.whiterose.ac.uk/75046/1/Forensic_Data_Recovery_From_The_Windows_Search_Database_preprint_DIIN328.pdf> <sup>[[Archive.org]][1123]</sup>

[^325]: A forensic insight into Windows 10 Jump Lists <https://cyberforensicator.com/wp-content/uploads/2017/01/1-s2.0-S1742287616300202-main.2-14.pdf> <sup>[[Archive.org]][1124]</sup>

[^326]: Wikipedia, Gatekeeper <https://en.wikipedia.org/wiki/Gatekeeper_(macOS)> <sup>[[Wikiless]][1125]</sup> <sup>[[Archive.org]][1126]</sup>

[^327]: Alpine Linux Wiki, Setting up a laptop <https://wiki.alpinelinux.org/wiki/Setting_up_a_laptop> <sup>[[Archive.org]][1127]</sup>

[^328]: Wikipedia Veracrypt <https://en.wikipedia.org/wiki/VeraCrypt> <sup>[[Wikiless]][1128]</sup> <sup>[[Archive.org]][1129]</sup>

[^329]: OSTIF Veracrypt Audit, 2016, <https://web.archive.org/web/https://ostif.org/the-veracrypt-audit-results/>

[^330]: Veracrypt Documentation, Unencrypted Data in RAM <https://www.veracrypt.fr/en/Unencrypted%20Data%20in%20RAM.html> <sup>[[Archive.org]][1130]</sup>

[^331]: Veracrypt Documentation, Data Leaks <https://www.veracrypt.fr/code/VeraCrypt/plain/doc/html/Data%20Leaks.html> <sup>[[Archive.org]][1131]</sup>

[^332]: Dolos Group, From Stolen Laptop to Inside the Company Network <https://dolosgroup.io/blog/2021/7/9/from-stolen-laptop-to-inside-the-company-network> <sup>[[Archive.org]][1132]</sup>

[^333]: Trammell Hudson's Projects, Understanding TPM Sniffing Attacks <https://trmm.net/tpm-sniffing/> <sup>[[Archive.org]][1133]</sup>

[^334]: Jon Aubrey, attacking laptops that are protected by Microsoft Bitlocker drive encryption <https://twitter.com/SecurityJon/status/1445020885472235524> <sup>[[Nitter]][1134]</sup>

[^335]: F-Secure Labs, Sniff, there leaks my BitLocker key <https://labs.f-secure.com/blog/sniff-there-leaks-my-bitlocker-key/> <sup>[[Archive.org]][1135]</sup>

[^336]: Microsoft, BitLocker Countermeasures, Attacker countermeasures <https://docs.microsoft.com/en-us/windows/security/information-protection/bitlocker/bitlocker-countermeasures> <sup>[[Archive.org]][1121]</sup>

[^337]: Wikipedia, Trim <https://en.wikipedia.org/wiki/Trim_(computing)> <sup>[[Wikiless]][482]</sup> <sup>[[Archive.org]][483]</sup>

[^338]: Veracrypt Documentation, Trim Operations <https://www.veracrypt.fr/en/Trim%20Operation.html> <sup>[[Archive.org]][1099]</sup>

[^339]: Veracrypt Documentation, Rescue Disk <https://www.veracrypt.fr/en/VeraCrypt%20Rescue%20Disk.html> <sup>[[Archive.org]][1136]</sup>

[^340]: St Cloud State University, Forensic Research on Solid State Drives using Trim Analysis <https://repository.stcloudstate.edu/cgi/viewcontent.cgi?article=1141&context=msia_etds> <sup>[[Archive.org]][1137]</sup>

[^341]: WindowsCentral, Trim Tutorial <https://www.windowscentral.com/how-ensure-trim-enabled-windows-10-speed-ssd-performance> <sup>[[Archive.org]][1138]</sup>

[^342]: Veracrypt Documentation, Trim Operation <https://veracrypt.eu/en/docs/trim-operation/> <sup>[[Archive.org]][1139]</sup>

[^343]: Black Hat 2018, Perfectly Deniable Steganographic Disk Encryption <https://i.blackhat.com/eu-18/Thu-Dec-6/eu-18-Schaub-Perfectly-Deniable-Steganographic-Disk-Encryption.pdf> <sup>[[Archive.org]][1140]</sup>

[^344]: Milan Broz's Blog, TRIM & dm-crypt ... problems? <http://asalor.blogspot.com/2011/08/trim-dm-crypt-problems.html> <sup>[[Archive.org]][1141]</sup>

[^345]: Veracrypt Documentation, Rescue Disk <https://www.veracrypt.fr/en/VeraCrypt%20Rescue%20Disk.html> <sup>[[Archive.org]][1136]</sup>

[^346]: Wikipedia, Virtualbox <https://en.wikipedia.org/wiki/VirtualBox> <sup>[[Wikiless]][1142]</sup> <sup>[[Archive.org]][1143]</sup>

[^347]: VirtualBox Ticket 17987 <https://www.virtualbox.org/ticket/17987> <sup>[[Archive.org]][1144]</sup>

[^348]: Whonix Documentation, Spectre Meltdown, <https://www.whonix.org/wiki/Spectre_Meltdown#VirtualBox> <sup>[[Archive.org]][79]</sup>

[^349]: Whonix Documentation, Stream Isolation <https://www.whonix.org/wiki/Stream_Isolation> <sup>[[Archive.org]][317]</sup>

[^350]: Whonix Documentation, Tunnels Comparison Table, <https://www.whonix.org/wiki/Tunnels/Introduction#Comparison_Table> <sup>[[Archive.org]][319]</sup>

[^351]: Wikipedia, Whonix <https://en.wikipedia.org/wiki/Whonix> <sup>[[Wikiless]][1145]</sup> <sup>[[Archive.org]][1146]</sup>

[^352]: Oracle Virtualbox Manual, Snapshots <https://docs.oracle.com/en/virtualization/virtualbox/6.0/user/snapshots.html> <sup>[[Archive.org]][1147]</sup>

[^353]: Utica College, FORENSIC RECOVERY OF EVIDENCE FROM DELETED ORACLE VIRTUALBOX VIRTUAL MACHINES <https://web.archive.org/web/https://programs.online.utica.edu/sites/default/files/Neal_6_Gonnella_Forensic_Recovery_of_Evidence_from_Deleted_Oracle_VirtualBox_Virtual_Machine.pdf>

[^354]: Wikipedia, Spectre <https://en.wikipedia.org/wiki/Spectre_(security_vulnerability)> <sup>[[Wikiless]][1148]</sup> <sup>[[Archive.org]][1149]</sup>

[^355]: Wikipedia, Meltdown <https://en.wikipedia.org/wiki/Meltdown_(security_vulnerability)> <sup>[[Wikiless]][1150]</sup> <sup>[[Archive.org]][1151]</sup>

[^356]: Whonix Documentation, Stream Isolation, By Settings <https://www.whonix.org/wiki/Stream_Isolation#By_Settings> <sup>[[Archive.org]][1152]</sup>

[^357]: Wikipedia, TOTP <https://en.wikipedia.org/wiki/Time-based_One-time_Password_algorithm> <sup>[[Wikiless]][1153]</sup> <sup>[[Archive.org]][1154]</sup>

[^358]: Wikipedia, Multi-Factor Authentication <https://en.wikipedia.org/wiki/Multi-factor_authentication> <sup>[[Wikiless]][1155]</sup> <sup>[[Archive.org]][1156]</sup>

[^359]: Whonix Documentation, Bridged Adapters Warning <https://www.whonix.org/wiki/Whonix-Gateway_Security#Warning:_Bridged_Networking> <sup>[[Archive.org]][1157]</sup>

[^360]: Qubes OS, FAQ, <https://www.qubes-os.org/faq/#is-qubes-just-another-linux-distribution> <sup>[[Archive.org]][1158]</sup>

[^361]: Qubes OS, System Requirements <https://www.qubes-os.org/doc/system-requirements/> <sup>[[Archive.org]][1159]</sup>

[^362]: Whonix Documentation, Stream Isolation <https://www.whonix.org/wiki/Stream_Isolation> <sup>[[Archive.org]][317]</sup>

[^363]: Whonix Documentation, Tunnels Comparison Table, <https://www.whonix.org/wiki/Tunnels/Introduction#Comparison_Table> <sup>[[Archive.org]][319]</sup>

[^364]: Qubes OS Issues, Simulate Hibernation / Suspend-To-Disk #2414 <https://github.com/QubesOS/qubes-issues/issues/2414> <sup>[[Archive.org]][1160]</sup>

[^365]: Wikipedia, AppArmor <https://en.wikipedia.org/wiki/AppArmor> <sup>[[Wikiless]][1161]</sup> <sup>[[Archive.org]][1162]</sup>

[^366]: Wikipedia, SELinux <https://en.wikipedia.org/wiki/Security-Enhanced_Linux> <sup>[[Wikiless]][1163]</sup> <sup>[[Archive.org]][1164]</sup>

[^367]: Wikipedia, TOTP <https://en.wikipedia.org/wiki/Time-based_One-time_Password_algorithm> <sup>[[Wikiless]][1153]</sup> <sup>[[Archive.org]][1154]</sup>

[^368]: Wikipedia, Multi-Factor Authentication <https://en.wikipedia.org/wiki/Multi-factor_authentication> <sup>[[Wikiless]][1155]</sup> <sup>[[Archive.org]][1156]</sup>

[^369]: Wikipedia, Captcha <https://en.wikipedia.org/wiki/CAPTCHA> <sup>[[Wikiless]][1165]</sup> <sup>[[Archive.org]][1166]</sup>

[^370]: Wikipedia, Turing Test <https://en.wikipedia.org/wiki/Turing_test> <sup>[[Wikiless]][1167]</sup> <sup>[[Archive.org]][1168]</sup>

[^371]: Google reCAPTCHA <https://www.google.com/recaptcha/about/> <sup>[[Archive.org]][1169]</sup>

[^372]: hCaptcha <https://www.hcaptcha.com/> <sup>[[Archive.org]][1170]</sup>

[^373]: hCaptcha, hCaptcha Is Now the Largest Independent CAPTCHA Service, Runs on 15% Of The Internet <https://www.hcaptcha.com/post/hcaptcha-now-the-largest-independent-captcha-service> <sup>[[Archive.org]][1171]</sup>

[^374]: Nearcyan.com, You (probably) don't need ReCAPTCHA <https://nearcyan.com/you-probably-dont-need-recaptcha/> <sup>[[Archive.org]][1172]</sup>

[^375]: ArsTechnica, "Google's reCAPTCHA turns "invisible," will separate bots from people without challenges" <https://arstechnica.com/gadgets/2017/03/googles-recaptcha-announces-invisible-background-captchas/> <sup>[[Archive.org]][1173]</sup>

[^376]: BlackHat Asia 2016, "I'm not a human: Breaking the Google reCAPTCHA", <https://www.blackhat.com/docs/asia-16/materials/asia-16-Sivakorn-Im-Not-a-Human-Breaking-the-Google-reCAPTCHA-wp.pdf> <sup>[[Archive.org]][1174]</sup>

[^377]: Google Blog <https://security.googleblog.com/2014/12/are-you-robot-introducing-no-captcha.html> <sup>[[Archive.org]][1175]</sup>

[^378]: Cloudflare Blog, Cloudflare supports Privacy Pass <https://blog.cloudflare.com/cloudflare-supports-privacy-pass/> <sup>[[Archive.org]][1176]</sup>

[^379]: Privacy International, Timeline of SIM Card Registration Laws <https://privacyinternational.org/long-read/3018/timeline-sim-card-registration-laws> <sup>[[Archive.org]][1093]</sup>

[^380]: Wikipedia, Device Fingerprinting <https://en.wikipedia.org/wiki/Device_fingerprint> <sup>[[Wikiless]][1177]</sup> <sup>[[Archive.org]][1178]</sup>

[^381]: Developers Google Blog,

    Guidance to developers affected by our effort to block less secure browsers and applications <https://developers.googleblog.com/2020/08/guidance-for-our-effort-to-block-less-secure-browser-and-apps.html> <sup>[[Archive.org]][1179]</sup>

[^382]: Google Help, Access age-restricted content & features <https://support.google.com/accounts/answer/10071085> <sup>[[Archive.org]][1180]</sup>

[^383]: Wikipedia, Dark Pattern <https://en.wikipedia.org/wiki/Dark_pattern> <sup>[[Wikiless]][1181]</sup> <sup>[[Archive.org]][1182]</sup>

[^384]: The Verge, Tinder will give you a verified blue check mark if you pass its catfishing test <https://www.theverge.com/2020/1/23/21077423/tinder-photo-verification-blue-checkmark-safety-center-launch-noonlight> <sup>[[Archive.org]][1183]</sup>

[^385]: DigitalInformationWorld, Facebook will now require you to Create a Video Selfie for Identity Verification <https://www.digitalinformationworld.com/2020/03/facebook-is-now-demanding-some-users-to-create-a-video-selfie-for-identity-verification.html> <sup>[[Archive.org]][1184]</sup>

[^386]: Vice.com, PornHub Announces 'Biometric Technology' to Verify Users <https://www.vice.com/en/article/m7a4eq/pornhub-new-verification-policy-biometric-id> <sup>[[Archive.org]][1185]</sup>

[^387]: Variety, China Launches Hotline to Report Online Comments That 'Distort' History or 'Deny' Its Cultural Excellence <https://variety.com/2021/digital/news/china-censorship-hotline-historical-nihilism-1234950554/> <sup>[[Archive.org]][1186]</sup>

[^388]: Wikipedia, Trust but verify <https://en.wikipedia.org/wiki/Trust,_but_verify> <sup>[[Wikiless]][770]</sup> <sup>[[Archive.org]][771]</sup>

[^389]: Wikipedia, Zero-trust Security Model <https://en.wikipedia.org/wiki/Zero_trust_security_model> <sup>[[Wikiless]][1187]</sup> <sup>[[Archive.org]][1188]</sup>

[^390]: Wikipedia, Espionage, Organization <https://en.wikipedia.org/wiki/Espionage#Organization> <sup>[[Wikiless]][1189]</sup> <sup>[[Archive.org]][1190]</sup>

[^391]: Medium.com, Kyle McDonald, How to recognize fake AI-generated images <https://kcimc.medium.com/how-to-recognize-fake-ai-generated-images-4d1f6f9a2842> <sup>[[Archive.org]][1191]</sup>

[^392]: Jayway Blog, Using ML to detect fake face images created by AI <https://blog.jayway.com/2020/03/06/using-ml-to-detect-fake-face-images-created-by-ai/> <sup>[[Archive.org]][1192]</sup>

[^393]: Wikipedia, Sim Swapping <https://en.wikipedia.org/wiki/SIM_swap_scam> <sup>[[Wikiless]][1193]</sup> <sup>[[Archive.org]][1194]</sup>

[^394]: Whonix Documentation, <https://www.whonix.org/wiki/Tor#Edit_Tor_Configuration> <sup>[[Archive.org]][1195]</sup>

[^395]: Tor Browser Documentation, <https://support.torproject.org/tbb/tbb-editing-torrc/> <sup>[[Archive.org]][1196]</sup>

[^396]: Facebook Onion Website <http://facebookwkhpilnemxj7asaniu7vnjjbiltxjqhye3mhbshg7kx5tfyd.onion/>

[^397]: Google Help <https://support.google.com/accounts/answer/114129?hl=en> <sup>[[Archive.org]][1197]</sup>

[^398]: Google Help <https://support.google.com/google-ads/answer/7474263?hl=en> <sup>[[Archive.org]][1198]</sup>

[^399]: Google, Your account is disabled <https://support.google.com/accounts/answer/40695> <sup>[[Archive.org]][1199]</sup>

[^400]: Google, Request to restore the account <https://support.google.com/accounts/contact/disabled2> <sup>[[Archive.org]][1200]</sup>

[^401]: Google Help, Update your account to meet age requirements <https://support.google.com/accounts/answer/1333913?hl=en> <sup>[[Archive.org]][1201]</sup>

[^402]: Jumio, ID verification features <https://www.jumio.com/features/> <sup>[[Archive.org]][1202]</sup>

[^403]: Privacyguides.org recommended E-mail Providers <https://privacyguides.org/providers/email/> <sup>[[Archive.org]][1203]</sup>

[^404]: ProtonMail Human Verification System [https://ProtonMail.com/support/knowledge-base/human-verification/][] <sup>[[Archive.org]][1204]</sup>

[^405]: Twitter Appeal Form <https://help.twitter.com/forms/general>

[^406]: KnowYourMeme, Good Luck, I'm Behind 7 Proxies <https://knowyourmeme.com/memes/good-luck-im-behind-7-proxies> <sup>[[Archive.org]][1205]</sup>

[^407]: Wikipedia, end-to-end encryption, <https://en.wikipedia.org/wiki/End-to-end_encryption> <sup>[[Wikiless]][1206]</sup> <sup>[[Archive.org]][1207]</sup>

[^408]: Wikipedia, Forward Secrecy, <https://en.wikipedia.org/wiki/Forward_secrecy> <sup>[[Wikiless]][1208]</sup> <sup>[[Archive.org]][1209]</sup>

[^409]: Protonblog, What is zero-access encryption and why it is important for security <https://protonmail.com/blog/zero-access-encryption/> <sup>[[Archive.org]][1210]</sup>

[^410]: Wikipedia, Cambridge Analytica Scandal, <https://en.wikipedia.org/wiki/Facebook%E2%80%93Cambridge_Analytica_data_scandal> <sup>[[Wikiless]][1211]</sup> <sup>[[Archive.org]][1212]</sup>

[^411]: Signal Blog, Technology preview: Sealed sender for Signal <https://signal.org/blog/sealed-sender/> <sup>[[Archive.org]][1213]</sup>

[^412]: Signal Blog, Private Contact Discovery, <https://signal.org/blog/private-contact-discovery/> <sup>[[Archive.org]][1214]</sup>

[^413]: Signal Blog, Private Group System, <https://signal.org/blog/signal-private-group-system/> <sup>[[Archive.org]][1215]</sup>

[^414]: Privacyguides.org, File-Sharing <https://privacyguides.org/software/file-sharing/> <sup>[[Archive.org]][1216]</sup>

[^415]: Privacyguides.org, Real-Time Communication <https://privacyguides.org/software/real-time-communication/> <sup>[[Archive.org]][1217]</sup>

[^416]: GetSession.org, The Session Protocol: What's changing --- and why <https://getsession.org/session-protocol-explained/> <sup>[[Archive.org]][1218]</sup>

[^417]: Quarkslab, Audit of Session Secure Messaging Application <https://blog.quarkslab.com/audit-of-session-secure-messaging-application.html> <sup>[[Archive.org]][1219]</sup>

[^418]: Techlore, Top 5 BEST Messengers For Privacy <https://www.youtube.com/watch?v=aVwl892hqb4> <sup>[[Invidious]][1220]</sup>

[^419]: Wikipedia, IPFS <https://en.wikipedia.org/wiki/InterPlanetary_File_System> <sup>[[Wikiless]][1221]</sup> <sup>[[Archive.org]][1222]</sup>

[^420]: Praxis Films, Open Letter from Laura Poitras <https://www.praxisfilms.org/open-letter-from-laura-poitras/> <sup>[[Archive.org]][1223]</sup>

[^421]: Wikipedia, SecureDrop <https://en.wikipedia.org/wiki/SecureDrop> <sup>[[Wikiless]][1224]</sup> <sup>[[Archive.org]][1225]</sup>

[^422]: Wikipedia, TPM <https://en.wikipedia.org/wiki/Trusted_Platform_Module> <sup>[[Wikiless]][1226]</sup> <sup>[[Archive.org]][1227]</sup>

[^423]: Wikipedia, Pastebin <https://en.wikipedia.org/wiki/Pastebin> <sup>[[Wikiless]][1228]</sup> <sup>[[Archive.org]][1229]</sup>

[^424]: Wikipedia, Wear Leveling <https://en.wikipedia.org/wiki/Wear_leveling> <sup>[[Wikiless]][1230]</sup> <sup>[[Archive.org]][1231]</sup>

[^425]: Wikipedia, Trim <https://en.wikipedia.org/wiki/Write_amplification#TRIM> <sup>[[Wikiless]][1232]</sup> <sup>[[Archive.org]][1233]</sup>

[^426]: Wikipedia, Write Amplification <https://en.wikipedia.org/wiki/Write_amplification> <sup>[[Wikiless]][1232]</sup> <sup>[[Archive.org]][1233]</sup>

[^427]: Wikipedia, Trim Disadvantages <https://en.wikipedia.org/wiki/Trim_(computing)#Disadvantages> <sup>[[Wikiless]][482]</sup> <sup>[[Archive.org]][483]</sup>

[^428]: Wikipedia, Garbage Collection <https://en.wikipedia.org/wiki/Write_amplification#Garbage_collection> <sup>[[Wikiless]][1232]</sup> <sup>[[Archive.org]][1233]</sup>

[^429]: Techgage, Too TRIM? When SSD Data Recovery is Impossible <https://techgage.com/article/too_trim_when_ssd_data_recovery_is_impossible/> <sup>[[Archive.org]][1234]</sup>

[^430]: ResearchGate, Live forensics method for acquisition on the Solid-State Drive (SSD) NVMe TRIM function <https://www.researchgate.net/publication/341761017_Live_forensics_method_for_acquisition_on_the_Solid_State_Drive_SSD_NVMe_TRIM_function> <sup>[[Archive.org]][1235]</sup>

[^431]: ElcomSoft, Life after Trim: Using Factory Access Mode for Imaging SSD Drives <https://blog.elcomsoft.com/2019/01/life-after-trim-using-factory-access-mode-for-imaging-ssd-drives/> <sup>[[Archive.org]][1236]</sup>

[^432]: Forensic Focus, Forensic Acquisition Of Solid State Drives With Open Source Tools <https://www.forensicfocus.com/articles/forensic-acquisition-of-solid-state-drives-with-open-source-tools/> <sup>[[Archive.org]][1237]</sup>

[^433]: ResearchGate, Solid State Drive Forensics: Where Do We Stand? <https://www.researchgate.net/publication/325976653_Solid_State_Drive_Forensics_Where_Do_We_Stand> <sup>[[Archive.org]][1238]</sup>

[^434]: Wikipedia, Parted Magic <https://en.wikipedia.org/wiki/Parted_Magic> <sup>[[Wikiless]][1239]</sup> <sup>[[Archive.org]][1240]</sup>

[^435]: Wikipedia, hdparm <https://en.wikipedia.org/wiki/Hdparm> <sup>[[Wikiless]][1241]</sup> <sup>[[Archive.org]][1242]</sup>

[^436]: GitHub, nvme-cli <https://github.com/linux-nvme/nvme-cli> <sup>[[Archive.org]][1243]</sup>

[^437]: PartedMagic Secure Erase, <https://partedmagic.com/secure-erase/> <sup>[[Archive.org]][1244]</sup>

[^438]: Partedmagic NVMe Secure Erase, <https://partedmagic.com/nvme-secure-erase/> <sup>[[Archive.org]][1245]</sup>

[^439]: UFSExplorer, Can I recover data from an encrypted storage? <https://www.ufsexplorer.com/solutions/data-recovery-on-encrypted-storage.php> <sup>[[Archive.org]][1246]</sup>

[^440]: Apple Developer Documentation, <https://developer.apple.com/library/archive/documentation/FileManagement/Conceptual/APFS_Guide/FAQ/FAQ.html> <sup>[[Archive.org]][1247]</sup>

[^441]: EFF, How to: Delete Your Data Securely on macOS <https://ssd.eff.org/en/module/how-delete-your-data-securely-macos> <sup>[[Archive.org]][505]</sup>

[^442]: Privacyguides.org, Productivity tools <https://privacyguides.org/software/productivity/> <sup>[[Archive.org]][1248]</sup>

[^443]: Whonix Documentation, Scrubbing Metadata <https://www.whonix.org/wiki/Metadata> <sup>[[Archive.org]][1249]</sup>

[^444]: Tails documentation, MAT <https://gitlab.tails.boum.org/tails/blueprints/-/wikis/doc/mat/> <sup>[[Archive.org]][1250]</sup>

[^445]: GitHub, Disable Gatekeeper on macOS Big Sur (11.x) <https://disable-gatekeeper.github.io/> <sup>[[Archive.org]][1251]</sup>

[^446]: DuckDuckGo help, Cache <https://help.duckduckgo.com/duckduckgo-help-pages/features/cache/> <sup>[[Archive.org]][1252]</sup>

[^447]: DuckDuckGo help, Sources <https://help.duckduckgo.com/duckduckgo-help-pages/results/sources/> <sup>[[Archive.org]][1253]</sup>

[^448]: Wikipedia, Dead Drop <https://en.wikipedia.org/wiki/Dead_drop> <sup>[[Wikiless]][1254]</sup> <sup>[[Archive.org]][1255]</sup>

[^449]: Wikipedia, Secure Communication Obfuscation <https://en.wikipedia.org/wiki/Obfuscation#Secure_communication> <sup>[[Wikiless]][1256]</sup> <sup>[[Archive.org]][1257]</sup>

[^450]: Wikipedia, Steganography <https://en.wikipedia.org/wiki/Steganography> <sup>[[Wikiless]][1014]</sup> <sup>[[Archive.org]][1015]</sup>

[^451]: Wikipedia, Kleptography <https://en.wikipedia.org/wiki/Kleptography> <sup>[[Wikiless]][1258]</sup> <sup>[[Archive.org]][1259]</sup>

[^452]: Wikipedia, Koalang <https://en.wikipedia.org/wiki/Koalang> <sup>[[Wikiless]][1260]</sup> <sup>[[Archive.org]][1261]</sup>

[^453]: Wikipedia, OPSEC <https://en.wikipedia.org/wiki/Operations_security> <sup>[[Wikiless]][1262]</sup> <sup>[[Archive.org]][1263]</sup>

[^454]: Quote Investigator, A Lie Can Travel Halfway Around the World While the Truth Is Putting On Its Shoes <https://quoteinvestigator.com/2014/07/13/truth/> <sup>[[Archive.org]][1264]</sup>

[^455]: Privacyguides.org, Operating Systems <https://privacyguides.org/operating-systems/> <sup>[[Archive.org]][1265]</sup>

[^456]: Brave Support, What is a Private Window with Tor? <https://support.brave.com/hc/en-us/articles/360018121491-What-is-a-Private-Window-with-Tor-> <sup>[[Archive.org]][1266]</sup>

[^457]: Medium.com, The Windows USN Journal <https://medium.com/velociraptor-ir/the-windows-usn-journal-f0c55c9010e> <sup>[[Archive.org]][1267]</sup>

[^458]: Medium.com, Digging into the System Resource Usage Monitor (SRUM) <https://medium.com/velociraptor-ir/digging-into-the-system-resource-usage-monitor-srum-afbadb1a375> <sup>[[Archive.org]][1268]</sup>

[^459]: SANS, Timestamped Registry & NTFS Artifacts from Unallocated Space <https://www.sans.org/blog/timestamped-registry-ntfs-artifacts-from-unallocated-space/> <sup>[[Archive.org]][1269]</sup>

[^460]: DBAN, <https://dban.org/> <sup>[[Archive.org]][1270]</sup>

[^461]: NYTimes, Lost Passwords Lock Millionaires Out of Their Bitcoin Fortunes <https://www.nytimes.com/2021/01/12/technology/bitcoin-passwords-wallets-fortunes.html> <sup>[[Archive.org]][1094]</sup>

[^462]: CrystalDiskInfo <https://crystalmark.info/en/software/crystaldiskinfo/> <sup>[[Archive.org]][1271]</sup>

[^463]: Wikipedia, Faraday Cage, <https://en.wikipedia.org/wiki/Faraday_cage> <sup>[[Wikiless]][1272]</sup> <sup>[[Archive.org]][1273]</sup>

[^464]: Edith Cowan University, A forensic examination of several mobile device Faraday bags & materials to test their effectiveness materials to test their effectiveness <https://ro.ecu.edu.au/cgi/viewcontent.cgi?article=1165&context=adf> <sup>[[Archive.org]][1274]</sup>

[^465]: arXiv, Deep-Spying: Spying using Smartwatch and Deep Learning <https://arxiv.org/abs/1512.05616> <sup>[[Archive.org]][1275]</sup>

[^466]: Acm.org, Privacy Implications of Accelerometer Data: A Review of Possible Inferences <https://dl.acm.org/doi/pdf/10.1145/3309074.3309076> <sup>[[Archive.org]][1276]</sup>

[^467]: YouTube, Fingerprinting Paper - Forensic Education <https://www.youtube.com/watch?v=sO98kDLkh-M> <sup>[[Invidious]][1277]</sup>

[^468]: Wikipedia, Touch DNA, <https://en.wikipedia.org/wiki/Touch_DNA> <sup>[[Wikiless]][1278]</sup> <sup>[[Archive.org]][1279]</sup>

[^469]: TheDNAGuide, DNA from Postage Stamps or Hair Samples? Yeeesssss..... <https://www.yourdnaguide.com/ydgblog/dna-hair-samples-postage-stamps> <sup>[[Archive.org]][1280]</sup>

[^470]: GitHub, Mhinkie, OONI-Detection <https://github.com/mhinkie/ooni-detection> <sup>[[Archive.org]][1281]</sup>

[^471]: Wikipedia, File Verification <https://en.wikipedia.org/wiki/File_verification> <sup>[[Wikiless]][1282]</sup> <sup>[[Archive.org]][1283]</sup>

[^472]: Wikipedia, CRC <https://en.wikipedia.org/wiki/Cyclic_redundancy_check> <sup>[[Wikiless]][1284]</sup> <sup>[[Archive.org]][1285]</sup>

[^473]: Wikipedia, MD5 <https://en.wikipedia.org/wiki/MD5> <sup>[[Wikiless]][1286]</sup> <sup>[[Archive.org]][1287]</sup>

[^474]: Wikipedia, MD5 Security <https://en.wikipedia.org/wiki/MD5#Security> <sup>[[Wikiless]][1286]</sup> <sup>[[Archive.org]][1287]</sup>

[^475]: Wikipedia, Collisions <https://en.wikipedia.org/wiki/Collision_(computer_science)> <sup>[[Wikiless]][1288]</sup> <sup>[[Archive.org]][1289]</sup>

[^476]: Wikipedia, SHA <https://en.wikipedia.org/wiki/Secure_Hash_Algorithms> <sup>[[Wikiless]][1290]</sup> <sup>[[Archive.org]][1291]</sup>

[^477]: Wikipedia, SHA-2 <https://en.wikipedia.org/wiki/SHA-2> <sup>[[Wikiless]][1292]</sup> <sup>[[Archive.org]][1293]</sup>

[^478]: Wikipedia, Collision Resistance <https://en.wikipedia.org/wiki/Collision_resistance> <sup>[[Wikiless]][1294]</sup> <sup>[[Archive.org]][1295]</sup>

[^479]: GnuPG Gpg4win Wiki, Check integrity of Gpg4win packages <https://wiki.gnupg.org/Gpg4win/CheckIntegrity> <sup>[[Archive.org]][1296]</sup>

[^480]: Medium.com, How to verify checksum on Mac <https://medium.com/@EvgeniIvanov/how-to-verify-checksum-on-mac-988f166b0c4f> <sup>[[Archive.org]][1297]</sup>

[^481]: Wikipedia, GPG <https://en.wikipedia.org/wiki/GNU_Privacy_Guard> <sup>[[Wikiless]][1298]</sup> <sup>[[Archive.org]][1299]</sup>

[^482]: Wikipedia, Public-Key Cryptography <https://en.wikipedia.org/wiki/Public-key_cryptography> <sup>[[Wikiless]][1300]</sup> <sup>[[Archive.org]][1301]</sup>

[^483]: Wikipedia, Polymorphic Code <https://en.wikipedia.org/wiki/Polymorphic_code> <sup>[[Wikiless]][1302]</sup> <sup>[[Archive.org]][1303]</sup>

[^484]: Whonix Documentation, Use of AV, <https://www.whonix.org/wiki/Malware_and_Firmware_Trojans#The_Utility_of_Antivirus_Tools> <sup>[[Archive.org]][1304]</sup>

[^485]: Whonix Forums, <https://forums.whonix.org/t/installation-of-antivirus-scanners-by-default/9755/8> <sup>[[Archive.org]][1305]</sup>

[^486]: AV-Test Security Report 2018-2019, <https://www.av-test.org/fileadmin/pdf/security_report/AV-TEST_Security_Report_2018-2019.pdf> <sup>[[Archive.org]][1306]</sup>

[^487]: ZDNet, ESET discovers 21 new Linux malware families <https://www.zdnet.com/article/eset-discovers-21-new-linux-malware-families/> <sup>[[Archive.org]][1307]</sup>

[^488]: NakeSecurity, EvilGnome -- Linux malware aimed at your desktop, not your servers <https://nakedsecurity.sophos.com/2019/07/25/evilgnome-linux-malware-aimed-at-your-laptop-not-your-servers/> <sup>[[Archive.org]][1308]</sup>

[^489]: Immunify, HiddenWasp: How to detect malware hidden on Linux & IoT <https://blog.imunify360.com/hiddenwasp-how-to-detect-malware-hidden-on-linux-iot> <sup>[[Archive.org]][1309]</sup>

[^490]: Wikipedia, Linux Malware <https://en.wikipedia.org/wiki/Linux_malware> <sup>[[Wikiless]][1310]</sup> <sup>[[Archive.org]][1311]</sup>

[^491]: Wikipedia, macOS Malware [https://en.wikipedia.org/wiki/macOS_malware][] <sup>[[Wikiless]][1312]</sup> <sup>[[Archive.org]][1313]</sup>

[^492]: MacWorld, List of Mac viruses, malware and security flaws <https://www.macworld.co.uk/feature/mac-viruses-list-3668354/> <sup>[[Archive.org]][1314]</sup>

[^493]: JAMF, The Mac Malware of 2020 <https://resources.jamf.com/documents/macmalware-2020.pdf> <sup>[[Archive.org]][1315]</sup>

[^494]: macOS Security and Privacy Guide, <https://github.com/drduh/macOS-Security-and-Privacy-Guide#viruses-and-malware> <sup>[[Archive.org]][295]</sup>

[^495]: ImageTragick.com, <https://imagetragick.com/> <sup>[[Archive.org]][1316]</sup>

[^496]: Oracle Virtualbox Documentation, <https://docs.oracle.com/en/virtualization/virtualbox/6.0/admin/hyperv-support.html> <sup>[[Archive.org]][1317]</sup>

[^497]: Oracle Virtualbox Documentation, <https://docs.oracle.com/en/virtualization/virtualbox/6.0/admin/hyperv-support.html> <sup>[[Archive.org]][1317]</sup>

[^498]: Lenny Zeltser, Analyzing Malicious Documents Cheat Sheet <https://zeltser.com/analyzing-malicious-documents/> <sup>[[Archive.org]][1318]</sup>

[^499]: Wikipedia, Portable Applications <https://en.wikipedia.org/wiki/Portable_application> <sup>[[Wikiless]][1319]</sup> <sup>[[Archive.org]][1320]</sup>

[^500]: Brave Help, What is a Private Window with Tor Connectivity? <https://support.brave.com/hc/en-us/articles/360018121491-What-is-a-Private-Window-with-Tor-> <sup>[[Archive.org]][1266]</sup>

[^501]: BlackGNU, <https://ebin.city/~werwolf/posts/brave-is-shit/> <sup>[[Archive.org]][1321]</sup>

[^502]: Brave Help Center, <https://support.brave.com/hc/en-us/articles/360022973471-What-is-Shields> <sup>[[Archive.org]][1322]</sup>

[^503]: VentureBeat, Browser benchmark battle January 2020: Chrome vs. Firefox vs. Edge vs. Brave <https://venturebeat.com/2020/01/15/browser-benchmark-battle-january-2020-chrome-firefox-edge-brave/view-all/> <sup>[[Archive.org]][1323]</sup>

[^504]: Brave.com, Brave, Fingerprinting, and Privacy Budgets <https://brave.com/brave-fingerprinting-and-privacy-budgets/> <sup>[[Archive.org]][154]</sup>

[^505]: Madaidan Insecurities, Firefox and Chromium <https://madaidans-insecurities.github.io/firefox-chromium.html> <sup>[[Archive.org]][1324]</sup>

[^506]: GrapheneOS, Web Browsing <https://grapheneos.org/usage#web-browsing> <sup>[[Archive.org]][1325]</sup>

[^507]: ResearchGate, Web Browser Privacy: What Do Browsers Say When They Phone Home? <https://www.researchgate.net/publication/349979628_Web_Browser_Privacy_What_Do_Browsers_Say_When_They_Phone_Home> <sup>[[Archive.org]][1326]</sup>

[^508]: Duck's pond, Ungoogled-Chromium, <https://qua3k.github.io/ungoogled/> <sup>[[Archive.org]][1327]</sup>

[^509]: Madaidan Insecurities, Firefox and Chromium <https://madaidans-insecurities.github.io/firefox-chromium.html> <sup>[[Archive.org]][1324]</sup>

[^510]: GrapheneOS, Web Browsing <https://grapheneos.org/usage#web-browsing> <sup>[[Archive.org]][1325]</sup>

[^511]: Microsoft.com, Microsoft Edge support for Microsoft Defender Application Guard <https://docs.microsoft.com/en-us/deployedge/microsoft-edge-security-windows-defender-application-guard> <sup>[[Archive.org]][1328]</sup>

[^512]: PcMag, Mozilla Signs Lucrative 3-Year Google Search Deal for Firefox <https://www.pcmag.com/news/mozilla-signs-lucrative-3-year-google-search-deal-for-firefox> <sup>[[Archive.org]][1329]</sup>

[^513]: Madaidan Insecurities, Firefox and Chromium <https://madaidans-insecurities.github.io/firefox-chromium.html> <sup>[[Archive.org]][1324]</sup>

[^514]: FingerprintJS, Demo: Disabling JavaScript Won't Save You from Fingerprinting <https://fingerprintjs.com/blog/disabling-javascript-wont-stop-fingerprinting/> <sup>[[Archive.org]][924]</sup>

[^515]: Duck's pond, Ungoogled-Chromium, <https://qua3k.github.io/ungoogled/> <sup>[[Archive.org]][1327]</sup>

[^516]: Wikipedia, Virtualization <https://en.wikipedia.org/wiki/Virtualization> <sup>[[Wikiless]][1330]</sup> <sup>[[Archive.org]][1331]</sup>

[^517]: Tor Project, Project Snowflake <https://snowflake.torproject.org/> <sup>[[Archive.org]][559]</sup>

[^518]: GitHub, Obfs4 Repository <https://github.com/Yawning/obfs4/> <sup>[[Archive.org]][1332]</sup>

[^519]: Tor Browser Manual, Pluggable Transport <https://tb-manual.torproject.org/circumvention/> <sup>[[Archive.org]][1333]</sup>

[^520]: Tor Browser Manual, Pluggable Transport <https://tb-manual.torproject.org/circumvention/> <sup>[[Archive.org]][1333]</sup>

[^521]: Wikipedia, Domain Fronting <https://en.wikipedia.org/wiki/Domain_fronting> <sup>[[Wikiless]][1334]</sup> <sup>[[Archive.org]][1335]</sup>

[^522]: GitLab, Tor Browser Issues, Add uBlock Origin to the Tor Browser <https://gitlab.torproject.org/tpo/applications/tor-browser/-/issues/17569> <sup>[[Archive.org]][1336]</sup>

[^523]: Vice, The NSA and CIA Use Ad Blockers Because Online Advertising Is So Dangerous <https://www.vice.com/en/article/93ypke/the-nsa-and-cia-use-ad-blockers-because-online-advertising-is-so-dangerous> <sup>[[Archive.org]][1337]</sup>

[^524]: Europol Wasabi Wallet Report, <https://www.tbstat.com/wp/uploads/2020/06/Europol-Wasabi-Wallet-Report.pdf> <sup>[[Archive.org]][1338]</sup>

[^525]: NIST, <https://www.sans.org/blog/nist-has-spoken-death-to-complexity-long-live-the-passphrase/> <sup>[[Archive.org]][1339]</sup>

[^526]: ZDnet, FBI recommends passphrases over password complexity <https://www.zdnet.com/article/fbi-recommends-passphrases-over-password-complexity/> <sup>[[Archive.org]][1340]</sup>

[^527]: The Intercept, Passphrases That You Can Memorize --- But That Even the NSA Can't Guess <https://theintercept.com/2015/03/26/passphrases-can-memorize-attackers-cant-guess/> <sup>[[Tor Mirror]][1341]</sup> <sup>[[Archive.org]][1342]</sup>

[^528]: ProtonMail Blog, Let's settle the password vs. passphrase debate once and for all <https://protonmail.com/blog/protonmail-com-blog-password-vs-passphrase/> <sup>[[Archive.org]][1343]</sup>

[^529]: YouTube, Edward Snowden on Passwords: Last Week Tonight with John Oliver (HBO) <https://www.youtube.com/watch?v=yzGzB-yYKcc> <sup>[[Invidious]][1344]</sup>

[^530]: YouTube, How to Choose a Password -- Computerphile <https://www.youtube.com/watch?v=3NjQ9b3pgIg> <sup>[[Invidious]][695]</sup>

[^531]: Wikipedia, Passphrase <https://en.wikipedia.org/wiki/Passphrase#Passphrase_selection> <sup>[[Wikiless]][1345]</sup> <sup>[[Archive.org]][1346]</sup>

[^532]: Monero Research Lab, Evaluating cryptocurrency security and privacy in a post-quantum world <https://github.com/insight-decentralized-consensus-lab/post-quantum-monero/blob/master/writeups/technical_note.pdf> <sup>[[Archive.org]][1347]</sup>
  ...
  [https://matrix.to/#/#privacy-security-anonymity:matrix.org]: https://matrix.to/#/#privacy-security-anonymity:matrix.org
  ...
  [675]: https://yewtu.be/watch?v=qkJGF3syQy4
  [676]: https://web.archive.org/web/https://brave.com/download/
  [677]: https://web.archive.org/web/https://wiki.archlinux.org/title/Firefox/Privacy
  [678]: https://web.archive.org/web/https://proprivacy.com/privacy-service/guides/firefox-privacy-security-guide
  [679]: https://web.archive.org/web/https://chrisx.xyz/blog/yet-another-firefox-hardening-guide/
  [680]: https://web.archive.org/web/https://ebin.city/~werwolf/posts/firefox-hardening-guide/
  [681]: media/image53.jpeg 
  [682]: media/image54.jpeg 
  [683]: https://web.archive.org/web/https://www.torproject.org/download/
  [684]: media/image55.jpeg 
  [685]: media/image56.jpeg 
  [686]: media/image57.jpeg 
  [687]: https://web.archive.org/web/https://z.cash/
  [688]: https://web.archive.org/web/https://z.cash/exchanges/
  [689]: https://web.archive.org/web/https://wasabiwallet.io/
  [690]: https://web.archive.org/web/https://community.torproject.org/relay/community-resources/good-bad-isps/
  [691]: https://web.archive.org/web/https://privacyguides.org/providers/hosting/
  [692]: https://web.archive.org/web/https://xkcd.com/936/
  [693]: https://web.archive.org/web/https://www.explainxkcd.com/wiki/index.php/936:_Password_Strength
  [694]: media/image58.jpeg 
  [695]: https://yewtu.be/watch?v=3NjQ9b3pgIg
  [696]: https://web.archive.org/web/https://privacyguides.org/providers/search-engines
  [697]: https://web.archive.org/web/https://arstechnica.com/tech-policy/2018/06/dark-web-vendor-oxymonster-turns-out-to-be-a-frenchman-with-luscious-beard/
  [698]: https://web.archive.org/web/https://www.whonix.org/wiki/Surfing_Posting_Blogging#Stylometry
  [699]: https://wikiless.org/wiki/Forensic_linguistics
  [700]: https://web.archive.org/web/https://wikipedia.org/wiki/Forensic_linguistics
  [701]: https://wikiless.org/wiki/Writeprint
  [702]: https://web.archive.org/web/https://wikipedia.org/wiki/Writeprint
  [703]: https://wikiless.org/wiki/Stylometry
  [704]: https://web.archive.org/web/https://wikipedia.org/wiki/Stylometry
  [705]: https://wikiless.org/wiki/Content_similarity_detection
  [706]: https://web.archive.org/web/https://wikipedia.org/wiki/Content_similarity_detection
  [707]: https://wikiless.org/wiki/Author_profiling
  [708]: https://web.archive.org/web/https://wikipedia.org/wiki/Author_profiling
  [709]: https://wikiless.org/wiki/Native-language_identification
  [710]: https://web.archive.org/web/https://wikipedia.org/wiki/Native-language_identification
  [711]: https://wikiless.org/wiki/Computational_linguistics
  [712]: https://web.archive.org/web/https://wikipedia.org/wiki/Computational_linguistics
  [713]: https://web.archive.org/web/https://regmedia.co.uk/2017/09/27/gal_vallerius.pdf
  [714]: https://wikiless.org/wiki/Ted_Kaczynski#After_publication
  [715]: https://web.archive.org/web/https://wikipedia.org/wiki/Ted_Kaczynski#After_publication
  [716]: https://web.archive.org/web/https://i.blackhat.com/USA-19/Wednesday/us-19-Wixey-Im-Unique-Just-Like-You-Human-Side-Channels-And-Their-Implications-For-Security-And-Privacy.pdf
  [717]: https://web.archive.org/web/https://media.defcon.org/DEF%20CON%2026/DEF%20CON%2026%20presentations/DEFCON-26-Matt-Wixey-Betrayed-by-the-Keyboard-Updated.pdf
  [718]: https://web.archive.org/web/https://i.blackhat.com/us-18/Wed-August-8/us-18-Wixey-Every-ROSE-Has-Its-Thorn-The-Dark-Art-Of-Remote-Online-Social-Engineering.pdf
  [https://yewtu.be]: https://invidious.fdn.fr
  [https://nitter.net]: https://nitter.fdn.fr
  [719]: https://web.archive.org/web/https://github.com/spikecodes/libreddit
  [720]: https://web.archive.org/web/https://git.sr.ht/~metalune/simplytranslate_web
  [https://anonymousplanet.org]: https://anonymousplanet.org/
  [721]: https://mirror.anonymousplanet.org/guide.pdf
  [722]: https://web.archive.org/web/https://anonymousplanet.org/guide.pdf
  [723]: http://thgtoa7imksbg7rit4grgijl2ef6kc7b56bp56pmtta4g354lydlzkqd.onion/guide.pdf
  [724]: https://mirror.anonymousplanet.org/guide-dark.pdf
  [725]: https://web.archive.org/web/https://anonymousplanet.org/guide-dark.pdf
  [726]: http://thgtoa7imksbg7rit4grgijl2ef6kc7b56bp56pmtta4g354lydlzkqd.onion/guide-dark.pdf
  [727]: https://mirror.anonymousplanet.org/guide.odt
  [728]: https://web.archive.org/web/https://anonymousplanet.org/guide.odt
  [729]: http://thgtoa7imksbg7rit4grgijl2ef6kc7b56bp56pmtta4g354lydlzkqd.onion/guide.odt
  [730]: https://web.archive.org/web/https://help.libreoffice.org/7.1/en-US/text/shared/guide/redlining_doccompare.html
  [731]: https://web.archive.org/web/https://www.whonix.org/wiki/Surfing_Posting_Blogging#Anonymous_File_Sharing
  [732]: https://yewtu.be/watch?v=H33ggs7bh8M
  [**https://www.youtube.com/watch?v=j02QoI4ZlnU**]: https://www.youtube.com/watch?v=j02QoI4ZlnU
  [733]: https://yewtu.be/watch?v=j02QoI4ZlnU
  [734]: https://web.archive.org/web/https://github.com/monero-project/monero/blob/master/docs/ANONYMITY_NETWORKS.md#privacy-limitations
  [735]: https://web.archive.org/web/https://www.linddun.org/
  [736]: https://wikiless.org/wiki/STRIDE_%28security%29
  [737]: https://web.archive.org/web/https://en.wikipedia.org/wiki/STRIDE_%28security%29
  [738]: https://web.archive.org/web/https://versprite.com/tag/pasta-threat-modeling/
  [739]: https://web.archive.org/web/https://insights.sei.cmu.edu/blog/threat-modeling-12-available-methods/
  [740]: https://web.archive.org/web/https://www.geeksforgeeks.org/threat-modelling/
  [741]: https://web.archive.org/web/https://www.threatmodelingmanifesto.org/
  [742]: https://web.archive.org/web/https://cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html
  ...
  [743]: https://web.archive.org/web/https://www.huntonprivacyblog.com/wp-content/uploads/sites/28/2016/02/Telemedia_Act__TMA_.pdf
  [744]: https://wikiless.org/wiki/Don%27t_be_evil
  [745]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Don%27t_be_evil
  [746]: https://yewtu.be/watch?v=6DGNZnfKYnU
  [747]: https://wikiless.org/wiki/Open-source_intelligence
  [748]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Open-source_intelligence
  [749]: https://yewtu.be/playlist?list=PLna1KTNJu3y09Tu70U6yPn28sekaNhOMY
  [750]: https://wikiless.org/wiki/4chan
  [751]: https://web.archive.org/web/https://en.wikipedia.org/wiki/4chan
  [752]: https://web.archive.org/web/https://www.privateinternetaccess.com/blog/how-does-privacy-differ-from-anonymity-and-why-are-both-important/
  [753]: https://web.archive.org/web/https://scholar.harvard.edu/files/mickens/files/thisworldofours.pdf
  [754]: https://web.archive.org/web/https://xkcd.com/538/
  [755]: https://wikiless.org/wiki/Threat_model
  [756]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Threat_model
  [757]: https://web.archive.org/web/https://www.bellingcat.com/
  [758]: https://wikiless.org/wiki/Doxing
  [759]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Doxing
  [760]: https://yewtu.be/watch?v=muoR8Td44UE
  [761]: https://web.archive.org/web/https://www.bbc.com/news/technology-50150981
  [762]: https://web.archive.org/web/https://github.com/alecmuffett/real-world-onion-sites
  [763]: https://web.archive.org/web/https://2019.www.torproject.org/about/torusers.html.en
  [764]: https://web.archive.org/web/https://www.whonix.org/wiki/Anonymity
  [765]: https://web.archive.org/web/https://geekfeminism.wikia.org/wiki/Who_is_harmed_by_a_%22Real_Names%22_policy%3F
  [766]: https://web.archive.org/web/https://www.cyberghostvpn.com/privacyhub/internet-privacy-surveillance/
  [767]: https://web.archive.org/web/https://www.privateinternetaccess.com/blog/internet-freedom-around-the-world-in-50-stats/
  [768]: https://wikiless.org/wiki/IANAL
  [769]: https://web.archive.org/web/https://en.wikipedia.org/wiki/IANAL
  [770]: https://wikiless.org/wiki/Trust,_but_verify
  [771]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Trust,_but_verify
  [772]: https://wikiless.org/wiki/IP_address
  [773]: https://web.archive.org/web/https://en.wikipedia.org/wiki/IP_address
  [774]: https://wikiless.org/wiki/Data_retention
  [775]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Data_retention
  [776]: https://wikiless.org/wiki/Tor_(anonymity_network)
  [777]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Tor_(anonymity_network)
  [778]: https://wikiless.org/wiki/Virtual_private_network
  [779]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Virtual_private_network
  [780]: https://web.archive.org/web/https://ieeexplore.ieee.org/document/8418599
  [781]: https://wikiless.org/wiki/Domain_Name_System
  [782]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Domain_Name_System
  [783]: https://wikiless.org/wiki/DNS_blocking
  [784]: https://web.archive.org/web/https://en.wikipedia.org/wiki/DNS_blocking
  [785]: https://web.archive.org/web/https://censoredplanet.org/
  [786]: https://web.archive.org/web/https://arxiv.org/pdf/2001.08288.pdf
  [787]: https://web.archive.org/web/https://labzilla.io/blog/force-dns-pihole
  [788]: https://wikiless.org/wiki/DNS_over_HTTPS
  [789]: https://web.archive.org/web/https://en.wikipedia.org/wiki/DNS_over_HTTPS
  [790]: https://wikiless.org/wiki/DNS_over_TLS
  [791]: https://web.archive.org/web/https://en.wikipedia.org/wiki/DNS_over_TLS
  [792]: https://wikiless.org/wiki/Pi-hole
  [793]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Pi-hole
  [794]: https://wikiless.org/wiki/Server_Name_Indication
  [795]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Server_Name_Indication
  [796]: https://web.archive.org/web/https://www.usenix.org/system/files/foci19-paper_chai_0.pdf
  [797]: https://wikiless.org/wiki/Content_delivery_network
  [798]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Content_delivery_network
  [799]: https://web.archive.org/web/https://blog.cloudflare.com/encrypted-client-hello/
  [800]: https://web.archive.org/web/https://www.zdnet.com/article/russia-wants-to-ban-the-use-of-secure-protocols-such-as-tls-1-3-doh-dot-esni/
  [801]: https://web.archive.org/web/https://www.zdnet.com/article/china-is-now-blocking-all-encrypted-https-traffic-using-tls-1-3-and-esni/
  [802]: https://wikiless.org/wiki/Online_Certificate_Status_Protocol
  [803]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Online_Certificate_Status_Protocol
  [804]: https://web.archive.org/web/https://madaidans-insecurities.github.io/encrypted-dns.html
  [805]: https://wikiless.org/wiki/OCSP_stapling
  [806]: https://web.archive.org/web/https://en.wikipedia.org/wiki/OCSP_stapling
  [807]: https://web.archive.org/web/https://dev.chromium.org/Home/chromium-security/crlsets
  [808]: https://web.archive.org/web/https://www.zdnet.com/article/chrome-does-certificate-revocation-better/
  [809]: https://web.archive.org/web/https://www.esat.kuleuven.be/cosic/publications/article-3153.pdf
  [810]: https://web.archive.org/web/https://www.researchgate.net/publication/332893422_Oblivious_DNS_Practical_Privacy_for_DNS_Queries
  [811]: https://web.archive.org/web/https://nymity.ch/tor-dns/
  [812]: https://wikiless.org/wiki/Near-field_communication
  [813]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Near-field_communication
  [814]: https://web.archive.org/web/https://shop.samsonite.com/accessories/rfid-accessories/
  [815]: https://web.archive.org/web/https://support.google.com/accounts/answer/3467281?hl=en
  [816]: https://web.archive.org/web/https://support.apple.com/en-us/HT207056
  [817]: https://web.archive.org/web/http://fly.isti.cnr.it/pub/papers/pdf/Wifi-probes-IPIN16.pdf
  [818]: https://web.archive.org/web/https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7472341/
  [819]: https://web.archive.org/web/https://medium.com/@brannondorsey/wi-fi-is-broken-3f6054210fa5
  [820]: https://web.archive.org/web/https://cse.buffalo.edu/~lusu/papers/MobiCom2020.pdf
  [821]: https://web.archive.org/web/https://digi.ninja/jasager/
  [822]: https://web.archive.org/web/https://shop.hak5.org/products/wifi-pineapple
  [823]: https://wikiless.org/wiki/Wi-Fi_deauthentication_attack
  [824]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Wi-Fi_deauthentication_attack
  [825]: https://wikiless.org/wiki/Captive_portal
  [826]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Captive_portal
  [827]: https://web.archive.org/web/https://www.hackerfactor.com/blog/index.php?/archives/868-Deanonymizing-Tor-Circuits.html
  [828]: https://web.archive.org/web/https://distrinet.cs.kuleuven.be/software/tor-wf-dl/
  [829]: https://web.archive.org/web/https://homes.esat.kuleuven.be/~mjuarezm/index_files/pdf/ccs18.pdf
  [830]: https://web.archive.org/web/https://www.internetsociety.org/sites/default/files/blogs-media/website-fingerprinting-internet-scale.pdf
  [831]: https://web.archive.org/web/https://www.esat.kuleuven.be/cosic/publications/article-2456.pdf
  [832]: https://web.archive.org/web/https://www.dailydot.com/unclick/tor-harvard-bomb-suspect/
  [833]: https://web.archive.org/web/https://arstechnica.com/information-technology/2015/10/how-the-nsa-can-break-trillions-of-encrypted-web-and-vpn-connections/
  [834]: https://web.archive.org/web/https://arstechnica.com/gadgets/2020/11/does-tor-provide-more-benefit-or-harm-new-paper-says-it-depends/
  [835]: https://web.archive.org/web/https://www.pnas.org/content/early/2020/11/24/2011893117
  [836]: https://web.archive.org/web/https://blog.cryptographyengineering.com/2019/06/05/how-does-apple-privately-find-your-offline-devices/
  [837]: https://web.archive.org/web/https://support.apple.com/en-us/HT210515
  [838]: https://web.archive.org/web/https://www.xda-developers.com/samsung-find-my-mobile-app-locate-galaxy-devices-offline/
  [839]: https://web.archive.org/web/https://support.apple.com/en-us/HT204756
  [840]: https://wikiless.org/wiki/Bluetooth_Low_Energy
  [841]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Bluetooth_Low_Energy
  [842]: https://wikiless.org/wiki/International_Mobile_Equipment_Identity
  [843]: https://web.archive.org/web/https://en.wikipedia.org/wiki/International_Mobile_Equipment_Identity
  [844]: https://wikiless.org/wiki/International_mobile_subscriber_identity
  [845]: https://web.archive.org/web/https://en.wikipedia.org/wiki/International_mobile_subscriber_identity
  [846]: https://web.archive.org/web/https://source.android.com/devices/tech/config/device-identifiers
  [847]: https://web.archive.org/web/https://policies.google.com/privacy/embedded?hl=en-US
  [848]: https://web.archive.org/web/https://www.bellingcat.com/news/uk-and-europe/2019/06/28/the-gru-globetrotters-mission-london/
  [849]: https://web.archive.org/web/https://www.bellingcat.com/news/uk-and-europe/2020/02/17/v-like-vympel-fsbs-secretive-department-v-behind-assassination-of-zelimkhan-khangoshvili/
  [850]: https://wikiless.org/wiki/Closed-circuit_television
  [851]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Closed-circuit_television
  [852]: https://web.archive.org/web/https://www.apple.com/legal/transparency/device-requests.html
  [853]: https://27m3p2uv7igmj6kvd4ql3cct5h3sdwrsajovkkndeufumzyfhlfev4qd.onion/2020/07/31/protests-surveillance-stingrays-dirtboxes-phone-tracking/
  [854]: https://web.archive.org/web/https://theintercept.com/2020/07/31/protests-surveillance-stingrays-dirtboxes-phone-tracking/
  [855]: https://wikiless.org/wiki/IMSI-catcher
  [856]: https://web.archive.org/web/https://en.wikipedia.org/wiki/IMSI-catcher
  [857]: https://wikiless.org/wiki/Stingray_phone_tracker
  [858]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Stingray_phone_tracker
  [859]: https://web.archive.org/web/https://gizmodo.com/american-cops-turns-to-canadian-phone-tracking-firm-aft-1845442778
  [860]: https://wikiless.org/wiki/Man-in-the-middle_attack
  [861]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Man-in-the-middle_attack
  [862]: https://web.archive.org/web/https://shop.puri.sm/shop/librem-5/
  [863]: https://wikiless.org/wiki/MAC_address
  [864]: https://web.archive.org/web/https://en.wikipedia.org/wiki/MAC_address
  [865]: https://web.archive.org/web/https://amsignalinc.com/data-sheets/Acyclica/Acyclica-RoadTrend-Product-Sheet.pdf
  [866]: https://web.archive.org/web/https://www.researchgate.net/publication/334590931_Tracking_Anonymized_Bluetooth_Devices/fulltext/5d3308db92851cd04675a469/Tracking-Anonymized-Bluetooth-Devices.pdf
  [867]: https://wikiless.org/wiki/Central_processing_unit
  [868]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Central_processing_unit
  [869]: https://wikiless.org/wiki/Intel_Management_Engine
  [870]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Intel_Management_Engine
  [871]: https://wikiless.org/wiki/AMD_Platform_Security_Processor
  [872]: https://web.archive.org/web/https://en.wikipedia.org/wiki/AMD_Platform_Security_Processor
  [873]: https://web.archive.org/web/https://libreboot.org/
  [874]: https://web.archive.org/web/https://www.apple.com/privacy/docs/Differential_Privacy_Overview.pdf
  [875]: https://wikiless.org/wiki/Differential_privacy
  [876]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Differential_privacy
  [877]: https://web.archive.org/web/https://edwardsnowden.substack.com/p/all-seeing-i
  [878]: https://web.archive.org/web/https://www.reuters.com/article/us-apple-fbi-icloud-exclusive-idUSKBN1ZK1CT
  [879]: https://web.archive.org/web/https://www.zdnet.com/article/apple-data-collection-stored-request/
  [880]: https://web.archive.org/web/https://decorrespondent.nl/8481/heres-how-we-found-the-names-and-addresses-of-soldiers-and-secret-agents-using-a-simple-fitness-app/412999257-6756ba27
  [881]: https://web.archive.org/web/https://www.websiteplanet.com/blog/gethealth-leak-report/
  [882]: https://web.archive.org/web/https://www.wired.com/story/strava-heat-map-military-bases-fitness-trackers-privacy/
  [883]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2018/01/29/strava-interpretation-guide/
  [884]: https://web.archive.org/web/https://www.theguardian.com/world/2018/jan/28/fitness-tracking-app-gives-away-location-of-secret-us-army-bases
  [885]: https://web.archive.org/web/https://www.telegraph.co.uk/technology/2018/07/08/running-app-exposes-mi6-gchq-workers-whereabouts/
  [886]: https://web.archive.org/web/https://www.washingtonpost.com/technology/2019/05/06/alexa-has-been-eavesdropping-you-this-whole-time/?itid=lk_interstitial_manual_59
  [887]: https://web.archive.org/web/https://www.washingtonpost.com/technology/2019/12/17/what-does-your-car-know-about-you-we-hacked-chevy-find-out/
  [888]: https://web.archive.org/web/https://kieranhealy.org/blog/archives/2013/06/09/using-metadata-to-find-paul-revere/
  [889]: https://wikiless.org/wiki/Sensorvault
  [890]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Sensorvault
  [891]: https://web.archive.org/web/https://nrkbeta.no/2020/12/03/my-phone-was-spying-on-me-so-i-tracked-down-the-surveillants/
  [892]: https://web.archive.org/web/https://www.nytimes.com/interactive/2019/12/19/opinion/location-tracking-cell-phone.html
  [893]: https://web.archive.org/web/https://nakedsecurity.sophos.com/2020/03/10/google-data-puts-innocent-man-at-the-scene-of-a-crime/
  [894]: https://wikiless.org/wiki/Geo-fence_warrant
  [895]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Geo-fence_warrant
  [896]: https://web.archive.org/web/https://www.vice.com/en/article/y3g97x/location-data-apps-drone-strikes-iowa-national-guard
  [897]: https://web.archive.org/web/https://techcrunch.com/2021/08/19/google-geofence-warrants/
  [898]: https://web.archive.org/web/https://www.techdirt.com/articles/20210821/10494847401/google-report-shows-reverse-warrants-are-swiftly-becoming-law-enforcements-go-to-investigative-tool.shtml
  [899]: https://web.archive.org/web/https://www.vice.com/en/article/m7vqkv/how-fbi-gets-phone-data-att-tmobile-verizon
  [900]: https://wikiless.org/wiki/Room_641A
  [901]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Room_641A
  [902]: https://wikiless.org/wiki/Edward_Snowden
  [903]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Edward_Snowden
  [904]: https://wikiless.org/wiki/XKeyscore
  [905]: https://web.archive.org/web/https://en.wikipedia.org/wiki/XKeyscore
  [906]: https://web.archive.org/web/https://www.electrospaces.net/2020/10/danish-military-intelligence-uses.html
  [907]: https://web.archive.org/web/https://en.m.wikipedia.org/wiki/MUSCULAR_(surveillance_program)
  [908]: https://wikiless.org/wiki/SORM
  [909]: https://web.archive.org/web/https://en.wikipedia.org/wiki/SORM
  [910]: https://wikiless.org/wiki/Tempora
  [911]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Tempora
  [912]: https://wikiless.org/wiki/PRISM_(surveillance_program)
  [913]: https://web.archive.org/web/https://en.wikipedia.org/wiki/PRISM_(surveillance_program)
  [914]: https://web.archive.org/web/https://www.justsecurity.org/10318/video-clip-director-nsa-cia-we-kill-people-based-metadata/
  [915]: https://web.archive.org/web/https://www.imdb.com/title/tt11464826/
  [916]: https://web.archive.org/web/https://arstechnica.com/information-technology/2015/07/how-the-way-you-type-can-shatter-anonymity-even-on-tor/
  [917]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Stylometry
  [918]: https://web.archive.org/web/https://paul.reviews/behavioral-profiling-the-password-you-cant-change/
  [919]: https://wikiless.org/wiki/Sentiment_analysis
  [920]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Sentiment_analysis
  [921]: https://web.archive.org/web/https://coveryourtracks.eff.org/
  [922]: https://web.archive.org/web/https://people.eecs.berkeley.edu/~dawnsong/papers/2012%20On%20the%20Feasibility%20of%20Internet-Scale%20Author%20Identification.pdf
  ...
  [923]: https://web.archive.org/web/https://www.forbes.com/sites/thomasbrewster/2021/10/04/google-keyword-warrants-give-us-government-data-on-search-users
  [924]: https://web.archive.org/web/https://fingerprintjs.com/blog/disabling-javascript-wont-stop-fingerprinting/
  [925]: https://web.archive.org/web/https://blog.securedtouch.com/behavioral-biometrics-101-an-in-depth-look-at-behavioral-biometrics-vs-behavioral-analytics
  [926]: https://web.archive.org/web/https://arstechnica.com/tech-policy/2012/03/stakeout-how-the-fbi-tracked-and-busted-a-chicago-anon/
  [927]: https://web.archive.org/web/https://www.bellingcat.com/news/uk-and-europe/2018/05/25/mh17-russian-gru-commander-orion-identified-oleg-ivannikov/
  [928]: https://web.archive.org/web/https://research.fb.com/publications/deepface-closing-the-gap-to-human-level-performance-in-face-verification/
  [929]: https://web.archive.org/web/https://www.privateinternetaccess.com/blog/putting-face-facebook-mark-zuckerberg-building-world-without-public-anonymity/
  [930]: https://web.archive.org/web/https://www.cnbc.com/2017/09/01/facebook-has-mapped-human-population-building-internet-in-space.html
  [931]: https://web.archive.org/web/https://www.technologyreview.com/2021/02/05/1017388/ai-deep-learning-facial-recognition-data-history/
  [932]: https://web.archive.org/web/https://www.bellingcat.com/resources/case-studies/2015/08/07/shadow-of-a-doubt/
  [933]: https://web.archive.org/web/https://brown.columbia.edu/open-source-investigation/
  [934]: https://web.archive.org/web/https://www.newscientist.com/article/dn27761-facebook-can-recognise-you-in-photos-even-if-youre-not-looking/
  [935]: https://web.archive.org/web/https://patents.google.com/patent/US20150242679
  [936]: https://web.archive.org/web/https://apnews.com/article/bf75dd1c26c947b7826d270a16e2658a
  [937]: https://web.archive.org/web/https://www.thesun.co.uk/news/7684204/cctv-technology-identify-body-shape-way-walk/
  [938]: https://web.archive.org/web/https://citysecuritymagazine.com/security-management/gait-recognition-identification-tool/
  [939]: https://web.archive.org/web/https://www.vice.com/en/article/bvzvdw/tech-companies-are-training-ai-to-read-your-lips
  [940]: https://web.archive.org/web/https://newatlas.com/science/science/eye-tracking-privacy/
  [941]: https://web.archive.org/web/https://techcrunch.com/2021/01/13/facial-recognition-reveals-political-party-in-troubling-new-research/
  [942]: https://web.archive.org/web/https://slate.com/technology/2018/04/facebook-collects-data-on-non-facebook-users-if-they-want-to-delete-it-they-have-to-sign-up.html
  [943]: https://web.archive.org/web/https://theconversation.com/shadow-profiles-facebook-knows-about-you-even-if-youre-not-on-facebook-94804
  [944]: https://web.archive.org/web/https://www.theverge.com/2018/4/11/17225482/facebook-shadow-profiles-zuckerberg-congress-data-privacy
  [945]: https://web.archive.org/web/https://www.zdnet.com/article/anger-mounts-after-facebooks-shadow-profiles-leak-in-bug/
  [946]: https://web.archive.org/web/https://www.cnet.com/news/shadow-profiles-facebook-has-information-you-didnt-hand-over/
  [947]: https://web.archive.org/web/https://www.anyvision.co/
  [948]: https://web.archive.org/web/https://www.buzzfeednews.com/article/ryanmac/clearview-ai-local-police-facial-recognition
  [949]: https://web.archive.org/web/https://www.wired.com/story/clearview-ai-new-tools-identify-you-photos/
  [950]: https://web.archive.org/web/https://www.nec.com/en/global/solutions/biometrics/face/neofacewatch.html
  [951]: https://web.archive.org/web/https://www.theguardian.com/uk-news/2020/feb/11/met-police-deploy-live-facial-recognition-technology
  [952]: https://yewtu.be/watch?v=lH2gMNrUuEY
  [953]: https://web.archive.org/web/https://edition.cnn.com/2021/07/23/tech/idme-unemployment-facial-recognition/index.html
  [954]: https://web.archive.org/web/https://www.washingtonpost.com/technology/2020/12/08/huawei-tested-ai-software-that-could-recognize-uighur-minorities-alert-police-report-says/
  [955]: https://27m3p2uv7igmj6kvd4ql3cct5h3sdwrsajovkkndeufumzyfhlfev4qd.onion/2016/10/13/how-a-facial-recognition-mismatch-can-ruin-your-life/
  [956]: https://web.archive.org/web/https://theintercept.com/2016/10/13/how-a-facial-recognition-mismatch-can-ruin-your-life/
  [957]: https://web.archive.org/web/https://www.vice.com/en/article/5dbywn/facial-recognition-failures-are-locking-people-out-of-unemployment-systems
  [958]: https://web.archive.org/web/https://www.bbc.com/news/uk-wales-43711477
  [959]: https://web.archive.org/web/https://edition.cnn.com/2021/05/25/uk/drug-dealer-cheese-sentenced-scli-gbr-intl/index.html
  [960]: https://web.archive.org/web/https://www.vice.com/en/article/evqk9e/photo-of-fingerprints-used-to-arrest-drug-dealers
  [961]: https://web.archive.org/web/https://patents.justia.com/patent/10891948
  [962]: https://web.archive.org/web/https://www.pymnts.com/news/biometrics/2021/iris-scan-traveler-identification-dubai-airport/
  [963]: https://web.archive.org/web/https://www.imdb.com/title/tt0119177/
  [964]: https://web.archive.org/web/https://www.imdb.com/title/tt1839578
  [965]: https://web.archive.org/web/https://www.imdb.com/title/tt0181689
  [966]: https://wikiless.org/wiki/Deepfake
  [967]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Deepfake
  [968]: https://web.archive.org/web/https://www.econotimes.com/Deepfake-Voice-Technology-The-Good-The-Bad-The-Future-1601278
  [969]: https://web.archive.org/web/https://www.forbes.com/sites/jessedamiani/2019/09/03/a-voice-deepfake-was-used-to-scam-a-ceo-out-of-243000/
  [970]: https://web.archive.org/web/https://josephsteinberg.com/how-to-prevent-facial-recognition-technology-from-identifying-you/
  [971]: https://web.archive.org/web/https://nvlpubs.nist.gov/nistpubs/ir/2020/NIST.IR.8311.pdf
  [972]: https://web.archive.org/web/https://www.bbc.com/news/technology-55573802
  [973]: https://web.archive.org/web/http://diglib.uwgb.edu/digital/api/collection/p17003coll4/id/71/download
  [974]: https://wikiless.org/wiki/Phishing
  [975]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Phishing
  [976]: https://wikiless.org/wiki/Social_engineering_(security)
  [977]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Social_engineering_(security)
  [978]: https://web.archive.org/web/https://www.bbc.com/news/technology-56071437
  [979]: https://wikiless.org/wiki/Exploit_(computer_security)
  [980]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Exploit_(computer_security)
  [981]: https://wikiless.org/wiki/Freedom_Hosting
  [982]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Freedom_Hosting
  [983]: https://web.archive.org/web/https://www.wired.com/2013/09/freedom-hosting-fbi/
  [984]: https://wikiless.org/wiki/2020_United_States_federal_government_data_breach
  [985]: https://web.archive.org/web/https://en.wikipedia.org/wiki/2020_United_States_federal_government_data_breach
  [986]: https://web.archive.org/web/https://www.bbc.com/news/blogs-china-blog-48552907
  [987]: https://27m3p2uv7igmj6kvd4ql3cct5h3sdwrsajovkkndeufumzyfhlfev4qd.onion/2021/01/29/china-uyghur-muslim-surveillance-police/
  [988]: https://web.archive.org/web/https://theintercept.com/2021/01/29/china-uyghur-muslim-surveillance-police/
  [989]: https://wikiless.org/wiki/Sandbox_(computer_security)
  [990]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Sandbox_(computer_security)
  [991]: https://web.archive.org/web/https://www.wired.com/2014/07/usb-security/
  [992]: https://wikiless.org/wiki/Stuxnet
  [993]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Stuxnet
  [994]: https://web.archive.org/web/https://superuser.com/questions/1206321/how-do-i-safely-investigate-a-usb-stick-found-in-the-parking-lot-at-work
  [995]: https://web.archive.org/web/https://www.theguardian.com/books/2014/may/12/glenn-greenwald-nsa-tampers-us-internet-routers-snowden
  [996]: https://wikiless.org/wiki/Rootkit
  [997]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Rootkit
  [998]: https://wikiless.org/wiki/User_space
  [999]: https://web.archive.org/web/https://en.wikipedia.org/wiki/User_space
  [1000]: https://wikiless.org/wiki/Firmware
  [1001]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Firmware
  [1002]: https://wikiless.org/wiki/BIOS
  [1003]: https://web.archive.org/web/https://en.wikipedia.org/wiki/BIOS
  [1004]: https://wikiless.org/wiki/Unified_Extensible_Firmware_Interface
  [1005]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Unified_Extensible_Firmware_Interface
  [1006]: https://web.archive.org/web/https://www.bellingcat.com/news/americas/2018/10/26/joseph-mifsud-rush-exif/
  [1007]: https://web.archive.org/web/https://support.zoom.us/hc/en-us/articles/209605273-Adding-a-Watermark
  [1008]: https://web.archive.org/web/https://support.zoom.us/hc/en-us/articles/360021839031-Audio-Watermark
  [1009]: https://web.archive.org/web/https://exchange.adobe.com/creativecloud.details.101789.imatag-invisible-watermark-and-image-monitoring.html
  [1010]: https://web.archive.org/web/https://dtv.nagra.com/nexguard-forensic-watermarking
  [1011]: https://web.archive.org/web/https://www.vobilegroup.com
  [1012]: https://web.archive.org/web/https://www.cinavia.com/languages/english/pages/technology.html
  [1013]: https://web.archive.org/web/https://www.imatag.com/
  [1014]: https://wikiless.org/wiki/Steganography
  [1015]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Steganography
  [1016]: https://web.archive.org/web/https://ieeexplore.ieee.org/document/4428921
  [1017]: https://web.archive.org/web/https://www.sciencedirect.com/science/article/abs/pii/S0165168498000140
  [1018]: https://web.archive.org/web/https://ieeexplore.ieee.org/abstract/document/1188746
  [1019]: https://web.archive.org/web/https://scholar.google.com/scholar?q=source+camera+identification
  [1020]: https://wikiless.org/wiki/Machine_Identification_Code
  [1021]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Machine_Identification_Code
  [1022]: https://web.archive.org/web/http://seeingyellow.com/
  [1023]: https://web.archive.org/web/https://arxiv.org/abs/1107.4524
  [1024]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2019/03/26/how-to-track-illegal-funding-campaigns-via-cryptocurrency/
  [1025]: https://web.archive.org/web/https://www.coindesk.com/business/2021/09/21/leaked-slides-show-how-chainalysis-flags-crypto-suspects-for-cops/
  [1026]: https://wikiless.org/wiki/Know_your_customer
  [1027]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Know_your_customer
  [1028]: https://web.archive.org/web/https://arxiv.org/pdf/1906.05754.pdf
  [1029]: https://yewtu.be/playlist?list=PLsSYUeVwrHBnAUre2G_LYDsdo-tD0ov-y
  [1030]: https://web.archive.org/web/https://monero.org/monero-vs-princeton-researchers/
  [1031]: https://wikiless.org/wiki/Cryptocurrency_tumbler
  [1032]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Cryptocurrency_tumbler
  [1033]: https://wikiless.org/wiki/Security_through_obscurity
  [1034]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Security_through_obscurity
  [1035]: https://web.archive.org/web/https://arxiv.org/abs/2009.14007
  [1036]: https://web.archive.org/web/https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3080361
  [1037]: https://web.archive.org/web/https://www.magnetforensics.com/products/magnet-axiom/cloud/
  [1038]: https://web.archive.org/web/https://www.cellebrite.com/en/ufed-cloud/
  [1039]: https://web.archive.org/web/https://sites.google.com/a/chromium.org/dev/Home/chromium-security/client-identification-mechanisms
  [1040]: https://web.archive.org/web/https://wiki.mozilla.org/Fingerprinting
  [1041]: https://web.archive.org/web/https://www.grayshift.com/
  [1042]: https://web.archive.org/web/https://securephones.io/main.pdf
  [1043]: https://web.archive.org/web/https://loup-vaillant.fr/articles/rolling-your-own-crypto
  [1044]: https://web.archive.org/web/https://soatok.blog/2021/02/09/crackpot-cryptography-and-security-theater/
  [1045]: https://web.archive.org/web/https://www.vice.com/en/article/wnx8nq/why-you-dont-roll-your-own-crypto
  [1046]: https://web.archive.org/web/https://arxiv.org/pdf/2107.04940.pdf
  [1047]: https://yewtu.be/watch?v=loy84K3AJ5Q
  [1048]: https://web.archive.org/web/https://citizenlab.ca/2020/04/move-fast-roll-your-own-crypto-a-quick-look-at-the-confidentiality-of-zoom-meetings/
  [1049]: https://web.archive.org/web/https://medium.com/@atcipher/the-myth-of-military-grade-encryption-292313ae6369
  [1050]: https://web.archive.org/web/https://blog.congruentlabs.co/military-grade-encryption/
  [1051]: https://web.archive.org/web/https://blog.ironcorelabs.com/military-grade-encryption-69aae0145588
  [1052]: https://wikiless.org/wiki/BLAKE_(hash_function)#BLAKE2
  [1053]: https://web.archive.org/web/https://en.wikipedia.org/wiki/BLAKE_(hash_function)#BLAKE2
  [1054]: https://wikiless.org/wiki/AES_instruction_set
  [1055]: https://web.archive.org/web/https://en.wikipedia.org/wiki/AES_instruction_set
  [1056]: https://wikiless.org/wiki/Salsa20#ChaCha_variant
  [1057]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Salsa20#ChaCha_variant
  [1058]: https://wikiless.org/wiki/Serpent_(cipher)
  [1059]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Serpent_(cipher)
  [1060]: https://wikiless.org/wiki/Twofish
  [1061]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Twofish
  [1062]: https://web.archive.org/web/https://latacora.singles/2019/07/16/the-pgp-problem.html
  [1063]: https://wikiless.org/wiki/Shor%27s_algorithm
  [1064]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Shor%27s_algorithm
  [1065]: https://wikiless.org/wiki/Gag_order
  [1066]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Gag_order
  [1067]: https://wikiless.org/wiki/National_security_letter
  [1068]: https://web.archive.org/web/https://en.wikipedia.org/wiki/National_security_letter
  [1069]: https://web.archive.org/web/https://techcrunch.com/2021/09/06/protonmail-logged-ip-address-of-french-activist-after-order-by-swiss-authorities/
  [1070]: https://web.archive.org/web/https://arstechnica.com/gadgets/2021/07/vpn-servers-seized-by-ukrainian-authorities-werent-encrypted/
  [1071]: https://web.archive.org/web/https://www.bleepingcomputer.com/news/security/doublevpn-servers-logs-and-account-info-seized-by-law-enforcement/
  [1072]: https://web.archive.org/web/https://www.cyberscoop.com/court-rules-encrypted-email-tutanota-monitor-messages/
  [1073]: https://web.archive.org/web/https://www.heise.de/news/Gericht-zwingt-Mailprovider-Tutanota-zu-Ueberwachungsfunktion-4972460.html
  [1074]: https://web.archive.org/web/https://www.pcmag.com/opinions/did-purevpn-cross-a-line-when-it-disclosed-user-information
  [1075]: https://web.archive.org/web/https://archive.is/XNuVw
  [1076]: https://wikiless.org/wiki/Lavabit
  [1077]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Lavabit
  [1078]: https://wikiless.org/wiki/Warrant_canary
  [1079]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Warrant_canary
  [1080]: https://web.archive.org/web/https://www.washingtonpost.com/graphics/2020/world/national-security/cia-crypto-encryption-machines-espionage/
  [1081]: https://web.archive.org/web/https://www.swissinfo.ch/eng/second-swiss-firm-allegedly-sold-encrypted-spying-devices/46186432
  [1082]: https://wikiless.org/wiki/The_Lives_of_Others
  [1083]: https://web.archive.org/web/https://en.wikipedia.org/wiki/The_Lives_of_Others
  [1084]: https://web.archive.org/web/https://www.wired.com/story/air-gap-researcher-mordechai-guri/
  [1085]: https://web.archive.org/web/https://www.scientificamerican.com/article/a-blank-wall-can-show-how-many-people-are-in-a-room-and-what-theyre-doing/
  [1086]: https://web.archive.org/web/https://www.scientificamerican.com/article/a-shiny-snack-bags-reflections-can-reconstruct-the-room-around-it/
  [1087]: https://web.archive.org/web/https://www.scientificamerican.com/article/footstep-sensors-identify-people-by-gait/
  [1088]: https://web.archive.org/web/https://www.nassiben.com/lamphone
  [1089]: https://web.archive.org/web/https://www.theguardian.com/world/2013/aug/22/gchq-warned-laser-spying-guardian-offices
  [1090]: https://web.archive.org/web/https://arstechnica.com/tech-policy/2014/05/photos-of-an-nsa-upgrade-factory-show-cisco-router-getting-implant/
  [1091]: https://wikiless.org/wiki/OONI
  [1092]: https://web.archive.org/web/https://en.wikipedia.org/wiki/OONI
  [1093]: https://web.archive.org/web/https://privacyinternational.org/long-read/3018/timeline-sim-card-registration-laws
  [1094]: https://web.archive.org/web/https://www.nytimes.com/2021/01/12/technology/bitcoin-passwords-wallets-fortunes.html
  [1095]: https://web.archive.org/web/https://www.usenix.org/system/files/conference/woot17/woot17-paper-obermaier.pdf
  [1096]: https://web.archive.org/web/https://support.torproject.org/tormobile/tormobile-3/
  [1097]: https://wikiless.org/wiki/Tails_(operating_system)
  [1098]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Tails_(operating_system)
  [1099]: https://web.archive.org/web/https://www.veracrypt.fr/en/Trim%20Operation.html
  [1100]: https://web.archive.org/web/https://www.coreboot.org/
  [1101]: https://wikiless.org/wiki/Booting
  [1102]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Booting
  [1103]: https://web.archive.org/web/https://www.wired.com/2013/12/better-data-security-nail-polish/
  [1104]: https://wikiless.org/wiki/Virtual_machine
  [1105]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Virtual_machine
  [1106]: https://wikiless.org/wiki/Plausible_deniability
  [1107]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Plausible_deniability
  [1108]: https://wikiless.org/wiki/Deniable_encryption
  [1109]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Deniable_encryption
  [1110]: https://web.archive.org/web/https://privacyguides.org/operating-systems/#win10
  [1111]: https://wikiless.org/wiki/BitLocker
  [1112]: https://web.archive.org/web/https://en.wikipedia.org/wiki/BitLocker
  [1113]: https://wikiless.org/wiki/Evil_maid_attack
  [1114]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Evil_maid_attack
  [1115]: https://wikiless.org/wiki/Cold_boot_attack
  [1116]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Cold_boot_attack
  [1117]: https://yewtu.be/watch?v=JDaicPIgn9U
  [1118]: https://web.archive.org/web/https://www.researchgate.net/publication/318155607_Defeating_Plausible_Deniability_of_VeraCrypt_Hidden_Operating_Systems
  [1119]: https://web.archive.org/web/https://www.sans.org/reading-room/whitepapers/forensics/mission-implausible-defeating-plausible-deniability-digital-forensics-39500
  [1120]: https://web.archive.org/web/https://sourceforge.net/p/veracrypt/discussion/technical/thread/53f33faf/
  [1121]: https://web.archive.org/web/https://docs.microsoft.com/en-us/windows/security/information-protection/bitlocker/bitlocker-countermeasures
  [1122]: https://web.archive.org/web/https://www.sans.org/reading-room/whitepapers/forensics/windows-shellbag-forensics-in-depth-34545
  [1123]: https://web.archive.org/web/https://eprints.whiterose.ac.uk/75046/1/Forensic_Data_Recovery_From_The_Windows_Search_Database_preprint_DIIN328.pdf
  [1124]: https://web.archive.org/web/https://cyberforensicator.com/wp-content/uploads/2017/01/1-s2.0-S1742287616300202-main.2-14.pdf
  [1125]: https://wikiless.org/wiki/Gatekeeper_(macOS)
  [1126]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Gatekeeper_(macOS)
  [1127]: https://web.archive.org/web/https://wiki.alpinelinux.org/wiki/Setting_up_a_laptop
  [1128]: https://wikiless.org/wiki/VeraCrypt
  [1129]: https://web.archive.org/web/https://en.wikipedia.org/wiki/VeraCrypt
  [1130]: https://web.archive.org/web/https://www.veracrypt.fr/en/Unencrypted%20Data%20in%20RAM.html
  [1131]: https://web.archive.org/web/https://www.veracrypt.fr/code/VeraCrypt/plain/doc/html/Data%20Leaks.html
  [1132]: https://web.archive.org/web/https://dolosgroup.io/blog/2021/7/9/from-stolen-laptop-to-inside-the-company-network
  [1133]: https://web.archive.org/web/https://trmm.net/tpm-sniffing/
  [1134]: https://nitter.net/SecurityJon/status/1445020885472235524
  [1135]: https://web.archive.org/web/https://labs.f-secure.com/blog/sniff-there-leaks-my-bitlocker-key/
  [1136]: https://web.archive.org/web/https://www.veracrypt.fr/en/VeraCrypt%20Rescue%20Disk.html
  [1137]: https://web.archive.org/web/20211009021236/https://repository.stcloudstate.edu/cgi/viewcontent.cgi?article=1141&context=msia_etds
  [1138]: https://web.archive.org/web/https://www.windowscentral.com/how-ensure-trim-enabled-windows-10-speed-ssd-performance
  [1139]: https://web.archive.org/web/https://veracrypt.eu/en/docs/trim-operation/
  [1140]: https://web.archive.org/web/https://i.blackhat.com/eu-18/Thu-Dec-6/eu-18-Schaub-Perfectly-Deniable-Steganographic-Disk-Encryption.pdf
  [1141]: https://web.archive.org/web/http://asalor.blogspot.com/2011/08/trim-dm-crypt-problems.html
  [1142]: https://wikiless.org/wiki/VirtualBox
  [1143]: https://web.archive.org/web/https://en.wikipedia.org/wiki/VirtualBox
  [1144]: https://web.archive.org/web/https://www.virtualbox.org/ticket/17987
  [1145]: https://wikiless.org/wiki/Whonix
  [1146]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Whonix
  [1147]: https://web.archive.org/web/https://docs.oracle.com/en/virtualization/virtualbox/6.0/user/snapshots.html
  [1148]: https://wikiless.org/wiki/Spectre_(security_vulnerability)
  [1149]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Spectre_(security_vulnerability)
  [1150]: https://wikiless.org/wiki/Meltdown_(security_vulnerability)
  [1151]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Meltdown_(security_vulnerability)
  [1152]: https://web.archive.org/web/https://www.whonix.org/wiki/Stream_Isolation#By_Settings
  [1153]: https://wikiless.org/wiki/Time-based_One-time_Password_algorithm
  [1154]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Time-based_One-time_Password_algorithm
  [1155]: https://wikiless.org/wiki/Multi-factor_authentication
  [1156]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Multi-factor_authentication
  [1157]: https://web.archive.org/web/https://www.whonix.org/wiki/Whonix-Gateway_Security#Warning:_Bridged_Networking
  [1158]: https://web.archive.org/web/https://www.qubes-os.org/faq/#is-qubes-just-another-linux-distribution
  [1159]: https://web.archive.org/web/https://www.qubes-os.org/doc/system-requirements/
  [1160]: https://web.archive.org/web/https://github.com/QubesOS/qubes-issues/issues/2414
  [1161]: https://wikiless.org/wiki/AppArmor
  [1162]: https://web.archive.org/web/https://en.wikipedia.org/wiki/AppArmor
  [1163]: https://wikiless.org/wiki/Security-Enhanced_Linux
  [1164]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Security-Enhanced_Linux
  [1165]: https://wikiless.org/wiki/CAPTCHA
  [1166]: https://web.archive.org/web/https://en.wikipedia.org/wiki/CAPTCHA
  [1167]: https://wikiless.org/wiki/Turing_test
  [1168]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Turing_test
  [1169]: https://web.archive.org/web/https://www.google.com/recaptcha/about/
  [1170]: https://web.archive.org/web/https://www.hcaptcha.com/
  [1171]: https://web.archive.org/web/https://www.hcaptcha.com/post/hcaptcha-now-the-largest-independent-captcha-service
  [1172]: https://web.archive.org/web/https://nearcyan.com/you-probably-dont-need-recaptcha/
  [1173]: https://web.archive.org/web/https://arstechnica.com/gadgets/2017/03/googles-recaptcha-announces-invisible-background-captchas/
  [1174]: https://web.archive.org/web/https://www.blackhat.com/docs/asia-16/materials/asia-16-Sivakorn-Im-Not-a-Human-Breaking-the-Google-reCAPTCHA-wp.pdf
  [1175]: https://web.archive.org/web/https://security.googleblog.com/2014/12/are-you-robot-introducing-no-captcha.html
  [1176]: https://web.archive.org/web/https://blog.cloudflare.com/cloudflare-supports-privacy-pass/
  [1177]: https://wikiless.org/wiki/Device_fingerprint
  [1178]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Device_fingerprint
  [1179]: https://web.archive.org/web/https://developers.googleblog.com/2020/08/guidance-for-our-effort-to-block-less-secure-browser-and-apps.html
  [1180]: https://web.archive.org/web/https://support.google.com/accounts/answer/10071085
  [1181]: https://wikiless.org/wiki/Dark_pattern
  [1182]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Dark_pattern
  [1183]: https://web.archive.org/web/https://www.theverge.com/2020/1/23/21077423/tinder-photo-verification-blue-checkmark-safety-center-launch-noonlight
  [1184]: https://web.archive.org/web/https://www.digitalinformationworld.com/2020/03/facebook-is-now-demanding-some-users-to-create-a-video-selfie-for-identity-verification.html
  [1185]: https://web.archive.org/web/https://www.vice.com/en/article/m7a4eq/pornhub-new-verification-policy-biometric-id
  [1186]: https://web.archive.org/web/https://variety.com/2021/digital/news/china-censorship-hotline-historical-nihilism-1234950554/
  [1187]: https://wikiless.org/wiki/Zero_trust_security_model
  [1188]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Zero_trust_security_model
  [1189]: https://wikiless.org/wiki/Espionage
  [1190]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Espionage
  [1191]: https://web.archive.org/web/https://kcimc.medium.com/how-to-recognize-fake-ai-generated-images-4d1f6f9a2842
  [1192]: https://web.archive.org/web/https://blog.jayway.com/2020/03/06/using-ml-to-detect-fake-face-images-created-by-ai/
  [1193]: https://wikiless.org/wiki/SIM_swap_scam
  [1194]: https://web.archive.org/web/https://en.wikipedia.org/wiki/SIM_swap_scam
  [1195]: https://web.archive.org/web/https://www.whonix.org/wiki/Tor
  [1196]: https://web.archive.org/web/https://support.torproject.org/tbb/tbb-editing-torrc/
  [1197]: https://web.archive.org/web/https://support.google.com/accounts/answer/114129?hl=en
  [1198]: https://web.archive.org/web/https://support.google.com/google-ads/answer/7474263?hl=en
  [1199]: https://web.archive.org/web/https://support.google.com/accounts/answer/40695
  [1200]: https://web.archive.org/web/https://support.google.com/accounts/contact/disabled2
  [1201]: https://web.archive.org/web/https://support.google.com/accounts/answer/1333913?hl=en
  [1202]: https://web.archive.org/web/https://www.jumio.com/features/
  [1203]: https://web.archive.org/web/https://privacyguides.org/providers/email/
  ...
  [1204]: https://web.archive.org/web/https://protonmail.com/support/knowledge-base/human-verification/
  [1205]: https://web.archive.org/web/https://knowyourmeme.com/memes/good-luck-im-behind-7-proxies
  [1206]: https://wikiless.org/wiki/End-to-end_encryption
  [1207]: https://web.archive.org/web/https://en.wikipedia.org/wiki/End-to-end_encryption
  [1208]: https://wikiless.org/wiki/Forward_secrecy
  [1209]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Forward_secrecy
  [1210]: https://web.archive.org/web/https://protonmail.com/blog/zero-access-encryption/
  [1211]: https://wikiless.org/wiki/Facebook%E2%80%93Cambridge_Analytica_data_scandal
  [1212]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Facebook%E2%80%93Cambridge_Analytica_data_scandal
  [1213]: https://web.archive.org/web/https://signal.org/blog/sealed-sender/
  [1214]: https://web.archive.org/web/https://signal.org/blog/private-contact-discovery/
  [1215]: https://web.archive.org/web/https://signal.org/blog/signal-private-group-system/
  [1216]: https://web.archive.org/web/https://privacyguides.org/software/file-sharing/
  [1217]: https://web.archive.org/web/https://privacyguides.org/software/real-time-communication/
  [1218]: https://web.archive.org/web/https://getsession.org/session-protocol-explained/
  [1219]: https://web.archive.org/web/https://blog.quarkslab.com/audit-of-session-secure-messaging-application.html
  [1220]: https://yewtu.be/watch?v=aVwl892hqb4
  [1221]: https://wikiless.org/wiki/InterPlanetary_File_System
  [1222]: https://web.archive.org/web/https://en.wikipedia.org/wiki/InterPlanetary_File_System
  [1223]: https://web.archive.org/web/https://www.praxisfilms.org/open-letter-from-laura-poitras/
  [1224]: https://wikiless.org/wiki/SecureDrop
  [1225]: https://web.archive.org/web/https://en.wikipedia.org/wiki/SecureDrop
  [1226]: https://wikiless.org/wiki/Trusted_Platform_Module
  [1227]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Trusted_Platform_Module
  [1228]: https://wikiless.org/wiki/Pastebin
  [1229]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Pastebin
  [1230]: https://wikiless.org/wiki/Wear_leveling
  [1231]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Wear_leveling
  [1232]: https://wikiless.org/wiki/Write_amplification
  [1233]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Write_amplification
  [1234]: https://web.archive.org/web/https://techgage.com/article/too_trim_when_ssd_data_recovery_is_impossible/
  [1235]: https://web.archive.org/web/https://www.researchgate.net/publication/341761017_Live_forensics_method_for_acquisition_on_the_Solid_State_Drive_SSD_NVMe_TRIM_function
  [1236]: https://web.archive.org/web/https://blog.elcomsoft.com/2019/01/life-after-trim-using-factory-access-mode-for-imaging-ssd-drives/
  [1237]: https://web.archive.org/web/https://www.forensicfocus.com/articles/forensic-acquisition-of-solid-state-drives-with-open-source-tools/
  [1238]: https://web.archive.org/web/https://www.researchgate.net/publication/325976653_Solid_State_Drive_Forensics_Where_Do_We_Stand
  [1239]: https://wikiless.org/wiki/Parted_Magic
  [1240]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Parted_Magic
  [1241]: https://wikiless.org/wiki/Hdparm
  [1242]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Hdparm
  [1243]: https://web.archive.org/web/https://github.com/linux-nvme/nvme-cli
  [1244]: https://web.archive.org/web/https://partedmagic.com/secure-erase/
  [1245]: https://web.archive.org/web/https://partedmagic.com/nvme-secure-erase/
  [1246]: https://web.archive.org/web/https://www.ufsexplorer.com/solutions/data-recovery-on-encrypted-storage.php
  [1247]: https://web.archive.org/web/https://developer.apple.com/library/archive/documentation/FileManagement/Conceptual/APFS_Guide/FAQ/FAQ.html
  [1248]: https://web.archive.org/web/https://privacyguides.org/software/productivity/
  [1249]: https://web.archive.org/web/https://www.whonix.org/wiki/Metadata
  [1250]: https://web.archive.org/web/https://gitlab.tails.boum.org/tails/blueprints/-/wikis/doc/mat/
  [1251]: https://web.archive.org/web/https://disable-gatekeeper.github.io/
  [1252]: https://web.archive.org/web/https://help.duckduckgo.com/duckduckgo-help-pages/features/cache/
  [1253]: https://web.archive.org/web/https://help.duckduckgo.com/duckduckgo-help-pages/results/sources/
  [1254]: https://wikiless.org/wiki/Dead_drop
  [1255]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Dead_drop
  [1256]: https://wikiless.org/wiki/Obfuscation
  [1257]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Obfuscation
  [1258]: https://wikiless.org/wiki/Kleptography
  [1259]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Kleptography
  [1260]: https://wikiless.org/wiki/Koalang
  [1261]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Koalang
  [1262]: https://wikiless.org/wiki/Operations_security
  [1263]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Operations_security
  [1264]: https://web.archive.org/web/https://quoteinvestigator.com/2014/07/13/truth/
  [1265]: https://web.archive.org/web/https://privacyguides.org/operating-systems/
  [1266]: https://web.archive.org/web/https://support.brave.com/hc/en-us/articles/360018121491-What-is-a-Private-Window-with-Tor-
  [1267]: https://web.archive.org/web/https://medium.com/velociraptor-ir/the-windows-usn-journal-f0c55c9010e
  [1268]: https://web.archive.org/web/https://medium.com/velociraptor-ir/digging-into-the-system-resource-usage-monitor-srum-afbadb1a375
  [1269]: https://web.archive.org/web/https://www.sans.org/blog/timestamped-registry-ntfs-artifacts-from-unallocated-space/
  [1270]: https://web.archive.org/web/https://dban.org/
  [1271]: https://web.archive.org/web/https://crystalmark.info/en/software/crystaldiskinfo/
  [1272]: https://wikiless.org/wiki/Faraday_cage
  [1273]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Faraday_cage
  [1274]: https://web.archive.org/web/20211011220410/https://ro.ecu.edu.au/cgi/viewcontent.cgi?article=1165&context=adf
  [1275]: https://web.archive.org/web/https://arxiv.org/abs/1512.05616
  [1276]: https://web.archive.org/web/https://dl.acm.org/doi/pdf/10.1145/3309074.3309076
  [1277]: https://yewtu.be/watch?v=sO98kDLkh-M
  [1278]: https://wikiless.org/wiki/Touch_DNA
  [1279]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Touch_DNA
  [1280]: https://web.archive.org/web/https://www.yourdnaguide.com/ydgblog/dna-hair-samples-postage-stamps
  [1281]: https://web.archive.org/web/https://github.com/mhinkie/ooni-detection
  [1282]: https://wikiless.org/wiki/File_verification
  [1283]: https://web.archive.org/web/https://en.wikipedia.org/wiki/File_verification
  [1284]: https://wikiless.org/wiki/Cyclic_redundancy_check
  [1285]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Cyclic_redundancy_check
  [1286]: https://wikiless.org/wiki/MD5
  [1287]: https://web.archive.org/web/https://en.wikipedia.org/wiki/MD5
  [1288]: https://wikiless.org/wiki/Collision_(computer_science)
  [1289]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Collision_(computer_science)
  [1290]: https://wikiless.org/wiki/Secure_Hash_Algorithms
  [1291]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Secure_Hash_Algorithms
  [1292]: https://wikiless.org/wiki/SHA-2
  [1293]: https://web.archive.org/web/https://en.wikipedia.org/wiki/SHA-2
  [1294]: https://wikiless.org/wiki/Collision_resistance
  [1295]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Collision_resistance
  [1296]: https://web.archive.org/web/https://wiki.gnupg.org/Gpg4win/CheckIntegrity
  [1297]: https://web.archive.org/web/https://medium.com/@EvgeniIvanov/how-to-verify-checksum-on-mac-988f166b0c4f
  [1298]: https://wikiless.org/wiki/GNU_Privacy_Guard
  [1299]: https://web.archive.org/web/https://en.wikipedia.org/wiki/GNU_Privacy_Guard
  [1300]: https://wikiless.org/wiki/Public-key_cryptography
  [1301]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Public-key_cryptography
  [1302]: https://wikiless.org/wiki/Polymorphic_code
  [1303]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Polymorphic_code
  [1304]: https://web.archive.org/web/https://www.whonix.org/wiki/Malware_and_Firmware_Trojans
  [1305]: https://web.archive.org/web/https://forums.whonix.org/t/installation-of-antivirus-scanners-by-default/9755/8
  [1306]: https://web.archive.org/web/https://www.av-test.org/fileadmin/pdf/security_report/AV-TEST_Security_Report_2018-2019.pdf
  [1307]: https://web.archive.org/web/https://www.zdnet.com/article/eset-discovers-21-new-linux-malware-families/
  [1308]: https://web.archive.org/web/https://nakedsecurity.sophos.com/2019/07/25/evilgnome-linux-malware-aimed-at-your-laptop-not-your-servers/
  [1309]: https://web.archive.org/web/https://blog.imunify360.com/hiddenwasp-how-to-detect-malware-hidden-on-linux-iot
  [1310]: https://wikiless.org/wiki/Linux_malware
  [1311]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Linux_malware
  [https://en.wikipedia.org/wiki/macOS_malware]: https://en.wikipedia.org/wiki/MacOS_malware
  [1312]: https://wikiless.org/wiki/MacOS_malware
  [1313]: https://web.archive.org/web/https://en.wikipedia.org/wiki/MacOS_malware
  [1314]: https://web.archive.org/web/https://www.macworld.co.uk/feature/mac-viruses-list-3668354/
  [1315]: https://web.archive.org/web/https://resources.jamf.com/documents/macmalware-2020.pdf
  [1316]: https://web.archive.org/web/https://imagetragick.com/
  [1317]: https://web.archive.org/web/https://docs.oracle.com/en/virtualization/virtualbox/6.0/admin/hyperv-support.html
  [1318]: https://web.archive.org/web/https://zeltser.com/analyzing-malicious-documents/
  [1319]: https://wikiless.org/wiki/Portable_application
  [1320]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Portable_application
  [1321]: https://web.archive.org/web/https://ebin.city/~werwolf/posts/brave-is-shit/
  [1322]: https://web.archive.org/web/https://support.brave.com/hc/en-us/articles/360022973471-What-is-Shields
  [1323]: https://web.archive.org/web/https://venturebeat.com/2020/01/15/browser-benchmark-battle-january-2020-chrome-firefox-edge-brave/view-all/
  [1324]: https://web.archive.org/web/https://madaidans-insecurities.github.io/firefox-chromium.html
  [1325]: https://web.archive.org/web/https://grapheneos.org/usage#web-browsing
  [1326]: https://web.archive.org/web/https://www.researchgate.net/publication/349979628_Web_Browser_Privacy_What_Do_Browsers_Say_When_They_Phone_Home
  [1327]: https://web.archive.org/web/https://qua3k.github.io/ungoogled/
  [1328]: https://web.archive.org/web/https://docs.microsoft.com/en-us/deployedge/microsoft-edge-security-windows-defender-application-guard
  [1329]: https://web.archive.org/web/https://www.pcmag.com/news/mozilla-signs-lucrative-3-year-google-search-deal-for-firefox
  [1330]: https://wikiless.org/wiki/Virtualization
  [1331]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Virtualization
  [1332]: https://web.archive.org/web/https://github.com/Yawning/obfs4/
  [1333]: https://web.archive.org/web/https://tb-manual.torproject.org/circumvention/
  [1334]: https://wikiless.org/wiki/Domain_fronting
  [1335]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Domain_fronting
  [1336]: https://web.archive.org/web/https://gitlab.torproject.org/tpo/applications/tor-browser/-/issues/17569
  [1337]: https://web.archive.org/web/https://www.vice.com/en/article/93ypke/the-nsa-and-cia-use-ad-blockers-because-online-advertising-is-so-dangerous
  [1338]: https://web.archive.org/web/https://www.tbstat.com/wp/uploads/2020/06/Europol-Wasabi-Wallet-Report.pdf
  [1339]: https://web.archive.org/web/https://www.sans.org/blog/nist-has-spoken-death-to-complexity-long-live-the-passphrase/
  [1340]: https://web.archive.org/web/https://www.zdnet.com/article/fbi-recommends-passphrases-over-password-complexity/
  [1341]: https://27m3p2uv7igmj6kvd4ql3cct5h3sdwrsajovkkndeufumzyfhlfev4qd.onion/2015/03/26/passphrases-can-memorize-attackers-cant-guess/
  [1342]: https://web.archive.org/web/https://theintercept.com/2015/03/26/passphrases-can-memorize-attackers-cant-guess/
  [1343]: https://web.archive.org/web/https://protonmail.com/blog/protonmail-com-blog-password-vs-passphrase/
  [1344]: https://yewtu.be/watch?v=yzGzB-yYKcc
  [1345]: https://wikiless.org/wiki/Passphrase#Passphrase_selection
  [1346]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Passphrase#Passphrase_selection
  [1347]: https://web.archive.org/web/https://github.com/insight-decentralized-consensus-lab/post-quantum-monero/blob/master/writeups/technical_note.pdf
