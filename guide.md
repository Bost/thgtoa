...
Version 1.1.0, October 2021 by AnonymousPlanet.
...
**If you are having trouble accessing any of the many academic articles referenced in this guide due to paywalls, feel free to use Sci-Hub (<https://en.wikipedia.org/wiki/Sci-Hub>** <sup>[[Wikiless]][33]</sup> <sup>[[Archive.org]][34]</sup>**) or LibGen (<https://en.wikipedia.org/wiki/Library_Genesis>** <sup>[[Wikiless]][35]</sup> <sup>[[Archive.org]][36]</sup>**) for finding and reading them. Because Science should be free. All of it.**
...
If you skipped those, you should really still consider viewing this YouTube playlist from the Techlore Go Incognito project (<https://github.com/techlore-official/go-incognito> <sup>[[Archive.org]][44]</sup>) as an introduction before going further: <https://www.youtube.com/playlist?list=PL3KeV6Ui_4CayDGHw64OFXEPHgXLkrtJO> <sup>[[Invidious]][45]</sup>. This guide will cover many of the topics in the videos of this playlist with more details and references as well as some added topics not covered within that series. This will just take you 2 or 3 hours to watch it all.
...
Here is a video explaining DNS visually if you are already lost: <https://www.youtube.com/watch?v=vrxwXXytEuI> <sup>[[Invidious]][46]</sup>
...
Here is a list of how various browsers behave with OCSP: <https://www.ssl.com/blogs/how-do-browsers-handle-revoked-ssl-tls-certificates/> <sup>[[Archive.org]][49]</sup>
...
One could also decide to use a Tor Hidden DNS Service or ODoH (Oblivious DNS over HTTPS[^53]) to further increase privacy/anonymity but **unfortunately**, as far as I know, these methods are only provided by Cloudflare as of this writing (<https://blog.cloudflare.com/welcome-hidden-resolver/> <sup>[[Archive.org]][51]</sup>, <https://blog.cloudflare.com/oblivious-dns/> <sup>[[Archive.org]][52]</sup>). These are workable and reasonably secure technical options but there is also a moral choice if you want to use Cloudflare or not (despite the risk posed by some researchers[^54]).

Lastly, there is also this new possibility called DoHoT which stands for DNS over HTTPS over Tor which could also further increase your privacy/anonymity and which you could consider if you are more skilled with Linux. See <https://github.com/alecmuffett/dohot> <sup>[[Archive.org]][53]</sup>. This guide will not help you with this one at this stage, but it might be coming soon.
...
More information over at Wikipedia: <https://en.wikipedia.org/wiki/Radio-frequency_identification#Security_concerns> <sup>[[Wikiless]][56]</sup> <sup>[[Archive.org]][57]</sup> and <https://en.wikipedia.org/wiki/Radio-frequency_identification#Privacy> <sup>[[Wikiless]][56]</sup> <sup>[[Archive.org]][57]</sup>
...
But that is not what all those Wi-Fi access points can do. Recently developed techs could even allow someone to track your movements accurately just based on radio interferences. What this means is that it is possible to track your movement inside a room/building based on the radio signals passing through. This might seem like a tinfoil hat conspiracy theory claim but here are the references[^60] with demonstrations showing this tech in action: <http://rfpose.csail.mit.edu/> <sup>[[Archive.org]][58]</sup> and the video here: <https://www.youtube.com/watch?v=HgDdaMy8KNE> <sup>[[Invidious]][59]</sup>
...
These have been used at least since 2008 using an attack called "Jasager"[^61] and can be done by anyone using self-built tools or using commercially available devices such as Wi-Fi Pineapple[^62].
...
These devices can fit in a small bag and can take over the Wi-Fi environment of any place within their range. For instance, a Bar/Restaurant/Café/Hotel Lobby. These devices can force Wi-Fi clients to disconnect from their current Wi-Fi (using de-authentication, disassociation attacks[^63]) while spoofing the normal Wi-Fi networks at the same location. They will continue to perform this attack until your computer, or you decide to try to connect to the rogue AP.

These devices can then mimic a captive portal[^64] with the exact same layout as the Wi-Fi you are trying to access (for instance an Airport Wi-Fi registration portal). Or they could just give you unrestricted access internet that they will themselves get from the same place.
...
Tor and VPNs are not silver bullets. Many advanced techniques have been developed and studied to de-anonymize encrypted Tor traffic over the years[^65]. Most of those techniques are Correlation attacks that will correlate your network traffic in one way or another to logs or datasets. Here are some examples:

-   **Correlation Fingerprinting Attack:** As illustrated (simplified) below, this attack will fingerprint your encrypted Tor traffic (like the websites you visited) based on the analysis of your encrypted traffic without decrypting it. Some of those methods can do so with a 96% success rate **in a closed-world setting**. **The efficacy of those methods in a real open-world setting** **has not been demonstrated yet and would probably require tremendous resources computing power making it very unlikely that such techniques would be used by a local adversary in the near future.** Such techniques could however hypothetically be used by an advanced and probably global adversary with access to your source network to determine some of your activity. Examples of those attacks are described in several research papers[^66]'[^67]'[^68] as well as their limitations[^69]. The Tor Project itself published an article about these attacks with some mitigations: <https://blog.torproject.org/new-low-cost-traffic-analysis-attacks-mitigations> <sup>[[Archive.org]][64]</sup>.

![][65]

-   **Correlation Timing Attacks:** As illustrated (simplified) below, an adversary that has access to network connection logs (IP or DNS for instance, remember that most VPN servers and most Tor nodes are known and publicly listed) at the source and the destination could correlate the timings to de-anonymize you without requiring any access to the Tor or VPN network in between. A real use case of this technique was done by the FBI in 2013 to de-anonymize[^70] a bomb threat hoax at Harvard University.
...
Be aware again that this might not be enough against a motivated global adversary[^71] with wide access to global mass surveillance. Such an adversary might have access to logs no matter where you are and could use those to de-anonymize you. **These adversaries are out of the scope of this guide.**
...
I also strongly recommend reading this very good, complete, and thorough (and more detailed) guide on most known Attack Vectors on Tor: <https://github.com/Attacks-on-Tor/Attacks-on-Tor> <sup>[[Archive.org]][68]</sup> as well as this recent research publication <https://www.researchgate.net/publication/323627387_Shedding_Light_on_the_Dark_Corners_of_the_Internet_A_Survey_of_Tor_Research> <sup>[[Archive.org]][69]</sup>

As well as this great series of blog posts: <https://www.hackerfactor.com/blog/index.php?/archives/906-Tor-0day-The-Management-Vulnerability.html> <sup>[[Archive.org]][70]</sup>

Lastly, do remember that using Tor can already be considered suspicious activity[^72], and its use could be considered malicious by some[^73].
...
-   iPhones and iPads (IOS 13 and above)[^74]'[^75]

-   Samsung Phones (Android 10 and above)[^76]

-   MacBooks (macOS 10.15 and above)[^77]

Such devices will continue to broadcast identity information to nearby devices even when offline using Bluetooth Low-Energy[^78]. They do not have access to the devices directly (which are not connected to the internet) but instead use BLE to find them through other nearby devices[^79]. They are using peer-to-peer short-range Bluetooth communication to broadcast their status through nearby online devices.
...
-   The smartphone OS makers (Google/Apple for Android/IOs) also keep logs of IMEI/IMSI identifications tied to Google/Apple accounts and which user has been using them. They too can trace back the history of the phone and to which accounts it was tied in the past[^88].

-   Government agencies around the world interested in your phone number can and do use[^89] special devices called "IMSI catchers"[^90] like the Stingray[^91] or more recently the Nyxcell[^92]. These devices can impersonate (to spoof) a cell phone Antenna and force a specific IMSI (your phone) to connect to it to access the cell network. Once they do, they will be able to use various MITM[^93] (Man-In-The-Middle Attacks) that will allow them to:
...
Here is also a good YouTube video on this topic: DEFCON Safe Mode - Cooper Quintin - Detecting Fake 4G Base Stations in Real-Time <https://www.youtube.com/watch?v=siCk4pGGcqA> <sup>[[Invidious]][72]</sup>
...
Some commercial devices will keep a record of MAC addresses roaming around for various purposes such as road congestion[^96].
...
Operating systems have protections in place to randomize those addresses but are still subject to vulnerabilities[^97].
...
All modern CPUs[^98] are now integrating hidden management platforms such as the now infamous Intel Management Engine[^99] and the AMD Platform Security Processor[^100].

Those management platforms are small operating systems running directly on your CPU as long as they have power. These systems have full access to your computer's network and could be accessed by an adversary to de-anonymize you in various ways (using direct access or using malware for instance) as shown in this enlightening video: BlackHat, How to Hack a Turned-Off Computer, or Running Unsigned Code in Intel Management Engine <https://www.youtube.com/watch?v=mYsTBPqbya8> <sup>[[Invidious]][73]</sup>.

These have already been affected by several security vulnerabilities in the past[^101] that allowed malware to gain control of target systems. These are also accused by many privacy actors including the EFF and Libreboot of being a backdoor into any system[^102].

There are some not so straightforward ways[^103] to disable the Intel IME on some CPUs and you should do so if you can. For some AMD laptops, you can disable it within the BIOS settings by disabling PSP.

Note that to AMD's defense, so far and AFAIK, there were no security vulnerabilities found for ASP and no backdoors either: See <https://www.youtube.com/watch?v=bKH5nGLgi08&t=2834s> <sup>[[Invidious]][74]</sup>. In addition, AMD PSP does not provide any remote management capabilities contrary to Intel IME.

If you are feeling a bit more adventurous, you could install your own BIOS using Libreboot[^104] or Coreboot[^296] if your laptop supports it (be aware that Coreboot does contain some propriety code unlike its fork Libreboot).

In addition, some CPUs have unfixable flaws (especially Intel CPUs) that could be exploited by various malware. Here is a good current list of such vulnerabilities affecting recent widespread CPUs: <https://en.wikipedia.org/wiki/Transient_execution_CPU_vulnerability> <sup>[[Wikiless]][75]</sup> <sup>[[Archive.org]][76]</sup>

Check yourself:

-   If you are using Linux you can check the vulnerability status of your CPU to Spectre/Meltdown attacks by using <https://github.com/speed47/spectre-meltdown-checker> <sup>[[Archive.org]][77]</sup> which is available as a package for most Linux distros including Whonix.

-   If you are using Windows, you can check the vulnerability status of your CPU using inSpectre <https://www.grc.com/inspectre.htm> <sup>[[Archive.org]][78]</sup>

Some of these can be avoided using Virtualization Software settings that can mitigate such exploits. See this guide for more information <https://www.whonix.org/wiki/Spectre_Meltdown> <sup>[[Archive.org]][79]</sup> (warning: these can severely impact the performance of your VMs).
...
Whether it is Android, iOS, Windows, macOS, or even Ubuntu. Most popular Operating Systems now collect telemetry information by default even if you never opt-in or opted-out[^108] from the start. Some like Windows will not even allow disabling telemetry completely without some technical tweaks. This information collection can be extensive and include a staggering number of details (metadata and data) on your devices and their usage.

Here are good overviews of what is being collected by those five popular OSes in their last versions:

-   Android/Google:

    -   Just have a read at their privacy policy <https://policies.google.com/privacy> <sup>[[Archive.org]][80]</sup>

    -   School of Computer Science & Statistics, Trinity College Dublin, Ireland Mobile Handset Privacy: Measuring The Data iOS and Android Send to Apple And Google <https://www.scss.tcd.ie/doug.leith/apple_google.pdf> <sup>[[Archive.org]][81]</sup>

-   IOS/Apple:

    -   More information at <https://www.apple.com/legal/privacy/en-ww/> <sup>[[Archive.org]][82]</sup> and <https://support.apple.com/en-us/HT202100> <sup>[[Archive.org]][83]</sup>

    -   School of Computer Science & Statistics, Trinity College Dublin, Ireland Mobile Handset Privacy: Measuring The Data iOS and Android Send to Apple And Google <https://www.scss.tcd.ie/doug.leith/apple_google.pdf> <sup>[[Archive.org]][81]</sup>

    -   Apple does claim[^105] that they anonymize this data using differential privacy[^106] but you will have to trust them on that.

-   Windows/Microsoft:

    -   Full list of required diagnostic data: <https://docs.microsoft.com/en-us/windows/privacy/required-windows-diagnostic-data-events-and-fields-2004> <sup>[[Archive.org]][84]</sup>

    -   Full list of optional diagnostic data: <https://docs.microsoft.com/en-us/windows/privacy/windows-diagnostic-data> <sup>[[Archive.org]][85]</sup>

-   macOS:

    -   More details on <https://support.apple.com/guide/mac-help/share-analytics-information-mac-apple-mh27990/mac> <sup>[[Archive.org]][86]</sup>

-   Ubuntu:

    -   Ubuntu despite being a Linux distribution also collects Telemetry Data nowadays. This data however is quite limited compared to the others. More details on <https://ubuntu.com/desktop/statistics> <sup>[[Archive.org]][87]</sup>
...
Data is being transmitted even if you opt-out[^108], processed, and stored indefinitely (most likely unencrypted[^109]) by various third parties[^110].
...
-   Your Fitness Devices and Apps[^111]'[^112]? (Strava[^113]'[^114], Fitbit[^115], Garmin, Polar[^116], ...)

-   Your Smart Speaker? (Amazon Alexa[^117], Google Echo, Apple Homepod ...)

-   Your Smart Transportation? (Car? Scooter?)

-   Your Smart Tags? (Apple AirTag, Galaxy SmartTag, Tile...)

-   Your Car? (Yes, most modern cars have advanced logging/tracking features these days[^118])
...
Your metadata is all the information about your activities without the actual content of those activities. For instance, it is like knowing you had a call from an oncologist before then calling your family and friends successively. You do not know what was said during the conversation, but you can guess what it was just from the metadata[^119].

This metadata will also often include your location that is being harvested by Smartphones, Operating Systems (Android[^120]/IOS), Browsers, Apps, Websites. Odds are several companies are knowing exactly where you are at any time[^121] because of your smartphone[^122].

This location data has been used in many judicial cases[^123] already as part of "geofence warrants" [^124] that allow law enforcement to ask companies (such as Google/Apple) a list of all devices present at a certain location at a certain time. In addition, this location data is even sold by private companies to the military who can then use it conveniently[^125]. These warrants are becoming widely used by law enforcement[^126]'[^127].
...
The question is: Is there someone somewhere that would have both pieces of information available[^128] for correlation in a convenient database?

Have you heard of Edward Snowden[^129]? Now is the time to google him and read his book[^130]. Also read about XKEYSCORE[^131]'[^132], MUSCULAR[^133], SORM[^134], Tempora[^135] , and PRISM[^136].

See "We kill people based on Metadata"[^137] or this famous tweet from the IDF <https://twitter.com/idf/status/1125066395010699264> <sup>[[Archive.org]][88]</sup> <sup>[[Nitter]][89]</sup>.

See [Appendix N: Warning about smartphones and smart devices]

### Your Digital Fingerprint, Footprint, and Online Behavior:

This is the part where you should watch the documentary "The Social Dilemma"[^138] on Netflix as they cover this topic much better than anyone else IMHO.

This includes is the way you write (stylometry) [^139]'[^140], the way you behave[^141]'[^142]. The way you click. The way you browse. The fonts you use on your browser[^143]. Fingerprinting is being used to guess who someone is by the way that user is behaving. You might be using specific pedantic words or making specific spelling mistakes that could give you away using a simple Google search for similar features because you typed comparably on some Reddit post 5 years ago using a not so anonymous Reddit account[^144]. The words you type in a search engine alone can be used against you as the authorities now have warrants to find users who used specific keywords in search engines[^145].
...
-   Specialized companies are selling to, for example, law enforcement agencies products for analyzing social network activities such as <https://mediasonar.com/> <sup>[[Archive.org]][90]</sup>

-   For example, as a basis of authentication, a user's typing speed, keystroke depressions, patterns of error (say accidentally hitting an "l" instead of a "k" on three out of every seven transactions) and mouse movements establish that person's unique pattern of behavior[^146]. Some commercial services such as TypingDNA (<https://www.typingdna.com/> <sup>[[Archive.org]][91]</sup>) even offer such analysis as a replacement for two-factor authentications.

-   This technology is also widely used in CAPTCHAS[^364] services to verify that you are "human" and can be used to fingerprint a user.
...
-   2017, Behavior Analysis in Social Networks, <https://link.springer.com/10.1007/978-1-4614-7163-9_110198-1> <sup>[[Archive.org]][92]</sup>

-   2017, Social Networks and Positive and Negative Affect <https://www.sciencedirect.com/science/article/pii/S1877042811013747/pdf?md5=253d8f1bb615d5dee195d353dc077d46&pid=1-s2.0-S1877042811013747-main.pdf> <sup>[[Archive.org]][93]</sup>

-   2015, Using Social Networks Data for Behavior and Sentiment Analysis <https://www.researchgate.net/publication/300562034_Using_Social_Networks_Data_for_Behavior_and_Sentiment_Analysis> <sup>[[Archive.org]][94]</sup>

-   2016, A Survey on User Behavior Analysis in Social Networks <https://www.academia.edu/30936118/A_Survey_on_User_Behaviour_Analysis_in_Social_Networks> <sup>[[Archive.org]][95]</sup>

-   2019, In­fluence and Behavior Analysis in Social Networks and Social Media <https://sci-hub.se/10.1007/978-3-030-02592-2> <sup>[[Archive.org]][96]</sup>
...
A real use and well-documented case of this was the arrest of the hacker Jeremy Hammond[^147] who shared over time several details about his past and was later discovered.

There are also a few cases involving OSINT at Bellingcat[^148]. Have a look at their very informative (but slightly outdated) toolkit here: <https://docs.google.com/spreadsheets/d/18rtqh8EG2q1xBo2cLNyhIDuK9jrPGwYr9DI2UncoqJQ/edit#gid=930747607> <sup>[[Archive.org]][97]</sup>
...
-   <https://github.com/jivoi/awesome-osint> <sup>[[Archive.org]][98]</sup>
...
As well as this interesting Playlist on YouTube: <https://www.youtube.com/playlist?list=PLrFPX1Vfqk3ehZKSFeb9pVIHqxqrNW8Sy> <sup>[[Invidious]][99]</sup>
...
Companies like Facebook have used advanced face recognition for years[^149]'[^150] and have been using other means (Satellite imagery) to create maps of "people" around the world[^151]. This evolution has been going on for years to the point we can now say "We lost control of our faces"[^152].

If you are walking in a touristy place, you will most likely appear in someone's selfie within minutes without knowing it. That person could then go ahead and upload that selfie to various platforms (Twitter, Google Photos, Instagram, Facebook, Snapchat ...). Those platforms will then apply face recognition algorithms to those pictures under the pretext of allowing better/easier tagging or to better organize your photo library. In addition to this, the same picture will provide a precise timestamp and in most cases geolocation of where it was taken. Even if the person does not provide a timestamp and geolocation, it can still be guessed with other means[^153]'[^154].

Here are a few resources for even trying this yourself:

-   Bellingcat, Guide To Using Reverse Image Search For Investigations: <https://www.bellingcat.com/resources/how-tos/2019/12/26/guide-to-using-reverse-image-search-for-investigations/> <sup>[[Archive.org]][100]</sup>

-   Bellingcat, Using the New Russian Facial Recognition Site SearchFace <https://www.bellingcat.com/resources/how-tos/2019/02/19/using-the-new-russian-facial-recognition-site-searchface-ru/> <sup>[[Archive.org]][101]</sup>

-   Bellingcat, Dali, Warhol, Boshirov: Determining the Time of an Alleged Photograph from Skripal Suspect Chepiga <https://www.bellingcat.com/resources/how-tos/2018/10/24/dali-warhol-boshirov-determining-time-alleged-photograph-skripal-suspect-chepiga/> <sup>[[Archive.org]][102]</sup>

-   Bellingcat, Advanced Guide on Verifying Video Content <https://www.bellingcat.com/resources/how-tos/2017/06/30/advanced-guide-verifying-video-content/> <sup>[[Archive.org]][103]</sup>

-   Bellingcat, Using the Sun and the Shadows for Geolocation <https://www.bellingcat.com/resources/2020/12/03/using-the-sun-and-the-shadows-for-geolocation/> <sup>[[Archive.org]][104]</sup>

-   Bellingcat, Navalny Poison Squad Implicated in Murders of Three Russian Activists <https://www.bellingcat.com/news/uk-and-europe/2021/01/27/navalny-poison-squad-implicated-in-murders-of-three-russian-activists/> <sup>[[Archive.org]][105]</sup>

-   Bellingcat, Berlin Assassination: New Evidence on Suspected FSB Hitman Passed to German Investigators <https://www.bellingcat.com/news/2021/03/19/berlin-assassination-new-evidence-on-suspected-fsb-hitman-passed-to-german-investigators/> <sup>[[Archive.org]][106]</sup>

-   Bellingcat, Digital Research Tutorial: Investigating a Saudi-Led Coalition Bombing of a Yemen Hospital <https://www.youtube.com/watch?v=cAVZaPiVArA> <sup>[[Invidious]][107]</sup>

-   Bellingcat, Digital Research Tutorial: Using Facial Recognition in Investigations <https://www.youtube.com/watch?v=awY87q2Mr0E> <sup>[[Invidious]][108]</sup>

-   Bellingcat, Digital Research Tutorial: Geolocating (Allegedly) Corrupt Venezuelan Officials in Europe <https://www.youtube.com/watch?v=bS6gYWM4kzY> <sup>[[Invidious]][109]</sup>

Even if you are not looking at the camera, they can still figure out who you are[^155], make out your emotions[^156], analyze your gait[^157]'[^158]'[^159], read your lips[^160], analyze the behavior of your eyes[^161], and probably guess your political affiliation[^162]'[^163].

![][110]

(Illustration from <https://www.nature.com/articles/s41598-020-79310-1> <sup>[[Archive.org]][111]</sup>)

![][112]

(illustration from <https://rd.springer.com/chapter/10.1007/978-3-030-42504-3_15> <sup>[[Archive.org]][113]</sup>)
...
-   Even if you never made a profile on those platforms, you still have one without even knowing it[^164]'[^165]'[^166]'[^167]'[^168].
...
Governments already know who you are because they have your ID/Passport/Driving License pictures and often added biometrics (Fingerprints) in their database. Those same governments are integrating those technologies (often provided by private companies such as the Israeli AnyVision[^169], Clearview AI[^170]'[^171], or NEC[^172]) in their CCTV networks to look for "persons of interest"[^173]. And some heavily surveilled states like China have implemented widespread use of Facial Recognition for various purposes[^174]'[^175] including possibly identifying ethnic minorities[^176]. A simple face recognition error by some algorithm can ruin your life[^177]'[^178].

Here are some resources detailing some techniques used by Law Enforcement today:

-   CCC video explaining current Law Enforcement surveillance capabilities: <https://media.ccc.de/v/rc3-11406-spot_the_surveillance#t=761> <sup>[[Archive.org]][114]</sup>

-   EFF SLS: <https://www.eff.org/sls> <sup>[[Archive.org]][115]</sup>

Apple is making FaceID mainstream and pushing its use to log you into many services including the Banking systems.

The same goes with fingerprint authentication being mainstreamed by many smartphone makers to authenticate yourself. A simple picture where your fingers appear can be used to de-anonymize you[^179]'[^180]'[^181].

The same goes with your voice which can be analyzed for various purposes as shown in the recent Spotify patent[^182].

Even your iris can be used for identification in some places[^183].

We can safely imagine a near future where you will not be able to create accounts or sign in anywhere without providing unique biometrics (A suitable time to re-watch Gattaca[^184], Person of Interest[^185] , and Minority Report[^186]). And you can safely imagine how useful these large biometrics databases could be to some interested third parties.

In addition, all this information can also be used against you (if you are already de-anonymized) using deepfake[^187] by crafting false information (Pictures, Videos, Voice Recordings[^188]...) and have already been used for such purposes[^189]'[^190]. There are even commercial services for this readily available such as <https://www.respeecher.com/> <sup>[[Archive.org]][116]</sup> and <https://www.descript.com/overdub> <sup>[[Archive.org]][117]</sup>.

See this demo: <https://www.youtube.com/watch?v=t5yw5cR79VA> <sup>[[Invidious]][118]</sup>

At this time, there are a few steps[^191] you can use to mitigate (and only mitigate) face recognition when conducting sensitive activities where CCTV might be present:

-   Wear a facemask as they have been proven to defeat some face recognition technologies[^192] but not all[^193].
...
-   Consider wearing special sunglasses (expensive, unfortunately) called "Reflectacles" <https://www.reflectacles.com/> <sup>[[Archive.org]][119]</sup>. There was a small study showing their efficiency against IBM and Amazon facial recognition[^194].

-   All that might still be useless because of gait recognition mentioned earlier[^157] but there might be hope here if you have a 3D Printer: <https://gitlab.com/FG-01/fg-01> <sup>[[Archive.org]][120]</sup>
...
Phishing[^195] is a social engineering[^196] type of attack where an adversary could try to extract information from you by pretending or impersonating something/someone else.

A typical case is an adversary using a man-in-the-middle[^93] attack or a fake e-mail/call to ask for your credential for a service. This could for example be through e-mail or through impersonating financial services.
...
These have been used countless times since the early days of the internet and the usual one is called the "419 scam" (see <https://en.wikipedia.org/wiki/Advance-fee_scam> <sup>[[Wikiless]][121]</sup> <sup>[[Archive.org]][122]</sup>).

Here is a good video if you want to learn a bit more about phishing types: Black Hat, Ichthyology: Phishing as a Science <https://www.youtube.com/watch?v=Z20XNp-luNA> <sup>[[Invidious]][123]</sup>.
...
These could be simple pixel-sized images[^197] hidden in your e-mails that would call a remote server to try and get your IP address.

These could be exploiting a vulnerability in an outdated format or an outdated reader[^198]. Such exploits could then be used to compromise your system.

See these good videos for more explanations on the matter:

-   What is a File Format? <https://www.youtube.com/watch?v=VVdmmN0su6E> <sup>[[Invidious]][124]</sup>

-   Ange Albertini: Funky File Formats: <https://www.youtube.com/watch?v=hdCs6bPM4is> <sup>[[Invidious]][125]</sup>
...
So, you are using Tor Browser or Brave Browser over Tor. You could be using those over a VPN for added security. But you should keep in mind that there are exploits[^199] (hacks) that could be known by an adversary (but unknown to the App/Browser provider). Such exploits could be used to compromise your system and reveal details to de-anonymize you such as your IP address or other details.

A real use case of this technique was the Freedom Hosting[^200] case in 2013 where the FBI inserted malware[^201] using a Firefox browser exploit on a Tor website. This exploit allowed them to reveal details of some users. More recently, there was the notable SolarWinds[^202] hack that breached several US government institutions by inserting malware into an official software update server.

In some countries, Malware is just mandatory and/or distributed by the state itself. This is the case for instance in China with WeChat[^203] which can then be used in combination with other data for state surveillance[^204].
...
To reflect these recommendations, this guide will therefore later guide you in the use of Virtualization (See [Appendix W: Virtualization][Appendix V1: Hardening your Browsers:]) so that even if your Browser/Apps get compromised by a skilled adversary, that adversary will find himself stuck in a sandbox[^205] without being able to access identifying information or compromise your system.

### Malicious USB devices:

There are readily available commercial and cheap "badUSB" [^206]devices that can take deploy malware, log your typing, geolocate you, listen to you or gain control of your laptop just by plugging them in. Here are some examples that you can already buy yourself:

-   Hak5, USB Rubber Ducky <https://shop.hak5.org/products/usb-rubber-ducky-deluxe> <sup>[[Archive.org]][126]</sup>

-   Hak5, O.MG Cable <https://www.youtube.com/watch?v=V5mBJHotZv0> <sup>[[Invidious]][127]</sup>

-   Keelog <https://www.keelog.com/> <sup>[[Archive.org]][128]</sup>

-   AliExpress <https://www.aliexpress.com/i/4000710369016.html> <sup>[[Archive.org]][129]</sup>

Such devices can be implanted anywhere (charging cable, mouse, keyboard, USB key ...) by an adversary and can be used to track you or compromise your computer or smartphone. The most notable example of such attacks is probably Stuxnet[^207] in 2005.

While you could inspect a USB key physically, scan it with various utilities, check the various components to see if they are genuine, you will most likely never be able to discover complex malware embedded in genuine parts of a genuine USB key by a skilled adversary without advanced forensics equipment[^208].
...
Malware and backdoors can be embedded directly into your hardware components. Sometimes those backdoors are implemented by the manufacturer itself such as the IME in the case of Intel CPUs. And in other cases, such backdoors can be implemented by a third party that places itself between orders of new hardware and customer delivery[^209].

Such malware and backdoors can also be deployed by an adversary using software exploits. Many of those are called rootkits[^210] within the tech world. Usually, these types of malware are harder to detect and mitigate as they are implemented at a lower level than the userspace[^211] and often in the firmware[^212] of hardware components itself.

What is firmware? Firmware is a low-level operating system for devices. Each component in your computer probably has firmware including for instance your disk drives. The BIOS[^213]/UEFI[^214] system of your machine for instance is a type of firmware.
...
This also works for videos. Yes, videos too have geo-tagging, and many are very unaware of this. Here Is for instance a very convenient tool to geo-locate YouTube videos: <https://mattw.io/youtube-geofind/location> <sup>[[Archive.org]][131]</sup>
...
So, if you are a whistleblower and thinking about leaking some picture/audio/video file. Think twice. There are chances that those might contain invisible watermarking within them that would include information about you as a viewer. Such watermarks can be enabled with a simple switch in like Zoom (Video[^216] or Audio[^217]) or with extensions[^218] for popular apps such as Adobe Premiere Pro. These can be inserted by various content management systems.

For a recent example where someone leaking a Zoom meeting recording was caught because it was watermarked: <https://theintercept.com/2021/01/18/leak-zoom-meeting/> <sup>[[Tor Mirror]][132]</sup> <sup>[[Archive.org]][133]</sup>

Such watermarks can be inserted by various products[^219]'[^220]'[^221]'[^222] using Steganography[^223] and can resist compression[^224] and re-encoding[^225]'[^226].

These watermarks are not easily detectable and could allow identification of the source despite all efforts.

In addition to watermarks, the camera used for filming (and therefore the device used for filming) a video can also be identified using various techniques such as lens identification[^227] which could lead to de-anonymization.
...
Yes ... Your printers can be used to de-anonymize you as well as explained by the EFF here <https://www.eff.org/issues/printers> <sup>[[Archive.org]][134]</sup>

With this (old but still relevant) video explaining how from the EFF as well: <https://www.youtube.com/watch?v=izMGMsIZK4U> <sup>[[Invidious]][135]</sup>

Many printers will print an invisible watermark allowing for identification of the printer on every printed page. This is called Printer Steganography[^228]. There is no tangible way to mitigate this but to inform yourself on your printer and make sure it does not print any invisible watermark. This is important if you intend to print anonymously.

Here is an (old but still relevant) list of printers and brands who do not print such tracking dots provided by the EFF <https://www.eff.org/pages/list-printers-which-do-or-do-not-display-tracking-dots> <sup>[[Archive.org]][136]</sup>

Here are also some tips from the Whonix documentation (<https://www.whonix.org/wiki/Printing_and_Scanning> <sup>[[Archive.org]][137]</sup>):

**Do not ever print in Color, usually, watermarks are not present without color toners/cartridges**[^229]**.**
...
Here is for example an open-source project you could use yourself for recovering text from some blurred images yourself: <https://github.com/beurtschipper/Depix> <sup>[[Archive.org]][138]</sup>
...
There are also tutorials for using such techniques using Photo Editing tools such as GIMP such as <https://medium.com/@somdevsangwan/unblurring-images-for-osint-and-more-part-1-5ee36db6a70b> <sup>[[Archive.org]][140]</sup> followed by <https://medium.com/@somdevsangwan/deblurring-images-for-osint-part-2-ba564af8eb5d> <sup>[[Archive.org]][141]</sup>

![][142]

Finally, you will find plenty of deblurring resources here: <https://github.com/subeeshvasu/Awesome-Deblurring> <sup>[[Archive.org]][143]</sup>

Some online services could even help you do this automatically to some extent like MyHeritage.com enhance tool:

<https://www.myheritage.com/photo-enhancer> <sup>[[Archive.org]][144]</sup>
...
Contrary to widespread belief, Crypto transactions (such as Bitcoin and Ethereum) are not anonymous[^230]. Most cryptocurrencies can be tracked accurately through various methods[^231]'[^232].

Remember what they say on their page: <https://bitcoin.org/en/you-need-to-know> <sup>[[Archive.org]][146]</sup> and <https://bitcoin.org/en/protect-your-privacy> <sup>[[Archive.org]][147]</sup>: "Bitcoin is not anonymous"

The main issue is not setting up a random Crypto wallet to receive some currency behind a VPN/Tor address (at this point, the wallet is anonymous). The issue is mainly when you want to convert Fiat money (Euros, Dollars ...) to Crypto and then when you want to cash in your Crypto. You will have few realistic options but to transfer those to an exchange (such as Coinbase/Kraken/Bitstamp/Binance). Those exchanges have known wallet addresses and will keep detailed logs (due to KYC[^233] financial regulations) and can then trace back those crypto transactions to you using the financial system[^234].

There are some cryptocurrencies with privacy/anonymity in mind like Monero but even those have some and warnings to consider[^235]'[^236].

Even if you use Mixers or Tumblers[^237] (services that specialize in "anonymizing" cryptocurrencies by "mixing them"), keep in mind this is only obfuscation[^238] and not actual anonymity[^239]. Not only are they only obfuscation but they could also put you in trouble as you might end up exchanging your crypto against "dirty" crypto that was used in various questionable contexts[^240].
...
There are specialized commercial forensics solutions available (Magnet Axiom[^241], Cellebrite Cloud[^242]) that will help an adversary analyze your cloud data with ease.

Notable Examples:

-   Apple iCloud: <https://support.apple.com/en-us/HT202303> <sup>[[Archive.org]][148]</sup> : "Messages in iCloud also uses end-to-end encryption. If you have iCloud Backup turned on**, your backup includes a copy of the key protecting your Messages**. This ensures you can recover your Messages if you lose access to iCloud Keychain and your trusted devices. ".

-   Google Drive and WhatsApp: <https://faq.whatsapp.com/android/chats/about-google-drive-backups/> <sup>[[Archive.org]][149]</sup>: "**Media and messages you back up aren't protected by WhatsApp end-to-end encryption while in Google Drive**. ". Do however note that Facebook/Whatsapp have announced the rollout of encrypted backups on October 14^th^ 2021 (<https://about.fb.com/news/2021/10/end-to-end-encrypted-backups-on-whatsapp/> <sup>[[Archive.org]][150]</sup>) which should solve this issue.

-   Dropbox: <https://www.dropbox.com/privacy#terms> <sup>[[Archive.org]][151]</sup> "To provide these and other features, **Dropbox accesses, stores, and scans Your Stuff**. You give us permission to do those things, and this permission extends to our affiliates and trusted third parties we work with".

-   Microsoft OneDrive: <https://privacy.microsoft.com/en-us/privacystatement> <sup>[[Archive.org]][152]</sup>: Productivity and communications products, "When you use OneDrive, we collect data about your usage of the service, as well as the content you store, to provide, improve, and protect the services. **Examples include indexing the contents of your OneDrive documents so that you can search for them later and using location information to enable you to search for photos based on where the photo was taken**".
...
Your Browser and Device Fingerprints[^375] are set of properties/capabilities of your System/Browser. These are used on most websites for invisible user tracking but also to adapt the website user experience depending on their browser. For instance, websites will be able to provide a "mobile experience" if you are using a mobile browser or propose a specific language/geographic version depending on your fingerprint. Most of those techniques work with recent Browsers like Chromium-based[^243] browsers (such as Chrome/Edge) or Firefox[^244] unless taking specific measures.

You can find a lot of detailed information and publications about this on these resources:

-   <https://amiunique.org/links> <sup>[[Archive.org]][153]</sup>

-   <https://brave.com/brave-fingerprinting-and-privacy-budgets/> <sup>[[Archive.org]][154]</sup>
...
Forensics techniques are now very advanced and can reveal a staggering amount of information from your devices even if they are encrypted[^245]. These techniques are widely used by law enforcement all over the world and should be considered.

Here are some recent resources you should read about your smartphone:

-   UpTurn, The Widespread Power of U.S. Law Enforcement to Search Mobile Phones <https://www.upturn.org/reports/2020/mass-extraction/> <sup>[[Archive.org]][156]</sup>

-   New-York Times, The Police Can Probably Break Into Your Phone <https://www.nytimes.com/2020/10/21/technology/iphone-encryption-police.html> <sup>[[Archive.org]][157]</sup>

-   Vice, Cops Around the Country Can Now Unlock iPhones, Records Show <https://www.vice.com/en/article/vbxxxd/unlock-iphone-ios11-graykey-grayshift-police> <sup>[[Archive.org]][158]</sup>

I also highly recommend that you read some documents from a forensics examiner perspective such as:

-   EnCase Forensic User Guide, <http://encase-docs.opentext.com/documentation/encase/forensic/8.07/Content/Resources/External%20Files/EnCase%20Forensic%20v8.07%20User%20Guide.pdf> <sup>[[Archive.org]][159]</sup>

-   FTK Forensic Toolkit, <https://accessdata.com/products-services/forensic-toolkit-ftk> <sup>[[Archive.org]][160]</sup>

-   SANS Digital Forensics and Incident Response Videos, <https://www.youtube.com/c/SANSDigitalForensics/videos>

And finally, here is this very instructive detailed paper on the current state of IOS/Android security from the John Hopkins University: https://securephones.io/main.html[^246].
...
And there are reasons[^247]'[^248]'[^249]'[^250] for that:
...
-   You should be wary of Apps/Services using a "modified" or proprietary cryptographic method[^251].

-   By default, you should not trust any "Roll your own crypto" until it was audited, peer-reviewed, vetted, and accepted by the cryptography community[^252]'[^253].

-   There is no such thing as "military-grade crypto"[^254]'[^255]'[^256].
...
-   File/Disk Encryption:
    ...
    -   Prefer:
        ...
        -   Hardware Accelerated[^258]: AES (Rijndael) 256 Bits with HMAC-SHA-2 or HMAC-SHA-3 (This is what Veracrypt, Bitlocker, Filevault 2, KeepassXC, and LUKS use by default). Prefer SHA-3.

        -   Non-Hardware Accelerated: Same as accelerated above or if available consider:

            -   ChaCha20[^259] or XChaCha20 (You can use ChaCha20 with Kryptor <https://www.kryptor.co.uk>, unfortunately, it is not available with Veracrypt).
...
-   Signing messages/files with PGP/GPG:
    ...
    -   Prefer ECDSA (ed25519)+ECDH (ec25519) or RSA 4096 Bits*
        ...
        -   **Consider a more modern**[^262] **alternative to PGP/GPG: Minisign <https://jedisct1.github.io/minisign/>** <sup>[[Archive.org]][162]</sup>
...
* **Warning: RSA and ED25519 are unfortunately not seen as "Quantum Resistant"**[^263] **and while they have not been broken yet, they probably will be broken someday into the future. It is just a matter of when rather than if RSA will ever be broken. So, these are preferred in those contexts due to the lack of a better possibility.**

Here are some real cases of issues bad cryptography:

-   Telegram: <https://democratic-europe.eu/2021/07/20/cryptographers-uncover-four-vulnerabilities-in-telegram/> <sup>[[Archive.org]][163]</sup>

-   Telegram: <https://buttondown.email/cryptography-dispatches/archive/cryptography-dispatches-the-most-backdoor-looking/> <sup>[[Archive.org]][164]</sup>
...
-   Some other examples can be found here: <https://www.cryptofails.com/> <sup>[[Archive.org]][165]</sup>
...
Any of those providers can be forced to silently (without your knowing (using for example a court order with a gag order[^264] or a national security letter[^265]) log your activity to de-anonymize you. There have been several recent examples of those:

-   2021, ProtonMail, ProtonMail logged IP address of French activist after an order by Swiss authorities[^266].

-   2021, WindScribe, Servers were not encrypted as they should have been allowing MITM attacks by authorities[^267].

-   2021, DoubleVPN servers, logs, and account info seized by law enforcement[^268].

-   2021, The Germany-based mail provider Tutanota was forced to monitor specific accounts for 3 months[^269].

-   2020, The Germany-based mail provider Tutanota was forced to implement a backdoor to intercept and save copies of the unencrypted e-mails of one user[^270] (they did not decrypt the stored e-mail).

-   2017, PureVPN was forced to disclose information of one user to the FBI[^271].

-   2014, an EarthVPN user was arrested based on logs provider to the Dutch Police[^272].

-   2013, Secure E-Mail provider Lavabit shuts down after fighting a secret gag order[^273].

-   2011, HideMyAss user was de-anonymized, and logs were provided to the FBI[^274].

Some providers have implemented the use of a Warrant Canary[^275] that would allow their users to find out if they have been compromised by such orders, but this has not been tested yet as far as I know.

Finally, it is now well known that some companies might be sponsored front ends for some state adversaries (see the Crypto AG story[^276] and Omnisec story[^277]).
...
(Illustration: an excellent movie I highly recommend: Das Leben der Anderen[^278])

Many advanced techniques can be used by skilled adversaries[^279] to bypass your security measures provided they already know where your devices are. Many of those techniques are detailed here <https://cyber.bgu.ac.il/advanced-cyber/airgap> <sup>[[Archive.org]][167]</sup> (Air-Gap Research Page, Cyber-Security Research Center, Ben-Gurion University of the Negev, Israel) and include:

-   Attacks that require malware implanted in some devices:

    -   Exfiltration of Data through a Malware infected Router: <https://www.youtube.com/watch?v=mSNt4h7EDKo> <sup>[[Invidious]][168]</sup>

    -   Exfiltration of Data through observation of Light variation in a Backlit keyboard with a compromised camera: <https://www.youtube.com/watch?v=1kBGDHVr7x0> <sup>[[Invidious]][169]</sup>

        -   Exfiltration of Data through a compromised Security Camera (that could first use the previous attack) <https://www.youtube.com/watch?v=om5fNqKjj2M> <sup>[[Invidious]][170]</sup>

        -   Communication from outsider to compromised Security Cameras through IR light signals: <https://www.youtube.com/watch?v=auoYKSzdOj4> <sup>[[Invidious]][171]</sup>

    -   Exfiltration of data from a compromised air-gapped computer through acoustic analysis of the FAN noises with a smartphone <https://www.youtube.com/watch?v=v2_sZIfZkDQ> <sup>[[Invidious]][172]</sup>

    -   Exfiltration of data from a malware-infected air-gapped computer through HD LEDs with a Drone <https://www.youtube.com/watch?v=4vIu8ld68fc> <sup>[[Invidious]][173]</sup>

    -   Exfiltration of data from a USB malware on an air-gapped computer through electromagnetic interferences <https://www.youtube.com/watch?v=E28V1t-k8Hk> <sup>[[Invidious]][174]</sup>

    -   Exfiltration of data from a malware-infected HDD drive through covert acoustic noise <https://www.youtube.com/watch?v=H7lQXmSLiP8> <sup>[[Invidious]][175]</sup>

    -   Exfiltration of data through GSM frequencies from a compromised (with malware) air-gapped computer <https://www.youtube.com/watch?v=RChj7Mg3rC4> <sup>[[Invidious]][176]</sup>

    -   Exfiltration of data through electromagnetic emissions from a compromised Display device <https://www.youtube.com/watch?v=2OzTWiGl1rM&t=20s> <sup>[[Invidious]][177]</sup>

    -   Exfiltration of data through magnetic waves from a compromised air-gapped computer to a Smartphone stored inside a Faraday bag <https://www.youtube.com/watch?v=yz8E5n1Tzlo> <sup>[[Invidious]][178]</sup>

    -   Communication between two compromised air-gapped computers using ultrasonic soundwaves <https://www.youtube.com/watch?v=yz8E5n1Tzlo> <sup>[[Invidious]][178]</sup>

    -   Exfiltration of Bitcoin Wallet from a compromised air-gapped computer to a smartphone <https://www.youtube.com/watch?v=2WtiHZNeveY> <sup>[[Invidious]][179]</sup>

    -   Exfiltration of Data from a compromised air-gapped computer using display brightness <https://www.youtube.com/watch?v=ZrkZUO2g4DE> <sup>[[Invidious]][180]</sup>

    -   Exfiltration of Data from a compromised air-gapped computer through vibrations <https://www.youtube.com/watch?v=XGD343nq1dg> <sup>[[Invidious]][181]</sup>

    -   Exfiltration of Data from a compromised air-gapped computer by turning RAM into a Wi-Fi emitter <https://www.youtube.com/watch?v=vhNnc0ln63c> <sup>[[Invidious]][182]</sup>

    -   Exfiltration of Data from a compromised air-gapped computer through power lines <https://arxiv.org/abs/1804.04014> <sup>[[Archive.org]][183]</sup>

-   **Attacks that require no malware:**

    -   Observing a blank wall in a room from a distance to figure how many people are in a room and what they are doing[^280]. Publication with demonstration: <http://wallcamera.csail.mit.edu/> <sup>[[Archive.org]][184]</sup>

    -   Observing a reflective bag of snacks in a room from a distance to reconstruct the entire room[^281]. Publication with photographic examples: <https://arxiv.org/abs/2001.04642> <sup>[[Archive.org]][185]</sup>

    -   Measuring floor vibrations to identify individuals and determine their health condition and mood[^282]. Publication with demonstration: <https://engineering.cmu.edu/news-events/news/2020/02/17-mauraders-map.html> <sup>[[Archive.org]][186]</sup>

    -   Observing a light bulb from a distance to listen to the sound in the room[^283] **without any malware**: Demonstration: <https://www.youtube.com/watch?v=t32QvpfOHqw> <sup>[[Invidious]][187]</sup>. It should be noted that this type of attack is not new at all and there have been articles about such techniques as far back as 2013[^284] and that you can even buy devices to perform this yourself such as here: <http://www.gcomtech.com/ccp0-prodshow/laser-surveillance-laser-listening.html> <sup>[[Archive.org]][188]</sup>
...
**Realistically, this guide will be of little help against such adversaries as such malware could be implanted on the devices by a manufacturer, anyone in the middle**[^285]**, or by anyone with physical access to the air-gapped computer but there are still some ways to mitigate such techniques:**
...
Zero-Trust Security[^384] ("Never trust, always verify").
...
-   If you want system-wide plausible deniability[^304]'[^286] despite the risks[^287]'[^307], consider:
...
-   Check some data yourself here on the Tor Project OONI[^288] (Open Observatory of Network Interference) website: <https://explorer.ooni.org/>

-   Have a look at <https://censoredplanet.org/> and see if they have data about your country.

-   Specific to China, look at <https://gfwatch.org/> and <https://www.usenix.org/system/files/sec21-hoang.pdf> <sup>[[Archive.org]][219]</sup>
...
**Site Note: Be careful of some sellers as shown here <https://therecord.media/malware-found-preinstalled-in-classic-push-button-phones-sold-in-russia/>** <sup>[[Archive.org]][220]</sup>
...
This is the hardest part of the whole guide. It is a SPOF (Single Point of Failure). The places where you can still buy prepaid SIM cards without ID registration are getting increasingly limited due to various KYC type regulations[^289].
...
-   **Recommended**: Do not require any identification (even e-mail):
    ...
    -   (Iceland based, accepts Monero) <https://crypton.sh> <sup>[[Tor Mirror]][222]</sup> <sup>[[Archive.org]][223]</sup>

    -   (Ukraine based, accepts Monero) <https://virtualsim.net/> <sup>[[Archive.org]][224]</sup>

-   Do require identification (valid e-mail):

    -   (US California based, accepts Monero) <https://mobilesms.io> <sup>[[Archive.org]][225]</sup>

    -   (Germany based, accepts Monero) <https://www.sms77.io/> <sup>[[Archive.org]][226]</sup>

    -   (Russia based, accepts Monero) <https://onlinesim.ru/> <sup>[[Archive.org]][227]</sup>

-   Not accepting Monero but accepting mainstream cryptocurrencies (less recommended):

    -   (US California based, untested) <http://smspool.net/> <sup>[[Archive.org]][228]</sup>

    -   (Unknown origin, untested) <https://smspva.com/> <sup>[[Archive.org]][229]</sup>

There are some other possibilities listed here <https://cryptwerk.com/companies/sms/xmr/> <sup>[[Archive.org]][230]</sup>. **Use at your own risk.**

Now, what if you have no money? Well, in that case, you'll have to try your luck with free services and hope for the best. Here are some examples:
...
Please do not buy or use gimmicky self-encrypting devices such as these: <https://syscall.eu/blog/2018/03/12/aigo_part1/> <sup>[[Archive.org]][231]</sup>

Some might be very efficient[^290] but many are gimmicky gadgets that offer no real protection[^291].
...
So, what is Tor Browser? Tor Browser (<https://www.torproject.org/> <sup>[[Archive.org]][232]</sup>) is a web browser like Safari/Firefox/Chrome/Edge/Brave designed with privacy and anonymity in mind.

This browser is different from other browsers as it will connect to the internet through the Tor Network using Onion Routing. I first recommend that you watch this very nice introduction video by the Tor Project themselves: <https://www.youtube.com/watch?v=JWII85UlzKw> <sup>[[Invidious]][233]</sup>. After that, you should probably head over to their page to read their quick overview here: <https://2019.www.torproject.org/about/overview.html.en> <sup>[[Archive.org]][234]</sup>. Without going into too many technical details, Tor Browser is an easy and simple "fire and forget" solution to browse the web anonymously from pretty much any device. It is probably sufficient for most people and can be used from any computer or smartphone.
...
-   Head over to:
    ...
    -   F-Droid Store: It's not yet there but you can add it manually following the instructions at <https://support.torproject.org/tormobile/tormobile-7/> <sup>[[Archive.org]][235]</sup>
...
You will find details about each level here: <https://tb-manual.torproject.org/security-settings/> <sup>[[Archive.org]][236]</sup> but here is a summary:
...
While the official Tor Browser is not yet available for iOS, there is an alternative called Onion Browser endorsed by the Tor Project[^292].
...
Tails[^293] stands for **The Amnesic Incognito Live System**. It is a bootable Live Operating System running from a USB key that is designed for leaving no traces and forcing all connections through the Tor network.
...
**WARNING: Tails is not always up to date with their bundled software. And not always up to date with the Tor Browser updates either. You should always make sure you are using the latest version of Tails and you should use extreme caution when using bundled apps within Tails that might be vulnerable to exploits and reveal your location**[^294]**.**
...
You should also read Tails Documentation, Warnings, and limitations, before going further <https://tails.boum.org/doc/about/warnings/index.en.html> <sup>[[Archive.org]][237]</sup>
...
<https://tails.boum.org/install/index.en.html> <sup>[[Archive.org]][238]</sup>, pick your flavor and proceed.

If you're having an issue accessing Tor due to censorship or other issues, you can try using Tor Bridges by following this Tails tutorial: <https://tails.boum.org/doc/anonymous_internet/tor/index.en.html> <sup>[[Archive.org]][239]</sup> and find more information about these on Tor Documentation <https://2019.www.torproject.org/docs/bridges> <sup>[[Archive.org]][240]</sup>
...
When using Tor Browser, you should click the little shield Icon (upper right, next to the Address bar) and select your Security level (see <https://tb-manual.torproject.org/security-settings/> <sup>[[Archive.org]][236]</sup> for details). Basically, there are three.
...
-   **Do not use hidden volumes on SSD drives as this is not supported/recommended by Veracrypt**[^295]**.**
...
-   Download the latest HiddenVM release from <https://github.com/aforensics/HiddenVM/releases> <sup>[[Archive.org]][247]</sup>

-   Download the latest Whonix XFCE release from <https://www.whonix.org/wiki/VirtualBox/XFCE> <sup>[[Archive.org]][248]</sup>
...
If you can afford it, you might consider getting a Purism Librem laptop (<https://puri.sm> <sup>[[Archive.org]][249]</sup>) or System76 laptops (<https://system76.com/> <sup>[[Archive.org]][250]</sup>) while using Coreboot[^296] (where Intel ME is disabled from the factory).

In other cases, I would strongly recommend getting Business grade laptops (meaning not consumer/gaming-grade laptops) if you can. For instance, some ThinkPad from Lenovo (my personal favorite). Here are lists of laptops currently supporting Libreboot and others where you can flash Coreboot yourself (that will allow you to disable Intel IME):

-   <https://freundschafter.com/research/system-alternatives-without-intel-me-iamt-and-amd-psp-secure-technology/> <sup>[[Archive.org]][251]</sup>

-   <https://libreboot.org/docs/hardware/> <sup>[[Archive.org]][252]</sup>

-   <https://coreboot.org/status/board-status.html> <sup>[[Archive.org]][253]</sup>
...
-   AMD laptops could be more interesting as some provide the ability to disable AMD PSP (the AMD equivalent of Intel IME) from the BIOS/UEFI settings by default. And, because AFAIK, AMD PSP was audited and contrary to IME was not found to have any "evil" functionalities[^297]. However, if you are going for the Qubes OS Route consider Intel as they do not support AMD with their anti-evil-maid system[^298].
...
These settings can be accessed through the boot menu of your laptop. Here is a good tutorial from HP explaining all the ways to access the BIOS on various computers: <https://store.hp.com/us/en/tech-takes/how-to-enter-bios-setup-windows-pcs> <sup>[[Archive.org]][254]</sup>
...
-   Disable Secure Boot if you intend to use QubesOS as they do not support it out of the box[^299]. Keep it on if you intend to use Linux/Windows.
...
So, what is Secure Boot[^300]? In short, it is a UEFI security feature designed to prevent your computer from booting an operating system from which the bootloader was not signed by specific keys stored in the UEFI firmware of your laptop.

When the operating system (or the Bootloader[^301]) supports it, you can store the keys of your bootloader in your UEFI firmware, and this will prevent booting up any unauthorized Operating System (such as a live OS USB or anything similar).
...
-   Defcon 22, <https://www.youtube.com/watch?v=QDSlWa9xQuA> <sup>[[Invidious]][255]</sup>

-   BlackHat 2016, <https://www.youtube.com/watch?v=0fZdL3ufVOI> <sup>[[Invidious]][256]</sup>
...
Take a moment to set a firmware password according to the tutorial here: <https://support.apple.com/en-au/HT204455> <sup>[[Archive.org]][257]</sup>

You should also enable firmware password reset protection (available from Catalina) according to the documentation here: <https://support.apple.com/en-gb/guide/security/sec28382c9ca/web> <sup>[[Archive.org]][258]</sup>
...
Here is a good cheap method to make your laptop tamper-proof using Nail Polish (with glitter) <https://mullvad.net/en/help/how-tamper-protect-laptop/> <sup>[[Archive.org]][259]</sup> [^302] (with pictures).
...
This route will make extensive use of Virtual Machines[^303], they will require a host OS to run the Virtualization software. You have three recommended choices in this part of the guide:

-   Your Linux distribution of choice (excluding Qubes OS)

-   Windows 10 (preferably Home edition due to the absence of Bitlocker)

    -   **Windows 11 is not yet supported by this guide**
...
Linux is also not necessarily the best choice for anonymity depending on your threat model. This is because using Windows will allow us to **conveniently** use Plausible Deniability[^304] (aka Deniable Encryption[^305]) easily at the OS level. Windows is also unfortunately at the same time a privacy nightmare[^306] but is the only easy to set up option for using OS-wide plausible deniability. Windows telemetry and telemetry blocking are also widely documented which should mitigate many issues.

**So, what is Plausible Deniability?** You can cooperate with an adversary requesting access to your device/data without revealing your true secret. All this using Deniable Encryption[^307].

A soft lawful adversary could ask for your encrypted laptop password. At first, you could refuse to give out any password (using your "right to remain silent", "right not to incriminate yourself") but some countries are implementing laws[^308]'[^309] to exempt this from such rights (because terrorists and "think of the children"). In that case, you might have to reveal the password or face jail time in contempt of court. This is where plausible deniability will come into play.
...
This also means you could set up your own advanced "plausible deniability" setup using any Host OS by storing for instance Virtual Machines on a Veracrypt hidden volume container (be careful of traces in the Host OS tho that would need to be cleaned if the host OS is persistent, see [Some additional measures against forensics][Some additional measures against forensics:] section later). There is a project for achieving this within Tails (<https://github.com/aforensics/HiddenVM> <sup>[[Archive.org]][241]</sup>) which would make your Host OS non-persistent and use plausible deniability within Tails.

In the case of Windows, plausible deniability is also the reason you should ideally have Windows 10 Home (and not Pro). This is because Windows 10 Pro natively offers a full-disk encryption system (Bitlocker[^310]) where Windows 10 Home offers no full-disk encryption at all. We will later use third-party open-source software for encryption that will allow full-disk encryption on Windows 10 Home. This will give you a good (plausible) excuse to use this software. While using this software on Windows 10 Pro would be suspicious.
...
-   Windows ShellBags that are stored within the Windows Registry silently storing various histories of accessed volumes/files/folders[^318].

-   Windows Indexing keeping traces of the files present in your user folder by default[^319].

-   Recent lists (aka Jump Lists) in Windows and various apps keeping traces of recently accessed documents[^320].
...
-   Gatekeeper[^321] and XProtect keeping track of your download history in a local database and file attributes.
...
Forensics could[^315]'[^318] use all those leaks (see [Local Data Leaks and Forensics][Local Data Leaks and Forensics:]) to prove the existence of hidden data and defeat your attempts at using plausible deniability and to find out about your various sensitive activities.
...
There are several ways to achieve plausible deniability on Linux[^322] and it is possible to achieve. Here are some more details about some of the ways I would recommend. All these options require some higher level of skills at using Linux.

##### The Detached Headers Way:

While not supported yet by this guide, it is possible to achieve a form of deniability on Linux using LUKS by using detached LUKS headers. For now, I will redirect you toward this page for more information: <https://wiki.archlinux.org/title/Dm-crypt/Specialties#Encrypted_system_using_a_detached_LUKS_header> <sup>[[Archive.org]][276]</sup>
...
-   If you are not sure, just make sure you did not enable any telemetry and follow this tutorial if needed <https://vitux.com/how-to-force-ubuntu-to-stop-collecting-your-data-from-your-pc/> <sup>[[Archive.org]][277]</sup>
...
-   Disable Bluetooth if enabled by following this guide <https://www.addictivetips.com/ubuntu-linux-tips/disable-bluetooth-in-ubuntu/> <sup>[[Archive.org]][278]</sup> or issuing the following command:

    -   ```sudo systemctl disable bluetooth.service --force```

-   Disable Indexing if enabled by default (Ubuntu >19.04) by following this guide <https://www.linuxuprising.com/2019/07/how-to-completely-disable-tracker.html> <sup>[[Archive.org]][279]</sup> or issuing the following commands:
...
-   <https://www.how2shout.com/linux/how-to-hibernate-ubuntu-20-04-lts-focal-fossa/> <sup>[[Archive.org]][280]</sup>

-   <http://www.lorenzobettini.it/2020/07/enabling-hibernation-on-ubuntu-20-04/> <sup>[[Archive.org]][281]</sup>

-   <https://blog.ivansmirnov.name/how-to-set-up-hibernate-on-ubuntu-20-04/> <sup>[[Archive.org]][282]</sup>

After Hibernate is enabled, change the behavior so that your laptop will hibernate when you close the lid by following this tutorial for Ubuntu 20.04 <http://ubuntuhandbook.org/index.php/2020/05/lid-close-behavior-ubuntu-20-04/> <sup>[[Archive.org]][283]</sup> and this tutorial for Ubuntu 18.04 <https://tipsonubuntu.com/2018/04/28/change-lid-close-action-ubuntu-18-04-lts/> <sup>[[Archive.org]][284]</sup>

Unfortunately, this will not clean the key from memory directly when hibernating. To avoid this at the cost of some performance, you might consider encrypting the swap file by following this tutorial: <https://help.ubuntu.com/community/EnableHibernateWithEncryptedSwap> <sup>[[Archive.org]][285]</sup>

These settings should mitigate cold boot attacks if you can hibernate fast enough.

#### Enable MAC address randomization:

-   Ubuntu, follow these steps <https://help.ubuntu.com/community/AnonymizingNetworkMACAddresses> <sup>[[Archive.org]][286]</sup>.

-   Any other distro: you will have to find the documentation yourself, but it should be quite similar to the Ubuntu tutorial.

-   Consider this tutorial which should still work: <https://josh.works/shell-script-basics-change-mac-address> <sup>[[Archive.org]][287]</sup>

#### Hardening Linux:

As a light introduction for new Linux users, consider <https://www.youtube.com/watch?v=Sa0KqbpLye4> <sup>[[Invidious]][288]</sup>

For more in-depth and advanced options, refer to:

-   This excellent guide: <https://madaidans-insecurities.github.io/guides/linux-hardening.html> <sup>[[Archive.org]][289]</sup>

-   This excellent wiki resource: <https://wiki.archlinux.org/title/Security> <sup>[[Archive.org]][290]</sup>

-   These excellent scripts are based on the guide and wiki above: <https://codeberg.org/SalamanderSecurity/PARSEC> <sup>[[Archive.org]][291]</sup>
...
-   Consider the use of KickSecure when using Debian: <https://www.whonix.org/wiki/Kicksecure> <sup>[[Archive.org]][292]</sup>

-   This interesting article: <http://0pointer.net/blog/authenticated-boot-and-disk-encryption-on-linux.html> <sup>[[Archive.org]][293]</sup>
...
As a light introduction for new macOS users, consider <https://www.youtube.com/watch?v=lFx5icuE6Io> <sup>[[Invidious]][294]</sup>

Now to go more in-depth in securing and hardening your macOS, I recommend reading this GitHub guide which should cover many of the issues: <https://github.com/drduh/macOS-Security-and-Privacy-Guide> <sup>[[Archive.org]][295]</sup>
...
First, you should set up a firmware password following this guide from Apple: <https://support.apple.com/en-us/HT204455> <sup>[[Archive.org]][296]</sup>

Unfortunately, some attacks are still possible and an adversary could disable this password so you should also follow this guide to prevent disabling the firmware password from anyone including Apple: <https://support.apple.com/en-gb/guide/security/sec28382c9ca/web> <sup>[[Archive.org]][258]</sup>
...
These are the infamous "unblockable telemetry" calls from macOS Big Sur disclosed here: <https://sneak.berlin/20201112/your-computer-isnt-yours/> <sup>[[Archive.org]][297]</sup>
...
But you should document yourself on the actual issue before acting. This page is a good place to start: <https://blog.jacopo.io/en/post/apple-ocsp/> <sup>[[Archive.org]][298]</sup>
...
You should enable full disk encryption on your Mac using Filevault according to this part of the guide: <https://github.com/drduh/macOS-Security-and-Privacy-Guide#full-disk-encryption> <sup>[[Archive.org]][295]</sup>
...
As a light introduction, consider watching <https://www.youtube.com/watch?v=vNRics7tlqw> <sup>[[Invidious]][299]</sup>
...
Alternatively, you could use this free piece of software: <https://technitium.com/tmac/> <sup>[[Archive.org]][300]</sup>
...
Veracrypt[^323] is the software I will recommend for full-disk encryption, file encryption, and plausible deniability. It is a fork of the well-known but deprecated and unmaintained TrueCrypt. It can be used for:
...
It is to my knowledge the only (convenient and usable by anyone) free, open-source, and openly audited[^324] encryption software that also provides plausible deniability for widespread use and it works with Windows Home Edition.

Go ahead and download and install Veracrypt from: <https://www.veracrypt.fr/en/Downloads.html> <sup>[[Archive.org]][301]</sup>

After installation, please take a moment to review the following options that will help mitigate some attacks:

-   Encrypt the memory with a Veracrypt option[^325] (settings > performance/driver options > encrypt RAM) at a cost of 5-15% performance. This setting will also disable hibernation (which does not actively clear the key when hibernating) and instead encrypt the memory altogether to mitigate some cold-boot attacks. More details about this feature here: <https://sourceforge.net/p/veracrypt/discussion/technical/thread/3961542951/> <sup>[[Archive.org]][262]</sup>
...
-   Enable the Veracrypt option to mount volumes as removable volumes (Settings > Preferences > Mount volume as removable media). This will prevent Windows from writing some logs about your mounts in the Event logs[^326] and prevent some local data leaks.
...
Basically, you can follow the instructions here: <https://support.microsoft.com/en-us/windows/turn-on-device-encryption-0c453637-bc88-5f74-5105-741561aae838> <sup>[[Archive.org]][302]</sup>
...
Unfortunately, this is not enough. With this setup, your Bitlocker key can just be stored as-is in the TPM chip of your computer. This is rather problematic as the key can be extracted in some cases with ease[^327]'[^328]'[^329]'[^330].

To mitigate this, we will have to enable a few more options as per the recommendations of Microsoft[^331]:
...
By default, Windows 10 might not offer you this possibility so you should enable it by following this Microsoft tutorial: <https://docs.microsoft.com/en-us/troubleshoot/windows-client/deployment/disable-and-re-enable-hibernation> <sup>[[Archive.org]][303]</sup>
...
-   Route C: Plausible Deniability Encryption of your Operating system (you will have a "hidden OS" and a "decoy OS" running on the laptop):
    ...
    -   Cons:
        ...
        -   No use with an SSD drive due to the requirement of disabling Trim[^332] Operations[^333]. This will severely degrade the performance/health of your SSD drive over time.

**As you can see, Route C only offers two privacy advantages over the others, and it will only be of use against a soft lawful adversary. Remember <https://en.wikipedia.org/wiki/Rubber-hose_cryptanalysis>** <sup>[[Wikiless]][245]</sup> <sup>[[Archive.org]][246]</sup>**.**
...
-   To rescue disk[^334] or not rescue disk, well that is up to you. I recommend making one (just in case), just make sure to store it outside your encrypted drive (USB key for instance or wait and see the end of this guide for guidance on safe backups). This rescue disk will not store your passphrase and you will still need it to use it.

-   Wipe mode:

    -   If you have no sensitive data yet on this laptop, select None

    -   If you have sensitive data on an SSD, Trim alone should take care of it[^335] but I would recommend one pass (random data) just to be sure.
...
Read the Veracrypt Documentation <https://www.veracrypt.fr/en/VeraCrypt%20Hidden%20Operating%20System.html> <sup>[[Archive.org]][304]</sup> (Process of Creation of Hidden Operating System part) and <https://www.veracrypt.fr/en/Security%20Requirements%20for%20Hidden%20Volumes.html> <sup>[[Archive.org]][305]</sup> (Security Requirements and Precautions Pertaining to Hidden Volumes).

This is how your system will look after this process is done:

![][306]

(Illustration from Veracrypt Documentation, <https://veracrypt.fr/en/VeraCrypt%20Hidden%20Operating%20System.html> <sup>[[Archive.org]][304]</sup>)
...
Remember to read <https://www.veracrypt.fr/en/VeraCrypt%20Hidden%20Operating%20System.html> <sup>[[Archive.org]][304]</sup>
...
-   To rescue disk[^340] or not rescue disk, well that is up to you. I recommend making one (just in case), just make sure to store it outside your encrypted drive (USB key for instance or wait and see the end of this guide for guidance on safe backups). This rescue disk will not store your passphrase and you will still need it to use it.
...
Before going to the next step, you should learn the way to mount your Outer Volume safely for writing content on it. This is also explained in this official Veracrypt Documentation <https://www.veracrypt.fr/en/Protection%20of%20Hidden%20Volumes.html> <sup>[[Archive.org]][308]</sup>
...
Take some time to read again the "Possible Explanations for Existence of Two Veracrypt Partitions on Single Drive" of the Veracrypt documentation here <https://www.veracrypt.fr/en/VeraCrypt%20Hidden%20Operating%20System.html> <sup>[[Archive.org]][304]</sup>
...
In this route, we will make extensive use of the free Oracle Virtualbox[^341] software. This is a virtualization software in which you can create Virtual Machines that emulate a computer running a specific OS (if you want to use something else like Xen, Qemu, KVM, or VMWARE, feel free to do so but this part of the guide covers Virtualbox only for convenience).

So, you should be aware that Virtualbox is not the virtualization software with the best track record in terms of security and some of the reported issues[^342] have not been completely fixed to this date[^343] and if you are using Linux with a bit more technical skills, you should consider using KVM instead by following the guide available at Whonix here <https://www.whonix.org/wiki/KVM> <sup>[[Archive.org]][309]</sup> and here <https://www.whonix.org/wiki/KVM#Why_Use_KVM_Over_VirtualBox.3F> <sup>[[Archive.org]][310]</sup>
...
**This solution however has one main drawback to consider: Interference with Tor Stream Isolation**[^344].
...
(Illustration from Marcelo Martins, <https://stakey.club/en/decred-via-tor-network/> <sup>[[Archive.org]][316]</sup>)

VPN/Proxy over Tor falls on the right-side[^345] meaning using a VPN/Proxy over Tor forces Tor to use one circuit for all activities instead of multiple circuits for each. This means that using a VPN/Proxy over Tor can reduce the effectiveness of Tor in some cases and should therefore be used only for some specific cases:
...
-   <https://www.whonix.org/wiki/Stream_Isolation> <sup>[[Archive.org]][317]</sup>

-   <https://tails.boum.org/contribute/design/stream_isolation/> <sup>[[Archive.org]][318]</sup>

-   <https://www.whonix.org/wiki/Tunnels/Introduction#Comparison_Table> <sup>[[Archive.org]][319]</sup>
...
-   <https://www.whonix.org/wiki/Comparison_Of_Tor_with_CGI_Proxies,_Proxy_Chains,_and_VPN_Services#Tor_and_VPN_Services_Comparison> <sup>[[Archive.org]][321]</sup>

-   <https://www.whonix.org/wiki/Why_does_Whonix_use_Tor> <sup>[[Archive.org]][322]</sup>

-   <https://www.researchgate.net/publication/324251041_Anonymity_communication_VPN_and_Tor_a_comparative_study> <sup>[[Archive.org]][323]</sup>

-   <https://gist.github.com/joepie91/5a9909939e6ce7d09e29#file-vpn-md> <sup>[[Archive.org]][324]</sup>

-   <https://schub.wtf/blog/2019/04/08/very-precarious-narrative.html> <sup>[[Archive.org]][325]</sup>
...
-   Tor Project: <https://gitlab.torproject.org/legacy/trac/-/wikis/doc/TorPlusVPN> <sup>[[Archive.org]][326]</sup>

-   Tails Documentation:

    -   <https://gitlab.tails.boum.org/tails/blueprints/-/wikis/vpn_support/> <sup>[[Archive.org]][327]</sup>

    -   <https://tails.boum.org/support/faq/index.en.html#index20h2> <sup>[[Archive.org]][328]</sup>

-   Whonix Documentation (in this order):

    -   <https://www.whonix.org/wiki/Tunnels/Introduction> <sup>[[Archive.org]][329]</sup>

    -   <https://www.whonix.org/wiki/Tunnels/Connecting_to_Tor_before_a_VPN> <sup>[[Archive.org]][330]</sup>

    -   <https://www.whonix.org/wiki/Tunnels/Connecting_to_a_VPN_before_Tor> <sup>[[Archive.org]][320]</sup>
...
This route will use Virtualization and Whonix[^346] as part of the anonymization process. Whonix is a Linux distribution composed of two Virtual Machines:
...
Later, you will create and run several Virtual Machines within Virtualbox for your sensitive activities. Virtualbox provides a feature called "Snapshots"[^347] that allow for saving the state of a VM at any point in time. If for any reason later you want to go back to that state, you can restore that snapshot at any moment.
...
This will allow you to turn your VMs into a kind of disposable "Live Operating Systems" (like Tails discussed earlier). Meaning that you will be able to erase all the traces of your activities within a VM by restoring a Snapshot to an earlier state. Of course, this will not be "as good" as Tails (where everything is stored in memory) as there might be traces of this activity left on your hard disk. Forensics studies have shown the ability to recover data from a reverted VM[^348]. Fortunately, there will be ways to remove those traces after the deletion or reverting to an earlier snapshot. Such techniques will be discussed in the [Some additional measures against forensics][Some additional measures against forensics:] section of this guide.

#### Download Virtualbox and Whonix utilities:

You should download a few things within the host OS:

-   The latest version of the Virtualbox installer according to your Host OS <https://www.virtualbox.org/wiki/Downloads> <sup>[[Archive.org]][333]</sup>

-   (Skip this if you cannot use Tor natively or through a VPN) The latest Whonix OVA file from <https://www.whonix.org/wiki/Download> <sup>[[Archive.org]][334]</sup> according to your preference (Linux/Windows, with a Desktop interface XFCE for simplicity or only with the text-client for advanced users)
...
For ideal security, you should follow the recommendations provided here for each Virtualbox Virtual Machine <https://www.whonix.org/wiki/Virtualization_Platform_Security#VirtualBox_Hardening> <sup>[[Archive.org]][335]</sup> :
...
Finally, also follow this recommendation to desync the clock you are your VM compared to your host OS <https://www.whonix.org/wiki/Network_Time_Synchronization#Spoof_the_Initial_Virtual_Hardware_Clock_Offset> <sup>[[Archive.org]][336]</sup>
...
Also, consider applying these mitigations from VirtualBox to mitigate Spectre[^349]/Meltdown[^350] vulnerabilities by running this command from the VirtualBox Program Directory. All of these are described here: <https://www.whonix.org/wiki/Spectre_Meltdown> <sup>[[Archive.org]][79]</sup> (be aware these can impact severely the performance of your VMs but should be done for best security).

Finally, consider the security advice from Virtualbox themselves here <https://www.virtualbox.org/manual/ch13.html> <sup>[[Archive.org]][337]</sup>
...
-   Import Whonix file Into Virtualbox following the instructions on <https://www.whonix.org/wiki/VirtualBox/XFCE> <sup>[[Archive.org]][248]</sup>

-   Start the Whonix VMs

Remember at this stage that if you are having issues connecting to Tor due to censorship or blocking, you should consider connecting using Bridges as explained in this tutorial <https://www.whonix.org/wiki/Bridges> <sup>[[Archive.org]][338]</sup>.

-   Update the Whonix VMs by following the instructions on <https://www.whonix.org/wiki/Operating_System_Software_and_Updates#Updates> <sup>[[Archive.org]][339]</sup>
...
**Important Note: You should also read these very good recommendations over there <https://www.whonix.org/wiki/DoNot>** <sup>[[Archive.org]][340]</sup> **as most of those principles will also apply to this guide. You should also read their general documentation here <https://www.whonix.org/wiki/Documentation>** <sup>[[Archive.org]][341]</sup> **which will also provide tons of advice like this guide.**
...
**It is also the only VM that will provide Stream Isolation pre-configured for most apps by default**[^351]**.**

If you want additional software on the Workstation (such as another Browser), follow their guide here <https://www.whonix.org/wiki/Install_Software> <sup>[[Archive.org]][342]</sup>

Consider running Whonix in Live Mode if for extra malware protection, See <https://www.whonix.org/wiki/Anti-Forensics_Precautions> <sup>[[Archive.org]][343]</sup>

Do not forget to apply the VM hardening recommendations here: [Virtualbox Hardening recommendations].

Consider using AppArmor on your Whonix Workstations by following this guide: <https://www.whonix.org/wiki/AppArmor> <sup>[[Archive.org]][344]</sup>

#### Linux (any distro):

**Be careful, any customization you make to the non-Whonix guest VMs (keyboard layout, language, time zone, screen resolution, or other) could be used to fingerprint your VMs later. See <https://www.whonix.org/wiki/VM_Fingerprinting>** <sup>[[Archive.org]][345]</sup>
...
Refer to this tutorial <https://www.whonix.org/wiki/Other_Operating_Systems> <sup>[[Archive.org]][346]</sup> for detailed instructions.
...
Go with the Official Windows 10 Pro VM and harden it yourself: see [Appendix C: Windows Installation Media Creation][307] and go with the ISO route.

There is also another option you might hear about which is Windows AME (Ameliorated) from the <https://ameliorated.info/> <sup>[[Archive.org]][347]</sup> project which is a special Windows 10 build stripped from all telemetry/advertising and update components. **I do not recommend this option due to the insecure nature of that release lacking the latest updates/patches and lacking the ability to update completely. I do believe the project general idea is good, but it is just too insecure/risky and contains unnecessary software picked by the dev.**
...
-   Download the appropriate ISO file, I recommend the CM 14.1 (based on old Android 7 "Nougat") as it was the snappier in my tests.
...
You will need something to store your data (logins/passwords, identities, and TOTP[^352] information).

For this purpose, I strongly recommend KeePassXC because of its integrated TOTP feature. This is the ability to create entries for 2FA[^353] authentication with the authenticator feature.
...
-   Whonix: <https://www.whonix.org/wiki/Keepassxc> <sup>[[Archive.org]][352]</sup>

-   Linux:

    -   Download from <https://keepassxc.org/download/> <sup>[[Archive.org]][353]</sup>

    -   Follow the tutorial here <https://keepassxc.org/docs/KeePassXC_GettingStarted.html#_linux> <sup>[[Archive.org]][354]</sup>

-   Windows:

    -   Download from <https://keepassxc.org/download/> <sup>[[Archive.org]][353]</sup>

    -   Follow the tutorial here [https://KeePassXC.org/docs/KeePassXC_GettingStarted.html#_microsoft_windows][] <sup>[[Archive.org]][354]</sup>

-   macOS:

    -   Download from <https://keepassxc.org/download/> <sup>[[Archive.org]][353]</sup>

    -   Follow the tutorial here <https://keepassxc.org/docs/KeePassXC_GettingStarted.html#_macos> <sup>[[Archive.org]][354]</sup>
...
**This way is not supported by the Whonix project**[^354] but I will go ahead and give this option anyway. IMHO this is helpful to prevent your Host OS from leaking any information while you are using the Whonix VMs.
...
**Note that this route is designed for Qubes OS 4.0.x, it should also work with Qubes OS 4.1.x but it hasn't been tested.**
...
Qubes OS is not a Linux distribution[^355] but a Xen distribution. It is different from Linux distributions because it will make extensive use of Virtualization and Compartmentalization so that any app will run in a different VM (Qube). As a bonus, Qubes OS integrates Whonix by default and allows for increased privacy and anonymity. It is highly recommended that you document yourself over Qubes OS principles before going this route. Here are some recommended resources:

-   Qubes OS Introduction, <https://www.qubes-os.org/intro/> <sup>[[Archive.org]][358]</sup>

-   Qubes OS Video Tours, <https://www.qubes-os.org/video-tours/> <sup>[[Archive.org]][359]</sup>

-   Qubes OS Getting Started, <https://www.qubes-os.org/doc/getting-started/> <sup>[[Archive.org]][360]</sup>

-   YouTube, Life Behind the Tinfoil: A Look at Qubes and Copperhead - Konstantin Ryabitsev, The Linux Foundation <https://www.youtube.com/watch?v=8cU4hQg6GvU> <sup>[[Invidious]][361]</sup>

-   YouTube, I used the reasonably-secure Qubes OS for 6 months and survived - Matty McFatty [@themattymcfatty] <https://www.youtube.com/watch?v=sbN5Bz3v-uA> <sup>[[Invidious]][362]</sup>

-   YouTube, Qubes OS: How it works, and a demo of this VM-centric OS <https://www.youtube.com/watch?v=YPAvoFsvSbg> <sup>[[Invidious]][363]</sup>

This OS is recommended by prominent figures such as Edward Snowden, PrivacyGuides.org.

Qubes is the best option in this guide for people who are more comfortable with Linux and tech in general. But it has some downsides such as the lack of OS-wide plausible deniability, its hardware requirements, and its hardware compatibility. While you can run this on 4GB of RAM as per their requirements[^356], the recommended RAM is 16GB. I would recommend against using Qubes OS if you have less than 8GB of RAM. If you want a comfortable experience, you should have 16GB, if you want a particularly enjoyable experience, you should have 24GB or 32GB.
...
You should also check their hardware compatibility here <https://www.qubes-os.org/hcl/> <sup>[[Archive.org]][364]</sup> before proceeding. Your mileage might vary, and you might experience several issues about hardware compatibility that you will have to troubleshoot and solve yourself.

I think that if you can afford it and are comfortable with the idea of using Linux, you should go with this route as it is probably the best one in terms of security and privacy. The only disadvantage of this route is that it does not provide a way to enable OS-wide plausible deniability[^304], unlike the Whonix route.
...
**This solution however has one main drawback to consider: Interference with Tor Stream Isolation**[^357].
...
VPN/Proxy over Tor falls on the right-side[^358] meaning using a VPN/Proxy over Tor forces Tor to use one circuit for all activities instead of multiple circuits for each. This means that using a VPN/Proxy over Tor can reduce the effectiveness of Tor in some cases and should therefore be used only for some specific cases:
...
Note, if you're having issues accessing the Tor Network due to blocking/censorship, you could try using Tor Bridges (see Tor Documentation <https://2019.www.torproject.org/docs/bridges> <sup>[[Archive.org]][240]</sup> and Whonix Documentation <https://www.whonix.org/wiki/Bridges> <sup>[[Archive.org]][338]</sup>).
...
We will follow the instructions from their own guide <https://www.qubes-os.org/doc/installation-guide/> <sup>[[Archive.org]][367]</sup>:

(Secure Boot is not supported as per their FAQ: <https://www.qubes-os.org/faq/#is-secure-boot-supported> <sup>[[Archive.org]][368]</sup> so it should be disabled in the BIOS/UEFI settings.)

-   Download the latest Qubes OS 4.0 installation ISO according to their hardware compatibility list.

-   Prepare a USB key with the Qubes OS ISO file

-   Install Qubes OS according to the installation guide:

    -   **If you want to use Tor or VPN over Tor: Check the** "**Enabling system and template updates over the Tor anonymity network using Whonix" during the last step. This will force all Qubes OS updates to go through Tor. While this will significantly reduce your update speed, it will increase your anonymity from the start.** (If you are having issues connecting to Tor due to censorship or blocking, consider using Tor Bridges as recommended earlier. Just follow the tutorial provided here: <https://www.whonix.org/wiki/Bridges> <sup>[[Archive.org]][338]</sup>)
...
-   Select Random to randomize your Mac Address
    ...
    -   **Warning: This setting should work in most cases but can be unreliable on some network adapters. Please refer to this documentation if you want to be sure: <https://github.com/Qubes-Community/Contents/blob/master/docs/privacy/anonymizing-your-mac-address.md>** <sup>[[Archive.org]][369]</sup>
...
Follow the instructions on <https://www.whonix.org/wiki/Qubes/Install> <sup>[[Archive.org]][370]</sup>
...
Basically, AppArmor[^360] is an application sandboxing system. By default, it is not enabled but supported by Qubes OS.
...
-   About the Debian VMs:
    ...
    -   Head out and read <https://wiki.debian.org/AppArmor> <sup>[[Archive.org]][371]</sup>

-   About any other Linux VM:

    -   Head out and read:

        -   <https://wiki.archlinux.org/title/AppArmor> <sup>[[Archive.org]][372]</sup>

        -   <https://wiki.debian.org/AppArmor> <sup>[[Archive.org]][371]</sup>

-   About the Whonix VMs, you should consider enabling and using AppArmor, especially on the Whonix VMs of Qubes OS:

    -   First, you should head out and read <https://www.whonix.org/wiki/AppArmor> <sup>[[Archive.org]][344]</sup>

    -   Secondly, you should head out again and read <https://www.whonix.org/wiki/Qubes/AppArmor> <sup>[[Archive.org]][373]</sup>

##### SELinux:

SELinux[^361] is similar to AppArmor. The differences between SELinux and AppArmor are technical details into which we will not get.

Here is a good explanation of what it is: <https://www.youtube.com/watch?v=_WOKRaM-HI4> <sup>[[Invidious]][374]</sup>
...
So, head out and read <https://docs.fedoraproject.org/en-US/quick-docs/getting-started-with-selinux/> <sup>[[Archive.org]][375]</sup>
...
This is based on the tutorial provided by Qubes OS themselves (<https://github.com/Qubes-Community/Contents/blob/master/docs/configuration/vpn.md> <sup>[[Archive.org]][376]</sup>). If you are familiar with this process, you can follow their tutorial. Here is mine:
...
-   Test your Connectivity:
    ...
    -   If you are going for VPN over Tor, Test the VM connectivity to Tor by launching a Browser within the ProxyVM and going to <https://check.torproject.org> <sup>[[Archive.org]][377]</sup> (It should say you are connected to Tor)
...
> (These will block outbound traffic when the VPN is down, it is a kill switch, more information here <https://linuxconfig.org/how-to-create-a-vpn-killswitch-using-iptables-on-linux> <sup>[[Archive.org]][378]</sup> )
...
-   Test the ProxyVM VPN connectivity by starting a Browser within it and going to your VPN provider test page. It should now say you are connected to a VPN:
    ...
    -   Mullvad: <https://mullvad.net/en/check/> <sup>[[Archive.org]][379]</sup>

    -   IVPN: <https://www.ivpn.net/> <sup>[[Archive.org]][380]</sup> (check the top banner)

    -   ProtonVPN: Follow their instructions here <https://protonvpn.com/support/vpn-ip-change/> <sup>[[Archive.org]][381]</sup>
...
-   Create a Whonix Workstation Disposable VM (follow this tutorial <https://www.whonix.org/wiki/Qubes/DisposableVM> <sup>[[Archive.org]][382]</sup>)
...
If you want to use Brave: apply the instructions from <https://brave.com/linux/> <sup>[[Archive.org]][383]</sup> (Fedora 28+ section) and run the following commands:
...
Edit the Whonix Disposable VM template and follow instructions here <https://www.whonix.org/wiki/Install_Software> <sup>[[Archive.org]][342]</sup>
...
Now you will have to follow the instructions from here: <https://github.com/anbox/anbox-modules> <sup>[[Archive.org]][384]</sup>:
...
Now we will follow their other tutorial from here: <https://github.com/anbox/anbox/blob/master/docs/install.md> <sup>[[Archive.org]][385]</sup>:
...
You will need something to store your data (logins/passwords, identities, and TOTP[^362] information).

For this purpose, I strongly recommend KeePassXC because of its integrated TOTP feature. This is the ability to create entries for 2FA[^363] authentication with the authenticator feature.
...
Captcha[^364] stands for "Completely Automated Public Turing test to tell Computers and Humans Apart" are Turing tests[^365] puzzles you need to complete before accessing a form/website. You will mostly encounter those provided by Google (reCAPTCHA service[^366]) and Cloudflare (hCaptcha[^367]). hCaptcha is used on 15% of the internet by their own metrics[^368].
...
If you often use VPNs or Tor, you will quickly encounter many captchas everywhere[^369]. Quite often when using Tor, even if you succeed in solving all the puzzles (sometimes dozens in a row), you will still be denied after solving the puzzles.

See <https://gitlab.torproject.org/legacy/trac/-/wikis/org/doc/ListOfServicesBlockingTor> <sup>[[Archive.org]][313]</sup>

While most people think those puzzles are only about solving a little puzzle, it is important to understand that it is much more complex, and that modern Captchas uses advanced machine learning and risk analysis algorithms to check if you are human[^370]:

-   They check your browser, cookies, and browsing history using Browser fingerprinting[^371].

-   They track your cursor movements (speed, accuracy) and use algorithms to decide if it is "human/organic".

-   They track your behavior before/during/after the tests to ensure you are "human"[^372].
...
Most platforms (including the privacy-oriented ones such as Signal/Telegram/ProtonMail will require a phone number to register, and most countries now make it mandatory to submit a proof of ID to register[^374].
...
-   RiseUp: <https://riseup.net> <sup>[[Tor Mirror]][391]</sup> (It has come to my attention that the site now, unfortunately, requires an invitation from a current registered user)
...
These services will allow creating random aliases for your anonymous e-mail (on ProtonMail for example) and could increase your general privacy if you do not want to disclose that e-mail for any purpose. They are both recommended by Privacyguides.org.
...
Sometimes some platforms will allow you to log in with a Tor IP but not sign-up (See <https://gitlab.torproject.org/legacy/trac/-/wikis/org/doc/ListOfServicesBlockingTor> <sup>[[Archive.org]][313]</sup>). Those platforms will keep a convenient permanent log of the IP you used during sign-up. And some will keep such logs indefinitely including all the IPs you used to log in (hi Facebook).
...
Browser and Device[^375] Fingerprinting are usually integrated into the Captcha services but also in other various services.

Many platforms (like Google[^376]) will check your browser for various capabilities and settings and block Browsers they do not like. This is one of the reasons I recommend using Chromium-based Browsers such as Brave Browser over Tor Browser within this VM.
...
While this might seem innocent, this is obviously an ID verification and de-anonymization method. This is just indirectly relying on third-party financial KYC[^233] regulations.

This is for instance now the case on YouTube for some European Users[^377] but also used by services like Amazon that requires a valid payment method for creating an account.
...
This option is often presented as the "default one", hiding away the "Sign-in with e-mail and password" with clever Dark Patterns[^378] and unfortunately sometimes needed.
...
This guide will not cover this one (yet) as it is mainly used on financial platforms (that will be able to identify you with other means anyway) and some dating apps like Tinder[^379]. Unfortunately, this method is now also sometimes being used on Facebook[^380] and Instagram as part of their verification methods (tho I did not face it yet so far).
...
Recently even platforms such as PornHub decided to implement similar measures in the future[^381].

This verification is extremely hard to defeat but possible. A method to possibly defeat those would be to use "deep fake" technology software such as the open-source FaceSwap <https://github.com/deepfakes/faceswap> <sup>[[Archive.org]][395]</sup> to generate the required verification pictures using a randomly computer-generated face that would be swapped over the picture of a complicit model (or a stock photo).

Unfortunately, some apps require direct access to a smartphone camera to process the verification. In that case, we will need to find a way to do such "face swaps" on the fly using a filter and another way to feed this into the camera used by the app. A possible approach would be similar to this impressive project <https://github.com/iperov/DeepFaceLive> <sup>[[Archive.org]][396]</sup>.
...
Some countries have even developed hotlines where you can report any subversive content[^382].
...
So what? Well instead of not trusting anyone or anything, I would advise to **"Trust but verify"**[^383] (or "Never trust, always verify" if you are more hardcore about it and want to apply Zero-Trust Security[^384]) instead.
...
This is the fun part where you will now create your identities from thin air. These identities do not exist but should be plausible and look "organic". They should ideally have a story, a "legend" (yes this is the real term for this[^385]).
...
-   Brave Browser (Chromium-based) with a Private Tor Tab has (IMHO) a better acceptance level than Tor Browser (Firefox based). You will experience fewer issues with captchas and online platforms[^376] if you use Brave than if you use Tor Browser (feel free to try this yourself).

-   For every identity, you should have a matching profile picture associated with it. For this purpose, I recommend you just go to <https://thispersondoesnotexist.com/> <sup>[[Archive.org]][397]</sup> and generate a computer-generated profile picture (Do note that algorithms have been developed[^386]'[^387] to detect these and it might not work 100% of the time). You can also generate such pictures yourself from your computer if you prefer by using the open-source StyleGan project here <https://github.com/NVlabs/stylegan2> <sup>[[Archive.org]][398]</sup>. Just refresh the page until you find a picture that matches your identity in all aspects (age, sex, and ethnicity) and save that picture. It would be even better to have several pictures associated with that identity, but I do not have an "easy way" of doing that yet.

    -   **Bonus**, you could also make it more real by using this service (with an anonymous identity) <https://www.myheritage.com/deep-nostalgia> <sup>[[Archive.org]][399]</sup> to make a picture more lifelike. Here is an example:
...
You could also achieve the same result without using MyHeritage and by doing it yourself using for example <https://github.com/AliaksandrSiarohin/first-order-model> <sup>[[Archive.org]][401]</sup> but this will require more manual operations (**and requires an NVIDIA GPU**). Other commercial products will soon be available such as: <https://www.d-id.com/talkingheads/> <sup>[[Archive.org]][402]</sup> with examples here: <https://www.youtube.com/channel/UCqyzLOHYamYX2tNXBNSHr1w/videos> <sup>[[Invidious]][403]</sup>.
...
-   **Always use TOTP 2FA (not SMS to prevent Sim Swapping attacks**[^388] **and to keep your identity working when your pre-paid card expires) using KeePassXC when available to secure your logins to various platforms.**

-   Remember [Appendix A2: Guidelines for passwords and passphrases].

Here is also a good guide on this specific topic: <https://gendersec.tacticaltech.org/wiki/index.php/Complete_manual#.22Real.22_names> <sup>[[Archive.org]][404]</sup>
...
-   Whonix/Tails: Create/Edit a file ```/usr/local/etc/torrc.d/50_user.conf```[^389].

-   On Tor Browser: Edit the torrc file located at ```Browser/TorBrowser/Data/Tor```[^390].
...
**Please note that this is restricting Onion Routing could limit your Anonymity if you are too restrictive. You can see a visualized list of available Exit Nodes here: <https://www.bigdatacloud.com/insights/tor-exit-nodes>** <sup>[[Archive.org]][405]</sup>
...
On my side, I strongly condemn this type of real-name policy. See for instance this Wikipedia article giving some examples: <https://en.wikipedia.org/wiki/Facebook_real-name_policy_controversy> <sup>[[Wikiless]][406]</sup> <sup>[[Archive.org]][407]</sup>

Here are some more references about the German case for reference:

-   <https://slate.com/technology/2018/02/why-some-americans-are-cheering-germany-for-taking-on-facebooks-real-name-policy.html> <sup>[[Archive.org]][408]</sup>

-   <https://www.theverge.com/2018/2/12/17005746/facebook-real-name-policy-illegal-german-court-rules> <sup>[[Archive.org]][409]</sup>

-   <https://www.pcmag.com/news/german-court-rules-facebooks-real-name-policy-is-illegal> <sup>[[Archive.org]][410]</sup>

-   <https://www.vzbv.de/sites/default/files/downloads/2018/02/14/18-02-12_vzbv_pm_facebook-urteil_en.pdf> <sup>[[Archive.org]][411]</sup>

-   <https://www.pcmag.com/news/german-court-rules-facebooks-real-name-policy-is-illegal> <sup>[[Archive.org]][410]</sup>

-   <https://www.reuters.com/article/us-germany-facebook/german-court-rules-facebook-use-of-personal-data-illegal-idUSKBN1FW1FI> <sup>[[Archive.org]][412]</sup>
...
-   **Consider using the recommended tools on <https://privacyguides.org>** <sup>[[Archive.org]][415]</sup> **for better privacy instead of the usual mainstream ones.**

-   **Consider using the recommended tools on <https://www.whonix.org/wiki/Documentation>** <sup>[[Archive.org]][341]</sup> **as well instead of the usual mainstream ones such as E-mail providers: <https://www.whonix.org/wiki/E-Mail#Anonymity_Friendly_Email_Provider_List>** <sup>[[Archive.org]][416]</sup>

**The following overview does not mention the privacy practices of those platforms but only their requirements for registering an account. If you want to use privacy-aware tools and platforms, head on to <https://privacyguides.org>** <sup>[[Archive.org]][43]</sup>**.**
...
-   Is this against their ToS? No, but yes <https://www.amazon.com/gp/help/customer/display.html?nodeId=202140280> <sup>[[Archive.org]][417]</sup>
...
-   Is this against their ToS? Yes <https://www.apple.com/legal/internet-services/icloud/en/terms.html> <sup>[[Archive.org]][418]</sup>
...
-   Is this against their ToS? Yes <https://www.binance.com/en/terms> <sup>[[Archive.org]][419]</sup>
...
-   Is this against their ToS? No <https://briarproject.org/privacy-policy/> <sup>[[Archive.org]][420]</sup>
...
-   Is this against their ToS? No <https://discord.com/terms> <sup>[[Archive.org]][421]</sup>
...
-   Is this against their ToS? No <https://element.io/terms-of-service> <sup>[[Archive.org]][422]</sup>
...
-   Is this against their ToS? Yes <https://www.facebook.com/terms.php> <sup>[[Archive.org]][423]</sup>
...
-   Can you create accounts through Tor? Yes, but it is very difficult and their onion address[^391] will not help. In most cases, you'll just have a random error at sign-up and your account suspended after sign-in."
...
-   Is this against their ToS? No <https://docs.github.com/en/free-pro-team@latest/github/site-policy/github-terms-of-service> <sup>[[Archive.org]][424]</sup>
...
-   Is this against their ToS? No <https://about.gitlab.com/handbook/legal/subscription-agreement/> <sup>[[Archive.org]][425]</sup>
...
-   Is this against their ToS? No <https://policies.google.com/terms> <sup>[[Archive.org]][426]</sup>
...
If your account gets suspended [^394] (this can happen on sign-up, after signing-up or after using it in some Google services), you can still get it unsuspended by submitting[^395] an appeal/verification (which will again require your Phone number and possibly an e-mail contact with Google support with the reason). **Suspension of the account does not disable the e-mail forwarding, but the suspended account will be deleted after a while.**
...
It is also possible that Google will require an ID check through indirect financial KYC or ID picture check if you try to access/publish mature content on their platform[^396].

#### HackerNews:

-   Is this against their ToS? No <https://www.ycombinator.com/legal/#tou> <sup>[[Archive.org]][427]</sup>
...
-   Is this against their ToS? **Maybe?** I am not sure <https://help.instagram.com/581066165581870?ref=dp> <sup>[[Archive.org]][428]</sup>
...
-   Is this against their ToS? No <https://jami.net/privacy-policy/> <sup>[[Archive.org]][429]</sup>
...
-   Is this against their ToS? No <https://www.ivpn.net/tos/> <sup>[[Archive.org]][430]</sup>
...
-   Is this against their ToS? Yes <https://www.kraken.com/legal> <sup>[[Archive.org]][431]</sup>
...
-   Is this against their ToS? Yes <https://www.linkedin.com/legal/user-agreement> <sup>[[Archive.org]][432]</sup>
...
LinkedIn will then require you to go through a verification process that will, unfortunately, require you to send an ID proof (identity card, passport, driver's license). This ID verification is processed by a company called Jumio[^397] that specializes in ID proofing. This is most likely a dead end as this would force you to develop some strong Photoshop skills.
...
-   Is this against their ToS? No, unless it is about crypto <https://policy.medium.com/medium-terms-of-service-9db0094a1e0f> <sup>[[Archive.org]][433]</sup>
...
-   Is this against their ToS? Yes <https://www.microsoft.com/en/servicesagreement/> <sup>[[Archive.org]][434]</sup>
...
-   Is this against their ToS? No <https://mullvad.net/en/help/terms-service/> <sup>[[Archive.org]][435]</sup>
...
-   Is this against their ToS? No <https://njal.la/tos/> <sup>[[Archive.org]][436]</sup>
...
-   Is this against their ToS? No, it looks fine <https://onlyfans.com/terms> <sup>[[Archive.org]][437]</sup>
...
-   Is this against their ToS? No <https://ProtonMail.com/terms-and-conditions> <sup>[[Archive.org]][438]</sup>
...
They are recommended by Privacyguides.org[^398]. Their only apparent issue is that they do require (in most cases) a phone number or another e-mail address for registration (when you try to register from a VPN or Tor at least).

They claim they do not store/link the phone/e-mail associated with the registration but only store a hash that is not linked to the account[^399]. If their claim is true and the hash is not linked to your account, and that you followed my guide about the phone number, you should be reasonably safe from tracking.

This e-mail account can be used for creating a Google/Gmail account.

#### ProtonVPN:

-   Is this against their ToS? No <https://protonvpn.com/terms-and-conditions> <sup>[[Archive.org]][439]</sup>
...
-   Is this against their ToS? No <https://www.redditinc.com/policies> <sup>[[Archive.org]][440]</sup>
...
Consider reading this reddit post: <https://old.reddit.com/r/ShadowBan/comments/8a2gpk/an_unofficial_guide_on_how_to_avoid_being/> <sup>[[Archive.org]][441]</sup>

#### Slashdot:

-   Is this against their ToS? Yes <https://slashdotmedia.com/terms-of-use/> <sup>[[Archive.org]][442]</sup>
...
-   Is this against their ToS? No <https://telegram.org/tos> <sup>[[Archive.org]][443]</sup>
...
Their appeal process is just sending an e-mail to <recover@telegram.org> <sup>[[Archive.org]][444]</sup> stating your phone number and issue and hope they answer.
...
-   Is this against their ToS? No <https://tutanota.com/terms/> <sup>[[Archive.org]][445]</sup>
...
This time you will need to submit an appeal using a form[^400], provide a good reason and wait for the appeal to be processed by Twitter. During that process, you may receive an e-mail (on ProtonMail) asking you to reply to a customer service ticket to prove that you do have access to your e-mail and that it is you. This will be directed toward your Gmail address but will arrive on your ProtonMail.
...
-   Is this against their ToS? No <https://www.twitch.tv/p/en/legal/terms-of-service/> <sup>[[Archive.org]][446]</sup>
...
-   Is this against their ToS? **Yes** <https://www.whatsapp.com/legal/updates/terms-of-service-eea> <sup>[[Archive.org]][447]</sup>
...
You are going to have to find a separate way to post there using at least seven proxies[^401] that are not known by 4chan blocking system (hint: Anonymous VPS using Monero is probably your best option).
...
End-to-end Encryption[^402] (aka e2ee) is a rather simple concept. It just means only you and your destination know each-others public encryption keys and no one in between that would be eavesdropping would be able to decrypt the communication.
...
More on this topic on this YouTube video: <https://www.youtube.com/watch?v=zSQtyW_ywZc> <sup>[[Invidious]][450]</sup>
...
Zero-Access Encryption[^404] at rest is used when you store data at some provider (let us say your chat history or chat backups) but this history or backup is encrypted on your side and cannot be read or decrypted by the provider hosting it.
...
Such a feature would have prevented important hacks such as the Cambridge Analytica scandal[^405] if it were implemented.
...
-   The Sealed Sender option[^406].

-   The Private Contact Discovery[^407].

-   The Private Group System[^408].
...
-   Wikipedia, <https://en.wikipedia.org/wiki/Comparison_of_instant_messaging_protocols> <sup>[[Wikiless]][451]</sup> <sup>[[Archive.org]][452]</sup>

-   Wikipedia, <https://en.wikipedia.org/wiki/Comparison_of_cross-platform_instant_messaging_clients> <sup>[[Wikiless]][453]</sup> <sup>[[Archive.org]][454]</sup>

-   Secure Messaging Apps <https://www.securemessagingapps.com/> <sup>[[Archive.org]][455]</sup>

-   ProtonMail Blog, <https://protonmail.com/blog/whatsapp-alternatives/> <sup>[[Archive.org]][456]</sup>

-   Whonix Documentation, Instant Messenger Chat <https://www.whonix.org/wiki/Chat> <sup>[[Archive.org]][457]</sup>

-   Have a look at <https://securechatguide.org/featuresmatrix.html> <sup>[[Archive.org]][458]</sup> which is also a good comparison table for messaging apps.
...
I will recommend these options in that order (as also recommend by Privacyguides.org[^409]'[^410] except for Session and Cwtch):

-   macOS:

    -   Native Tor Onion Routing Support (**preferred**):

        -   OnionShare version >2.3 (<https://onionshare.org/> <sup>[[Tor Mirror]][459]</sup> <sup>[[Archive.org]][460]</sup>)**

        -   Cwtch (<https://cwtch.im> <sup>[[Archive.org]][461]</sup> **warning, this is at the alpha/beta stage**)**
    ...
    -   Non-Native Tor Support (needs additional steps for ideal anonymity to proxy it through Tor through Virtualization or Proxying):
        ...
        -   Element/Matrix.org (<https://element.io/> <sup>[[Archive.org]][462]</sup>)

        -   Jami (<https://jami.net/> <sup>[[Archive.org]][463]</sup>)*

        -   Gajim/XMPP (<https://gajim.org/> <sup>[[Archive.org]][464]</sup>)
...
-   Linux:
    ...
    -   Native Tor Onion Routing Support (**preferred**):
        ...
        -   Briar (<https://briarproject.org/> <sup>[[Archive.org]][465]</sup>)*
...
-   iOS:
    ...
    -   Due to the lack of any better option and while it is **normally not recommended**: Session Messenger: <https://getsession.org/> <sup>[[Archive.org]][466]</sup>. Why is it not recommended these days within the privacy community? Well, it is because they recently[^411] dropped two key security features from their protocol: Perfect Forward Secrecy and Deniability which are considered rather essential in most other apps. Yet Session has been audited[^412] with satisfactory results but that audit does not mention these changes. We also currently lack sufficient information on LokiNet (the Onion Routing Network used by Session) to endorse it. Session is still recommended by some like Techlore[^413].
...
-   Cryptpad.fr (<https://cryptpad.fr/>): Free tier limited to 1GB total and recommended by PrivacyGuides.org at <https://privacyguides.org/providers/cloud-storage/> <sup>[[Archive.org]][467]</sup>

-   AnonArchive (<https://anonarchive.org/>): free tier limited to 1GB total

-   Filen (<https://filen.io/>): free tier limited to 10GB total

Consider the use of IPFS[^414]:
...
If you must do so, you should take some steps because you cannot trust any organization to protect your anonymity[^415]. See [Appendix B1: Checklist of things to verify before sharing information][Appendix B1: Checklist of things to verify before sharing information:].

For this, I strongly recommend the use of SecureDrop[^416] (<https://securedrop.org/> <sup>[[Archive.org]][468]</sup>) which is an open-source project from the Freedom of the Press Foundation.

-   Do take a moment to their read their "source guide" here: <https://docs.securedrop.org/en/stable/source.html> <sup>[[Archive.org]][469]</sup>

-   Ideally, you should use SecureDrop over Tor and you will find a curated list of those here <https://github.com/alecmuffett/real-world-onion-sites#securedrop> <sup>[[Archive.org]][470]</sup>
...
-   Check regularly the eventual appearance of compromise of any of your identities using <https://haveibeenpwned.com/> <sup>[[Archive.org]][471]</sup> (obviously from a safe environment).
...
The process is fairly simple and all you will need is to follow Veracrypt tutorial here: <https://www.veracrypt.fr/en/Beginner%27s%20Tutorial.html> <sup>[[Archive.org]][472]</sup>
...
Qubes OS recommends using their own utility for backups as documented here <https://www.qubes-os.org/doc/backup-restore/> <sup>[[Archive.org]][473]</sup>. But it is just a hassle and provides limited added value unless you just want to back up a single Qube. So instead, I am also recommending just making a full image with Clonezilla which will remove all the hassle and bring you back a working system in a few simple steps.
...
If you just want to save information (text), I will recommend the use of secure and private pastebins[^418]. Mostly I will stick to the ones recommended by PrivacyGuides.org (<https://privacyguides.org/providers/paste/> <sup>[[Archive.org]][477]</sup> ) :
...
To that, the answer is very simple and a clear consensus for everyone: <https://syncthing.net/> <sup>[[Archive.org]][478]</sup>
...
So, the fact is that it is very unlikely[^424]'[^425] and difficult for a forensic examiner to be able to recover data from a Trimmed SSD but it is not completely impossible either[^426]'[^427]'[^428] if they are fast enough and have access to extensive equipment, skills, and motivation.
...
-   Easy options for less experienced users:
    ...
    -   Buy PartedMagic[^429] for 11$ and use it to erase any disk.
...
Trim should be sufficient in most cases and you could just use the blkdiscard command to force an entire device trim as explained here: <https://wiki.archlinux.org/index.php/Solid_state_drive#Trim_an_entire_device> <sup>[[Archive.org]][486]</sup>
...
-   Option A: Follow one of these tutorials:
    ...
    -   <https://linuxhint.com/completely_wipe_hard_drive_ubuntu/> <sup>[[Archive.org]][489]</sup>

    -   <https://linoxide.com/linux-command/commands-wipe-disk-linux/> <sup>[[Archive.org]][490]</sup>

    -   <https://wiki.archlinux.org/index.php/Securely_wipe_disk> <sup>[[Archive.org]][491]</sup>

I recommend using dd or shred for this purpose.

-   Option B: Install and use BleachBit <https://www.bleachbit.org/download/linux> <sup>[[Archive.org]][487]</sup> or follow this EFF tutorial <https://ssd.eff.org/en/module/how-delete-your-data-securely-linux> <sup>[[Archive.org]][492]</sup>
...
-   Option B: Use external tools such as:
    ...
    -   Eraser (open-source): <https://eraser.heidi.ie/download/> <sup>[[Archive.org]][493]</sup>

    -   KillDisk Free: <http://killdisk.com/killdisk-freeware.htm> <sup>[[Archive.org]][494]</sup>
...
Unfortunately, the macOS Recovery disk utility will not be able to perform a secure erase of your SSD drive as stated in Apple documentation <https://support.apple.com/en-gb/guide/disk-utility/dskutl14079/mac> <sup>[[Archive.org]][495]</sup>.
...
-   <https://support.apple.com/guide/disk-utility/erase-and-reformat-a-storage-device-dskutl14079/mac> <sup>[[Archive.org]][496]</sup>

-   <https://support.apple.com/guide/disk-utility/encrypt-protect-a-storage-device-password-dskutl35612/mac> <sup>[[Archive.org]][497]</sup> or using Veracrypt full disk encryption.
...
Follow this tutorial: <https://support.apple.com/guide/disk-utility/erase-and-reformat-a-storage-device-dskutl14079/mac> <sup>[[Archive.org]][496]</sup> and use the secure erase option from Disk Utility which should work fine on HDD and Thumb drives.
...
-   Right-click a file/folder:
    ...
    -   BleachBit: Shred with BleachBit (or see this tutorial from the EFF <https://ssd.eff.org/en/module/how-delete-your-data-securely-windows> <sup>[[Archive.org]][499]</sup>)
...
-   Decrypt and re-encrypt (using LUKS for instance following this tutorial <https://wiki.archlinux.org/index.php/dm-crypt/Device_encryption#Re-encrypting_devices> <sup>[[Archive.org]][500]</sup>) the whole drive to overwrite all free space after data deletion. This will ensure overwriting of all the free space.

-   Trim using ```fstrim --all``` and then fill up the entire free space of the disk using a utility such as:

    -   BleachBit <https://www.bleachbit.org/download/linux> <sup>[[Archive.org]][487]</sup>
    ...
    -   Use the old school dd method (taken from this answer <https://superuser.com/questions/19326/how-to-wipe-free-disk-space-in-linux> <sup>[[Archive.org]][488]</sup>) run these commands on the drive you want to fill:
...
-   You can do this the graphical way with BleachBit following this tutorial from the EFF: <https://ssd.eff.org/en/module/how-delete-your-data-securely-linux> <sup>[[Archive.org]][492]</sup>

-   Or you can do this from the command line following this tutorial: <https://linuxhint.com/completely_wipe_hard_drive_ubuntu/> <sup>[[Archive.org]][489]</sup> (For this purpose I recommend wipe and shred).
...
-   Decrypt and re-encrypt (using LUKS using this tutorial <https://wiki.archlinux.org/index.php/dm-crypt/Device_encryption#Re-encrypting_devices> <sup>[[Archive.org]][500]</sup> or Veracrypt from the graphical interface for instance) the whole drive to overwrite all free space after data deletion. This will ensure overwriting of all the free space.
...
-   Fill the free space using one of those methods:
    ...
    -   Use the old school dd method (taken from this answer <https://superuser.com/questions/19326/how-to-wipe-free-disk-space-in-linux> <sup>[[Archive.org]][488]</sup>) run these commands:
...
Please follow this documentation to Trim within Qubes OS: <https://github.com/Qubes-Community/Contents/blob/master/docs/configuration/disk-trim.md> <sup>[[Archive.org]][501]</sup>
...
-   Decrypt and re-encrypt the whole drive to overwrite all free space after data deletion. This will ensure overwriting of all the free space. I didn't find a reliable tutorial on how to do this safely on Qubes OS but it is possible this tutorial could work: <https://wiki.archlinux.org/index.php/dm-crypt/Device_encryption#Re-encrypting_devices> <sup>[[Archive.org]][500]</sup> (at your own risk, this has not been tested yet).

-   Refer to this Documentation (<https://github.com/Qubes-Community/Contents/blob/master/docs/configuration/disk-trim.md> <sup>[[Archive.org]][501]</sup>) and then trim using "fstrim --all" and then fill up the entire free space of the disk using a utility such as:
...
If Trim is supported and enabled by your Linux Distribution for your external SSD drive. There should be no issue in securely deleting data normally and just issue a "fstrim --all" from the terminal to trim the drive. Refer to this Documentation (<https://github.com/Qubes-Community/Contents/blob/master/docs/configuration/disk-trim.md> <sup>[[Archive.org]][501]</sup>) to enable trim on a drive.
...
-   If your file system is APFS, you do not need to worry about Trim, it happens asynchronously as the OS writes data[^435] according to their documentation.
...
-   If your file system is HFS+, you could run First Aid on your System Drive from the Disk Utility which should perform a Trim operation in the details (<https://support.apple.com/en-us/HT210898> <sup>[[Archive.org]][502]</sup>)

![][503]

#### System/Internal, External HDD drive or a Thumb Drive:

Unfortunately, Apple has removed the secure erase options from the trash bin even for HDD drives[^436]. So, you are left with using other tools:

-   Permanent Eraser <http://www.edenwaith.com/products/permanent%20eraser/> <sup>[[Archive.org]][504]</sup>

-   From the terminal, you can use the "rm --P filename" command which should erase the file and overwrite it as explained in this EFF tutorial <https://ssd.eff.org/en/module/how-delete-your-data-securely-macos> <sup>[[Archive.org]][505]</sup>.
...
Consider also reading this documentation if you're going with Whonix <https://www.whonix.org/wiki/Anti-Forensics_Precautions> <sup>[[Archive.org]][343]</sup> as well as their general hardening tutorial for all platforms here <https://www.whonix.org/wiki/System_Hardening_Checklist> <sup>[[Archive.org]][506]</sup>

### Removing Metadata from Files/Documents/Pictures:

#### Pictures and videos:

On Windows, macOS, and Linux I would recommend ExifTool (<https://exiftool.org/> <sup>[[Archive.org]][507]</sup>) and/or ExifCleaner (<https://exifcleaner.com/> <sup>[[Archive.org]][508]</sup>) that allows viewing and/or removing those properties.

**ExifTool is natively available on Tails and Whonix Workstation.**

##### ExifCleaner:

Just install it from <https://exifcleaner.com/> <sup>[[Archive.org]][508]</sup>, run and drag and drop the files into the GUI.
...
Here is a tutorial to remove metadata from a Picture using OS provided tools: <https://www.purevpn.com/internet-privacy/how-to-remove-metadata-from-photos> <sup>[[Archive.org]][509]</sup>

##### Cloaking/Obfuscating to prevent picture recognition:

Consider the use of Fawkes <https://sandlab.cs.uchicago.edu/fawkes/> <sup>[[Archive.org]][510]</sup> (<https://github.com/Shawn-Shan/fawkes> <sup>[[Archive.org]][511]</sup>) to cloak the images from picture recognition tech on various platforms.

Or if you want online versions, consider:

-   <https://lowkey.umiacs.umd.edu/> <sup>[[Archive.org]][512]</sup>

-   <https://adversarial.io/> <sup>[[Archive.org]][513]</sup>

#### PDF Documents:

##### PDFParanoia (Linux/Windows/macOS/QubesOS):

Consider using <https://github.com/kanzure/pdfparanoia> <sup>[[Archive.org]][514]</sup> which will remove metadata and watermarks on any PDF.
...
First, here is a tutorial to remove metadata from Office documents: <https://support.microsoft.com/en-us/office/remove-hidden-data-and-personal-information-by-inspecting-documents-presentations-or-workbooks-356b7b5d-77af-44fe-a07f-9aa4d085966f> <sup>[[Archive.org]][515]</sup>. Make sure however that you do use the latest version of Office with the latest security updates.

Alternatively, on Windows, macOS, Qubes OS, and Linux I would recommend ExifTool (<https://exiftool.org/> <sup>[[Archive.org]][507]</sup>) and/or ExifCleaner (<https://exifcleaner.com/> <sup>[[Archive.org]][508]</sup>) that allows viewing and/or removing those properties
...
In addition, on Windows, macOS, Qubes OS, and Linux I would recommend ExifTool (<https://exiftool.org/> <sup>[[Archive.org]][507]</sup>) and/or ExifCleaner (<https://exifcleaner.com/> <sup>[[Archive.org]][508]</sup>) that allows viewing and/or removing additional properties
...
Another option good tool IMHO to remove metadata from various documents is the open-source mat2 recommended by privacyguides.org[^437] (<https://0xacab.org/jvoisin/mat2> <sup>[[Archive.org]][516]</sup>) which you can use on Linux quite easily. I never managed to make it work properly within Windows due to various dependencies issues despite the provided instructions. It is however very straightforward to install and use on Linux.
...
Mat2 is also pre-installed on the Whonix Workstation VM[^438] and available on Tails by default[^439].
...
Note that it's possible to run Whonix in Live mode leaving no traces when you shut down the VMs, consider reading their documentation here <https://www.whonix.org/wiki/VM_Live_Mode> <sup>[[Archive.org]][518]</sup> and here <https://www.whonix.org/wiki/Warning#Whonix_.E2.84.A2_Persistence_vs_Live_vs_Amnesic> <sup>[[Archive.org]][215]</sup>.
...
Most of the info from this section can also be found at this nice guide <https://github.com/drduh/macOS-Security-and-Privacy-Guide> <sup>[[Archive.org]][295]</sup>
...
Lastly, you can also disable Gatekeeper altogether by issuing the following command in the terminal[^440]:

-   ```sudo spctl --master-disable```

Refer to this section of this guide for further information <https://github.com/drduh/macOS-Security-and-Privacy-Guide#gatekeeper-and-xprotect> <sup>[[Archive.org]][295]</sup>
...
See this section of this guide for guidance on where to find and how to delete such artifacts: <https://github.com/drduh/macOS-Security-and-Privacy-Guide#metadata-and-artifacts> <sup>[[Archive.org]][295]</sup>

Many of those can be deleted using various commercial third-party tools but I would personally recommend using the free and well-known Onyx which you can find here: <https://www.titanium-software.fr/en/onyx.html> <sup>[[Archive.org]][519]</sup>. Unfortunately, it is closed-source, but it is notarized, signed, and has been trusted for many years.
...
-   If your file system is HFS+ (or any other than APFS), you could run First Aid on your System Drive from the Disk Utility which should perform a Trim operation in the details (<https://support.apple.com/en-us/HT210898> <sup>[[Archive.org]][502]</sup>).

![][503]

### Linux (Qubes OS):

Please consider their guidelines <https://github.com/Qubes-Community/Contents/blob/master/docs/security/security-guidelines.md> <sup>[[Archive.org]][520]</sup>

If you are using Whonix on Qubes OS, please consider following some of their guides:

-   Whonix System Hardening guide <https://www.whonix.org/wiki/System_Hardening_Checklist> <sup>[[Archive.org]][506]</sup>

-   Enabling App Armor on Qubes <https://www.whonix.org/wiki/Qubes/AppArmor> <sup>[[Archive.org]][373]</sup>

-   Also, consider the use of Linux Kernel Guard <https://www.whonix.org/wiki/Linux_Kernel_Runtime_Guard_LKRG> <sup>[[Archive.org]][521]</sup>
...
Nevertheless, you might want to clean some logs. Consider having a look this convenient (but unfortunately unmaintained) tool: <https://github.com/sundowndev/covermyass> <sup>[[Archive.org]][522]</sup>
...
Consider the use of Linux Kernel Guard as an added measure <https://www.whonix.org/wiki/Linux_Kernel_Runtime_Guard_LKRG> <sup>[[Archive.org]][521]</sup>
...
Windows Event logs will keep many various pieces of information that could contain traces of your activities such as the devices that were mounted (including Veracrypt NTFS volumes for instance[^326]), your network connections, app crash information, and various errors. It is always best to clean those up regularly. Do not do this on the Decoy OS.
...
-   Launch Regedit using this tutorial: <https://support.microsoft.com/en-us/windows/how-to-open-registry-editor-in-windows-10-deab38e6-91d6-e0aa-4b7c-8878d9e07b11> <sup>[[Archive.org]][523]</sup>
...
As explained earlier, Shellbags are basically histories of accessed volumes/files on your computer. Remember that shellbags are exceptionally useful sources of information for forensics[^318] and you need to clean those. Especially if you mounted any "hidden volume" anywhere. Again, you should not do this on the Decoy OS:

-   Download Shellbag Analyzer & Cleaner from <https://privazer.com/en/download-shellbag-analyzer-shellbag-cleaner.php> <sup>[[Archive.org]][524]</sup>
...
-   Download and install PrivaZer from <https://privazer.com/en/download.php> <sup>[[Archive.org]][525]</sup>
    ...
    -   (If you did select Free Space cleaning) Within Clean Options **(Be careful with this option as it will erase all the free space on the selected partition, especially if you are running the decoy OS. Do not erase the free space or anything else on the second partition as you risk destroying your Hidden OS)**
        ...
        -   If you have an SSD drive:
            ...
            -   Secure Overwriting Tab: I would just pick Normal Deletion + Trim (Trim itself should be enough[^335]). Secure Deletion with Trim[^332] (1 pass) might be redundant and overkill here if you intend to overwrite the free space anyway.
...
-   Get and install the latest version from BleachBit here <https://www.bleachbit.org/download> <sup>[[Archive.org]][526]</sup>
...
-   <https://justdeleteme.xyz/> <sup>[[Archive.org]][527]</sup>

-   <https://justgetmydata.com/> <sup>[[Archive.org]][528]</sup>
...
Go to their "Remove outdated content from Google Search" page here: <https://search.google.com/search-console/remove-outdated-content> <sup>[[Archive.org]][529]</sup> and submit a request accordingly.
...
Go to their "Content Removal" page here: <https://www.bing.com/webmasters/tools/contentremoval> <sup>[[Archive.org]][530]</sup> and submit a request accordingly.
...
DuckDuckGo does not store a cached version of pages[^441] and will instead forward you to a Google/Bing cached version if available.

In addition, DuckDuckGo source most of their searches from Bing (and not Google)[^442] and therefore removing the content from Bing should in time have it removed it from DuckDuckGo too.
...
Once have your Yandex account, head to the Yandex Webmaster tools <https://webmaster.yandex.com> <sup>[[Archive.org]][531]</sup> and then select Tools and Delete URL <https://webmaster.yandex.com/tools/del-url/> <sup>[[Archive.org]][532]</sup>
...
Yes, Yahoo Search still exists but as per their help page <https://help.yahoo.com/kb/SLN4530.html> <sup>[[Archive.org]][533]</sup>, there is no way to remove information or refresh information besides waiting. This could take 6 to 8 weeks.
...
-   <https://inteltechniques.com/workbook.html> <sup>[[Archive.org]][536]</sup>
...
A commonly used technique that combines the idea of a Dead Drop[^443] and Secure Communication Obfuscation[^444] through Steganography[^445] and/or Kleptography[^446] and has many names such as Koalang[^447] or "Talking Around" or even "Social Steganography". This technique is very old and still widely used nowadays by teenagers to bypass parental control. It is hiding in plain sight.
...
Wait, what is OPSEC? Well, OPSEC means Operations Security[^448]. The basic definition is: "OPSEC is the process of protecting individual pieces of data that could be grouped together to give the bigger picture ".
...
-   Consider the use of Haven <https://guardianproject.github.io/haven/> <sup>[[Archive.org]][537]</sup> on some old android phone to keep watch on your home/room while you are away.

-   Doxx "yourself" and your identities from time to time by looking for them yourself online using various search engines to monitor your online identities. You can even automate the process somewhat using various tools such as Google Alerts <https://www.google.com/alerts> <sup>[[Archive.org]][538]</sup>.
...
-   Never ever leave your laptop unattended/on/unlocked anywhere when conducting sensitive activities. Remember the story of Ross Ulbricht and his arrest <https://en.wikipedia.org/wiki/Ross_Ulbricht#Silk_Road,_arrest_and_trial> <sup>[[Wikiless]][539]</sup> <sup>[[Archive.org]][540]</sup>.

-   Check for tampering regularly (not only your devices but also your home/room).

-   If you can, do not talk to the police/authorities (at least if you are in the US) <https://www.youtube.com/watch?v=d-7o9xYp7eE> <sup>[[Invidious]][541]</sup> without a lawyer. Remain silent.
...
-   Read those tips here <https://www.whonix.org/wiki/DoNot> <sup>[[Archive.org]][340]</sup>

-   **Finally, have common sense, do not be dumb, look and learn from others' mistakes, watch/read these:**

    -   Medium.com, Darkweb Vendors and the Basic Opsec Mistakes They Keep Making <https://medium.com/@c5/darkweb-vendors-and-the-basic-opsec-mistakes-they-keep-making-e54c285a488c> <sup>[[Archive.org]][542]</sup>

    -   2020, Sinwindie, OSINT, and Dark Web Markets, Why OPSEC Still Matters <https://www.youtube.com/watch?v=IqZZU9lFlF4> <sup>[[Invidious]][543]</sup>

    -   2020, RSA Conference 2020, When Cybercriminals with Good OpSec Attack <https://www.youtube.com/watch?v=zXmZnU2GdVk> <sup>[[Invidious]][544]</sup>

    -   2015, DEFCON 22, Adrian Crenshaw- Dropping Docs on Darknets: How People Got Caught, <https://www.youtube.com/watch?v=eQ2OZKitRwc> <sup>[[Invidious]][545]</sup> ([Slides][] <sup>[[Archive.org]][546]</sup>)

    -   2017, Ochko123 - How the Feds Caught Russian Mega-Carder Roman Seleznev <https://www.youtube.com/watch?v=6Chp12sEnWk> <sup>[[Invidious]][547]</sup>

    -   2015, DEF CON 22 - Zoz - Don't Fuck It Up! <https://www.youtube.com/watch?v=J1q4Ir2J8P8> <sup>[[Invidious]][548]</sup>

    -   2020, Bad Opsec - How Tor Users Got Caught, <https://www.youtube.com/watch?v=GR_U0G-QGA0> <sup>[[Invidious]][549]</sup>
...
Keep in mind that many countries have specific laws to compel you to reveal your passwords that could override your "right to remain silent". See this Wikipedia article: <https://en.wikipedia.org/wiki/Key_disclosure_law> <sup>[[Wikiless]][550]</sup> <sup>[[Archive.org]][551]</sup> and this other visual resource with law references <https://www.gp-digital.org/world-map-of-encryption/> <sup>[[Archive.org]][552]</sup>.
...
**"A lie can travel halfway around the world while the truth is putting on its shoes"**[^449]
...
See current goals and donate at <https://anonymousplanet.org/donations.html> <sup>[[Mirror]][553]</sup> <sup>[[Archive.org]][554]</sup> <sup>[[Tor Mirror]][555]</sup> or directly by sending Monero (XMR) to this Address: ```4549BGJrEPBfpiPRL9CVGzGMgJnC1Dzf8EXLVfY8Ukrnj7LzkTV611dGf9tuQHiSQjbixsNWiffNiV5fPB3LkyF7UXi3vwQ```
...
-   The Easiest:
    ...
    -   Using the Snowflake addon on your browser (<https://snowflake.torproject.org/> <sup>[[Archive.org]][559]</sup>)

-   Slightly more work:

    -   Running a Tor relay node (<https://community.torproject.org/relay/> <sup>[[Archive.org]][560]</sup>)

        -   See [Recommended VPS hosting providers]

        -   Additional Tutorial: <https://torrelay.ca/> <sup>[[Archive.org]][561]</sup>

If you want a bit more challenge, you can also run a Tor Exit node anonymously using the recommended VPS providers above.

For this, see <https://blog.torproject.org/tips-running-exit-node> <sup>[[Archive.org]][562]</sup>
...
-   **Very Special Thanks to Edward Snowden and who inspired me to write this guide (buy and read his book please <https://en.wikipedia.org/wiki/Permanent_Record_(autobiography)>** <sup>[[Wikiless]][563]</sup> <sup>[[Archive.org]][564]</sup>**)**
...
As written earlier in this guide and as noted by PrivacyGuides.org[^450], Windows 10 is a privacy nightmare. And disabling everything during and after the installation using the settings available to you is not enough. The amount of telemetry data collected by Microsoft is staggering and could defeat your attempts at keeping secrets. You will need to download and use a couple of utilities to (hopefully) force Windows 10 into not sending data back to Microsoft.
...
-   Download and install W10Privacy from <https://www.w10privacy.de/english-home/> <sup>[[Archive.org]][565]</sup>
...
-   Download and run WindowsSpyBlocker from <https://crazymax.dev/WindowsSpyBlocker/download/> <sup>[[Archive.org]][566]</sup>
...
-   Also, consider using ShutUp10 from <https://www.oo-software.com/en/shutup10> <sup>[[Archive.org]][567]</sup>
...
-   System Rescue:
    ...
    -   Create a System Rescue USB disk following these instructions <https://www.system-rescue.org/Installing-SystemRescue-on-a-USB-memory-stick/> <sup>[[Archive.org]][570]</sup> (download the ISO and write to a USB stick with Rufus).
...
-   SATA SSD:
    ...
    -   ATA Secure Erase:
        ...
        -   Follow one of these tutorials
            ...
            -   <https://wiki.archlinux.org/index.php/Solid_state_drive/Memory_cell_clearing> <sup>[[Archive.org]][571]</sup>

            -   <https://ata.wiki.kernel.org/index.php/ATA_Secure_Erase> <sup>[[Archive.org]][572]</sup>

            -   <https://tinyapps.org/docs/wipe_drives_hdparm.html> <sup>[[Archive.org]][573]</sup>

    -   ATA Sanitize:

        -   Follow this tutorial <https://tinyapps.org/docs/ata_sanitize_hdparm.html> <sup>[[Archive.org]][574]</sup>
...
-   NVMe SSD:
    ...
    -   Follow one of these tutorials:
        ...
        -   <https://tinyapps.org/docs/nvme-secure-erase.html> <sup>[[Archive.org]][575]</sup>

        -   <https://tinyapps.org/docs/nvme-sanitize.html> <sup>[[Archive.org]][576]</sup>

# Appendix E: Clonezilla

-   Get Clonezilla by just following these instructions: <https://clonezilla.org/liveusb.php> <sup>[[Archive.org]][577]</sup> (I recommend the Alternative version AMD64 that should work with most recent laptops)

-   Boot from Clonezilla

-   Follow these steps to make a backup: <https://clonezilla.org/show-live-doc-content.php?topic=clonezilla-live/doc/01_Save_disk_image> <sup>[[Archive.org]][578]</sup>
...
-   You are done, if you need to restore, follow these instructions: <https://clonezilla.org/show-live-doc-content.php?topic=clonezilla-live/doc/02_Restore_disk_image> <sup>[[Archive.org]][579]</sup>
...
If you are experiencing issues connecting to Tor due to Censorship or Blocking, you might consider using Tor bridges as explained here: <https://bridges.torproject.org/> <sup>[[Archive.org]][580]</sup>
...
-   Native Tools:
    ...
    -   Windows 10 Disk Cleanup Utility: <https://support.microsoft.com/en-us/windows/disk-cleanup-in-windows-10-8a96ff42-5751-39ad-23d6-434b4d5b9a68> <sup>[[Archive.org]][581]</sup>
...
-   Windows 10 Optimize Utility (Defrag on HDD Drives): <https://support.microsoft.com/en-us/windows/defragment-your-windows-10-pc-048aefac-7f1f-4632-d48a-9700c4ec702a> <sup>[[Archive.org]][582]</sup>
...
-   Third-Party Tools:
    ...
    -   The open-source utility BleachBit <https://www.bleachbit.org/> <sup>[[Archive.org]][583]</sup>

    -   The closed-source utility PrivaZer <https://privazer.com/> <sup>[[Archive.org]][584]</sup>
...
-   The Windows USN journal which stores plenty of information[^452].

-   The Windows System Resource Usage Monitor (SRUM)[^453].

-   Various histories of various programs (such as the recent lists).

-   Various logs

-   The free (unallocated) space of your hard drive[^454].
...
Several utilities are recommended (like the old unmaintained DBAN[^455] or System Rescue CD (<https://www.system-rescue.org/> <sup>[[Archive.org]][585]</sup>)) for this but I will recommend the use of ShredOS.

Feel free to go with DBAN instead if you want (using this tutorial: <https://www.lifewire.com/how-to-erase-a-hard-drive-using-dban-2619148> <sup>[[Archive.org]][586]</sup>), the process is basically the same but will not work out of the box with UEFI laptops.

If you want to go with System-Rescue, just head to their website and follow the instructions.

## Windows:

-   Download ShredOS from <https://github.com/PartialVolume/shredos.2020.02> <sup>[[Archive.org]][587]</sup>

-   Unzip the ISO file

-   Download Rufus from <https://rufus.ie/> <sup>[[Archive.org]][588]</sup>
...
-   Follow instructions on <https://github.com/PartialVolume/shredos.2020.02> <sup>[[Archive.org]][587]</sup>
...
-   SanDisk DashBoard: <https://kb.sandisk.com/app/answers/detail/a_id/15108/~/dashboard-support-information> <sup>[[Archive.org]][589]</sup>

-   Seagate SeaTools: <https://www.seagate.com/support/downloads/seatools/> <sup>[[Archive.org]][590]</sup>

-   Samsung Magican: <https://www.samsung.com/semiconductor/minisite/ssd/download/tools/> <sup>[[Archive.org]][591]</sup>

-   Kingston SSD Manager: <https://www.kingston.com/unitedstates/en/support/technical/ssdmanager> <sup>[[Archive.org]][592]</sup>

-   Lenovo:

    -   Most likely native utility available within the BIOS/UEFI, please check

    -   Drive Erase Utility: <https://support.lenovo.com/us/en/downloads/ds019026-thinkpad-drive-erase-utility-for-resetting-the-cryptographic-key-and-erasing-the-solid-state-drive-thinkpad> <sup>[[Archive.org]][593]</sup>

-   Crucial Storage Executive: <https://www.crucial.com/support/storage-executive> <sup>[[Archive.org]][594]</sup>

-   Western Digital Dashboard: <https://support.wdc.com/downloads.aspx?p=279> <sup>[[Archive.org]][595]</sup>

-   HP: Follow instructions on <https://store.hp.com/us/en/tech-takes/how-to-secure-erase-ssd> <sup>[[Archive.org]][596]</sup>

-   Transcend SSD Scope: <https://www.transcend-info.com/Support/Software-10/> <sup>[[Archive.org]][597]</sup>

-   Dell:

    -   Most likely native utility available within the BIOS/UEFI, please check <https://www.dell.com/support/kbdoc/en-us/000134997/using-the-dell-bios-data-wipe-function-for-optiplex-precision-and-latitude-systems-built-after-november-2015?lwp=rt> <sup>[[Archive.org]][598]</sup>

## Tools that provide only support from running OS (for external drives).

-   Toshiba Storage Tools: <https://www.toshiba-storage.com/downloads/> <sup>[[Archive.org]][599]</sup>
...
Some might be very efficient[^456] but many are gimmicky gadgets.
...
**Use the manufacturer-provided tools to check and perform these operations** ... It is pretty much the only way to be sure it is not only supported but actually works. Some utilities can tell you whether it is supported or not like CrystalDiskInfo[^457] but will not actually check if it is working. See [Appendix J: Manufacturer tools for Wiping HDD and SSD drives][Appendix J: Manufacturer tools for Wiping HDD and SSD drives:].
...
Follow this good tutorial: <https://www.glump.net/howto/desktop/enable-trim-on-an-external-ssd-on-linux> <sup>[[Archive.org]][600]</sup>

### ATA/NVMe Operations (Secure Erase/Sanitize):

**It is not "recommended". Please read the disclaimers here <https://ata.wiki.kernel.org/index.php/ATA_Secure_Erase>** <sup>[[Archive.org]][572]</sup> **and here <https://wiki.archlinux.org/index.php/Solid_state_drive/Memory_cell_clearing>** <sup>[[Archive.org]][571]</sup>
...
See also this tutorial <https://code.mendhak.com/securely-wipe-ssd/> <sup>[[Archive.org]][601]</sup>
...
According to Apple Documentation[^450], Trim is supported on APFS (asynchronously) and HFS+ (through period trim or first-aid).
...
If your disk supports it but it is not enabled in macOS. You could try issuing a "sudo trimforce enable" command from the Terminal and see if it enables Trim on your external SSD. And then again check the first aid command if it is not APFS (see this Tutorial for info <https://www.lifewire.com/enable-trim-for-ssd-in-os-x-yosemite-2260789> <sup>[[Archive.org]][602]</sup>)

If it does not work, I am not aware of any reliable method to enable TRIM besides the commercial utility Trim Enabler here <https://cindori.org/trimenabler/> <sup>[[Archive.org]][603]</sup> which claims support for external drives.
...
Download the latest Debian testing amd64 netinst ISO from <https://www.debian.org/CD/netinst/> <sup>[[Archive.org]][604]</sup>
...
-   Lenovo ThinkPads: <https://support.lenovo.com/be/en/solutions/migr-68369> <sup>[[Archive.org]][605]</sup>

-   HP (all): <https://support.hp.com/gb-en/document/c06204100> <sup>[[Archive.org]][606]</sup>

-   Dell (all): <https://www.dell.com/support/kbdoc/en-us/000146892/dell-data-wipe> <sup>[[Archive.org]][607]</sup>

-   Acer (Travelmate only): <https://us.answers.acer.com/app/answers/detail/a_id/41567/~/how-to-use-disk-sanitizer-on-acer-travelmate-notebooks> <sup>[[Archive.org]][608]</sup>
...
-   **AN0M: <https://www.theguardian.com/australia-news/2021/sep/11/inside-story-most-daring-surveillance-sting-in-history>** <sup>[[Archive.org]][611]</sup>

-   **Encrochat: <https://en.wikipedia.org/wiki/EncroChat>** <sup>[[Wikiless]][612]</sup> <sup>[[Archive.org]][613]</sup>

-   **Sky ECC: <https://en.wikipedia.org/wiki/Sky_ECC>** <sup>[[Wikiless]][614]</sup> <sup>[[Archive.org]][615]</sup>
...
There are three VPN companies recommended by PrivacyGuides.org (<https://privacyguides.org/providers/vpn/> <sup>[[Archive.org]][616]</sup>) that accept cash payments: Mullvad, iVPN, and ProtonVPN.

In addition, I will also mention a newcomer to watch: Safing SPN <https://safing.io/> <sup>[[Archive.org]][617]</sup>) which (while still in the alpha stage at the time of this writing) which also accepts cash and has a very distinct new concept for a VPN which provides benefits similar to Tor Stream isolation with their "SPN"). Note that Safing SPN is not available on macOS at the moment. This possibility is "provisional" and at your own risk, but I think was worth mentioning.
...
-   Wearing gloves while manipulating anything to avoid leaving fingerprints[^462] and touch DNA[^463].
...
-   Do not lick the envelope or the stamps[^464] if you use them to avoid leaving DNA traces.
...
This does also offer some disadvantages as Monero is not perfect as explained earlier in this guide and some global adversaries could maybe still track you. You will need to get Monero from an Exchange using the normal financial system and then pick a hosting (list here <https://www.getmonero.org/community/merchants/#exchanges> <sup>[[Archive.org]][618]</sup>) or from a local reseller using cash from <https://localmonero.co>.
...
There are plenty of tutorials on how to do this like this one <https://proprivacy.com/vpn/guides/create-your-own-vpn-server> <sup>[[Archive.org]][619]</sup>
...
-   (Windows/Linux/macOS) <https://linuxize.com/post/how-to-setup-ssh-socks-tunnel-for-private-browsing/> <sup>[[Archive.org]][620]</sup>

-   (Windows/Linux/macOS) <https://www.digitalocean.com/community/tutorials/how-to-route-web-traffic-securely-without-a-vpn-using-a-socks-tunnel> <sup>[[Archive.org]][621]</sup>

-   (Windows) <https://www.forwardproxy.com/2018/12/using-putty-to-setup-a-quick-socks-proxy/> <sup>[[Archive.org]][622]</sup>

-   (Linux/macOS) <https://ma.ttias.be/socks-proxy-linux-ssh-bypass-content-filters/> <sup>[[Archive.org]][623]</sup>
...
-   Download and install Putty from <https://www.putty.org/> <sup>[[Archive.org]][624]</sup>
...
In that case, my last resort recommendation is to connect safely **from a distance** to a Public Wi-Fi (See [Find some safe places with decent public Wi-Fi][Find some safe places with decent public Wi-Fi:]) using your laptop and Tails "unsafe browser". See <https://tails.boum.org/contribute/design/Unsafe_Browser/> <sup>[[Archive.org]][626]</sup>.
...
Consider reading this older but still relevant guide <https://archive.flossmanuals.net/bypassing-censorship/index.html> <sup>[[Archive.org]][627]</sup>
...
**I would recommend the AWUS036 series in the Alfa brand of adapters (see <https://www.alfa.com.tw/>** <sup>[[Archive.org]][629]</sup>**).** But you could also go with some other brands if you want such as the TP-Link TL-WN722 (see <https://www.tp-link.com/us/home-networking/usb-adapter/tl-wn722n/> <sup>[[Archive.org]][630]</sup>).

See this post for a comparison of various adapters: <https://www.wirelesshack.org/best-kali-linux-compatible-usb-adapter-dongles.html> <sup>[[Archive.org]][631]</sup> (Usually those antennas are used by Penetration Testers to probe Wi-Fis from a distance and are often discussed within the scope of the Kali Linux distribution).
...
**Do not forget tho that this will only delay a motivated adversary. Your signal can be triangulated easily by a motivated adversary in a matter of minutes once they reach the physical location of the Wi-Fi you're connecting to (for instance using a device such as AirCheck <https://www.youtube.com/watch?v=8FV2QZ1BPnw>** <sup>[[Invidious]][632]</sup>**, also see their other products here <https://www.netally.com/products/>** <sup>[[Archive.org]][633]</sup>**). These products can easily be deployed on mobile units (in a Car for instance) and pinpoint your location in a matter of minutes.**
...
-   Whonix Tutorial (should work with any VPN provider): <https://www.whonix.org/wiki/Tunnels/Connecting_to_a_VPN_before_Tor> <sup>[[Archive.org]][320]</sup> (use the Linux configurations below to get the necessary configuration files)

-   Windows Tutorials:

    -   Mullvad: <https://mullvad.net/en/help/install-mullvad-app-windows/> <sup>[[Archive.org]][634]</sup>

    -   iVPN: <https://www.ivpn.net/apps-windows> <sup>[[Archive.org]][635]</sup>

    -   Safing: <https://docs.safing.io/portmaster/install/windows> <sup>[[Archive.org]][636]</sup>

    -   ProtonVPN: <https://protonvpn.com/support/protonvpn-windows-vpn-application/> <sup>[[Archive.org]][637]</sup>

-   macOS:

    -   Mullvad: <https://mullvad.net/en/help/install-and-use-mullvad-app-macos/> <sup>[[Archive.org]][638]</sup>

    -   IVPN: <https://www.ivpn.net/apps-macos/> <sup>[[Archive.org]][639]</sup>

    -   Safing: Not available on macOS

    -   ProtonVPN: <https://protonvpn.com/support/protonvpn-mac-vpn-application/> <sup>[[Archive.org]][640]</sup>

-   Linux:

    -   Mullvad: <https://mullvad.net/en/help/install-mullvad-app-linux/> <sup>[[Archive.org]][641]</sup>

    -   iVPN: <https://www.ivpn.net/apps-linux/> <sup>[[Archive.org]][642]</sup>

    -   Safing: <https://docs.safing.io/portmaster/install/linux> <sup>[[Archive.org]][643]</sup>

    -   ProtonVPN: <https://protonvpn.com/support/linux-vpn-setup/> <sup>[[Archive.org]][644]</sup>
...
-   Windows:
    ...
    -   iVPN: <https://www.ivpn.net/knowledgebase/general/do-you-offer-a-kill-switch-or-vpn-firewall/> <sup>[[Archive.org]][645]</sup>

    -   ProtonVPN: <https://protonvpn.com/support/what-is-kill-switch/> <sup>[[Archive.org]][646]</sup>

    -   Mullvad: <https://mullvad.net/en/help/using-mullvad-vpn-app/#killswitch> <sup>[[Archive.org]][647]</sup>
...
-   macOS:
    ...
    -   ProtonVPN same as Windows with the client, the option should be in the provided VPN client <https://protonvpn.com/blog/macos-vpn-kill-switch/> <sup>[[Archive.org]][648]</sup>

-   Linux:

    -   Mullvad:

        -   <https://mullvad.net/en/help/wireguard-and-mullvad-vpn/> <sup>[[Archive.org]][649]</sup>

        -   <https://mullvad.net/en/help/linux-openvpn-installation/> <sup>[[Archive.org]][650]</sup>

    -   ProtonVPN: <https://github.com/ProtonVPN/linux-cli/blob/master/USAGE.md#kill-switch> <sup>[[Archive.org]][651]</sup>

    -   iVPN:

        -   <https://www.ivpn.net/knowledgebase/linux/linux-wireguard-kill-switch/> <sup>[[Archive.org]][652]</sup>

        -   <https://www.ivpn.net/knowledgebase/linux/linux-kill-switch-using-the-uncomplicated-firewall-ufw/> <sup>[[Archive.org]][653]</sup>

# Appendix S: Check your network for surveillance/censorship using OONI

So, what is OONI? OONI stands for Open Observatory of Network Interference and is a sub-project of the Tor Project[^288].
...
The problem is that your network providers will be able to see those tests and your attempts at connecting to various services if the network is monitored. The other issue is that there are solutions to prevent OONI from working properly[^465].
...
The probe can be found here: <https://ooni.org/install/> <sup>[[Archive.org]][654]</sup> for various platforms (iOS, Android, Windows, macOS, and Linux).

# Appendix T: Checking files for malware

## Integrity (if available):

Usually, integrity checks[^466] are done using hashes of files (usually stored within checksum files). Older files could use CRC[^467], more recently MD5[^468] but those present several weaknesses (CRC, MD5[^469]) that make them unreliable for file integrity checks (which does not mean they are not still widely used in other contexts).

This is because they do not prevent Collision[^470] well enough and could allow an adversary to create a similar but malicious file that would still produce in the same CRC or MD5 hash despite having different content.

For this reason, it is usually recommended to use SHA-based[^471] hashes and the most used is probably the SHA-2[^472] based SHA256 for verifying file integrity. SHA is much more resistant to collisions[^473] than CRC and MD5. And collisions with SHA256 or SHA512 are rare and hard to compute for an adversary.
...
Integrity is one thing. Authenticity is another thing. This is a process where you can verify some information is authentic and from the expected source. This is usually done by signing information (using GPG[^476] for instance) using public-key cryptography[^477].
...
-   Install GPG for your OS:
    ...
    -   Windows: gpg4win (<https://www.gpg4win.org/> <sup>[[Archive.org]][655]</sup>)

    -   macOS: GPGTools (<https://gpgtools.org/> <sup>[[Archive.org]][656]</sup>)
...
-   <https://support.torproject.org/tbb/how-to-verify-signature/> <sup>[[Archive.org]][657]</sup>

-   <https://tails.boum.org/install/vm-download/index.en.html> <sup>[[Archive.org]][658]</sup> (See Basic OpenPGP verification).

-   <https://www.whonix.org/wiki/Verify_the_Whonix_images> <sup>[[Archive.org]][659]</sup>
...
You might be asking yourself, what about Anti-Virus solutions? Well, no ... these are not perfect solutions against many modern malware and viruses using polymorphic code[^478]. But it does not mean they cannot help against less sophisticated and known attacks. It depends on how to use them as AV software can become an attack vector in itself.
...
Some will just argue against them broadly like Whonix[^479] but this topic is being discussed and disputed even at Whonix[^480] by other members of their community.
...
-   Yes, there are viruses and malware for Linux[^481]'[^482]'[^483]'[^484]'[^485]

-   Yes, there are viruses and malware for macOS[^496]'[^486][^487]'[^488][^489]
...
-   Do use Open-Source non-real-time offline Anti-Virus/Anti-Malware tools as an added measure to scan some files such as:
    ...
    -   Windows/Linux/macOS/Qubes OS: ClamAV (<https://www.clamav.net/> <sup>[[Archive.org]][660]</sup>)

    -   Linux/Qubes OS: RFXN Linux Malware Detect (<https://github.com/rfxn/linux-malware-detect> <sup>[[Archive.org]][661]</sup>)

    -   Linux/Qubes OS: Chkrootkit (<http://www.chkrootkit.org/> <sup>[[Archive.org]][662]</sup>)
...
-   You could also use online services for **non-sensitive files*** such as VirusTotal (<https://www.virustotal.com/gui/>) or Hybrid-analysis (<https://hybrid-analysis.com/>).
    ...
    -   You could also just check the VirusTotal database for the hash of your file if you don't want to send it over (see <https://developers.virustotal.com/v3.0/docs/search-by-hash> <sup>[[Archive.org]][663]</sup> (See the [Integrity (if available):] section again for guidance on how to generate hashes).

    -   Other tools are also available for non-sensitive files and a convenient list is right here: <https://github.com/rshipp/awesome-malware-analysis#online-scanners-and-sandboxes> <sup>[[Archive.org]][664]</sup>

* **Please be aware that while VirusTotal might seem very practical for scanning various files, their "privacy policy" is problematic (see <https://support.virustotal.com/hc/en-us/articles/115002168385-Privacy-Policy>** <sup>[[Archive.org]][665]</sup>**) and states:**
...
Again, regarding the PDFs of this guide and as explained in the README of my repository, you could check for anomalies using PDFID which you can download at <https://blog.didierstevens.com/programs/pdf-tools/> <sup>[[Archive.org]][666]</sup>:
...
-   **Qubes OS:** Consider using <https://github.com/QubesOS/qubes-app-linux-pdf-converter> <sup>[[Archive.org]][667]</sup> which will convert your PDF into a flattened image file. This should theoretically remove any malicious code in it. Note that this will also render the PDF formatting useless (such as links, headings, bookmarks, and references).

-   **(Deprecated) Linux/Qubes OS** (or possibly macOS through Homebrew or Windows through Cygwin): Consider not using <https://github.com/firstlookmedia/pdf-redact-tools> <sup>[[Archive.org]][668]</sup> which will also turn your PDF into a flattened image file. Again, this should theoretically remove any malicious code in it. Again, this will also render the PDF formatting useless (such as links, headings, bookmarks, and references). **Note that this tool is deprecated and relies on a library called "ImageMagick" which is known for several security issues**[^490]**. You should not use this tool even if it is recommended in some other guides.**

-   **Windows/Linux/Qubes/OS/macOS:** Consider using <https://github.com/firstlookmedia/dangerzone> <sup>[[Archive.org]][669]</sup> which was inspired by Qubes PDF Converted above and does the same but is well maintained and works on all OSes. This tool also works with Images, ODF files, and Office files (Warning: On Windows, this tool requires Docker-Desktop installed and this might (will) interfere with Virtualbox and other Virtualization software because it requires enabling Hyper-V. VirtualBox and Hyper-V do not play nice together[^491]. Consider installing this within a Linux VM for convenience instead of a Windows OS).

#### Other types of files:

Here are some various resources for this purpose where you will find what tool to use for what type:

-   **For Documents/Pictures:** Consider using <https://github.com/firstlookmedia/dangerzone> <sup>[[Archive.org]][669]</sup> which was inspired by Qubes PDF Converted above and does the same but is well maintained and works on all OSes. This tool also works with Images, ODF files, and Office files (Warning: On Windows, this tool requires Docker-Desktop installed and this might (will) interfere with Virtualbox and other Virtualization software because it requires enabling Hyper-V. VirtualBox and Hyper-V do not play nice together[^492]. Consider installing this within a Linux VM for convenience instead of a Windows OS).

-   **For Videos:** Be extremely careful, use an up-to-date player in a sandboxed environment. Remember <https://www.vice.com/en/article/v7gd9b/facebook-helped-fbi-hack-child-predator-buster-hernandez> <sup>[[Archive.org]][670]</sup>

-   This practical cheat sheet from SANS: <https://digital-forensics.sans.org/media/analyzing-malicious-document-files.pdf> <sup>[[Archive.org]][671]</sup> (warning, many of those tools might be harder to use on Windows and you might consider using them from a Linux OS such as Tails, Whonix Workstation, or a Linux distribution of your choice as explained later in this guide. There are also other guides out there[^493] that might be of use).

-   This GitHub repository with various resources on malware analysis: <https://github.com/rshipp/awesome-malware-analysis> <sup>[[Archive.org]][664]</sup>

-   This interesting PDF detailing which tool to use for which file type <https://www.winitor.com/pdf/Malware-Analysis-Fundamentals-Files-Tools.pdf> <sup>[[Archive.org]][672]</sup>
...
There are plenty of methods you could use to bypass those restrictions locally. One of them would be to use portable apps[^494]. Those apps do not require installation on your system and can be run from a USB key or anywhere else.
...
Another useful resource to be considered for comparing browsers is: <https://privacytests.org/> <sup>[[Archive.org]][673]</sup>

## Brave:

**This is my recommended/preferred choice for a Browser within your guest VMs. This is not my recommended choice for a Browser within your Host OS where I strictly recommend Tor Browser as they recommend it themselves**[^495]**.**

Why Brave despite the controversies[^496]?
...
-   You will enjoy native ad-blocking where none is available in others by default without adding extensions[^497].

-   Performance is arguably better than Firefox[^498].

-   Brave is arguably better at fingerprinting resistance than others[^499].

-   Security of Chromium-based Browser is arguably better than Firefox[^500]'[^501]. Within the context of this guide, security should be privileged to prevent any vulnerability or exploit from gaining access to the VM.

-   Comparison of both by Mozilla: <https://www.mozilla.org/en-US/firefox/browsers/compare/brave/> <sup>[[Archive.org]][674]</sup>
...
-   Brave was found to be sending no identifiable telemetry compared to other browsers[^502].
...
-   Better Security than Firefox as it is Chromium-based[^503]'[^504].

-   Better Performance than Firefox.

-   The whole traffic will be router through Tor anyway.

-   Can benefit from additional security using Microsoft Defender Application Guard (MDAG)[^505]. Note that this feature cannot be enabled in a Virtualbox VM unfortunately.
...
-   In addition to being out of the Chromium world, it is also completely out of the Google world (despite the Mozilla Foundation being almost entirely funded by Google[^506]).
...
Security (especially sandboxing) of Firefox is arguably weaker than Chromium-based browsers[^507].
...
-   Download and install Brave browser from <https://brave.com/download/> <sup>[[Archive.org]][675]</sup>
...
1.  <https://wiki.archlinux.org/title/Firefox/Privacy> <sup>[[Archive.org]][676]</sup> **(most recommended)**

2.  <https://proprivacy.com/privacy-service/guides/firefox-privacy-security-guide> <sup>[[Archive.org]][677]</sup>
...
-   <https://chrisx.xyz/blog/yet-another-firefox-hardening-guide/> <sup>[[Archive.org]][678]</sup>

-   <https://ebin.city/~werwolf/posts/firefox-hardening-guide/> <sup>[[Archive.org]][679]</sup>

# Appendix W: Virtualization

So, you might ask yourself, what is Virtualization[^508]?
...
In those cases, it might be necessary to use Tor bridges to connect to the Tor network (see Tor Documentation <https://2019.www.torproject.org/docs/bridges> <sup>[[Archive.org]][240]</sup> and Whonix Documentation <https://www.whonix.org/wiki/Bridges> <sup>[[Archive.org]][338]</sup>).

Bridges are special Tor entry nodes that are not listed on the Tor public directory. Some of those are running on people running the Snowflake Browser extension[^509] while others are running on various servers around the world. Most of those bridges are running some type of obfuscation method called obfs4[^510].

Here is the definition from the Tor Browser Manual[^511]: "obfs4 makes Tor traffic look random and prevents censors from finding bridges by Internet scanning. obfs4 bridges are less likely to be blocked than its predecessor, obfs3 bridges".
...
As per their definition from their manual[^512]: "meek transports make it look like you are browsing a major web site instead of using Tor. meek-azure makes it look like you are using a Microsoft web site". This is a type of "domain fronting" [^513].

Lastly, there are also bridges called Snowflake bridges that rely on users running the snowflake extension in their browser to become themselves entry nodes. See <https://snowflake.torproject.org/> <sup>[[Archive.org]][559]</sup>.

First, you should proceed with the following checklist to make sure you cannot circumvent Tor Blocking (double-check) and try to use Tor Bridges (<https://bridges.torproject.org/> <sup>[[Archive.org]][580]</sup>):
...
Finally, you could also request a bridge request by e-mail to <bridges@torproject.org> with the subject empty and the body being: "get transport obfs4" or "get transport meek". There is some limitation with this method tho as it is only available from a Gmail e-mail address or a Riseup.net (<https://riseup.net/> <sup>[[Tor Mirror]][391]</sup>) e-mail address.
...
-   Download and install Tor Browser according to the instructions from <https://www.torproject.org/download/> <sup>[[Archive.org]][682]</sup>
...
-   At this point, still before connecting, you should click the little shield Icon (upper right, next to the Address bar) and select your Security level (see <https://tb-manual.torproject.org/security-settings/> <sup>[[Archive.org]][236]</sup> for details). Basically, there are three.
...
Let's keep in mind that even 3 letters agencies recommend blocking ads for their internal users in order to improve security[^515].
...
The origin of those BTC cannot be traced back to your real identity due to the use of Moner**o (unless Monero is broken). Please do read [Appendix B2: Monero Disclaimer].**

## Extra-Paranoid anonymous option:

**As explained in the disclaimer, If you feel extra paranoid,** you could consider using an additional conversion step using a different privacy/anonymity-focused cryptocurrency such as Zcash (<https://z.cash/> <sup>[[Archive.org]][686]</sup>).
...
2.  **Buying Zcash first option:**
    ...
    a.  Buy Zcash (see <https://z.cash/exchanges/> <sup>[[Archive.org]][687]</sup>)
...
You might want to consider the use of Wasabi (<https://wasabiwallet.io/> <sup>[[Archive.org]][688]</sup>) for your BTC transactions using their "CoinJoin feature"[^516] to further cover your tracks. This would mean swapping your Monero for BTC to a Wasabi Wallet instead of a normal Wallet. And then using that Wasabi Wallet for your BTC transactions using their CoinJoin feature.
...
-   Tor Project: <https://community.torproject.org/relay/community-resources/good-bad-isps/> <sup>[[Archive.org]][689]</sup>

-   PrivacyGuides.org: <https://privacyguides.org/providers/hosting/> <sup>[[Archive.org]][690]</sup>

Lastly, you could pick one (at your own risk) from the list here that does accept Monero: <https://www.getmonero.org/community/merchants/#hosting> <sup>[[Archive.org]][618]</sup>
...
My opinion (and the one of many[^517]'[^518]'[^519]'[^520]'[^521]'[^522]) is that passphrases are generally better than passwords. So instead of thinking of better passwords, forget them altogether and use passphrases instead (when possible). Or just use a password manager with very long passwords (such as KeePassXC, the preferred password manager in this guide).

The well-known shown-below XKCD <https://xkcd.com/936/> <sup>[[Archive.org]][691]</sup> is still valid despite some people disputing it (See <https://www.explainxkcd.com/wiki/index.php/936:_Password_Strength> <sup>[[Archive.org]][692]</sup>). Yes, it is quite old now and is a little bit outdated and might be misinterpreted. But generally, it is still valid and a good argument for using passphrases instead of passwords.

![][693]

(Illustration by Randall Munroe, xkcd.com, licensed under CC BY-NC 2.5)

Here are some recommendations (based on Wikipedia[^523]):
...
Watch this insightful video by Computerphile: <https://www.youtube.com/watch?v=3NjQ9b3pgIg> <sup>[[Invidious]][694]</sup>
...
I will not go into too many details. Just pick one from PrivacyGuides.org (<https://privacyguides.org/providers/search-engines> <sup>[[Archive.org]][695]</sup>).
...
-   The OxyMonster case (<https://arstechnica.com/tech-policy/2018/06/dark-web-vendor-oxymonster-turns-out-to-be-a-frenchman-with-luscious-beard/> <sup>[[Archive.org]][696]</sup>):
...
-   <https://www.whonix.org/wiki/Surfing_Posting_Blogging#Stylometry> <sup>[[Archive.org]][697]</sup>: Whonix documentation about stylometry.

-   <https://wikipedia.org/wiki/Forensic_linguistics> <sup>[[Wikiless]][698]</sup> <sup>[[Archive.org]][699]</sup>: Gives a brief rundown of the basics of forensic linguistics, not too informative.

-   <https://wikipedia.org/wiki/Writeprint> <sup>[[Wikiless]][700]</sup> <sup>[[Archive.org]][701]</sup>: Gives a brief and informative rundown of forensic linguistics applied to internet investigations.

-   <https://wikipedia.org/wiki/Stylometry> <sup>[[Wikiless]][702]</sup> <sup>[[Archive.org]][703]</sup>: Gives a brief overview of Stylometry.

-   <https://wikipedia.org/wiki/Content_similarity_detection> <sup>[[Wikiless]][704]</sup> <sup>[[Archive.org]][705]</sup>: I would recommend reading this, quite informative.

-   <https://wikipedia.org/wiki/Author_profiling> <sup>[[Wikiless]][706]</sup> <sup>[[Archive.org]][707]</sup>: Read through this as well if you are interested in this topic.

-   <https://wikipedia.org/wiki/Native-language_identification> <sup>[[Wikiless]][708]</sup> <sup>[[Archive.org]][709]</sup>: This is less important if you use a translator, but if you do not use a translator to communicate on forums that are not in your native language, consider giving this a quick read through.

-   <https://wikipedia.org/wiki/Computational_linguistics> <sup>[[Wikiless]][710]</sup> <sup>[[Archive.org]][711]</sup>: Only read through this if this topic is interesting to you.

-   <https://regmedia.co.uk/2017/09/27/gal_vallerius.pdf> <sup>[[Archive.org]][712]</sup>: Explains how authorities used forensic linguistics to help arrest OxyMonster (pages 13 -- 14).

-   <https://wikipedia.org/wiki/Ted_Kaczynski#After_publication> <sup>[[Wikiless]][713]</sup> <sup>[[Archive.org]][714]</sup>: May have an IQ of 167, but he was caught primarily based on forensic linguistics.

-   <https://i.blackhat.com/USA-19/Wednesday/us-19-Wixey-Im-Unique-Just-Like-You-Human-Side-Channels-And-Their-Implications-For-Security-And-Privacy.pdf> <sup>[[Archive.org]][715]</sup>: Explains how your writing style can be used to track you, I highly recommend reading through these slides, or watching the accompanying presentation on YouTube.

-   <https://media.defcon.org/DEF%20CON%2026/DEF%20CON%2026%20presentations/DEFCON-26-Matt-Wixey-Betrayed-by-the-Keyboard-Updated.pdf> <sup>[[Archive.org]][716]</sup>: Explains how your writing style can be used to track you, I highly recommend reading through these slides, or watching the accompanying presentation on YouTube, this is quite similar to the last presentation.

-   <https://i.blackhat.com/us-18/Wed-August-8/us-18-Wixey-Every-ROSE-Has-Its-Thorn-The-Dark-Art-Of-Remote-Online-Social-Engineering.pdf> <sup>[[Archive.org]][717]</sup>: This goes over how to potentially spot deception through the internet, and presents a checklist to see how trustworthy someone is. I would advise reading the slides or watching the presentation on YouTube.
...
-   For Reddit, use a LibReddit instance (<https://github.com/spikecodes/libreddit> <sup>[[Archive.org]][718]</sup>)

-   For Maps, consider using <https://www.openstreetmap.org>

-   For Translation, consider using a SimplyTranslate (<https://git.sr.ht/~metalune/simplytranslate_web> <sup>[[Archive.org]][719]</sup>) at <https://translate.metalune.xyz/>
...
**(Optional)** Consider the use of the <https://github.com/SimonBrazell/privacy-redirect> <sup>[[Archive.org]][32]</sup> extension to automate the use of the above services.
...
-   Archive.today over Tor: <http://archiveiya74codqgiixo33q62qlrqtkgmcitqx5u2oeqnmn5bpcbiyd.onion/anonymousplanet.org/guide.html>

Offline versions (best format for the best readability) of this guide at:

-   Light Theme PDF: <https://anonymousplanet.org/guide.pdf> <sup>[[Mirror]][720]</sup> <sup>[[Archive.org]][721]</sup> <sup>[[Tor Mirror]][722]</sup>

-   Dark Theme PDF: <https://anonymousplanet.org/guide-dark.pdf> <sup>[[Mirror]][723]</sup> <sup>[[Archive.org]][724]</sup> <sup>[[Tor Mirror]][725]</sup>

-   OpenDocument Text (ODT) version at: <https://anonymousplanet.org/guide.odt> <sup>[[Mirror]][726]</sup> <sup>[[Archive.org]][727]</sup> <sup>[[Tor Mirror]][728]</sup>
...
If you want to compare the older version of the ODT format with a newer version, use the LibreWriter compare features as explained here: <https://help.libreoffice.org/7.1/en-US/text/shared/guide/redlining_doccompare.html> <sup>[[Archive.org]][729]</sup>
...
-   Go to your download directory and run the following command (with the updated downloaded version if needed): ```sudo apt install ./Zecwallet_Lite_1.7.5_amd64.deb```
...
-   Have a look at this part of the Whonix documentation: <https://www.whonix.org/wiki/Surfing_Posting_Blogging#Anonymous_File_Sharing> <sup>[[Archive.org]][730]</sup>
...
The anonymity of Monero depends on its crypto algorithms. If you do use Monero from a KYC Exchange. You can be almost certain that you are safe today. But you might not be in the long-term future if Monero algorithms are ever broken[^524] (think Quantum Computing). Do keep in mind that KYC regulations might force operators (such as Crypto Exchanges) to keep your financial records for up to 10 years and that you, therefore, need Monero algorithms to not be broken for the next 10 years as well.

You may want to watch this insightful video for more details: [**https://www.youtube.com/watch?v=j02QoI4ZlnU**][] <sup>[[Invidious]][731]</sup>

Also please consider reading: **<https://github.com/monero-project/monero/blob/master/docs/ANONYMITY_NETWORKS.md#privacy-limitations>** <sup>[[Archive.org]][732]</sup>
...
-   (My personal favorite) LINDDUN <https://www.linddun.org/> <sup>[[Archive.org]][733]</sup>

-   STRIDE <https://en.wikipedia.org/wiki/STRIDE_%28security%29> <sup>[[Wikiless]][734]</sup> <sup>[[Archive.org]][735]</sup>

-   PASTA <https://versprite.com/tag/pasta-threat-modeling/> <sup>[[Archive.org]][736]</sup>

And there are quite a few others too, see:

-   <https://insights.sei.cmu.edu/blog/threat-modeling-12-available-methods/> <sup>[[Archive.org]][737]</sup>

-   <https://www.geeksforgeeks.org/threat-modelling/> <sup>[[Archive.org]][738]</sup>

You can find some introduction on these on these projects:

-   Threat Modeling Manifesto: <https://www.threatmodelingmanifesto.org/> <sup>[[Archive.org]][739]</sup>

-   OWASP: <https://cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html> <sup>[[Archive.org]][740]</sup>
...
[^1]: English translation of German Telemedia Act <https://www.huntonprivacyblog.com/wp-content/uploads/sites/28/2016/02/Telemedia_Act__TMA_.pdf> <sup>[[Archive.org]][741]</sup>. Section 13, Article 6, "The service provider must enable the use of Telemedia and payment for them to occur anonymously or via a pseudonym where this is technically possible and reasonable. The recipient of the service is to be informed about this possibility. ".

[^2]: Wikipedia, Real-Name System Germany <https://en.wikipedia.org/wiki/Real-name_system#Germany> <sup>[[Wikiless]][413]</sup> <sup>[[Archive.org]][414]</sup>

[^3]: Wikipedia, Don't be evil <https://en.wikipedia.org/wiki/Don%27t_be_evil> <sup>[[Wikiless]][742]</sup> <sup>[[Archive.org]][743]</sup>

[^4]: YouTube, <https://www.youtube.com/watch?v=6DGNZnfKYnU> <sup>[[Invidious]][744]</sup>

[^5]: Wikipedia, OSINT <https://en.wikipedia.org/wiki/Open-source_intelligence> <sup>[[Wikiless]][745]</sup> <sup>[[Archive.org]][746]</sup>

[^6]: YouTube Internet Historian Playlist, HWNDU <https://www.youtube.com/playlist?list=PLna1KTNJu3y09Tu70U6yPn28sekaNhOMY> <sup>[[Invidious]][747]</sup>

[^7]: Wikipedia, 4chan <https://en.wikipedia.org/wiki/4chan> <sup>[[Wikiless]][748]</sup> <sup>[[Archive.org]][749]</sup>

[^8]: PIA, See this good article on the matter <https://www.privateinternetaccess.com/blog/how-does-privacy-differ-from-anonymity-and-why-are-both-important/> <sup>[[Archive.org]][750]</sup> (disclaimer: this is not an endorsement or recommendation for this commercial service).
...
[^10]: This World of Ours, James Mickens <https://scholar.harvard.edu/files/mickens/files/thisworldofours.pdf> <sup>[[Archive.org]][751]</sup>

[^11]: XKCD, Security <https://xkcd.com/538/> <sup>[[Archive.org]][752]</sup>

[^12]: Wikipedia, Threat Model <https://en.wikipedia.org/wiki/Threat_model> <sup>[[Wikiless]][753]</sup> <sup>[[Archive.org]][754]</sup>

[^13]: Bellingcat <https://www.bellingcat.com/> <sup>[[Archive.org]][755]</sup>

[^14]: Wikipedia, Doxing <https://en.wikipedia.org/wiki/Doxing> <sup>[[Wikiless]][756]</sup> <sup>[[Archive.org]][757]</sup>

[^15]: YouTube, Internet Historian, The Bikelock Fugitive of Berkeley <https://www.youtube.com/watch?v=muoR8Td44UE> <sup>[[Invidious]][758]</sup>

[^16]: BBC News, Tor Mirror <https://www.bbc.com/news/technology-50150981> <sup>[[Archive.org]][759]</sup>

[^17]: GitHub, Real World Onion websites <https://github.com/alecmuffett/real-world-onion-sites> <sup>[[Archive.org]][760]</sup>

[^18]: Tor Project, Who Uses Tor <https://2019.www.torproject.org/about/torusers.html.en> <sup>[[Archive.org]][761]</sup>

[^19]: Whonix Documentation, The importance of Anonymity <https://www.whonix.org/wiki/Anonymity> <sup>[[Archive.org]][762]</sup>

[^20]: Geek Feminism, <https://geekfeminism.wikia.org/wiki/Who_is_harmed_by_a_%22Real_Names%22_policy%3F> <sup>[[Archive.org]][763]</sup>

[^21]: Tor Project, Tor Users <https://2019.www.torproject.org/about/torusers.html.en> <sup>[[Archive.org]][761]</sup>

[^22]: PrivacyHub, Internet Privacy in the Age of Surveillance <https://www.cyberghostvpn.com/privacyhub/internet-privacy-surveillance/> <sup>[[Archive.org]][764]</sup>

[^23]: PIA Blog, 50 Key Stats About Freedom of the Internet Around the World <https://www.privateinternetaccess.com/blog/internet-freedom-around-the-world-in-50-stats/> <sup>[[Archive.org]][765]</sup>

[^24]: Wikipedia, IANAL <https://en.wikipedia.org/wiki/IANAL> <sup>[[Wikiless]][766]</sup> <sup>[[Archive.org]][767]</sup>

[^25]: Wikipedia, Trust but verify <https://en.wikipedia.org/wiki/Trust,_but_verify> <sup>[[Wikiless]][768]</sup> <sup>[[Archive.org]][769]</sup>

[^26]: Wikipedia, IP Address, <https://en.wikipedia.org/wiki/IP_address> <sup>[[Wikiless]][770]</sup> <sup>[[Archive.org]][771]</sup>

[^27]: Wikipedia; Data Retention <https://en.wikipedia.org/wiki/Data_retention> <sup>[[Wikiless]][772]</sup> <sup>[[Archive.org]][773]</sup>

[^28]: Wikipedia, Tor Anonymity Network <https://en.wikipedia.org/wiki/Tor_(anonymity_network)> <sup>[[Wikiless]][774]</sup> <sup>[[Archive.org]][775]</sup>

[^29]: Wikipedia, VPN <https://en.wikipedia.org/wiki/Virtual_private_network> <sup>[[Wikiless]][776]</sup> <sup>[[Archive.org]][777]</sup>

[^30]: Ieee.org, Anonymity Trilemma: Strong Anonymity, Low Bandwidth Overhead, Low Latency - Choose Two <https://ieeexplore.ieee.org/document/8418599> <sup>[[Archive.org]][778]</sup>

[^31]: Wikipedia, DNS <https://en.wikipedia.org/wiki/Domain_Name_System> <sup>[[Wikiless]][779]</sup> <sup>[[Archive.org]][780]</sup>

[^32]: Wikipedia, DNS Blocking <https://en.wikipedia.org/wiki/DNS_blocking> <sup>[[Wikiless]][781]</sup> <sup>[[Archive.org]][782]</sup>

[^33]: CensoredPlanet <https://censoredplanet.org/> <sup>[[Archive.org]][783]</sup>

[^34]: ArXiv, Characterizing Smart Home IoT Traffic in the Wild <https://arxiv.org/pdf/2001.08288.pdf> <sup>[[Archive.org]][784]</sup>

[^35]: Labzilla.io, Your Smart TV is probably ignoring your Pi-Hole <https://labzilla.io/blog/force-dns-pihole> <sup>[[Archive.org]][785]</sup>

[^36]: Wikipedia, DNS over HTTPS: <https://en.wikipedia.org/wiki/DNS_over_HTTPS> <sup>[[Wikiless]][786]</sup> <sup>[[Archive.org]][787]</sup>

[^37]: Wikipedia, DNS over TLS, <https://en.wikipedia.org/wiki/DNS_over_TLS> <sup>[[Wikiless]][788]</sup> <sup>[[Archive.org]][789]</sup>

[^38]: Wikipedia, Pi-Hole <https://en.wikipedia.org/wiki/Pi-hole> <sup>[[Wikiless]][790]</sup> <sup>[[Archive.org]][791]</sup>

[^39]: Wikipedia, SNI <https://en.wikipedia.org/wiki/Server_Name_Indication> <sup>[[Wikiless]][792]</sup> <sup>[[Archive.org]][793]</sup>

[^40]: Wikipedia, ECH, <https://en.wikipedia.org/wiki/Server_Name_Indication#Encrypted_Client_Hello> <sup>[[Wikiless]][792]</sup> <sup>[[Archive.org]][793]</sup>

[^41]: Wikipedia, eSNI <https://en.wikipedia.org/wiki/Server_Name_Indication#Encrypted_Client_Hello> <sup>[[Wikiless]][792]</sup> <sup>[[Archive.org]][793]</sup>

[^42]: Usenix.org, On the Importance of Encrypted-SNI (ESNI) to Censorship Circumvention <https://www.usenix.org/system/files/foci19-paper_chai_0.pdf> <sup>[[Archive.org]][794]</sup>

[^43]: Wikipedia, CDN <https://en.wikipedia.org/wiki/Content_delivery_network> <sup>[[Wikiless]][795]</sup> <sup>[[Archive.org]][796]</sup>

[^44]: Cloudflare, Good-bye ESNI, hello ECH! <https://blog.cloudflare.com/encrypted-client-hello/> <sup>[[Archive.org]][797]</sup>

[^45]: ZDNET, Russia wants to ban the use of secure protocols such as TLS 1.3, DoH, DoT, ESNI <https://www.zdnet.com/article/russia-wants-to-ban-the-use-of-secure-protocols-such-as-tls-1-3-doh-dot-esni/> <sup>[[Archive.org]][798]</sup>

[^46]: ZDNET, China is now blocking all encrypted HTTPS traffic that uses TLS 1.3 and ESNI <https://www.zdnet.com/article/china-is-now-blocking-all-encrypted-https-traffic-using-tls-1-3-and-esni/> <sup>[[Archive.org]][799]</sup>

[^47]: Wikipedia, OCSP <https://en.wikipedia.org/wiki/Online_Certificate_Status_Protocol> <sup>[[Wikiless]][800]</sup> <sup>[[Archive.org]][801]</sup>

[^48]: Madaidans Insecurities, Why encrypted DNS is ineffective <https://madaidans-insecurities.github.io/encrypted-dns.html> <sup>[[Archive.org]][802]</sup>

[^49]: Wikipedia, OCSP Stapling <https://en.wikipedia.org/wiki/OCSP_stapling> <sup>[[Wikiless]][803]</sup> <sup>[[Archive.org]][804]</sup>

[^50]: Chromium Documentation, CRLSets <https://dev.chromium.org/Home/chromium-security/crlsets> <sup>[[Archive.org]][805]</sup>

[^51]: ZDNet, Chrome does certificate revocation better <https://www.zdnet.com/article/chrome-does-certificate-revocation-better/> <sup>[[Archive.org]][806]</sup>

[^52]: KUL, Encrypted DNS=⇒Privacy? A Traffic Analysis Perspective <https://www.esat.kuleuven.be/cosic/publications/article-3153.pdf> <sup>[[Archive.org]][807]</sup>

[^53]: ResearhGate, Oblivious DNS: Practical Privacy for DNS Queries <https://www.researchgate.net/publication/332893422_Oblivious_DNS_Practical_Privacy_for_DNS_Queries> <sup>[[Archive.org]][808]</sup>

[^54]: Nymity.ch, The Effect of DNS on Tor's Anonymity <https://nymity.ch/tor-dns/> <sup>[[Archive.org]][809]</sup>

[^55]: Wikipedia, RFID <https://en.wikipedia.org/wiki/Radio-frequency_identification> <sup>[[Wikiless]][56]</sup> <sup>[[Archive.org]][57]</sup>

[^56]: Wikipedia, NFC <https://en.wikipedia.org/wiki/Near-field_communication> <sup>[[Wikiless]][810]</sup> <sup>[[Archive.org]][811]</sup>

[^57]: Samsonite Online Shop, RFID accessories, <https://shop.samsonite.com/accessories/rfid-accessories/> <sup>[[Archive.org]][812]</sup>

[^58]: Google Android Help, Android Location Services <https://support.google.com/accounts/answer/3467281?hl=en> <sup>[[Archive.org]][813]</sup>

[^59]: Apple Support, Location Services and Privacy <https://support.apple.com/en-us/HT207056> <sup>[[Archive.org]][814]</sup>

[^60]: State University of New York, Towards 3D Human Pose Construction Using Wi-Fi <https://cse.buffalo.edu/~lusu/papers/MobiCom2020.pdf> <sup>[[Archive.org]][815]</sup>

[^61]: Digi.Ninja, Jasager <https://digi.ninja/jasager/> <sup>[[Archive.org]][816]</sup>

[^62]: Hak5 Shop, Wi-Fi Pineapple <https://shop.hak5.org/products/wifi-pineapple> <sup>[[Archive.org]][817]</sup>

[^63]: Wikipedia, Deautentication Attack <https://en.wikipedia.org/wiki/Wi-Fi_deauthentication_attack> <sup>[[Wikiless]][818]</sup> <sup>[[Archive.org]][819]</sup>

[^64]: Wikipedia, Capture Portal <https://en.wikipedia.org/wiki/Captive_portal> <sup>[[Wikiless]][820]</sup> <sup>[[Archive.org]][821]</sup>

[^65]: HackerFactor Blog, Deanonymizing Tor Circuits <https://www.hackerfactor.com/blog/index.php?/archives/868-Deanonymizing-Tor-Circuits.html> <sup>[[Archive.org]][822]</sup>

[^66]: KU Leuven, Website Fingerprinting through Deep Learning <https://distrinet.cs.kuleuven.be/software/tor-wf-dl/> <sup>[[Archive.org]][823]</sup>

[^67]: KU Leuven, Deep Fingerprinting: Undermining Website Fingerprinting Defenses with Deep Learning <https://homes.esat.kuleuven.be/~mjuarezm/index_files/pdf/ccs18.pdf> <sup>[[Archive.org]][824]</sup>

[^68]: Internet Society, Website Fingerprinting at Internet Scale <https://www.internetsociety.org/sites/default/files/blogs-media/website-fingerprinting-internet-scale.pdf> <sup>[[Archive.org]][825]</sup>

[^69]: KU Leuven, A Critical Evaluation of Website Fingerprinting Attacks <https://www.esat.kuleuven.be/cosic/publications/article-2456.pdf> <sup>[[Archive.org]][826]</sup>

[^70]: DailyDot, How Tor helped catch the Harvard bomb threat suspect <https://www.dailydot.com/unclick/tor-harvard-bomb-suspect/> <sup>[[Archive.org]][827]</sup>

[^71]: ArsTechnica, How the NSA can break trillions of encrypted Web and VPN connections <https://arstechnica.com/information-technology/2015/10/how-the-nsa-can-break-trillions-of-encrypted-web-and-vpn-connections/> <sup>[[Archive.org]][828]</sup>

[^72]: ArsTechnica, Does Tor provide more benefit or harm? New paper says it depends <https://arstechnica.com/gadgets/2020/11/does-tor-provide-more-benefit-or-harm-new-paper-says-it-depends/> <sup>[[Archive.org]][829]</sup>

[^73]: ResearchGate, The potential harms of the Tor anonymity network cluster disproportionately in free countries <https://www.pnas.org/content/early/2020/11/24/2011893117> <sup>[[Archive.org]][830]</sup>

[^74]: CryptoEngineering, How does Apple (privately) find your offline devices? <https://blog.cryptographyengineering.com/2019/06/05/how-does-apple-privately-find-your-offline-devices/> <sup>[[Archive.org]][831]</sup>

[^75]: Apple Support <https://support.apple.com/en-us/HT210515> <sup>[[Archive.org]][832]</sup>

[^76]: XDA, Samsung's Find My Mobile app can locate Galaxy devices even when they're offline <https://www.xda-developers.com/samsung-find-my-mobile-app-locate-galaxy-devices-offline/> <sup>[[Archive.org]][833]</sup>

[^77]: Apple Support, If your Mac is lost or stolen <https://support.apple.com/en-us/HT204756> <sup>[[Archive.org]][834]</sup>

[^78]: Wikipedia, BLE <https://en.wikipedia.org/wiki/Bluetooth_Low_Energy> <sup>[[Wikiless]][835]</sup> <sup>[[Archive.org]][836]</sup>

[^79]: Cryptography Engineering Blog, How does Apple (privately) find your offline devices? <https://blog.cryptographyengineering.com/2019/06/05/how-does-apple-privately-find-your-offline-devices/> <sup>[[Archive.org]][831]</sup>

[^80]: Wikipedia, IMEI <https://en.wikipedia.org/wiki/International_Mobile_Equipment_Identity> <sup>[[Wikiless]][837]</sup> <sup>[[Archive.org]][838]</sup>

[^81]: Wikipedia, IMSI <https://en.wikipedia.org/wiki/International_mobile_subscriber_identity> <sup>[[Wikiless]][839]</sup> <sup>[[Archive.org]][840]</sup>

[^82]: Android Documentation, Device Identifiers <https://source.android.com/devices/tech/config/device-identifiers> <sup>[[Archive.org]][841]</sup>

[^83]: Google Privacy Policy, Look for IMEI <https://policies.google.com/privacy/embedded?hl=en-US> <sup>[[Archive.org]][842]</sup>

[^84]: Wikipedia, IMEI and the Law <https://en.wikipedia.org/wiki/International_Mobile_Equipment_Identity#IMEI_and_the_law> <sup>[[Wikiless]][837]</sup> <sup>[[Archive.org]][838]</sup>

[^85]: Bellingcat, The GRU Globetrotters: Mission London <https://www.bellingcat.com/news/uk-and-europe/2019/06/28/the-gru-globetrotters-mission-london/> <sup>[[Archive.org]][843]</sup>

[^86]: Bellingcat,"V" For "Vympel": FSB's Secretive Department "V" Behind Assassination Of Georgian Asylum Seeker In Germany <https://www.bellingcat.com/news/uk-and-europe/2020/02/17/v-like-vympel-fsbs-secretive-department-v-behind-assassination-of-zelimkhan-khangoshvili/> <sup>[[Archive.org]][844]</sup>

[^87]: Wikipedia, CCTV <https://en.wikipedia.org/wiki/Closed-circuit_television> <sup>[[Wikiless]][845]</sup> <sup>[[Archive.org]][846]</sup>

[^88]: Apple, Transparency Report, Device Requests <https://www.apple.com/legal/transparency/device-requests.html> <sup>[[Archive.org]][847]</sup>

[^89]: The Intercept, How Cops Can Secretly Track Your Phone <https://theintercept.com/2020/07/31/protests-surveillance-stingrays-dirtboxes-phone-tracking/> <sup>[[Tor Mirror]][848]</sup> <sup>[[Archive.org]][849]</sup>

[^90]: Wikipedia, IMSI Catcher <https://en.wikipedia.org/wiki/IMSI-catcher> <sup>[[Wikiless]][850]</sup> <sup>[[Archive.org]][851]</sup>

[^91]: Wikipedia, Stingray <https://en.wikipedia.org/wiki/Stingray_phone_tracker> <sup>[[Wikiless]][852]</sup> <sup>[[Archive.org]][853]</sup>

[^92]: Gizmodo, Cops Turn to Canadian Phone-Tracking Firm After Infamous 'Stingrays' Become 'Obsolete' <https://gizmodo.com/american-cops-turns-to-canadian-phone-tracking-firm-aft-1845442778> <sup>[[Archive.org]][854]</sup>

[^93]: Wikipedia, MITM <https://en.wikipedia.org/wiki/Man-in-the-middle_attack> <sup>[[Wikiless]][855]</sup> <sup>[[Archive.org]][856]</sup>

[^94]: Purism, Librem 5 <https://shop.puri.sm/shop/librem-5/> <sup>[[Archive.org]][857]</sup>

[^95]: Wikipedia, MAC Address <https://en.wikipedia.org/wiki/MAC_address> <sup>[[Wikiless]][858]</sup> <sup>[[Archive.org]][859]</sup>

[^96]: Acyclica Road Trend Product Sheet, <https://amsignalinc.com/data-sheets/Acyclica/Acyclica-RoadTrend-Product-Sheet.pdf> <sup>[[Archive.org]][860]</sup>

[^97]: ResearchGate, Tracking Anonymized Bluetooth Devices <https://www.researchgate.net/publication/334590931_Tracking_Anonymized_Bluetooth_Devices/fulltext/5d3308db92851cd04675a469/Tracking-Anonymized-Bluetooth-Devices.pdf> <sup>[[Archive.org]][861]</sup>

[^98]: Wikipedia, CPU <https://en.wikipedia.org/wiki/Central_processing_unit> <sup>[[Wikiless]][862]</sup> <sup>[[Archive.org]][863]</sup>

[^99]: Wikipedia, Intel Management Engine <https://en.wikipedia.org/wiki/Intel_Management_Engine> <sup>[[Wikiless]][864]</sup> <sup>[[Archive.org]][865]</sup>

[^100]: Wikipedia, AMD Platform Security Processor <https://en.wikipedia.org/wiki/AMD_Platform_Security_Processor> <sup>[[Wikiless]][866]</sup> <sup>[[Archive.org]][867]</sup>

[^101]: Wikipedia, IME, Security Vulnerabilities <https://en.wikipedia.org/wiki/Intel_Management_Engine#Security_vulnerabilities> <sup>[[Wikiless]][864]</sup> <sup>[[Archive.org]][865]</sup>

[^102]: Wikipedia, IME, Assertions that ME is a backdoor <https://en.wikipedia.org/wiki/Intel_Management_Engine#Assertions_that_ME_is_a_backdoor> <sup>[[Wikiless]][864]</sup> <sup>[[Archive.org]][865]</sup>

[^103]: Wikipedia, IME, Disabling the ME <https://en.wikipedia.org/wiki/Intel_Management_Engine#Disabling_the_ME> <sup>[[Wikiless]][864]</sup> <sup>[[Archive.org]][865]</sup>

[^104]: Libreboot, <https://libreboot.org/> <sup>[[Archive.org]][868]</sup>

[^105]: Apple, Differential Privacy White Paper <https://www.apple.com/privacy/docs/Differential_Privacy_Overview.pdf> <sup>[[Archive.org]][869]</sup>

[^106]: Wikipedia, Differential Privacy <https://en.wikipedia.org/wiki/Differential_privacy> <sup>[[Wikiless]][870]</sup> <sup>[[Archive.org]][871]</sup>

[^107]: Continuing Ed, The All-Seeing "i": Apple Just Declared War on Your Privacy <https://edwardsnowden.substack.com/p/all-seeing-i> <sup>[[Archive.org]][872]</sup>

[^108]: Trinity College Dublin, Mobile Handset Privacy: Measuring The Data iOS and Android Send to Apple And Google <https://www.scss.tcd.ie/doug.leith/apple_google.pdf> <sup>[[Archive.org]][81]</sup>

[^109]: Reuters, Exclusive: Apple dropped plan for encrypting backups after FBI complained -- sources <https://www.reuters.com/article/us-apple-fbi-icloud-exclusive-idUSKBN1ZK1CT> <sup>[[Archive.org]][873]</sup>

[^110]: ZDnet, I asked Apple for all my data. Here's what was sent back <https://www.zdnet.com/article/apple-data-collection-stored-request/> <sup>[[Archive.org]][874]</sup>

[^111]: De Correspondent, Here's how we found the names and addresses of soldiers and secret agents using a simple fitness app <https://decorrespondent.nl/8481/heres-how-we-found-the-names-and-addresses-of-soldiers-and-secret-agents-using-a-simple-fitness-app/412999257-6756ba27> <sup>[[Archive.org]][875]</sup>

[^112]: Website Planet, Report: Fitness Tracker Data Breach Exposed 61 Million Records and User Data Online <https://www.websiteplanet.com/blog/gethealth-leak-report/> <sup>[[Archive.org]][876]</sup>

[^113]: Wired, The Strava Heat Map and the End of Secrets <https://www.wired.com/story/strava-heat-map-military-bases-fitness-trackers-privacy/> <sup>[[Archive.org]][877]</sup>

[^114]: Bellingcat, How to Use and Interpret Data from Strava's Activity Map <https://www.bellingcat.com/resources/how-tos/2018/01/29/strava-interpretation-guide/> <sup>[[Archive.org]][878]</sup>

[^115]: The Guardian, Fitness tracking app Strava gives away location of secret US army bases <https://www.theguardian.com/world/2018/jan/28/fitness-tracking-app-gives-away-location-of-secret-us-army-bases> <sup>[[Archive.org]][879]</sup>

[^116]: Telegraph, Running app reveals locations of secret service agents in MI6 and GCHQ <https://www.telegraph.co.uk/technology/2018/07/08/running-app-exposes-mi6-gchq-workers-whereabouts/> <sup>[[Archive.org]][880]</sup>

[^117]: Washington Post, Alexa has been eavesdropping on you this whole time <https://www.washingtonpost.com/technology/2019/05/06/alexa-has-been-eavesdropping-you-this-whole-time/?itid=lk_interstitial_manual_59> <sup>[[Archive.org]][881]</sup>

[^118]: Washington Post, What does your car know about you? We hacked a Chevy to find out <https://www.washingtonpost.com/technology/2019/12/17/what-does-your-car-know-about-you-we-hacked-chevy-find-out/> <sup>[[Archive.org]][882]</sup>

[^119]: Using Metadata to find Paul Revere (<https://kieranhealy.org/blog/archives/2013/06/09/using-metadata-to-find-paul-revere/> <sup>[[Archive.org]][883]</sup>)

[^120]: Wikipedia, Google SensorVault, <https://en.wikipedia.org/wiki/Sensorvault> <sup>[[Wikiless]][884]</sup> <sup>[[Archive.org]][885]</sup>

[^121]: NRKBeta, My Phone Was Spying on Me, so I Tracked Down the Surveillants <https://nrkbeta.no/2020/12/03/my-phone-was-spying-on-me-so-i-tracked-down-the-surveillants/> <sup>[[Archive.org]][886]</sup>

[^122]: New York Times <https://www.nytimes.com/interactive/2019/12/19/opinion/location-tracking-cell-phone.html> <sup>[[Archive.org]][887]</sup>

[^123]: Sophos, Google data puts innocent man at the scene of a crime <https://nakedsecurity.sophos.com/2020/03/10/google-data-puts-innocent-man-at-the-scene-of-a-crime/> <sup>[[Archive.org]][888]</sup>

[^124]: Wikipedia, Geofence Warrant <https://en.wikipedia.org/wiki/Geo-fence_warrant> <sup>[[Wikiless]][889]</sup> <sup>[[Archive.org]][890]</sup>

[^125]: Vice.com, Military Unit That Conducts Drone Strikes Bought Location Data From Ordinary Apps <https://www.vice.com/en/article/y3g97x/location-data-apps-drone-strikes-iowa-national-guard> <sup>[[Archive.org]][891]</sup>

[^126]: TechCrunch, Google says geofence warrants make up one-quarter of all US demands <https://techcrunch.com/2021/08/19/google-geofence-warrants/> <sup>[[Archive.org]][892]</sup>

[^127]: TechDirt, Google Report Shows 'Reverse Warrants' Are Swiftly Becoming Law Enforcement's Go-To Investigative Tool <https://www.techdirt.com/articles/20210821/10494847401/google-report-shows-reverse-warrants-are-swiftly-becoming-law-enforcements-go-to-investigative-tool.shtml> <sup>[[Archive.org]][893]</sup>

[^128]: Wikipedia, Room 641A <https://en.wikipedia.org/wiki/Room_641A> <sup>[[Wikiless]][894]</sup> <sup>[[Archive.org]][895]</sup>

[^129]: Wikipedia, Edward Snowden <https://en.wikipedia.org/wiki/Edward_Snowden> <sup>[[Wikiless]][896]</sup> <sup>[[Archive.org]][897]</sup>

[^130]: Wikipedia, Permanent Record <https://en.wikipedia.org/wiki/Permanent_Record_(autobiography)> <sup>[[Wikiless]][563]</sup> <sup>[[Archive.org]][564]</sup>

[^131]: Wikipedia, XKEYSCORE <https://en.wikipedia.org/wiki/XKeyscore> <sup>[[Wikiless]][898]</sup> <sup>[[Archive.org]][899]</sup>

[^132]: ElectroSpaces, Danish military intelligence uses XKEYSCORE to tap cables in cooperation with the NSA <https://www.electrospaces.net/2020/10/danish-military-intelligence-uses.html> <sup>[[Archive.org]][900]</sup>

[^133]: Wikipedia, MUSCULAR <https://en.m.wikipedia.org/wiki/MUSCULAR_(surveillance_program)> <sup>[[Archive.org]][901]</sup>

[^134]: Wikipedia, SORM <https://en.wikipedia.org/wiki/SORM> <sup>[[Wikiless]][902]</sup> <sup>[[Archive.org]][903]</sup>

[^135]: Wikipedia, Tempora <https://en.wikipedia.org/wiki/Tempora> <sup>[[Wikiless]][904]</sup> <sup>[[Archive.org]][905]</sup>

[^136]: Wikipedia, PRISM <https://en.wikipedia.org/wiki/PRISM_(surveillance_program)> <sup>[[Wikiless]][906]</sup> <sup>[[Archive.org]][907]</sup>

[^137]: Justsecurity, General Hayden <https://www.justsecurity.org/10318/video-clip-director-nsa-cia-we-kill-people-based-metadata/> <sup>[[Archive.org]][908]</sup>

[^138]: IDMB, The Social Dilemma <https://www.imdb.com/title/tt11464826/> <sup>[[Archive.org]][909]</sup>

[^139]: ArsTechnica, How the way you type can shatter anonymity---even on Tor <https://arstechnica.com/information-technology/2015/07/how-the-way-you-type-can-shatter-anonymity-even-on-tor/> <sup>[[Archive.org]][910]</sup>

[^140]: Wikipedia, Stylometry <https://en.wikipedia.org/wiki/Stylometry> <sup>[[Wikiless]][702]</sup> <sup>[[Archive.org]][911]</sup>

[^141]: Paul Moore Blog, Behavioral Profiling: The password you can't change. <https://paul.reviews/behavioral-profiling-the-password-you-cant-change/> <sup>[[Archive.org]][912]</sup>

[^142]: Wikipedia, Sentiment Analysis, <https://en.wikipedia.org/wiki/Sentiment_analysis> <sup>[[Wikiless]][913]</sup> <sup>[[Archive.org]][914]</sup>

[^143]: EFF CoverYourTracks, <https://coveryourtracks.eff.org/> <sup>[[Archive.org]][915]</sup>

[^144]: Berkeley.edu, On the Feasibility of Internet-Scale Author Identification <https://people.eecs.berkeley.edu/~dawnsong/papers/2012%20On%20the%20Feasibility%20of%20Internet-Scale%20Author%20Identification.pdf> <sup>[[Archive.org]][916]</sup>

[^145]: Forbes, Exclusive: Government Secretly Orders Google To Identify Anyone Who Searched A Sexual Assault Victim's Name, Address And Telephone Number [https://www.forbes.com/sites/thomasbrewster/2021/10/04/google-keyword-warrants-give-us-government-data-on-search-users][] <sup>[[Archive.org]][917]</sup>

[^146]: SecuredTouch Blog, Behavioral Biometrics 101: Behavioral Biometrics vs. Behavioral Analytics <https://blog.securedtouch.com/behavioral-biometrics-101-an-in-depth-look-at-behavioral-biometrics-vs-behavioral-analytics> <sup>[[Archive.org]][918]</sup>

[^147]: ArsTechnica, Stakeout: how the FBI tracked and busted a Chicago Anon <https://arstechnica.com/tech-policy/2012/03/stakeout-how-the-fbi-tracked-and-busted-a-chicago-anon/> <sup>[[Archive.org]][919]</sup>

[^148]: Bellingcat MH17 - Russian GRU Commander 'Orion' Identified as Oleg Ivannikov <https://www.bellingcat.com/news/uk-and-europe/2018/05/25/mh17-russian-gru-commander-orion-identified-oleg-ivannikov/> <sup>[[Archive.org]][920]</sup>

[^149]: Facebook Research, Deepface <https://research.fb.com/publications/deepface-closing-the-gap-to-human-level-performance-in-face-verification/> <sup>[[Archive.org]][921]</sup>

[^150]: Privacy News Online, Putting the "face" in Facebook: how Mark Zuckerberg is building a world without public anonymity <https://www.privateinternetaccess.com/blog/putting-face-facebook-mark-zuckerberg-building-world-without-public-anonymity/> <sup>[[Archive.org]][922]</sup>

[^151]: CNBC, "Facebook has mapped populations in 23 countries as it explores satellites to expand internet" <https://www.cnbc.com/2017/09/01/facebook-has-mapped-human-population-building-internet-in-space.html> <sup>[[Archive.org]][923]</sup>

[^152]: MIT Technology Review, This is how we lost control of our faces, <https://www.technologyreview.com/2021/02/05/1017388/ai-deep-learning-facial-recognition-data-history/> <sup>[[Archive.org]][924]</sup>

[^153]: Bellingcat, Shadow of a Doubt: Crowdsourcing Time Verification of the MH17 Missile Launch Photo <https://www.bellingcat.com/resources/case-studies/2015/08/07/shadow-of-a-doubt/> <sup>[[Archive.org]][925]</sup>

[^154]: Brown Institute, Open-Source Investigation, <https://brown.columbia.edu/open-source-investigation/> <sup>[[Archive.org]][926]</sup>

[^155]: NewScientist, Facebook can recognize you in photos even if you're not looking <https://www.newscientist.com/article/dn27761-facebook-can-recognise-you-in-photos-even-if-youre-not-looking/> <sup>[[Archive.org]][927]</sup>

[^156]: Google Patent, Techniques for emotion detection and content delivery <https://patents.google.com/patent/US20150242679> <sup>[[Archive.org]][928]</sup>

[^157]: APNews, Chinese 'gait recognition' tech IDs people by how they walk <https://apnews.com/article/bf75dd1c26c947b7826d270a16e2658a> <sup>[[Archive.org]][929]</sup>

[^158]: The Sun, New CCTV technology could now identify you just by the WAY you walk and your body shape <https://www.thesun.co.uk/news/7684204/cctv-technology-identify-body-shape-way-walk/> <sup>[[Archive.org]][930]</sup>

[^159]: City Security Magazine, Gait recognition: a useful identification tool <https://citysecuritymagazine.com/security-management/gait-recognition-identification-tool/> <sup>[[Archive.org]][931]</sup>

[^160]: Vice.com, Tech Companies Are Training AI to Read Your Lips <https://www.vice.com/en/article/bvzvdw/tech-companies-are-training-ai-to-read-your-lips> <sup>[[Archive.org]][932]</sup>

[^161]: New Atlas, Eye tracking can reveal an unbelievable amount of information about you <https://newatlas.com/science/science/eye-tracking-privacy/> <sup>[[Archive.org]][933]</sup>

[^162]: TechCrunch, Facial recognition reveals political party in troubling new research <https://techcrunch.com/2021/01/13/facial-recognition-reveals-political-party-in-troubling-new-research/> <sup>[[Archive.org]][934]</sup>

[^163]: Nature.com, Facial recognition technology can expose political orientation from naturalistic facial images <https://www.nature.com/articles/s41598-020-79310-1> <sup>[[Archive.org]][111]</sup>

[^164]: Slate <https://slate.com/technology/2018/04/facebook-collects-data-on-non-facebook-users-if-they-want-to-delete-it-they-have-to-sign-up.html> <sup>[[Archive.org]][935]</sup>

[^165]: The Conversation <https://theconversation.com/shadow-profiles-facebook-knows-about-you-even-if-youre-not-on-facebook-94804> <sup>[[Archive.org]][936]</sup>

[^166]: The Verge <https://www.theverge.com/2018/4/11/17225482/facebook-shadow-profiles-zuckerberg-congress-data-privacy> <sup>[[Archive.org]][937]</sup>

[^167]: ZDNET <https://www.zdnet.com/article/anger-mounts-after-facebooks-shadow-profiles-leak-in-bug/> <sup>[[Archive.org]][938]</sup>

[^168]: CNET <https://www.cnet.com/news/shadow-profiles-facebook-has-information-you-didnt-hand-over/> <sup>[[Archive.org]][939]</sup>

[^169]: Anyvision <https://www.anyvision.co/> <sup>[[Archive.org]][940]</sup>

[^170]: BuzzFeed.news, Surveillance Nation <https://www.buzzfeednews.com/article/ryanmac/clearview-ai-local-police-facial-recognition> <sup>[[Archive.org]][941]</sup>

[^171]: Wired, Clearview AI Has New Tools to Identify You in Photos <https://www.wired.com/story/clearview-ai-new-tools-identify-you-photos/> <sup>[[Archive.org]][942]</sup>

[^172]: NEC, Neoface <https://www.nec.com/en/global/solutions/biometrics/face/neofacewatch.html> <sup>[[Archive.org]][943]</sup>

[^173]: The Guardian, Met police deploy live facial recognition technology <https://www.theguardian.com/uk-news/2020/feb/11/met-police-deploy-live-facial-recognition-technology> <sup>[[Archive.org]][944]</sup>

[^174]: YouTube, The Economist, China: facial recognition and state control <https://www.youtube.com/watch?v=lH2gMNrUuEY> <sup>[[Invidious]][945]</sup>

[^175]: CNN, Want your unemployment benefits? You may have to submit to facial recognition first <https://edition.cnn.com/2021/07/23/tech/idme-unemployment-facial-recognition/index.html> <sup>[[Archive.org]][946]</sup>

[^176]: Washington Post, Huawei tested AI software that could recognize Uighur minorities and alert police, report says <https://www.washingtonpost.com/technology/2020/12/08/huawei-tested-ai-software-that-could-recognize-uighur-minorities-alert-police-report-says/> <sup>[[Archive.org]][947]</sup>

[^177]: The Intercept, How a Facial Recognition Mismatch Can Ruin Your Life <https://theintercept.com/2016/10/13/how-a-facial-recognition-mismatch-can-ruin-your-life/> <sup>[[Tor Mirror]][948]</sup> <sup>[[Archive.org]][949]</sup>

[^178]: Vice, Facial Recognition Failures Are Locking People Out of Unemployment Systems <https://www.vice.com/en/article/5dbywn/facial-recognition-failures-are-locking-people-out-of-unemployment-systems> <sup>[[Archive.org]][950]</sup>

[^179]: BBC, WhatsApp photo drug dealer caught by 'groundbreaking' work <https://www.bbc.com/news/uk-wales-43711477> <sup>[[Archive.org]][951]</sup>

[^180]: CNN, Drug dealer jailed after sharing a photo of cheese that included his fingerprints <https://edition.cnn.com/2021/05/25/uk/drug-dealer-cheese-sentenced-scli-gbr-intl/index.html> <sup>[[Archive.org]][952]</sup>

[^181]: Vice.com, Cops Got a Drug Dealer's Fingerprints From Photos of His Hand on WhatsApp <https://www.vice.com/en/article/evqk9e/photo-of-fingerprints-used-to-arrest-drug-dealers> <sup>[[Archive.org]][953]</sup>

[^182]: JUSTIA Patent, Identification of taste attributes from an audio signal <https://patents.justia.com/patent/10891948> <sup>[[Archive.org]][954]</sup>

[^183]: PYMNTS, Iris Scan Serves As Traveler ID At Dubai Airport <https://www.pymnts.com/news/biometrics/2021/iris-scan-traveler-identification-dubai-airport/> <sup>[[Archive.org]][955]</sup>

[^184]: IMDB, Gattaca 1997, <https://www.imdb.com/title/tt0119177/> <sup>[[Archive.org]][956]</sup>

[^185]: IMDB, Person of Interest 2011 <https://www.imdb.com/title/tt1839578> <sup>[[Archive.org]][957]</sup>

[^186]: IMDB, Minority Report 2002, <https://www.imdb.com/title/tt0181689> <sup>[[Archive.org]][958]</sup>

[^187]: Wikipedia, Deepfake <https://en.wikipedia.org/wiki/Deepfake> <sup>[[Wikiless]][959]</sup> <sup>[[Archive.org]][960]</sup>

[^188]: Econotimes, Deepfake Voice Technology: The Good. The Bad. The Future <https://www.econotimes.com/Deepfake-Voice-Technology-The-Good-The-Bad-The-Future-1601278> <sup>[[Archive.org]][961]</sup>

[^189]: Wikipedia, Deepfake Events <https://en.wikipedia.org/wiki/Deepfake#Example_events> <sup>[[Wikiless]][959]</sup> <sup>[[Archive.org]][960]</sup>

[^190]: Forbes, A Voice Deepfake Was Used To Scam A CEO Out Of $243,000 <https://www.forbes.com/sites/jessedamiani/2019/09/03/a-voice-deepfake-was-used-to-scam-a-ceo-out-of-243000/> <sup>[[Archive.org]][962]</sup>

[^191]: Joseph Steinberg, How To Prevent Facial Recognition Technology From Identifying You <https://josephsteinberg.com/how-to-prevent-facial-recognition-technology-from-identifying-you/> <sup>[[Archive.org]][963]</sup>

[^192]: NIST, Face recognition accuracy with masks using pre-COVID-19 algorithms <https://nvlpubs.nist.gov/nistpubs/ir/2020/NIST.IR.8311.pdf> <sup>[[Archive.org]][964]</sup>

[^193]: BBC, Facial recognition identifies people wearing masks <https://www.bbc.com/news/technology-55573802> <sup>[[Archive.org]][965]</sup>

[^194]: University of Wisconsin, Exploring Reflectacles As Anti-Surveillance Glasses and for Adversarial Machine Learning in Computer Vision <http://diglib.uwgb.edu/digital/api/collection/p17003coll4/id/71/download> <sup>[[Archive.org]][966]</sup>

[^195]: Wikipedia, Phishing <https://en.wikipedia.org/wiki/Phishing> <sup>[[Wikiless]][967]</sup> <sup>[[Archive.org]][968]</sup>

[^196]: Wikipedia, Social Engineering <https://en.wikipedia.org/wiki/Social_engineering_(security)> <sup>[[Wikiless]][969]</sup> <sup>[[Archive.org]][970]</sup>

[^197]: BBC, Spy pixels in emails have become endemic <https://www.bbc.com/news/technology-56071437> <sup>[[Archive.org]][971]</sup>

[^198]: Vice, Facebook Helped the FBI Hack a Child Predator <https://www.vice.com/en/article/v7gd9b/facebook-helped-fbi-hack-child-predator-buster-hernandez> <sup>[[Archive.org]][670]</sup>

[^199]: Wikipedia, Exploit <https://en.wikipedia.org/wiki/Exploit_(computer_security)> <sup>[[Wikiless]][972]</sup> <sup>[[Archive.org]][973]</sup>

[^200]: Wikipedia, Freedom Hosting <https://en.wikipedia.org/wiki/Freedom_Hosting> <sup>[[Wikiless]][974]</sup> <sup>[[Archive.org]][975]</sup>

[^201]: Wired, 2013 FBI Admits It Controlled Tor Servers Behind Mass Malware Attack <https://www.wired.com/2013/09/freedom-hosting-fbi/> <sup>[[Archive.org]][976]</sup>

[^202]: Wikipedia, 2020 United States federal government data breach <https://en.wikipedia.org/wiki/2020_United_States_federal_government_data_breach> <sup>[[Wikiless]][977]</sup> <sup>[[Archive.org]][978]</sup>

[^203]: BBC, China social media: WeChat and the Surveillance State <https://www.bbc.com/news/blogs-china-blog-48552907> <sup>[[Archive.org]][979]</sup>

[^204]: The Intercept, Revealed: Massive Chinese Police Database <https://theintercept.com/2021/01/29/china-uyghur-muslim-surveillance-police/> <sup>[[Tor Mirror]][980]</sup> <sup>[[Archive.org]][981]</sup>

[^205]: Wikipedia, Sandbox <https://en.wikipedia.org/wiki/Sandbox_(computer_security)> <sup>[[Wikiless]][982]</sup> <sup>[[Archive.org]][983]</sup>

[^206]: Wired, Why the Security of USB Is Fundamentally Broken <https://www.wired.com/2014/07/usb-security/> <sup>[[Archive.org]][984]</sup>

[^207]: Wikipedia, Stuxnet <https://en.wikipedia.org/wiki/Stuxnet> <sup>[[Wikiless]][985]</sup> <sup>[[Archive.org]][986]</sup>

[^208]: Superuser.com, How do I safely investigate a USB stick found in the parking lot at work? <https://superuser.com/questions/1206321/how-do-i-safely-investigate-a-usb-stick-found-in-the-parking-lot-at-work> <sup>[[Archive.org]][987]</sup>

[^209]: The Guardian, Glenn Greenwald: how the NSA tampers with US-made internet routers <https://www.theguardian.com/books/2014/may/12/glenn-greenwald-nsa-tampers-us-internet-routers-snowden> <sup>[[Archive.org]][988]</sup>

[^210]: Wikipedia, Rootkit <https://en.wikipedia.org/wiki/Rootkit> <sup>[[Wikiless]][989]</sup> <sup>[[Archive.org]][990]</sup>

[^211]: Wikipedia, Userspace <https://en.wikipedia.org/wiki/User_space> <sup>[[Wikiless]][991]</sup> <sup>[[Archive.org]][992]</sup>

[^212]: Wikipedia, Firmware <https://en.wikipedia.org/wiki/Firmware> <sup>[[Wikiless]][993]</sup> <sup>[[Archive.org]][994]</sup>

[^213]: Wikipedia, BIOS <https://en.wikipedia.org/wiki/BIOS> <sup>[[Wikiless]][995]</sup> <sup>[[Archive.org]][996]</sup>

[^214]: Wikipedia, UEFI <https://en.wikipedia.org/wiki/Unified_Extensible_Firmware_Interface> <sup>[[Wikiless]][997]</sup> <sup>[[Archive.org]][998]</sup>

[^215]: Bellingcat, Joseph Mifsud: Rush for the EXIF <https://www.bellingcat.com/news/americas/2018/10/26/joseph-mifsud-rush-exif/> <sup>[[Archive.org]][999]</sup>

[^216]: Zoom Support, Adding a watermark <https://support.zoom.us/hc/en-us/articles/209605273-Adding-a-Watermark> <sup>[[Archive.org]][1000]</sup>

[^217]: Zoom Support, Audio Watermark <https://support.zoom.us/hc/en-us/articles/360021839031-Audio-Watermark> <sup>[[Archive.org]][1001]</sup>

[^218]: CreativeCloud Extension, IMATAG <https://exchange.adobe.com/creativecloud.details.101789.imatag-invisible-watermark-and-image-monitoring.html> <sup>[[Archive.org]][1002]</sup>

[^219]: NexGuard, <https://dtv.nagra.com/nexguard-forensic-watermarking> <sup>[[Archive.org]][1003]</sup>

[^220]: Vobile Solutions, <https://www.vobilegroup.com/> <sup>[[Archive.org]][1004]</sup>

[^221]: Cinavia, <https://www.cinavia.com/languages/english/pages/technology.html> <sup>[[Archive.org]][1005]</sup>

[^222]: Imatag, <https://www.imatag.com/> <sup>[[Archive.org]][1006]</sup>

[^223]: Wikipedia, Steganography <https://en.wikipedia.org/wiki/Steganography> <sup>[[Wikiless]][1007]</sup> <sup>[[Archive.org]][1008]</sup>

[^224]: IEEExplore, A JPEG compression resistant steganography scheme for raster graphics images <https://ieeexplore.ieee.org/document/4428921> <sup>[[Archive.org]][1009]</sup>

[^225]: ScienceDirect, Robust audio watermarking using perceptual masking <https://www.sciencedirect.com/science/article/abs/pii/S0165168498000140> <sup>[[Archive.org]][1010]</sup>

[^226]: IEEExplore, Spread-spectrum watermarking of audio signals <https://ieeexplore.ieee.org/abstract/document/1188746> <sup>[[Archive.org]][1011]</sup>

[^227]: Google Scholar, source camera identification <https://scholar.google.com/scholar?q=source+camera+identification> <sup>[[Archive.org]][1012]</sup>

[^228]: Wikipedia, Printing Steganography <https://en.wikipedia.org/wiki/Machine_Identification_Code> <sup>[[Wikiless]][1013]</sup> <sup>[[Archive.org]][1014]</sup>

[^229]: MIT, SeeingYellow, <http://seeingyellow.com/> <sup>[[Archive.org]][1015]</sup>

[^230]: arXiv, An Analysis of Anonymity in the Bitcoin System <https://arxiv.org/abs/1107.4524> <sup>[[Archive.org]][1016]</sup>

[^231]: Bellingcat, How To Track Illegal Funding Campaigns Via Cryptocurrency, <https://www.bellingcat.com/resources/how-tos/2019/03/26/how-to-track-illegal-funding-campaigns-via-cryptocurrency/> <sup>[[Archive.org]][1017]</sup>

[^232]: CoinDesk, Leaked Slides Show How Chainalysis Flags Crypto Suspects for Cops <https://www.coindesk.com/business/2021/09/21/leaked-slides-show-how-chainalysis-flags-crypto-suspects-for-cops/> <sup>[[Archive.org]][1018]</sup>

[^233]: Wikipedia, KYC <https://en.wikipedia.org/wiki/Know_your_customer> <sup>[[Wikiless]][1019]</sup> <sup>[[Archive.org]][1020]</sup>

[^234]: arXiv.org, Probing the Mystery of Cryptocurrency Theft: An Investigation into Methods for Taint Analysis <https://arxiv.org/pdf/1906.05754.pdf> <sup>[[Archive.org]][1021]</sup>

[^235]: YouTube, Breaking Monero <https://www.youtube.com/watch?v=WOyC6OB6ezA&list=PLsSYUeVwrHBnAUre2G_LYDsdo-tD0ov-y> <sup>[[Invidious]][1022]</sup>

[^236]: Monero, Monero vs Princeton Researchers, <https://monero.org/monero-vs-princeton-researchers/> <sup>[[Archive.org]][1023]</sup>

[^237]: Wikipedia, Cryptocurrency Tumbler <https://en.wikipedia.org/wiki/Cryptocurrency_tumbler> <sup>[[Wikiless]][1024]</sup> <sup>[[Archive.org]][1025]</sup>

[^238]: Wikipedia, Security Through Obscurity <https://en.wikipedia.org/wiki/Security_through_obscurity> <sup>[[Wikiless]][1026]</sup> <sup>[[Archive.org]][1027]</sup>

[^239]: ArXiv, Tracking Mixed Bitcoins, <https://arxiv.org/abs/2009.14007> <sup>[[Archive.org]][1028]</sup>

[^240]: SSRN, The Cryptocurrency Tumblers: Risks, Legality and Oversight <https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3080361> <sup>[[Archive.org]][1029]</sup>

[^241]: Magnet Forensics, Magnet AXIOM <https://www.magnetforensics.com/products/magnet-axiom/cloud/> <sup>[[Archive.org]][1030]</sup>

[^242]: Cellebrite, Unlock cloud-based evidence to solve the case sooner <https://www.cellebrite.com/en/ufed-cloud/> <sup>[[Archive.org]][1031]</sup>

[^243]: Chromium Documentation, Technical analysis of client identification mechanisms <https://sites.google.com/a/chromium.org/dev/Home/chromium-security/client-identification-mechanisms#TOC-Machine-specific-characteristics> <sup>[[Archive.org]][1032]</sup>

[^244]: Mozilla Wiki, Fingerprinting <https://wiki.mozilla.org/Fingerprinting> <sup>[[Archive.org]][1033]</sup>

[^245]: Grayshirt, <https://www.grayshift.com/> <sup>[[Archive.org]][1034]</sup>

[^246]: Securephones.io, Data Security on Mobile Devices: Current State of the Art, Open Problems, and Proposed Solutions <https://securephones.io/main.pdf> <sup>[[Archive.org]][1035]</sup>

[^247]: Loup-Vaillant.fr, Rolling Your Own Crypto <https://loup-vaillant.fr/articles/rolling-your-own-crypto> <sup>[[Archive.org]][1036]</sup>

[^248]: Dhole Moments, Crackpot Cryptography and Security Theater <https://soatok.blog/2021/02/09/crackpot-cryptography-and-security-theater/> <sup>[[Archive.org]][1037]</sup>

[^249]: Vice.com, Why You Don't Roll Your Own Crypto <https://www.vice.com/en/article/wnx8nq/why-you-dont-roll-your-own-crypto> <sup>[[Archive.org]][1038]</sup>

[^250]: arXiv, MIT, You Really Shouldn't Roll Your Own Crypto: An Empirical Study of Vulnerabilities in Cryptographic Libraries <https://arxiv.org/pdf/2107.04940.pdf> <sup>[[Archive.org]][1039]</sup>

[^251]: YouTube, Great Crypto Failures <https://www.youtube.com/watch?v=loy84K3AJ5Q> <sup>[[Invidious]][1040]</sup>

[^252]: Cryptography Dispatches, The Most Backdoor-Looking Bug I've Ever Seen <https://buttondown.email/cryptography-dispatches/archive/cryptography-dispatches-the-most-backdoor-looking/> <sup>[[Archive.org]][164]</sup>

[^253]: Citizenlab.ca, Move Fast and Roll Your Own Crypto <https://citizenlab.ca/2020/04/move-fast-roll-your-own-crypto-a-quick-look-at-the-confidentiality-of-zoom-meetings/> <sup>[[Archive.org]][1041]</sup>

[^254]: Jack Poon, The myth of military grade encryption <https://medium.com/@atcipher/the-myth-of-military-grade-encryption-292313ae6369> <sup>[[Archive.org]][1042]</sup>

[^255]: Congruent Labs, Stop calling it "Military-Grade Encryption" <https://blog.congruentlabs.co/military-grade-encryption/> <sup>[[Archive.org]][1043]</sup>

[^256]: IronCoreLabs Blog, "Military Grade Encryption" <https://blog.ironcorelabs.com/military-grade-encryption-69aae0145588> <sup>[[Archive.org]][1044]</sup>

[^257]: Wikipedia, BLAKE2, <https://en.wikipedia.org/wiki/BLAKE_(hash_function)#BLAKE2> <sup>[[Wikiless]][1045]</sup> <sup>[[Archive.org]][1046]</sup>

[^258]: Wikipedia, AES Instruction Set, <https://en.wikipedia.org/wiki/AES_instruction_set> <sup>[[Wikiless]][1047]</sup> <sup>[[Archive.org]][1048]</sup>

[^259]: Wikipedia, ChaCha Variants, <https://en.wikipedia.org/wiki/Salsa20#ChaCha_variant> <sup>[[Wikiless]][1049]</sup> <sup>[[Archive.org]][1050]</sup>

[^260]: Wikipedia, Serpent, <https://en.wikipedia.org/wiki/Serpent_(cipher)> <sup>[[Wikiless]][1051]</sup> <sup>[[Archive.org]][1052]</sup>

[^261]: Wikipedia, TwoFish, <https://en.wikipedia.org/wiki/Twofish> <sup>[[Wikiless]][1053]</sup> <sup>[[Archive.org]][1054]</sup>

[^262]: Lacatora, The PGP Problem <https://latacora.singles/2019/07/16/the-pgp-problem.html> <sup>[[Archive.org]][1055]</sup>

[^263]: Wikipedia, Shor's Algorithm, <https://en.wikipedia.org/wiki/Shor%27s_algorithm> <sup>[[Wikiless]][1056]</sup> <sup>[[Archive.org]][1057]</sup>

[^264]: Wikipedia, Gag Order, <https://en.wikipedia.org/wiki/Gag_order> <sup>[[Wikiless]][1058]</sup> <sup>[[Archive.org]][1059]</sup>

[^265]: Wikipedia, National Security Letter <https://en.wikipedia.org/wiki/National_security_letter> <sup>[[Wikiless]][1060]</sup> <sup>[[Archive.org]][1061]</sup>

[^266]: TechCrunch, ProtonMail logged IP address of French activist after order by Swiss authorities <https://techcrunch.com/2021/09/06/protonmail-logged-ip-address-of-french-activist-after-order-by-swiss-authorities/> <sup>[[Archive.org]][1062]</sup>

[^267]: ArsTechnica, VPN servers seized by Ukrainian authorities weren't encrypted <https://arstechnica.com/gadgets/2021/07/vpn-servers-seized-by-ukrainian-authorities-werent-encrypted/> <sup>[[Archive.org]][1063]</sup>

[^268]: BleepingComputer, DoubleVPN servers, logs, and account info seized by law enforcement <https://www.bleepingcomputer.com/news/security/doublevpn-servers-logs-and-account-info-seized-by-law-enforcement/> <sup>[[Archive.org]][1064]</sup>

[^269]: CyberScoop, Court rules encrypted email provider Tutanota must monitor messages in blackmail case <https://www.cyberscoop.com/court-rules-encrypted-email-tutanota-monitor-messages/> <sup>[[Archive.org]][1065]</sup>

[^270]: Heise Online (German), <https://www.heise.de/news/Gericht-zwingt-Mailprovider-Tutanota-zu-Ueberwachungsfunktion-4972460.html> <sup>[[Archive.org]][1066]</sup>

[^271]: PCMag, Did PureVPN Cross a Line When It Disclosed User Information? <https://www.pcmag.com/opinions/did-purevpn-cross-a-line-when-it-disclosed-user-information> <sup>[[Archive.org]][1067]</sup>

[^272]: Internet Archive, Wipeyourdata, "No logs" EarthVPN user arrested after police finds logs <https://archive.is/XNuVw#selection-230.0-230.1> <sup>[[Archive.org]][1068]</sup>

[^273]: Wikipedia, Lavabit Suspension and Gag order, <https://en.wikipedia.org/wiki/Lavabit#Suspension_and_gag_order> <sup>[[Wikiless]][1069]</sup> <sup>[[Archive.org]][1070]</sup>

[^274]: Internet Archive, Invisibler, What Everybody Ought to Know About HideMyAss <https://archive.is/ag9w4#selection-136.0-136.1>

[^275]: Wikipedia, Warrant Canary <https://en.wikipedia.org/wiki/Warrant_canary> <sup>[[Wikiless]][1071]</sup> <sup>[[Archive.org]][1072]</sup>

[^276]: Washington Post, The intelligence coup of the century <https://www.washingtonpost.com/graphics/2020/world/national-security/cia-crypto-encryption-machines-espionage/> <sup>[[Archive.org]][1073]</sup>

[^277]: Swissinfo.ch, Second Swiss firm allegedly sold encrypted spying devices <https://www.swissinfo.ch/eng/second-swiss-firm-allegedly-sold-encrypted-spying-devices/46186432> <sup>[[Archive.org]][1074]</sup>

[^278]: Wikipedia, Das Leben der Anderen <https://en.wikipedia.org/wiki/The_Lives_of_Others> <sup>[[Wikiless]][1075]</sup> <sup>[[Archive.org]][1076]</sup>

[^279]: Wired, Mind the Gap: This Researcher Steals Data With Noise, Light, and Magnets <https://www.wired.com/story/air-gap-researcher-mordechai-guri/> <sup>[[Archive.org]][1077]</sup>

[^280]: Scientific American, A Blank Wall Can Show How Many People Are in a Room and What They're Doing <https://www.scientificamerican.com/article/a-blank-wall-can-show-how-many-people-are-in-a-room-and-what-theyre-doing/> <sup>[[Archive.org]][1078]</sup>

[^281]: Scientific American, A Shiny Snack Bag's Reflections Can Reconstruct the Room around It <https://www.scientificamerican.com/article/a-shiny-snack-bags-reflections-can-reconstruct-the-room-around-it/> <sup>[[Archive.org]][1079]</sup>

[^282]: Scientific American, Footstep Sensors Identify People by Gait <https://www.scientificamerican.com/article/footstep-sensors-identify-people-by-gait/> <sup>[[Archive.org]][1080]</sup>

[^283]: Ben Nassi, Lamphone, <https://www.nassiben.com/lamphone> <sup>[[Archive.org]][1081]</sup>

[^284]: The Guardian, Laser spying: is it really practical? <https://www.theguardian.com/world/2013/aug/22/gchq-warned-laser-spying-guardian-offices> <sup>[[Archive.org]][1082]</sup>

[^285]: ArsTechnica, Photos of an NSA "upgrade" factory show Cisco router getting implant <https://arstechnica.com/tech-policy/2014/05/photos-of-an-nsa-upgrade-factory-show-cisco-router-getting-implant/> <sup>[[Archive.org]][1083]</sup>

[^286]: Wikipedia, Rubber-hose Cryptanalysis https://en.wikipedia.org/wiki/Rubber-hose_cryptanalysis

[^287]: Defuse.ca, TrueCrypt's Plausible Deniability is Theoretically Useless <https://defuse.ca/truecrypt-plausible-deniability-useless-by-game-theory.htm> <sup>[[Archive.org]][244]</sup>

[^288]: Wikipedia, OONI, <https://en.wikipedia.org/wiki/OONI> <sup>[[Wikiless]][1084]</sup> <sup>[[Archive.org]][1085]</sup>

[^289]: Privacy International, Timeline of SIM Card Registration Laws <https://privacyinternational.org/long-read/3018/timeline-sim-card-registration-laws> <sup>[[Archive.org]][1086]</sup>

[^290]: NYTimes, Lost Passwords Lock Millionaires Out of Their Bitcoin Fortunes <https://www.nytimes.com/2021/01/12/technology/bitcoin-passwords-wallets-fortunes.html> <sup>[[Archive.org]][1087]</sup>

[^291]: Usenix.org, Shedding too much Light on a Microcontroller's Firmware Protection <https://www.usenix.org/system/files/conference/woot17/woot17-paper-obermaier.pdf> <sup>[[Archive.org]][1088]</sup>

[^292]: TorProject.org, Can I run Tor Browser on an iOS device? <https://support.torproject.org/tormobile/tormobile-3/> <sup>[[Archive.org]][1089]</sup>

[^293]: Wikipedia, Tails, <https://en.wikipedia.org/wiki/Tails_(operating_system)> <sup>[[Wikiless]][1090]</sup> <sup>[[Archive.org]][1091]</sup>

[^294]: Vice.com, Facebook Helped the FBI Hack a Child Predator <https://www.vice.com/en/article/v7gd9b/facebook-helped-fbi-hack-child-predator-buster-hernandez> <sup>[[Archive.org]][670]</sup>

[^295]: Veracrypt Documentation, Trim Operations <https://www.veracrypt.fr/en/Trim%20Operation.html> <sup>[[Archive.org]][1092]</sup>

[^296]: Coreboot, <https://www.coreboot.org/> <sup>[[Archive.org]][1093]</sup>

[^297]: YouTube, 36C3 - Uncover, Understand, Own - Regaining Control Over Your AMD CPU <https://www.youtube.com/watch?v=bKH5nGLgi08&t=2834s> <sup>[[Invidious]][74]</sup>

[^298]: Qubes OS, Anti-Evil Maid, <https://github.com/QubesOS/qubes-antievilmaid> <sup>[[Archive.org]][270]</sup>

[^299]: QubesOS FAQ, <https://www.qubes-os.org/faq/#is-secure-boot-supported> <sup>[[Archive.org]][368]</sup>

[^300]: Wikipedia, Secure Boot, <https://en.wikipedia.org/wiki/Unified_Extensible_Firmware_Interface#Secure_boot> <sup>[[Wikiless]][997]</sup> <sup>[[Archive.org]][998]</sup>

[^301]: Wikipedia, Booting <https://en.wikipedia.org/wiki/Booting> <sup>[[Wikiless]][1094]</sup> <sup>[[Archive.org]][1095]</sup>

[^302]: Wired <https://www.wired.com/2013/12/better-data-security-nail-polish/> <sup>[[Archive.org]][1096]</sup>

[^303]: Wikipedia, Virtual Machine <https://en.wikipedia.org/wiki/Virtual_machine> <sup>[[Wikiless]][1097]</sup> <sup>[[Archive.org]][1098]</sup>

[^304]: Wikipedia, Plausible Deniability <https://en.wikipedia.org/wiki/Plausible_deniability> <sup>[[Wikiless]][1099]</sup> <sup>[[Archive.org]][1100]</sup>

[^305]: Wikipedia, Deniable Encryption <https://en.wikipedia.org/wiki/Deniable_encryption> <sup>[[Wikiless]][1101]</sup> <sup>[[Archive.org]][1102]</sup>

[^306]: PrivacyGuides.org, Don't use Windows 10 - It's a privacy nightmare <https://privacyguides.org/operating-systems/#win10> <sup>[[Archive.org]][1103]</sup>

[^307]: Wikipedia, Deniable Encryption <https://en.wikipedia.org/wiki/Deniable_encryption> <sup>[[Wikiless]][1101]</sup> <sup>[[Archive.org]][1102]</sup>

[^308]: Wikipedia, Key Disclosure Laws <https://en.wikipedia.org/wiki/Key_disclosure_law> <sup>[[Wikiless]][550]</sup> <sup>[[Archive.org]][551]</sup>

[^309]: GP Digital, World map of encryption laws and policies <https://www.gp-digital.org/world-map-of-encryption/> <sup>[[Archive.org]][552]</sup>

[^310]: Wikipedia, Bitlocker <https://en.wikipedia.org/wiki/BitLocker> <sup>[[Wikiless]][1104]</sup> <sup>[[Archive.org]][1105]</sup>

[^311]: Wikipedia, Evil Maid Attack <https://en.wikipedia.org/wiki/Evil_maid_attack> <sup>[[Wikiless]][1106]</sup> <sup>[[Archive.org]][1107]</sup>

[^312]: Wikipedia, Cold Boot Attack <https://en.wikipedia.org/wiki/Cold_boot_attack> <sup>[[Wikiless]][1108]</sup> <sup>[[Archive.org]][1109]</sup>

[^313]: CITP 2008 (<https://www.youtube.com/watch?v=JDaicPIgn9U>) <sup>[[Invidious]][1110]</sup>

[^314]: ResearchGate, Defeating Plausible Deniability of VeraCrypt Hidden Operating Systems <https://www.researchgate.net/publication/318155607_Defeating_Plausible_Deniability_of_VeraCrypt_Hidden_Operating_Systems> <sup>[[Archive.org]][1111]</sup>

[^315]: SANS.org, Mission Implausible: Defeating Plausible Deniability with Digital Forensics <https://www.sans.org/reading-room/whitepapers/forensics/mission-implausible-defeating-plausible-deniability-digital-forensics-39500> <sup>[[Archive.org]][1112]</sup>

[^316]: SourceForge, Veracrypt Forum <https://sourceforge.net/p/veracrypt/discussion/technical/thread/53f33faf/> <sup>[[Archive.org]][1113]</sup>

[^317]: Microsoft, BitLocker Countermeasures <https://docs.microsoft.com/en-us/windows/security/information-protection/bitlocker/bitlocker-countermeasures> <sup>[[Archive.org]][1114]</sup>

[^318]: SANS, Windows ShellBag Forensics in-depth <https://www.sans.org/reading-room/whitepapers/forensics/windows-shellbag-forensics-in-depth-34545> <sup>[[Archive.org]][1115]</sup>

[^319]: University of York, Forensic data recovery from the Windows Search Database <https://eprints.whiterose.ac.uk/75046/1/Forensic_Data_Recovery_From_The_Windows_Search_Database_preprint_DIIN328.pdf> <sup>[[Archive.org]][1116]</sup>

[^320]: A forensic insight into Windows 10 Jump Lists <https://cyberforensicator.com/wp-content/uploads/2017/01/1-s2.0-S1742287616300202-main.2-14.pdf> <sup>[[Archive.org]][1117]</sup>

[^321]: Wikipedia, Gatekeeper <https://en.wikipedia.org/wiki/Gatekeeper_(macOS)> <sup>[[Wikiless]][1118]</sup> <sup>[[Archive.org]][1119]</sup>

[^322]: Alpine Linux Wiki, Setting up a laptop <https://wiki.alpinelinux.org/wiki/Setting_up_a_laptop> <sup>[[Archive.org]][1120]</sup>

[^323]: Wikipedia Veracrypt <https://en.wikipedia.org/wiki/VeraCrypt> <sup>[[Wikiless]][1121]</sup> <sup>[[Archive.org]][1122]</sup>

[^324]: OSTIF Veracrypt Audit, 2016, <https://web.archive.org/web/https://ostif.org/the-veracrypt-audit-results/>

[^325]: Veracrypt Documentation, Unencrypted Data in RAM <https://www.veracrypt.fr/en/Unencrypted%20Data%20in%20RAM.html> <sup>[[Archive.org]][1123]</sup>

[^326]: Veracrypt Documentation, Data Leaks <https://www.veracrypt.fr/code/VeraCrypt/plain/doc/html/Data%20Leaks.html> <sup>[[Archive.org]][1124]</sup>

[^327]: Dolos Group, From Stolen Laptop to Inside the Company Network <https://dolosgroup.io/blog/2021/7/9/from-stolen-laptop-to-inside-the-company-network> <sup>[[Archive.org]][1125]</sup>

[^328]: Trammell Hudson's Projects, Understanding TPM Sniffing Attacks <https://trmm.net/tpm-sniffing/> <sup>[[Archive.org]][1126]</sup>

[^329]: Jon Aubrey, attacking laptops that are protected by Microsoft Bitlocker drive encryption <https://twitter.com/SecurityJon/status/1445020885472235524> <sup>[[Nitter]][1127]</sup>

[^330]: F-Secure Labs, Sniff, there leaks my BitLocker key <https://labs.f-secure.com/blog/sniff-there-leaks-my-bitlocker-key/> <sup>[[Archive.org]][1128]</sup>

[^331]: Microsoft, BitLocker Countermeasures, Attacker countermeasures <https://docs.microsoft.com/en-us/windows/security/information-protection/bitlocker/bitlocker-countermeasures> <sup>[[Archive.org]][1114]</sup>

[^332]: Wikipedia, Trim <https://en.wikipedia.org/wiki/Trim_(computing)> <sup>[[Wikiless]][482]</sup> <sup>[[Archive.org]][483]</sup>

[^333]: Veracrypt Documentation, Trim Operations <https://www.veracrypt.fr/en/Trim%20Operation.html> <sup>[[Archive.org]][1092]</sup>

[^334]: Veracrypt Documentation, Rescue Disk <https://www.veracrypt.fr/en/VeraCrypt%20Rescue%20Disk.html> <sup>[[Archive.org]][1129]</sup>

[^335]: St Cloud State University, Forensic Research on Solid State Drives using Trim Analysis <https://repository.stcloudstate.edu/cgi/viewcontent.cgi?article=1141&context=msia_etds> <sup>[[Archive.org]][1130]</sup>

[^336]: WindowsCentral, Trim Tutorial <https://www.windowscentral.com/how-ensure-trim-enabled-windows-10-speed-ssd-performance> <sup>[[Archive.org]][1131]</sup>

[^337]: Veracrypt Documentation, Trim Operation <https://veracrypt.eu/en/docs/trim-operation/> <sup>[[Archive.org]][1132]</sup>

[^338]: Black Hat 2018, Perfectly Deniable Steganographic Disk Encryption <https://i.blackhat.com/eu-18/Thu-Dec-6/eu-18-Schaub-Perfectly-Deniable-Steganographic-Disk-Encryption.pdf> <sup>[[Archive.org]][1133]</sup>

[^339]: Milan Broz's Blog, TRIM & dm-crypt ... problems? <http://asalor.blogspot.com/2011/08/trim-dm-crypt-problems.html> <sup>[[Archive.org]][1134]</sup>

[^340]: Veracrypt Documentation, Rescue Disk <https://www.veracrypt.fr/en/VeraCrypt%20Rescue%20Disk.html> <sup>[[Archive.org]][1129]</sup>

[^341]: Wikipedia, Virtualbox <https://en.wikipedia.org/wiki/VirtualBox> <sup>[[Wikiless]][1135]</sup> <sup>[[Archive.org]][1136]</sup>

[^342]: VirtualBox Ticket 17987 <https://www.virtualbox.org/ticket/17987> <sup>[[Archive.org]][1137]</sup>

[^343]: Whonix Documentation, Spectre Meltdown, <https://www.whonix.org/wiki/Spectre_Meltdown#VirtualBox> <sup>[[Archive.org]][79]</sup>

[^344]: Whonix Documentation, Stream Isolation <https://www.whonix.org/wiki/Stream_Isolation> <sup>[[Archive.org]][317]</sup>

[^345]: Whonix Documentation, Tunnels Comparison Table, <https://www.whonix.org/wiki/Tunnels/Introduction#Comparison_Table> <sup>[[Archive.org]][319]</sup>

[^346]: Wikipedia, Whonix <https://en.wikipedia.org/wiki/Whonix> <sup>[[Wikiless]][1138]</sup> <sup>[[Archive.org]][1139]</sup>

[^347]: Oracle Virtualbox Manual, Snapshots <https://docs.oracle.com/en/virtualization/virtualbox/6.0/user/snapshots.html> <sup>[[Archive.org]][1140]</sup>

[^348]: Utica College, FORENSIC RECOVERY OF EVIDENCE FROM DELETED ORACLE VIRTUALBOX VIRTUAL MACHINES <https://web.archive.org/web/https://programs.online.utica.edu/sites/default/files/Neal_6_Gonnella_Forensic_Recovery_of_Evidence_from_Deleted_Oracle_VirtualBox_Virtual_Machine.pdf>

[^349]: Wikipedia, Spectre <https://en.wikipedia.org/wiki/Spectre_(security_vulnerability)> <sup>[[Wikiless]][1141]</sup> <sup>[[Archive.org]][1142]</sup>

[^350]: Wikipedia, Meltdown <https://en.wikipedia.org/wiki/Meltdown_(security_vulnerability)> <sup>[[Wikiless]][1143]</sup> <sup>[[Archive.org]][1144]</sup>

[^351]: Whonix Documentation, Stream Isolation, By Settings <https://www.whonix.org/wiki/Stream_Isolation#By_Settings> <sup>[[Archive.org]][1145]</sup>

[^352]: Wikipedia, TOTP <https://en.wikipedia.org/wiki/Time-based_One-time_Password_algorithm> <sup>[[Wikiless]][1146]</sup> <sup>[[Archive.org]][1147]</sup>

[^353]: Wikipedia, Multi-Factor Authentication <https://en.wikipedia.org/wiki/Multi-factor_authentication> <sup>[[Wikiless]][1148]</sup> <sup>[[Archive.org]][1149]</sup>

[^354]: Whonix Documentation, Bridged Adapters Warning <https://www.whonix.org/wiki/Whonix-Gateway_Security#Warning:_Bridged_Networking> <sup>[[Archive.org]][1150]</sup>

[^355]: Qubes OS, FAQ, <https://www.qubes-os.org/faq/#is-qubes-just-another-linux-distribution> <sup>[[Archive.org]][1151]</sup>

[^356]: Qubes OS, System Requirements <https://www.qubes-os.org/doc/system-requirements/> <sup>[[Archive.org]][1152]</sup>

[^357]: Whonix Documentation, Stream Isolation <https://www.whonix.org/wiki/Stream_Isolation> <sup>[[Archive.org]][317]</sup>

[^358]: Whonix Documentation, Tunnels Comparison Table, <https://www.whonix.org/wiki/Tunnels/Introduction#Comparison_Table> <sup>[[Archive.org]][319]</sup>

[^359]: Qubes OS Issues, Simulate Hibernation / Suspend-To-Disk #2414 <https://github.com/QubesOS/qubes-issues/issues/2414> <sup>[[Archive.org]][1153]</sup>

[^360]: Wikipedia, AppArmor <https://en.wikipedia.org/wiki/AppArmor> <sup>[[Wikiless]][1154]</sup> <sup>[[Archive.org]][1155]</sup>

[^361]: Wikipedia, SELinux <https://en.wikipedia.org/wiki/Security-Enhanced_Linux> <sup>[[Wikiless]][1156]</sup> <sup>[[Archive.org]][1157]</sup>

[^362]: Wikipedia, TOTP <https://en.wikipedia.org/wiki/Time-based_One-time_Password_algorithm> <sup>[[Wikiless]][1146]</sup> <sup>[[Archive.org]][1147]</sup>

[^363]: Wikipedia, Multi-Factor Authentication <https://en.wikipedia.org/wiki/Multi-factor_authentication> <sup>[[Wikiless]][1148]</sup> <sup>[[Archive.org]][1149]</sup>

[^364]: Wikipedia, Captcha <https://en.wikipedia.org/wiki/CAPTCHA> <sup>[[Wikiless]][1158]</sup> <sup>[[Archive.org]][1159]</sup>

[^365]: Wikipedia, Turing Test <https://en.wikipedia.org/wiki/Turing_test> <sup>[[Wikiless]][1160]</sup> <sup>[[Archive.org]][1161]</sup>

[^366]: Google reCAPTCHA <https://www.google.com/recaptcha/about/> <sup>[[Archive.org]][1162]</sup>

[^367]: hCaptcha <https://www.hcaptcha.com/> <sup>[[Archive.org]][1163]</sup>

[^368]: hCaptcha, hCaptcha Is Now the Largest Independent CAPTCHA Service, Runs on 15% Of The Internet <https://www.hcaptcha.com/post/hcaptcha-now-the-largest-independent-captcha-service> <sup>[[Archive.org]][1164]</sup>

[^369]: Nearcyan.com, You (probably) don't need ReCAPTCHA <https://nearcyan.com/you-probably-dont-need-recaptcha/> <sup>[[Archive.org]][1165]</sup>

[^370]: ArsTechnica, "Google's reCAPTCHA turns "invisible," will separate bots from people without challenges" <https://arstechnica.com/gadgets/2017/03/googles-recaptcha-announces-invisible-background-captchas/> <sup>[[Archive.org]][1166]</sup>

[^371]: BlackHat Asia 2016, "I'm not a human: Breaking the Google reCAPTCHA", <https://www.blackhat.com/docs/asia-16/materials/asia-16-Sivakorn-Im-Not-a-Human-Breaking-the-Google-reCAPTCHA-wp.pdf> <sup>[[Archive.org]][1167]</sup>

[^372]: Google Blog <https://security.googleblog.com/2014/12/are-you-robot-introducing-no-captcha.html> <sup>[[Archive.org]][1168]</sup>

[^373]: Cloudflare Blog, Cloudflare supports Privacy Pass <https://blog.cloudflare.com/cloudflare-supports-privacy-pass/> <sup>[[Archive.org]][1169]</sup>

[^374]: Privacy International, Timeline of SIM Card Registration Laws <https://privacyinternational.org/long-read/3018/timeline-sim-card-registration-laws> <sup>[[Archive.org]][1086]</sup>

[^375]: Wikipedia, Device Fingerprinting <https://en.wikipedia.org/wiki/Device_fingerprint> <sup>[[Wikiless]][1170]</sup> <sup>[[Archive.org]][1171]</sup>

[^376]: Developers Google Blog,

    Guidance to developers affected by our effort to block less secure browsers and applications <https://developers.googleblog.com/2020/08/guidance-for-our-effort-to-block-less-secure-browser-and-apps.html> <sup>[[Archive.org]][1172]</sup>

[^377]: Google Help, Access age-restricted content & features <https://support.google.com/accounts/answer/10071085> <sup>[[Archive.org]][1173]</sup>

[^378]: Wikipedia, Dark Pattern <https://en.wikipedia.org/wiki/Dark_pattern> <sup>[[Wikiless]][1174]</sup> <sup>[[Archive.org]][1175]</sup>

[^379]: The Verge, Tinder will give you a verified blue check mark if you pass its catfishing test <https://www.theverge.com/2020/1/23/21077423/tinder-photo-verification-blue-checkmark-safety-center-launch-noonlight> <sup>[[Archive.org]][1176]</sup>

[^380]: DigitalInformationWorld, Facebook will now require you to Create a Video Selfie for Identity Verification <https://www.digitalinformationworld.com/2020/03/facebook-is-now-demanding-some-users-to-create-a-video-selfie-for-identity-verification.html> <sup>[[Archive.org]][1177]</sup>

[^381]: Vice.com, PornHub Announces 'Biometric Technology' to Verify Users <https://www.vice.com/en/article/m7a4eq/pornhub-new-verification-policy-biometric-id> <sup>[[Archive.org]][1178]</sup>

[^382]: Variety, China Launches Hotline to Report Online Comments That 'Distort' History or 'Deny' Its Cultural Excellence <https://variety.com/2021/digital/news/china-censorship-hotline-historical-nihilism-1234950554/> <sup>[[Archive.org]][1179]</sup>

[^383]: Wikipedia, Trust but verify <https://en.wikipedia.org/wiki/Trust,_but_verify> <sup>[[Wikiless]][768]</sup> <sup>[[Archive.org]][769]</sup>

[^384]: Wikipedia, Zero-trust Security Model <https://en.wikipedia.org/wiki/Zero_trust_security_model> <sup>[[Wikiless]][1180]</sup> <sup>[[Archive.org]][1181]</sup>

[^385]: Wikipedia, Espionage, Organization <https://en.wikipedia.org/wiki/Espionage#Organization> <sup>[[Wikiless]][1182]</sup> <sup>[[Archive.org]][1183]</sup>

[^386]: Medium.com, Kyle McDonald, How to recognize fake AI-generated images <https://kcimc.medium.com/how-to-recognize-fake-ai-generated-images-4d1f6f9a2842> <sup>[[Archive.org]][1184]</sup>

[^387]: Jayway Blog, Using ML to detect fake face images created by AI <https://blog.jayway.com/2020/03/06/using-ml-to-detect-fake-face-images-created-by-ai/> <sup>[[Archive.org]][1185]</sup>

[^388]: Wikipedia, Sim Swapping <https://en.wikipedia.org/wiki/SIM_swap_scam> <sup>[[Wikiless]][1186]</sup> <sup>[[Archive.org]][1187]</sup>

[^389]: Whonix Documentation, <https://www.whonix.org/wiki/Tor#Edit_Tor_Configuration> <sup>[[Archive.org]][1188]</sup>

[^390]: Tor Browser Documentation, <https://support.torproject.org/tbb/tbb-editing-torrc/> <sup>[[Archive.org]][1189]</sup>

[^391]: Facebook Onion Website <http://facebookwkhpilnemxj7asaniu7vnjjbiltxjqhye3mhbshg7kx5tfyd.onion/>

[^392]: Google Help <https://support.google.com/accounts/answer/114129?hl=en> <sup>[[Archive.org]][1190]</sup>

[^393]: Google Help <https://support.google.com/google-ads/answer/7474263?hl=en> <sup>[[Archive.org]][1191]</sup>

[^394]: Google, Your account is disabled <https://support.google.com/accounts/answer/40695> <sup>[[Archive.org]][1192]</sup>

[^395]: Google, Request to restore the account <https://support.google.com/accounts/contact/disabled2> <sup>[[Archive.org]][1193]</sup>

[^396]: Google Help, Update your account to meet age requirements <https://support.google.com/accounts/answer/1333913?hl=en> <sup>[[Archive.org]][1194]</sup>

[^397]: Jumio, ID verification features <https://www.jumio.com/features/> <sup>[[Archive.org]][1195]</sup>

[^398]: Privacyguides.org recommended E-mail Providers <https://privacyguides.org/providers/email/> <sup>[[Archive.org]][1196]</sup>

[^399]: ProtonMail Human Verification System [https://ProtonMail.com/support/knowledge-base/human-verification/][] <sup>[[Archive.org]][1197]</sup>

[^400]: Twitter Appeal Form <https://help.twitter.com/forms/general>

[^401]: KnowYourMeme, Good Luck, I'm Behind 7 Proxies <https://knowyourmeme.com/memes/good-luck-im-behind-7-proxies> <sup>[[Archive.org]][1198]</sup>

[^402]: Wikipedia, end-to-end encryption, <https://en.wikipedia.org/wiki/End-to-end_encryption> <sup>[[Wikiless]][1199]</sup> <sup>[[Archive.org]][1200]</sup>

[^403]: Wikipedia, Forward Secrecy, <https://en.wikipedia.org/wiki/Forward_secrecy> <sup>[[Wikiless]][1201]</sup> <sup>[[Archive.org]][1202]</sup>

[^404]: Protonblog, What is zero-access encryption and why it is important for security <https://protonmail.com/blog/zero-access-encryption/> <sup>[[Archive.org]][1203]</sup>

[^405]: Wikipedia, Cambridge Analytica Scandal, <https://en.wikipedia.org/wiki/Facebook%E2%80%93Cambridge_Analytica_data_scandal> <sup>[[Wikiless]][1204]</sup> <sup>[[Archive.org]][1205]</sup>

[^406]: Signal Blog, Technology preview: Sealed sender for Signal <https://signal.org/blog/sealed-sender/> <sup>[[Archive.org]][1206]</sup>

[^407]: Signal Blog, Private Contact Discovery, <https://signal.org/blog/private-contact-discovery/> <sup>[[Archive.org]][1207]</sup>

[^408]: Signal Blog, Private Group System, <https://signal.org/blog/signal-private-group-system/> <sup>[[Archive.org]][1208]</sup>

[^409]: Privacyguides.org, File-Sharing <https://privacyguides.org/software/file-sharing/> <sup>[[Archive.org]][1209]</sup>

[^410]: Privacyguides.org, Real-Time Communication <https://privacyguides.org/software/real-time-communication/> <sup>[[Archive.org]][1210]</sup>

[^411]: GetSession.org, The Session Protocol: What's changing --- and why <https://getsession.org/session-protocol-explained/> <sup>[[Archive.org]][1211]</sup>

[^412]: Quarkslab, Audit of Session Secure Messaging Application <https://blog.quarkslab.com/audit-of-session-secure-messaging-application.html> <sup>[[Archive.org]][1212]</sup>

[^413]: Techlore, Top 5 BEST Messengers For Privacy <https://www.youtube.com/watch?v=aVwl892hqb4> <sup>[[Invidious]][1213]</sup>

[^414]: Wikipedia, IPFS <https://en.wikipedia.org/wiki/InterPlanetary_File_System> <sup>[[Wikiless]][1214]</sup> <sup>[[Archive.org]][1215]</sup>

[^415]: Praxis Films, Open Letter from Laura Poitras <https://www.praxisfilms.org/open-letter-from-laura-poitras/> <sup>[[Archive.org]][1216]</sup>

[^416]: Wikipedia, SecureDrop <https://en.wikipedia.org/wiki/SecureDrop> <sup>[[Wikiless]][1217]</sup> <sup>[[Archive.org]][1218]</sup>

[^417]: Wikipedia, TPM <https://en.wikipedia.org/wiki/Trusted_Platform_Module> <sup>[[Wikiless]][1219]</sup> <sup>[[Archive.org]][1220]</sup>

[^418]: Wikipedia, Pastebin <https://en.wikipedia.org/wiki/Pastebin> <sup>[[Wikiless]][1221]</sup> <sup>[[Archive.org]][1222]</sup>

[^419]: Wikipedia, Wear Leveling <https://en.wikipedia.org/wiki/Wear_leveling> <sup>[[Wikiless]][1223]</sup> <sup>[[Archive.org]][1224]</sup>

[^420]: Wikipedia, Trim <https://en.wikipedia.org/wiki/Write_amplification#TRIM> <sup>[[Wikiless]][1225]</sup> <sup>[[Archive.org]][1226]</sup>

[^421]: Wikipedia, Write Amplification <https://en.wikipedia.org/wiki/Write_amplification> <sup>[[Wikiless]][1225]</sup> <sup>[[Archive.org]][1226]</sup>

[^422]: Wikipedia, Trim Disadvantages <https://en.wikipedia.org/wiki/Trim_(computing)#Disadvantages> <sup>[[Wikiless]][482]</sup> <sup>[[Archive.org]][483]</sup>

[^423]: Wikipedia, Garbage Collection <https://en.wikipedia.org/wiki/Write_amplification#Garbage_collection> <sup>[[Wikiless]][1225]</sup> <sup>[[Archive.org]][1226]</sup>

[^424]: Techgage, Too TRIM? When SSD Data Recovery is Impossible <https://techgage.com/article/too_trim_when_ssd_data_recovery_is_impossible/> <sup>[[Archive.org]][1227]</sup>

[^425]: ResearchGate, Live forensics method for acquisition on the Solid-State Drive (SSD) NVMe TRIM function <https://www.researchgate.net/publication/341761017_Live_forensics_method_for_acquisition_on_the_Solid_State_Drive_SSD_NVMe_TRIM_function> <sup>[[Archive.org]][1228]</sup>

[^426]: ElcomSoft, Life after Trim: Using Factory Access Mode for Imaging SSD Drives <https://blog.elcomsoft.com/2019/01/life-after-trim-using-factory-access-mode-for-imaging-ssd-drives/> <sup>[[Archive.org]][1229]</sup>

[^427]: Forensic Focus, Forensic Acquisition Of Solid State Drives With Open Source Tools <https://www.forensicfocus.com/articles/forensic-acquisition-of-solid-state-drives-with-open-source-tools/> <sup>[[Archive.org]][1230]</sup>

[^428]: ResearchGate, Solid State Drive Forensics: Where Do We Stand? <https://www.researchgate.net/publication/325976653_Solid_State_Drive_Forensics_Where_Do_We_Stand> <sup>[[Archive.org]][1231]</sup>

[^429]: Wikipedia, Parted Magic <https://en.wikipedia.org/wiki/Parted_Magic> <sup>[[Wikiless]][1232]</sup> <sup>[[Archive.org]][1233]</sup>

[^430]: Wikipedia, hdparm <https://en.wikipedia.org/wiki/Hdparm> <sup>[[Wikiless]][1234]</sup> <sup>[[Archive.org]][1235]</sup>

[^431]: GitHub, nvme-cli <https://github.com/linux-nvme/nvme-cli> <sup>[[Archive.org]][1236]</sup>

[^432]: PartedMagic Secure Erase, <https://partedmagic.com/secure-erase/> <sup>[[Archive.org]][1237]</sup>

[^433]: Partedmagic NVMe Secure Erase, <https://partedmagic.com/nvme-secure-erase/> <sup>[[Archive.org]][1238]</sup>

[^434]: UFSExplorer, Can I recover data from an encrypted storage? <https://www.ufsexplorer.com/solutions/data-recovery-on-encrypted-storage.php> <sup>[[Archive.org]][1239]</sup>

[^435]: Apple Developer Documentation, <https://developer.apple.com/library/archive/documentation/FileManagement/Conceptual/APFS_Guide/FAQ/FAQ.html> <sup>[[Archive.org]][1240]</sup>

[^436]: EFF, How to: Delete Your Data Securely on macOS <https://ssd.eff.org/en/module/how-delete-your-data-securely-macos> <sup>[[Archive.org]][505]</sup>

[^437]: Privacyguides.org, Productivity tools <https://privacyguides.org/software/productivity/> <sup>[[Archive.org]][1241]</sup>

[^438]: Whonix Documentation, Scrubbing Metadata <https://www.whonix.org/wiki/Metadata> <sup>[[Archive.org]][1242]</sup>

[^439]: Tails documentation, MAT <https://gitlab.tails.boum.org/tails/blueprints/-/wikis/doc/mat/> <sup>[[Archive.org]][1243]</sup>

[^440]: GitHub, Disable Gatekeeper on macOS Big Sur (11.x) <https://disable-gatekeeper.github.io/> <sup>[[Archive.org]][1244]</sup>

[^441]: DuckDuckGo help, Cache <https://help.duckduckgo.com/duckduckgo-help-pages/features/cache/> <sup>[[Archive.org]][1245]</sup>

[^442]: DuckDuckGo help, Sources <https://help.duckduckgo.com/duckduckgo-help-pages/results/sources/> <sup>[[Archive.org]][1246]</sup>

[^443]: Wikipedia, Dead Drop <https://en.wikipedia.org/wiki/Dead_drop> <sup>[[Wikiless]][1247]</sup> <sup>[[Archive.org]][1248]</sup>

[^444]: Wikipedia, Secure Communication Obfuscation <https://en.wikipedia.org/wiki/Obfuscation#Secure_communication> <sup>[[Wikiless]][1249]</sup> <sup>[[Archive.org]][1250]</sup>

[^445]: Wikipedia, Steganography <https://en.wikipedia.org/wiki/Steganography> <sup>[[Wikiless]][1007]</sup> <sup>[[Archive.org]][1008]</sup>

[^446]: Wikipedia, Kleptography <https://en.wikipedia.org/wiki/Kleptography> <sup>[[Wikiless]][1251]</sup> <sup>[[Archive.org]][1252]</sup>

[^447]: Wikipedia, Koalang <https://en.wikipedia.org/wiki/Koalang> <sup>[[Wikiless]][1253]</sup> <sup>[[Archive.org]][1254]</sup>

[^448]: Wikipedia, OPSEC <https://en.wikipedia.org/wiki/Operations_security> <sup>[[Wikiless]][1255]</sup> <sup>[[Archive.org]][1256]</sup>

[^449]: Quote Investigator, A Lie Can Travel Halfway Around the World While the Truth Is Putting On Its Shoes <https://quoteinvestigator.com/2014/07/13/truth/> <sup>[[Archive.org]][1257]</sup>

[^450]: Privacyguides.org, Operating Systems <https://privacyguides.org/operating-systems/> <sup>[[Archive.org]][1258]</sup>

[^451]: Brave Support, What is a Private Window with Tor? <https://support.brave.com/hc/en-us/articles/360018121491-What-is-a-Private-Window-with-Tor-> <sup>[[Archive.org]][1259]</sup>

[^452]: Medium.com, The Windows USN Journal <https://medium.com/velociraptor-ir/the-windows-usn-journal-f0c55c9010e> <sup>[[Archive.org]][1260]</sup>

[^453]: Medium.com, Digging into the System Resource Usage Monitor (SRUM) <https://medium.com/velociraptor-ir/digging-into-the-system-resource-usage-monitor-srum-afbadb1a375> <sup>[[Archive.org]][1261]</sup>

[^454]: SANS, Timestamped Registry & NTFS Artifacts from Unallocated Space <https://www.sans.org/blog/timestamped-registry-ntfs-artifacts-from-unallocated-space/> <sup>[[Archive.org]][1262]</sup>

[^455]: DBAN, <https://dban.org/> <sup>[[Archive.org]][1263]</sup>

[^456]: NYTimes, Lost Passwords Lock Millionaires Out of Their Bitcoin Fortunes <https://www.nytimes.com/2021/01/12/technology/bitcoin-passwords-wallets-fortunes.html> <sup>[[Archive.org]][1087]</sup>

[^457]: CrystalDiskInfo <https://crystalmark.info/en/software/crystaldiskinfo/> <sup>[[Archive.org]][1264]</sup>

[^458]: Wikipedia, Faraday Cage, <https://en.wikipedia.org/wiki/Faraday_cage> <sup>[[Wikiless]][1265]</sup> <sup>[[Archive.org]][1266]</sup>

[^459]: Edith Cowan University, A forensic examination of several mobile device Faraday bags & materials to test their effectiveness materials to test their effectiveness <https://ro.ecu.edu.au/cgi/viewcontent.cgi?article=1165&context=adf> <sup>[[Archive.org]][1267]</sup>

[^460]: arXiv, Deep-Spying: Spying using Smartwatch and Deep Learning <https://arxiv.org/abs/1512.05616> <sup>[[Archive.org]][1268]</sup>

[^461]: Acm.org, Privacy Implications of Accelerometer Data: A Review of Possible Inferences <https://dl.acm.org/doi/pdf/10.1145/3309074.3309076> <sup>[[Archive.org]][1269]</sup>

[^462]: YouTube, Fingerprinting Paper - Forensic Education <https://www.youtube.com/watch?v=sO98kDLkh-M> <sup>[[Invidious]][1270]</sup>

[^463]: Wikipedia, Touch DNA, <https://en.wikipedia.org/wiki/Touch_DNA> <sup>[[Wikiless]][1271]</sup> <sup>[[Archive.org]][1272]</sup>

[^464]: TheDNAGuide, DNA from Postage Stamps or Hair Samples? Yeeesssss..... <https://www.yourdnaguide.com/ydgblog/dna-hair-samples-postage-stamps> <sup>[[Archive.org]][1273]</sup>

[^465]: GitHub, Mhinkie, OONI-Detection <https://github.com/mhinkie/ooni-detection> <sup>[[Archive.org]][1274]</sup>

[^466]: Wikipedia, File Verification <https://en.wikipedia.org/wiki/File_verification> <sup>[[Wikiless]][1275]</sup> <sup>[[Archive.org]][1276]</sup>

[^467]: Wikipedia, CRC <https://en.wikipedia.org/wiki/Cyclic_redundancy_check> <sup>[[Wikiless]][1277]</sup> <sup>[[Archive.org]][1278]</sup>

[^468]: Wikipedia, MD5 <https://en.wikipedia.org/wiki/MD5> <sup>[[Wikiless]][1279]</sup> <sup>[[Archive.org]][1280]</sup>

[^469]: Wikipedia, MD5 Security <https://en.wikipedia.org/wiki/MD5#Security> <sup>[[Wikiless]][1279]</sup> <sup>[[Archive.org]][1280]</sup>

[^470]: Wikipedia, Collisions <https://en.wikipedia.org/wiki/Collision_(computer_science)> <sup>[[Wikiless]][1281]</sup> <sup>[[Archive.org]][1282]</sup>

[^471]: Wikipedia, SHA <https://en.wikipedia.org/wiki/Secure_Hash_Algorithms> <sup>[[Wikiless]][1283]</sup> <sup>[[Archive.org]][1284]</sup>

[^472]: Wikipedia, SHA-2 <https://en.wikipedia.org/wiki/SHA-2> <sup>[[Wikiless]][1285]</sup> <sup>[[Archive.org]][1286]</sup>

[^473]: Wikipedia, Collision Resistance <https://en.wikipedia.org/wiki/Collision_resistance> <sup>[[Wikiless]][1287]</sup> <sup>[[Archive.org]][1288]</sup>

[^474]: GnuPG Gpg4win Wiki, Check integrity of Gpg4win packages <https://wiki.gnupg.org/Gpg4win/CheckIntegrity> <sup>[[Archive.org]][1289]</sup>

[^475]: Medium.com, How to verify checksum on Mac <https://medium.com/@EvgeniIvanov/how-to-verify-checksum-on-mac-988f166b0c4f> <sup>[[Archive.org]][1290]</sup>

[^476]: Wikipedia, GPG <https://en.wikipedia.org/wiki/GNU_Privacy_Guard> <sup>[[Wikiless]][1291]</sup> <sup>[[Archive.org]][1292]</sup>

[^477]: Wikipedia, Public-Key Cryptography <https://en.wikipedia.org/wiki/Public-key_cryptography> <sup>[[Wikiless]][1293]</sup> <sup>[[Archive.org]][1294]</sup>

[^478]: Wikipedia, Polymorphic Code <https://en.wikipedia.org/wiki/Polymorphic_code> <sup>[[Wikiless]][1295]</sup> <sup>[[Archive.org]][1296]</sup>

[^479]: Whonix Documentation, Use of AV, <https://www.whonix.org/wiki/Malware_and_Firmware_Trojans#The_Utility_of_Antivirus_Tools> <sup>[[Archive.org]][1297]</sup>

[^480]: Whonix Forums, <https://forums.whonix.org/t/installation-of-antivirus-scanners-by-default/9755/8> <sup>[[Archive.org]][1298]</sup>

[^481]: AV-Test Security Report 2018-2019, <https://www.av-test.org/fileadmin/pdf/security_report/AV-TEST_Security_Report_2018-2019.pdf> <sup>[[Archive.org]][1299]</sup>

[^482]: ZDNet, ESET discovers 21 new Linux malware families <https://www.zdnet.com/article/eset-discovers-21-new-linux-malware-families/> <sup>[[Archive.org]][1300]</sup>

[^483]: NakeSecurity, EvilGnome -- Linux malware aimed at your desktop, not your servers <https://nakedsecurity.sophos.com/2019/07/25/evilgnome-linux-malware-aimed-at-your-laptop-not-your-servers/> <sup>[[Archive.org]][1301]</sup>

[^484]: Immunify, HiddenWasp: How to detect malware hidden on Linux & IoT <https://blog.imunify360.com/hiddenwasp-how-to-detect-malware-hidden-on-linux-iot> <sup>[[Archive.org]][1302]</sup>

[^485]: Wikipedia, Linux Malware <https://en.wikipedia.org/wiki/Linux_malware> <sup>[[Wikiless]][1303]</sup> <sup>[[Archive.org]][1304]</sup>

[^486]: Wikipedia, macOS Malware [https://en.wikipedia.org/wiki/macOS_malware][] <sup>[[Wikiless]][1305]</sup> <sup>[[Archive.org]][1306]</sup>

[^487]: MacWorld, List of Mac viruses, malware and security flaws <https://www.macworld.co.uk/feature/mac-viruses-list-3668354/> <sup>[[Archive.org]][1307]</sup>

[^488]: JAMF, The Mac Malware of 2020 <https://resources.jamf.com/documents/macmalware-2020.pdf> <sup>[[Archive.org]][1308]</sup>

[^489]: macOS Security and Privacy Guide, <https://github.com/drduh/macOS-Security-and-Privacy-Guide#viruses-and-malware> <sup>[[Archive.org]][295]</sup>

[^490]: ImageTragick.com, <https://imagetragick.com/> <sup>[[Archive.org]][1309]</sup>

[^491]: Oracle Virtualbox Documentation, <https://docs.oracle.com/en/virtualization/virtualbox/6.0/admin/hyperv-support.html> <sup>[[Archive.org]][1310]</sup>

[^492]: Oracle Virtualbox Documentation, <https://docs.oracle.com/en/virtualization/virtualbox/6.0/admin/hyperv-support.html> <sup>[[Archive.org]][1310]</sup>

[^493]: Lenny Zeltser, Analyzing Malicious Documents Cheat Sheet <https://zeltser.com/analyzing-malicious-documents/> <sup>[[Archive.org]][1311]</sup>

[^494]: Wikipedia, Portable Applications <https://en.wikipedia.org/wiki/Portable_application> <sup>[[Wikiless]][1312]</sup> <sup>[[Archive.org]][1313]</sup>

[^495]: Brave Help, What is a Private Window with Tor Connectivity? <https://support.brave.com/hc/en-us/articles/360018121491-What-is-a-Private-Window-with-Tor-> <sup>[[Archive.org]][1259]</sup>

[^496]: BlackGNU, <https://ebin.city/~werwolf/posts/brave-is-shit/> <sup>[[Archive.org]][1314]</sup>

[^497]: Brave Help Center, <https://support.brave.com/hc/en-us/articles/360022973471-What-is-Shields> <sup>[[Archive.org]][1315]</sup>

[^498]: VentureBeat, Browser benchmark battle January 2020: Chrome vs. Firefox vs. Edge vs. Brave <https://venturebeat.com/2020/01/15/browser-benchmark-battle-january-2020-chrome-firefox-edge-brave/view-all/> <sup>[[Archive.org]][1316]</sup>

[^499]: Brave.com, Brave, Fingerprinting, and Privacy Budgets <https://brave.com/brave-fingerprinting-and-privacy-budgets/> <sup>[[Archive.org]][154]</sup>

[^500]: Madaidan Insecurities, Firefox and Chromium <https://madaidans-insecurities.github.io/firefox-chromium.html> <sup>[[Archive.org]][1317]</sup>

[^501]: GrapheneOS, Web Browsing <https://grapheneos.org/usage#web-browsing> <sup>[[Archive.org]][1318]</sup>

[^502]: ResearchGate, Web Browser Privacy: What Do Browsers Say When They Phone Home? <https://www.researchgate.net/publication/349979628_Web_Browser_Privacy_What_Do_Browsers_Say_When_They_Phone_Home> <sup>[[Archive.org]][1319]</sup>

[^503]: Madaidan Insecurities, Firefox and Chromium <https://madaidans-insecurities.github.io/firefox-chromium.html> <sup>[[Archive.org]][1317]</sup>

[^504]: GrapheneOS, Web Browsing <https://grapheneos.org/usage#web-browsing> <sup>[[Archive.org]][1318]</sup>

[^505]: Microsoft.com, Microsoft Edge support for Microsoft Defender Application Guard <https://docs.microsoft.com/en-us/deployedge/microsoft-edge-security-windows-defender-application-guard> <sup>[[Archive.org]][1320]</sup>

[^506]: PcMag, Mozilla Signs Lucrative 3-Year Google Search Deal for Firefox <https://www.pcmag.com/news/mozilla-signs-lucrative-3-year-google-search-deal-for-firefox> <sup>[[Archive.org]][1321]</sup>

[^507]: Madaidan Insecurities, Firefox and Chromium <https://madaidans-insecurities.github.io/firefox-chromium.html> <sup>[[Archive.org]][1317]</sup>

[^508]: Wikipedia, Virtualization <https://en.wikipedia.org/wiki/Virtualization> <sup>[[Wikiless]][1322]</sup> <sup>[[Archive.org]][1323]</sup>

[^509]: Tor Project, Project Snowflake <https://snowflake.torproject.org/> <sup>[[Archive.org]][559]</sup>

[^510]: GitHub, Obfs4 Repository <https://github.com/Yawning/obfs4/> <sup>[[Archive.org]][1324]</sup>

[^511]: Tor Browser Manual, Pluggable Transport <https://tb-manual.torproject.org/circumvention/> <sup>[[Archive.org]][1325]</sup>

[^512]: Tor Browser Manual, Pluggable Transport <https://tb-manual.torproject.org/circumvention/> <sup>[[Archive.org]][1325]</sup>

[^513]: Wikipedia, Domain Fronting <https://en.wikipedia.org/wiki/Domain_fronting> <sup>[[Wikiless]][1326]</sup> <sup>[[Archive.org]][1327]</sup>

[^514]: GitLab, Tor Browser Issues, Add uBlock Origin to the Tor Browser <https://gitlab.torproject.org/tpo/applications/tor-browser/-/issues/17569> <sup>[[Archive.org]][1328]</sup>

[^515]: Vice, The NSA and CIA Use Ad Blockers Because Online Advertising Is So Dangerous <https://www.vice.com/en/article/93ypke/the-nsa-and-cia-use-ad-blockers-because-online-advertising-is-so-dangerous> <sup>[[Archive.org]][1329]</sup>

[^516]: Europol Wasabi Wallet Report, <https://www.tbstat.com/wp/uploads/2020/06/Europol-Wasabi-Wallet-Report.pdf> <sup>[[Archive.org]][1330]</sup>

[^517]: NIST, <https://www.sans.org/blog/nist-has-spoken-death-to-complexity-long-live-the-passphrase/> <sup>[[Archive.org]][1331]</sup>

[^518]: ZDnet, FBI recommends passphrases over password complexity <https://www.zdnet.com/article/fbi-recommends-passphrases-over-password-complexity/> <sup>[[Archive.org]][1332]</sup>

[^519]: The Intercept, Passphrases That You Can Memorize --- But That Even the NSA Can't Guess <https://theintercept.com/2015/03/26/passphrases-can-memorize-attackers-cant-guess/> <sup>[[Tor Mirror]][1333]</sup> <sup>[[Archive.org]][1334]</sup>

[^520]: ProtonMail Blog, Let's settle the password vs. passphrase debate once and for all <https://protonmail.com/blog/protonmail-com-blog-password-vs-passphrase/> <sup>[[Archive.org]][1335]</sup>

[^521]: YouTube, Edward Snowden on Passwords: Last Week Tonight with John Oliver (HBO) <https://www.youtube.com/watch?v=yzGzB-yYKcc> <sup>[[Invidious]][1336]</sup>

[^522]: YouTube, How to Choose a Password -- Computerphile <https://www.youtube.com/watch?v=3NjQ9b3pgIg> <sup>[[Invidious]][694]</sup>

[^523]: Wikipedia, Passphrase <https://en.wikipedia.org/wiki/Passphrase#Passphrase_selection> <sup>[[Wikiless]][1337]</sup> <sup>[[Archive.org]][1338]</sup>

[^524]: Monero Research Lab, Evaluating cryptocurrency security and privacy in a post-quantum world <https://github.com/insight-decentralized-consensus-lab/post-quantum-monero/blob/master/writeups/technical_note.pdf> <sup>[[Archive.org]][1339]</sup>
  ...
  [Ubuntu 20.04 VM:]: #ubuntu-20.04-vm
  ...
  [33]: https://wikiless.org/wiki/Sci-Hub
  [34]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Sci-Hub
  [35]: https://wikiless.org/wiki/Library_Genesis
  [36]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Library_Genesis
  [Your Network: 12]: #_Toc85400096
  [37]: media/image1.jpeg 
  [38]: media/image2.jpeg
  [39]: media/image3.jpeg 
  [40]: https://web.archive.org/web/https://ssd.eff.org/en/module-categories/security-scenarios
  [41]: https://web.archive.org/web/https://thenewoil.org/
  [42]: https://yewtu.be/c/Techlore
  [43]: https://web.archive.org/web/https://privacyguides.org/
  [44]: https://web.archive.org/web/https://github.com/techlore-official/go-incognito
  [45]: https://yewtu.be/playlist?list=PL3KeV6Ui_4CayDGHw64OFXEPHgXLkrtJO
  [46]: https://yewtu.be/watch?v=vrxwXXytEuI
  [47]: https://web.archive.org/web/https://www.cloudflare.com/ssl/encrypted-sni/
  [48]: media/image4.jpeg 
  [49]: https://web.archive.org/web/https://www.ssl.com/blogs/how-do-browsers-handle-revoked-ssl-tls-certificates/
  [50]: media/image5.jpeg 
  [51]: https://web.archive.org/web/https://blog.cloudflare.com/welcome-hidden-resolver/
  [52]: https://web.archive.org/web/https://blog.cloudflare.com/oblivious-dns/
  [53]: https://web.archive.org/web/https://github.com/alecmuffett/dohot
  [54]: media/image6.jpeg 
  [55]: https://web.archive.org/web/https://blog.apnic.net/2019/08/23/what-can-you-learn-from-an-ip-address/
  [56]: https://wikiless.org/wiki/Radio-frequency_identification
  [57]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Radio-frequency_identification
  [58]: https://web.archive.org/web/http://rfpose.csail.mit.edu/
  [59]: https://yewtu.be/watch?v=HgDdaMy8KNE
  [60]: https://web.archive.org/web/https://www.news.ucsb.edu/2021/020392/dont-fidget-wifi-will-count-you
  [61]: media/image7.jpeg 
  [62]: https://yewtu.be/watch?v=FDZ39h-kCS8
  [63]: https://yewtu.be/watch?v=7v3JR4Wlw4Q
  [64]: https://web.archive.org/web/https://blog.torproject.org/new-low-cost-traffic-analysis-attacks-mitigations
  [65]: media/image8.jpeg 
  [66]: media/image9.jpeg 
  [67]: media/image10.jpeg 
  [68]: https://web.archive.org/web/https://github.com/Attacks-on-Tor/Attacks-on-Tor
  [69]: https://web.archive.org/web/https://www.researchgate.net/publication/323627387_Shedding_Light_on_the_Dark_Corners_of_the_Internet_A_Survey_of_Tor_Research
  [70]: https://web.archive.org/web/https://www.hackerfactor.com/blog/index.php?/archives/906-Tor-0day-The-Management-Vulnerability.html
  [71]: https://web.archive.org/web/https://svn-archive.torproject.org/svn/projects/design-paper/tor-design.pdf
  [72]: https://yewtu.be/watch?v=siCk4pGGcqA
  [73]: https://yewtu.be/watch?v=mYsTBPqbya8
  [74]: https://yewtu.be/watch?v=bKH5nGLgi08&t=2834s
  [75]: https://wikiless.org/wiki/Transient_execution_CPU_vulnerability
  [76]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Transient_execution_CPU_vulnerability
  [77]: https://web.archive.org/web/https://github.com/speed47/spectre-meltdown-checker
  [78]: https://web.archive.org/web/https://www.grc.com/inspectre.htm
  [79]: https://web.archive.org/web/https://www.whonix.org/wiki/Spectre_Meltdown
  [80]: https://web.archive.org/web/https://policies.google.com/privacy
  [81]: https://web.archive.org/web/https://www.scss.tcd.ie/doug.leith/apple_google.pdf
  [82]: https://web.archive.org/web/https://www.apple.com/legal/privacy/en-ww/
  [83]: https://web.archive.org/web/https://support.apple.com/en-us/HT202100
  [84]: https://web.archive.org/web/https://docs.microsoft.com/en-us/windows/privacy/required-windows-diagnostic-data-events-and-fields-2004
  [85]: https://web.archive.org/web/https://docs.microsoft.com/en-us/windows/privacy/windows-diagnostic-data
  [86]: https://web.archive.org/web/https://support.apple.com/guide/mac-help/share-analytics-information-mac-apple-mh27990/mac
  [87]: https://web.archive.org/web/https://ubuntu.com/desktop/statistics
  [88]: https://web.archive.org/web/https://twitter.com/idf/status/1125066395010699264
  [89]: https://nitter.net/idf/status/1125066395010699264
  [90]: https://web.archive.org/web/https://mediasonar.com/
  [91]: https://web.archive.org/web/https://www.typingdna.com/
  [92]: https://web.archive.org/web/https://link.springer.com/10.1007/978-1-4614-7163-9_110198-1
  [93]: https://web.archive.org/web/https://www.sciencedirect.com/science/article/pii/S1877042811013747/pdf?md5=253d8f1bb615d5dee195d353dc077d46&pid=1-s2.0-S1877042811013747-main.pdf
  [94]: https://web.archive.org/web/https://www.researchgate.net/publication/300562034_Using_Social_Networks_Data_for_Behavior_and_Sentiment_Analysis
  [95]: https://web.archive.org/web/https://www.academia.edu/30936118/A_Survey_on_User_Behaviour_Analysis_in_Social_Networks
  [96]: https://web.archive.org/web/https://web.archive.org/web/https://sci-hub.se/10.1007/978-3-030-02592-2
  [97]: https://web.archive.org/web/https://docs.google.com/spreadsheets/d/18rtqh8EG2q1xBo2cLNyhIDuK9jrPGwYr9DI2UncoqJQ/edit
  [98]: https://web.archive.org/web/https://github.com/jivoi/awesome-osint
  [99]: https://yewtu.be/playlist?list=PLrFPX1Vfqk3ehZKSFeb9pVIHqxqrNW8Sy
  [100]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2019/12/26/guide-to-using-reverse-image-search-for-investigations/
  [101]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2019/02/19/using-the-new-russian-facial-recognition-site-searchface-ru/
  [102]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2018/10/24/dali-warhol-boshirov-determining-time-alleged-photograph-skripal-suspect-chepiga/
  [103]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2017/06/30/advanced-guide-verifying-video-content/
  [104]: https://web.archive.org/web/https://www.bellingcat.com/resources/2020/12/03/using-the-sun-and-the-shadows-for-geolocation/
  [105]: https://web.archive.org/web/https://www.bellingcat.com/news/uk-and-europe/2021/01/27/navalny-poison-squad-implicated-in-murders-of-three-russian-activists/
  [106]: https://web.archive.org/web/https://www.bellingcat.com/news/2021/03/19/berlin-assassination-new-evidence-on-suspected-fsb-hitman-passed-to-german-investigators/
  [107]: https://yewtu.be/watch?v=cAVZaPiVArA
  [108]: https://yewtu.be/watch?v=awY87q2Mr0E
  [109]: https://yewtu.be/watch?v=bS6gYWM4kzY
  [110]: media/image11.jpeg 
  [111]: https://web.archive.org/web/https://www.nature.com/articles/s41598-020-79310-1
  [112]: media/image12.jpeg 
  [113]: https://web.archive.org/web/https://rd.springer.com/chapter/10.1007/978-3-030-42504-3_15
  [114]: https://web.archive.org/web/https://media.ccc.de/v/rc3-11406-spot_the_surveillance
  [115]: https://web.archive.org/web/https://www.eff.org/sls
  [116]: https://web.archive.org/web/https://www.respeecher.com/
  [117]: https://web.archive.org/web/https://www.descript.com/overdub
  [118]: https://yewtu.be/watch?v=t5yw5cR79VA
  [119]: https://web.archive.org/web/https://www.reflectacles.com/
  [120]: https://web.archive.org/web/https://gitlab.com/FG-01/fg-01
  [121]: https://wikiless.org/wiki/Advance-fee_scam
  [122]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Advance-fee_scam
  [123]: https://yewtu.be/watch?v=Z20XNp-luNA
  [124]: https://yewtu.be/watch?v=VVdmmN0su6E
  [125]: https://yewtu.be/watch?v=hdCs6bPM4is
  [126]: https://web.archive.org/web/https://shop.hak5.org/products/usb-rubber-ducky-deluxe
  [127]: https://yewtu.be/watch?v=V5mBJHotZv0
  [128]: https://web.archive.org/web/https://www.keelog.com/
  [129]: https://web.archive.org/web/https://www.aliexpress.com/i/4000710369016.html
  [130]: media/image13.jpeg 
  [131]: https://web.archive.org/web/https://mattw.io/youtube-geofind/location
  [132]: https://27m3p2uv7igmj6kvd4ql3cct5h3sdwrsajovkkndeufumzyfhlfev4qd.onion/2021/01/18/leak-zoom-meeting/
  [133]: https://web.archive.org/web/https://theintercept.com/2021/01/18/leak-zoom-meeting/
  [134]: https://web.archive.org/web/https://www.eff.org/issues/printers
  [135]: https://yewtu.be/watch?v=izMGMsIZK4U
  [136]: https://web.archive.org/web/https://www.eff.org/pages/list-printers-which-do-or-do-not-display-tracking-dots
  [137]: https://web.archive.org/web/https://www.whonix.org/wiki/Printing_and_Scanning
  [138]: https://web.archive.org/web/https://github.com/beurtschipper/Depix
  [139]: media/image14.jpeg
  [140]: https://web.archive.org/web/https://medium.com/@somdevsangwan/unblurring-images-for-osint-and-more-part-1-5ee36db6a70b
  [141]: https://web.archive.org/web/https://medium.com/@somdevsangwan/deblurring-images-for-osint-part-2-ba564af8eb5d
  [142]: media/image15.jpeg 
  [143]: https://web.archive.org/web/https://github.com/subeeshvasu/Awesome-Deblurring
  [144]: https://web.archive.org/web/https://www.myheritage.com/photo-enhancer
  [145]: media/image16.jpeg 
  [146]: https://web.archive.org/web/https://bitcoin.org/en/you-need-to-know
  [147]: https://web.archive.org/web/https://bitcoin.org/en/protect-your-privacy
  [148]: https://web.archive.org/web/https://support.apple.com/en-us/HT202303
  [149]: https://web.archive.org/web/https://faq.whatsapp.com/android/chats/about-google-drive-backups/
  [150]: https://web.archive.org/web/https://about.fb.com/news/2021/10/end-to-end-encrypted-backups-on-whatsapp/
  [151]: https://web.archive.org/web/https://www.dropbox.com/privacy
  [152]: https://web.archive.org/web/https://privacy.microsoft.com/en-us/privacystatement
  [153]: https://web.archive.org/web/https://amiunique.org/links
  [154]: https://web.archive.org/web/https://brave.com/brave-fingerprinting-and-privacy-budgets/
  [155]: https://web.archive.org/web/https://palant.info/2020/12/10/how-anti-fingerprinting-extensions-tend-to-make-fingerprinting-easier/
  [156]: https://web.archive.org/web/https://www.upturn.org/reports/2020/mass-extraction/
  [157]: https://web.archive.org/web/https://www.nytimes.com/2020/10/21/technology/iphone-encryption-police.html
  [158]: https://web.archive.org/web/https://www.vice.com/en/article/vbxxxd/unlock-iphone-ios11-graykey-grayshift-police
  [159]: https://web.archive.org/web/http://encase-docs.opentext.com/documentation/encase/forensic/8.07/Content/Resources/External%20Files/EnCase%20Forensic%20v8.07%20User%20Guide.pdf
  [160]: https://web.archive.org/web/https://accessdata.com/products-services/forensic-toolkit-ftk
  [161]: https://web.archive.org/web/https://latacora.micro.blog/2018/04/03/cryptographic-right-answers.html
  [162]: https://web.archive.org/web/https://jedisct1.github.io/minisign/
  [163]: https://web.archive.org/web/https://democratic-europe.eu/2021/07/20/cryptographers-uncover-four-vulnerabilities-in-telegram/
  [164]: https://web.archive.org/web/https://buttondown.email/cryptography-dispatches/archive/cryptography-dispatches-the-most-backdoor-looking/
  [165]: https://web.archive.org/web/https://www.cryptofails.com/
  [166]: media/image17.jpeg 
  [167]: https://web.archive.org/web/https://cyber.bgu.ac.il/advanced-cyber/airgap
  [168]: https://yewtu.be/watch?v=mSNt4h7EDKo
  [169]: https://yewtu.be/watch?v=1kBGDHVr7x0
  [170]: https://yewtu.be/watch?v=om5fNqKjj2M
  [171]: https://yewtu.be/watch?v=auoYKSzdOj4
  [172]: https://yewtu.be/watch?v=v2_sZIfZkDQ
  [173]: https://yewtu.be/watch?v=4vIu8ld68fc
  [174]: https://yewtu.be/watch?v=E28V1t-k8Hk
  [175]: https://yewtu.be/watch?v=H7lQXmSLiP8
  [176]: https://yewtu.be/watch?v=RChj7Mg3rC4
  [177]: https://yewtu.be/watch?v=2OzTWiGl1rM&t=20s
  [178]: https://yewtu.be/watch?v=yz8E5n1Tzlo
  [179]: https://yewtu.be/watch?v=2WtiHZNeveY
  [180]: https://yewtu.be/watch?v=ZrkZUO2g4DE
  [181]: https://yewtu.be/watch?v=XGD343nq1dg
  [182]: https://yewtu.be/watch?v=vhNnc0ln63c
  [183]: https://web.archive.org/web/https://arxiv.org/abs/1804.04014
  [184]: https://web.archive.org/web/http://wallcamera.csail.mit.edu/
  [185]: https://web.archive.org/web/https://arxiv.org/abs/2001.04642
  [186]: https://web.archive.org/web/https://engineering.cmu.edu/news-events/news/2020/02/17-mauraders-map.html
  [187]: https://yewtu.be/watch?v=t32QvpfOHqw
  [188]: https://web.archive.org/web/http://www.gcomtech.com/ccp0-prodshow/laser-surveillance-laser-listening.html
  ...
  [219]: https://web.archive.org/web/https://www.usenix.org/system/files/sec21-hoang.pdf
  [220]: https://web.archive.org/web/https://therecord.media/malware-found-preinstalled-in-classic-push-button-phones-sold-in-russia/
  [221]: https://web.archive.org/web/https://prepaid-data-sim-card.fandom.com/wiki/Registration_Policies_Per_Country
  [222]: http://cryptonx6nsmspsnpicuihgmbbz3qvro4na35od3eht4vojdo7glm6yd.onion
  [223]: https://web.archive.org/web/https://crypton.sh/
  [224]: https://web.archive.org/web/https://virtualsim.net/
  [225]: https://web.archive.org/web/https://mobilesms.io/
  [226]: https://web.archive.org/web/https://www.sms77.io/
  [227]: https://web.archive.org/web/https://onlinesim.ru/
  [228]: https://web.archive.org/web/http://smspool.net/
  [229]: https://web.archive.org/web/https://smspva.com/
  [230]: https://web.archive.org/web/https://cryptwerk.com/companies/sms/xmr/
  [231]: https://web.archive.org/web/https://syscall.eu/blog/2018/03/12/aigo_part1/
  [232]: https://web.archive.org/web/https://www.torproject.org/
  [233]: https://yewtu.be/watch?v=JWII85UlzKw
  [234]: https://web.archive.org/web/https://2019.www.torproject.org/about/overview.html.en
  [235]: https://web.archive.org/web/https://support.torproject.org/tormobile/tormobile-7/
  [236]: https://web.archive.org/web/https://tb-manual.torproject.org/security-settings/
  [237]: https://web.archive.org/web/https://tails.boum.org/doc/about/warnings/index.en.html
  [238]: https://web.archive.org/web/https://tails.boum.org/install/index.en.html
  [239]: https://web.archive.org/web/https://tails.boum.org/doc/anonymous_internet/tor/index.en.html
  [240]: https://web.archive.org/web/https://2019.www.torproject.org/docs/bridges
  [241]: https://web.archive.org/web/https://github.com/aforensics/HiddenVM
  [242]: media/image19.jpeg 
  [Tor over VPN]: #tor-over-vpn
  [243]: https://web.archive.org/web/https://www.whonix.org/wiki/Whonix-Host
  [244]: https://web.archive.org/web/https://defuse.ca/truecrypt-plausible-deniability-useless-by-game-theory.htm
  [245]: https://wikiless.org/wiki/Rubber-hose_cryptanalysis
  [246]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Rubber-hose_cryptanalysis
  [247]: https://web.archive.org/web/https://github.com/aforensics/HiddenVM/releases
  [248]: https://web.archive.org/web/https://www.whonix.org/wiki/VirtualBox/XFCE
  [249]: https://web.archive.org/web/https://puri.sm/
  [250]: https://web.archive.org/web/https://system76.com/
  [251]: https://web.archive.org/web/https://freundschafter.com/research/system-alternatives-without-intel-me-iamt-and-amd-psp-secure-technology/
  [252]: https://web.archive.org/web/https://libreboot.org/docs/hardware/
  [253]: https://web.archive.org/web/https://coreboot.org/status/board-status.html
  [254]: https://web.archive.org/web/https://store.hp.com/us/en/tech-takes/how-to-enter-bios-setup-windows-pcs
  [255]: https://yewtu.be/watch?v=QDSlWa9xQuA
  [256]: https://yewtu.be/watch?v=0fZdL3ufVOI
  [257]: https://web.archive.org/web/https://support.apple.com/en-au/HT204455
  [258]: https://web.archive.org/web/https://support.apple.com/en-gb/guide/security/sec28382c9ca/web
  [259]: https://web.archive.org/web/https://mullvad.net/en/help/how-tamper-protect-laptop/
  [260]: media/image20.jpeg
  [261]: media/image21.jpeg
  [262]: https://web.archive.org/web/https://sourceforge.net/p/veracrypt/discussion/technical/thread/3961542951/
  ...
  [276]: https://web.archive.org/web/https://wiki.archlinux.org/title/Dm-crypt/Specialties#Encrypted_system_using_a_detached_LUKS_header
  [277]: https://web.archive.org/web/https://vitux.com/how-to-force-ubuntu-to-stop-collecting-your-data-from-your-pc/
  [278]: https://web.archive.org/web/https://www.addictivetips.com/ubuntu-linux-tips/disable-bluetooth-in-ubuntu/
  [279]: https://web.archive.org/web/https://www.linuxuprising.com/2019/07/how-to-completely-disable-tracker.html
  [280]: https://web.archive.org/web/https://www.how2shout.com/linux/how-to-hibernate-ubuntu-20-04-lts-focal-fossa/
  [281]: https://web.archive.org/web/http://www.lorenzobettini.it/2020/07/enabling-hibernation-on-ubuntu-20-04/
  [282]: https://web.archive.org/web/20211011215449/https://blog.ivansmirnov.name/how-to-set-up-hibernate-on-ubuntu-20-04/
  [283]: https://web.archive.org/web/http://ubuntuhandbook.org/index.php/2020/05/lid-close-behavior-ubuntu-20-04/
  [284]: https://web.archive.org/web/https://tipsonubuntu.com/2018/04/28/change-lid-close-action-ubuntu-18-04-lts/
  [285]: https://web.archive.org/web/https://help.ubuntu.com/community/EnableHibernateWithEncryptedSwap
  [286]: https://web.archive.org/web/https://help.ubuntu.com/community/AnonymizingNetworkMACAddresses
  [287]: https://web.archive.org/web/https://josh.works/shell-script-basics-change-mac-address
  [288]: https://yewtu.be/watch?v=Sa0KqbpLye4
  [289]: https://web.archive.org/web/https://madaidans-insecurities.github.io/guides/linux-hardening.html
  [290]: https://web.archive.org/web/https://wiki.archlinux.org/title/Security
  [291]: https://web.archive.org/web/https://codeberg.org/SalamanderSecurity/PARSEC
  [292]: https://web.archive.org/web/https://www.whonix.org/wiki/Kicksecure
  [293]: https://web.archive.org/web/http://0pointer.net/blog/authenticated-boot-and-disk-encryption-on-linux.html
  [294]: https://yewtu.be/watch?v=lFx5icuE6Io
  [295]: https://web.archive.org/web/https://github.com/drduh/macOS-Security-and-Privacy-Guide
  [296]: https://web.archive.org/web/https://support.apple.com/en-us/HT204455
  [297]: https://web.archive.org/web/https://sneak.berlin/20201112/your-computer-isnt-yours/
  [298]: https://web.archive.org/web/https://blog.jacopo.io/en/post/apple-ocsp/
  [299]: https://yewtu.be/watch?v=vNRics7tlqw
  [300]: https://web.archive.org/web/https://technitium.com/tmac/
  [301]: https://web.archive.org/web/https://www.veracrypt.fr/en/Downloads.html
  ...
  [302]: https://web.archive.org/web/https://support.microsoft.com/en-us/windows/turn-on-device-encryption-0c453637-bc88-5f74-5105-741561aae838
  [303]: https://web.archive.org/web/https://docs.microsoft.com/en-us/troubleshoot/windows-client/deployment/disable-and-re-enable-hibernation
  [304]: https://web.archive.org/web/https://www.veracrypt.fr/en/VeraCrypt%20Hidden%20Operating%20System.html
  [305]: https://web.archive.org/web/https://www.veracrypt.fr/en/Security%20Requirements%20for%20Hidden%20Volumes.html
  [306]: media/image22.jpeg
  [307]: #_Appendix_C:_Windows
  [308]: https://web.archive.org/web/https://www.veracrypt.fr/en/Protection%20of%20Hidden%20Volumes.html
  [309]: https://web.archive.org/web/https://www.whonix.org/wiki/KVM
  [310]: https://web.archive.org/web/https://www.whonix.org/wiki/KVM#Why_Use_KVM_Over_VirtualBox.3F
  [311]: media/image23.jpeg 
  [312]: media/image24.jpeg 
  [313]: https://web.archive.org/web/https://gitlab.torproject.org/legacy/trac/-/wikis/org/doc/ListOfServicesBlockingTor
  [314]: media/image25.jpeg 
  [315]: media/image26.jpeg 
  [316]: https://web.archive.org/web/https://stakey.club/en/decred-via-tor-network/
  [317]: https://web.archive.org/web/https://www.whonix.org/wiki/Stream_Isolation
  [318]: https://web.archive.org/web/https://tails.boum.org/contribute/design/stream_isolation/
  [319]: https://web.archive.org/web/https://www.whonix.org/wiki/Tunnels/Introduction#Comparison_Table
  [320]: https://web.archive.org/web/https://www.whonix.org/wiki/Tunnels/Connecting_to_a_VPN_before_Tor
  [321]: https://web.archive.org/web/https://www.whonix.org/wiki/Comparison_Of_Tor_with_CGI_Proxies,_Proxy_Chains,_and_VPN_Services
  [322]: https://web.archive.org/web/https://www.whonix.org/wiki/Why_does_Whonix_use_Tor
  [323]: https://web.archive.org/web/https://www.researchgate.net/publication/324251041_Anonymity_communication_VPN_and_Tor_a_comparative_study
  [324]: https://web.archive.org/web/https://gist.github.com/joepie91/5a9909939e6ce7d09e29
  [325]: https://web.archive.org/web/https://schub.wtf/blog/2019/04/08/very-precarious-narrative.html
  [Adversaries (threats)]: #threats
  [326]: https://web.archive.org/web/https://gitlab.torproject.org/legacy/trac/-/wikis/doc/TorPlusVPN
  [327]: https://web.archive.org/web/https://gitlab.tails.boum.org/tails/blueprints/-/wikis/vpn_support/
  [328]: https://web.archive.org/web/https://tails.boum.org/support/faq/index.en.html
  [329]: https://web.archive.org/web/https://www.whonix.org/wiki/Tunnels/Introduction
  [330]: https://web.archive.org/web/https://www.whonix.org/wiki/Tunnels/Connecting_to_Tor_before_a_VPN
  [331]: media/image27.jpeg 
  [332]: media/image28.jpeg 
  [333]: https://web.archive.org/web/https://www.virtualbox.org/wiki/Downloads
  [334]: https://web.archive.org/web/https://www.whonix.org/wiki/Download
  [335]: https://web.archive.org/web/https://www.whonix.org/wiki/Virtualization_Platform_Security
  [336]: https://web.archive.org/web/https://www.whonix.org/wiki/Network_Time_Synchronization
  [337]: https://web.archive.org/web/https://www.virtualbox.org/manual/ch13.html
  [338]: https://web.archive.org/web/https://www.whonix.org/wiki/Bridges
  [339]: https://web.archive.org/web/https://www.whonix.org/wiki/Operating_System_Software_and_Updates
  [340]: https://web.archive.org/web/https://www.whonix.org/wiki/DoNot
  [341]: https://web.archive.org/web/https://www.whonix.org/wiki/Documentation
  [342]: https://web.archive.org/web/https://www.whonix.org/wiki/Install_Software
  [343]: https://web.archive.org/web/https://www.whonix.org/wiki/Anti-Forensics_Precautions
  [Virtualbox Hardening recommendations]: #virtualbox-hardening-recommendations
  [344]: https://web.archive.org/web/https://www.whonix.org/wiki/AppArmor
  [345]: https://web.archive.org/web/https://www.whonix.org/wiki/VM_Fingerprinting
  [346]: https://web.archive.org/web/https://www.whonix.org/wiki/Other_Operating_Systems
  [Hardening Linux]: #hardening-linux
  [347]: https://web.archive.org/web/https://ameliorated.info/
  ...
  [351]: https://web.archive.org/web/https://github.com/myspaghetti/macos-virtualbox
  [Hardening macOS]: #hardening-macos
  [352]: https://web.archive.org/web/https://www.whonix.org/wiki/Keepassxc
  [353]: https://web.archive.org/web/https://keepassxc.org/download/
  [354]: https://web.archive.org/web/https://keepassxc.org/docs/KeePassXC_GettingStarted.html
  ...
  [355]: media/image29.jpeg 
  [356]: media/image30.jpeg 
  [357]: media/image31.jpeg 
  [358]: https://web.archive.org/web/https://www.qubes-os.org/intro/
  [359]: https://web.archive.org/web/https://www.qubes-os.org/video-tours/
  [360]: https://web.archive.org/web/https://www.qubes-os.org/doc/getting-started/
  [361]: https://yewtu.be/watch?v=8cU4hQg6GvU
  [362]: https://yewtu.be/watch?v=sbN5Bz3v-uA
  [363]: https://yewtu.be/watch?v=YPAvoFsvSbg
  [364]: https://web.archive.org/web/https://www.qubes-os.org/hcl/
  [365]: media/image32.jpeg 
  [366]: media/image33.jpeg
  [Note about plausible deniability on Linux]: #note-about-plausible-deniability-on-linux
  [367]: https://web.archive.org/web/https://www.qubes-os.org/doc/installation-guide/
  [368]: https://web.archive.org/web/https://www.qubes-os.org/faq/
  [369]: https://web.archive.org/web/https://github.com/Qubes-Community/Contents/blob/master/docs/privacy/anonymizing-your-mac-address.md
  [370]: https://web.archive.org/web/https://www.whonix.org/wiki/Qubes/Install
  [371]: https://web.archive.org/web/https://wiki.debian.org/AppArmor
  [372]: https://web.archive.org/web/https://wiki.archlinux.org/title/AppArmor
  [373]: https://web.archive.org/web/https://www.whonix.org/wiki/Qubes/AppArmor
  [374]: https://yewtu.be/watch?v=_WOKRaM-HI4
  [375]: https://web.archive.org/web/https://docs.fedoraproject.org/en-US/quick-docs/getting-started-with-selinux/
  [376]: https://web.archive.org/web/https://github.com/Qubes-Community/Contents/blob/master/docs/configuration/vpn.md
  [377]: https://web.archive.org/web/https://check.torproject.org/
  [378]: https://web.archive.org/web/https://linuxconfig.org/how-to-create-a-vpn-killswitch-using-iptables-on-linux
  [379]: https://web.archive.org/web/https://mullvad.net/en/check/
  [380]: https://web.archive.org/web/https://www.ivpn.net/
  [381]: https://web.archive.org/web/https://protonvpn.com/support/vpn-ip-change/
  [382]: https://web.archive.org/web/https://www.whonix.org/wiki/Qubes/DisposableVM
  [383]: https://web.archive.org/web/https://brave.com/linux/
  [384]: https://web.archive.org/web/https://github.com/anbox/anbox-modules
  [385]: https://web.archive.org/web/https://github.com/anbox/anbox/blob/master/docs/install.md
  [386]: media/image34.jpeg 
  [387]: media/image35.jpeg 
  [388]: https://web.archive.org/web/https://github.com/dessant/buster
  [389]: https://web.archive.org/web/https://www.hcaptcha.com/accessibility
  [390]: https://web.archive.org/web/https://privacypass.github.io/
  [391]: http://vww6ybal4bd7szmgncyruucpgfkqahzddi37ktceo3ah7ngmcopnpyyd.onion/
  [392]: media/image36.jpeg
  [393]: media/image37.jpeg
  [394]: media/image38.jpeg
  [395]: https://web.archive.org/web/https://github.com/deepfakes/faceswap
  [396]: https://web.archive.org/web/https://github.com/iperov/DeepFaceLive
  [Online Phone Number (less recommended)]: #online-phone-number
  [397]: https://web.archive.org/web/https://thispersondoesnotexist.com/
  [398]: https://web.archive.org/web/https://github.com/NVlabs/stylegan2
  [399]: https://web.archive.org/web/https://www.myheritage.com/deep-nostalgia
  [400]: media/image39.jpeg 
  [401]: https://web.archive.org/web/https://github.com/AliaksandrSiarohin/first-order-model
  [402]: https://web.archive.org/web/https://www.d-id.com/talkingheads/
  [403]: https://yewtu.be/channel/UCqyzLOHYamYX2tNXBNSHr1w/videos
  [404]: https://web.archive.org/web/https://gendersec.tacticaltech.org/wiki/index.php/Complete_manual
  [405]: https://web.archive.org/web/https://www.bigdatacloud.com/insights/tor-exit-nodes
  [406]: https://wikiless.org/wiki/Facebook_real-name_policy_controversy
  [407]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Facebook_real-name_policy_controversy
  [408]: https://web.archive.org/web/https://slate.com/technology/2018/02/why-some-americans-are-cheering-germany-for-taking-on-facebooks-real-name-policy.html
  [409]: https://web.archive.org/web/https://www.theverge.com/2018/2/12/17005746/facebook-real-name-policy-illegal-german-court-rules
  [410]: https://web.archive.org/web/https://www.pcmag.com/news/german-court-rules-facebooks-real-name-policy-is-illegal
  [411]: https://web.archive.org/web/https://www.vzbv.de/sites/default/files/downloads/2018/02/14/18-02-12_vzbv_pm_facebook-urteil_en.pdf
  [412]: https://web.archive.org/web/https://www.reuters.com/article/us-germany-facebook/german-court-rules-facebook-use-of-personal-data-illegal-idUSKBN1FW1FI
  [413]: https://wikiless.org/wiki/Real-name_system
  [414]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Real-name_system
  [415]: https://web.archive.org/web/https://privacyguides.org
  [416]: https://web.archive.org/web/https://www.whonix.org/wiki/E-Mail#Anonymity_Friendly_Email_Provider_List
  [417]: https://web.archive.org/web/https://www.amazon.com/gp/help/customer/display.html?nodeId=202140280
  [418]: https://web.archive.org/web/https://www.apple.com/legal/internet-services/icloud/en/terms.html
  [419]: https://web.archive.org/web/https://www.binance.com/en/terms
  [420]: https://web.archive.org/web/https://briarproject.org/privacy-policy/
  [421]: https://web.archive.org/web/https://discord.com/terms
  [422]: https://web.archive.org/web/https://element.io/terms-of-service
  [423]: https://web.archive.org/web/https://www.facebook.com/terms.php
  [424]: https://web.archive.org/web/https://docs.github.com/en/free-pro-team@latest/github/site-policy/github-terms-of-service
  [425]: https://web.archive.org/web/https://about.gitlab.com/handbook/legal/subscription-agreement/
  [426]: https://web.archive.org/web/https://policies.google.com/terms
  [427]: https://web.archive.org/web/https://www.ycombinator.com/legal/
  [428]: https://web.archive.org/web/https://help.instagram.com/581066165581870?ref=dp
  [429]: https://web.archive.org/web/https://jami.net/privacy-policy/
  [430]: https://web.archive.org/web/https://www.ivpn.net/tos/
  [431]: https://web.archive.org/web/https://www.kraken.com/legal
  [432]: https://web.archive.org/web/https://www.linkedin.com/legal/user-agreement
  [433]: https://web.archive.org/web/https://policy.medium.com/medium-terms-of-service-9db0094a1e0f
  [434]: https://web.archive.org/web/https://www.microsoft.com/en/servicesagreement/
  [435]: https://web.archive.org/web/https://mullvad.net/en/help/terms-service/
  [436]: https://web.archive.org/web/https://njal.la/tos/
  [437]: https://web.archive.org/web/https://onlyfans.com/terms
  [438]: https://web.archive.org/web/https://protonmail.com/terms-and-conditions
  [439]: https://web.archive.org/web/https://protonvpn.com/terms-and-conditions
  [440]: https://web.archive.org/web/https://www.redditinc.com/policies
  [441]: https://web.archive.org/web/https://old.reddit.com/r/ShadowBan/comments/8a2gpk/an_unofficial_guide_on_how_to_avoid_being/
  [442]: https://web.archive.org/web/https://slashdotmedia.com/terms-of-use/
  [443]: https://web.archive.org/web/https://telegram.org/tos
  [444]: https://web.archive.org/web/mailto:recover@telegram.org
  [445]: https://web.archive.org/web/https://tutanota.com/terms/
  [446]: https://web.archive.org/web/https://www.twitch.tv/p/en/legal/terms-of-service/
  [447]: https://web.archive.org/web/https://www.whatsapp.com/legal/updates/terms-of-service-eea
  [448]: media/image40.jpeg
  [449]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2018/08/23/creating-android-open-source-research-device-pc/
  [450]: https://yewtu.be/watch?v=zSQtyW_ywZc
  [451]: https://wikiless.org/wiki/Comparison_of_instant_messaging_protocols
  [452]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Comparison_of_instant_messaging_protocols
  [453]: https://wikiless.org/wiki/Comparison_of_cross-platform_instant_messaging_clients
  [454]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Comparison_of_cross-platform_instant_messaging_clients
  [455]: https://web.archive.org/web/https://www.securemessagingapps.com/
  [456]: https://web.archive.org/web/https://protonmail.com/blog/whatsapp-alternatives/
  [457]: https://web.archive.org/web/https://www.whonix.org/wiki/Chat
  [458]: https://web.archive.org/web/https://securechatguide.org/featuresmatrix.html
  [459]: http://lldan5gahapx5k7iafb3s4ikijc4ni7gx5iywdflkba5y2ezyg6sjgyd.onion/
  [460]: https://web.archive.org/web/https://onionshare.org/
  [461]: https://web.archive.org/web/https://cwtch.im/
  [462]: https://web.archive.org/web/https://element.io/
  [463]: https://web.archive.org/web/https://jami.net/
  [464]: https://web.archive.org/web/https://gajim.org/
  [465]: https://web.archive.org/web/https://briarproject.org/
  [466]: https://web.archive.org/web/https://getsession.org/
  [467]: https://web.archive.org/web/https://privacyguides.org/providers/cloud-storage/
  [468]: https://web.archive.org/web/https://securedrop.org/
  [469]: https://web.archive.org/web/https://docs.securedrop.org/en/stable/source.html
  [470]: https://web.archive.org/web/https://github.com/alecmuffett/real-world-onion-sites#securedrop
  [471]: https://web.archive.org/web/https://haveibeenpwned.com/
  [472]: https://web.archive.org/web/https://www.veracrypt.fr/en/Beginner%27s%20Tutorial.html
  [473]: https://web.archive.org/web/https://www.qubes-os.org/doc/backup-restore/
  [474]: https://web.archive.org/web/https://support.apple.com/en-ie/guide/mac-help/mh21241/mac
  [475]: https://web.archive.org/web/https://support.apple.com/en-ie/guide/mac-help/mh11421/11.0/mac/11.0
  [476]: https://web.archive.org/web/https://support.apple.com/en-ie/guide/disk-utility/dskutl1010/mac
  [477]: https://web.archive.org/web/https://privacyguides.org/providers/paste/
  [478]: https://web.archive.org/web/https://syncthing.net/
  [479]: media/image41.jpeg
  [480]: media/image42.jpeg
  [481]: media/image43.jpeg
  [482]: https://wikiless.org/wiki/Trim_(computing)
  [483]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Trim_(computing)
  [484]: media/image44.jpeg
  [485]: https://yewtu.be/watch?v=-bpX8YvNg6Y
  [486]: https://web.archive.org/web/https://wiki.archlinux.org/index.php/Solid_state_drive
  [487]: https://web.archive.org/web/https://www.bleachbit.org/download/linux
  [488]: https://web.archive.org/web/https://superuser.com/questions/19326/how-to-wipe-free-disk-space-in-linux
  [489]: https://web.archive.org/web/https://linuxhint.com/completely_wipe_hard_drive_ubuntu/
  [490]: https://web.archive.org/web/https://linoxide.com/linux-command/commands-wipe-disk-linux/
  [491]: https://web.archive.org/web/https://wiki.archlinux.org/index.php/Securely_wipe_disk
  [492]: https://web.archive.org/web/https://ssd.eff.org/en/module/how-delete-your-data-securely-linux
  [Extra Tools Cleaning]: #extra-tools-cleaning
  [493]: https://web.archive.org/web/https://eraser.heidi.ie/download/
  [494]: https://web.archive.org/web/http://killdisk.com/killdisk-freeware.htm
  [495]: https://web.archive.org/web/https://support.apple.com/en-gb/guide/disk-utility/dskutl14079/mac
  [496]: https://web.archive.org/web/https://support.apple.com/guide/disk-utility/erase-and-reformat-a-storage-device-dskutl14079/mac
  [497]: https://web.archive.org/web/https://support.apple.com/guide/disk-utility/encrypt-protect-a-storage-device-password-dskutl35612/mac
  [498]: media/image45.jpeg
  [499]: https://web.archive.org/web/https://ssd.eff.org/en/module/how-delete-your-data-securely-windows
  [500]: https://web.archive.org/web/https://wiki.archlinux.org/index.php/dm-crypt/Device_encryption
  [501]: https://web.archive.org/web/https://github.com/Qubes-Community/Contents/blob/master/docs/configuration/disk-trim.md
  [502]: https://web.archive.org/web/https://support.apple.com/en-us/HT210898
  [503]: media/image46.jpeg
  [504]: https://web.archive.org/web/http://www.edenwaith.com/products/permanent%20eraser/
  [505]: https://web.archive.org/web/https://ssd.eff.org/en/module/how-delete-your-data-securely-macos
  [506]: https://web.archive.org/web/https://www.whonix.org/wiki/System_Hardening_Checklist
  [507]: https://web.archive.org/web/https://exiftool.org/
  [508]: https://web.archive.org/web/https://exifcleaner.com/
  [509]: https://web.archive.org/web/https://www.purevpn.com/internet-privacy/how-to-remove-metadata-from-photos
  [510]: https://web.archive.org/web/https://sandlab.cs.uchicago.edu/fawkes/
  [511]: https://web.archive.org/web/https://github.com/Shawn-Shan/fawkes
  [512]: https://web.archive.org/web/https://lowkey.umiacs.umd.edu/
  [513]: https://web.archive.org/web/https://adversarial.io/
  [514]: https://web.archive.org/web/https://github.com/kanzure/pdfparanoia
  [515]: https://web.archive.org/web/https://support.microsoft.com/en-us/office/remove-hidden-data-and-personal-information-by-inspecting-documents-presentations-or-workbooks-356b7b5d-77af-44fe-a07f-9aa4d085966f
  [516]: https://web.archive.org/web/https://0xacab.org/jvoisin/mat2
  [517]: media/image47.jpeg 
  [518]: https://web.archive.org/web/https://www.whonix.org/wiki/VM_Live_Mode
  [519]: https://web.archive.org/web/https://www.titanium-software.fr/en/onyx.html
  [520]: https://web.archive.org/web/https://github.com/Qubes-Community/Contents/blob/master/docs/security/security-guidelines.md
  [521]: https://web.archive.org/web/https://www.whonix.org/wiki/Linux_Kernel_Runtime_Guard_LKRG
  [522]: https://web.archive.org/web/https://github.com/sundowndev/covermyass
  [523]: https://web.archive.org/web/https://support.microsoft.com/en-us/windows/how-to-open-registry-editor-in-windows-10-deab38e6-91d6-e0aa-4b7c-8878d9e07b11
  [524]: https://web.archive.org/web/https://privazer.com/en/download-shellbag-analyzer-shellbag-cleaner.php
  [525]: https://web.archive.org/web/https://privazer.com/en/download.php
  [526]: https://web.archive.org/web/https://www.bleachbit.org/download
  [527]: https://web.archive.org/web/https://justdeleteme.xyz/
  [528]: https://web.archive.org/web/https://justgetmydata.com/
  [529]: https://web.archive.org/web/https://search.google.com/search-console/remove-outdated-content
  [530]: https://web.archive.org/web/https://www.bing.com/webmasters/tools/contentremoval
  [531]: https://web.archive.org/web/https://webmaster.yandex.com/
  [532]: https://web.archive.org/web/https://webmaster.yandex.com/tools/del-url/
  [533]: https://web.archive.org/web/https://help.yahoo.com/kb/SLN4530.html
  [534]: https://wikiless.org/wiki/Wikipedia:Courtesy_vanishing
  [535]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Wikipedia:Courtesy_vanishing
  [536]: https://web.archive.org/web/https://inteltechniques.com/workbook.html
  [537]: https://web.archive.org/web/https://guardianproject.github.io/haven/
  [538]: https://web.archive.org/web/https://www.google.com/alerts
  [539]: https://wikiless.org/wiki/Ross_Ulbricht
  [540]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Ross_Ulbricht
  [541]: https://yewtu.be/watch?v=d-7o9xYp7eE
  [542]: https://web.archive.org/web/https://medium.com/@c5/darkweb-vendors-and-the-basic-opsec-mistakes-they-keep-making-e54c285a488c
  [543]: https://yewtu.be/watch?v=IqZZU9lFlF4
  [544]: https://yewtu.be/watch?v=zXmZnU2GdVk
  [545]: https://yewtu.be/watch?v=eQ2OZKitRwc
  ...
  [546]: https://web.archive.org/web/https://www.defcon.org/images/defcon-22/dc-22-presentations/Crenshaw/DEFCON-22-Adrian-Crenshaw-Dropping-Docs-on-Darknets-How-People-Got-Caught-UPDATED.pdf
  [547]: https://yewtu.be/watch?v=6Chp12sEnWk
  [548]: https://yewtu.be/watch?v=J1q4Ir2J8P8
  [549]: https://yewtu.be/watch?v=GR_U0G-QGA0
  [550]: https://wikiless.org/wiki/Key_disclosure_law
  [551]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Key_disclosure_law
  [552]: https://web.archive.org/web/https://www.gp-digital.org/world-map-of-encryption/
  [553]: https://mirror.anonymousplanet.org/donations.html
  [554]: https://web.archive.org/web/https://anonymousplanet.org/donations.html
  [555]: http://thgtoa7imksbg7rit4grgijl2ef6kc7b56bp56pmtta4g354lydlzkqd.onion/donations.html
  [556]: media/image48.jpeg 
  [557]: media/image49.jpeg 
  [558]: media/image50.jpeg 
  [559]: https://web.archive.org/web/https://snowflake.torproject.org/
  [560]: https://web.archive.org/web/https://community.torproject.org/relay/
  [Recommended VPS hosting providers]: #_Recommended_VPS_hosting
  [561]: https://web.archive.org/web/https://torrelay.ca/
  [562]: https://web.archive.org/web/https://blog.torproject.org/tips-running-exit-node
  [563]: https://wikiless.org/wiki/Permanent_Record_(autobiography)
  [564]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Permanent_Record_(autobiography)
  [565]: https://web.archive.org/web/https://www.w10privacy.de/english-home/
  [566]: https://web.archive.org/web/https://crazymax.dev/WindowsSpyBlocker/download/
  [567]: https://web.archive.org/web/https://www.oo-software.com/en/shutup10
  [568]: https://web.archive.org/web/https://github.com/beerisgood/windows10_hardening
  [569]: https://web.archive.org/web/https://www.microsoft.com/en-us/software-download/windows10
  [570]: https://web.archive.org/web/https://www.system-rescue.org/Installing-SystemRescue-on-a-USB-memory-stick/
  [571]: https://web.archive.org/web/https://wiki.archlinux.org/index.php/Solid_state_drive/Memory_cell_clearing
  [572]: https://web.archive.org/web/https://ata.wiki.kernel.org/index.php/ATA_Secure_Erase
  [573]: https://web.archive.org/web/https://tinyapps.org/docs/wipe_drives_hdparm.html
  [574]: https://web.archive.org/web/https://tinyapps.org/docs/ata_sanitize_hdparm.html
  [575]: https://web.archive.org/web/https://tinyapps.org/docs/nvme-secure-erase.html
  [576]: https://web.archive.org/web/https://tinyapps.org/docs/nvme-sanitize.html
  [577]: https://web.archive.org/web/https://clonezilla.org/liveusb.php
  [578]: https://web.archive.org/web/https://clonezilla.org/show-live-doc-content.php?topic=clonezilla-live/doc/01_Save_disk_image
  [579]: https://web.archive.org/web/https://clonezilla.org/show-live-doc-content.php?topic=clonezilla-live/doc/02_Restore_disk_image
  [580]: https://web.archive.org/web/https://bridges.torproject.org/
  [581]: https://web.archive.org/web/https://support.microsoft.com/en-us/windows/disk-cleanup-in-windows-10-8a96ff42-5751-39ad-23d6-434b4d5b9a68
  [582]: https://web.archive.org/web/https://support.microsoft.com/en-us/windows/defragment-your-windows-10-pc-048aefac-7f1f-4632-d48a-9700c4ec702a
  [583]: https://web.archive.org/web/https://www.bleachbit.org/
  [584]: https://web.archive.org/web/https://privazer.com/
  [585]: https://web.archive.org/web/https://www.system-rescue.org/
  [586]: https://web.archive.org/web/https://www.lifewire.com/how-to-erase-a-hard-drive-using-dban-2619148
  [587]: https://web.archive.org/web/https://github.com/PartialVolume/shredos.2020.02
  [588]: https://web.archive.org/web/https://rufus.ie/
  [589]: https://web.archive.org/web/https://kb.sandisk.com/app/answers/detail/a_id/15108/~/dashboard-support-information
  [590]: https://web.archive.org/web/https://www.seagate.com/support/downloads/seatools/
  [591]: https://web.archive.org/web/https://www.samsung.com/semiconductor/minisite/ssd/download/tools/
  [592]: https://web.archive.org/web/https://www.kingston.com/unitedstates/en/support/technical/ssdmanager
  [593]: https://web.archive.org/web/https://support.lenovo.com/us/en/downloads/ds019026-thinkpad-drive-erase-utility-for-resetting-the-cryptographic-key-and-erasing-the-solid-state-drive-thinkpad
  [594]: https://web.archive.org/web/https://www.crucial.com/support/storage-executive
  [595]: https://web.archive.org/web/https://support.wdc.com/downloads.aspx?p=279
  [596]: https://web.archive.org/web/https://store.hp.com/us/en/tech-takes/how-to-secure-erase-ssd
  [597]: https://web.archive.org/web/https://www.transcend-info.com/Support/Software-10/
  [598]: https://web.archive.org/web/https://www.dell.com/support/kbdoc/en-us/000134997/using-the-dell-bios-data-wipe-function-for-optiplex-precision-and-latitude-systems-built-after-november-2015?lwp=rt
  [599]: https://web.archive.org/web/https://www.toshiba-storage.com/downloads/
  [600]: https://web.archive.org/web/https://www.glump.net/howto/desktop/enable-trim-on-an-external-ssd-on-linux
  [601]: https://web.archive.org/web/https://code.mendhak.com/securely-wipe-ssd/
  [602]: https://web.archive.org/web/https://www.lifewire.com/enable-trim-for-ssd-in-os-x-yosemite-2260789
  [603]: https://web.archive.org/web/https://cindori.org/trimenabler/
  [604]: https://web.archive.org/web/https://www.debian.org/CD/netinst/
  [605]: https://web.archive.org/web/https://support.lenovo.com/be/en/solutions/migr-68369
  [606]: https://web.archive.org/web/https://support.hp.com/gb-en/document/c06204100
  [607]: https://web.archive.org/web/https://www.dell.com/support/kbdoc/en-us/000146892/dell-data-wipe
  [608]: https://web.archive.org/web/https://us.answers.acer.com/app/answers/detail/a_id/41567/~/how-to-use-disk-sanitizer-on-acer-travelmate-notebooks
  [609]: https://translate.google.com/translate?hl=&sl=ru&tl=en&u=https%3A%2F%2Fbiboroda.livejournal.com%2F4894724.html&anno=2
  [610]: https://web.archive.org/web/https://biboroda.livejournal.com/4894724.html
  [611]: https://web.archive.org/web/https://www.theguardian.com/australia-news/2021/sep/11/inside-story-most-daring-surveillance-sting-in-history
  [612]: https://wikiless.org/wiki/EncroChat
  [613]: https://web.archive.org/web/https://en.wikipedia.org/wiki/EncroChat
  [614]: https://wikiless.org/wiki/Sky_ECC
  [615]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Sky_ECC
  [616]: https://web.archive.org/web/https://privacyguides.org/providers/vpn/
  [617]: https://web.archive.org/web/https://safing.io/
  [Printing Watermarking]: #printing-watermarking
  [618]: https://web.archive.org/web/https://www.getmonero.org/community/merchants/
  [619]: https://web.archive.org/web/https://proprivacy.com/vpn/guides/create-your-own-vpn-server
  [620]: https://web.archive.org/web/https://linuxize.com/post/how-to-setup-ssh-socks-tunnel-for-private-browsing/
  [621]: https://web.archive.org/web/https://www.digitalocean.com/community/tutorials/how-to-route-web-traffic-securely-without-a-vpn-using-a-socks-tunnel
  [622]: https://web.archive.org/web/https://www.forwardproxy.com/2018/12/using-putty-to-setup-a-quick-socks-proxy/
  [623]: https://web.archive.org/web/https://ma.ttias.be/socks-proxy-linux-ssh-bypass-content-filters/
  [624]: https://web.archive.org/web/https://www.putty.org/
  [625]: media/image51.jpeg 
  [626]: https://web.archive.org/web/https://tails.boum.org/contribute/design/Unsafe_Browser/
  [627]: https://web.archive.org/web/https://archive.flossmanuals.net/bypassing-censorship/index.html
  [628]: media/image52.jpeg 
  [629]: https://web.archive.org/web/https://www.alfa.com.tw/
  [630]: https://web.archive.org/web/https://www.tp-link.com/us/home-networking/usb-adapter/tl-wn722n/
  [631]: https://web.archive.org/web/https://www.wirelesshack.org/best-kali-linux-compatible-usb-adapter-dongles.html
  [632]: https://yewtu.be/watch?v=8FV2QZ1BPnw
  [633]: https://web.archive.org/web/https://www.netally.com/products/
  [634]: https://web.archive.org/web/https://mullvad.net/en/help/install-mullvad-app-windows/
  [635]: https://web.archive.org/web/https://www.ivpn.net/apps-windows
  [636]: https://web.archive.org/web/https://docs.safing.io/portmaster/install/windows
  [637]: https://web.archive.org/web/https://protonvpn.com/support/protonvpn-windows-vpn-application/
  [638]: https://web.archive.org/web/https://mullvad.net/en/help/install-and-use-mullvad-app-macos/
  [639]: https://web.archive.org/web/https://www.ivpn.net/apps-macos/
  [640]: https://web.archive.org/web/https://protonvpn.com/support/protonvpn-mac-vpn-application/
  [641]: https://web.archive.org/web/https://mullvad.net/en/help/install-mullvad-app-linux/
  [642]: https://web.archive.org/web/https://www.ivpn.net/apps-linux/
  [643]: https://web.archive.org/web/https://docs.safing.io/portmaster/install/linux
  [644]: https://web.archive.org/web/https://protonvpn.com/support/linux-vpn-setup/
  [645]: https://web.archive.org/web/https://www.ivpn.net/knowledgebase/general/do-you-offer-a-kill-switch-or-vpn-firewall/
  [646]: https://web.archive.org/web/https://protonvpn.com/support/what-is-kill-switch/
  [647]: https://web.archive.org/web/https://mullvad.net/en/help/using-mullvad-vpn-app/
  [648]: https://web.archive.org/web/https://protonvpn.com/blog/macos-vpn-kill-switch/
  [649]: https://web.archive.org/web/https://mullvad.net/en/help/wireguard-and-mullvad-vpn/
  [650]: https://web.archive.org/web/https://mullvad.net/en/help/linux-openvpn-installation/
  [651]: https://web.archive.org/web/https://github.com/ProtonVPN/linux-cli/blob/master/USAGE.md
  [652]: https://web.archive.org/web/https://www.ivpn.net/knowledgebase/linux/linux-wireguard-kill-switch/
  [653]: https://web.archive.org/web/https://www.ivpn.net/knowledgebase/linux/linux-kill-switch-using-the-uncomplicated-firewall-ufw/
  [654]: https://web.archive.org/web/https://ooni.org/install/
  [655]: https://web.archive.org/web/https://www.gpg4win.org/
  [656]: https://web.archive.org/web/https://gpgtools.org/
  [657]: https://web.archive.org/web/https://support.torproject.org/tbb/how-to-verify-signature/
  [658]: https://web.archive.org/web/https://tails.boum.org/install/vm-download/index.en.html
  [659]: https://web.archive.org/web/https://www.whonix.org/wiki/Verify_the_Whonix_images
  [660]: https://web.archive.org/web/https://www.clamav.net/
  [661]: https://web.archive.org/web/https://github.com/rfxn/linux-malware-detect
  [662]: https://web.archive.org/web/http://www.chkrootkit.org/
  [663]: https://web.archive.org/web/https://developers.virustotal.com/v3.0/docs/search-by-hash
  [664]: https://web.archive.org/web/https://github.com/rshipp/awesome-malware-analysis
  [665]: https://web.archive.org/web/https://support.virustotal.com/hc/en-us/articles/115002168385-Privacy-Policy
  [666]: https://web.archive.org/web/https://blog.didierstevens.com/programs/pdf-tools/
  [667]: https://web.archive.org/web/https://github.com/QubesOS/qubes-app-linux-pdf-converter
  [668]: https://web.archive.org/web/https://github.com/firstlookmedia/pdf-redact-tools
  [669]: https://web.archive.org/web/https://github.com/firstlookmedia/dangerzone
  [670]: https://web.archive.org/web/https://www.vice.com/en/article/v7gd9b/facebook-helped-fbi-hack-child-predator-buster-hernandez
  [671]: https://web.archive.org/web/https://digital-forensics.sans.org/media/analyzing-malicious-document-files.pdf
  [672]: https://web.archive.org/web/https://www.winitor.com/pdf/Malware-Analysis-Fundamentals-Files-Tools.pdf
  [673]: https://web.archive.org/web/https://privacytests.org/
  [674]: https://web.archive.org/web/https://www.mozilla.org/en-US/firefox/browsers/compare/brave/
  [675]: https://web.archive.org/web/https://brave.com/download/
  [676]: https://web.archive.org/web/https://wiki.archlinux.org/title/Firefox/Privacy
  [677]: https://web.archive.org/web/https://proprivacy.com/privacy-service/guides/firefox-privacy-security-guide
  [678]: https://web.archive.org/web/https://chrisx.xyz/blog/yet-another-firefox-hardening-guide/
  [679]: https://web.archive.org/web/https://ebin.city/~werwolf/posts/firefox-hardening-guide/
  [680]: media/image53.jpeg 
  [681]: media/image54.jpeg 
  [682]: https://web.archive.org/web/https://www.torproject.org/download/
  [683]: media/image55.jpeg 
  [684]: media/image56.jpeg 
  [685]: media/image57.jpeg 
  [686]: https://web.archive.org/web/https://z.cash/
  [687]: https://web.archive.org/web/https://z.cash/exchanges/
  [688]: https://web.archive.org/web/https://wasabiwallet.io/
  [689]: https://web.archive.org/web/https://community.torproject.org/relay/community-resources/good-bad-isps/
  [690]: https://web.archive.org/web/https://privacyguides.org/providers/hosting/
  [691]: https://web.archive.org/web/https://xkcd.com/936/
  [692]: https://web.archive.org/web/https://www.explainxkcd.com/wiki/index.php/936:_Password_Strength
  [693]: media/image58.jpeg 
  [694]: https://yewtu.be/watch?v=3NjQ9b3pgIg
  [695]: https://web.archive.org/web/https://privacyguides.org/providers/search-engines
  [696]: https://web.archive.org/web/https://arstechnica.com/tech-policy/2018/06/dark-web-vendor-oxymonster-turns-out-to-be-a-frenchman-with-luscious-beard/
  [697]: https://web.archive.org/web/https://www.whonix.org/wiki/Surfing_Posting_Blogging#Stylometry
  [698]: https://wikiless.org/wiki/Forensic_linguistics
  [699]: https://web.archive.org/web/https://wikipedia.org/wiki/Forensic_linguistics
  [700]: https://wikiless.org/wiki/Writeprint
  [701]: https://web.archive.org/web/https://wikipedia.org/wiki/Writeprint
  [702]: https://wikiless.org/wiki/Stylometry
  [703]: https://web.archive.org/web/https://wikipedia.org/wiki/Stylometry
  [704]: https://wikiless.org/wiki/Content_similarity_detection
  [705]: https://web.archive.org/web/https://wikipedia.org/wiki/Content_similarity_detection
  [706]: https://wikiless.org/wiki/Author_profiling
  [707]: https://web.archive.org/web/https://wikipedia.org/wiki/Author_profiling
  [708]: https://wikiless.org/wiki/Native-language_identification
  [709]: https://web.archive.org/web/https://wikipedia.org/wiki/Native-language_identification
  [710]: https://wikiless.org/wiki/Computational_linguistics
  [711]: https://web.archive.org/web/https://wikipedia.org/wiki/Computational_linguistics
  [712]: https://web.archive.org/web/https://regmedia.co.uk/2017/09/27/gal_vallerius.pdf
  [713]: https://wikiless.org/wiki/Ted_Kaczynski#After_publication
  [714]: https://web.archive.org/web/https://wikipedia.org/wiki/Ted_Kaczynski#After_publication
  [715]: https://web.archive.org/web/https://i.blackhat.com/USA-19/Wednesday/us-19-Wixey-Im-Unique-Just-Like-You-Human-Side-Channels-And-Their-Implications-For-Security-And-Privacy.pdf
  [716]: https://web.archive.org/web/https://media.defcon.org/DEF%20CON%2026/DEF%20CON%2026%20presentations/DEFCON-26-Matt-Wixey-Betrayed-by-the-Keyboard-Updated.pdf
  [717]: https://web.archive.org/web/https://i.blackhat.com/us-18/Wed-August-8/us-18-Wixey-Every-ROSE-Has-Its-Thorn-The-Dark-Art-Of-Remote-Online-Social-Engineering.pdf
  [https://yewtu.be]: https://invidious.fdn.fr
  [https://nitter.net]: https://nitter.fdn.fr
  [718]: https://web.archive.org/web/https://github.com/spikecodes/libreddit
  [719]: https://web.archive.org/web/https://git.sr.ht/~metalune/simplytranslate_web
  [https://anonymousplanet.org]: https://anonymousplanet.org/
  [720]: https://mirror.anonymousplanet.org/guide.pdf
  [721]: https://web.archive.org/web/https://anonymousplanet.org/guide.pdf
  [722]: http://thgtoa7imksbg7rit4grgijl2ef6kc7b56bp56pmtta4g354lydlzkqd.onion/guide.pdf
  [723]: https://mirror.anonymousplanet.org/guide-dark.pdf
  [724]: https://web.archive.org/web/https://anonymousplanet.org/guide-dark.pdf
  [725]: http://thgtoa7imksbg7rit4grgijl2ef6kc7b56bp56pmtta4g354lydlzkqd.onion/guide-dark.pdf
  [726]: https://mirror.anonymousplanet.org/guide.odt
  [727]: https://web.archive.org/web/https://anonymousplanet.org/guide.odt
  [728]: http://thgtoa7imksbg7rit4grgijl2ef6kc7b56bp56pmtta4g354lydlzkqd.onion/guide.odt
  [729]: https://web.archive.org/web/https://help.libreoffice.org/7.1/en-US/text/shared/guide/redlining_doccompare.html
  [730]: https://web.archive.org/web/https://www.whonix.org/wiki/Surfing_Posting_Blogging#Anonymous_File_Sharing
  [**https://www.youtube.com/watch?v=j02QoI4ZlnU**]: https://www.youtube.com/watch?v=j02QoI4ZlnU
  [731]: https://yewtu.be/watch?v=j02QoI4ZlnU
  [732]: https://web.archive.org/web/https://github.com/monero-project/monero/blob/master/docs/ANONYMITY_NETWORKS.md#privacy-limitations
  [733]: https://web.archive.org/web/https://www.linddun.org/
  [734]: https://wikiless.org/wiki/STRIDE_%28security%29
  [735]: https://web.archive.org/web/https://en.wikipedia.org/wiki/STRIDE_%28security%29
  [736]: https://web.archive.org/web/https://versprite.com/tag/pasta-threat-modeling/
  [737]: https://web.archive.org/web/https://insights.sei.cmu.edu/blog/threat-modeling-12-available-methods/
  [738]: https://web.archive.org/web/https://www.geeksforgeeks.org/threat-modelling/
  [739]: https://web.archive.org/web/https://www.threatmodelingmanifesto.org/
  [740]: https://web.archive.org/web/https://cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html
  ...
  [741]: https://web.archive.org/web/https://www.huntonprivacyblog.com/wp-content/uploads/sites/28/2016/02/Telemedia_Act__TMA_.pdf
  [742]: https://wikiless.org/wiki/Don%27t_be_evil
  [743]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Don%27t_be_evil
  [744]: https://yewtu.be/watch?v=6DGNZnfKYnU
  [745]: https://wikiless.org/wiki/Open-source_intelligence
  [746]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Open-source_intelligence
  [747]: https://yewtu.be/playlist?list=PLna1KTNJu3y09Tu70U6yPn28sekaNhOMY
  [748]: https://wikiless.org/wiki/4chan
  [749]: https://web.archive.org/web/https://en.wikipedia.org/wiki/4chan
  [750]: https://web.archive.org/web/https://www.privateinternetaccess.com/blog/how-does-privacy-differ-from-anonymity-and-why-are-both-important/
  [751]: https://web.archive.org/web/https://scholar.harvard.edu/files/mickens/files/thisworldofours.pdf
  [752]: https://web.archive.org/web/https://xkcd.com/538/
  [753]: https://wikiless.org/wiki/Threat_model
  [754]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Threat_model
  [755]: https://web.archive.org/web/https://www.bellingcat.com/
  [756]: https://wikiless.org/wiki/Doxing
  [757]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Doxing
  [758]: https://yewtu.be/watch?v=muoR8Td44UE
  [759]: https://web.archive.org/web/https://www.bbc.com/news/technology-50150981
  [760]: https://web.archive.org/web/https://github.com/alecmuffett/real-world-onion-sites
  [761]: https://web.archive.org/web/https://2019.www.torproject.org/about/torusers.html.en
  [762]: https://web.archive.org/web/https://www.whonix.org/wiki/Anonymity
  [763]: https://web.archive.org/web/https://geekfeminism.wikia.org/wiki/Who_is_harmed_by_a_%22Real_Names%22_policy%3F
  [764]: https://web.archive.org/web/https://www.cyberghostvpn.com/privacyhub/internet-privacy-surveillance/
  [765]: https://web.archive.org/web/https://www.privateinternetaccess.com/blog/internet-freedom-around-the-world-in-50-stats/
  [766]: https://wikiless.org/wiki/IANAL
  [767]: https://web.archive.org/web/https://en.wikipedia.org/wiki/IANAL
  [768]: https://wikiless.org/wiki/Trust,_but_verify
  [769]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Trust,_but_verify
  [770]: https://wikiless.org/wiki/IP_address
  [771]: https://web.archive.org/web/https://en.wikipedia.org/wiki/IP_address
  [772]: https://wikiless.org/wiki/Data_retention
  [773]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Data_retention
  [774]: https://wikiless.org/wiki/Tor_(anonymity_network)
  [775]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Tor_(anonymity_network)
  [776]: https://wikiless.org/wiki/Virtual_private_network
  [777]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Virtual_private_network
  [778]: https://web.archive.org/web/https://ieeexplore.ieee.org/document/8418599
  [779]: https://wikiless.org/wiki/Domain_Name_System
  [780]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Domain_Name_System
  [781]: https://wikiless.org/wiki/DNS_blocking
  [782]: https://web.archive.org/web/https://en.wikipedia.org/wiki/DNS_blocking
  [783]: https://web.archive.org/web/https://censoredplanet.org/
  [784]: https://web.archive.org/web/https://arxiv.org/pdf/2001.08288.pdf
  [785]: https://web.archive.org/web/https://labzilla.io/blog/force-dns-pihole
  [786]: https://wikiless.org/wiki/DNS_over_HTTPS
  [787]: https://web.archive.org/web/https://en.wikipedia.org/wiki/DNS_over_HTTPS
  [788]: https://wikiless.org/wiki/DNS_over_TLS
  [789]: https://web.archive.org/web/https://en.wikipedia.org/wiki/DNS_over_TLS
  [790]: https://wikiless.org/wiki/Pi-hole
  [791]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Pi-hole
  [792]: https://wikiless.org/wiki/Server_Name_Indication
  [793]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Server_Name_Indication
  [794]: https://web.archive.org/web/https://www.usenix.org/system/files/foci19-paper_chai_0.pdf
  [795]: https://wikiless.org/wiki/Content_delivery_network
  [796]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Content_delivery_network
  [797]: https://web.archive.org/web/https://blog.cloudflare.com/encrypted-client-hello/
  [798]: https://web.archive.org/web/https://www.zdnet.com/article/russia-wants-to-ban-the-use-of-secure-protocols-such-as-tls-1-3-doh-dot-esni/
  [799]: https://web.archive.org/web/https://www.zdnet.com/article/china-is-now-blocking-all-encrypted-https-traffic-using-tls-1-3-and-esni/
  [800]: https://wikiless.org/wiki/Online_Certificate_Status_Protocol
  [801]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Online_Certificate_Status_Protocol
  [802]: https://web.archive.org/web/https://madaidans-insecurities.github.io/encrypted-dns.html
  [803]: https://wikiless.org/wiki/OCSP_stapling
  [804]: https://web.archive.org/web/https://en.wikipedia.org/wiki/OCSP_stapling
  [805]: https://web.archive.org/web/https://dev.chromium.org/Home/chromium-security/crlsets
  [806]: https://web.archive.org/web/https://www.zdnet.com/article/chrome-does-certificate-revocation-better/
  [807]: https://web.archive.org/web/https://www.esat.kuleuven.be/cosic/publications/article-3153.pdf
  [808]: https://web.archive.org/web/https://www.researchgate.net/publication/332893422_Oblivious_DNS_Practical_Privacy_for_DNS_Queries
  [809]: https://web.archive.org/web/https://nymity.ch/tor-dns/
  [810]: https://wikiless.org/wiki/Near-field_communication
  [811]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Near-field_communication
  [812]: https://web.archive.org/web/https://shop.samsonite.com/accessories/rfid-accessories/
  [813]: https://web.archive.org/web/https://support.google.com/accounts/answer/3467281?hl=en
  [814]: https://web.archive.org/web/https://support.apple.com/en-us/HT207056
  [815]: https://web.archive.org/web/https://cse.buffalo.edu/~lusu/papers/MobiCom2020.pdf
  [816]: https://web.archive.org/web/https://digi.ninja/jasager/
  [817]: https://web.archive.org/web/https://shop.hak5.org/products/wifi-pineapple
  [818]: https://wikiless.org/wiki/Wi-Fi_deauthentication_attack
  [819]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Wi-Fi_deauthentication_attack
  [820]: https://wikiless.org/wiki/Captive_portal
  [821]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Captive_portal
  [822]: https://web.archive.org/web/https://www.hackerfactor.com/blog/index.php?/archives/868-Deanonymizing-Tor-Circuits.html
  [823]: https://web.archive.org/web/https://distrinet.cs.kuleuven.be/software/tor-wf-dl/
  [824]: https://web.archive.org/web/https://homes.esat.kuleuven.be/~mjuarezm/index_files/pdf/ccs18.pdf
  [825]: https://web.archive.org/web/https://www.internetsociety.org/sites/default/files/blogs-media/website-fingerprinting-internet-scale.pdf
  [826]: https://web.archive.org/web/https://www.esat.kuleuven.be/cosic/publications/article-2456.pdf
  [827]: https://web.archive.org/web/https://www.dailydot.com/unclick/tor-harvard-bomb-suspect/
  [828]: https://web.archive.org/web/https://arstechnica.com/information-technology/2015/10/how-the-nsa-can-break-trillions-of-encrypted-web-and-vpn-connections/
  [829]: https://web.archive.org/web/https://arstechnica.com/gadgets/2020/11/does-tor-provide-more-benefit-or-harm-new-paper-says-it-depends/
  [830]: https://web.archive.org/web/https://www.pnas.org/content/early/2020/11/24/2011893117
  [831]: https://web.archive.org/web/https://blog.cryptographyengineering.com/2019/06/05/how-does-apple-privately-find-your-offline-devices/
  [832]: https://web.archive.org/web/https://support.apple.com/en-us/HT210515
  [833]: https://web.archive.org/web/https://www.xda-developers.com/samsung-find-my-mobile-app-locate-galaxy-devices-offline/
  [834]: https://web.archive.org/web/https://support.apple.com/en-us/HT204756
  [835]: https://wikiless.org/wiki/Bluetooth_Low_Energy
  [836]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Bluetooth_Low_Energy
  [837]: https://wikiless.org/wiki/International_Mobile_Equipment_Identity
  [838]: https://web.archive.org/web/https://en.wikipedia.org/wiki/International_Mobile_Equipment_Identity
  [839]: https://wikiless.org/wiki/International_mobile_subscriber_identity
  [840]: https://web.archive.org/web/https://en.wikipedia.org/wiki/International_mobile_subscriber_identity
  [841]: https://web.archive.org/web/https://source.android.com/devices/tech/config/device-identifiers
  [842]: https://web.archive.org/web/https://policies.google.com/privacy/embedded?hl=en-US
  [843]: https://web.archive.org/web/https://www.bellingcat.com/news/uk-and-europe/2019/06/28/the-gru-globetrotters-mission-london/
  [844]: https://web.archive.org/web/https://www.bellingcat.com/news/uk-and-europe/2020/02/17/v-like-vympel-fsbs-secretive-department-v-behind-assassination-of-zelimkhan-khangoshvili/
  [845]: https://wikiless.org/wiki/Closed-circuit_television
  [846]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Closed-circuit_television
  [847]: https://web.archive.org/web/https://www.apple.com/legal/transparency/device-requests.html
  [848]: https://27m3p2uv7igmj6kvd4ql3cct5h3sdwrsajovkkndeufumzyfhlfev4qd.onion/2020/07/31/protests-surveillance-stingrays-dirtboxes-phone-tracking/
  [849]: https://web.archive.org/web/https://theintercept.com/2020/07/31/protests-surveillance-stingrays-dirtboxes-phone-tracking/
  [850]: https://wikiless.org/wiki/IMSI-catcher
  [851]: https://web.archive.org/web/https://en.wikipedia.org/wiki/IMSI-catcher
  [852]: https://wikiless.org/wiki/Stingray_phone_tracker
  [853]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Stingray_phone_tracker
  [854]: https://web.archive.org/web/https://gizmodo.com/american-cops-turns-to-canadian-phone-tracking-firm-aft-1845442778
  [855]: https://wikiless.org/wiki/Man-in-the-middle_attack
  [856]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Man-in-the-middle_attack
  [857]: https://web.archive.org/web/https://shop.puri.sm/shop/librem-5/
  [858]: https://wikiless.org/wiki/MAC_address
  [859]: https://web.archive.org/web/https://en.wikipedia.org/wiki/MAC_address
  [860]: https://web.archive.org/web/https://amsignalinc.com/data-sheets/Acyclica/Acyclica-RoadTrend-Product-Sheet.pdf
  [861]: https://web.archive.org/web/https://www.researchgate.net/publication/334590931_Tracking_Anonymized_Bluetooth_Devices/fulltext/5d3308db92851cd04675a469/Tracking-Anonymized-Bluetooth-Devices.pdf
  [862]: https://wikiless.org/wiki/Central_processing_unit
  [863]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Central_processing_unit
  [864]: https://wikiless.org/wiki/Intel_Management_Engine
  [865]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Intel_Management_Engine
  [866]: https://wikiless.org/wiki/AMD_Platform_Security_Processor
  [867]: https://web.archive.org/web/https://en.wikipedia.org/wiki/AMD_Platform_Security_Processor
  [868]: https://web.archive.org/web/https://libreboot.org/
  [869]: https://web.archive.org/web/https://www.apple.com/privacy/docs/Differential_Privacy_Overview.pdf
  [870]: https://wikiless.org/wiki/Differential_privacy
  [871]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Differential_privacy
  [872]: https://web.archive.org/web/https://edwardsnowden.substack.com/p/all-seeing-i
  [873]: https://web.archive.org/web/https://www.reuters.com/article/us-apple-fbi-icloud-exclusive-idUSKBN1ZK1CT
  [874]: https://web.archive.org/web/https://www.zdnet.com/article/apple-data-collection-stored-request/
  [875]: https://web.archive.org/web/https://decorrespondent.nl/8481/heres-how-we-found-the-names-and-addresses-of-soldiers-and-secret-agents-using-a-simple-fitness-app/412999257-6756ba27
  [876]: https://web.archive.org/web/https://www.websiteplanet.com/blog/gethealth-leak-report/
  [877]: https://web.archive.org/web/https://www.wired.com/story/strava-heat-map-military-bases-fitness-trackers-privacy/
  [878]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2018/01/29/strava-interpretation-guide/
  [879]: https://web.archive.org/web/https://www.theguardian.com/world/2018/jan/28/fitness-tracking-app-gives-away-location-of-secret-us-army-bases
  [880]: https://web.archive.org/web/https://www.telegraph.co.uk/technology/2018/07/08/running-app-exposes-mi6-gchq-workers-whereabouts/
  [881]: https://web.archive.org/web/https://www.washingtonpost.com/technology/2019/05/06/alexa-has-been-eavesdropping-you-this-whole-time/?itid=lk_interstitial_manual_59
  [882]: https://web.archive.org/web/https://www.washingtonpost.com/technology/2019/12/17/what-does-your-car-know-about-you-we-hacked-chevy-find-out/
  [883]: https://web.archive.org/web/https://kieranhealy.org/blog/archives/2013/06/09/using-metadata-to-find-paul-revere/
  [884]: https://wikiless.org/wiki/Sensorvault
  [885]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Sensorvault
  [886]: https://web.archive.org/web/https://nrkbeta.no/2020/12/03/my-phone-was-spying-on-me-so-i-tracked-down-the-surveillants/
  [887]: https://web.archive.org/web/https://www.nytimes.com/interactive/2019/12/19/opinion/location-tracking-cell-phone.html
  [888]: https://web.archive.org/web/https://nakedsecurity.sophos.com/2020/03/10/google-data-puts-innocent-man-at-the-scene-of-a-crime/
  [889]: https://wikiless.org/wiki/Geo-fence_warrant
  [890]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Geo-fence_warrant
  [891]: https://web.archive.org/web/https://www.vice.com/en/article/y3g97x/location-data-apps-drone-strikes-iowa-national-guard
  [892]: https://web.archive.org/web/https://techcrunch.com/2021/08/19/google-geofence-warrants/
  [893]: https://web.archive.org/web/https://www.techdirt.com/articles/20210821/10494847401/google-report-shows-reverse-warrants-are-swiftly-becoming-law-enforcements-go-to-investigative-tool.shtml
  [894]: https://wikiless.org/wiki/Room_641A
  [895]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Room_641A
  [896]: https://wikiless.org/wiki/Edward_Snowden
  [897]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Edward_Snowden
  [898]: https://wikiless.org/wiki/XKeyscore
  [899]: https://web.archive.org/web/https://en.wikipedia.org/wiki/XKeyscore
  [900]: https://web.archive.org/web/https://www.electrospaces.net/2020/10/danish-military-intelligence-uses.html
  [901]: https://web.archive.org/web/https://en.m.wikipedia.org/wiki/MUSCULAR_(surveillance_program)
  [902]: https://wikiless.org/wiki/SORM
  [903]: https://web.archive.org/web/https://en.wikipedia.org/wiki/SORM
  [904]: https://wikiless.org/wiki/Tempora
  [905]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Tempora
  [906]: https://wikiless.org/wiki/PRISM_(surveillance_program)
  [907]: https://web.archive.org/web/https://en.wikipedia.org/wiki/PRISM_(surveillance_program)
  [908]: https://web.archive.org/web/https://www.justsecurity.org/10318/video-clip-director-nsa-cia-we-kill-people-based-metadata/
  [909]: https://web.archive.org/web/https://www.imdb.com/title/tt11464826/
  [910]: https://web.archive.org/web/https://arstechnica.com/information-technology/2015/07/how-the-way-you-type-can-shatter-anonymity-even-on-tor/
  [911]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Stylometry
  [912]: https://web.archive.org/web/https://paul.reviews/behavioral-profiling-the-password-you-cant-change/
  [913]: https://wikiless.org/wiki/Sentiment_analysis
  [914]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Sentiment_analysis
  [915]: https://web.archive.org/web/https://coveryourtracks.eff.org/
  [916]: https://web.archive.org/web/https://people.eecs.berkeley.edu/~dawnsong/papers/2012%20On%20the%20Feasibility%20of%20Internet-Scale%20Author%20Identification.pdf
  [https://www.forbes.com/sites/thomasbrewster/2021/10/04/google-keyword-warrants-give-us-government-data-on-search-users]: https://www.forbes.com/sites/thomasbrewster/2021/10/04/google-keyword-warrants-give-us-government-data-on-search-users/?sh=188183ac7c97
  [917]: https://web.archive.org/web/https://www.forbes.com/sites/thomasbrewster/2021/10/04/google-keyword-warrants-give-us-government-data-on-search-users
  [918]: https://web.archive.org/web/https://blog.securedtouch.com/behavioral-biometrics-101-an-in-depth-look-at-behavioral-biometrics-vs-behavioral-analytics
  [919]: https://web.archive.org/web/https://arstechnica.com/tech-policy/2012/03/stakeout-how-the-fbi-tracked-and-busted-a-chicago-anon/
  [920]: https://web.archive.org/web/https://www.bellingcat.com/news/uk-and-europe/2018/05/25/mh17-russian-gru-commander-orion-identified-oleg-ivannikov/
  [921]: https://web.archive.org/web/https://research.fb.com/publications/deepface-closing-the-gap-to-human-level-performance-in-face-verification/
  [922]: https://web.archive.org/web/https://www.privateinternetaccess.com/blog/putting-face-facebook-mark-zuckerberg-building-world-without-public-anonymity/
  [923]: https://web.archive.org/web/https://www.cnbc.com/2017/09/01/facebook-has-mapped-human-population-building-internet-in-space.html
  [924]: https://web.archive.org/web/https://www.technologyreview.com/2021/02/05/1017388/ai-deep-learning-facial-recognition-data-history/
  [925]: https://web.archive.org/web/https://www.bellingcat.com/resources/case-studies/2015/08/07/shadow-of-a-doubt/
  [926]: https://web.archive.org/web/https://brown.columbia.edu/open-source-investigation/
  [927]: https://web.archive.org/web/https://www.newscientist.com/article/dn27761-facebook-can-recognise-you-in-photos-even-if-youre-not-looking/
  [928]: https://web.archive.org/web/https://patents.google.com/patent/US20150242679
  [929]: https://web.archive.org/web/https://apnews.com/article/bf75dd1c26c947b7826d270a16e2658a
  [930]: https://web.archive.org/web/https://www.thesun.co.uk/news/7684204/cctv-technology-identify-body-shape-way-walk/
  [931]: https://web.archive.org/web/https://citysecuritymagazine.com/security-management/gait-recognition-identification-tool/
  [932]: https://web.archive.org/web/https://www.vice.com/en/article/bvzvdw/tech-companies-are-training-ai-to-read-your-lips
  [933]: https://web.archive.org/web/https://newatlas.com/science/science/eye-tracking-privacy/
  [934]: https://web.archive.org/web/https://techcrunch.com/2021/01/13/facial-recognition-reveals-political-party-in-troubling-new-research/
  [935]: https://web.archive.org/web/https://slate.com/technology/2018/04/facebook-collects-data-on-non-facebook-users-if-they-want-to-delete-it-they-have-to-sign-up.html
  [936]: https://web.archive.org/web/https://theconversation.com/shadow-profiles-facebook-knows-about-you-even-if-youre-not-on-facebook-94804
  [937]: https://web.archive.org/web/https://www.theverge.com/2018/4/11/17225482/facebook-shadow-profiles-zuckerberg-congress-data-privacy
  [938]: https://web.archive.org/web/https://www.zdnet.com/article/anger-mounts-after-facebooks-shadow-profiles-leak-in-bug/
  [939]: https://web.archive.org/web/https://www.cnet.com/news/shadow-profiles-facebook-has-information-you-didnt-hand-over/
  [940]: https://web.archive.org/web/https://www.anyvision.co/
  [941]: https://web.archive.org/web/https://www.buzzfeednews.com/article/ryanmac/clearview-ai-local-police-facial-recognition
  [942]: https://web.archive.org/web/https://www.wired.com/story/clearview-ai-new-tools-identify-you-photos/
  [943]: https://web.archive.org/web/https://www.nec.com/en/global/solutions/biometrics/face/neofacewatch.html
  [944]: https://web.archive.org/web/https://www.theguardian.com/uk-news/2020/feb/11/met-police-deploy-live-facial-recognition-technology
  [945]: https://yewtu.be/watch?v=lH2gMNrUuEY
  [946]: https://web.archive.org/web/https://edition.cnn.com/2021/07/23/tech/idme-unemployment-facial-recognition/index.html
  [947]: https://web.archive.org/web/https://www.washingtonpost.com/technology/2020/12/08/huawei-tested-ai-software-that-could-recognize-uighur-minorities-alert-police-report-says/
  [948]: https://27m3p2uv7igmj6kvd4ql3cct5h3sdwrsajovkkndeufumzyfhlfev4qd.onion/2016/10/13/how-a-facial-recognition-mismatch-can-ruin-your-life/
  [949]: https://web.archive.org/web/https://theintercept.com/2016/10/13/how-a-facial-recognition-mismatch-can-ruin-your-life/
  [950]: https://web.archive.org/web/https://www.vice.com/en/article/5dbywn/facial-recognition-failures-are-locking-people-out-of-unemployment-systems
  [951]: https://web.archive.org/web/https://www.bbc.com/news/uk-wales-43711477
  [952]: https://web.archive.org/web/https://edition.cnn.com/2021/05/25/uk/drug-dealer-cheese-sentenced-scli-gbr-intl/index.html
  [953]: https://web.archive.org/web/https://www.vice.com/en/article/evqk9e/photo-of-fingerprints-used-to-arrest-drug-dealers
  [954]: https://web.archive.org/web/https://patents.justia.com/patent/10891948
  [955]: https://web.archive.org/web/https://www.pymnts.com/news/biometrics/2021/iris-scan-traveler-identification-dubai-airport/
  [956]: https://web.archive.org/web/https://www.imdb.com/title/tt0119177/
  [957]: https://web.archive.org/web/https://www.imdb.com/title/tt1839578
  [958]: https://web.archive.org/web/https://www.imdb.com/title/tt0181689
  [959]: https://wikiless.org/wiki/Deepfake
  [960]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Deepfake
  [961]: https://web.archive.org/web/https://www.econotimes.com/Deepfake-Voice-Technology-The-Good-The-Bad-The-Future-1601278
  [962]: https://web.archive.org/web/https://www.forbes.com/sites/jessedamiani/2019/09/03/a-voice-deepfake-was-used-to-scam-a-ceo-out-of-243000/
  [963]: https://web.archive.org/web/https://josephsteinberg.com/how-to-prevent-facial-recognition-technology-from-identifying-you/
  [964]: https://web.archive.org/web/https://nvlpubs.nist.gov/nistpubs/ir/2020/NIST.IR.8311.pdf
  [965]: https://web.archive.org/web/https://www.bbc.com/news/technology-55573802
  [966]: https://web.archive.org/web/http://diglib.uwgb.edu/digital/api/collection/p17003coll4/id/71/download
  [967]: https://wikiless.org/wiki/Phishing
  [968]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Phishing
  [969]: https://wikiless.org/wiki/Social_engineering_(security)
  [970]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Social_engineering_(security)
  [971]: https://web.archive.org/web/https://www.bbc.com/news/technology-56071437
  [972]: https://wikiless.org/wiki/Exploit_(computer_security)
  [973]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Exploit_(computer_security)
  [974]: https://wikiless.org/wiki/Freedom_Hosting
  [975]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Freedom_Hosting
  [976]: https://web.archive.org/web/https://www.wired.com/2013/09/freedom-hosting-fbi/
  [977]: https://wikiless.org/wiki/2020_United_States_federal_government_data_breach
  [978]: https://web.archive.org/web/https://en.wikipedia.org/wiki/2020_United_States_federal_government_data_breach
  [979]: https://web.archive.org/web/https://www.bbc.com/news/blogs-china-blog-48552907
  [980]: https://27m3p2uv7igmj6kvd4ql3cct5h3sdwrsajovkkndeufumzyfhlfev4qd.onion/2021/01/29/china-uyghur-muslim-surveillance-police/
  [981]: https://web.archive.org/web/https://theintercept.com/2021/01/29/china-uyghur-muslim-surveillance-police/
  [982]: https://wikiless.org/wiki/Sandbox_(computer_security)
  [983]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Sandbox_(computer_security)
  [984]: https://web.archive.org/web/https://www.wired.com/2014/07/usb-security/
  [985]: https://wikiless.org/wiki/Stuxnet
  [986]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Stuxnet
  [987]: https://web.archive.org/web/https://superuser.com/questions/1206321/how-do-i-safely-investigate-a-usb-stick-found-in-the-parking-lot-at-work
  [988]: https://web.archive.org/web/https://www.theguardian.com/books/2014/may/12/glenn-greenwald-nsa-tampers-us-internet-routers-snowden
  [989]: https://wikiless.org/wiki/Rootkit
  [990]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Rootkit
  [991]: https://wikiless.org/wiki/User_space
  [992]: https://web.archive.org/web/https://en.wikipedia.org/wiki/User_space
  [993]: https://wikiless.org/wiki/Firmware
  [994]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Firmware
  [995]: https://wikiless.org/wiki/BIOS
  [996]: https://web.archive.org/web/https://en.wikipedia.org/wiki/BIOS
  [997]: https://wikiless.org/wiki/Unified_Extensible_Firmware_Interface
  [998]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Unified_Extensible_Firmware_Interface
  [999]: https://web.archive.org/web/https://www.bellingcat.com/news/americas/2018/10/26/joseph-mifsud-rush-exif/
  [1000]: https://web.archive.org/web/https://support.zoom.us/hc/en-us/articles/209605273-Adding-a-Watermark
  [1001]: https://web.archive.org/web/https://support.zoom.us/hc/en-us/articles/360021839031-Audio-Watermark
  [1002]: https://web.archive.org/web/https://exchange.adobe.com/creativecloud.details.101789.imatag-invisible-watermark-and-image-monitoring.html
  [1003]: https://web.archive.org/web/https://dtv.nagra.com/nexguard-forensic-watermarking
  [1004]: https://web.archive.org/web/https://www.vobilegroup.com
  [1005]: https://web.archive.org/web/https://www.cinavia.com/languages/english/pages/technology.html
  [1006]: https://web.archive.org/web/https://www.imatag.com/
  [1007]: https://wikiless.org/wiki/Steganography
  [1008]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Steganography
  [1009]: https://web.archive.org/web/https://ieeexplore.ieee.org/document/4428921
  [1010]: https://web.archive.org/web/https://www.sciencedirect.com/science/article/abs/pii/S0165168498000140
  [1011]: https://web.archive.org/web/https://ieeexplore.ieee.org/abstract/document/1188746
  [1012]: https://web.archive.org/web/https://scholar.google.com/scholar?q=source+camera+identification
  [1013]: https://wikiless.org/wiki/Machine_Identification_Code
  [1014]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Machine_Identification_Code
  [1015]: https://web.archive.org/web/http://seeingyellow.com/
  [1016]: https://web.archive.org/web/https://arxiv.org/abs/1107.4524
  [1017]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2019/03/26/how-to-track-illegal-funding-campaigns-via-cryptocurrency/
  [1018]: https://web.archive.org/web/https://www.coindesk.com/business/2021/09/21/leaked-slides-show-how-chainalysis-flags-crypto-suspects-for-cops/
  [1019]: https://wikiless.org/wiki/Know_your_customer
  [1020]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Know_your_customer
  [1021]: https://web.archive.org/web/https://arxiv.org/pdf/1906.05754.pdf
  [1022]: https://yewtu.be/playlist?list=PLsSYUeVwrHBnAUre2G_LYDsdo-tD0ov-y
  [1023]: https://web.archive.org/web/https://monero.org/monero-vs-princeton-researchers/
  [1024]: https://wikiless.org/wiki/Cryptocurrency_tumbler
  [1025]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Cryptocurrency_tumbler
  [1026]: https://wikiless.org/wiki/Security_through_obscurity
  [1027]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Security_through_obscurity
  [1028]: https://web.archive.org/web/https://arxiv.org/abs/2009.14007
  [1029]: https://web.archive.org/web/https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3080361
  [1030]: https://web.archive.org/web/https://www.magnetforensics.com/products/magnet-axiom/cloud/
  [1031]: https://web.archive.org/web/https://www.cellebrite.com/en/ufed-cloud/
  [1032]: https://web.archive.org/web/https://sites.google.com/a/chromium.org/dev/Home/chromium-security/client-identification-mechanisms
  [1033]: https://web.archive.org/web/https://wiki.mozilla.org/Fingerprinting
  [1034]: https://web.archive.org/web/https://www.grayshift.com/
  [1035]: https://web.archive.org/web/https://securephones.io/main.pdf
  [1036]: https://web.archive.org/web/https://loup-vaillant.fr/articles/rolling-your-own-crypto
  [1037]: https://web.archive.org/web/https://soatok.blog/2021/02/09/crackpot-cryptography-and-security-theater/
  [1038]: https://web.archive.org/web/https://www.vice.com/en/article/wnx8nq/why-you-dont-roll-your-own-crypto
  [1039]: https://web.archive.org/web/https://arxiv.org/pdf/2107.04940.pdf
  [1040]: https://yewtu.be/watch?v=loy84K3AJ5Q
  [1041]: https://web.archive.org/web/https://citizenlab.ca/2020/04/move-fast-roll-your-own-crypto-a-quick-look-at-the-confidentiality-of-zoom-meetings/
  [1042]: https://web.archive.org/web/https://medium.com/@atcipher/the-myth-of-military-grade-encryption-292313ae6369
  [1043]: https://web.archive.org/web/https://blog.congruentlabs.co/military-grade-encryption/
  [1044]: https://web.archive.org/web/https://blog.ironcorelabs.com/military-grade-encryption-69aae0145588
  [1045]: https://wikiless.org/wiki/BLAKE_(hash_function)#BLAKE2
  [1046]: https://web.archive.org/web/https://en.wikipedia.org/wiki/BLAKE_(hash_function)#BLAKE2
  [1047]: https://wikiless.org/wiki/AES_instruction_set
  [1048]: https://web.archive.org/web/https://en.wikipedia.org/wiki/AES_instruction_set
  [1049]: https://wikiless.org/wiki/Salsa20#ChaCha_variant
  [1050]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Salsa20#ChaCha_variant
  [1051]: https://wikiless.org/wiki/Serpent_(cipher)
  [1052]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Serpent_(cipher)
  [1053]: https://wikiless.org/wiki/Twofish
  [1054]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Twofish
  [1055]: https://web.archive.org/web/https://latacora.singles/2019/07/16/the-pgp-problem.html
  [1056]: https://wikiless.org/wiki/Shor%27s_algorithm
  [1057]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Shor%27s_algorithm
  [1058]: https://wikiless.org/wiki/Gag_order
  [1059]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Gag_order
  [1060]: https://wikiless.org/wiki/National_security_letter
  [1061]: https://web.archive.org/web/https://en.wikipedia.org/wiki/National_security_letter
  [1062]: https://web.archive.org/web/https://techcrunch.com/2021/09/06/protonmail-logged-ip-address-of-french-activist-after-order-by-swiss-authorities/
  [1063]: https://web.archive.org/web/https://arstechnica.com/gadgets/2021/07/vpn-servers-seized-by-ukrainian-authorities-werent-encrypted/
  [1064]: https://web.archive.org/web/https://www.bleepingcomputer.com/news/security/doublevpn-servers-logs-and-account-info-seized-by-law-enforcement/
  [1065]: https://web.archive.org/web/https://www.cyberscoop.com/court-rules-encrypted-email-tutanota-monitor-messages/
  [1066]: https://web.archive.org/web/https://www.heise.de/news/Gericht-zwingt-Mailprovider-Tutanota-zu-Ueberwachungsfunktion-4972460.html
  [1067]: https://web.archive.org/web/https://www.pcmag.com/opinions/did-purevpn-cross-a-line-when-it-disclosed-user-information
  [1068]: https://web.archive.org/web/https://archive.is/XNuVw
  [1069]: https://wikiless.org/wiki/Lavabit
  [1070]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Lavabit
  [1071]: https://wikiless.org/wiki/Warrant_canary
  [1072]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Warrant_canary
  [1073]: https://web.archive.org/web/https://www.washingtonpost.com/graphics/2020/world/national-security/cia-crypto-encryption-machines-espionage/
  [1074]: https://web.archive.org/web/https://www.swissinfo.ch/eng/second-swiss-firm-allegedly-sold-encrypted-spying-devices/46186432
  [1075]: https://wikiless.org/wiki/The_Lives_of_Others
  [1076]: https://web.archive.org/web/https://en.wikipedia.org/wiki/The_Lives_of_Others
  [1077]: https://web.archive.org/web/https://www.wired.com/story/air-gap-researcher-mordechai-guri/
  [1078]: https://web.archive.org/web/https://www.scientificamerican.com/article/a-blank-wall-can-show-how-many-people-are-in-a-room-and-what-theyre-doing/
  [1079]: https://web.archive.org/web/https://www.scientificamerican.com/article/a-shiny-snack-bags-reflections-can-reconstruct-the-room-around-it/
  [1080]: https://web.archive.org/web/https://www.scientificamerican.com/article/footstep-sensors-identify-people-by-gait/
  [1081]: https://web.archive.org/web/https://www.nassiben.com/lamphone
  [1082]: https://web.archive.org/web/https://www.theguardian.com/world/2013/aug/22/gchq-warned-laser-spying-guardian-offices
  [1083]: https://web.archive.org/web/https://arstechnica.com/tech-policy/2014/05/photos-of-an-nsa-upgrade-factory-show-cisco-router-getting-implant/
  [1084]: https://wikiless.org/wiki/OONI
  [1085]: https://web.archive.org/web/https://en.wikipedia.org/wiki/OONI
  [1086]: https://web.archive.org/web/https://privacyinternational.org/long-read/3018/timeline-sim-card-registration-laws
  [1087]: https://web.archive.org/web/https://www.nytimes.com/2021/01/12/technology/bitcoin-passwords-wallets-fortunes.html
  [1088]: https://web.archive.org/web/https://www.usenix.org/system/files/conference/woot17/woot17-paper-obermaier.pdf
  [1089]: https://web.archive.org/web/https://support.torproject.org/tormobile/tormobile-3/
  [1090]: https://wikiless.org/wiki/Tails_(operating_system)
  [1091]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Tails_(operating_system)
  [1092]: https://web.archive.org/web/https://www.veracrypt.fr/en/Trim%20Operation.html
  [1093]: https://web.archive.org/web/https://www.coreboot.org/
  [1094]: https://wikiless.org/wiki/Booting
  [1095]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Booting
  [1096]: https://web.archive.org/web/https://www.wired.com/2013/12/better-data-security-nail-polish/
  [1097]: https://wikiless.org/wiki/Virtual_machine
  [1098]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Virtual_machine
  [1099]: https://wikiless.org/wiki/Plausible_deniability
  [1100]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Plausible_deniability
  [1101]: https://wikiless.org/wiki/Deniable_encryption
  [1102]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Deniable_encryption
  [1103]: https://web.archive.org/web/https://privacyguides.org/operating-systems/#win10
  [1104]: https://wikiless.org/wiki/BitLocker
  [1105]: https://web.archive.org/web/https://en.wikipedia.org/wiki/BitLocker
  [1106]: https://wikiless.org/wiki/Evil_maid_attack
  [1107]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Evil_maid_attack
  [1108]: https://wikiless.org/wiki/Cold_boot_attack
  [1109]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Cold_boot_attack
  [1110]: https://yewtu.be/watch?v=JDaicPIgn9U
  [1111]: https://web.archive.org/web/https://www.researchgate.net/publication/318155607_Defeating_Plausible_Deniability_of_VeraCrypt_Hidden_Operating_Systems
  [1112]: https://web.archive.org/web/https://www.sans.org/reading-room/whitepapers/forensics/mission-implausible-defeating-plausible-deniability-digital-forensics-39500
  [1113]: https://web.archive.org/web/https://sourceforge.net/p/veracrypt/discussion/technical/thread/53f33faf/
  [1114]: https://web.archive.org/web/https://docs.microsoft.com/en-us/windows/security/information-protection/bitlocker/bitlocker-countermeasures
  [1115]: https://web.archive.org/web/https://www.sans.org/reading-room/whitepapers/forensics/windows-shellbag-forensics-in-depth-34545
  [1116]: https://web.archive.org/web/https://eprints.whiterose.ac.uk/75046/1/Forensic_Data_Recovery_From_The_Windows_Search_Database_preprint_DIIN328.pdf
  [1117]: https://web.archive.org/web/https://cyberforensicator.com/wp-content/uploads/2017/01/1-s2.0-S1742287616300202-main.2-14.pdf
  [1118]: https://wikiless.org/wiki/Gatekeeper_(macOS)
  [1119]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Gatekeeper_(macOS)
  [1120]: https://web.archive.org/web/https://wiki.alpinelinux.org/wiki/Setting_up_a_laptop
  [1121]: https://wikiless.org/wiki/VeraCrypt
  [1122]: https://web.archive.org/web/https://en.wikipedia.org/wiki/VeraCrypt
  [1123]: https://web.archive.org/web/https://www.veracrypt.fr/en/Unencrypted%20Data%20in%20RAM.html
  [1124]: https://web.archive.org/web/https://www.veracrypt.fr/code/VeraCrypt/plain/doc/html/Data%20Leaks.html
  [1125]: https://web.archive.org/web/https://dolosgroup.io/blog/2021/7/9/from-stolen-laptop-to-inside-the-company-network
  [1126]: https://web.archive.org/web/https://trmm.net/tpm-sniffing/
  [1127]: https://nitter.net/SecurityJon/status/1445020885472235524
  [1128]: https://web.archive.org/web/https://labs.f-secure.com/blog/sniff-there-leaks-my-bitlocker-key/
  [1129]: https://web.archive.org/web/https://www.veracrypt.fr/en/VeraCrypt%20Rescue%20Disk.html
  [1130]: https://web.archive.org/web/20211009021236/https://repository.stcloudstate.edu/cgi/viewcontent.cgi?article=1141&context=msia_etds
  [1131]: https://web.archive.org/web/https://www.windowscentral.com/how-ensure-trim-enabled-windows-10-speed-ssd-performance
  [1132]: https://web.archive.org/web/https://veracrypt.eu/en/docs/trim-operation/
  [1133]: https://web.archive.org/web/https://i.blackhat.com/eu-18/Thu-Dec-6/eu-18-Schaub-Perfectly-Deniable-Steganographic-Disk-Encryption.pdf
  [1134]: https://web.archive.org/web/http://asalor.blogspot.com/2011/08/trim-dm-crypt-problems.html
  [1135]: https://wikiless.org/wiki/VirtualBox
  [1136]: https://web.archive.org/web/https://en.wikipedia.org/wiki/VirtualBox
  [1137]: https://web.archive.org/web/https://www.virtualbox.org/ticket/17987
  [1138]: https://wikiless.org/wiki/Whonix
  [1139]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Whonix
  [1140]: https://web.archive.org/web/https://docs.oracle.com/en/virtualization/virtualbox/6.0/user/snapshots.html
  [1141]: https://wikiless.org/wiki/Spectre_(security_vulnerability)
  [1142]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Spectre_(security_vulnerability)
  [1143]: https://wikiless.org/wiki/Meltdown_(security_vulnerability)
  [1144]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Meltdown_(security_vulnerability)
  [1145]: https://web.archive.org/web/https://www.whonix.org/wiki/Stream_Isolation#By_Settings
  [1146]: https://wikiless.org/wiki/Time-based_One-time_Password_algorithm
  [1147]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Time-based_One-time_Password_algorithm
  [1148]: https://wikiless.org/wiki/Multi-factor_authentication
  [1149]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Multi-factor_authentication
  [1150]: https://web.archive.org/web/https://www.whonix.org/wiki/Whonix-Gateway_Security#Warning:_Bridged_Networking
  [1151]: https://web.archive.org/web/https://www.qubes-os.org/faq/#is-qubes-just-another-linux-distribution
  [1152]: https://web.archive.org/web/https://www.qubes-os.org/doc/system-requirements/
  [1153]: https://web.archive.org/web/https://github.com/QubesOS/qubes-issues/issues/2414
  [1154]: https://wikiless.org/wiki/AppArmor
  [1155]: https://web.archive.org/web/https://en.wikipedia.org/wiki/AppArmor
  [1156]: https://wikiless.org/wiki/Security-Enhanced_Linux
  [1157]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Security-Enhanced_Linux
  [1158]: https://wikiless.org/wiki/CAPTCHA
  [1159]: https://web.archive.org/web/https://en.wikipedia.org/wiki/CAPTCHA
  [1160]: https://wikiless.org/wiki/Turing_test
  [1161]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Turing_test
  [1162]: https://web.archive.org/web/https://www.google.com/recaptcha/about/
  [1163]: https://web.archive.org/web/https://www.hcaptcha.com/
  [1164]: https://web.archive.org/web/https://www.hcaptcha.com/post/hcaptcha-now-the-largest-independent-captcha-service
  [1165]: https://web.archive.org/web/https://nearcyan.com/you-probably-dont-need-recaptcha/
  [1166]: https://web.archive.org/web/https://arstechnica.com/gadgets/2017/03/googles-recaptcha-announces-invisible-background-captchas/
  [1167]: https://web.archive.org/web/https://www.blackhat.com/docs/asia-16/materials/asia-16-Sivakorn-Im-Not-a-Human-Breaking-the-Google-reCAPTCHA-wp.pdf
  [1168]: https://web.archive.org/web/https://security.googleblog.com/2014/12/are-you-robot-introducing-no-captcha.html
  [1169]: https://web.archive.org/web/https://blog.cloudflare.com/cloudflare-supports-privacy-pass/
  [1170]: https://wikiless.org/wiki/Device_fingerprint
  [1171]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Device_fingerprint
  [1172]: https://web.archive.org/web/https://developers.googleblog.com/2020/08/guidance-for-our-effort-to-block-less-secure-browser-and-apps.html
  [1173]: https://web.archive.org/web/https://support.google.com/accounts/answer/10071085
  [1174]: https://wikiless.org/wiki/Dark_pattern
  [1175]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Dark_pattern
  [1176]: https://web.archive.org/web/https://www.theverge.com/2020/1/23/21077423/tinder-photo-verification-blue-checkmark-safety-center-launch-noonlight
  [1177]: https://web.archive.org/web/https://www.digitalinformationworld.com/2020/03/facebook-is-now-demanding-some-users-to-create-a-video-selfie-for-identity-verification.html
  [1178]: https://web.archive.org/web/https://www.vice.com/en/article/m7a4eq/pornhub-new-verification-policy-biometric-id
  [1179]: https://web.archive.org/web/https://variety.com/2021/digital/news/china-censorship-hotline-historical-nihilism-1234950554/
  [1180]: https://wikiless.org/wiki/Zero_trust_security_model
  [1181]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Zero_trust_security_model
  [1182]: https://wikiless.org/wiki/Espionage
  [1183]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Espionage
  [1184]: https://web.archive.org/web/https://kcimc.medium.com/how-to-recognize-fake-ai-generated-images-4d1f6f9a2842
  [1185]: https://web.archive.org/web/https://blog.jayway.com/2020/03/06/using-ml-to-detect-fake-face-images-created-by-ai/
  [1186]: https://wikiless.org/wiki/SIM_swap_scam
  [1187]: https://web.archive.org/web/https://en.wikipedia.org/wiki/SIM_swap_scam
  [1188]: https://web.archive.org/web/https://www.whonix.org/wiki/Tor
  [1189]: https://web.archive.org/web/https://support.torproject.org/tbb/tbb-editing-torrc/
  [1190]: https://web.archive.org/web/https://support.google.com/accounts/answer/114129?hl=en
  [1191]: https://web.archive.org/web/https://support.google.com/google-ads/answer/7474263?hl=en
  [1192]: https://web.archive.org/web/https://support.google.com/accounts/answer/40695
  [1193]: https://web.archive.org/web/https://support.google.com/accounts/contact/disabled2
  [1194]: https://web.archive.org/web/https://support.google.com/accounts/answer/1333913?hl=en
  [1195]: https://web.archive.org/web/https://www.jumio.com/features/
  [1196]: https://web.archive.org/web/https://privacyguides.org/providers/email/
  ...
  [1197]: https://web.archive.org/web/https://protonmail.com/support/knowledge-base/human-verification/
  [1198]: https://web.archive.org/web/https://knowyourmeme.com/memes/good-luck-im-behind-7-proxies
  [1199]: https://wikiless.org/wiki/End-to-end_encryption
  [1200]: https://web.archive.org/web/https://en.wikipedia.org/wiki/End-to-end_encryption
  [1201]: https://wikiless.org/wiki/Forward_secrecy
  [1202]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Forward_secrecy
  [1203]: https://web.archive.org/web/https://protonmail.com/blog/zero-access-encryption/
  [1204]: https://wikiless.org/wiki/Facebook%E2%80%93Cambridge_Analytica_data_scandal
  [1205]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Facebook%E2%80%93Cambridge_Analytica_data_scandal
  [1206]: https://web.archive.org/web/https://signal.org/blog/sealed-sender/
  [1207]: https://web.archive.org/web/https://signal.org/blog/private-contact-discovery/
  [1208]: https://web.archive.org/web/https://signal.org/blog/signal-private-group-system/
  [1209]: https://web.archive.org/web/https://privacyguides.org/software/file-sharing/
  [1210]: https://web.archive.org/web/https://privacyguides.org/software/real-time-communication/
  [1211]: https://web.archive.org/web/https://getsession.org/session-protocol-explained/
  [1212]: https://web.archive.org/web/https://blog.quarkslab.com/audit-of-session-secure-messaging-application.html
  [1213]: https://yewtu.be/watch?v=aVwl892hqb4
  [1214]: https://wikiless.org/wiki/InterPlanetary_File_System
  [1215]: https://web.archive.org/web/https://en.wikipedia.org/wiki/InterPlanetary_File_System
  [1216]: https://web.archive.org/web/https://www.praxisfilms.org/open-letter-from-laura-poitras/
  [1217]: https://wikiless.org/wiki/SecureDrop
  [1218]: https://web.archive.org/web/https://en.wikipedia.org/wiki/SecureDrop
  [1219]: https://wikiless.org/wiki/Trusted_Platform_Module
  [1220]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Trusted_Platform_Module
  [1221]: https://wikiless.org/wiki/Pastebin
  [1222]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Pastebin
  [1223]: https://wikiless.org/wiki/Wear_leveling
  [1224]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Wear_leveling
  [1225]: https://wikiless.org/wiki/Write_amplification
  [1226]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Write_amplification
  [1227]: https://web.archive.org/web/https://techgage.com/article/too_trim_when_ssd_data_recovery_is_impossible/
  [1228]: https://web.archive.org/web/https://www.researchgate.net/publication/341761017_Live_forensics_method_for_acquisition_on_the_Solid_State_Drive_SSD_NVMe_TRIM_function
  [1229]: https://web.archive.org/web/https://blog.elcomsoft.com/2019/01/life-after-trim-using-factory-access-mode-for-imaging-ssd-drives/
  [1230]: https://web.archive.org/web/https://www.forensicfocus.com/articles/forensic-acquisition-of-solid-state-drives-with-open-source-tools/
  [1231]: https://web.archive.org/web/https://www.researchgate.net/publication/325976653_Solid_State_Drive_Forensics_Where_Do_We_Stand
  [1232]: https://wikiless.org/wiki/Parted_Magic
  [1233]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Parted_Magic
  [1234]: https://wikiless.org/wiki/Hdparm
  [1235]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Hdparm
  [1236]: https://web.archive.org/web/https://github.com/linux-nvme/nvme-cli
  [1237]: https://web.archive.org/web/https://partedmagic.com/secure-erase/
  [1238]: https://web.archive.org/web/https://partedmagic.com/nvme-secure-erase/
  [1239]: https://web.archive.org/web/https://www.ufsexplorer.com/solutions/data-recovery-on-encrypted-storage.php
  [1240]: https://web.archive.org/web/https://developer.apple.com/library/archive/documentation/FileManagement/Conceptual/APFS_Guide/FAQ/FAQ.html
  [1241]: https://web.archive.org/web/https://privacyguides.org/software/productivity/
  [1242]: https://web.archive.org/web/https://www.whonix.org/wiki/Metadata
  [1243]: https://web.archive.org/web/https://gitlab.tails.boum.org/tails/blueprints/-/wikis/doc/mat/
  [1244]: https://web.archive.org/web/https://disable-gatekeeper.github.io/
  [1245]: https://web.archive.org/web/https://help.duckduckgo.com/duckduckgo-help-pages/features/cache/
  [1246]: https://web.archive.org/web/https://help.duckduckgo.com/duckduckgo-help-pages/results/sources/
  [1247]: https://wikiless.org/wiki/Dead_drop
  [1248]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Dead_drop
  [1249]: https://wikiless.org/wiki/Obfuscation
  [1250]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Obfuscation
  [1251]: https://wikiless.org/wiki/Kleptography
  [1252]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Kleptography
  [1253]: https://wikiless.org/wiki/Koalang
  [1254]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Koalang
  [1255]: https://wikiless.org/wiki/Operations_security
  [1256]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Operations_security
  [1257]: https://web.archive.org/web/https://quoteinvestigator.com/2014/07/13/truth/
  [1258]: https://web.archive.org/web/https://privacyguides.org/operating-systems/
  [1259]: https://web.archive.org/web/https://support.brave.com/hc/en-us/articles/360018121491-What-is-a-Private-Window-with-Tor-
  [1260]: https://web.archive.org/web/https://medium.com/velociraptor-ir/the-windows-usn-journal-f0c55c9010e
  [1261]: https://web.archive.org/web/https://medium.com/velociraptor-ir/digging-into-the-system-resource-usage-monitor-srum-afbadb1a375
  [1262]: https://web.archive.org/web/https://www.sans.org/blog/timestamped-registry-ntfs-artifacts-from-unallocated-space/
  [1263]: https://web.archive.org/web/https://dban.org/
  [1264]: https://web.archive.org/web/https://crystalmark.info/en/software/crystaldiskinfo/
  [1265]: https://wikiless.org/wiki/Faraday_cage
  [1266]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Faraday_cage
  [1267]: https://web.archive.org/web/20211011220410/https://ro.ecu.edu.au/cgi/viewcontent.cgi?article=1165&context=adf
  [1268]: https://web.archive.org/web/https://arxiv.org/abs/1512.05616
  [1269]: https://web.archive.org/web/https://dl.acm.org/doi/pdf/10.1145/3309074.3309076
  [1270]: https://yewtu.be/watch?v=sO98kDLkh-M
  [1271]: https://wikiless.org/wiki/Touch_DNA
  [1272]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Touch_DNA
  [1273]: https://web.archive.org/web/https://www.yourdnaguide.com/ydgblog/dna-hair-samples-postage-stamps
  [1274]: https://web.archive.org/web/https://github.com/mhinkie/ooni-detection
  [1275]: https://wikiless.org/wiki/File_verification
  [1276]: https://web.archive.org/web/https://en.wikipedia.org/wiki/File_verification
  [1277]: https://wikiless.org/wiki/Cyclic_redundancy_check
  [1278]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Cyclic_redundancy_check
  [1279]: https://wikiless.org/wiki/MD5
  [1280]: https://web.archive.org/web/https://en.wikipedia.org/wiki/MD5
  [1281]: https://wikiless.org/wiki/Collision_(computer_science)
  [1282]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Collision_(computer_science)
  [1283]: https://wikiless.org/wiki/Secure_Hash_Algorithms
  [1284]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Secure_Hash_Algorithms
  [1285]: https://wikiless.org/wiki/SHA-2
  [1286]: https://web.archive.org/web/https://en.wikipedia.org/wiki/SHA-2
  [1287]: https://wikiless.org/wiki/Collision_resistance
  [1288]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Collision_resistance
  [1289]: https://web.archive.org/web/https://wiki.gnupg.org/Gpg4win/CheckIntegrity
  [1290]: https://web.archive.org/web/https://medium.com/@EvgeniIvanov/how-to-verify-checksum-on-mac-988f166b0c4f
  [1291]: https://wikiless.org/wiki/GNU_Privacy_Guard
  [1292]: https://web.archive.org/web/https://en.wikipedia.org/wiki/GNU_Privacy_Guard
  [1293]: https://wikiless.org/wiki/Public-key_cryptography
  [1294]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Public-key_cryptography
  [1295]: https://wikiless.org/wiki/Polymorphic_code
  [1296]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Polymorphic_code
  [1297]: https://web.archive.org/web/https://www.whonix.org/wiki/Malware_and_Firmware_Trojans
  [1298]: https://web.archive.org/web/https://forums.whonix.org/t/installation-of-antivirus-scanners-by-default/9755/8
  [1299]: https://web.archive.org/web/https://www.av-test.org/fileadmin/pdf/security_report/AV-TEST_Security_Report_2018-2019.pdf
  [1300]: https://web.archive.org/web/https://www.zdnet.com/article/eset-discovers-21-new-linux-malware-families/
  [1301]: https://web.archive.org/web/https://nakedsecurity.sophos.com/2019/07/25/evilgnome-linux-malware-aimed-at-your-laptop-not-your-servers/
  [1302]: https://web.archive.org/web/https://blog.imunify360.com/hiddenwasp-how-to-detect-malware-hidden-on-linux-iot
  [1303]: https://wikiless.org/wiki/Linux_malware
  [1304]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Linux_malware
  [https://en.wikipedia.org/wiki/macOS_malware]: https://en.wikipedia.org/wiki/MacOS_malware
  [1305]: https://wikiless.org/wiki/MacOS_malware
  [1306]: https://web.archive.org/web/https://en.wikipedia.org/wiki/MacOS_malware
  [1307]: https://web.archive.org/web/https://www.macworld.co.uk/feature/mac-viruses-list-3668354/
  [1308]: https://web.archive.org/web/https://resources.jamf.com/documents/macmalware-2020.pdf
  [1309]: https://web.archive.org/web/https://imagetragick.com/
  [1310]: https://web.archive.org/web/https://docs.oracle.com/en/virtualization/virtualbox/6.0/admin/hyperv-support.html
  [1311]: https://web.archive.org/web/https://zeltser.com/analyzing-malicious-documents/
  [1312]: https://wikiless.org/wiki/Portable_application
  [1313]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Portable_application
  [1314]: https://web.archive.org/web/https://ebin.city/~werwolf/posts/brave-is-shit/
  [1315]: https://web.archive.org/web/https://support.brave.com/hc/en-us/articles/360022973471-What-is-Shields
  [1316]: https://web.archive.org/web/https://venturebeat.com/2020/01/15/browser-benchmark-battle-january-2020-chrome-firefox-edge-brave/view-all/
  [1317]: https://web.archive.org/web/https://madaidans-insecurities.github.io/firefox-chromium.html
  [1318]: https://web.archive.org/web/https://grapheneos.org/usage#web-browsing
  [1319]: https://web.archive.org/web/https://www.researchgate.net/publication/349979628_Web_Browser_Privacy_What_Do_Browsers_Say_When_They_Phone_Home
  [1320]: https://web.archive.org/web/https://docs.microsoft.com/en-us/deployedge/microsoft-edge-security-windows-defender-application-guard
  [1321]: https://web.archive.org/web/https://www.pcmag.com/news/mozilla-signs-lucrative-3-year-google-search-deal-for-firefox
  [1322]: https://wikiless.org/wiki/Virtualization
  [1323]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Virtualization
  [1324]: https://web.archive.org/web/https://github.com/Yawning/obfs4/
  [1325]: https://web.archive.org/web/https://tb-manual.torproject.org/circumvention/
  [1326]: https://wikiless.org/wiki/Domain_fronting
  [1327]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Domain_fronting
  [1328]: https://web.archive.org/web/https://gitlab.torproject.org/tpo/applications/tor-browser/-/issues/17569
  [1329]: https://web.archive.org/web/https://www.vice.com/en/article/93ypke/the-nsa-and-cia-use-ad-blockers-because-online-advertising-is-so-dangerous
  [1330]: https://web.archive.org/web/https://www.tbstat.com/wp/uploads/2020/06/Europol-Wasabi-Wallet-Report.pdf
  [1331]: https://web.archive.org/web/https://www.sans.org/blog/nist-has-spoken-death-to-complexity-long-live-the-passphrase/
  [1332]: https://web.archive.org/web/https://www.zdnet.com/article/fbi-recommends-passphrases-over-password-complexity/
  [1333]: https://27m3p2uv7igmj6kvd4ql3cct5h3sdwrsajovkkndeufumzyfhlfev4qd.onion/2015/03/26/passphrases-can-memorize-attackers-cant-guess/
  [1334]: https://web.archive.org/web/https://theintercept.com/2015/03/26/passphrases-can-memorize-attackers-cant-guess/
  [1335]: https://web.archive.org/web/https://protonmail.com/blog/protonmail-com-blog-password-vs-passphrase/
  [1336]: https://yewtu.be/watch?v=yzGzB-yYKcc
  [1337]: https://wikiless.org/wiki/Passphrase#Passphrase_selection
  [1338]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Passphrase#Passphrase_selection
  [1339]: https://web.archive.org/web/https://github.com/insight-decentralized-consensus-lab/post-quantum-monero/blob/master/writeups/technical_note.pdf
