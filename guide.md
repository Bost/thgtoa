...
Version 1.0.8, October 2021 by AnonymousPlanet.
...
-   If you are reading this in PDF or ODT format, you will notice plenty of \`\`\` in place of double quotes (""). These \`\`\` should be ignored and are just there to ease conversion into Markdown/HTML format for online viewing of code blocks.
...
More information over at Wikipedia: <https://en.wikipedia.org/wiki/Radio-frequency_identification#Security_concerns> <sup>[[Wikiless]][57]</sup> <sup>[[Archive.org]][58]</sup> and <https://en.wikipedia.org/wiki/Radio-frequency_identification#Privacy> <sup>[[Wikiless]][57]</sup> <sup>[[Archive.org]][58]</sup>
...
Other researchers have found a way to count the people in a defined space using only Wi-Fi, see <https://www.news.ucsb.edu/2021/020392/dont-fidget-wifi-will-count-you> <sup>[[Archive.org]][61]</sup>
...
Here is another video of the same kind of tech in action: <https://www.youtube.com/watch?v=FDZ39h-kCS8> <sup>[[Invidious]][63]</sup>
...
These have been used since at least since 2008 using an attack called "Jasager"[^61] and can be done by anyone using self-built tools or using commercially available devices such as Wi-Fi Pineapple[^62].
...
-   YouTube, Hak5, Wi-Fi Pineapple Mark VII <https://www.youtube.com/watch?v=7v3JR4Wlw4Q> <sup>[[Invidious]][64]</sup>
...
I also strongly recommend reading this very good, complete, and thorough (and more detailed) guide on most known Attack Vectors on Tor: <https://github.com/Attacks-on-Tor/Attacks-on-Tor> <sup>[[Archive.org]][69]</sup> as well as this recent research publication <https://www.researchgate.net/publication/323627387_Shedding_Light_on_the_Dark_Corners_of_the_Internet_A_Survey_of_Tor_Research> <sup>[[Archive.org]][70]</sup>

As well as this great series of blog posts: <https://www.hackerfactor.com/blog/index.php?/archives/906-Tor-0day-The-Management-Vulnerability.html> <sup>[[Archive.org]][71]</sup>
...
**Disclaimer: it should also be noted that Tor is not designed to protect against a global adversary. For more information see <https://svn-archive.torproject.org/svn/projects/design-paper/tor-design.pdf> <sup>[[Archive.org]][72]</sup> and specifically, "Part 3. Design goals and assumptions.".**
...
Here is also a good YouTube video on this topic: DEFCON Safe Mode - Cooper Quintin - Detecting Fake 4G Base Stations in Real-Time <https://www.youtube.com/watch?v=siCk4pGGcqA> <sup>[[Invidious]][73]</sup>
...
Note that to AMD's defense, so far and AFAIK, there were no security vulnerabilities found for ASP and no backdoors either: See <https://www.youtube.com/watch?v=bKH5nGLgi08&t=2834s> <sup>[[Invidious]][75]</sup>. In addition, AMD PSP does not provide any remote management capabilities contrary to Intel IME.
...
In addition, some CPUs have unfixable flaws (especially Intel CPUs) that could be exploited by various malware. Here is a good current list of such vulnerabilities affecting recent widespread CPUs: <https://en.wikipedia.org/wiki/Transient_execution_CPU_vulnerability> <sup>[[Wikiless]][76]</sup> <sup>[[Archive.org]][77]</sup>

Check yourself:

-   If you are using Linux you can check the vulnerability status of your CPU to Spectre/Meltdown attacks by using <https://github.com/speed47/spectre-meltdown-checker> <sup>[[Archive.org]][78]</sup> which is available as a package for most Linux distros including Whonix.

-   If you are using Windows, you can check the vulnerability status of your CPU using inSpectre <https://www.grc.com/inspectre.htm> <sup>[[Archive.org]][79]</sup>

Some of these can be avoided using Virtualization Software settings that can mitigate such exploits. See this guide for more information <https://www.whonix.org/wiki/Spectre_Meltdown> <sup>[[Archive.org]][80]</sup> (warning: these can severely impact the performance of your VMs).
...
-   Android/Google:
    ...
    -   Just have a read at their privacy policy <https://policies.google.com/privacy> <sup>[[Archive.org]][81]</sup>

    -   School of Computer Science & Statistics, Trinity College Dublin, Ireland Mobile Handset Privacy: Measuring The Data iOS and Android Send to Apple And Google <https://www.scss.tcd.ie/doug.leith/apple_google.pdf> <sup>[[Archive.org]][82]</sup>

-   IOS/Apple:

    -   More information at <https://www.apple.com/legal/privacy/en-ww/> <sup>[[Archive.org]][83]</sup> and <https://support.apple.com/en-us/HT202100> <sup>[[Archive.org]][84]</sup>
...
-   Windows/Microsoft:
    ...
    -   Full list of required diagnostic data: <https://docs.microsoft.com/en-us/windows/privacy/required-windows-diagnostic-data-events-and-fields-2004> <sup>[[Archive.org]][85]</sup>

    -   Full list of optional diagnostic data: <https://docs.microsoft.com/en-us/windows/privacy/windows-diagnostic-data> <sup>[[Archive.org]][86]</sup>

-   macOS:

    -   More details on <https://support.apple.com/guide/mac-help/share-analytics-information-mac-apple-mh27990/mac> <sup>[[Archive.org]][87]</sup>

-   Ubuntu:

    -   Ubuntu despite being a Linux distribution also collects Telemetry Data nowadays. This data however is quite limited compared to the others. More details on <https://ubuntu.com/desktop/statistics> <sup>[[Archive.org]][88]</sup>
...
See "We kill people based on Metadata"[^137] or this famous tweet from the IDF <https://twitter.com/idf/status/1125066395010699264> <sup>[[Archive.org]][89]</sup> <sup>[[Nitter]][90]</sup>.
...
-   Specialized companies are selling to, for example, law enforcement agencies products for analyzing social network activities such as <https://mediasonar.com/> <sup>[[Archive.org]][91]</sup>

-   For example, as a basis of authentication, a user's typing speed, keystroke depressions, patterns of error (say accidentally hitting an "l" instead of a "k" on three out of every seven transactions) and mouse movements establish that person's unique pattern of behavior[^146]. Some commercial services such as TypingDNA (<https://www.typingdna.com/> <sup>[[Archive.org]][92]</sup>) even offer such analysis as a replacement for two-factor authentications.
...
-   2017, Behavior Analysis in Social Networks, <https://link.springer.com/10.1007/978-1-4614-7163-9_110198-1> <sup>[[Archive.org]][93]</sup>

-   2017, Social Networks and Positive and Negative Affect <https://www.sciencedirect.com/science/article/pii/S1877042811013747/pdf?md5=253d8f1bb615d5dee195d353dc077d46&pid=1-s2.0-S1877042811013747-main.pdf> <sup>[[Archive.org]][94]</sup>

-   2015, Using Social Networks Data for Behavior and Sentiment Analysis <https://www.researchgate.net/publication/300562034_Using_Social_Networks_Data_for_Behavior_and_Sentiment_Analysis> <sup>[[Archive.org]][95]</sup>

-   2016, A Survey on User Behavior Analysis in Social Networks <https://www.academia.edu/30936118/A_Survey_on_User_Behaviour_Analysis_in_Social_Networks> <sup>[[Archive.org]][96]</sup>

-   2019, In­fluence and Behavior Analysis in Social Networks and Social Media <https://sci-hub.se/10.1007/978-3-030-02592-2> <sup>[[Archive.org]][97]</sup>
...
There are also a few cases involving OSINT at Bellingcat[^148]. Have a look at their very informative (but slightly outdated) toolkit here: <https://docs.google.com/spreadsheets/d/18rtqh8EG2q1xBo2cLNyhIDuK9jrPGwYr9DI2UncoqJQ/edit#gid=930747607> <sup>[[Archive.org]][98]</sup>
...
-   <https://github.com/jivoi/awesome-osint> <sup>[[Archive.org]][99]</sup>
...
As well as this interesting Playlist on YouTube: <https://www.youtube.com/playlist?list=PLrFPX1Vfqk3ehZKSFeb9pVIHqxqrNW8Sy> <sup>[[Invidious]][100]</sup>
...
-   Bellingcat, Guide To Using Reverse Image Search For Investigations: <https://www.bellingcat.com/resources/how-tos/2019/12/26/guide-to-using-reverse-image-search-for-investigations/> <sup>[[Archive.org]][101]</sup>

-   Bellingcat, Using the New Russian Facial Recognition Site SearchFace <https://www.bellingcat.com/resources/how-tos/2019/02/19/using-the-new-russian-facial-recognition-site-searchface-ru/> <sup>[[Archive.org]][102]</sup>

-   Bellingcat, Dali, Warhol, Boshirov: Determining the Time of an Alleged Photograph from Skripal Suspect Chepiga <https://www.bellingcat.com/resources/how-tos/2018/10/24/dali-warhol-boshirov-determining-time-alleged-photograph-skripal-suspect-chepiga/> <sup>[[Archive.org]][103]</sup>

-   Bellingcat, Advanced Guide on Verifying Video Content <https://www.bellingcat.com/resources/how-tos/2017/06/30/advanced-guide-verifying-video-content/> <sup>[[Archive.org]][104]</sup>

-   Bellingcat, Using the Sun and the Shadows for Geolocation <https://www.bellingcat.com/resources/2020/12/03/using-the-sun-and-the-shadows-for-geolocation/> <sup>[[Archive.org]][105]</sup>

-   Bellingcat, Navalny Poison Squad Implicated in Murders of Three Russian Activists <https://www.bellingcat.com/news/uk-and-europe/2021/01/27/navalny-poison-squad-implicated-in-murders-of-three-russian-activists/> <sup>[[Archive.org]][106]</sup>

-   Bellingcat, Berlin Assassination: New Evidence on Suspected FSB Hitman Passed to German Investigators <https://www.bellingcat.com/news/2021/03/19/berlin-assassination-new-evidence-on-suspected-fsb-hitman-passed-to-german-investigators/> <sup>[[Archive.org]][107]</sup>

-   Bellingcat, Digital Research Tutorial: Investigating a Saudi-Led Coalition Bombing of a Yemen Hospital <https://www.youtube.com/watch?v=cAVZaPiVArA> <sup>[[Invidious]][108]</sup>

-   Bellingcat, Digital Research Tutorial: Using Facial Recognition in Investigations <https://www.youtube.com/watch?v=awY87q2Mr0E> <sup>[[Invidious]][109]</sup>

-   Bellingcat, Digital Research Tutorial: Geolocating (Allegedly) Corrupt Venezuelan Officials in Europe <https://www.youtube.com/watch?v=bS6gYWM4kzY> <sup>[[Invidious]][110]</sup>
...
(Illustration from <https://www.nature.com/articles/s41598-020-79310-1> <sup>[[Archive.org]][112]</sup>)

![][113]

(illustration from <https://rd.springer.com/chapter/10.1007/978-3-030-42504-3_15> <sup>[[Archive.org]][114]</sup>)
...
-   CCC video explaining current Law Enforcement surveillance capabilities: <https://media.ccc.de/v/rc3-11406-spot_the_surveillance#t=761> <sup>[[Archive.org]][115]</sup>

-   EFF SLS: <https://www.eff.org/sls> <sup>[[Archive.org]][116]</sup>
...
-   Consider wearing special sunglasses (expensive, unfortunately) called "Reflectacles" <https://www.reflectacles.com/> <sup>[[Archive.org]][120]</sup>. There was a small study showing their efficiency against IBM and Amazon facial recognition[^194].

-   All that might still be useless because of gait recognition mentioned earlier[^157] but there might be hope here if you have a 3D Printer: <https://gitlab.com/FG-01/fg-01> <sup>[[Archive.org]][121]</sup>
...
These have been used countless times since the early days of the internet and the usual one is called the "419 scam" (see <https://en.wikipedia.org/wiki/Advance-fee_scam> <sup>[[Wikiless]][122]</sup> <sup>[[Archive.org]][123]</sup>).

Here is a good video if you want to learn a bit more about phishing types: Black Hat, Ichthyology: Phishing as a Science <https://www.youtube.com/watch?v=Z20XNp-luNA> <sup>[[Invidious]][124]</sup>.
...
-   What is a File Format? <https://www.youtube.com/watch?v=VVdmmN0su6E> <sup>[[Invidious]][125]</sup>

-   Ange Albertini: Funky File Formats: <https://www.youtube.com/watch?v=hdCs6bPM4is> <sup>[[Invidious]][126]</sup>
...
-   Hak5, USB Rubber Ducky <https://shop.hak5.org/products/usb-rubber-ducky-deluxe> <sup>[[Archive.org]][127]</sup>

-   Hak5, O.MG Cable <https://www.youtube.com/watch?v=V5mBJHotZv0> <sup>[[Invidious]][128]</sup>

-   Keelog <https://www.keelog.com/> <sup>[[Archive.org]][129]</sup>

-   AliExpress <https://www.aliexpress.com/i/4000710369016.html> <sup>[[Archive.org]][130]</sup>
...
This also works for videos. Yes, videos too have geo-tagging, and many are very unaware of this. Here Is for instance a very convenient tool to geo-locate YouTube videos: <https://mattw.io/youtube-geofind/location> <sup>[[Archive.org]][132]</sup>
...
For a recent example where someone leaking a Zoom meeting recording was caught because it was watermarked: <https://theintercept.com/2021/01/18/leak-zoom-meeting/> <sup>[[Tor Mirror]][133]</sup> <sup>[[Archive.org]][134]</sup>
...
Yes ... Your printers can be used to de-anonymize you as well as explained by the EFF here <https://www.eff.org/issues/printers> <sup>[[Archive.org]][135]</sup>

With this (old but still relevant) video explaining how from the EFF as well: <https://www.youtube.com/watch?v=izMGMsIZK4U> <sup>[[Invidious]][136]</sup>
...
Here is an (old but still relevant) list of printers and brands who do not print such tracking dots provided by the EFF <https://www.eff.org/pages/list-printers-which-do-or-do-not-display-tracking-dots> <sup>[[Archive.org]][137]</sup>

Here are also some tips from the Whonix documentation (<https://www.whonix.org/wiki/Printing_and_Scanning> <sup>[[Archive.org]][138]</sup>):
...
Here is for example an open-source project you could use yourself for recovering text from some blurred images yourself: <https://github.com/beurtschipper/Depix> <sup>[[Archive.org]][139]</sup>
...
There are also tutorials for using such techniques using Photo Editing tools such as GIMP such as <https://medium.com/@somdevsangwan/unblurring-images-for-osint-and-more-part-1-5ee36db6a70b> <sup>[[Archive.org]][141]</sup> followed by <https://medium.com/@somdevsangwan/deblurring-images-for-osint-part-2-ba564af8eb5d> <sup>[[Archive.org]][142]</sup>

![][143]

Finally, you will find plenty of deblurring resources here: <https://github.com/subeeshvasu/Awesome-Deblurring> <sup>[[Archive.org]][144]</sup>

Some online services could even help you do this automatically to some extent like MyHeritage.com enhance tool:

<https://www.myheritage.com/photo-enhancer> <sup>[[Archive.org]][145]</sup>
...
Remember what they say on their page: <https://bitcoin.org/en/you-need-to-know> <sup>[[Archive.org]][147]</sup> and <https://bitcoin.org/en/protect-your-privacy> <sup>[[Archive.org]][148]</sup>: "Bitcoin is not anonymous"
...
-   Apple iCloud: <https://support.apple.com/en-us/HT202303> <sup>[[Archive.org]][149]</sup> : "Messages in iCloud also uses end-to-end encryption. If you have iCloud Backup turned on**, your backup includes a copy of the key protecting your Messages**. This ensures you can recover your Messages if you lose access to iCloud Keychain and your trusted devices. ".

-   Google Drive and WhatsApp: <https://faq.whatsapp.com/android/chats/about-google-drive-backups/> <sup>[[Archive.org]][150]</sup>: "**Media and messages you back up aren't protected by WhatsApp end-to-end encryption while in Google Drive**. ". Do however note that Facebook/Whatsapp have announced the rollout of encrypted backups on October 14^th^ 2021 (<https://about.fb.com/news/2021/10/end-to-end-encrypted-backups-on-whatsapp/> <sup>[[Archive.org]][151]</sup>) which should solve this issue.

-   Dropbox: <https://www.dropbox.com/privacy#terms> <sup>[[Archive.org]][152]</sup> "To provide these and other features, **Dropbox accesses, stores, and scans Your Stuff**. You give us permission to do those things, and this permission extends to our affiliates and trusted third parties we work with".

-   Microsoft OneDrive: <https://privacy.microsoft.com/en-us/privacystatement> <sup>[[Archive.org]][153]</sup>: Productivity and communications products, "When you use OneDrive, we collect data about your usage of the service, as well as the content you store, to provide, improve, and protect the services. **Examples include indexing the contents of your OneDrive documents so that you can search for them later and using location information to enable you to search for photos based on where the photo was taken**".
...
-   <https://amiunique.org/links> <sup>[[Archive.org]][154]</sup>

-   <https://brave.com/brave-fingerprinting-and-privacy-budgets/> <sup>[[Archive.org]][155]</sup>
...
-   UpTurn, The Widespread Power of U.S. Law Enforcement to Search Mobile Phones <https://www.upturn.org/reports/2020/mass-extraction/> <sup>[[Archive.org]][157]</sup>

-   New-York Times, The Police Can Probably Break Into Your Phone <https://www.nytimes.com/2020/10/21/technology/iphone-encryption-police.html> <sup>[[Archive.org]][158]</sup>

-   Vice, Cops Around the Country Can Now Unlock iPhones, Records Show <https://www.vice.com/en/article/vbxxxd/unlock-iphone-ios11-graykey-grayshift-police> <sup>[[Archive.org]][159]</sup>

I also highly recommend that you read some documents from a forensics examiner perspective such as:

-   EnCase Forensic User Guide, <http://encase-docs.opentext.com/documentation/encase/forensic/8.07/Content/Resources/External%20Files/EnCase%20Forensic%20v8.07%20User%20Guide.pdf> <sup>[[Archive.org]][160]</sup>

-   FTK Forensic Toolkit, <https://accessdata.com/products-services/forensic-toolkit-ftk> <sup>[[Archive.org]][161]</sup>
...
-   Signing messages/files with PGP/GPG:
    ...
    -   Prefer ECDSA (ed25519)+ECDH (ec25519) or RSA 4096 Bits*
        ...
        -   **Consider a more modern**[^262] **alternative to PGP/GPG: Minisign <https://jedisct1.github.io/minisign/>** <sup>[[Archive.org]][163]</sup>
...
-   Telegram: <https://democratic-europe.eu/2021/07/20/cryptographers-uncover-four-vulnerabilities-in-telegram/> <sup>[[Archive.org]][164]</sup>
...
-   2014, HideMyAss user was de-anonymized, and logs were provided to the FBI[^273].

-   2013, Secure E-Mail provider Lavabit shuts down after fighting a secret gag order[^274].
...
Many advanced techniques can be used by skilled adversaries[^279] to bypass your security measures provided they already know where your devices are. Many of those techniques are detailed here <https://cyber.bgu.ac.il/advanced-cyber/airgap> <sup>[[Archive.org]][168]</sup> (Air-Gap Research Page, Cyber-Security Research Center, Ben-Gurion University of the Negev, Israel) and include:
...
-   **Attacks that require no malware:**
    ...
    -   Observing a blank wall in a room from a distance to figure how many people are in a room and what they are doing[^280]. Publication with demonstration: <http://wallcamera.csail.mit.edu/> <sup>[[Archive.org]][185]</sup>

    -   Observing a reflective bag of snacks in a room from a distance to reconstruct the entire room[^281]. Publication with photographic examples: <https://arxiv.org/abs/2001.04642> <sup>[[Archive.org]][186]</sup>

    -   Measuring floor vibrations to identify individuals and determine their health condition and mood[^282]. Publication with demonstration: <https://engineering.cmu.edu/news-events/news/2020/02/17-mauraders-map.html> <sup>[[Archive.org]][187]</sup>

    -   Observing a light bulb from a distance to listen to the sound in the room[^283] **without any malware**: Demonstration: <https://www.youtube.com/watch?v=t32QvpfOHqw> <sup>[[Invidious]][188]</sup>. It should be noted that this type of attack is not new at all and there have been articles about such techniques as far back as 2013[^284] and that you can even buy devices to perform this yourself such as here: <http://www.gcomtech.com/ccp0-prodshow/laser-surveillance-laser-listening.html> <sup>[[Archive.org]][189]</sup>
...
-   Specific to China, look at <https://gfwatch.org/> and <https://www.usenix.org/system/files/sec21-hoang.pdf> <sup>[[Archive.org]][220]</sup>
...
**Site Note: Be careful of some sellers as shown here <https://therecord.media/malware-found-preinstalled-in-classic-push-button-phones-sold-in-russia/>** <sup>[[Archive.org]][221]</sup>
...
-   **Recommended**: Do not require any identification (even e-mail):
    ...
    -   (Iceland based, accepts Monero) <https://crypton.sh> <sup>[[Tor Mirror]][223]</sup> <sup>[[Archive.org]][224]</sup>

    -   (Ukraine based, accepts Monero) <https://virtualsim.net/> <sup>[[Archive.org]][225]</sup>

-   Do require identification (valid e-mail):

    -   (US California based, accepts Monero) <https://mobilesms.io> <sup>[[Archive.org]][226]</sup>

    -   (Germany based, accepts Monero) <https://www.sms77.io/> <sup>[[Archive.org]][227]</sup>

    -   (Russia based, accepts Monero) <https://onlinesim.ru/> <sup>[[Archive.org]][228]</sup>

-   Not accepting Monero but accepting mainstream cryptocurrencies (less recommended):

    -   (US California based, untested) <http://smspool.net/> <sup>[[Archive.org]][229]</sup>
...
You will find details about each level here: <https://tb-manual.torproject.org/security-settings/> <sup>[[Archive.org]][237]</sup> but here is a summary:
...
When using Tor Browser, you should click the little shield Icon (upper right, next to the Address bar) and select your Security level (see <https://tb-manual.torproject.org/security-settings/> <sup>[[Archive.org]][237]</sup> for details). Basically, there are three.
...
In the future, this could also be supported by the Whonix project themselves as explained here: <https://www.whonix.org/wiki/Whonix-Host> <sup>[[Archive.org]][244]</sup> but it is not yet recommended as of now for end-users.
...
If you can afford it, you might consider getting a Purism Librem laptop (<https://puri.sm> <sup>[[Archive.org]][250]</sup>) or System76 laptops (<https://system76.com/> <sup>[[Archive.org]][251]</sup>) while using Coreboot[^296] (where Intel IME is disabled from the factory).
...
Here is a good cheap method to make your laptop tamper-proof using Nail Polish (with glitter) <https://mullvad.net/en/help/how-tamper-protect-laptop/> <sup>[[Archive.org]][260]</sup> [^302] (with pictures).
...
This also means you could set up your own advanced "plausible deniability" setup using any Host OS by storing for instance Virtual Machines on a Veracrypt hidden volume container (be careful of traces in the Host OS tho that would need to be cleaned if the host OS is persistent, see [Some additional measures against forensics][Some additional measures against forensics:] section later). There is a project for achieving this within Tails (<https://github.com/aforensics/HiddenVM> <sup>[[Archive.org]][242]</sup>) which would make your Host OS non-persistent and use plausible deniability within Tails.
...
-   If your OS or Encryption software allows it, you should consider encrypting the keys within RAM too (this is possible with Windows/Veracrypt and will be explained later). Again see <https://sourceforge.net/p/veracrypt/discussion/technical/thread/3961542951/> <sup>[[Archive.org]][263]</sup>
...
See also <https://www.whonix.org/wiki/Cold_Boot_Attack_Defense> <sup>[[Archive.org]][264]</sup> and <https://www.whonix.org/wiki/Protection_Against_Physical_Attacks> <sup>[[Archive.org]][265]</sup>

Here are also some interesting tools to consider for Linux users to defend against these:

-   <https://github.com/0xPoly/Centry> <sup>[[Archive.org]][266]</sup> (unfortunately unmaintained it seems so I made a fork and pull request updating for Veracrypt <https://github.com/AnonymousPlanet/Centry> <sup>[[Archive.org]][267]</sup> which should still work)

-   <https://github.com/hephaest0s/usbkill> <sup>[[Archive.org]][268]</sup> (unfortunately unmaintained as well it seems)

-   <https://github.com/Lvl4Sword/Killer> <sup>[[Archive.org]][269]</sup>

-   <https://askubuntu.com/questions/153245/how-to-wipe-ram-on-shutdown-prevent-cold-boot-attacks> <sup>[[Archive.org]][270]</sup>

-   (Qubes OS, Intel CPU only) <https://github.com/QubesOS/qubes-antievilmaid> <sup>[[Archive.org]][271]</sup>
...
-   Many more traces in various logs, please see this convenient interesting poster for more insight: <https://www.sans.org/security-resources/posters/windows-forensic-analysis/170/download> <sup>[[Archive.org]][272]</sup>
...
Consider also reading **<https://www.whonix.org/wiki/Full_Disk_Encryption#Encrypting_Whonix_VMs>** <sup>[[Archive.org]][273]</sup>
...
You should always remember that despite the reputation, Linux mainstream distributions (Ubuntu for instance) are not necessarily better at security than other systems such as macOS and Windows. See this reference to understand why <https://madaidans-insecurities.github.io/linux.html> <sup>[[Archive.org]][274]</sup>.
...
-   Using LUKS:
    ...
    -   Without plausible deniability:
        ...
        -   (Recommended and easy) Encrypt as part of the installation process: <https://ubuntu.com/tutorials/install-ubuntu-desktop> <sup>[[Archive.org]][275]</sup>
        ...
        -   (Tedious but possible) Encrypt after installation: <https://help.ubuntu.com/community/ManualFullSystemEncryption> <sup>[[Archive.org]][276]</sup>
...
While not supported yet by this guide, it is possible to achieve a form of deniability on Linux using LUKS by using detached LUKS headers. For now, I will redirect you toward this page for more information: <https://wiki.archlinux.org/title/Dm-crypt/Specialties#Encrypted_system_using_a_detached_LUKS_header> <sup>[[Archive.org]][277]</sup>
...
-   If you are not sure, just make sure you did not enable any telemetry and follow this tutorial if needed <https://vitux.com/how-to-force-ubuntu-to-stop-collecting-your-data-from-your-pc/> <sup>[[Archive.org]][278]</sup>
...
-   Disable Bluetooth if enabled by following this guide <https://www.addictivetips.com/ubuntu-linux-tips/disable-bluetooth-in-ubuntu/> <sup>[[Archive.org]][279]</sup> or issuing the following command:

    -   ```sudo systemctl disable bluetooth.service --force```

-   Disable Indexing if enabled by default (Ubuntu >19.04) by following this guide <https://www.linuxuprising.com/2019/07/how-to-completely-disable-tracker.html> <sup>[[Archive.org]][280]</sup> or issuing the following commands:
...
-   <https://www.how2shout.com/linux/how-to-hibernate-ubuntu-20-04-lts-focal-fossa/> <sup>[[Archive.org]][281]</sup>

-   <http://www.lorenzobettini.it/2020/07/enabling-hibernation-on-ubuntu-20-04/> <sup>[[Archive.org]][282]</sup>

-   <https://blog.ivansmirnov.name/how-to-set-up-hibernate-on-ubuntu-20-04/> <sup>[[Archive.org]][283]</sup>

After Hibernate is enabled, change the behavior so that your laptop will hibernate when you close the lid by following this tutorial for Ubuntu 20.04 <http://ubuntuhandbook.org/index.php/2020/05/lid-close-behavior-ubuntu-20-04/> <sup>[[Archive.org]][284]</sup> and this tutorial for Ubuntu 18.04 <https://tipsonubuntu.com/2018/04/28/change-lid-close-action-ubuntu-18-04-lts/> <sup>[[Archive.org]][285]</sup>

Unfortunately, this will not clean the key from memory directly when hibernating. To avoid this at the cost of some performance, you might consider encrypting the swap file by following this tutorial: <https://help.ubuntu.com/community/EnableHibernateWithEncryptedSwap> <sup>[[Archive.org]][286]</sup>

These settings should mitigate cold boot attacks if you can hibernate fast enough.

#### Enable MAC address randomization:

-   Ubuntu, follow these steps <https://help.ubuntu.com/community/AnonymizingNetworkMACAddresses> <sup>[[Archive.org]][287]</sup>.

-   Any other distro: you will have to find the documentation yourself, but it should be quite similar to the Ubuntu tutorial.

-   Consider this tutorial which should still work: <https://josh.works/shell-script-basics-change-mac-address> <sup>[[Archive.org]][288]</sup>

#### Hardening Linux:

As a light introduction for new Linux users, consider <https://www.youtube.com/watch?v=Sa0KqbpLye4> <sup>[[Invidious]][289]</sup>

For more in-depth and advanced options, refer to:

-   This excellent guide: <https://madaidans-insecurities.github.io/guides/linux-hardening.html> <sup>[[Archive.org]][290]</sup>

-   This excellent wiki resource: <https://wiki.archlinux.org/title/Security> <sup>[[Archive.org]][291]</sup>

-   These excellent scripts are based on the guide and wiki above: <https://codeberg.org/SalamanderSecurity/PARSEC> <sup>[[Archive.org]][292]</sup>
...
This OS is recommended by prominent figures such as Edward Snowden and Privacyguides.org.
...
Note, if you're having issues accessing the Tor Network due to blocking/censorship, you could try using Tor Bridges (see Tor Documentation <https://2019.www.torproject.org/docs/bridges> <sup>[[Archive.org]][241]</sup> and Whonix Documentation <https://www.whonix.org/wiki/Bridges> <sup>[[Archive.org]][338]</sup>).
...
-   Is this against their ToS? Yes <https://slashdotmedia.com/terms-of-use/> <sup>[[Archive.org]][441]</sup>
...
-   Is this against their ToS? No <https://telegram.org/tos> <sup>[[Archive.org]][442]</sup>
...
Their appeal process is just sending an e-mail to <recover@telegram.org> <sup>[[Archive.org]][443]</sup> stating your phone number and issue and hope they answer.
...
-   Is this against their ToS? No <https://tutanota.com/terms/> <sup>[[Archive.org]][444]</sup>
...
-   Is this against their ToS? No <https://www.twitch.tv/p/en/legal/terms-of-service/> <sup>[[Archive.org]][445]</sup>
...
-   Is this against their ToS? **Yes** <https://www.whatsapp.com/legal/updates/terms-of-service-eea> <sup>[[Archive.org]][446]</sup>
...
More on this topic on this YouTube video: <https://www.youtube.com/watch?v=zSQtyW_ywZc> <sup>[[Invidious]][449]</sup>
...
-   Wikipedia, <https://en.wikipedia.org/wiki/Comparison_of_instant_messaging_protocols> <sup>[[Wikiless]][450]</sup> <sup>[[Archive.org]][451]</sup>

-   Wikipedia, <https://en.wikipedia.org/wiki/Comparison_of_cross-platform_instant_messaging_clients> <sup>[[Wikiless]][452]</sup> <sup>[[Archive.org]][453]</sup>

-   Secure Messaging Apps <https://www.securemessagingapps.com/> <sup>[[Archive.org]][454]</sup>

-   ProtonMail Blog, <https://protonmail.com/blog/whatsapp-alternatives/> <sup>[[Archive.org]][455]</sup>

-   Whonix Documentation, Instant Messenger Chat <https://www.whonix.org/wiki/Chat> <sup>[[Archive.org]][456]</sup>

-   Have a look at <https://securechatguide.org/featuresmatrix.html> <sup>[[Archive.org]][457]</sup> which is also a good comparison table for messaging apps.
...
I will recommend these options in that order (as also recommend by Privacyguides.org[^409]'[^410] except for Session):

-   macOS:

    -   Native Tor Onion Routing Support (**preferred**):

        -   OnionShare version >2.3 (<https://onionshare.org/> <sup>[[Tor Mirror]][458]</sup> <sup>[[Archive.org]][459]</sup>)**

        -   Cwtch (<https://cwtch.im> <sup>[[Archive.org]][460]</sup> **warning, this is at the alpha/beta stage**)**
    ...
    -   Non-Native Tor Support (needs additional steps for ideal anonymity to proxy it through Tor through Virtualization or Proxying):
        ...
        -   Element/Matrix.org (<https://element.io/> <sup>[[Archive.org]][461]</sup>)

        -   Jami (<https://jami.net/> <sup>[[Archive.org]][462]</sup>)*

        -   Gajim/XMPP (<https://gajim.org/> <sup>[[Archive.org]][463]</sup>)
...
-   Linux:
    ...
    -   Native Tor Onion Routing Support (**preferred**):
        ...
        -   Briar (<https://briarproject.org/> <sup>[[Archive.org]][464]</sup>)*
...
-   iOS:
    ...
    -   Due to the lack of any better option (Briar is not on iOS) and general Tor support, only one option can still be possible here and it is normally not recommended by this guide but the only option: Session Messenger: <https://getsession.org/> <sup>[[Archive.org]][465]</sup>. Why is it not recommended these days within the privacy community? Well, it is because they recently[^411] dropped two key security features from their protocol: Perfect Forward Secrecy and Deniability which are considered rather essential in most other apps. Yet Session has been audited[^412] with satisfactory results but that audit took place before those changes. We also currently lack sufficient information on LokiNet (the Onion Routing Network used by Session) to endorse it. Session is still recommended by some like Techlore[^413].
...
-   Cryptpad.fr (<https://cryptpad.fr/>) as recommended by PrivacyGuides.org at <https://privacyguides.org/providers/cloud-storage/> <sup>[[Archive.org]][466]</sup>: Free tier limited to 1GB total
...
For this, I strongly recommend the use of SecureDrop[^416] (<https://securedrop.org/> <sup>[[Archive.org]][467]</sup>) which is an open-source project from the Freedom of the Press Foundation.

-   Ideally, you should use SecureDrop over Tor and you will find a curated list of those here <https://github.com/alecmuffett/real-world-onion-sites#securedrop> <sup>[[Archive.org]][468]</sup>
...
-   Check regularly the eventual appearance of compromise of any of your identities using <https://haveibeenpwned.com/> <sup>[[Archive.org]][469]</sup> (obviously from a safe environment).
...
The process is fairly simple and all you will need is to follow Veracrypt tutorial here: <https://www.veracrypt.fr/en/Beginner%27s%20Tutorial.html> <sup>[[Archive.org]][470]</sup>
...
Qubes OS recommends using their own utility for backups as documented here <https://www.qubes-os.org/doc/backup-restore/> <sup>[[Archive.org]][471]</sup>. But it is just a hassle and provides limited added value unless you just want to back up a single Qube. So instead, I am also recommending just making a full image with Clonezilla which will remove all the hassle and bring you back a working system in a few simple steps.
...
-   Cryptpad.fr as recommended by PrivacyGuides.org at <https://privacyguides.org/providers/cloud-storage/> <sup>[[Archive.org]][466]</sup> (limited to 1GB total)

-   AnonArchive.org (free tier limited to 1GB total)
...
If you just want to save information (text), I will recommend the use of secure and private pastebins[^418]. Mostly I will stick to the ones recommended by PrivacyGuides.org (<https://privacyguides.org/providers/paste/> <sup>[[Archive.org]][475]</sup> ):
...
To that, the answer is very simple and a clear consensus for everyone: <https://syncthing.net/> <sup>[[Archive.org]][476]</sup>
...
-   Physical Destruction:
    ...
    -   Bonus: See <https://www.youtube.com/watch?v=-bpX8YvNg6Y> <sup>[[Invidious]][483]</sup>
...
Trim should be sufficient in most cases and you could just use the blkdiscard command to force an entire device trim as explained here: <https://wiki.archlinux.org/index.php/Solid_state_drive#Trim_an_entire_device> <sup>[[Archive.org]][484]</sup>
...
-   Option A: Follow one of these tutorials:
    ...
    -   <https://linuxhint.com/completely_wipe_hard_drive_ubuntu/> <sup>[[Archive.org]][487]</sup>

    -   <https://linoxide.com/linux-command/commands-wipe-disk-linux/> <sup>[[Archive.org]][488]</sup>

    -   <https://wiki.archlinux.org/index.php/Securely_wipe_disk> <sup>[[Archive.org]][489]</sup>

I recommend using dd or shred for this purpose.

-   Option B: Install and use BleachBit <https://www.bleachbit.org/download/linux> <sup>[[Archive.org]][485]</sup> or follow this EFF tutorial <https://ssd.eff.org/en/module/how-delete-your-data-securely-linux> <sup>[[Archive.org]][490]</sup>
...
-   Option B: Use external tools such as:
    ...
    -   Eraser (open-source): <https://eraser.heidi.ie/download/> <sup>[[Archive.org]][491]</sup>

    -   KillDisk Free: <http://killdisk.com/killdisk-freeware.htm> <sup>[[Archive.org]][492]</sup>
...
Unfortunately, the macOS Recovery disk utility will not be able to perform a secure erase of your SSD drive as stated in Apple documentation <https://support.apple.com/en-gb/guide/disk-utility/dskutl14079/mac> <sup>[[Archive.org]][493]</sup>.
...
-   <https://support.apple.com/guide/disk-utility/erase-and-reformat-a-storage-device-dskutl14079/mac> <sup>[[Archive.org]][494]</sup>

-   <https://support.apple.com/guide/disk-utility/encrypt-protect-a-storage-device-password-dskutl35612/mac> <sup>[[Archive.org]][495]</sup> or using Veracrypt full disk encryption.
...
Follow this tutorial: <https://support.apple.com/guide/disk-utility/erase-and-reformat-a-storage-device-dskutl14079/mac> <sup>[[Archive.org]][494]</sup> and use the secure erase option from Disk Utility which should work fine on HDD and Thumb drives.
...
-   Right-click a file/folder:
    ...
    -   BleachBit: Shred with BleachBit (or see this tutorial from the EFF <https://ssd.eff.org/en/module/how-delete-your-data-securely-windows> <sup>[[Archive.org]][497]</sup>)
...
-   Decrypt and re-encrypt (using LUKS for instance following this tutorial <https://wiki.archlinux.org/index.php/dm-crypt/Device_encryption#Re-encrypting_devices> <sup>[[Archive.org]][498]</sup>) the whole drive to overwrite all free space after data deletion. This will ensure overwriting of all the free space.

-   Trim using ```fstrim --all``` and then fill up the entire free space of the disk using a utility such as:

    -   BleachBit <https://www.bleachbit.org/download/linux> <sup>[[Archive.org]][485]</sup>
    ...
    -   Use the old school dd method (taken from this answer <https://superuser.com/questions/19326/how-to-wipe-free-disk-space-in-linux> <sup>[[Archive.org]][486]</sup>) run these commands on the drive you want to fill:
...
-   You can do this the graphical way with BleachBit following this tutorial from the EFF: <https://ssd.eff.org/en/module/how-delete-your-data-securely-linux> <sup>[[Archive.org]][490]</sup>

-   Or you can do this from the command line following this tutorial: <https://linuxhint.com/completely_wipe_hard_drive_ubuntu/> <sup>[[Archive.org]][487]</sup> (For this purpose I recommend wipe and shred).
...
-   Decrypt and re-encrypt (using LUKS using this tutorial <https://wiki.archlinux.org/index.php/dm-crypt/Device_encryption#Re-encrypting_devices> <sup>[[Archive.org]][498]</sup> or Veracrypt from the graphical interface for instance) the whole drive to overwrite all free space after data deletion. This will ensure overwriting of all the free space.
...
-   Fill the free space using one of those methods:
    ...
    -   Use the old school dd method (taken from this answer <https://superuser.com/questions/19326/how-to-wipe-free-disk-space-in-linux> <sup>[[Archive.org]][486]</sup>) run these commands:
...
Please follow this documentation to Trim within Qubes OS: <https://github.com/Qubes-Community/Contents/blob/master/docs/configuration/disk-trim.md> <sup>[[Archive.org]][499]</sup>
...
-   Decrypt and re-encrypt the whole drive to overwrite all free space after data deletion. This will ensure overwriting of all the free space. I didn't find a reliable tutorial on how to do this safely on Qubes OS but it is possible this tutorial could work: <https://wiki.archlinux.org/index.php/dm-crypt/Device_encryption#Re-encrypting_devices> <sup>[[Archive.org]][498]</sup> (at your own risk, this has not been tested yet).

-   Refer to this Documentation (<https://github.com/Qubes-Community/Contents/blob/master/docs/configuration/disk-trim.md> <sup>[[Archive.org]][499]</sup>) and then trim using "fstrim --all" and then fill up the entire free space of the disk using a utility such as:
...
If Trim is supported and enabled by your Linux Distribution for your external SSD drive. There should be no issue in securely deleting data normally and just issue a "fstrim --all" from the terminal to trim the drive. Refer to this Documentation (<https://github.com/Qubes-Community/Contents/blob/master/docs/configuration/disk-trim.md> <sup>[[Archive.org]][499]</sup>) to enable trim on a drive.
...
-   If your file system is HFS+, you could run First Aid on your System Drive from the Disk Utility which should perform a Trim operation in the details (<https://support.apple.com/en-us/HT210898> <sup>[[Archive.org]][500]</sup>)
...
-   Permanent Eraser <http://www.edenwaith.com/products/permanent%20eraser/> <sup>[[Archive.org]][502]</sup>

-   From the terminal, you can use the "rm --P filename" command which should erase the file and overwrite it as explained in this EFF tutorial <https://ssd.eff.org/en/module/how-delete-your-data-securely-macos> <sup>[[Archive.org]][503]</sup>.
...
Consider also reading this documentation if you're going with Whonix <https://www.whonix.org/wiki/Anti-Forensics_Precautions> <sup>[[Archive.org]][343]</sup> as well as their general hardening tutorial for all platforms here <https://www.whonix.org/wiki/System_Hardening_Checklist> <sup>[[Archive.org]][504]</sup>

### Removing Metadata from Files/Documents/Pictures:

#### Pictures and videos:

On Windows, macOS, and Linux I would recommend ExifTool (<https://exiftool.org/> <sup>[[Archive.org]][505]</sup>) and/or ExifCleaner (<https://exifcleaner.com/> <sup>[[Archive.org]][506]</sup>) that allows viewing and/or removing those properties.

**ExifTool is natively available on Tails and Whonix Workstation.**

##### ExifCleaner:

Just install it from <https://exifcleaner.com/> <sup>[[Archive.org]][506]</sup>, run and drag and drop the files into the GUI.
...
Here is a tutorial to remove metadata from a Picture using OS provided tools: <https://www.purevpn.com/internet-privacy/how-to-remove-metadata-from-photos> <sup>[[Archive.org]][507]</sup>

##### Cloaking/Obfuscating to prevent picture recognition:

Consider the use of Fawkes <https://sandlab.cs.uchicago.edu/fawkes/> <sup>[[Archive.org]][508]</sup> (<https://github.com/Shawn-Shan/fawkes> <sup>[[Archive.org]][509]</sup>) to cloak the images from picture recognition tech on various platforms.

Or if you want online versions, consider:

-   <https://lowkey.umiacs.umd.edu/> <sup>[[Archive.org]][510]</sup>

-   <https://adversarial.io/> <sup>[[Archive.org]][511]</sup>

#### PDF Documents:

##### PDFParanoia (Linux/Windows/macOS/QubesOS):

Consider using <https://github.com/kanzure/pdfparanoia> <sup>[[Archive.org]][512]</sup> which will remove metadata and watermarks on any PDF.
...
First, here is a tutorial to remove metadata from Office documents: <https://support.microsoft.com/en-us/office/remove-hidden-data-and-personal-information-by-inspecting-documents-presentations-or-workbooks-356b7b5d-77af-44fe-a07f-9aa4d085966f> <sup>[[Archive.org]][513]</sup>. Make sure however that you do use the latest version of Office with the latest security updates.

Alternatively, on Windows, macOS, Qubes OS, and Linux I would recommend ExifTool (<https://exiftool.org/> <sup>[[Archive.org]][505]</sup>) and/or ExifCleaner (<https://exifcleaner.com/> <sup>[[Archive.org]][506]</sup>) that allows viewing and/or removing those properties
...
In addition, on Windows, macOS, Qubes OS, and Linux I would recommend ExifTool (<https://exiftool.org/> <sup>[[Archive.org]][505]</sup>) and/or ExifCleaner (<https://exifcleaner.com/> <sup>[[Archive.org]][506]</sup>) that allows viewing and/or removing additional properties
...
Another option good tool IMHO to remove metadata from various documents is the open-source mat2 recommended by privacyguiides.org[^437] (<https://0xacab.org/jvoisin/mat2> <sup>[[Archive.org]][514]</sup>) which you can use on Linux quite easily. I never managed to make it work properly within Windows due to various dependencies issues despite the provided instructions. It is however very straightforward to install and use on Linux.
...
Note that it's possible to run Whonix in Live mode leaving no traces when you shut down the VMs, consider reading their documentation here <https://www.whonix.org/wiki/VM_Live_Mode> <sup>[[Archive.org]][516]</sup> and here <https://www.whonix.org/wiki/Warning#Whonix_.E2.84.A2_Persistence_vs_Live_vs_Amnesic> <sup>[[Archive.org]][216]</sup>.
...
Many of those can be deleted using various commercial third-party tools but I would personally recommend using the free and well-known Onyx which you can find here: <https://www.titanium-software.fr/en/onyx.html> <sup>[[Archive.org]][517]</sup>. Unfortunately, it is closed-source, but it is notarized, signed, and has been trusted for many years.
...
-   If your file system is HFS+ (or any other than APFS), you could run First Aid on your System Drive from the Disk Utility which should perform a Trim operation in the details (<https://support.apple.com/en-us/HT210898> <sup>[[Archive.org]][500]</sup>).

![][501]

### Linux (Qubes OS):

Please consider their guidelines <https://github.com/Qubes-Community/Contents/blob/master/docs/security/security-guidelines.md> <sup>[[Archive.org]][518]</sup>

If you are using Whonix on Qubes OS, please consider following some of their guides:

-   Whonix System Hardening guide <https://www.whonix.org/wiki/System_Hardening_Checklist> <sup>[[Archive.org]][504]</sup>

-   Enabling App Armor on Qubes <https://www.whonix.org/wiki/Qubes/AppArmor> <sup>[[Archive.org]][373]</sup>

-   Also, consider the use of Linux Kernel Guard <https://www.whonix.org/wiki/Linux_Kernel_Runtime_Guard_LKRG> <sup>[[Archive.org]][519]</sup>
...
Nevertheless, you might want to clean some logs. Just use this convenient tool: <https://web.archive.org/web/20210205163035/https://github.com/sundowndev/go-covermyass> (instructions on the page, to download head to the releases, this repository was recently removed)
...
Consider the use of Linux Kernel Guard as an added measure <https://www.whonix.org/wiki/Linux_Kernel_Runtime_Guard_LKRG> <sup>[[Archive.org]][519]</sup>
...
-   Launch Regedit using this tutorial: <https://support.microsoft.com/en-us/windows/how-to-open-registry-editor-in-windows-10-deab38e6-91d6-e0aa-4b7c-8878d9e07b11> <sup>[[Archive.org]][520]</sup>
...
-   Download Shellbag Analyzer & Cleaner from <https://privazer.com/en/download-shellbag-analyzer-shellbag-cleaner.php> <sup>[[Archive.org]][521]</sup>
...
-   Download and install PrivaZer from <https://privazer.com/en/download.php> <sup>[[Archive.org]][522]</sup>
...
-   Get and install the latest version from BleachBit here <https://www.bleachbit.org/download> <sup>[[Archive.org]][523]</sup>
...
-   <https://justdeleteme.xyz/> <sup>[[Archive.org]][524]</sup>

-   <https://justgetmydata.com/> <sup>[[Archive.org]][525]</sup>
...
Go to their "Remove outdated content from Google Search" page here: <https://search.google.com/search-console/remove-outdated-content> <sup>[[Archive.org]][526]</sup> and submit a request accordingly.
...
Go to their "Content Removal" page here: <https://www.bing.com/webmasters/tools/contentremoval> <sup>[[Archive.org]][527]</sup> and submit a request accordingly.
...
Once have your Yandex account, head to the Yandex Webmaster tools <https://webmaster.yandex.com> <sup>[[Archive.org]][528]</sup> and then select Tools and Delete URL <https://webmaster.yandex.com/tools/del-url/> <sup>[[Archive.org]][529]</sup>
...
Yes, Yahoo Search still exists but as per their help page <https://help.yahoo.com/kb/SLN4530.html> <sup>[[Archive.org]][530]</sup>, there is no way to remove information or refresh information besides waiting. This could take 6 to 8 weeks.
...
-   <https://inteltechniques.com/workbook.html> <sup>[[Archive.org]][533]</sup>
...
-   Consider the use of Haven <https://guardianproject.github.io/haven/> <sup>[[Archive.org]][534]</sup> on some old android phone to keep watch on your home/room while you are away.

-   Doxx "yourself" and your identities from time to time by looking for them yourself online using various search engines to monitor your online identities. You can even automate the process somewhat using various tools such as Google Alerts <https://www.google.com/alerts> <sup>[[Archive.org]][535]</sup>.
...
-   Never ever leave your laptop unattended/on/unlocked anywhere when conducting sensitive activities. Remember the story of Ross Ulbricht and his arrest <https://en.wikipedia.org/wiki/Ross_Ulbricht#Silk_Road,_arrest_and_trial> <sup>[[Wikiless]][536]</sup> <sup>[[Archive.org]][537]</sup>.

-   Check for tampering regularly (not only your devices but also your home/room).

-   If you can, do not talk to the police/authorities (at least if you are in the US) <https://www.youtube.com/watch?v=d-7o9xYp7eE> <sup>[[Invidious]][538]</sup> without a lawyer. Remain silent.
...
-   **Finally, have common sense, do not be dumb, look and learn from others' mistakes, watch these:**
    ...
    -   2020, Sinwindie, OSINT, and Dark Web Markets, Why OPSEC Still Matters <https://www.youtube.com/watch?v=IqZZU9lFlF4> <sup>[[Invidious]][539]</sup>

    -   2020, RSA Conference 2020, When Cybercriminals with Good OpSec Attack <https://www.youtube.com/watch?v=zXmZnU2GdVk> <sup>[[Invidious]][540]</sup>

    -   2015, DEFCON 22, Adrian Crenshaw- Dropping Docs on Darknets: How People Got Caught, <https://www.youtube.com/watch?v=eQ2OZKitRwc> <sup>[[Invidious]][541]</sup> ([Slides][] <sup>[[Archive.org]][542]</sup>)

    -   2017, Ochko123 - How the Feds Caught Russian Mega-Carder Roman Seleznev <https://www.youtube.com/watch?v=6Chp12sEnWk> <sup>[[Invidious]][543]</sup>

    -   2015, DEF CON 22 - Zoz - Don't Fuck It Up! <https://www.youtube.com/watch?v=J1q4Ir2J8P8> <sup>[[Invidious]][544]</sup>

    -   2020, Bad Opsec - How Tor Users Got Caught, <https://www.youtube.com/watch?v=GR_U0G-QGA0> <sup>[[Invidious]][545]</sup>
...
Keep in mind that many countries have specific laws to compel you to reveal your passwords that could override your "right to remain silent". See this Wikipedia article: <https://en.wikipedia.org/wiki/Key_disclosure_law> <sup>[[Wikiless]][546]</sup> <sup>[[Archive.org]][547]</sup> and this other visual resource with law references <https://www.gp-digital.org/world-map-of-encryption/> <sup>[[Archive.org]][548]</sup>.
...
See current goals and donate at <https://anonymousplanet.org/donations.html> <sup>[[Mirror]][549]</sup> <sup>[[Archive.org]][550]</sup> <sup>[[Tor Mirror]][551]</sup> or directly by sending Monero (XMR) to this Address: ```4549BGJrEPBfpiPRL9CVGzGMgJnC1Dzf8EXLVfY8Ukrnj7LzkTV611dGf9tuQHiSQjbixsNWiffNiV5fPB3LkyF7UXi3vwQ```
...
-   The Easiest:
    ...
    -   Using the Snowflake addon on your browser (<https://snowflake.torproject.org/> <sup>[[Archive.org]][555]</sup>)

-   Slightly more work:

    -   Running a Tor relay node (<https://community.torproject.org/relay/> <sup>[[Archive.org]][556]</sup>)

        -   See [Recommended VPS hosting providers]

        -   Additional Tutorial: <https://torrelay.ca/> <sup>[[Archive.org]][557]</sup>

If you want a bit more challenge, you can also run a Tor Exit node anonymously using the recommended VPS providers above.

For this, see <https://blog.torproject.org/tips-running-exit-node> <sup>[[Archive.org]][558]</sup>
...
-   **Very Special Thanks to Edward Snowden and who inspired me to write this guide (buy and read his book please <https://en.wikipedia.org/wiki/Permanent_Record_(autobiography)>** <sup>[[Wikiless]][559]</sup> <sup>[[Archive.org]][560]</sup>**)**
...
-   Download and install W10Privacy from <https://www.w10privacy.de/english-home/> <sup>[[Archive.org]][561]</sup>
...
-   Download and run WindowsSpyBlocker from <https://crazymax.dev/WindowsSpyBlocker/download/> <sup>[[Archive.org]][562]</sup>
...
-   Also, consider using ShutUp10 from <https://www.oo-software.com/en/shutup10> <sup>[[Archive.org]][563]</sup>
...
-   System Rescue:
    ...
    -   Create a System Rescue USB disk following these instructions <https://www.system-rescue.org/Installing-SystemRescue-on-a-USB-memory-stick/> <sup>[[Archive.org]][566]</sup> (download the ISO and write to a USB stick with Rufus).
...
-   SATA SSD:
    ...
    -   ATA Secure Erase:
        ...
        -   Follow one of these tutorials
            ...
            -   <https://wiki.archlinux.org/index.php/Solid_state_drive/Memory_cell_clearing> <sup>[[Archive.org]][567]</sup>

            -   <https://ata.wiki.kernel.org/index.php/ATA_Secure_Erase> <sup>[[Archive.org]][568]</sup>

            -   <https://tinyapps.org/docs/wipe_drives_hdparm.html> <sup>[[Archive.org]][569]</sup>

    -   ATA Sanitize:

        -   Follow this tutorial <https://tinyapps.org/docs/ata_sanitize_hdparm.html> <sup>[[Archive.org]][570]</sup>
...
-   NVMe SSD:
    ...
    -   Follow one of these tutorials:
        ...
        -   <https://tinyapps.org/docs/nvme-secure-erase.html> <sup>[[Archive.org]][571]</sup>

        -   <https://tinyapps.org/docs/nvme-sanitize.html> <sup>[[Archive.org]][572]</sup>

# Appendix E: Clonezilla

-   Get Clonezilla by just following these instructions: <https://clonezilla.org/liveusb.php> <sup>[[Archive.org]][573]</sup> (I recommend the Alternative version AMD64 that should work with most recent laptops)

-   Boot from Clonezilla

-   Follow these steps to make a backup: <https://clonezilla.org/show-live-doc-content.php?topic=clonezilla-live/doc/01_Save_disk_image> <sup>[[Archive.org]][574]</sup>
...
-   You are done, if you need to restore, follow these instructions: <https://clonezilla.org/show-live-doc-content.php?topic=clonezilla-live/doc/02_Restore_disk_image> <sup>[[Archive.org]][575]</sup>
...
If you are experiencing issues connecting to Tor due to Censorship or Blocking, you might consider using Tor bridges as explained here: <https://bridges.torproject.org/> <sup>[[Archive.org]][576]</sup>
...
-   Native Tools:
    ...
    -   Windows 10 Disk Cleanup Utility: <https://support.microsoft.com/en-us/windows/disk-cleanup-in-windows-10-8a96ff42-5751-39ad-23d6-434b4d5b9a68> <sup>[[Archive.org]][577]</sup>
...
-   Windows 10 Optimize Utility (Defrag on HDD Drives): <https://support.microsoft.com/en-us/windows/defragment-your-windows-10-pc-048aefac-7f1f-4632-d48a-9700c4ec702a> <sup>[[Archive.org]][578]</sup>
...
-   Third-Party Tools:
    ...
    -   The open-source utility BleachBit <https://www.bleachbit.org/> <sup>[[Archive.org]][579]</sup>

    -   The closed-source utility PrivaZer <https://privazer.com/> <sup>[[Archive.org]][580]</sup>
...
Several utilities are recommended (like the old unmaintained DBAN[^455] or System Rescue CD (<https://www.system-rescue.org/> <sup>[[Archive.org]][581]</sup>)) for this but I will recommend the use of ShredOS.

Feel free to go with DBAN instead if you want (using this tutorial: <https://www.lifewire.com/how-to-erase-a-hard-drive-using-dban-2619148> <sup>[[Archive.org]][582]</sup>), the process is basically the same but will not work out of the box with UEFI laptops.

If you want to go with System-Rescue, just head to their website and follow the instructions.

## Windows:

-   Download ShredOS from <https://github.com/PartialVolume/shredos.2020.02> <sup>[[Archive.org]][583]</sup>

-   Unzip the ISO file

-   Download Rufus from <https://rufus.ie/> <sup>[[Archive.org]][584]</sup>
...
-   Follow instructions on <https://github.com/PartialVolume/shredos.2020.02> <sup>[[Archive.org]][583]</sup>
...
-   SanDisk DashBoard: <https://kb.sandisk.com/app/answers/detail/a_id/15108/~/dashboard-support-information> <sup>[[Archive.org]][585]</sup>

-   Seagate SeaTools: <https://www.seagate.com/support/downloads/seatools/> <sup>[[Archive.org]][586]</sup>

-   Samsung Magican: <https://www.samsung.com/semiconductor/minisite/ssd/download/tools/> <sup>[[Archive.org]][587]</sup>

-   Kingston SSD Manager: <https://www.kingston.com/unitedstates/en/support/technical/ssdmanager> <sup>[[Archive.org]][588]</sup>

-   Lenovo:

    -   Most likely native utility available within the BIOS/UEFI, please check

    -   Drive Erase Utility: <https://support.lenovo.com/us/en/downloads/ds019026-thinkpad-drive-erase-utility-for-resetting-the-cryptographic-key-and-erasing-the-solid-state-drive-thinkpad> <sup>[[Archive.org]][589]</sup>

-   Crucial Storage Executive: <https://www.crucial.com/support/storage-executive> <sup>[[Archive.org]][590]</sup>

-   Western Digital Dashboard: <https://support.wdc.com/downloads.aspx?p=279> <sup>[[Archive.org]][591]</sup>

-   HP: Follow instructions on <https://store.hp.com/us/en/tech-takes/how-to-secure-erase-ssd> <sup>[[Archive.org]][592]</sup>

-   Transcend SSD Scope: <https://www.transcend-info.com/Support/Software-10/> <sup>[[Archive.org]][593]</sup>

-   Dell:

    -   Most likely native utility available within the BIOS/UEFI, please check <https://www.dell.com/support/kbdoc/en-us/000134997/using-the-dell-bios-data-wipe-function-for-optiplex-precision-and-latitude-systems-built-after-november-2015?lwp=rt> <sup>[[Archive.org]][594]</sup>

## Tools that provide only support from running OS (for external drives).

-   Toshiba Storage Tools: <https://www.toshiba-storage.com/downloads/> <sup>[[Archive.org]][595]</sup>
...
Follow this good tutorial: <https://www.glump.net/howto/desktop/enable-trim-on-an-external-ssd-on-linux> <sup>[[Archive.org]][596]</sup>

### ATA/NVMe Operations (Secure Erase/Sanitize):

**It is not "recommended". Please read the disclaimers here <https://ata.wiki.kernel.org/index.php/ATA_Secure_Erase>** <sup>[[Archive.org]][568]</sup> **and here <https://wiki.archlinux.org/index.php/Solid_state_drive/Memory_cell_clearing>** <sup>[[Archive.org]][567]</sup>
...
See also this tutorial <https://code.mendhak.com/securely-wipe-ssd/> <sup>[[Archive.org]][597]</sup>
...
According to Apple Documentation[^447], Trim is supported on APFS (asynchronously) and HFS+ (through period trim or first-aid).
...
If your disk supports it but it is not enabled in macOS. You could try issuing a "sudo trimforce enable" command from the Terminal and see if it enables Trim on your external SSD. And then again check the first aid command if it is not APFS (see this Tutorial for info <https://www.lifewire.com/enable-trim-for-ssd-in-os-x-yosemite-2260789> <sup>[[Archive.org]][598]</sup>)

If it does not work, I am not aware of any reliable method to enable TRIM besides the commercial utility Trim Enabler here <https://cindori.org/trimenabler/> <sup>[[Archive.org]][599]</sup> which claims support for external drives.
...
Download the latest Debian testing amd64 netinst ISO from <https://www.debian.org/CD/netinst/> <sup>[[Archive.org]][600]</sup>
...
-   Lenovo ThinkPads: <https://support.lenovo.com/be/en/solutions/migr-68369> <sup>[[Archive.org]][601]</sup>

-   HP (all): <https://support.hp.com/gb-en/document/c06204100> <sup>[[Archive.org]][602]</sup>

-   Dell (all): <https://www.dell.com/support/kbdoc/en-us/000146892/dell-data-wipe> <sup>[[Archive.org]][603]</sup>

-   Acer (Travelmate only): <https://us.answers.acer.com/app/answers/detail/a_id/41567/~/how-to-use-disk-sanitizer-on-acer-travelmate-notebooks> <sup>[[Archive.org]][604]</sup>
...
-   **AN0M: <https://www.theguardian.com/australia-news/2021/sep/11/inside-story-most-daring-surveillance-sting-in-history>** <sup>[[Archive.org]][607]</sup>

-   **Encrochat: <https://en.wikipedia.org/wiki/EncroChat>** <sup>[[Wikiless]][608]</sup> <sup>[[Archive.org]][609]</sup>

-   **Sky ECC: <https://en.wikipedia.org/wiki/Sky_ECC>** <sup>[[Wikiless]][610]</sup> <sup>[[Archive.org]][611]</sup>
...
There are three VPN companies recommended by PrivacyGuides.org (<https://privacyguides.org/providers/vpn/> <sup>[[Archive.org]][612]</sup>) that accept cash payments: Mullvad, iVPN, and ProtonVPN.

In addition, I will also mention a newcomer to watch: Safing SPN <https://safing.io/> <sup>[[Archive.org]][613]</sup>) which (while still in the alpha stage at the time of this writing) which also accepts cash and has a very distinct new concept for a VPN which provides benefits similar to Tor Stream isolation with their "SPN"). Note that Safing SPN is not available on macOS at the moment. This possibility is "provisional" and at your own risk, but I think was worth mentioning.
...
This does also offer some disadvantages as Monero is not perfect as explained earlier in this guide and some global adversaries could maybe still track you. You will need to get Monero from an Exchange using the normal financial system and then pick a hosting (list here <https://www.getmonero.org/community/merchants/#exchanges> <sup>[[Archive.org]][614]</sup>) or from a local reseller using cash from <https://localmonero.co>.
...
There are plenty of tutorials on how to do this like this one <https://proprivacy.com/vpn/guides/create-your-own-vpn-server> <sup>[[Archive.org]][615]</sup>
...
-   (Windows/Linux/macOS) <https://linuxize.com/post/how-to-setup-ssh-socks-tunnel-for-private-browsing/> <sup>[[Archive.org]][616]</sup>

-   (Windows/Linux/macOS) <https://www.digitalocean.com/community/tutorials/how-to-route-web-traffic-securely-without-a-vpn-using-a-socks-tunnel> <sup>[[Archive.org]][617]</sup>

-   (Windows) <https://www.forwardproxy.com/2018/12/using-putty-to-setup-a-quick-socks-proxy/> <sup>[[Archive.org]][618]</sup>

-   (Linux/macOS) <https://ma.ttias.be/socks-proxy-linux-ssh-bypass-content-filters/> <sup>[[Archive.org]][619]</sup>
...
-   Download and install Putty from <https://www.putty.org/> <sup>[[Archive.org]][620]</sup>
...
In that case, my last resort recommendation is to connect safely **from a distance** to a Public Wi-Fi (See [Find some safe places with decent public Wi-Fi][Find some safe places with decent public Wi-Fi:]) using your laptop and Tails "unsafe browser". See <https://tails.boum.org/contribute/design/Unsafe_Browser/> <sup>[[Archive.org]][622]</sup>.
...
Consider reading this older but still relevant guide <https://archive.flossmanuals.net/bypassing-censorship/index.html> <sup>[[Archive.org]][623]</sup>
...
**I would recommend the AWUS036 series in the Alfa brand of adapters (see <https://www.alfa.com.tw/>** <sup>[[Archive.org]][625]</sup>**).** But you could also go with some other brands if you want such as the TP-Link TL-WN722 (see <https://www.tp-link.com/us/home-networking/usb-adapter/tl-wn722n/> <sup>[[Archive.org]][626]</sup>).

See this post for a comparison of various adapters: <https://www.wirelesshack.org/best-kali-linux-compatible-usb-adapter-dongles.html> <sup>[[Archive.org]][627]</sup> (Usually those antennas are used by Penetration Testers to probe Wi-Fis from a distance and are often discussed within the scope of the Kali Linux distribution).
...
**Do not forget tho that this will only delay a motivated adversary. Your signal can be triangulated easily by a motivated adversary in a matter of minutes once they reach the physical location of the Wi-Fi you're connecting to (for instance using a device such as AirCheck <https://www.youtube.com/watch?v=8FV2QZ1BPnw>** <sup>[[Invidious]][628]</sup>**, also see their other products here <https://www.netally.com/products/>** <sup>[[Archive.org]][629]</sup>**). These products can easily be deployed on mobile units (in a Car for instance) and pinpoint your location in a matter of minutes.**
...
-   Windows Tutorials:
    ...
    -   Mullvad: <https://mullvad.net/en/help/install-mullvad-app-windows/> <sup>[[Archive.org]][630]</sup>

    -   iVPN: <https://www.ivpn.net/apps-windows> <sup>[[Archive.org]][631]</sup>

    -   Safing: <https://docs.safing.io/portmaster/install/windows> <sup>[[Archive.org]][632]</sup>

    -   ProtonVPN: <https://protonvpn.com/support/protonvpn-windows-vpn-application/> <sup>[[Archive.org]][633]</sup>

-   macOS:

    -   Mullvad: <https://mullvad.net/en/help/install-and-use-mullvad-app-macos/> <sup>[[Archive.org]][634]</sup>

    -   IVPN: <https://www.ivpn.net/apps-macos/> <sup>[[Archive.org]][635]</sup>

    -   Safing: Not available on macOS

    -   ProtonVPN: <https://protonvpn.com/support/protonvpn-mac-vpn-application/> <sup>[[Archive.org]][636]</sup>

-   Linux:

    -   Mullvad: <https://mullvad.net/en/help/install-mullvad-app-linux/> <sup>[[Archive.org]][637]</sup>

    -   iVPN: <https://www.ivpn.net/apps-linux/> <sup>[[Archive.org]][638]</sup>

    -   Safing: <https://docs.safing.io/portmaster/install/linux> <sup>[[Archive.org]][639]</sup>

    -   ProtonVPN: <https://protonvpn.com/support/linux-vpn-setup/> <sup>[[Archive.org]][640]</sup>
...
-   Windows:
    ...
    -   iVPN: <https://www.ivpn.net/knowledgebase/general/do-you-offer-a-kill-switch-or-vpn-firewall/> <sup>[[Archive.org]][641]</sup>

    -   ProtonVPN: <https://protonvpn.com/support/what-is-kill-switch/> <sup>[[Archive.org]][642]</sup>

    -   Mullvad: <https://mullvad.net/en/help/using-mullvad-vpn-app/#killswitch> <sup>[[Archive.org]][643]</sup>
...
-   macOS:
    ...
    -   ProtonVPN same as Windows with the client, the option should be in the provided VPN client <https://protonvpn.com/blog/macos-vpn-kill-switch/> <sup>[[Archive.org]][644]</sup>

-   Linux:

    -   Mullvad:

        -   <https://mullvad.net/en/help/wireguard-and-mullvad-vpn/> <sup>[[Archive.org]][645]</sup>

        -   <https://mullvad.net/en/help/linux-openvpn-installation/> <sup>[[Archive.org]][646]</sup>

    -   ProtonVPN: <https://github.com/ProtonVPN/linux-cli/blob/master/USAGE.md#kill-switch> <sup>[[Archive.org]][647]</sup>

    -   iVPN:

        -   <https://www.ivpn.net/knowledgebase/linux/linux-wireguard-kill-switch/> <sup>[[Archive.org]][648]</sup>

        -   <https://www.ivpn.net/knowledgebase/linux/linux-kill-switch-using-the-uncomplicated-firewall-ufw/> <sup>[[Archive.org]][649]</sup>
...
The probe can be found here: <https://ooni.org/install/> <sup>[[Archive.org]][650]</sup> for various platforms (iOS, Android, Windows, macOS, and Linux).
...
-   Install GPG for your OS:
    ...
    -   Windows: gpg4win (<https://www.gpg4win.org/> <sup>[[Archive.org]][651]</sup>)

    -   macOS: GPGTools (<https://gpgtools.org/> <sup>[[Archive.org]][652]</sup>)
...
-   <https://support.torproject.org/tbb/how-to-verify-signature/> <sup>[[Archive.org]][653]</sup>

-   <https://tails.boum.org/install/vm-download/index.en.html> <sup>[[Archive.org]][654]</sup> (See Basic OpenPGP verification).

-   <https://www.whonix.org/wiki/Verify_the_Whonix_images> <sup>[[Archive.org]][655]</sup>
...
-   Yes, there are viruses and malware for macOS[^493]'[^486][^487]'[^488][^489]
...
-   Do use Open-Source non-real-time offline Anti-Virus/Anti-Malware tools as an added measure to scan some files such as:
    ...
    -   Windows/Linux/macOS/Qubes OS: ClamAV (<https://www.clamav.net/> <sup>[[Archive.org]][656]</sup>)

    -   Linux/Qubes OS: RFXN Linux Malware Detect (<https://github.com/rfxn/linux-malware-detect> <sup>[[Archive.org]][657]</sup>)

    -   Linux/Qubes OS: Chkrootkit (<http://www.chkrootkit.org/> <sup>[[Archive.org]][658]</sup>)
...
-   You could also use online services for **non-sensitive files*** such as VirusTotal (<https://www.virustotal.com/gui/>) or Hybrid-analysis (<https://hybrid-analysis.com/>).
    ...
    -   You could also just check the VirusTotal database for the hash of your file if you don't want to send it over (see <https://developers.virustotal.com/v3.0/docs/search-by-hash> <sup>[[Archive.org]][659]</sup> (See the [Integrity (if available):] section again for guidance on how to generate hashes).

    -   Other tools are also available for non-sensitive files and a convenient list is right here: <https://github.com/rshipp/awesome-malware-analysis#online-scanners-and-sandboxes> <sup>[[Archive.org]][660]</sup>

* **Please be aware that while VirusTotal might seem very practical for scanning various files, their "privacy policy" is problematic (see <https://support.virustotal.com/hc/en-us/articles/115002168385-Privacy-Policy>** <sup>[[Archive.org]][661]</sup>**) and states:**
...
Again, regarding the PDFs of this guide and as explained in the README of my repository, you could check for anomalies using PDFID which you can download at <https://blog.didierstevens.com/programs/pdf-tools/> <sup>[[Archive.org]][662]</sup>:
...
-   **Qubes OS:** Consider using <https://github.com/QubesOS/qubes-app-linux-pdf-converter> <sup>[[Archive.org]][663]</sup> which will convert your PDF into a flattened image file. This should theoretically remove any malicious code in it. Note that this will also render the PDF formatting useless (such as links, headings, bookmarks, and references).

-   **(Deprecated) Linux/Qubes OS** (or possibly macOS through Homebrew or Windows through Cygwin): Consider not using <https://github.com/firstlookmedia/pdf-redact-tools> <sup>[[Archive.org]][664]</sup> which will also turn your PDF into a flattened image file. Again, this should theoretically remove any malicious code in it. Again, this will also render the PDF formatting useless (such as links, headings, bookmarks, and references). **Note that this tool is deprecated and relies on a library called "ImageMagick" which is known for several security issues**[^490]**. You should not use this tool even if it is recommended in some other guides.**

-   **Windows/Linux/Qubes/OS/macOS:** Consider using <https://github.com/firstlookmedia/dangerzone> <sup>[[Archive.org]][665]</sup> which was inspired by Qubes PDF Converted above and does the same but is well maintained and works on all OSes. This tool also works with Images, ODF files, and Office files (Warning: On Windows, this tool requires Docker-Desktop installed and this might (will) interfere with Virtualbox and other Virtualization software because it requires enabling Hyper-V. VirtualBox and Hyper-V do not play nice together[^491]. Consider installing this within a Linux VM for convenience instead of a Windows OS).
...
-   **For Videos:** Be extremely careful, use an up-to-date player in a sandboxed environment. Remember <https://www.vice.com/en/article/v7gd9b/facebook-helped-fbi-hack-child-predator-buster-hernandez> <sup>[[Archive.org]][666]</sup>

-   This practical cheat sheet from SANS: <https://digital-forensics.sans.org/media/analyzing-malicious-document-files.pdf> <sup>[[Archive.org]][667]</sup> (warning, many of those tools might be harder to use on Windows and you might consider using them from a Linux OS such as Tails, Whonix Workstation, or a Linux distribution of your choice as explained later in this guide. There are also other guides out there[^493] that might be of use).

-   This GitHub repository with various resources on malware analysis: <https://github.com/rshipp/awesome-malware-analysis> <sup>[[Archive.org]][660]</sup>

-   This interesting PDF detailing which tool to use for which file type <https://www.winitor.com/pdf/Malware-Analysis-Fundamentals-Files-Tools.pdf> <sup>[[Archive.org]][668]</sup>
...
-   Comparison of both by Mozilla: <https://www.mozilla.org/en-US/firefox/browsers/compare/brave/> <sup>[[Archive.org]][669]</sup>
...
Ungoogled-Chromium is a Chromium-based Browser with all the Google bits removed (<https://github.com/Eloston/ungoogled-chromium> <sup>[[Archive.org]][55]</sup>).
...
-   Better Security than Firefox as it is Chromium-based[^505]'[^506].

-   Better Performance than Firefox.

-   The whole traffic will be router through Tor anyway.

-   Can benefit from additional security using Microsoft Defender Application Guard (MDAG)[^507]. Note that this feature cannot be enabled in a Virtualbox VM unfortunately.
...
-   In addition to being out of the Chromium world, it is also completely out of the Google world (despite the Mozilla Foundation being almost entirely funded by Google[^508]).
...
Security (especially sandboxing) of Firefox is arguably weaker than Chromium-based browsers[^509].
...
-   Download and install Brave browser from <https://brave.com/download/> <sup>[[Archive.org]][670]</sup>
...
-   Privacy Redirect (<https://github.com/SimonBrazell/privacy-redirect>)
    ...
    -   While the settings for Invidious and Nitter instances are random, I would recommend setting them to "nitter.fdn.fr" for Nitter and "yewtu.be" for Invidious.
...
-   Download first:
    ...
    -   NoScript: Download the latest zip release from <https://github.com/hackademix/noscript/releases>
        ...
        -   Alternatively, uMatrix: Download the chromium zip from <https://github.com/gorhill/uMatrix>
    ...
    -   LocalCDN: Download the latest source zip from <https://codeberg.org/nobody/LocalCDN/releases>
        ...
        -   Alternatively, DecentralEyes: Download the latest zip (not the CRX) file from <https://github.com/Synzvato/decentraleyes/releases>
    ...
    -   Privacy Redirect: Download the latest zip file from <https://github.com/SimonBrazell/privacy-redirect/releases> **(warning for this one, unpack and use the src subfolder)**
...
1.  <https://wiki.archlinux.org/title/Firefox/Privacy> <sup>[[Archive.org]][671]</sup> **(most recommended)**

2.  <https://www.privacytools.io/browsers/#about_config> <sup>[[Archive.org]][672]</sup>

3.  <https://proprivacy.com/privacy-service/guides/firefox-privacy-security-guide> <sup>[[Archive.org]][673]</sup>
...
-   <https://chrisx.xyz/blog/yet-another-firefox-hardening-guide/> <sup>[[Archive.org]][674]</sup>

-   <https://ebin.city/~werwolf/posts/firefox-hardening-guide/> <sup>[[Archive.org]][675]</sup>

# Appendix W: Virtualization

So, you might ask yourself, what is Virtualization[^510]?
...
In those cases, it might be necessary to use Tor bridges to connect to the Tor network (see Tor Documentation <https://2019.www.torproject.org/docs/bridges> <sup>[[Archive.org]][241]</sup> and Whonix Documentation <https://www.whonix.org/wiki/Bridges> <sup>[[Archive.org]][338]</sup>).

Bridges are special Tor entry nodes that are not listed on the Tor public directory. Some of those are running on people running the Snowflake Browser extension[^511] while others are running on various servers around the world. Most of those bridges are running some type of obfuscation method called obfs4[^512].

Here is the definition from the Tor Browser Manual[^513]: "obfs4 makes Tor traffic look random and prevents censors from finding bridges by Internet scanning. obfs4 bridges are less likely to be blocked than its predecessor, obfs3 bridges".
...
As per their definition from their manual[^514]: "meek transports make it look like you are browsing a major web site instead of using Tor. meek-azure makes it look like you are using a Microsoft web site". This is a type of "domain fronting" [^515].

Lastly, there are also bridges called Snowflake bridges that rely on users running the snowflake extension in their browser to become themselves entry nodes. See <https://snowflake.torproject.org/> <sup>[[Archive.org]][555]</sup>.

First, you should proceed with the following checklist to make sure you cannot circumvent Tor Blocking (double-check) and try to use Tor Bridges (<https://bridges.torproject.org/> <sup>[[Archive.org]][576]</sup>):
...
-   Download and install Tor Browser according to the instructions from <https://www.torproject.org/download/> <sup>[[Archive.org]][678]</sup>
...
-   At this point, still before connecting, you should click the little shield Icon (upper right, next to the Address bar) and select your Security level (see <https://tb-manual.torproject.org/security-settings/> <sup>[[Archive.org]][237]</sup> for details). Basically, there are three.
...
Let's keep in mind that even 3 letters agencies recommend blocking ads for their internal users in order to improve security[^517].
...
-   **Stay away from Crypto Mixers and Tumblers.** You might think this is a good idea but not only are they IMHO useless with cryptocurrencies such as BTC/ETH/LTC, but they are also dangerous as you might end up trading your currency for dirty currency from illicit activities. Use Monero to anonymize your crypto. Use a normal KYC-enabled Exchange to buy/sell your Monero (such as Kraken).
...
**As explained in the disclaimer, If you feel extra paranoid,** you could consider using an additional conversion step using a different privacy/anonymity-focused cryptocurrency such as Zcash (<https://z.cash/> <sup>[[Archive.org]][682]</sup>).

For example, here are two possibilities:

1.  **Buying Monero first option:**

    a.  Buy Monero (XMR) at a KYC exchange (such as Kraken).

    b.  Transfer your Monero from the KYC exchange to your Monero wallet in a secure environment (such as the Monero GUI wallet pre-installed on the Whonix workstation or using the Monero GUI wallet from <https://www.getmonero.org/downloads/> on other OSes).
...
2.  **Buying Zcash first option:**
    ...
    a.  Buy Zcash (see <https://z.cash/exchanges/> <sup>[[Archive.org]][683]</sup>)

    b.  Transfer your Zcash from the KYC exchange to a VM Zcash Wallet (see [Appendix A9: Installing a Zcash wallet][Appendix A9: Installing a Zcash wallet:]).
...
You might want to consider the use of Wasabi (<https://wasabiwallet.io/> <sup>[[Archive.org]][684]</sup>) for your BTC transactions using their "CoinJoin feature"[^518] to further cover your tracks. This would mean swapping your Monero for BTC to a Wasabi Wallet instead of a normal Wallet. And then using that Wasabi Wallet for your BTC transactions using their CoinJoin feature.
...
-   **Njalla <https://njal.la/> (my personal favorite but quite expensive, recommended by PrivacyGuides.org (<https://privacyguides.org/providers/hosting/>** <sup>[[Archive.org]][685]</sup>**).**
...
-   Tor Project: <https://community.torproject.org/relay/community-resources/good-bad-isps/> <sup>[[Archive.org]][686]</sup>

-   PrivacyGuides.org: <https://privacyguides.org/providers/hosting/> <sup>[[Archive.org]][685]</sup>

Lastly, you could pick one (at your own risk) from the list here that does accept Monero: <https://www.getmonero.org/community/merchants/#hosting> <sup>[[Archive.org]][614]</sup>
...
My opinion (and the one of many[^519]'[^520]'[^521]'[^522]'[^523]'[^524]) is that passphrases are generally better than passwords. So instead of thinking of better passwords, forget them altogether and use passphrases instead (when possible). Or just use a password manager with very long passwords (such as KeePassXC, the preferred password manager in this guide).

The well-known shown-below XKCD <https://xkcd.com/936/> <sup>[[Archive.org]][687]</sup> is still valid despite some people disputing it (See <https://www.explainxkcd.com/wiki/index.php/936:_Password_Strength> <sup>[[Archive.org]][688]</sup>). Yes, it is quite old now and is a little bit outdated and might be misinterpreted. But generally, it is still valid and a good argument for using passphrases instead of passwords.

![][689]

(Illustration by Randall Munroe, xkcd.com, licensed under CC BY-NC 2.5)

Here are some recommendations (based on Wikipedia[^525]):
...
Watch this insightful video by Computerphile: <https://www.youtube.com/watch?v=3NjQ9b3pgIg> <sup>[[Invidious]][690]</sup>
...
I will not go into too many details. Just pick one from the PrivacyGuides.org list: <https://privacyguides.org/providers/search-engines> <sup>[[Archive.org]][691]</sup>
...
-   The OxyMonster case (<https://arstechnica.com/tech-policy/2018/06/dark-web-vendor-oxymonster-turns-out-to-be-a-frenchman-with-luscious-beard/> <sup>[[Archive.org]][692]</sup>):
...
-   <https://wikipedia.org/wiki/Forensic_linguistics> <sup>[[Wikiless]][693]</sup> <sup>[[Archive.org]][694]</sup>: Gives a brief rundown of the basics of forensic linguistics, not too informative.

-   <https://wikipedia.org/wiki/Writeprint> <sup>[[Wikiless]][695]</sup> <sup>[[Archive.org]][696]</sup>: Gives a brief and informative rundown of forensic linguistics applied to internet investigations.

-   <https://wikipedia.org/wiki/Stylometry> <sup>[[Wikiless]][697]</sup> <sup>[[Archive.org]][698]</sup>: Gives a brief overview of Stylometry.

-   <https://wikipedia.org/wiki/Content_similarity_detection> <sup>[[Wikiless]][699]</sup> <sup>[[Archive.org]][700]</sup>: I would recommend reading this, quite informative.

-   <https://wikipedia.org/wiki/Author_profiling> <sup>[[Wikiless]][701]</sup> <sup>[[Archive.org]][702]</sup>: Read through this as well if you are interested in this topic.

-   <https://wikipedia.org/wiki/Native-language_identification> <sup>[[Wikiless]][703]</sup> <sup>[[Archive.org]][704]</sup>: This is less important if you use a translator, but if you do not use a translator to communicate on forums that are not in your native language, consider giving this a quick read through.

-   <https://wikipedia.org/wiki/Computational_linguistics> <sup>[[Wikiless]][705]</sup> <sup>[[Archive.org]][706]</sup>: Only read through this if this topic is interesting to you.

-   <https://regmedia.co.uk/2017/09/27/gal_vallerius.pdf> <sup>[[Archive.org]][707]</sup>: Explains how authorities used forensic linguistics to help arrest OxyMonster (pages 13 -- 14).

-   <https://wikipedia.org/wiki/Ted_Kaczynski#After_publication> <sup>[[Wikiless]][708]</sup> <sup>[[Archive.org]][709]</sup>: May have an IQ of 167, but he was caught primarily based on forensic linguistics.

-   <https://i.blackhat.com/USA-19/Wednesday/us-19-Wixey-Im-Unique-Just-Like-You-Human-Side-Channels-And-Their-Implications-For-Security-And-Privacy.pdf> <sup>[[Archive.org]][710]</sup>: Explains how your writing style can be used to track you, I highly recommend reading through these slides, or watching the accompanying presentation on YouTube.

-   <https://media.defcon.org/DEF%20CON%2026/DEF%20CON%2026%20presentations/DEFCON-26-Matt-Wixey-Betrayed-by-the-Keyboard-Updated.pdf> <sup>[[Archive.org]][711]</sup>: Explains how your writing style can be used to track you, I highly recommend reading through these slides, or watching the accompanying presentation on YouTube, this is quite similar to the last presentation.

-   <https://i.blackhat.com/us-18/Wed-August-8/us-18-Wixey-Every-ROSE-Has-Its-Thorn-The-Dark-Art-Of-Remote-Online-Social-Engineering.pdf> <sup>[[Archive.org]][712]</sup>: This goes over how to potentially spot deception through the internet, and presents a checklist to see how trustworthy someone is. I would advise reading the slides or watching the presentation on YouTube.
...
-   For YouTube links, use an Invidious instance (<https://github.com/iv-org/invidious> <sup>[[Archive.org]][29]</sup>)
    ...
    -   I recommend <https://invidious.fdn.fr>

-   For Twitter links, use a Nitter instance (<https://github.com/zedeus/nitter> <sup>[[Archive.org]][30]</sup>)

    -   I recommend <https://nitter.fdn.fr>

-   For Wikipedia links, use a Wikiless instance (<https://codeberg.org/orenom/wikiless> <sup>[[Archive.org]][31]</sup>)

-   For Reddit, use a LibReddit instance (<https://github.com/spikecodes/libreddit> <sup>[[Archive.org]][713]</sup>)

-   For Maps, consider using <https://www.openstreetmap.org>

-   For Translation, consider using a SimplyTranslate (<https://git.sr.ht/~metalune/simplytranslate_web> <sup>[[Archive.org]][714]</sup>) at <https://translate.metalune.xyz/>
...
-   Light Theme PDF: <https://anonymousplanet.org/guide.pdf> <sup>[[Mirror]][715]</sup> <sup>[[Archive.org]][716]</sup> <sup>[[Tor Mirror]][717]</sup>

-   Dark Theme PDF: <https://anonymousplanet.org/guide-dark.pdf> <sup>[[Mirror]][718]</sup> <sup>[[Archive.org]][719]</sup> <sup>[[Tor Mirror]][720]</sup>

-   OpenDocument Text (ODT) version at: <https://anonymousplanet.org/guide.odt> <sup>[[Mirror]][721]</sup> <sup>[[Archive.org]][722]</sup> <sup>[[Tor Mirror]][723]</sup>
...
If you want to compare the older version of the ODT format with a newer version, use the LibreWriter compare features as explained here: <https://help.libreoffice.org/7.1/en-US/text/shared/guide/redlining_doccompare.html> <sup>[[Archive.org]][724]</sup>
...
-   <https://simpleswap.io/> (warning it seems they do have some kind of KYC, but I am not sure when it is required, could depend on the size of the transaction, had no issues myself with small transactions)

-   <https://changelly.com/> (less recommended, they seem to now require an e-mail registration for any transaction and do also have some KYC in place but was not required when doing small transactions)

-   <https://sideshift.ai> (untested but recommended by some and seems to have no KYC at all)

-   Consider Binance but **do note they block Tor Exit Nodes from registration**, you will need to use a VPN over Tor for this. They also limit the amounts that can be withdrawn from their service per day if you do not verify your identity. **Anonymous registration against their ToS (but should be legal in Germany).**

-   Consider Kraken but **do note they block Tor Exit Nodes from registration**, you will need to use a VPN over Tor for this. They also limit the amounts that can be withdrawn from their service per day if you do not verify your identity. **Anonymous registration against their ToS (but should be legal in Germany).** **If you used Kraken with KYC to buy Monero in the first place, do not use the same account for these transactions.**
...
The anonymity of Monero depends on its crypto algorithms. If you do use Monero from a KYC Exchange. You can be almost certain that you are safe today. But you might not be in the long-term future if Monero algorithms are ever broken[^526] (think Quantum Computing). Do keep in mind that KYC regulations might force operators (such as Crypto Exchanges) to keep your financial records for up to 10 years and that you, therefore, need Monero algorithms to not be broken for the next 10 years as well.

You may want to watch this insightful video for more details: [**https://www.youtube.com/watch?v=j02QoI4ZlnU**][] <sup>[[Invidious]][725]</sup>

Also please consider reading: **<https://github.com/monero-project/monero/blob/master/docs/ANONYMITY_NETWORKS.md#privacy-limitations>** <sup>[[Archive.org]][726]</sup>
...
-   (My personal favorite) LINDDUN <https://www.linddun.org/> <sup>[[Archive.org]][727]</sup>

-   STRIDE <https://en.wikipedia.org/wiki/STRIDE_%28security%29> <sup>[[Wikiless]][728]</sup> <sup>[[Archive.org]][729]</sup>

-   PASTA <https://versprite.com/tag/pasta-threat-modeling/> <sup>[[Archive.org]][730]</sup>

And there are quite a few others too, see:

-   <https://insights.sei.cmu.edu/blog/threat-modeling-12-available-methods/> <sup>[[Archive.org]][731]</sup>

-   <https://www.geeksforgeeks.org/threat-modelling/> <sup>[[Archive.org]][732]</sup>

You can find some introduction on these on these projects:

-   Threat Modeling Manifesto: <https://www.threatmodelingmanifesto.org/> <sup>[[Archive.org]][733]</sup>

-   OWASP: <https://cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html> <sup>[[Archive.org]][734]</sup>
...
[^3]: Wikipedia, Don't be evil <https://en.wikipedia.org/wiki/Don%27t_be_evil> <sup>[[Wikiless]][736]</sup> <sup>[[Archive.org]][737]</sup>

[^4]: YouTube, <https://www.youtube.com/watch?v=6DGNZnfKYnU> <sup>[[Invidious]][738]</sup>

[^5]: Wikipedia, OSINT <https://en.wikipedia.org/wiki/Open-source_intelligence> <sup>[[Wikiless]][739]</sup> <sup>[[Archive.org]][740]</sup>

[^6]: YouTube Internet Historian Playlist, HWNDU <https://www.youtube.com/playlist?list=PLna1KTNJu3y09Tu70U6yPn28sekaNhOMY> <sup>[[Invidious]][741]</sup>

[^7]: Wikipedia, 4chan <https://en.wikipedia.org/wiki/4chan> <sup>[[Wikiless]][742]</sup> <sup>[[Archive.org]][743]</sup>

[^8]: PIA, See this good article on the matter <https://www.privateinternetaccess.com/blog/how-does-privacy-differ-from-anonymity-and-why-are-both-important/> <sup>[[Archive.org]][744]</sup> (disclaimer: this is not an endorsement or recommendation for this commercial service).
...
[^10]: This World of Ours, James Mickens <https://scholar.harvard.edu/files/mickens/files/thisworldofours.pdf> <sup>[[Archive.org]][745]</sup>

[^11]: XKCD, Security <https://xkcd.com/538/> <sup>[[Archive.org]][746]</sup>

[^12]: Wikipedia, Threat Model <https://en.wikipedia.org/wiki/Threat_model> <sup>[[Wikiless]][747]</sup> <sup>[[Archive.org]][748]</sup>

[^13]: Bellingcat <https://www.bellingcat.com/> <sup>[[Archive.org]][749]</sup>

[^14]: Wikipedia, Doxing <https://en.wikipedia.org/wiki/Doxing> <sup>[[Wikiless]][750]</sup> <sup>[[Archive.org]][751]</sup>

[^15]: YouTube, Internet Historian, The Bikelock Fugitive of Berkeley <https://www.youtube.com/watch?v=muoR8Td44UE> <sup>[[Invidious]][752]</sup>

[^16]: BBC News, Tor Mirror <https://www.bbc.com/news/technology-50150981> <sup>[[Archive.org]][753]</sup>

[^17]: GitHub, Real World Onion websites <https://github.com/alecmuffett/real-world-onion-sites> <sup>[[Archive.org]][754]</sup>

[^18]: Tor Project, Who Uses Tor <https://2019.www.torproject.org/about/torusers.html.en> <sup>[[Archive.org]][755]</sup>

[^19]: Whonix Documentation, The importance of Anonymity <https://www.whonix.org/wiki/Anonymity> <sup>[[Archive.org]][756]</sup>

[^20]: Geek Feminism, <https://geekfeminism.wikia.org/wiki/Who_is_harmed_by_a_%22Real_Names%22_policy%3F> <sup>[[Archive.org]][757]</sup>

[^21]: Tor Project, Tor Users <https://2019.www.torproject.org/about/torusers.html.en> <sup>[[Archive.org]][755]</sup>

[^22]: PrivacyHub, Internet Privacy in the Age of Surveillance <https://www.cyberghostvpn.com/privacyhub/internet-privacy-surveillance/> <sup>[[Archive.org]][758]</sup>

[^23]: PIA Blog, 50 Key Stats About Freedom of the Internet Around the World <https://www.privateinternetaccess.com/blog/internet-freedom-around-the-world-in-50-stats/> <sup>[[Archive.org]][759]</sup>

[^24]: Wikipedia, IANAL <https://en.wikipedia.org/wiki/IANAL> <sup>[[Wikiless]][760]</sup> <sup>[[Archive.org]][761]</sup>

[^25]: Wikipedia, Trust but verify <https://en.wikipedia.org/wiki/Trust,_but_verify> <sup>[[Wikiless]][762]</sup> <sup>[[Archive.org]][763]</sup>

[^26]: Wikipedia, IP Address, <https://en.wikipedia.org/wiki/IP_address> <sup>[[Wikiless]][764]</sup> <sup>[[Archive.org]][765]</sup>

[^27]: Wikipedia; Data Retention <https://en.wikipedia.org/wiki/Data_retention> <sup>[[Wikiless]][766]</sup> <sup>[[Archive.org]][767]</sup>

[^28]: Wikipedia, Tor Anonymity Network <https://en.wikipedia.org/wiki/Tor_(anonymity_network)> <sup>[[Wikiless]][768]</sup> <sup>[[Archive.org]][769]</sup>

[^29]: Wikipedia, VPN <https://en.wikipedia.org/wiki/Virtual_private_network> <sup>[[Wikiless]][770]</sup> <sup>[[Archive.org]][771]</sup>

[^30]: Ieee.org, Anonymity Trilemma: Strong Anonymity, Low Bandwidth Overhead, Low Latency - Choose Two <https://ieeexplore.ieee.org/document/8418599> <sup>[[Archive.org]][772]</sup>

[^31]: Wikipedia, DNS <https://en.wikipedia.org/wiki/Domain_Name_System> <sup>[[Wikiless]][773]</sup> <sup>[[Archive.org]][774]</sup>

[^32]: Wikipedia, DNS Blocking <https://en.wikipedia.org/wiki/DNS_blocking> <sup>[[Wikiless]][775]</sup> <sup>[[Archive.org]][776]</sup>

[^33]: CensoredPlanet <https://censoredplanet.org/> <sup>[[Archive.org]][777]</sup>

[^34]: ArXiv, Characterizing Smart Home IoT Traffic in the Wild <https://arxiv.org/pdf/2001.08288.pdf> <sup>[[Archive.org]][778]</sup>

[^35]: Labzilla.io, Your Smart TV is probably ignoring your Pi-Hole <https://labzilla.io/blog/force-dns-pihole> <sup>[[Archive.org]][779]</sup>

[^36]: Wikipedia, DNS over HTTPS: <https://en.wikipedia.org/wiki/DNS_over_HTTPS> <sup>[[Wikiless]][780]</sup> <sup>[[Archive.org]][781]</sup>

[^37]: Wikipedia, DNS over TLS, <https://en.wikipedia.org/wiki/DNS_over_TLS> <sup>[[Wikiless]][782]</sup> <sup>[[Archive.org]][783]</sup>

[^38]: Wikipedia, Pi-Hole <https://en.wikipedia.org/wiki/Pi-hole> <sup>[[Wikiless]][784]</sup> <sup>[[Archive.org]][785]</sup>

[^39]: Wikipedia, SNI <https://en.wikipedia.org/wiki/Server_Name_Indication> <sup>[[Wikiless]][786]</sup> <sup>[[Archive.org]][787]</sup>

[^40]: Wikipedia, ECH, <https://en.wikipedia.org/wiki/Server_Name_Indication#Encrypted_Client_Hello> <sup>[[Wikiless]][786]</sup> <sup>[[Archive.org]][787]</sup>

[^41]: Wikipedia, eSNI <https://en.wikipedia.org/wiki/Server_Name_Indication#Encrypted_Client_Hello> <sup>[[Wikiless]][786]</sup> <sup>[[Archive.org]][787]</sup>

[^42]: Usenix.org, On the Importance of Encrypted-SNI (ESNI) to Censorship Circumvention <https://www.usenix.org/system/files/foci19-paper_chai_0.pdf> <sup>[[Archive.org]][788]</sup>

[^43]: Wikipedia, CDN <https://en.wikipedia.org/wiki/Content_delivery_network> <sup>[[Wikiless]][789]</sup> <sup>[[Archive.org]][790]</sup>

[^44]: Cloudflare, Good-bye ESNI, hello ECH! <https://blog.cloudflare.com/encrypted-client-hello/> <sup>[[Archive.org]][791]</sup>

[^45]: ZDNET, Russia wants to ban the use of secure protocols such as TLS 1.3, DoH, DoT, ESNI <https://www.zdnet.com/article/russia-wants-to-ban-the-use-of-secure-protocols-such-as-tls-1-3-doh-dot-esni/> <sup>[[Archive.org]][792]</sup>

[^46]: ZDNET, China is now blocking all encrypted HTTPS traffic that uses TLS 1.3 and ESNI <https://www.zdnet.com/article/china-is-now-blocking-all-encrypted-https-traffic-using-tls-1-3-and-esni/> <sup>[[Archive.org]][793]</sup>

[^47]: Wikipedia, OCSP <https://en.wikipedia.org/wiki/Online_Certificate_Status_Protocol> <sup>[[Wikiless]][794]</sup> <sup>[[Archive.org]][795]</sup>

[^48]: Madaidans Insecurities, Why encrypted DNS is ineffective <https://madaidans-insecurities.github.io/encrypted-dns.html> <sup>[[Archive.org]][796]</sup>

[^49]: Wikipedia, OCSP Stapling <https://en.wikipedia.org/wiki/OCSP_stapling> <sup>[[Wikiless]][797]</sup> <sup>[[Archive.org]][798]</sup>

[^50]: Chromium Documentation, CRLSets <https://dev.chromium.org/Home/chromium-security/crlsets> <sup>[[Archive.org]][799]</sup>

[^51]: ZDNet, Chrome does certificate revocation better <https://www.zdnet.com/article/chrome-does-certificate-revocation-better/> <sup>[[Archive.org]][800]</sup>

[^52]: KUL, Encrypted DNS=⇒Privacy? A Traffic Analysis Perspective <https://www.esat.kuleuven.be/cosic/publications/article-3153.pdf> <sup>[[Archive.org]][801]</sup>

[^53]: ResearhGate, Oblivious DNS: Practical Privacy for DNS Queries <https://www.researchgate.net/publication/332893422_Oblivious_DNS_Practical_Privacy_for_DNS_Queries> <sup>[[Archive.org]][802]</sup>

[^54]: Nymity.ch, The Effect of DNS on Tor's Anonymity <https://nymity.ch/tor-dns/> <sup>[[Archive.org]][803]</sup>

[^55]: Wikipedia, RFID <https://en.wikipedia.org/wiki/Radio-frequency_identification> <sup>[[Wikiless]][57]</sup> <sup>[[Archive.org]][58]</sup>

[^56]: Wikipedia, NFC <https://en.wikipedia.org/wiki/Near-field_communication> <sup>[[Wikiless]][804]</sup> <sup>[[Archive.org]][805]</sup>

[^57]: Samsonite Online Shop, RFID accessories, <https://shop.samsonite.com/accessories/rfid-accessories/> <sup>[[Archive.org]][806]</sup>

[^58]: Google Android Help, Android Location Services <https://support.google.com/accounts/answer/3467281?hl=en> <sup>[[Archive.org]][807]</sup>

[^59]: Apple Support, Location Services and Privacy <https://support.apple.com/en-us/HT207056> <sup>[[Archive.org]][808]</sup>

[^60]: State University of New York, Towards 3D Human Pose Construction Using Wi-Fi <https://cse.buffalo.edu/~lusu/papers/MobiCom2020.pdf> <sup>[[Archive.org]][809]</sup>

[^61]: Digi.Ninja, Jasager <https://digi.ninja/jasager/> <sup>[[Archive.org]][810]</sup>

[^62]: Hak5 Shop, Wi-Fi Pineapple <https://shop.hak5.org/products/wifi-pineapple> <sup>[[Archive.org]][811]</sup>

[^63]: Wikipedia, Deautentication Attack <https://en.wikipedia.org/wiki/Wi-Fi_deauthentication_attack> <sup>[[Wikiless]][812]</sup> <sup>[[Archive.org]][813]</sup>

[^64]: Wikipedia, Capture Portal <https://en.wikipedia.org/wiki/Captive_portal> <sup>[[Wikiless]][814]</sup> <sup>[[Archive.org]][815]</sup>

[^65]: HackerFactor Blog, Deanonymizing Tor Circuits <https://www.hackerfactor.com/blog/index.php?/archives/868-Deanonymizing-Tor-Circuits.html> <sup>[[Archive.org]][816]</sup>

[^66]: KU Leuven, Website Fingerprinting through Deep Learning <https://distrinet.cs.kuleuven.be/software/tor-wf-dl/> <sup>[[Archive.org]][817]</sup>

[^67]: KU Leuven, Deep Fingerprinting: Undermining Website Fingerprinting Defenses with Deep Learning <https://homes.esat.kuleuven.be/~mjuarezm/index_files/pdf/ccs18.pdf> <sup>[[Archive.org]][818]</sup>

[^68]: Internet Society, Website Fingerprinting at Internet Scale <https://www.internetsociety.org/sites/default/files/blogs-media/website-fingerprinting-internet-scale.pdf> <sup>[[Archive.org]][819]</sup>

[^69]: KU Leuven, A Critical Evaluation of Website Fingerprinting Attacks <https://www.esat.kuleuven.be/cosic/publications/article-2456.pdf> <sup>[[Archive.org]][820]</sup>

[^70]: DailyDot, How Tor helped catch the Harvard bomb threat suspect <https://www.dailydot.com/unclick/tor-harvard-bomb-suspect/> <sup>[[Archive.org]][821]</sup>

[^71]: ArsTechnica, How the NSA can break trillions of encrypted Web and VPN connections <https://arstechnica.com/information-technology/2015/10/how-the-nsa-can-break-trillions-of-encrypted-web-and-vpn-connections/> <sup>[[Archive.org]][822]</sup>

[^72]: ArsTechnica, Does Tor provide more benefit or harm? New paper says it depends <https://arstechnica.com/gadgets/2020/11/does-tor-provide-more-benefit-or-harm-new-paper-says-it-depends/> <sup>[[Archive.org]][823]</sup>

[^73]: ResearchGate, The potential harms of the Tor anonymity network cluster disproportionately in free countries <https://www.pnas.org/content/early/2020/11/24/2011893117> <sup>[[Archive.org]][824]</sup>

[^74]: CryptoEngineering, How does Apple (privately) find your offline devices? <https://blog.cryptographyengineering.com/2019/06/05/how-does-apple-privately-find-your-offline-devices/> <sup>[[Archive.org]][825]</sup>

[^75]: Apple Support <https://support.apple.com/en-us/HT210515> <sup>[[Archive.org]][826]</sup>

[^76]: XDA, Samsung's Find My Mobile app can locate Galaxy devices even when they're offline <https://www.xda-developers.com/samsung-find-my-mobile-app-locate-galaxy-devices-offline/> <sup>[[Archive.org]][827]</sup>

[^77]: Apple Support, If your Mac is lost or stolen <https://support.apple.com/en-us/HT204756> <sup>[[Archive.org]][828]</sup>

[^78]: Wikipedia, BLE <https://en.wikipedia.org/wiki/Bluetooth_Low_Energy> <sup>[[Wikiless]][829]</sup> <sup>[[Archive.org]][830]</sup>

[^79]: Cryptography Engineering Blog, How does Apple (privately) find your offline devices? <https://blog.cryptographyengineering.com/2019/06/05/how-does-apple-privately-find-your-offline-devices/> <sup>[[Archive.org]][825]</sup>

[^80]: Wikipedia, IMEI <https://en.wikipedia.org/wiki/International_Mobile_Equipment_Identity> <sup>[[Wikiless]][831]</sup> <sup>[[Archive.org]][832]</sup>

[^81]: Wikipedia, IMSI <https://en.wikipedia.org/wiki/International_mobile_subscriber_identity> <sup>[[Wikiless]][833]</sup> <sup>[[Archive.org]][834]</sup>

[^82]: Android Documentation, Device Identifiers <https://source.android.com/devices/tech/config/device-identifiers> <sup>[[Archive.org]][835]</sup>

[^83]: Google Privacy Policy, Look for IMEI <https://policies.google.com/privacy/embedded?hl=en-US> <sup>[[Archive.org]][836]</sup>

[^84]: Wikipedia, IMEI and the Law <https://en.wikipedia.org/wiki/International_Mobile_Equipment_Identity#IMEI_and_the_law> <sup>[[Wikiless]][831]</sup> <sup>[[Archive.org]][832]</sup>

[^85]: Bellingcat, The GRU Globetrotters: Mission London <https://www.bellingcat.com/news/uk-and-europe/2019/06/28/the-gru-globetrotters-mission-london/> <sup>[[Archive.org]][837]</sup>

[^86]: Bellingcat,"V" For "Vympel": FSB's Secretive Department "V" Behind Assassination Of Georgian Asylum Seeker In Germany <https://www.bellingcat.com/news/uk-and-europe/2020/02/17/v-like-vympel-fsbs-secretive-department-v-behind-assassination-of-zelimkhan-khangoshvili/> <sup>[[Archive.org]][838]</sup>

[^87]: Wikipedia, CCTV <https://en.wikipedia.org/wiki/Closed-circuit_television> <sup>[[Wikiless]][839]</sup> <sup>[[Archive.org]][840]</sup>

[^88]: Apple, Transparency Report, Device Requests <https://www.apple.com/legal/transparency/device-requests.html> <sup>[[Archive.org]][841]</sup>

[^89]: The Intercept, How Cops Can Secretly Track Your Phone <https://theintercept.com/2020/07/31/protests-surveillance-stingrays-dirtboxes-phone-tracking/> <sup>[[Tor Mirror]][842]</sup> <sup>[[Archive.org]][843]</sup>

[^90]: Wikipedia, IMSI Catcher <https://en.wikipedia.org/wiki/IMSI-catcher> <sup>[[Wikiless]][844]</sup> <sup>[[Archive.org]][845]</sup>

[^91]: Wikipedia, Stingray <https://en.wikipedia.org/wiki/Stingray_phone_tracker> <sup>[[Wikiless]][846]</sup> <sup>[[Archive.org]][847]</sup>

[^92]: Gizmodo, Cops Turn to Canadian Phone-Tracking Firm After Infamous 'Stingrays' Become 'Obsolete' <https://gizmodo.com/american-cops-turns-to-canadian-phone-tracking-firm-aft-1845442778> <sup>[[Archive.org]][848]</sup>

[^93]: Wikipedia, MITM <https://en.wikipedia.org/wiki/Man-in-the-middle_attack> <sup>[[Wikiless]][849]</sup> <sup>[[Archive.org]][850]</sup>

[^94]: Purism, Librem 5 <https://shop.puri.sm/shop/librem-5/> <sup>[[Archive.org]][851]</sup>

[^95]: Wikipedia, MAC Address <https://en.wikipedia.org/wiki/MAC_address> <sup>[[Wikiless]][852]</sup> <sup>[[Archive.org]][853]</sup>

[^96]: Acyclica Road Trend Product Sheet, <https://amsignalinc.com/data-sheets/Acyclica/Acyclica-RoadTrend-Product-Sheet.pdf> <sup>[[Archive.org]][854]</sup>

[^97]: ResearchGate, Tracking Anonymized Bluetooth Devices <https://www.researchgate.net/publication/334590931_Tracking_Anonymized_Bluetooth_Devices/fulltext/5d3308db92851cd04675a469/Tracking-Anonymized-Bluetooth-Devices.pdf> <sup>[[Archive.org]][855]</sup>

[^98]: Wikipedia, CPU <https://en.wikipedia.org/wiki/Central_processing_unit> <sup>[[Wikiless]][856]</sup> <sup>[[Archive.org]][857]</sup>

[^99]: Wikipedia, Intel Management Engine <https://en.wikipedia.org/wiki/Intel_Management_Engine> <sup>[[Wikiless]][858]</sup> <sup>[[Archive.org]][859]</sup>

[^100]: Wikipedia, AMD Platform Security Processor <https://en.wikipedia.org/wiki/AMD_Platform_Security_Processor> <sup>[[Wikiless]][860]</sup> <sup>[[Archive.org]][861]</sup>

[^101]: Wikipedia, IME, Security Vulnerabilities <https://en.wikipedia.org/wiki/Intel_Management_Engine#Security_vulnerabilities> <sup>[[Wikiless]][858]</sup> <sup>[[Archive.org]][859]</sup>

[^102]: Wikipedia, IME, Assertions that ME is a backdoor <https://en.wikipedia.org/wiki/Intel_Management_Engine#Assertions_that_ME_is_a_backdoor> <sup>[[Wikiless]][858]</sup> <sup>[[Archive.org]][859]</sup>

[^103]: Wikipedia, IME, Disabling the ME <https://en.wikipedia.org/wiki/Intel_Management_Engine#Disabling_the_ME> <sup>[[Wikiless]][858]</sup> <sup>[[Archive.org]][859]</sup>

[^104]: Libreboot, <https://libreboot.org/> <sup>[[Archive.org]][862]</sup>

[^105]: Apple, Differential Privacy White Paper <https://www.apple.com/privacy/docs/Differential_Privacy_Overview.pdf> <sup>[[Archive.org]][863]</sup>

[^106]: Wikipedia, Differential Privacy <https://en.wikipedia.org/wiki/Differential_privacy> <sup>[[Wikiless]][864]</sup> <sup>[[Archive.org]][865]</sup>

[^107]: Continuing Ed, The All-Seeing "i": Apple Just Declared War on Your Privacy <https://edwardsnowden.substack.com/p/all-seeing-i> <sup>[[Archive.org]][866]</sup>

[^108]: Trinity College Dublin, Mobile Handset Privacy: Measuring The Data iOS and Android Send to Apple And Google <https://www.scss.tcd.ie/doug.leith/apple_google.pdf> <sup>[[Archive.org]][82]</sup>

[^109]: Reuters, Exclusive: Apple dropped plan for encrypting backups after FBI complained -- sources <https://www.reuters.com/article/us-apple-fbi-icloud-exclusive-idUSKBN1ZK1CT> <sup>[[Archive.org]][867]</sup>

[^110]: ZDnet, I asked Apple for all my data. Here's what was sent back <https://www.zdnet.com/article/apple-data-collection-stored-request/> <sup>[[Archive.org]][868]</sup>

[^111]: De Correspondent, Here's how we found the names and addresses of soldiers and secret agents using a simple fitness app <https://decorrespondent.nl/8481/heres-how-we-found-the-names-and-addresses-of-soldiers-and-secret-agents-using-a-simple-fitness-app/412999257-6756ba27> <sup>[[Archive.org]][869]</sup>

[^112]: Website Planet, Report: Fitness Tracker Data Breach Exposed 61 Million Records and User Data Online <https://www.websiteplanet.com/blog/gethealth-leak-report/> <sup>[[Archive.org]][870]</sup>

[^113]: Wired, The Strava Heat Map and the End of Secrets <https://www.wired.com/story/strava-heat-map-military-bases-fitness-trackers-privacy/> <sup>[[Archive.org]][871]</sup>

[^114]: Bellingcat, How to Use and Interpret Data from Strava's Activity Map <https://www.bellingcat.com/resources/how-tos/2018/01/29/strava-interpretation-guide/> <sup>[[Archive.org]][872]</sup>

[^115]: The Guardian, Fitness tracking app Strava gives away location of secret US army bases <https://www.theguardian.com/world/2018/jan/28/fitness-tracking-app-gives-away-location-of-secret-us-army-bases> <sup>[[Archive.org]][873]</sup>

[^116]: Telegraph, Running app reveals locations of secret service agents in MI6 and GCHQ <https://www.telegraph.co.uk/technology/2018/07/08/running-app-exposes-mi6-gchq-workers-whereabouts/> <sup>[[Archive.org]][874]</sup>

[^117]: Washington Post, Alexa has been eavesdropping on you this whole time <https://www.washingtonpost.com/technology/2019/05/06/alexa-has-been-eavesdropping-you-this-whole-time/?itid=lk_interstitial_manual_59> <sup>[[Archive.org]][875]</sup>

[^118]: Washington Post, What does your car know about you? We hacked a Chevy to find out <https://www.washingtonpost.com/technology/2019/12/17/what-does-your-car-know-about-you-we-hacked-chevy-find-out/> <sup>[[Archive.org]][876]</sup>

[^119]: Using Metadata to find Paul Revere (<https://kieranhealy.org/blog/archives/2013/06/09/using-metadata-to-find-paul-revere/> <sup>[[Archive.org]][877]</sup>)

[^120]: Wikipedia, Google SensorVault, <https://en.wikipedia.org/wiki/Sensorvault> <sup>[[Wikiless]][878]</sup> <sup>[[Archive.org]][879]</sup>

[^121]: NRKBeta, My Phone Was Spying on Me, so I Tracked Down the Surveillants <https://nrkbeta.no/2020/12/03/my-phone-was-spying-on-me-so-i-tracked-down-the-surveillants/> <sup>[[Archive.org]][880]</sup>

[^122]: New York Times <https://www.nytimes.com/interactive/2019/12/19/opinion/location-tracking-cell-phone.html> <sup>[[Archive.org]][881]</sup>

[^123]: Sophos, Google data puts innocent man at the scene of a crime <https://nakedsecurity.sophos.com/2020/03/10/google-data-puts-innocent-man-at-the-scene-of-a-crime/> <sup>[[Archive.org]][882]</sup>

[^124]: Wikipedia, Geofence Warrant <https://en.wikipedia.org/wiki/Geo-fence_warrant> <sup>[[Wikiless]][883]</sup> <sup>[[Archive.org]][884]</sup>

[^125]: Vice.com, Military Unit That Conducts Drone Strikes Bought Location Data From Ordinary Apps <https://www.vice.com/en/article/y3g97x/location-data-apps-drone-strikes-iowa-national-guard> <sup>[[Archive.org]][885]</sup>

[^126]: TechCrunch, Google says geofence warrants make up one-quarter of all US demands <https://techcrunch.com/2021/08/19/google-geofence-warrants/> <sup>[[Archive.org]][886]</sup>

[^127]: TechDirt, Google Report Shows 'Reverse Warrants' Are Swiftly Becoming Law Enforcement's Go-To Investigative Tool <https://www.techdirt.com/articles/20210821/10494847401/google-report-shows-reverse-warrants-are-swiftly-becoming-law-enforcements-go-to-investigative-tool.shtml> <sup>[[Archive.org]][887]</sup>

[^128]: Wikipedia, Room 641A <https://en.wikipedia.org/wiki/Room_641A> <sup>[[Wikiless]][888]</sup> <sup>[[Archive.org]][889]</sup>

[^129]: Wikipedia, Edward Snowden <https://en.wikipedia.org/wiki/Edward_Snowden> <sup>[[Wikiless]][890]</sup> <sup>[[Archive.org]][891]</sup>

[^130]: Wikipedia, Permanent Record <https://en.wikipedia.org/wiki/Permanent_Record_(autobiography)> <sup>[[Wikiless]][559]</sup> <sup>[[Archive.org]][560]</sup>

[^131]: Wikipedia, XKEYSCORE <https://en.wikipedia.org/wiki/XKeyscore> <sup>[[Wikiless]][892]</sup> <sup>[[Archive.org]][893]</sup>

[^132]: ElectroSpaces, Danish military intelligence uses XKEYSCORE to tap cables in cooperation with the NSA <https://www.electrospaces.net/2020/10/danish-military-intelligence-uses.html> <sup>[[Archive.org]][894]</sup>

[^133]: Wikipedia, MUSCULAR <https://en.m.wikipedia.org/wiki/MUSCULAR_(surveillance_program)> <sup>[[Archive.org]][895]</sup>

[^134]: Wikipedia, SORM <https://en.wikipedia.org/wiki/SORM> <sup>[[Wikiless]][896]</sup> <sup>[[Archive.org]][897]</sup>

[^135]: Wikipedia, Tempora <https://en.wikipedia.org/wiki/Tempora> <sup>[[Wikiless]][898]</sup> <sup>[[Archive.org]][899]</sup>

[^136]: Wikipedia, PRISM <https://en.wikipedia.org/wiki/PRISM_(surveillance_program)> <sup>[[Wikiless]][900]</sup> <sup>[[Archive.org]][901]</sup>

[^137]: Justsecurity, General Hayden <https://www.justsecurity.org/10318/video-clip-director-nsa-cia-we-kill-people-based-metadata/> <sup>[[Archive.org]][902]</sup>

[^138]: IDMB, The Social Dilemma <https://www.imdb.com/title/tt11464826/> <sup>[[Archive.org]][903]</sup>

[^139]: ArsTechnica, How the way you type can shatter anonymity---even on Tor <https://arstechnica.com/information-technology/2015/07/how-the-way-you-type-can-shatter-anonymity-even-on-tor/> <sup>[[Archive.org]][904]</sup>

[^140]: Wikipedia, Stylometry <https://en.wikipedia.org/wiki/Stylometry> <sup>[[Wikiless]][697]</sup> <sup>[[Archive.org]][905]</sup>

[^141]: Paul Moore Blog, Behavioral Profiling: The password you can't change. <https://paul.reviews/behavioral-profiling-the-password-you-cant-change/> <sup>[[Archive.org]][906]</sup>

[^142]: Wikipedia, Sentiment Analysis, <https://en.wikipedia.org/wiki/Sentiment_analysis> <sup>[[Wikiless]][907]</sup> <sup>[[Archive.org]][908]</sup>

[^143]: EFF CoverYourTracks, <https://coveryourtracks.eff.org/> <sup>[[Archive.org]][909]</sup>

[^144]: Berkeley.edu, On the Feasibility of Internet-Scale Author Identification <https://people.eecs.berkeley.edu/~dawnsong/papers/2012%20On%20the%20Feasibility%20of%20Internet-Scale%20Author%20Identification.pdf> <sup>[[Archive.org]][910]</sup>

[^145]: Forbes, Exclusive: Government Secretly Orders Google To Identify Anyone Who Searched A Sexual Assault Victim's Name, Address And Telephone Number [https://www.forbes.com/sites/thomasbrewster/2021/10/04/google-keyword-warrants-give-us-government-data-on-search-users][] <sup>[[Archive.org]][911]</sup>

[^146]: SecuredTouch Blog, Behavioral Biometrics 101: Behavioral Biometrics vs. Behavioral Analytics <https://blog.securedtouch.com/behavioral-biometrics-101-an-in-depth-look-at-behavioral-biometrics-vs-behavioral-analytics> <sup>[[Archive.org]][912]</sup>

[^147]: ArsTechnica, Stakeout: how the FBI tracked and busted a Chicago Anon <https://arstechnica.com/tech-policy/2012/03/stakeout-how-the-fbi-tracked-and-busted-a-chicago-anon/> <sup>[[Archive.org]][913]</sup>

[^148]: Bellingcat MH17 - Russian GRU Commander 'Orion' Identified as Oleg Ivannikov <https://www.bellingcat.com/news/uk-and-europe/2018/05/25/mh17-russian-gru-commander-orion-identified-oleg-ivannikov/> <sup>[[Archive.org]][914]</sup>

[^149]: Facebook Research, Deepface <https://research.fb.com/publications/deepface-closing-the-gap-to-human-level-performance-in-face-verification/> <sup>[[Archive.org]][915]</sup>

[^150]: Privacy News Online, Putting the "face" in Facebook: how Mark Zuckerberg is building a world without public anonymity <https://www.privateinternetaccess.com/blog/putting-face-facebook-mark-zuckerberg-building-world-without-public-anonymity/> <sup>[[Archive.org]][916]</sup>

[^151]: CNBC, "Facebook has mapped populations in 23 countries as it explores satellites to expand internet" <https://www.cnbc.com/2017/09/01/facebook-has-mapped-human-population-building-internet-in-space.html> <sup>[[Archive.org]][917]</sup>

[^152]: MIT Technology Review, This is how we lost control of our faces, <https://www.technologyreview.com/2021/02/05/1017388/ai-deep-learning-facial-recognition-data-history/> <sup>[[Archive.org]][918]</sup>

[^153]: Bellingcat, Shadow of a Doubt: Crowdsourcing Time Verification of the MH17 Missile Launch Photo <https://www.bellingcat.com/resources/case-studies/2015/08/07/shadow-of-a-doubt/> <sup>[[Archive.org]][919]</sup>

[^154]: Brown Institute, Open-Source Investigation, <https://brown.columbia.edu/open-source-investigation/> <sup>[[Archive.org]][920]</sup>

[^155]: NewScientist, Facebook can recognize you in photos even if you're not looking <https://www.newscientist.com/article/dn27761-facebook-can-recognise-you-in-photos-even-if-youre-not-looking/> <sup>[[Archive.org]][921]</sup>

[^156]: Google Patent, Techniques for emotion detection and content delivery <https://patents.google.com/patent/US20150242679> <sup>[[Archive.org]][922]</sup>

[^157]: APNews, Chinese 'gait recognition' tech IDs people by how they walk <https://apnews.com/article/bf75dd1c26c947b7826d270a16e2658a> <sup>[[Archive.org]][923]</sup>

[^158]: The Sun, New CCTV technology could now identify you just by the WAY you walk and your body shape <https://www.thesun.co.uk/news/7684204/cctv-technology-identify-body-shape-way-walk/> <sup>[[Archive.org]][924]</sup>

[^159]: City Security Magazine, Gait recognition: a useful identification tool <https://citysecuritymagazine.com/security-management/gait-recognition-identification-tool/> <sup>[[Archive.org]][925]</sup>

[^160]: Vice.com, Tech Companies Are Training AI to Read Your Lips <https://www.vice.com/en/article/bvzvdw/tech-companies-are-training-ai-to-read-your-lips> <sup>[[Archive.org]][926]</sup>

[^161]: New Atlas, Eye tracking can reveal an unbelievable amount of information about you <https://newatlas.com/science/science/eye-tracking-privacy/> <sup>[[Archive.org]][927]</sup>

[^162]: TechCrunch, Facial recognition reveals political party in troubling new research <https://techcrunch.com/2021/01/13/facial-recognition-reveals-political-party-in-troubling-new-research/> <sup>[[Archive.org]][928]</sup>

[^163]: Nature.com, Facial recognition technology can expose political orientation from naturalistic facial images <https://www.nature.com/articles/s41598-020-79310-1> <sup>[[Archive.org]][112]</sup>

[^164]: Slate <https://slate.com/technology/2018/04/facebook-collects-data-on-non-facebook-users-if-they-want-to-delete-it-they-have-to-sign-up.html> <sup>[[Archive.org]][929]</sup>

[^165]: The Conversation <https://theconversation.com/shadow-profiles-facebook-knows-about-you-even-if-youre-not-on-facebook-94804> <sup>[[Archive.org]][930]</sup>

[^166]: The Verge <https://www.theverge.com/2018/4/11/17225482/facebook-shadow-profiles-zuckerberg-congress-data-privacy> <sup>[[Archive.org]][931]</sup>

[^167]: ZDNET <https://www.zdnet.com/article/anger-mounts-after-facebooks-shadow-profiles-leak-in-bug/> <sup>[[Archive.org]][932]</sup>

[^168]: CNET <https://www.cnet.com/news/shadow-profiles-facebook-has-information-you-didnt-hand-over/> <sup>[[Archive.org]][933]</sup>

[^169]: Anyvision <https://www.anyvision.co/> <sup>[[Archive.org]][934]</sup>

[^170]: BuzzFeed.news, Surveillance Nation <https://www.buzzfeednews.com/article/ryanmac/clearview-ai-local-police-facial-recognition> <sup>[[Archive.org]][935]</sup>

[^171]: Wired, Clearview AI Has New Tools to Identify You in Photos <https://www.wired.com/story/clearview-ai-new-tools-identify-you-photos/> <sup>[[Archive.org]][936]</sup>

[^172]: NEC, Neoface <https://www.nec.com/en/global/solutions/biometrics/face/neofacewatch.html> <sup>[[Archive.org]][937]</sup>

[^173]: The Guardian, Met police deploy live facial recognition technology <https://www.theguardian.com/uk-news/2020/feb/11/met-police-deploy-live-facial-recognition-technology> <sup>[[Archive.org]][938]</sup>

[^174]: YouTube, The Economist, China: facial recognition and state control <https://www.youtube.com/watch?v=lH2gMNrUuEY> <sup>[[Invidious]][939]</sup>

[^175]: CNN, Want your unemployment benefits? You may have to submit to facial recognition first <https://edition.cnn.com/2021/07/23/tech/idme-unemployment-facial-recognition/index.html> <sup>[[Archive.org]][940]</sup>

[^176]: Washington Post, Huawei tested AI software that could recognize Uighur minorities and alert police, report says <https://www.washingtonpost.com/technology/2020/12/08/huawei-tested-ai-software-that-could-recognize-uighur-minorities-alert-police-report-says/> <sup>[[Archive.org]][941]</sup>

[^177]: The Intercept, How a Facial Recognition Mismatch Can Ruin Your Life <https://theintercept.com/2016/10/13/how-a-facial-recognition-mismatch-can-ruin-your-life/> <sup>[[Tor Mirror]][942]</sup> <sup>[[Archive.org]][943]</sup>

[^178]: Vice, Facial Recognition Failures Are Locking People Out of Unemployment Systems <https://www.vice.com/en/article/5dbywn/facial-recognition-failures-are-locking-people-out-of-unemployment-systems> <sup>[[Archive.org]][944]</sup>

[^179]: BBC, WhatsApp photo drug dealer caught by 'groundbreaking' work <https://www.bbc.com/news/uk-wales-43711477> <sup>[[Archive.org]][945]</sup>

[^180]: CNN, Drug dealer jailed after sharing a photo of cheese that included his fingerprints <https://edition.cnn.com/2021/05/25/uk/drug-dealer-cheese-sentenced-scli-gbr-intl/index.html> <sup>[[Archive.org]][946]</sup>

[^181]: Vice.com, Cops Got a Drug Dealer's Fingerprints From Photos of His Hand on WhatsApp <https://www.vice.com/en/article/evqk9e/photo-of-fingerprints-used-to-arrest-drug-dealers> <sup>[[Archive.org]][947]</sup>

[^182]: JUSTIA Patent, Identification of taste attributes from an audio signal <https://patents.justia.com/patent/10891948> <sup>[[Archive.org]][948]</sup>

[^183]: PYMNTS, Iris Scan Serves As Traveler ID At Dubai Airport <https://www.pymnts.com/news/biometrics/2021/iris-scan-traveler-identification-dubai-airport/> <sup>[[Archive.org]][949]</sup>

[^184]: IMDB, Gattaca 1997, <https://www.imdb.com/title/tt0119177/> <sup>[[Archive.org]][950]</sup>

[^185]: IMDB, Person of Interest 2011 <https://www.imdb.com/title/tt1839578> <sup>[[Archive.org]][951]</sup>

[^186]: IMDB, Minority Report 2002, <https://www.imdb.com/title/tt0181689> <sup>[[Archive.org]][952]</sup>

[^187]: Wikipedia, Deepfake <https://en.wikipedia.org/wiki/Deepfake> <sup>[[Wikiless]][953]</sup> <sup>[[Archive.org]][954]</sup>

[^188]: Econotimes, Deepfake Voice Technology: The Good. The Bad. The Future <https://www.econotimes.com/Deepfake-Voice-Technology-The-Good-The-Bad-The-Future-1601278> <sup>[[Archive.org]][955]</sup>

[^189]: Wikipedia, Deepfake Events <https://en.wikipedia.org/wiki/Deepfake#Example_events> <sup>[[Wikiless]][953]</sup> <sup>[[Archive.org]][954]</sup>

[^190]: Forbes, A Voice Deepfake Was Used To Scam A CEO Out Of $243,000 <https://www.forbes.com/sites/jessedamiani/2019/09/03/a-voice-deepfake-was-used-to-scam-a-ceo-out-of-243000/> <sup>[[Archive.org]][956]</sup>

[^191]: Joseph Steinberg, How To Prevent Facial Recognition Technology From Identifying You <https://josephsteinberg.com/how-to-prevent-facial-recognition-technology-from-identifying-you/> <sup>[[Archive.org]][957]</sup>

[^192]: NIST, Face recognition accuracy with masks using pre-COVID-19 algorithms <https://nvlpubs.nist.gov/nistpubs/ir/2020/NIST.IR.8311.pdf> <sup>[[Archive.org]][958]</sup>

[^193]: BBC, Facial recognition identifies people wearing masks <https://www.bbc.com/news/technology-55573802> <sup>[[Archive.org]][959]</sup>

[^194]: University of Wisconsin, Exploring Reflectacles As Anti-Surveillance Glasses and for Adversarial Machine Learning in Computer Vision <http://diglib.uwgb.edu/digital/api/collection/p17003coll4/id/71/download> <sup>[[Archive.org]][960]</sup>

[^195]: Wikipedia, Phishing <https://en.wikipedia.org/wiki/Phishing> <sup>[[Wikiless]][961]</sup> <sup>[[Archive.org]][962]</sup>

[^196]: Wikipedia, Social Engineering <https://en.wikipedia.org/wiki/Social_engineering_(security)> <sup>[[Wikiless]][963]</sup> <sup>[[Archive.org]][964]</sup>

[^197]: BBC, Spy pixels in emails have become endemic <https://www.bbc.com/news/technology-56071437> <sup>[[Archive.org]][965]</sup>

[^198]: Vice, Facebook Helped the FBI Hack a Child Predator <https://www.vice.com/en/article/v7gd9b/facebook-helped-fbi-hack-child-predator-buster-hernandez> <sup>[[Archive.org]][666]</sup>

[^199]: Wikipedia, Exploit <https://en.wikipedia.org/wiki/Exploit_(computer_security)> <sup>[[Wikiless]][966]</sup> <sup>[[Archive.org]][967]</sup>

[^200]: Wikipedia, Freedom Hosting <https://en.wikipedia.org/wiki/Freedom_Hosting> <sup>[[Wikiless]][968]</sup> <sup>[[Archive.org]][969]</sup>

[^201]: Wired, 2013 FBI Admits It Controlled Tor Servers Behind Mass Malware Attack <https://www.wired.com/2013/09/freedom-hosting-fbi/> <sup>[[Archive.org]][970]</sup>

[^202]: Wikipedia, 2020 United States federal government data breach <https://en.wikipedia.org/wiki/2020_United_States_federal_government_data_breach> <sup>[[Wikiless]][971]</sup> <sup>[[Archive.org]][972]</sup>

[^203]: BBC, China social media: WeChat and the Surveillance State <https://www.bbc.com/news/blogs-china-blog-48552907> <sup>[[Archive.org]][973]</sup>

[^204]: The Intercept, Revealed: Massive Chinese Police Database <https://theintercept.com/2021/01/29/china-uyghur-muslim-surveillance-police/> <sup>[[Tor Mirror]][974]</sup> <sup>[[Archive.org]][975]</sup>

[^205]: Wikipedia, Sandbox <https://en.wikipedia.org/wiki/Sandbox_(computer_security)> <sup>[[Wikiless]][976]</sup> <sup>[[Archive.org]][977]</sup>

[^206]: Wired, Why the Security of USB Is Fundamentally Broken <https://www.wired.com/2014/07/usb-security/> <sup>[[Archive.org]][978]</sup>

[^207]: Wikipedia, Stuxnet <https://en.wikipedia.org/wiki/Stuxnet> <sup>[[Wikiless]][979]</sup> <sup>[[Archive.org]][980]</sup>

[^208]: Superuser.com, How do I safely investigate a USB stick found in the parking lot at work? <https://superuser.com/questions/1206321/how-do-i-safely-investigate-a-usb-stick-found-in-the-parking-lot-at-work> <sup>[[Archive.org]][981]</sup>

[^209]: The Guardian, Glenn Greenwald: how the NSA tampers with US-made internet routers <https://www.theguardian.com/books/2014/may/12/glenn-greenwald-nsa-tampers-us-internet-routers-snowden> <sup>[[Archive.org]][982]</sup>

[^210]: Wikipedia, Rootkit <https://en.wikipedia.org/wiki/Rootkit> <sup>[[Wikiless]][983]</sup> <sup>[[Archive.org]][984]</sup>

[^211]: Wikipedia, Userspace <https://en.wikipedia.org/wiki/User_space> <sup>[[Wikiless]][985]</sup> <sup>[[Archive.org]][986]</sup>

[^212]: Wikipedia, Firmware <https://en.wikipedia.org/wiki/Firmware> <sup>[[Wikiless]][987]</sup> <sup>[[Archive.org]][988]</sup>

[^213]: Wikipedia, BIOS <https://en.wikipedia.org/wiki/BIOS> <sup>[[Wikiless]][989]</sup> <sup>[[Archive.org]][990]</sup>

[^214]: Wikipedia, UEFI <https://en.wikipedia.org/wiki/Unified_Extensible_Firmware_Interface> <sup>[[Wikiless]][991]</sup> <sup>[[Archive.org]][992]</sup>

[^215]: Bellingcat, Joseph Mifsud: Rush for the EXIF <https://www.bellingcat.com/news/americas/2018/10/26/joseph-mifsud-rush-exif/> <sup>[[Archive.org]][993]</sup>

[^216]: Zoom Support, Adding a watermark <https://support.zoom.us/hc/en-us/articles/209605273-Adding-a-Watermark> <sup>[[Archive.org]][994]</sup>

[^217]: Zoom Support, Audio Watermark <https://support.zoom.us/hc/en-us/articles/360021839031-Audio-Watermark> <sup>[[Archive.org]][995]</sup>

[^218]: CreativeCloud Extension, IMATAG <https://exchange.adobe.com/creativecloud.details.101789.imatag-invisible-watermark-and-image-monitoring.html> <sup>[[Archive.org]][996]</sup>

[^219]: NexGuard, <https://dtv.nagra.com/nexguard-forensic-watermarking> <sup>[[Archive.org]][997]</sup>

[^220]: Vobile Solutions, <https://www.vobilegroup.com/> <sup>[[Archive.org]][998]</sup>

[^221]: Cinavia, <https://www.cinavia.com/languages/english/pages/technology.html> <sup>[[Archive.org]][999]</sup>

[^222]: Imatag, <https://www.imatag.com/> <sup>[[Archive.org]][1000]</sup>

[^223]: Wikipedia, Steganography <https://en.wikipedia.org/wiki/Steganography> <sup>[[Wikiless]][1001]</sup> <sup>[[Archive.org]][1002]</sup>

[^224]: IEEExplore, A JPEG compression resistant steganography scheme for raster graphics images <https://ieeexplore.ieee.org/document/4428921> <sup>[[Archive.org]][1003]</sup>

[^225]: ScienceDirect, Robust audio watermarking using perceptual masking <https://www.sciencedirect.com/science/article/abs/pii/S0165168498000140> <sup>[[Archive.org]][1004]</sup>

[^226]: IEEExplore, Spread-spectrum watermarking of audio signals <https://ieeexplore.ieee.org/abstract/document/1188746> <sup>[[Archive.org]][1005]</sup>

[^227]: Google Scholar, source camera identification <https://scholar.google.com/scholar?q=source+camera+identification> <sup>[[Archive.org]][1006]</sup>

[^228]: Wikipedia, Printing Steganography <https://en.wikipedia.org/wiki/Machine_Identification_Code> <sup>[[Wikiless]][1007]</sup> <sup>[[Archive.org]][1008]</sup>

[^229]: MIT, SeeingYellow, <http://seeingyellow.com/> <sup>[[Archive.org]][1009]</sup>

[^230]: arXiv, An Analysis of Anonymity in the Bitcoin System <https://arxiv.org/abs/1107.4524> <sup>[[Archive.org]][1010]</sup>

[^231]: Bellingcat, How To Track Illegal Funding Campaigns Via Cryptocurrency, <https://www.bellingcat.com/resources/how-tos/2019/03/26/how-to-track-illegal-funding-campaigns-via-cryptocurrency/> <sup>[[Archive.org]][1011]</sup>

[^232]: CoinDesk, Leaked Slides Show How Chainalysis Flags Crypto Suspects for Cops <https://www.coindesk.com/business/2021/09/21/leaked-slides-show-how-chainalysis-flags-crypto-suspects-for-cops/> <sup>[[Archive.org]][1012]</sup>

[^233]: Wikipedia, KYC <https://en.wikipedia.org/wiki/Know_your_customer> <sup>[[Wikiless]][1013]</sup> <sup>[[Archive.org]][1014]</sup>

[^234]: arXiv.org, Probing the Mystery of Cryptocurrency Theft: An Investigation into Methods for Taint Analysis <https://arxiv.org/pdf/1906.05754.pdf> <sup>[[Archive.org]][1015]</sup>

[^235]: YouTube, Breaking Monero <https://www.youtube.com/watch?v=WOyC6OB6ezA&list=PLsSYUeVwrHBnAUre2G_LYDsdo-tD0ov-y> <sup>[[Invidious]][1016]</sup>

[^236]: Monero, Monero vs Princeton Researchers, <https://monero.org/monero-vs-princeton-researchers/> <sup>[[Archive.org]][1017]</sup>

[^237]: Wikipedia, Cryptocurrency Tumbler <https://en.wikipedia.org/wiki/Cryptocurrency_tumbler> <sup>[[Wikiless]][1018]</sup> <sup>[[Archive.org]][1019]</sup>

[^238]: Wikipedia, Security Through Obscurity <https://en.wikipedia.org/wiki/Security_through_obscurity> <sup>[[Wikiless]][1020]</sup> <sup>[[Archive.org]][1021]</sup>

[^239]: ArXiv, Tracking Mixed Bitcoins, <https://arxiv.org/abs/2009.14007> <sup>[[Archive.org]][1022]</sup>

[^240]: SSRN, The Cryptocurrency Tumblers: Risks, Legality and Oversight <https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3080361> <sup>[[Archive.org]][1023]</sup>

[^241]: Magnet Forensics, Magnet AXIOM <https://www.magnetforensics.com/products/magnet-axiom/cloud/> <sup>[[Archive.org]][1024]</sup>

[^242]: Cellebrite, Unlock cloud-based evidence to solve the case sooner <https://www.cellebrite.com/en/ufed-cloud/> <sup>[[Archive.org]][1025]</sup>

[^243]: Chromium Documentation, Technical analysis of client identification mechanisms <https://sites.google.com/a/chromium.org/dev/Home/chromium-security/client-identification-mechanisms#TOC-Machine-specific-characteristics> <sup>[[Archive.org]][1026]</sup>

[^244]: Mozilla Wiki, Fingerprinting <https://wiki.mozilla.org/Fingerprinting> <sup>[[Archive.org]][1027]</sup>

[^245]: Grayshirt, <https://www.grayshift.com/> <sup>[[Archive.org]][1028]</sup>

[^246]: Securephones.io, Data Security on Mobile Devices: Current State of the Art, Open Problems, and Proposed Solutions <https://securephones.io/main.pdf> <sup>[[Archive.org]][1029]</sup>

[^247]: Loup-Vaillant.fr, Rolling Your Own Crypto <https://loup-vaillant.fr/articles/rolling-your-own-crypto> <sup>[[Archive.org]][1030]</sup>

[^248]: Dhole Moments, Crackpot Cryptography and Security Theater <https://soatok.blog/2021/02/09/crackpot-cryptography-and-security-theater/> <sup>[[Archive.org]][1031]</sup>

[^249]: Vice.com, Why You Don't Roll Your Own Crypto <https://www.vice.com/en/article/wnx8nq/why-you-dont-roll-your-own-crypto> <sup>[[Archive.org]][1032]</sup>

[^250]: arXiv, MIT, You Really Shouldn't Roll Your Own Crypto: An Empirical Study of Vulnerabilities in Cryptographic Libraries <https://arxiv.org/pdf/2107.04940.pdf> <sup>[[Archive.org]][1033]</sup>

[^251]: YouTube, Great Crypto Failures <https://www.youtube.com/watch?v=loy84K3AJ5Q> <sup>[[Invidious]][1034]</sup>

[^252]: Cryptography Dispatches, The Most Backdoor-Looking Bug I've Ever Seen <https://buttondown.email/cryptography-dispatches/archive/cryptography-dispatches-the-most-backdoor-looking/> <sup>[[Archive.org]][165]</sup>

[^253]: Citizenlab.ca, Move Fast and Roll Your Own Crypto <https://citizenlab.ca/2020/04/move-fast-roll-your-own-crypto-a-quick-look-at-the-confidentiality-of-zoom-meetings/> <sup>[[Archive.org]][1035]</sup>

[^254]: Jack Poon, The myth of military grade encryption <https://medium.com/@atcipher/the-myth-of-military-grade-encryption-292313ae6369> <sup>[[Archive.org]][1036]</sup>

[^255]: Congruent Labs, Stop calling it "Military-Grade Encryption" <https://blog.congruentlabs.co/military-grade-encryption/> <sup>[[Archive.org]][1037]</sup>

[^256]: IronCoreLabs Blog, "Military Grade Encryption" <https://blog.ironcorelabs.com/military-grade-encryption-69aae0145588> <sup>[[Archive.org]][1038]</sup>

[^257]: Wikipedia, BLAKE2, <https://en.wikipedia.org/wiki/BLAKE_(hash_function)#BLAKE2> <sup>[[Wikiless]][1039]</sup> <sup>[[Archive.org]][1040]</sup>

[^258]: Wikipedia, AES Instruction Set, <https://en.wikipedia.org/wiki/AES_instruction_set> <sup>[[Wikiless]][1041]</sup> <sup>[[Archive.org]][1042]</sup>

[^259]: Wikipedia, ChaCha Variants, <https://en.wikipedia.org/wiki/Salsa20#ChaCha_variant> <sup>[[Wikiless]][1043]</sup> <sup>[[Archive.org]][1044]</sup>

[^260]: Wikipedia, Serpent, <https://en.wikipedia.org/wiki/Serpent_(cipher)> <sup>[[Wikiless]][1045]</sup> <sup>[[Archive.org]][1046]</sup>

[^261]: Wikipedia, TwoFish, <https://en.wikipedia.org/wiki/Twofish> <sup>[[Wikiless]][1047]</sup> <sup>[[Archive.org]][1048]</sup>

[^262]: Lacatora, The PGP Problem <https://latacora.singles/2019/07/16/the-pgp-problem.html> <sup>[[Archive.org]][1049]</sup>

[^263]: Wikipedia, Shor's Algorithm, <https://en.wikipedia.org/wiki/Shor%27s_algorithm> <sup>[[Wikiless]][1050]</sup> <sup>[[Archive.org]][1051]</sup>

[^264]: Wikipedia, Gag Order, <https://en.wikipedia.org/wiki/Gag_order> <sup>[[Wikiless]][1052]</sup> <sup>[[Archive.org]][1053]</sup>

[^265]: Wikipedia, National Security Letter <https://en.wikipedia.org/wiki/National_security_letter> <sup>[[Wikiless]][1054]</sup> <sup>[[Archive.org]][1055]</sup>

[^266]: TechCrunch, ProtonMail logged IP address of French activist after order by Swiss authorities <https://techcrunch.com/2021/09/06/protonmail-logged-ip-address-of-french-activist-after-order-by-swiss-authorities/> <sup>[[Archive.org]][1056]</sup>

[^267]: ArsTechnica, VPN servers seized by Ukrainian authorities weren't encrypted <https://arstechnica.com/gadgets/2021/07/vpn-servers-seized-by-ukrainian-authorities-werent-encrypted/> <sup>[[Archive.org]][1057]</sup>

[^268]: BleepingComputer, DoubleVPN servers, logs, and account info seized by law enforcement <https://www.bleepingcomputer.com/news/security/doublevpn-servers-logs-and-account-info-seized-by-law-enforcement/> <sup>[[Archive.org]][1058]</sup>

[^269]: CyberScoop, Court rules encrypted email provider Tutanota must monitor messages in blackmail case <https://www.cyberscoop.com/court-rules-encrypted-email-tutanota-monitor-messages/> <sup>[[Archive.org]][1059]</sup>

[^270]: Heise Online (German), <https://www.heise.de/news/Gericht-zwingt-Mailprovider-Tutanota-zu-Ueberwachungsfunktion-4972460.html> <sup>[[Archive.org]][1060]</sup>

[^271]: PCMag, Did PureVPN Cross a Line When It Disclosed User Information? <https://www.pcmag.com/opinions/did-purevpn-cross-a-line-when-it-disclosed-user-information> <sup>[[Archive.org]][1061]</sup>

[^272]: Internet Archive, Wipeyourdata, "No logs" EarthVPN user arrested after police finds logs <https://archive.is/XNuVw#selection-230.0-230.1> <sup>[[Archive.org]][1062]</sup>

[^273]: Internet Archive, Invisibler, What Everybody Ought to Know About HideMyAss <https://archive.is/ag9w4#selection-136.0-136.1>

[^274]: Wikipedia, Lavabit Suspension and Gag order, <https://en.wikipedia.org/wiki/Lavabit#Suspension_and_gag_order> <sup>[[Wikiless]][1063]</sup> <sup>[[Archive.org]][1064]</sup>

[^275]: Wikipedia, Warrant Canary <https://en.wikipedia.org/wiki/Warrant_canary> <sup>[[Wikiless]][1065]</sup> <sup>[[Archive.org]][1066]</sup>

[^276]: Washington Post, The intelligence coup of the century <https://www.washingtonpost.com/graphics/2020/world/national-security/cia-crypto-encryption-machines-espionage/> <sup>[[Archive.org]][1067]</sup>

[^277]: Swissinfo.ch, Second Swiss firm allegedly sold encrypted spying devices <https://www.swissinfo.ch/eng/second-swiss-firm-allegedly-sold-encrypted-spying-devices/46186432> <sup>[[Archive.org]][1068]</sup>

[^278]: Wikipedia, Das Leben der Anderen <https://en.wikipedia.org/wiki/The_Lives_of_Others> <sup>[[Wikiless]][1069]</sup> <sup>[[Archive.org]][1070]</sup>

[^279]: Wired, Mind the Gap: This Researcher Steals Data With Noise, Light, and Magnets <https://www.wired.com/story/air-gap-researcher-mordechai-guri/> <sup>[[Archive.org]][1071]</sup>

[^280]: Scientific American, A Blank Wall Can Show How Many People Are in a Room and What They're Doing <https://www.scientificamerican.com/article/a-blank-wall-can-show-how-many-people-are-in-a-room-and-what-theyre-doing/> <sup>[[Archive.org]][1072]</sup>

[^281]: Scientific American, A Shiny Snack Bag's Reflections Can Reconstruct the Room around It <https://www.scientificamerican.com/article/a-shiny-snack-bags-reflections-can-reconstruct-the-room-around-it/> <sup>[[Archive.org]][1073]</sup>

[^282]: Scientific American, Footstep Sensors Identify People by Gait <https://www.scientificamerican.com/article/footstep-sensors-identify-people-by-gait/> <sup>[[Archive.org]][1074]</sup>

[^283]: Ben Nassi, Lamphone, <https://www.nassiben.com/lamphone> <sup>[[Archive.org]][1075]</sup>

[^284]: The Guardian, Laser spying: is it really practical? <https://www.theguardian.com/world/2013/aug/22/gchq-warned-laser-spying-guardian-offices> <sup>[[Archive.org]][1076]</sup>

[^285]: ArsTechnica, Photos of an NSA "upgrade" factory show Cisco router getting implant <https://arstechnica.com/tech-policy/2014/05/photos-of-an-nsa-upgrade-factory-show-cisco-router-getting-implant/> <sup>[[Archive.org]][1077]</sup>

[^286]: Wikipedia, Rubber-hose Cryptanalysis https://en.wikipedia.org/wiki/Rubber-hose_cryptanalysis

[^287]: Defuse.ca, TrueCrypt's Plausible Deniability is Theoretically Useless <https://defuse.ca/truecrypt-plausible-deniability-useless-by-game-theory.htm> <sup>[[Archive.org]][245]</sup>

[^288]: Wikipedia, OONI, <https://en.wikipedia.org/wiki/OONI> <sup>[[Wikiless]][1078]</sup> <sup>[[Archive.org]][1079]</sup>

[^289]: Privacy International, Timeline of SIM Card Registration Laws <https://privacyinternational.org/long-read/3018/timeline-sim-card-registration-laws> <sup>[[Archive.org]][1080]</sup>

[^290]: NYTimes, Lost Passwords Lock Millionaires Out of Their Bitcoin Fortunes <https://www.nytimes.com/2021/01/12/technology/bitcoin-passwords-wallets-fortunes.html> <sup>[[Archive.org]][1081]</sup>

[^291]: Usenix.org, Shedding too much Light on a Microcontroller's Firmware Protection <https://www.usenix.org/system/files/conference/woot17/woot17-paper-obermaier.pdf> <sup>[[Archive.org]][1082]</sup>

[^292]: TorProject.org, Can I run Tor Browser on an iOS device? <https://support.torproject.org/tormobile/tormobile-3/> <sup>[[Archive.org]][1083]</sup>

[^293]: Wikipedia, Tails, <https://en.wikipedia.org/wiki/Tails_(operating_system)> <sup>[[Wikiless]][1084]</sup> <sup>[[Archive.org]][1085]</sup>

[^294]: Vice.com, Facebook Helped the FBI Hack a Child Predator <https://www.vice.com/en/article/v7gd9b/facebook-helped-fbi-hack-child-predator-buster-hernandez> <sup>[[Archive.org]][666]</sup>

[^295]: Veracrypt Documentation, Trim Operations <https://www.veracrypt.fr/en/Trim%20Operation.html> <sup>[[Archive.org]][1086]</sup>

[^296]: Coreboot, <https://www.coreboot.org/> <sup>[[Archive.org]][1087]</sup>

[^297]: YouTube, 36C3 - Uncover, Understand, Own - Regaining Control Over Your AMD CPU <https://www.youtube.com/watch?v=bKH5nGLgi08&t=2834s> <sup>[[Invidious]][75]</sup>

[^298]: Qubes OS, Anti-Evil Maid, <https://github.com/QubesOS/qubes-antievilmaid> <sup>[[Archive.org]][271]</sup>

[^299]: QubesOS FAQ, <https://www.qubes-os.org/faq/#is-secure-boot-supported> <sup>[[Archive.org]][368]</sup>

[^300]: Wikipedia, Secure Boot, <https://en.wikipedia.org/wiki/Unified_Extensible_Firmware_Interface#Secure_boot> <sup>[[Wikiless]][991]</sup> <sup>[[Archive.org]][992]</sup>

[^301]: Wikipedia, Booting <https://en.wikipedia.org/wiki/Booting> <sup>[[Wikiless]][1088]</sup> <sup>[[Archive.org]][1089]</sup>

[^302]: Wired <https://www.wired.com/2013/12/better-data-security-nail-polish/> <sup>[[Archive.org]][1090]</sup>

[^303]: Wikipedia, Virtual Machine <https://en.wikipedia.org/wiki/Virtual_machine> <sup>[[Wikiless]][1091]</sup> <sup>[[Archive.org]][1092]</sup>

[^304]: Wikipedia, Plausible Deniability <https://en.wikipedia.org/wiki/Plausible_deniability> <sup>[[Wikiless]][1093]</sup> <sup>[[Archive.org]][1094]</sup>

[^305]: Wikipedia, Deniable Encryption <https://en.wikipedia.org/wiki/Deniable_encryption> <sup>[[Wikiless]][1095]</sup> <sup>[[Archive.org]][1096]</sup>

[^306]: PrivacyGuides.org, Don't use Windows 10 - It's a privacy nightmare <https://privacyguides.org/operating-systems/#win10> <sup>[[Archive.org]][1097]</sup>

[^307]: Wikipedia, Deniable Encryption <https://en.wikipedia.org/wiki/Deniable_encryption> <sup>[[Wikiless]][1095]</sup> <sup>[[Archive.org]][1096]</sup>

[^308]: Wikipedia, Key Disclosure Laws <https://en.wikipedia.org/wiki/Key_disclosure_law> <sup>[[Wikiless]][546]</sup> <sup>[[Archive.org]][547]</sup>

[^309]: GP Digital, World map of encryption laws and policies <https://www.gp-digital.org/world-map-of-encryption/> <sup>[[Archive.org]][548]</sup>

[^310]: Wikipedia, Bitlocker <https://en.wikipedia.org/wiki/BitLocker> <sup>[[Wikiless]][1098]</sup> <sup>[[Archive.org]][1099]</sup>

[^311]: Wikipedia, Evil Maid Attack <https://en.wikipedia.org/wiki/Evil_maid_attack> <sup>[[Wikiless]][1100]</sup> <sup>[[Archive.org]][1101]</sup>

[^312]: Wikipedia, Cold Boot Attack <https://en.wikipedia.org/wiki/Cold_boot_attack> <sup>[[Wikiless]][1102]</sup> <sup>[[Archive.org]][1103]</sup>

[^313]: CITP 2008 (<https://www.youtube.com/watch?v=JDaicPIgn9U>) <sup>[[Invidious]][1104]</sup>

[^314]: ResearchGate, Defeating Plausible Deniability of VeraCrypt Hidden Operating Systems <https://www.researchgate.net/publication/318155607_Defeating_Plausible_Deniability_of_VeraCrypt_Hidden_Operating_Systems> <sup>[[Archive.org]][1105]</sup>

[^315]: SANS.org, Mission Implausible: Defeating Plausible Deniability with Digital Forensics <https://www.sans.org/reading-room/whitepapers/forensics/mission-implausible-defeating-plausible-deniability-digital-forensics-39500> <sup>[[Archive.org]][1106]</sup>

[^316]: SourceForge, Veracrypt Forum <https://sourceforge.net/p/veracrypt/discussion/technical/thread/53f33faf/> <sup>[[Archive.org]][1107]</sup>

[^317]: Microsoft, BitLocker Countermeasures <https://docs.microsoft.com/en-us/windows/security/information-protection/bitlocker/bitlocker-countermeasures> <sup>[[Archive.org]][1108]</sup>

[^318]: SANS, Windows ShellBag Forensics in-depth <https://www.sans.org/reading-room/whitepapers/forensics/windows-shellbag-forensics-in-depth-34545> <sup>[[Archive.org]][1109]</sup>

[^319]: University of York, Forensic data recovery from the Windows Search Database <https://eprints.whiterose.ac.uk/75046/1/Forensic_Data_Recovery_From_The_Windows_Search_Database_preprint_DIIN328.pdf> <sup>[[Archive.org]][1110]</sup>

[^320]: A forensic insight into Windows 10 Jump Lists <https://cyberforensicator.com/wp-content/uploads/2017/01/1-s2.0-S1742287616300202-main.2-14.pdf> <sup>[[Archive.org]][1111]</sup>

[^321]: Wikipedia, Gatekeeper <https://en.wikipedia.org/wiki/Gatekeeper_(macOS)> <sup>[[Wikiless]][1112]</sup> <sup>[[Archive.org]][1113]</sup>

[^322]: Alpine Linux Wiki, Setting up a laptop <https://wiki.alpinelinux.org/wiki/Setting_up_a_laptop> <sup>[[Archive.org]][1114]</sup>

[^323]: Wikipedia Veracrypt <https://en.wikipedia.org/wiki/VeraCrypt> <sup>[[Wikiless]][1115]</sup> <sup>[[Archive.org]][1116]</sup>

[^324]: OSTIF Veracrypt Audit, 2016, <https://web.archive.org/web/https://ostif.org/the-veracrypt-audit-results/>

[^325]: Veracrypt Documentation, Unencrypted Data in RAM <https://www.veracrypt.fr/en/Unencrypted%20Data%20in%20RAM.html> <sup>[[Archive.org]][1117]</sup>

[^326]: Veracrypt Documentation, Data Leaks <https://www.veracrypt.fr/code/VeraCrypt/plain/doc/html/Data%20Leaks.html> <sup>[[Archive.org]][1118]</sup>

[^327]: Dolos Group, From Stolen Laptop to Inside the Company Network <https://dolosgroup.io/blog/2021/7/9/from-stolen-laptop-to-inside-the-company-network> <sup>[[Archive.org]][1119]</sup>

[^328]: Trammell Hudson's Projects, Understanding TPM Sniffing Attacks <https://trmm.net/tpm-sniffing/> <sup>[[Archive.org]][1120]</sup>

[^329]: Jon Aubrey, attacking laptops that are protected by Microsoft Bitlocker drive encryption <https://twitter.com/SecurityJon/status/1445020885472235524> <sup>[[Nitter]][1121]</sup>

[^330]: F-Secure Labs, Sniff, there leaks my BitLocker key <https://labs.f-secure.com/blog/sniff-there-leaks-my-bitlocker-key/> <sup>[[Archive.org]][1122]</sup>

[^331]: Microsoft, BitLocker Countermeasures, Attacker countermeasures <https://docs.microsoft.com/en-us/windows/security/information-protection/bitlocker/bitlocker-countermeasures> <sup>[[Archive.org]][1108]</sup>

[^332]: Wikipedia, Trim <https://en.wikipedia.org/wiki/Trim_(computing)> <sup>[[Wikiless]][480]</sup> <sup>[[Archive.org]][481]</sup>

[^333]: Veracrypt Documentation, Trim Operations <https://www.veracrypt.fr/en/Trim%20Operation.html> <sup>[[Archive.org]][1086]</sup>

[^334]: Veracrypt Documentation, Rescue Disk <https://www.veracrypt.fr/en/VeraCrypt%20Rescue%20Disk.html> <sup>[[Archive.org]][1123]</sup>

[^335]: St Cloud State University, Forensic Research on Solid State Drives using Trim Analysis <https://repository.stcloudstate.edu/cgi/viewcontent.cgi?article=1141&context=msia_etds> <sup>[[Archive.org]][1124]</sup>

[^336]: WindowsCentral, Trim Tutorial <https://www.windowscentral.com/how-ensure-trim-enabled-windows-10-speed-ssd-performance> <sup>[[Archive.org]][1125]</sup>

[^337]: Veracrypt Documentation, Trim Operation <https://veracrypt.eu/en/docs/trim-operation/> <sup>[[Archive.org]][1126]</sup>

[^338]: Black Hat 2018, Perfectly Deniable Steganographic Disk Encryption <https://i.blackhat.com/eu-18/Thu-Dec-6/eu-18-Schaub-Perfectly-Deniable-Steganographic-Disk-Encryption.pdf> <sup>[[Archive.org]][1127]</sup>

[^339]: Milan Broz's Blog, TRIM & dm-crypt ... problems? <http://asalor.blogspot.com/2011/08/trim-dm-crypt-problems.html> <sup>[[Archive.org]][1128]</sup>

[^340]: Veracrypt Documentation, Rescue Disk <https://www.veracrypt.fr/en/VeraCrypt%20Rescue%20Disk.html> <sup>[[Archive.org]][1123]</sup>

[^341]: Wikipedia, Virtualbox <https://en.wikipedia.org/wiki/VirtualBox> <sup>[[Wikiless]][1129]</sup> <sup>[[Archive.org]][1130]</sup>

[^342]: VirtualBox Ticket 17987 <https://www.virtualbox.org/ticket/17987> <sup>[[Archive.org]][1131]</sup>

[^343]: Whonix Documentation, Spectre Meltdown, <https://www.whonix.org/wiki/Spectre_Meltdown#VirtualBox> <sup>[[Archive.org]][80]</sup>
...
[^346]: Wikipedia, Whonix <https://en.wikipedia.org/wiki/Whonix> <sup>[[Wikiless]][1132]</sup> <sup>[[Archive.org]][1133]</sup>

[^347]: Oracle Virtualbox Manual, Snapshots <https://docs.oracle.com/en/virtualization/virtualbox/6.0/user/snapshots.html> <sup>[[Archive.org]][1134]</sup>
...
[^349]: Wikipedia, Spectre <https://en.wikipedia.org/wiki/Spectre_(security_vulnerability)> <sup>[[Wikiless]][1135]</sup> <sup>[[Archive.org]][1136]</sup>

[^350]: Wikipedia, Meltdown <https://en.wikipedia.org/wiki/Meltdown_(security_vulnerability)> <sup>[[Wikiless]][1137]</sup> <sup>[[Archive.org]][1138]</sup>

[^351]: Whonix Documentation, Stream Isolation, By Settings <https://www.whonix.org/wiki/Stream_Isolation#By_Settings> <sup>[[Archive.org]][1139]</sup>

[^352]: Wikipedia, TOTP <https://en.wikipedia.org/wiki/Time-based_One-time_Password_algorithm> <sup>[[Wikiless]][1140]</sup> <sup>[[Archive.org]][1141]</sup>

[^353]: Wikipedia, Multi-Factor Authentication <https://en.wikipedia.org/wiki/Multi-factor_authentication> <sup>[[Wikiless]][1142]</sup> <sup>[[Archive.org]][1143]</sup>

[^354]: Whonix Documentation, Bridged Adapters Warning <https://www.whonix.org/wiki/Whonix-Gateway_Security#Warning:_Bridged_Networking> <sup>[[Archive.org]][1144]</sup>

[^355]: Qubes OS, FAQ, <https://www.qubes-os.org/faq/#is-qubes-just-another-linux-distribution> <sup>[[Archive.org]][1145]</sup>

[^356]: Qubes OS, System Requirements <https://www.qubes-os.org/doc/system-requirements/> <sup>[[Archive.org]][1146]</sup>
...
[^359]: Qubes OS Issues, Simulate Hibernation / Suspend-To-Disk #2414 <https://github.com/QubesOS/qubes-issues/issues/2414> <sup>[[Archive.org]][1147]</sup>

[^360]: Wikipedia, AppArmor <https://en.wikipedia.org/wiki/AppArmor> <sup>[[Wikiless]][1148]</sup> <sup>[[Archive.org]][1149]</sup>

[^361]: Wikipedia, SELinux <https://en.wikipedia.org/wiki/Security-Enhanced_Linux> <sup>[[Wikiless]][1150]</sup> <sup>[[Archive.org]][1151]</sup>

[^362]: Wikipedia, TOTP <https://en.wikipedia.org/wiki/Time-based_One-time_Password_algorithm> <sup>[[Wikiless]][1140]</sup> <sup>[[Archive.org]][1141]</sup>

[^363]: Wikipedia, Multi-Factor Authentication <https://en.wikipedia.org/wiki/Multi-factor_authentication> <sup>[[Wikiless]][1142]</sup> <sup>[[Archive.org]][1143]</sup>

[^364]: Wikipedia, Captcha <https://en.wikipedia.org/wiki/CAPTCHA> <sup>[[Wikiless]][1152]</sup> <sup>[[Archive.org]][1153]</sup>

[^365]: Wikipedia, Turing Test <https://en.wikipedia.org/wiki/Turing_test> <sup>[[Wikiless]][1154]</sup> <sup>[[Archive.org]][1155]</sup>

[^366]: Google reCAPTCHA <https://www.google.com/recaptcha/about/> <sup>[[Archive.org]][1156]</sup>

[^367]: hCaptcha <https://www.hcaptcha.com/> <sup>[[Archive.org]][1157]</sup>

[^368]: hCaptcha, hCaptcha Is Now the Largest Independent CAPTCHA Service, Runs on 15% Of The Internet <https://www.hcaptcha.com/post/hcaptcha-now-the-largest-independent-captcha-service> <sup>[[Archive.org]][1158]</sup>

[^369]: Nearcyan.com, You (probably) don't need ReCAPTCHA <https://nearcyan.com/you-probably-dont-need-recaptcha/> <sup>[[Archive.org]][1159]</sup>

[^370]: ArsTechnica, "Google's reCAPTCHA turns "invisible," will separate bots from people without challenges" <https://arstechnica.com/gadgets/2017/03/googles-recaptcha-announces-invisible-background-captchas/> <sup>[[Archive.org]][1160]</sup>

[^371]: BlackHat Asia 2016, "I'm not a human: Breaking the Google reCAPTCHA", <https://www.blackhat.com/docs/asia-16/materials/asia-16-Sivakorn-Im-Not-a-Human-Breaking-the-Google-reCAPTCHA-wp.pdf> <sup>[[Archive.org]][1161]</sup>

[^372]: Google Blog <https://security.googleblog.com/2014/12/are-you-robot-introducing-no-captcha.html> <sup>[[Archive.org]][1162]</sup>

[^373]: Cloudflare Blog, Cloudflare supports Privacy Pass <https://blog.cloudflare.com/cloudflare-supports-privacy-pass/> <sup>[[Archive.org]][1163]</sup>

[^374]: Privacy International, Timeline of SIM Card Registration Laws <https://privacyinternational.org/long-read/3018/timeline-sim-card-registration-laws> <sup>[[Archive.org]][1080]</sup>

[^375]: Wikipedia, Device Fingerprinting <https://en.wikipedia.org/wiki/Device_fingerprint> <sup>[[Wikiless]][1164]</sup> <sup>[[Archive.org]][1165]</sup>

[^376]: Developers Google Blog,

    Guidance to developers affected by our effort to block less secure browsers and applications <https://developers.googleblog.com/2020/08/guidance-for-our-effort-to-block-less-secure-browser-and-apps.html> <sup>[[Archive.org]][1166]</sup>

[^377]: Google Help, Access age-restricted content & features <https://support.google.com/accounts/answer/10071085> <sup>[[Archive.org]][1167]</sup>

[^378]: Wikipedia, Dark Pattern <https://en.wikipedia.org/wiki/Dark_pattern> <sup>[[Wikiless]][1168]</sup> <sup>[[Archive.org]][1169]</sup>

[^379]: The Verge, Tinder will give you a verified blue check mark if you pass its catfishing test <https://www.theverge.com/2020/1/23/21077423/tinder-photo-verification-blue-checkmark-safety-center-launch-noonlight> <sup>[[Archive.org]][1170]</sup>

[^380]: DigitalInformationWorld, Facebook will now require you to Create a Video Selfie for Identity Verification <https://www.digitalinformationworld.com/2020/03/facebook-is-now-demanding-some-users-to-create-a-video-selfie-for-identity-verification.html> <sup>[[Archive.org]][1171]</sup>

[^381]: Vice.com, PornHub Announces 'Biometric Technology' to Verify Users <https://www.vice.com/en/article/m7a4eq/pornhub-new-verification-policy-biometric-id> <sup>[[Archive.org]][1172]</sup>

[^382]: Variety, China Launches Hotline to Report Online Comments That 'Distort' History or 'Deny' Its Cultural Excellence <https://variety.com/2021/digital/news/china-censorship-hotline-historical-nihilism-1234950554/> <sup>[[Archive.org]][1173]</sup>

[^383]: Wikipedia, Trust but verify <https://en.wikipedia.org/wiki/Trust,_but_verify> <sup>[[Wikiless]][762]</sup> <sup>[[Archive.org]][763]</sup>

[^384]: Wikipedia, Zero-trust Security Model <https://en.wikipedia.org/wiki/Zero_trust_security_model> <sup>[[Wikiless]][1174]</sup> <sup>[[Archive.org]][1175]</sup>

[^385]: Wikipedia, Espionage, Organization <https://en.wikipedia.org/wiki/Espionage#Organization> <sup>[[Wikiless]][1176]</sup> <sup>[[Archive.org]][1177]</sup>

[^386]: Medium.com, Kyle McDonald, How to recognize fake AI-generated images <https://kcimc.medium.com/how-to-recognize-fake-ai-generated-images-4d1f6f9a2842> <sup>[[Archive.org]][1178]</sup>

[^387]: Jayway Blog, Using ML to detect fake face images created by AI <https://blog.jayway.com/2020/03/06/using-ml-to-detect-fake-face-images-created-by-ai/> <sup>[[Archive.org]][1179]</sup>

[^388]: Wikipedia, Sim Swapping <https://en.wikipedia.org/wiki/SIM_swap_scam> <sup>[[Wikiless]][1180]</sup> <sup>[[Archive.org]][1181]</sup>

[^389]: Whonix Documentation, <https://www.whonix.org/wiki/Tor#Edit_Tor_Configuration> <sup>[[Archive.org]][1182]</sup>

[^390]: Tor Browser Documentation, <https://support.torproject.org/tbb/tbb-editing-torrc/> <sup>[[Archive.org]][1183]</sup>

[^391]: Facebook Onion Website <http://facebookwkhpilnemxj7asaniu7vnjjbiltxjqhye3mhbshg7kx5tfyd.onion/>

[^392]: Google Help <https://support.google.com/accounts/answer/114129?hl=en> <sup>[[Archive.org]][1184]</sup>

[^393]: Google Help <https://support.google.com/google-ads/answer/7474263?hl=en> <sup>[[Archive.org]][1185]</sup>

[^394]: Google, Your account is disabled <https://support.google.com/accounts/answer/40695> <sup>[[Archive.org]][1186]</sup>

[^395]: Google, Request to restore the account <https://support.google.com/accounts/contact/disabled2> <sup>[[Archive.org]][1187]</sup>

[^396]: Google Help, Update your account to meet age requirements <https://support.google.com/accounts/answer/1333913?hl=en> <sup>[[Archive.org]][1188]</sup>

[^397]: Jumio, ID verification features <https://www.jumio.com/features/> <sup>[[Archive.org]][1189]</sup>

[^398]: Privacyguides.org recommended E-mail Providers <https://privacyguides.org/providers/email/> <sup>[[Archive.org]][1190]</sup>

[^399]: ProtonMail Human Verification System [https://ProtonMail.com/support/knowledge-base/human-verification/][] <sup>[[Archive.org]][1191]</sup>

[^400]: Twitter Appeal Form <https://help.twitter.com/forms/general>

[^401]: KnowYourMeme, Good Luck, I'm Behind 7 Proxies <https://knowyourmeme.com/memes/good-luck-im-behind-7-proxies> <sup>[[Archive.org]][1192]</sup>

[^402]: Wikipedia, end-to-end encryption, <https://en.wikipedia.org/wiki/End-to-end_encryption> <sup>[[Wikiless]][1193]</sup> <sup>[[Archive.org]][1194]</sup>

[^403]: Wikipedia, Forward Secrecy, <https://en.wikipedia.org/wiki/Forward_secrecy> <sup>[[Wikiless]][1195]</sup> <sup>[[Archive.org]][1196]</sup>

[^404]: Protonblog, What is zero-access encryption and why it is important for security <https://protonmail.com/blog/zero-access-encryption/> <sup>[[Archive.org]][1197]</sup>

[^405]: Wikipedia, Cambridge Analytica Scandal, <https://en.wikipedia.org/wiki/Facebook%E2%80%93Cambridge_Analytica_data_scandal> <sup>[[Wikiless]][1198]</sup> <sup>[[Archive.org]][1199]</sup>

[^406]: Signal Blog, Technology preview: Sealed sender for Signal <https://signal.org/blog/sealed-sender/> <sup>[[Archive.org]][1200]</sup>

[^407]: Signal Blog, Private Contact Discovery, <https://signal.org/blog/private-contact-discovery/> <sup>[[Archive.org]][1201]</sup>

[^408]: Signal Blog, Private Group System, <https://signal.org/blog/signal-private-group-system/> <sup>[[Archive.org]][1202]</sup>

[^409]: Privacyguides.org, File-Sharing <https://privacyguides.org/software/file-sharing/> <sup>[[Archive.org]][1203]</sup>

[^410]: Privacyguides.org, Real-Time Communication <https://privacyguides.org/software/real-time-communication/> <sup>[[Archive.org]][1204]</sup>

[^411]: GetSession.org, The Session Protocol: What's changing --- and why <https://getsession.org/session-protocol-explained/> <sup>[[Archive.org]][1205]</sup>

[^412]: Quarkslab, Audit of Session Secure Messaging Application <https://blog.quarkslab.com/audit-of-session-secure-messaging-application.html> <sup>[[Archive.org]][1206]</sup>

[^413]: Techlore, Top 5 BEST Messengers For Privacy <https://www.youtube.com/watch?v=aVwl892hqb4> <sup>[[Invidious]][1207]</sup>

[^414]: Wikipedia, IPFS <https://en.wikipedia.org/wiki/InterPlanetary_File_System> <sup>[[Wikiless]][1208]</sup> <sup>[[Archive.org]][1209]</sup>

[^415]: Praxis Films, Open Letter from Laura Poitras <https://www.praxisfilms.org/open-letter-from-laura-poitras/> <sup>[[Archive.org]][1210]</sup>

[^416]: Wikipedia, SecureDrop <https://en.wikipedia.org/wiki/SecureDrop> <sup>[[Wikiless]][1211]</sup> <sup>[[Archive.org]][1212]</sup>

[^417]: Wikipedia, TPM <https://en.wikipedia.org/wiki/Trusted_Platform_Module> <sup>[[Wikiless]][1213]</sup> <sup>[[Archive.org]][1214]</sup>

[^418]: Wikipedia, Pastebin <https://en.wikipedia.org/wiki/Pastebin> <sup>[[Wikiless]][1215]</sup> <sup>[[Archive.org]][1216]</sup>

[^419]: Wikipedia, Wear Leveling <https://en.wikipedia.org/wiki/Wear_leveling> <sup>[[Wikiless]][1217]</sup> <sup>[[Archive.org]][1218]</sup>

[^420]: Wikipedia, Trim <https://en.wikipedia.org/wiki/Write_amplification#TRIM> <sup>[[Wikiless]][1219]</sup> <sup>[[Archive.org]][1220]</sup>

[^421]: Wikipedia, Write Amplification <https://en.wikipedia.org/wiki/Write_amplification> <sup>[[Wikiless]][1219]</sup> <sup>[[Archive.org]][1220]</sup>

[^422]: Wikipedia, Trim Disadvantages <https://en.wikipedia.org/wiki/Trim_(computing)#Disadvantages> <sup>[[Wikiless]][480]</sup> <sup>[[Archive.org]][481]</sup>

[^423]: Wikipedia, Garbage Collection <https://en.wikipedia.org/wiki/Write_amplification#Garbage_collection> <sup>[[Wikiless]][1219]</sup> <sup>[[Archive.org]][1220]</sup>

[^424]: Techgage, Too TRIM? When SSD Data Recovery is Impossible <https://techgage.com/article/too_trim_when_ssd_data_recovery_is_impossible/> <sup>[[Archive.org]][1221]</sup>

[^425]: ResearchGate, Live forensics method for acquisition on the Solid-State Drive (SSD) NVMe TRIM function <https://www.researchgate.net/publication/341761017_Live_forensics_method_for_acquisition_on_the_Solid_State_Drive_SSD_NVMe_TRIM_function> <sup>[[Archive.org]][1222]</sup>

[^426]: ElcomSoft, Life after Trim: Using Factory Access Mode for Imaging SSD Drives <https://blog.elcomsoft.com/2019/01/life-after-trim-using-factory-access-mode-for-imaging-ssd-drives/> <sup>[[Archive.org]][1223]</sup>

[^427]: Forensic Focus, Forensic Acquisition Of Solid State Drives With Open Source Tools <https://www.forensicfocus.com/articles/forensic-acquisition-of-solid-state-drives-with-open-source-tools/> <sup>[[Archive.org]][1224]</sup>

[^428]: ResearchGate, Solid State Drive Forensics: Where Do We Stand? <https://www.researchgate.net/publication/325976653_Solid_State_Drive_Forensics_Where_Do_We_Stand> <sup>[[Archive.org]][1225]</sup>

[^429]: Wikipedia, Parted Magic <https://en.wikipedia.org/wiki/Parted_Magic> <sup>[[Wikiless]][1226]</sup> <sup>[[Archive.org]][1227]</sup>

[^430]: Wikipedia, hdparm <https://en.wikipedia.org/wiki/Hdparm> <sup>[[Wikiless]][1228]</sup> <sup>[[Archive.org]][1229]</sup>

[^431]: GitHub, nvme-cli <https://github.com/linux-nvme/nvme-cli> <sup>[[Archive.org]][1230]</sup>

[^432]: PartedMagic Secure Erase, <https://partedmagic.com/secure-erase/> <sup>[[Archive.org]][1231]</sup>

[^433]: Partedmagic NVMe Secure Erase, <https://partedmagic.com/nvme-secure-erase/> <sup>[[Archive.org]][1232]</sup>

[^434]: UFSExplorer, Can I recover data from an encrypted storage? <https://www.ufsexplorer.com/solutions/data-recovery-on-encrypted-storage.php> <sup>[[Archive.org]][1233]</sup>

[^435]: Apple Developer Documentation, <https://developer.apple.com/library/archive/documentation/FileManagement/Conceptual/APFS_Guide/FAQ/FAQ.html> <sup>[[Archive.org]][1234]</sup>

[^436]: EFF, How to: Delete Your Data Securely on macOS <https://ssd.eff.org/en/module/how-delete-your-data-securely-macos> <sup>[[Archive.org]][503]</sup>

[^437]: Privacyguides.org, Productivity tools <https://privacyguides.org/software/productivity/> <sup>[[Archive.org]][1235]</sup>

[^438]: Whonix Documentation, Scrubbing Metadata <https://www.whonix.org/wiki/Metadata> <sup>[[Archive.org]][1236]</sup>

[^439]: Tails documentation, MAT <https://gitlab.tails.boum.org/tails/blueprints/-/wikis/doc/mat/> <sup>[[Archive.org]][1237]</sup>

[^440]: GitHub, Disable Gatekeeper on macOS Big Sur (11.x) <https://disable-gatekeeper.github.io/> <sup>[[Archive.org]][1238]</sup>

[^441]: DuckDuckGo help, Cache <https://help.duckduckgo.com/duckduckgo-help-pages/features/cache/> <sup>[[Archive.org]][1239]</sup>

[^442]: DuckDuckGo help, Sources <https://help.duckduckgo.com/duckduckgo-help-pages/results/sources/> <sup>[[Archive.org]][1240]</sup>

[^443]: Wikipedia, Dead Drop <https://en.wikipedia.org/wiki/Dead_drop> <sup>[[Wikiless]][1241]</sup> <sup>[[Archive.org]][1242]</sup>

[^444]: Wikipedia, Secure Communication Obfuscation <https://en.wikipedia.org/wiki/Obfuscation#Secure_communication> <sup>[[Wikiless]][1243]</sup> <sup>[[Archive.org]][1244]</sup>

[^445]: Wikipedia, Steganography <https://en.wikipedia.org/wiki/Steganography> <sup>[[Wikiless]][1001]</sup> <sup>[[Archive.org]][1002]</sup>

[^446]: Wikipedia, Kleptography <https://en.wikipedia.org/wiki/Kleptography> <sup>[[Wikiless]][1245]</sup> <sup>[[Archive.org]][1246]</sup>

[^447]: Wikipedia, Koalang <https://en.wikipedia.org/wiki/Koalang> <sup>[[Wikiless]][1247]</sup> <sup>[[Archive.org]][1248]</sup>

[^448]: Wikipedia, OPSEC <https://en.wikipedia.org/wiki/Operations_security> <sup>[[Wikiless]][1249]</sup> <sup>[[Archive.org]][1250]</sup>

[^449]: Quote Investigator, A Lie Can Travel Halfway Around the World While the Truth Is Putting On Its Shoes <https://quoteinvestigator.com/2014/07/13/truth/> <sup>[[Archive.org]][1251]</sup>

[^450]: Privacyguides.org, Operating Systems <https://privacyguides.org/operating-systems/> <sup>[[Archive.org]][1252]</sup>

[^451]: Brave Support, What is a Private Window with Tor? <https://support.brave.com/hc/en-us/articles/360018121491-What-is-a-Private-Window-with-Tor-> <sup>[[Archive.org]][1253]</sup>

[^452]: Medium.com, The Windows USN Journal <https://medium.com/velociraptor-ir/the-windows-usn-journal-f0c55c9010e> <sup>[[Archive.org]][1254]</sup>

[^453]: Medium.com, Digging into the System Resource Usage Monitor (SRUM) <https://medium.com/velociraptor-ir/digging-into-the-system-resource-usage-monitor-srum-afbadb1a375> <sup>[[Archive.org]][1255]</sup>

[^454]: SANS, Timestamped Registry & NTFS Artifacts from Unallocated Space <https://www.sans.org/blog/timestamped-registry-ntfs-artifacts-from-unallocated-space/> <sup>[[Archive.org]][1256]</sup>

[^455]: DBAN, <https://dban.org/> <sup>[[Archive.org]][1257]</sup>

[^456]: NYTimes, Lost Passwords Lock Millionaires Out of Their Bitcoin Fortunes <https://www.nytimes.com/2021/01/12/technology/bitcoin-passwords-wallets-fortunes.html> <sup>[[Archive.org]][1081]</sup>

[^457]: CrystalDiskInfo <https://crystalmark.info/en/software/crystaldiskinfo/> <sup>[[Archive.org]][1258]</sup>

[^458]: Wikipedia, Faraday Cage, <https://en.wikipedia.org/wiki/Faraday_cage> <sup>[[Wikiless]][1259]</sup> <sup>[[Archive.org]][1260]</sup>

[^459]: Edith Cowan University, A forensic examination of several mobile device Faraday bags & materials to test their effectiveness materials to test their effectiveness <https://ro.ecu.edu.au/cgi/viewcontent.cgi?article=1165&context=adf> <sup>[[Archive.org]][1261]</sup>

[^460]: arXiv, Deep-Spying: Spying using Smartwatch and Deep Learning <https://arxiv.org/abs/1512.05616> <sup>[[Archive.org]][1262]</sup>

[^461]: Acm.org, Privacy Implications of Accelerometer Data: A Review of Possible Inferences <https://dl.acm.org/doi/pdf/10.1145/3309074.3309076> <sup>[[Archive.org]][1263]</sup>

[^462]: YouTube, Fingerprinting Paper - Forensic Education <https://www.youtube.com/watch?v=sO98kDLkh-M> <sup>[[Invidious]][1264]</sup>

[^463]: Wikipedia, Touch DNA, <https://en.wikipedia.org/wiki/Touch_DNA> <sup>[[Wikiless]][1265]</sup> <sup>[[Archive.org]][1266]</sup>

[^464]: TheDNAGuide, DNA from Postage Stamps or Hair Samples? Yeeesssss..... <https://www.yourdnaguide.com/ydgblog/dna-hair-samples-postage-stamps> <sup>[[Archive.org]][1267]</sup>

[^465]: GitHub, Mhinkie, OONI-Detection <https://github.com/mhinkie/ooni-detection> <sup>[[Archive.org]][1268]</sup>

[^466]: Wikipedia, File Verification <https://en.wikipedia.org/wiki/File_verification> <sup>[[Wikiless]][1269]</sup> <sup>[[Archive.org]][1270]</sup>

[^467]: Wikipedia, CRC <https://en.wikipedia.org/wiki/Cyclic_redundancy_check> <sup>[[Wikiless]][1271]</sup> <sup>[[Archive.org]][1272]</sup>

[^468]: Wikipedia, MD5 <https://en.wikipedia.org/wiki/MD5> <sup>[[Wikiless]][1273]</sup> <sup>[[Archive.org]][1274]</sup>

[^469]: Wikipedia, MD5 Security <https://en.wikipedia.org/wiki/MD5#Security> <sup>[[Wikiless]][1273]</sup> <sup>[[Archive.org]][1274]</sup>

[^470]: Wikipedia, Collisions <https://en.wikipedia.org/wiki/Collision_(computer_science)> <sup>[[Wikiless]][1275]</sup> <sup>[[Archive.org]][1276]</sup>

[^471]: Wikipedia, SHA <https://en.wikipedia.org/wiki/Secure_Hash_Algorithms> <sup>[[Wikiless]][1277]</sup> <sup>[[Archive.org]][1278]</sup>

[^472]: Wikipedia, SHA-2 <https://en.wikipedia.org/wiki/SHA-2> <sup>[[Wikiless]][1279]</sup> <sup>[[Archive.org]][1280]</sup>

[^473]: Wikipedia, Collision Resistance <https://en.wikipedia.org/wiki/Collision_resistance> <sup>[[Wikiless]][1281]</sup> <sup>[[Archive.org]][1282]</sup>

[^474]: GnuPG Gpg4win Wiki, Check integrity of Gpg4win packages <https://wiki.gnupg.org/Gpg4win/CheckIntegrity> <sup>[[Archive.org]][1283]</sup>

[^475]: Medium.com, How to verify checksum on Mac <https://medium.com/@EvgeniIvanov/how-to-verify-checksum-on-mac-988f166b0c4f> <sup>[[Archive.org]][1284]</sup>

[^476]: Wikipedia, GPG <https://en.wikipedia.org/wiki/GNU_Privacy_Guard> <sup>[[Wikiless]][1285]</sup> <sup>[[Archive.org]][1286]</sup>

[^477]: Wikipedia, Public-Key Cryptography <https://en.wikipedia.org/wiki/Public-key_cryptography> <sup>[[Wikiless]][1287]</sup> <sup>[[Archive.org]][1288]</sup>

[^478]: Wikipedia, Polymorphic Code <https://en.wikipedia.org/wiki/Polymorphic_code> <sup>[[Wikiless]][1289]</sup> <sup>[[Archive.org]][1290]</sup>

[^479]: Whonix Documentation, Use of AV, <https://www.whonix.org/wiki/Malware_and_Firmware_Trojans#The_Utility_of_Antivirus_Tools> <sup>[[Archive.org]][1291]</sup>

[^480]: Whonix Forums, <https://forums.whonix.org/t/installation-of-antivirus-scanners-by-default/9755/8> <sup>[[Archive.org]][1292]</sup>

[^481]: AV-Test Security Report 2018-2019, <https://www.av-test.org/fileadmin/pdf/security_report/AV-TEST_Security_Report_2018-2019.pdf> <sup>[[Archive.org]][1293]</sup>

[^482]: ZDNet, ESET discovers 21 new Linux malware families <https://www.zdnet.com/article/eset-discovers-21-new-linux-malware-families/> <sup>[[Archive.org]][1294]</sup>

[^483]: NakeSecurity, EvilGnome -- Linux malware aimed at your desktop, not your servers <https://nakedsecurity.sophos.com/2019/07/25/evilgnome-linux-malware-aimed-at-your-laptop-not-your-servers/> <sup>[[Archive.org]][1295]</sup>

[^484]: Immunify, HiddenWasp: How to detect malware hidden on Linux & IoT <https://blog.imunify360.com/hiddenwasp-how-to-detect-malware-hidden-on-linux-iot> <sup>[[Archive.org]][1296]</sup>

[^485]: Wikipedia, Linux Malware <https://en.wikipedia.org/wiki/Linux_malware> <sup>[[Wikiless]][1297]</sup> <sup>[[Archive.org]][1298]</sup>

[^486]: Wikipedia, macOS Malware [https://en.wikipedia.org/wiki/macOS_malware][] <sup>[[Wikiless]][1299]</sup> <sup>[[Archive.org]][1300]</sup>

[^487]: MacWorld, List of Mac viruses, malware and security flaws <https://www.macworld.co.uk/feature/mac-viruses-list-3668354/> <sup>[[Archive.org]][1301]</sup>

[^488]: JAMF, The Mac Malware of 2020 <https://resources.jamf.com/documents/macmalware-2020.pdf> <sup>[[Archive.org]][1302]</sup>
...
[^490]: ImageTragick.com, <https://imagetragick.com/> <sup>[[Archive.org]][1303]</sup>

[^491]: Oracle Virtualbox Documentation, <https://docs.oracle.com/en/virtualization/virtualbox/6.0/admin/hyperv-support.html> <sup>[[Archive.org]][1304]</sup>

[^492]: Oracle Virtualbox Documentation, <https://docs.oracle.com/en/virtualization/virtualbox/6.0/admin/hyperv-support.html> <sup>[[Archive.org]][1304]</sup>

[^493]: Lenny Zeltser, Analyzing Malicious Documents Cheat Sheet <https://zeltser.com/analyzing-malicious-documents/> <sup>[[Archive.org]][1305]</sup>

[^494]: Wikipedia, Portable Applications <https://en.wikipedia.org/wiki/Portable_application> <sup>[[Wikiless]][1306]</sup> <sup>[[Archive.org]][1307]</sup>

[^495]: Brave Help, What is a Private Window with Tor Connectivity? <https://support.brave.com/hc/en-us/articles/360018121491-What-is-a-Private-Window-with-Tor-> <sup>[[Archive.org]][1253]</sup>

[^496]: BlackGNU, <https://ebin.city/~werwolf/posts/brave-is-shit/> <sup>[[Archive.org]][1308]</sup>

[^497]: Brave Help Center, <https://support.brave.com/hc/en-us/articles/360022973471-What-is-Shields> <sup>[[Archive.org]][1309]</sup>

[^498]: VentureBeat, Browser benchmark battle January 2020: Chrome vs. Firefox vs. Edge vs. Brave <https://venturebeat.com/2020/01/15/browser-benchmark-battle-january-2020-chrome-firefox-edge-brave/view-all/> <sup>[[Archive.org]][1310]</sup>

[^499]: Brave.com, Brave, Fingerprinting, and Privacy Budgets <https://brave.com/brave-fingerprinting-and-privacy-budgets/> <sup>[[Archive.org]][155]</sup>

[^500]: Madaidan Insecurities, Firefox and Chromium <https://madaidans-insecurities.github.io/firefox-chromium.html> <sup>[[Archive.org]][1311]</sup>

[^501]: GrapheneOS, Web Browsing <https://grapheneos.org/usage#web-browsing> <sup>[[Archive.org]][1312]</sup>

[^502]: ResearchGate, Web Browser Privacy: What Do Browsers Say When They Phone Home? <https://www.researchgate.net/publication/349979628_Web_Browser_Privacy_What_Do_Browsers_Say_When_They_Phone_Home> <sup>[[Archive.org]][1313]</sup>

[^503]: Madaidan Insecurities, Firefox and Chromium <https://madaidans-insecurities.github.io/firefox-chromium.html> <sup>[[Archive.org]][1311]</sup>

[^504]: GrapheneOS, Web Browsing <https://grapheneos.org/usage#web-browsing> <sup>[[Archive.org]][1312]</sup>

[^505]: Madaidan Insecurities, Firefox and Chromium <https://madaidans-insecurities.github.io/firefox-chromium.html> <sup>[[Archive.org]][1311]</sup>

[^506]: GrapheneOS, Web Browsing <https://grapheneos.org/usage#web-browsing> <sup>[[Archive.org]][1312]</sup>

[^507]: Microsoft.com, Microsoft Edge support for Microsoft Defender Application Guard <https://docs.microsoft.com/en-us/deployedge/microsoft-edge-security-windows-defender-application-guard> <sup>[[Archive.org]][1314]</sup>

[^508]: PcMag, Mozilla Signs Lucrative 3-Year Google Search Deal for Firefox <https://www.pcmag.com/news/mozilla-signs-lucrative-3-year-google-search-deal-for-firefox> <sup>[[Archive.org]][1315]</sup>

[^509]: Madaidan Insecurities, Firefox and Chromium <https://madaidans-insecurities.github.io/firefox-chromium.html> <sup>[[Archive.org]][1311]</sup>

[^510]: Wikipedia, Virtualization <https://en.wikipedia.org/wiki/Virtualization> <sup>[[Wikiless]][1316]</sup> <sup>[[Archive.org]][1317]</sup>

[^511]: Tor Project, Project Snowflake <https://snowflake.torproject.org/> <sup>[[Archive.org]][555]</sup>

[^512]: GitHub, Obfs4 Repository <https://github.com/Yawning/obfs4/> <sup>[[Archive.org]][1318]</sup>

[^513]: Tor Browser Manual, Pluggable Transport <https://tb-manual.torproject.org/circumvention/> <sup>[[Archive.org]][1319]</sup>

[^514]: Tor Browser Manual, Pluggable Transport <https://tb-manual.torproject.org/circumvention/> <sup>[[Archive.org]][1319]</sup>

[^515]: Wikipedia, Domain Fronting <https://en.wikipedia.org/wiki/Domain_fronting> <sup>[[Wikiless]][1320]</sup> <sup>[[Archive.org]][1321]</sup>

[^516]: GitLab, Tor Browser Issues, Add uBlock Origin to the Tor Browser <https://gitlab.torproject.org/tpo/applications/tor-browser/-/issues/17569> <sup>[[Archive.org]][1322]</sup>

[^517]: Vice, The NSA and CIA Use Ad Blockers Because Online Advertising Is So Dangerous <https://www.vice.com/en/article/93ypke/the-nsa-and-cia-use-ad-blockers-because-online-advertising-is-so-dangerous> <sup>[[Archive.org]][1323]</sup>

[^518]: Europol Wasabi Wallet Report, <https://www.tbstat.com/wp/uploads/2020/06/Europol-Wasabi-Wallet-Report.pdf> <sup>[[Archive.org]][1324]</sup>

[^519]: NIST, <https://www.sans.org/blog/nist-has-spoken-death-to-complexity-long-live-the-passphrase/> <sup>[[Archive.org]][1325]</sup>

[^520]: ZDnet, FBI recommends passphrases over password complexity <https://www.zdnet.com/article/fbi-recommends-passphrases-over-password-complexity/> <sup>[[Archive.org]][1326]</sup>

[^521]: The Intercept, Passphrases That You Can Memorize --- But That Even the NSA Can't Guess <https://theintercept.com/2015/03/26/passphrases-can-memorize-attackers-cant-guess/> <sup>[[Tor Mirror]][1327]</sup> <sup>[[Archive.org]][1328]</sup>

[^522]: ProtonMail Blog, Let's settle the password vs. passphrase debate once and for all <https://protonmail.com/blog/protonmail-com-blog-password-vs-passphrase/> <sup>[[Archive.org]][1329]</sup>

[^523]: YouTube, Edward Snowden on Passwords: Last Week Tonight with John Oliver (HBO) <https://www.youtube.com/watch?v=yzGzB-yYKcc> <sup>[[Invidious]][1330]</sup>

[^524]: YouTube, How to Choose a Password -- Computerphile <https://www.youtube.com/watch?v=3NjQ9b3pgIg> <sup>[[Invidious]][690]</sup>

[^525]: Wikipedia, Passphrase <https://en.wikipedia.org/wiki/Passphrase#Passphrase_selection> <sup>[[Wikiless]][1331]</sup> <sup>[[Archive.org]][1332]</sup>

[^526]: Monero Research Lab, Evaluating cryptocurrency security and privacy in a post-quantum world <https://github.com/insight-decentralized-consensus-lab/post-quantum-monero/blob/master/writeups/technical_note.pdf> <sup>[[Archive.org]][1333]</sup>
  ...
  [How to share files publicly:]: #how-to-share-files-publicly
  ...
  [Examples:]: #examples
  [How to counteract le efforts:]: #how-to-counteract-le-efforts
  [What different linguistic choices say about you:]: #what-different-linguistic-choices-say-about-you
  [Emoticons:]: #emoticons
  [Structural features:]: #structural-features
  [Spelling slang and symbols:]: #spelling-slang-and-symbols
  [Techniques to prevent Writeprint:]: #techniques-to-prevent-writeprint
  ...
  [Monero to BTC:]: #monero-to-btc
  [BTC to Monero:]: #btc-to-monero
  ...
  [55]: https://web.archive.org/web/https://github.com/Eloston/ungoogled-chromium
  [56]: https://web.archive.org/web/https://blog.apnic.net/2019/08/23/what-can-you-learn-from-an-ip-address/
  [57]: https://wikiless.org/wiki/Radio-frequency_identification
  [58]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Radio-frequency_identification
  [59]: https://web.archive.org/web/http://rfpose.csail.mit.edu/
  [60]: https://yewtu.be/watch?v=HgDdaMy8KNE
  [61]: https://web.archive.org/web/https://www.news.ucsb.edu/2021/020392/dont-fidget-wifi-will-count-you
  [62]: media/image7.jpeg 
  [63]: https://yewtu.be/watch?v=FDZ39h-kCS8
  [64]: https://yewtu.be/watch?v=7v3JR4Wlw4Q
  [65]: https://web.archive.org/web/https://blog.torproject.org/new-low-cost-traffic-analysis-attacks-mitigations
  [66]: media/image8.jpeg 
  [67]: media/image9.jpeg 
  [68]: media/image10.jpeg 
  [69]: https://web.archive.org/web/https://github.com/Attacks-on-Tor/Attacks-on-Tor
  [70]: https://web.archive.org/web/https://www.researchgate.net/publication/323627387_Shedding_Light_on_the_Dark_Corners_of_the_Internet_A_Survey_of_Tor_Research
  [71]: https://web.archive.org/web/https://www.hackerfactor.com/blog/index.php?/archives/906-Tor-0day-The-Management-Vulnerability.html
  [72]: https://web.archive.org/web/https://svn-archive.torproject.org/svn/projects/design-paper/tor-design.pdf
  [73]: https://yewtu.be/watch?v=siCk4pGGcqA
  [74]: https://yewtu.be/watch?v=mYsTBPqbya8
  [75]: https://yewtu.be/watch?v=bKH5nGLgi08&t=2834s
  [76]: https://wikiless.org/wiki/Transient_execution_CPU_vulnerability
  [77]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Transient_execution_CPU_vulnerability
  [78]: https://web.archive.org/web/https://github.com/speed47/spectre-meltdown-checker
  [79]: https://web.archive.org/web/https://www.grc.com/inspectre.htm
  [80]: https://web.archive.org/web/https://www.whonix.org/wiki/Spectre_Meltdown
  [81]: https://web.archive.org/web/https://policies.google.com/privacy
  [82]: https://web.archive.org/web/https://www.scss.tcd.ie/doug.leith/apple_google.pdf
  [83]: https://web.archive.org/web/https://www.apple.com/legal/privacy/en-ww/
  [84]: https://web.archive.org/web/https://support.apple.com/en-us/HT202100
  [85]: https://web.archive.org/web/https://docs.microsoft.com/en-us/windows/privacy/required-windows-diagnostic-data-events-and-fields-2004
  [86]: https://web.archive.org/web/https://docs.microsoft.com/en-us/windows/privacy/windows-diagnostic-data
  [87]: https://web.archive.org/web/https://support.apple.com/guide/mac-help/share-analytics-information-mac-apple-mh27990/mac
  [88]: https://web.archive.org/web/https://ubuntu.com/desktop/statistics
  [89]: https://web.archive.org/web/https://twitter.com/idf/status/1125066395010699264
  [90]: https://nitter.fdn.fr/idf/status/1125066395010699264
  [91]: https://web.archive.org/web/https://mediasonar.com/
  [92]: https://web.archive.org/web/https://www.typingdna.com/
  [93]: https://web.archive.org/web/https://link.springer.com/10.1007/978-1-4614-7163-9_110198-1
  [94]: https://web.archive.org/web/https://www.sciencedirect.com/science/article/pii/S1877042811013747/pdf?md5=253d8f1bb615d5dee195d353dc077d46&pid=1-s2.0-S1877042811013747-main.pdf
  [95]: https://web.archive.org/web/https://www.researchgate.net/publication/300562034_Using_Social_Networks_Data_for_Behavior_and_Sentiment_Analysis
  [96]: https://web.archive.org/web/https://www.academia.edu/30936118/A_Survey_on_User_Behaviour_Analysis_in_Social_Networks
  [97]: https://web.archive.org/web/https://web.archive.org/web/https://sci-hub.se/10.1007/978-3-030-02592-2
  [98]: https://web.archive.org/web/https://docs.google.com/spreadsheets/d/18rtqh8EG2q1xBo2cLNyhIDuK9jrPGwYr9DI2UncoqJQ/edit
  [99]: https://web.archive.org/web/https://github.com/jivoi/awesome-osint
  [100]: https://yewtu.be/playlist?list=PLrFPX1Vfqk3ehZKSFeb9pVIHqxqrNW8Sy
  [101]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2019/12/26/guide-to-using-reverse-image-search-for-investigations/
  [102]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2019/02/19/using-the-new-russian-facial-recognition-site-searchface-ru/
  [103]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2018/10/24/dali-warhol-boshirov-determining-time-alleged-photograph-skripal-suspect-chepiga/
  [104]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2017/06/30/advanced-guide-verifying-video-content/
  [105]: https://web.archive.org/web/https://www.bellingcat.com/resources/2020/12/03/using-the-sun-and-the-shadows-for-geolocation/
  [106]: https://web.archive.org/web/https://www.bellingcat.com/news/uk-and-europe/2021/01/27/navalny-poison-squad-implicated-in-murders-of-three-russian-activists/
  [107]: https://web.archive.org/web/https://www.bellingcat.com/news/2021/03/19/berlin-assassination-new-evidence-on-suspected-fsb-hitman-passed-to-german-investigators/
  [108]: https://yewtu.be/watch?v=cAVZaPiVArA
  [109]: https://yewtu.be/watch?v=awY87q2Mr0E
  [110]: https://yewtu.be/watch?v=bS6gYWM4kzY
  [111]: media/image11.jpeg 
  [112]: https://web.archive.org/web/https://www.nature.com/articles/s41598-020-79310-1
  [113]: media/image12.jpeg 
  [114]: https://web.archive.org/web/https://rd.springer.com/chapter/10.1007/978-3-030-42504-3_15
  [115]: https://web.archive.org/web/https://media.ccc.de/v/rc3-11406-spot_the_surveillance
  [116]: https://web.archive.org/web/https://www.eff.org/sls
  [117]: https://web.archive.org/web/https://www.respeecher.com/
  [118]: https://web.archive.org/web/https://www.descript.com/overdub
  [119]: https://yewtu.be/watch?v=t5yw5cR79VA
  [120]: https://web.archive.org/web/https://www.reflectacles.com/
  [121]: https://web.archive.org/web/https://gitlab.com/FG-01/fg-01
  [122]: https://wikiless.org/wiki/Advance-fee_scam
  [123]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Advance-fee_scam
  [124]: https://yewtu.be/watch?v=Z20XNp-luNA
  [125]: https://yewtu.be/watch?v=VVdmmN0su6E
  [126]: https://yewtu.be/watch?v=hdCs6bPM4is
  [127]: https://web.archive.org/web/https://shop.hak5.org/products/usb-rubber-ducky-deluxe
  [128]: https://yewtu.be/watch?v=V5mBJHotZv0
  [129]: https://web.archive.org/web/https://www.keelog.com/
  [130]: https://web.archive.org/web/https://www.aliexpress.com/i/4000710369016.html
  [131]: media/image13.jpeg 
  [132]: https://web.archive.org/web/https://mattw.io/youtube-geofind/location
  [133]: https://27m3p2uv7igmj6kvd4ql3cct5h3sdwrsajovkkndeufumzyfhlfev4qd.onion/2021/01/18/leak-zoom-meeting/
  [134]: https://web.archive.org/web/https://theintercept.com/2021/01/18/leak-zoom-meeting/
  [135]: https://web.archive.org/web/https://www.eff.org/issues/printers
  [136]: https://yewtu.be/watch?v=izMGMsIZK4U
  [137]: https://web.archive.org/web/https://www.eff.org/pages/list-printers-which-do-or-do-not-display-tracking-dots
  [138]: https://web.archive.org/web/https://www.whonix.org/wiki/Printing_and_Scanning
  [139]: https://web.archive.org/web/https://github.com/beurtschipper/Depix
  [140]: media/image14.jpeg
  [141]: https://web.archive.org/web/https://medium.com/@somdevsangwan/unblurring-images-for-osint-and-more-part-1-5ee36db6a70b
  [142]: https://web.archive.org/web/https://medium.com/@somdevsangwan/deblurring-images-for-osint-part-2-ba564af8eb5d
  [143]: media/image15.jpeg 
  [144]: https://web.archive.org/web/https://github.com/subeeshvasu/Awesome-Deblurring
  [145]: https://web.archive.org/web/https://www.myheritage.com/photo-enhancer
  [146]: media/image16.jpeg 
  [147]: https://web.archive.org/web/https://bitcoin.org/en/you-need-to-know
  [148]: https://web.archive.org/web/https://bitcoin.org/en/protect-your-privacy
  [149]: https://web.archive.org/web/https://support.apple.com/en-us/HT202303
  [150]: https://web.archive.org/web/https://faq.whatsapp.com/android/chats/about-google-drive-backups/
  [151]: https://web.archive.org/web/https://about.fb.com/news/2021/10/end-to-end-encrypted-backups-on-whatsapp/
  [152]: https://web.archive.org/web/https://www.dropbox.com/privacy
  [153]: https://web.archive.org/web/https://privacy.microsoft.com/en-us/privacystatement
  [154]: https://web.archive.org/web/https://amiunique.org/links
  [155]: https://web.archive.org/web/https://brave.com/brave-fingerprinting-and-privacy-budgets/
  [156]: https://web.archive.org/web/https://palant.info/2020/12/10/how-anti-fingerprinting-extensions-tend-to-make-fingerprinting-easier/
  [157]: https://web.archive.org/web/https://www.upturn.org/reports/2020/mass-extraction/
  [158]: https://web.archive.org/web/https://www.nytimes.com/2020/10/21/technology/iphone-encryption-police.html
  [159]: https://web.archive.org/web/https://www.vice.com/en/article/vbxxxd/unlock-iphone-ios11-graykey-grayshift-police
  [160]: https://web.archive.org/web/http://encase-docs.opentext.com/documentation/encase/forensic/8.07/Content/Resources/External%20Files/EnCase%20Forensic%20v8.07%20User%20Guide.pdf
  [161]: https://web.archive.org/web/https://accessdata.com/products-services/forensic-toolkit-ftk
  [162]: https://web.archive.org/web/https://latacora.micro.blog/2018/04/03/cryptographic-right-answers.html
  [163]: https://web.archive.org/web/https://jedisct1.github.io/minisign/
  [164]: https://web.archive.org/web/https://democratic-europe.eu/2021/07/20/cryptographers-uncover-four-vulnerabilities-in-telegram/
  ...
  [185]: https://web.archive.org/web/http://wallcamera.csail.mit.edu/
  [186]: https://web.archive.org/web/https://arxiv.org/abs/2001.04642
  [187]: https://web.archive.org/web/https://engineering.cmu.edu/news-events/news/2020/02/17-mauraders-map.html
  [188]: https://yewtu.be/watch?v=t32QvpfOHqw
  [189]: https://web.archive.org/web/http://www.gcomtech.com/ccp0-prodshow/laser-surveillance-laser-listening.html
  ...
  [220]: https://web.archive.org/web/https://www.usenix.org/system/files/sec21-hoang.pdf
  [221]: https://web.archive.org/web/https://therecord.media/malware-found-preinstalled-in-classic-push-button-phones-sold-in-russia/
  ...
  [240]: https://web.archive.org/web/https://tails.boum.org/doc/anonymous_internet/tor/index.en.html
  ...
  [261]: media/image20.jpeg
  [262]: media/image21.jpeg
  [263]: https://web.archive.org/web/https://sourceforge.net/p/veracrypt/discussion/technical/thread/3961542951/
  [264]: https://web.archive.org/web/https://www.whonix.org/wiki/Cold_Boot_Attack_Defense
  [265]: https://web.archive.org/web/https://www.whonix.org/wiki/Protection_Against_Physical_Attacks
  [266]: https://web.archive.org/web/https://github.com/0xPoly/Centry
  [267]: https://web.archive.org/web/https://github.com/AnonymousPlanet/Centry
  [268]: https://web.archive.org/web/https://github.com/hephaest0s/usbkill
  [269]: https://web.archive.org/web/https://github.com/Lvl4Sword/Killer
  [270]: https://web.archive.org/web/https://askubuntu.com/questions/153245/how-to-wipe-ram-on-shutdown-prevent-cold-boot-attacks
  [271]: https://web.archive.org/web/https://github.com/QubesOS/qubes-antievilmaid
  [272]: https://web.archive.org/web/https://www.sans.org/security-resources/posters/windows-forensic-analysis/170/download
  [273]: https://web.archive.org/web/https://www.whonix.org/wiki/Full_Disk_Encryption
  [274]: https://web.archive.org/web/https://madaidans-insecurities.github.io/linux.html
  [275]: https://web.archive.org/web/https://ubuntu.com/tutorials/install-ubuntu-desktop
  [276]: https://web.archive.org/web/https://help.ubuntu.com/community/ManualFullSystemEncryption
  [The Detached Headers Way]: #the-detached-headers-way
  [The Veracrypt Way]: #the-veracrypt-way
  [277]: https://web.archive.org/web/https://wiki.archlinux.org/title/Dm-crypt/Specialties#Encrypted_system_using_a_detached_LUKS_header
  [278]: https://web.archive.org/web/https://vitux.com/how-to-force-ubuntu-to-stop-collecting-your-data-from-your-pc/
  [279]: https://web.archive.org/web/https://www.addictivetips.com/ubuntu-linux-tips/disable-bluetooth-in-ubuntu/
  [280]: https://web.archive.org/web/https://www.linuxuprising.com/2019/07/how-to-completely-disable-tracker.html
  [281]: https://web.archive.org/web/https://www.how2shout.com/linux/how-to-hibernate-ubuntu-20-04-lts-focal-fossa/
  [282]: https://web.archive.org/web/http://www.lorenzobettini.it/2020/07/enabling-hibernation-on-ubuntu-20-04/
  [283]: https://web.archive.org/web/20211011215449/https://blog.ivansmirnov.name/how-to-set-up-hibernate-on-ubuntu-20-04/
  [284]: https://web.archive.org/web/http://ubuntuhandbook.org/index.php/2020/05/lid-close-behavior-ubuntu-20-04/
  [285]: https://web.archive.org/web/https://tipsonubuntu.com/2018/04/28/change-lid-close-action-ubuntu-18-04-lts/
  [286]: https://web.archive.org/web/https://help.ubuntu.com/community/EnableHibernateWithEncryptedSwap
  [287]: https://web.archive.org/web/https://help.ubuntu.com/community/AnonymizingNetworkMACAddresses
  [288]: https://web.archive.org/web/https://josh.works/shell-script-basics-change-mac-address
  [289]: https://yewtu.be/watch?v=Sa0KqbpLye4
  [290]: https://web.archive.org/web/https://madaidans-insecurities.github.io/guides/linux-hardening.html
  [291]: https://web.archive.org/web/https://wiki.archlinux.org/title/Security
  [292]: https://web.archive.org/web/https://codeberg.org/SalamanderSecurity/PARSEC
  ...
  [441]: https://web.archive.org/web/https://slashdotmedia.com/terms-of-use/
  [442]: https://web.archive.org/web/https://telegram.org/tos
  [443]: https://web.archive.org/web/mailto:recover@telegram.org
  [444]: https://web.archive.org/web/https://tutanota.com/terms/
  [445]: https://web.archive.org/web/https://www.twitch.tv/p/en/legal/terms-of-service/
  [446]: https://web.archive.org/web/https://www.whatsapp.com/legal/updates/terms-of-service-eea
  [447]: media/image40.jpeg
  [448]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2018/08/23/creating-android-open-source-research-device-pc/
  [449]: https://yewtu.be/watch?v=zSQtyW_ywZc
  [450]: https://wikiless.org/wiki/Comparison_of_instant_messaging_protocols
  [451]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Comparison_of_instant_messaging_protocols
  [452]: https://wikiless.org/wiki/Comparison_of_cross-platform_instant_messaging_clients
  [453]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Comparison_of_cross-platform_instant_messaging_clients
  [454]: https://web.archive.org/web/https://www.securemessagingapps.com/
  [455]: https://web.archive.org/web/https://protonmail.com/blog/whatsapp-alternatives/
  [456]: https://web.archive.org/web/https://www.whonix.org/wiki/Chat
  [457]: https://web.archive.org/web/https://securechatguide.org/featuresmatrix.html
  [458]: http://lldan5gahapx5k7iafb3s4ikijc4ni7gx5iywdflkba5y2ezyg6sjgyd.onion/
  [459]: https://web.archive.org/web/https://onionshare.org/
  [460]: https://web.archive.org/web/https://cwtch.im/
  [461]: https://web.archive.org/web/https://element.io/
  [462]: https://web.archive.org/web/https://jami.net/
  [463]: https://web.archive.org/web/https://gajim.org/
  [464]: https://web.archive.org/web/https://briarproject.org/
  [465]: https://web.archive.org/web/https://getsession.org/
  [466]: https://web.archive.org/web/https://privacyguides.org/providers/cloud-storage/
  [467]: https://web.archive.org/web/https://securedrop.org/
  [468]: https://web.archive.org/web/https://github.com/alecmuffett/real-world-onion-sites#securedrop
  [469]: https://web.archive.org/web/https://haveibeenpwned.com/
  [470]: https://web.archive.org/web/https://www.veracrypt.fr/en/Beginner%27s%20Tutorial.html
  [471]: https://web.archive.org/web/https://www.qubes-os.org/doc/backup-restore/
  [472]: https://web.archive.org/web/https://support.apple.com/en-ie/guide/mac-help/mh21241/mac
  [473]: https://web.archive.org/web/https://support.apple.com/en-ie/guide/mac-help/mh11421/11.0/mac/11.0
  [474]: https://web.archive.org/web/https://support.apple.com/en-ie/guide/disk-utility/dskutl1010/mac
  [475]: https://web.archive.org/web/https://privacyguides.org/providers/paste/
  [476]: https://web.archive.org/web/https://syncthing.net/
  [477]: media/image41.jpeg
  [478]: media/image42.jpeg
  [479]: media/image43.jpeg
  [480]: https://wikiless.org/wiki/Trim_(computing)
  [481]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Trim_(computing)
  [482]: media/image44.jpeg
  [483]: https://yewtu.be/watch?v=-bpX8YvNg6Y
  [484]: https://web.archive.org/web/https://wiki.archlinux.org/index.php/Solid_state_drive
  [485]: https://web.archive.org/web/https://www.bleachbit.org/download/linux
  [486]: https://web.archive.org/web/https://superuser.com/questions/19326/how-to-wipe-free-disk-space-in-linux
  [487]: https://web.archive.org/web/https://linuxhint.com/completely_wipe_hard_drive_ubuntu/
  [488]: https://web.archive.org/web/https://linoxide.com/linux-command/commands-wipe-disk-linux/
  [489]: https://web.archive.org/web/https://wiki.archlinux.org/index.php/Securely_wipe_disk
  [490]: https://web.archive.org/web/https://ssd.eff.org/en/module/how-delete-your-data-securely-linux
  [Extra Tools Cleaning]: #extra-tools-cleaning
  [491]: https://web.archive.org/web/https://eraser.heidi.ie/download/
  [492]: https://web.archive.org/web/http://killdisk.com/killdisk-freeware.htm
  [493]: https://web.archive.org/web/https://support.apple.com/en-gb/guide/disk-utility/dskutl14079/mac
  [494]: https://web.archive.org/web/https://support.apple.com/guide/disk-utility/erase-and-reformat-a-storage-device-dskutl14079/mac
  [495]: https://web.archive.org/web/https://support.apple.com/guide/disk-utility/encrypt-protect-a-storage-device-password-dskutl35612/mac
  [496]: media/image45.jpeg
  [497]: https://web.archive.org/web/https://ssd.eff.org/en/module/how-delete-your-data-securely-windows
  [498]: https://web.archive.org/web/https://wiki.archlinux.org/index.php/dm-crypt/Device_encryption
  [499]: https://web.archive.org/web/https://github.com/Qubes-Community/Contents/blob/master/docs/configuration/disk-trim.md
  [500]: https://web.archive.org/web/https://support.apple.com/en-us/HT210898
  [501]: media/image46.jpeg
  [502]: https://web.archive.org/web/http://www.edenwaith.com/products/permanent%20eraser/
  [503]: https://web.archive.org/web/https://ssd.eff.org/en/module/how-delete-your-data-securely-macos
  [504]: https://web.archive.org/web/https://www.whonix.org/wiki/System_Hardening_Checklist
  [505]: https://web.archive.org/web/https://exiftool.org/
  [506]: https://web.archive.org/web/https://exifcleaner.com/
  [507]: https://web.archive.org/web/https://www.purevpn.com/internet-privacy/how-to-remove-metadata-from-photos
  [508]: https://web.archive.org/web/https://sandlab.cs.uchicago.edu/fawkes/
  [509]: https://web.archive.org/web/https://github.com/Shawn-Shan/fawkes
  [510]: https://web.archive.org/web/https://lowkey.umiacs.umd.edu/
  [511]: https://web.archive.org/web/https://adversarial.io/
  [512]: https://web.archive.org/web/https://github.com/kanzure/pdfparanoia
  [513]: https://web.archive.org/web/https://support.microsoft.com/en-us/office/remove-hidden-data-and-personal-information-by-inspecting-documents-presentations-or-workbooks-356b7b5d-77af-44fe-a07f-9aa4d085966f
  [514]: https://web.archive.org/web/https://0xacab.org/jvoisin/mat2
  [515]: media/image47.jpeg 
  [516]: https://web.archive.org/web/https://www.whonix.org/wiki/VM_Live_Mode
  [517]: https://web.archive.org/web/https://www.titanium-software.fr/en/onyx.html
  [518]: https://web.archive.org/web/https://github.com/Qubes-Community/Contents/blob/master/docs/security/security-guidelines.md
  [519]: https://web.archive.org/web/https://www.whonix.org/wiki/Linux_Kernel_Runtime_Guard_LKRG
  [520]: https://web.archive.org/web/https://support.microsoft.com/en-us/windows/how-to-open-registry-editor-in-windows-10-deab38e6-91d6-e0aa-4b7c-8878d9e07b11
  [521]: https://web.archive.org/web/https://privazer.com/en/download-shellbag-analyzer-shellbag-cleaner.php
  [522]: https://web.archive.org/web/https://privazer.com/en/download.php
  [523]: https://web.archive.org/web/https://www.bleachbit.org/download
  [524]: https://web.archive.org/web/https://justdeleteme.xyz/
  [525]: https://web.archive.org/web/https://justgetmydata.com/
  [526]: https://web.archive.org/web/https://search.google.com/search-console/remove-outdated-content
  [527]: https://web.archive.org/web/https://www.bing.com/webmasters/tools/contentremoval
  [528]: https://web.archive.org/web/https://webmaster.yandex.com/
  [529]: https://web.archive.org/web/https://webmaster.yandex.com/tools/del-url/
  [530]: https://web.archive.org/web/https://help.yahoo.com/kb/SLN4530.html
  [531]: https://wikiless.org/wiki/Wikipedia:Courtesy_vanishing
  [532]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Wikipedia:Courtesy_vanishing
  [533]: https://web.archive.org/web/https://inteltechniques.com/workbook.html
  [534]: https://web.archive.org/web/https://guardianproject.github.io/haven/
  [535]: https://web.archive.org/web/https://www.google.com/alerts
  [536]: https://wikiless.org/wiki/Ross_Ulbricht
  [537]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Ross_Ulbricht
  [538]: https://yewtu.be/watch?v=d-7o9xYp7eE
  [539]: https://yewtu.be/watch?v=IqZZU9lFlF4
  [540]: https://yewtu.be/watch?v=zXmZnU2GdVk
  [541]: https://yewtu.be/watch?v=eQ2OZKitRwc
  ...
  [542]: https://web.archive.org/web/https://www.defcon.org/images/defcon-22/dc-22-presentations/Crenshaw/DEFCON-22-Adrian-Crenshaw-Dropping-Docs-on-Darknets-How-People-Got-Caught-UPDATED.pdf
  [543]: https://yewtu.be/watch?v=6Chp12sEnWk
  [544]: https://yewtu.be/watch?v=J1q4Ir2J8P8
  [545]: https://yewtu.be/watch?v=GR_U0G-QGA0
  [546]: https://wikiless.org/wiki/Key_disclosure_law
  [547]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Key_disclosure_law
  [548]: https://web.archive.org/web/https://www.gp-digital.org/world-map-of-encryption/
  [549]: https://mirror.anonymousplanet.org/donations.html
  [550]: https://web.archive.org/web/https://anonymousplanet.org/donations.html
  [551]: http://thgtoa7imksbg7rit4grgijl2ef6kc7b56bp56pmtta4g354lydlzkqd.onion/donations.html
  [552]: media/image48.jpeg 
  [553]: media/image49.jpeg 
  [554]: media/image50.jpeg 
  [555]: https://web.archive.org/web/https://snowflake.torproject.org/
  [556]: https://web.archive.org/web/https://community.torproject.org/relay/
  [Recommended VPS hosting providers]: #_Recommended_VPS_hosting
  [557]: https://web.archive.org/web/https://torrelay.ca/
  [558]: https://web.archive.org/web/https://blog.torproject.org/tips-running-exit-node
  [559]: https://wikiless.org/wiki/Permanent_Record_(autobiography)
  [560]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Permanent_Record_(autobiography)
  [561]: https://web.archive.org/web/https://www.w10privacy.de/english-home/
  [562]: https://web.archive.org/web/https://crazymax.dev/WindowsSpyBlocker/download/
  [563]: https://web.archive.org/web/https://www.oo-software.com/en/shutup10
  [564]: https://web.archive.org/web/https://github.com/beerisgood/windows10_hardening
  [565]: https://web.archive.org/web/https://www.microsoft.com/en-us/software-download/windows10
  [566]: https://web.archive.org/web/https://www.system-rescue.org/Installing-SystemRescue-on-a-USB-memory-stick/
  [567]: https://web.archive.org/web/https://wiki.archlinux.org/index.php/Solid_state_drive/Memory_cell_clearing
  [568]: https://web.archive.org/web/https://ata.wiki.kernel.org/index.php/ATA_Secure_Erase
  [569]: https://web.archive.org/web/https://tinyapps.org/docs/wipe_drives_hdparm.html
  [570]: https://web.archive.org/web/https://tinyapps.org/docs/ata_sanitize_hdparm.html
  [571]: https://web.archive.org/web/https://tinyapps.org/docs/nvme-secure-erase.html
  [572]: https://web.archive.org/web/https://tinyapps.org/docs/nvme-sanitize.html
  [573]: https://web.archive.org/web/https://clonezilla.org/liveusb.php
  [574]: https://web.archive.org/web/https://clonezilla.org/show-live-doc-content.php?topic=clonezilla-live/doc/01_Save_disk_image
  [575]: https://web.archive.org/web/https://clonezilla.org/show-live-doc-content.php?topic=clonezilla-live/doc/02_Restore_disk_image
  [576]: https://web.archive.org/web/https://bridges.torproject.org/
  [577]: https://web.archive.org/web/https://support.microsoft.com/en-us/windows/disk-cleanup-in-windows-10-8a96ff42-5751-39ad-23d6-434b4d5b9a68
  [578]: https://web.archive.org/web/https://support.microsoft.com/en-us/windows/defragment-your-windows-10-pc-048aefac-7f1f-4632-d48a-9700c4ec702a
  [579]: https://web.archive.org/web/https://www.bleachbit.org/
  [580]: https://web.archive.org/web/https://privazer.com/
  [581]: https://web.archive.org/web/https://www.system-rescue.org/
  [582]: https://web.archive.org/web/https://www.lifewire.com/how-to-erase-a-hard-drive-using-dban-2619148
  [583]: https://web.archive.org/web/https://github.com/PartialVolume/shredos.2020.02
  [584]: https://web.archive.org/web/https://rufus.ie/
  [585]: https://web.archive.org/web/https://kb.sandisk.com/app/answers/detail/a_id/15108/~/dashboard-support-information
  [586]: https://web.archive.org/web/https://www.seagate.com/support/downloads/seatools/
  [587]: https://web.archive.org/web/https://www.samsung.com/semiconductor/minisite/ssd/download/tools/
  [588]: https://web.archive.org/web/https://www.kingston.com/unitedstates/en/support/technical/ssdmanager
  [589]: https://web.archive.org/web/https://support.lenovo.com/us/en/downloads/ds019026-thinkpad-drive-erase-utility-for-resetting-the-cryptographic-key-and-erasing-the-solid-state-drive-thinkpad
  [590]: https://web.archive.org/web/https://www.crucial.com/support/storage-executive
  [591]: https://web.archive.org/web/https://support.wdc.com/downloads.aspx?p=279
  [592]: https://web.archive.org/web/https://store.hp.com/us/en/tech-takes/how-to-secure-erase-ssd
  [593]: https://web.archive.org/web/https://www.transcend-info.com/Support/Software-10/
  [594]: https://web.archive.org/web/https://www.dell.com/support/kbdoc/en-us/000134997/using-the-dell-bios-data-wipe-function-for-optiplex-precision-and-latitude-systems-built-after-november-2015?lwp=rt
  [595]: https://web.archive.org/web/https://www.toshiba-storage.com/downloads/
  [596]: https://web.archive.org/web/https://www.glump.net/howto/desktop/enable-trim-on-an-external-ssd-on-linux
  [597]: https://web.archive.org/web/https://code.mendhak.com/securely-wipe-ssd/
  [598]: https://web.archive.org/web/https://www.lifewire.com/enable-trim-for-ssd-in-os-x-yosemite-2260789
  [599]: https://web.archive.org/web/https://cindori.org/trimenabler/
  [600]: https://web.archive.org/web/https://www.debian.org/CD/netinst/
  [601]: https://web.archive.org/web/https://support.lenovo.com/be/en/solutions/migr-68369
  [602]: https://web.archive.org/web/https://support.hp.com/gb-en/document/c06204100
  [603]: https://web.archive.org/web/https://www.dell.com/support/kbdoc/en-us/000146892/dell-data-wipe
  [604]: https://web.archive.org/web/https://us.answers.acer.com/app/answers/detail/a_id/41567/~/how-to-use-disk-sanitizer-on-acer-travelmate-notebooks
  [605]: https://translate.google.com/translate?hl=&sl=ru&tl=en&u=https%3A%2F%2Fbiboroda.livejournal.com%2F4894724.html&anno=2
  [606]: https://web.archive.org/web/https://biboroda.livejournal.com/4894724.html
  [607]: https://web.archive.org/web/https://www.theguardian.com/australia-news/2021/sep/11/inside-story-most-daring-surveillance-sting-in-history
  [608]: https://wikiless.org/wiki/EncroChat
  [609]: https://web.archive.org/web/https://en.wikipedia.org/wiki/EncroChat
  [610]: https://wikiless.org/wiki/Sky_ECC
  [611]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Sky_ECC
  [612]: https://web.archive.org/web/https://privacyguides.org/providers/vpn/
  [613]: https://web.archive.org/web/https://safing.io/
  [Printing Watermarking]: #printing-watermarking
  [614]: https://web.archive.org/web/https://www.getmonero.org/community/merchants/
  [615]: https://web.archive.org/web/https://proprivacy.com/vpn/guides/create-your-own-vpn-server
  [616]: https://web.archive.org/web/https://linuxize.com/post/how-to-setup-ssh-socks-tunnel-for-private-browsing/
  [617]: https://web.archive.org/web/https://www.digitalocean.com/community/tutorials/how-to-route-web-traffic-securely-without-a-vpn-using-a-socks-tunnel
  [618]: https://web.archive.org/web/https://www.forwardproxy.com/2018/12/using-putty-to-setup-a-quick-socks-proxy/
  [619]: https://web.archive.org/web/https://ma.ttias.be/socks-proxy-linux-ssh-bypass-content-filters/
  [620]: https://web.archive.org/web/https://www.putty.org/
  [621]: media/image51.jpeg 
  [622]: https://web.archive.org/web/https://tails.boum.org/contribute/design/Unsafe_Browser/
  [623]: https://web.archive.org/web/https://archive.flossmanuals.net/bypassing-censorship/index.html
  [624]: media/image52.jpeg 
  [625]: https://web.archive.org/web/https://www.alfa.com.tw/
  [626]: https://web.archive.org/web/https://www.tp-link.com/us/home-networking/usb-adapter/tl-wn722n/
  [627]: https://web.archive.org/web/https://www.wirelesshack.org/best-kali-linux-compatible-usb-adapter-dongles.html
  [628]: https://yewtu.be/watch?v=8FV2QZ1BPnw
  [629]: https://web.archive.org/web/https://www.netally.com/products/
  [630]: https://web.archive.org/web/https://mullvad.net/en/help/install-mullvad-app-windows/
  [631]: https://web.archive.org/web/https://www.ivpn.net/apps-windows
  [632]: https://web.archive.org/web/https://docs.safing.io/portmaster/install/windows
  [633]: https://web.archive.org/web/https://protonvpn.com/support/protonvpn-windows-vpn-application/
  [634]: https://web.archive.org/web/https://mullvad.net/en/help/install-and-use-mullvad-app-macos/
  [635]: https://web.archive.org/web/https://www.ivpn.net/apps-macos/
  [636]: https://web.archive.org/web/https://protonvpn.com/support/protonvpn-mac-vpn-application/
  [637]: https://web.archive.org/web/https://mullvad.net/en/help/install-mullvad-app-linux/
  [638]: https://web.archive.org/web/https://www.ivpn.net/apps-linux/
  [639]: https://web.archive.org/web/https://docs.safing.io/portmaster/install/linux
  [640]: https://web.archive.org/web/https://protonvpn.com/support/linux-vpn-setup/
  [641]: https://web.archive.org/web/https://www.ivpn.net/knowledgebase/general/do-you-offer-a-kill-switch-or-vpn-firewall/
  [642]: https://web.archive.org/web/https://protonvpn.com/support/what-is-kill-switch/
  [643]: https://web.archive.org/web/https://mullvad.net/en/help/using-mullvad-vpn-app/
  [644]: https://web.archive.org/web/https://protonvpn.com/blog/macos-vpn-kill-switch/
  [645]: https://web.archive.org/web/https://mullvad.net/en/help/wireguard-and-mullvad-vpn/
  [646]: https://web.archive.org/web/https://mullvad.net/en/help/linux-openvpn-installation/
  [647]: https://web.archive.org/web/https://github.com/ProtonVPN/linux-cli/blob/master/USAGE.md
  [648]: https://web.archive.org/web/https://www.ivpn.net/knowledgebase/linux/linux-wireguard-kill-switch/
  [649]: https://web.archive.org/web/https://www.ivpn.net/knowledgebase/linux/linux-kill-switch-using-the-uncomplicated-firewall-ufw/
  [650]: https://web.archive.org/web/https://ooni.org/install/
  [651]: https://web.archive.org/web/https://www.gpg4win.org/
  [652]: https://web.archive.org/web/https://gpgtools.org/
  [653]: https://web.archive.org/web/https://support.torproject.org/tbb/how-to-verify-signature/
  [654]: https://web.archive.org/web/https://tails.boum.org/install/vm-download/index.en.html
  [655]: https://web.archive.org/web/https://www.whonix.org/wiki/Verify_the_Whonix_images
  [656]: https://web.archive.org/web/https://www.clamav.net/
  [657]: https://web.archive.org/web/https://github.com/rfxn/linux-malware-detect
  [658]: https://web.archive.org/web/http://www.chkrootkit.org/
  [659]: https://web.archive.org/web/https://developers.virustotal.com/v3.0/docs/search-by-hash
  [660]: https://web.archive.org/web/https://github.com/rshipp/awesome-malware-analysis
  [661]: https://web.archive.org/web/https://support.virustotal.com/hc/en-us/articles/115002168385-Privacy-Policy
  [662]: https://web.archive.org/web/https://blog.didierstevens.com/programs/pdf-tools/
  [663]: https://web.archive.org/web/https://github.com/QubesOS/qubes-app-linux-pdf-converter
  [664]: https://web.archive.org/web/https://github.com/firstlookmedia/pdf-redact-tools
  [665]: https://web.archive.org/web/https://github.com/firstlookmedia/dangerzone
  [666]: https://web.archive.org/web/https://www.vice.com/en/article/v7gd9b/facebook-helped-fbi-hack-child-predator-buster-hernandez
  [667]: https://web.archive.org/web/https://digital-forensics.sans.org/media/analyzing-malicious-document-files.pdf
  [668]: https://web.archive.org/web/https://www.winitor.com/pdf/Malware-Analysis-Fundamentals-Files-Tools.pdf
  [669]: https://web.archive.org/web/https://www.mozilla.org/en-US/firefox/browsers/compare/brave/
  [670]: https://web.archive.org/web/https://brave.com/download/
  [671]: https://web.archive.org/web/https://wiki.archlinux.org/title/Firefox/Privacy
  [672]: https://web.archive.org/web/https://www.privacytools.io/browsers/#about_config
  [673]: https://web.archive.org/web/https://proprivacy.com/privacy-service/guides/firefox-privacy-security-guide
  [674]: https://web.archive.org/web/https://chrisx.xyz/blog/yet-another-firefox-hardening-guide/
  [675]: https://web.archive.org/web/https://ebin.city/~werwolf/posts/firefox-hardening-guide/
  [676]: media/image53.jpeg 
  [677]: media/image54.jpeg 
  [678]: https://web.archive.org/web/https://www.torproject.org/download/
  [679]: media/image55.jpeg 
  [680]: media/image56.jpeg 
  [681]: media/image57.jpeg 
  [682]: https://web.archive.org/web/https://z.cash/
  [683]: https://web.archive.org/web/https://z.cash/exchanges/
  [684]: https://web.archive.org/web/https://wasabiwallet.io/
  [685]: https://web.archive.org/web/https://privacyguides.org/providers/hosting/
  [686]: https://web.archive.org/web/https://community.torproject.org/relay/community-resources/good-bad-isps/
  [687]: https://web.archive.org/web/https://xkcd.com/936/
  [688]: https://web.archive.org/web/https://www.explainxkcd.com/wiki/index.php/936:_Password_Strength
  [689]: media/image58.jpeg 
  [690]: https://yewtu.be/watch?v=3NjQ9b3pgIg
  [691]: https://web.archive.org/web/https://privacyguides.org/providers/search-engines
  [692]: https://web.archive.org/web/https://arstechnica.com/tech-policy/2018/06/dark-web-vendor-oxymonster-turns-out-to-be-a-frenchman-with-luscious-beard/
  [693]: https://wikiless.org/wiki/Forensic_linguistics
  [694]: https://web.archive.org/web/https://wikipedia.org/wiki/Forensic_linguistics
  [695]: https://wikiless.org/wiki/Writeprint
  [696]: https://web.archive.org/web/https://wikipedia.org/wiki/Writeprint
  [697]: https://wikiless.org/wiki/Stylometry
  [698]: https://web.archive.org/web/https://wikipedia.org/wiki/Stylometry
  [699]: https://wikiless.org/wiki/Content_similarity_detection
  [700]: https://web.archive.org/web/https://wikipedia.org/wiki/Content_similarity_detection
  [701]: https://wikiless.org/wiki/Author_profiling
  [702]: https://web.archive.org/web/https://wikipedia.org/wiki/Author_profiling
  [703]: https://wikiless.org/wiki/Native-language_identification
  [704]: https://web.archive.org/web/https://wikipedia.org/wiki/Native-language_identification
  [705]: https://wikiless.org/wiki/Computational_linguistics
  [706]: https://web.archive.org/web/https://wikipedia.org/wiki/Computational_linguistics
  [707]: https://web.archive.org/web/https://regmedia.co.uk/2017/09/27/gal_vallerius.pdf
  [708]: https://wikiless.org/wiki/Ted_Kaczynski#After_publication
  [709]: https://web.archive.org/web/https://wikipedia.org/wiki/Ted_Kaczynski#After_publication
  [710]: https://web.archive.org/web/https://i.blackhat.com/USA-19/Wednesday/us-19-Wixey-Im-Unique-Just-Like-You-Human-Side-Channels-And-Their-Implications-For-Security-And-Privacy.pdf
  [711]: https://web.archive.org/web/https://media.defcon.org/DEF%20CON%2026/DEF%20CON%2026%20presentations/DEFCON-26-Matt-Wixey-Betrayed-by-the-Keyboard-Updated.pdf
  [712]: https://web.archive.org/web/https://i.blackhat.com/us-18/Wed-August-8/us-18-Wixey-Every-ROSE-Has-Its-Thorn-The-Dark-Art-Of-Remote-Online-Social-Engineering.pdf
  [713]: https://web.archive.org/web/https://github.com/spikecodes/libreddit
  [714]: https://web.archive.org/web/https://git.sr.ht/~metalune/simplytranslate_web
  [https://anonymousplanet.org]: https://anonymousplanet.org/
  [715]: https://mirror.anonymousplanet.org/guide.pdf
  [716]: https://web.archive.org/web/https://anonymousplanet.org/guide.pdf
  [717]: http://thgtoa7imksbg7rit4grgijl2ef6kc7b56bp56pmtta4g354lydlzkqd.onion/guide.pdf
  [718]: https://mirror.anonymousplanet.org/guide-dark.pdf
  [719]: https://web.archive.org/web/https://anonymousplanet.org/guide-dark.pdf
  [720]: http://thgtoa7imksbg7rit4grgijl2ef6kc7b56bp56pmtta4g354lydlzkqd.onion/guide-dark.pdf
  [721]: https://mirror.anonymousplanet.org/guide.odt
  [722]: https://web.archive.org/web/https://anonymousplanet.org/guide.odt
  [723]: http://thgtoa7imksbg7rit4grgijl2ef6kc7b56bp56pmtta4g354lydlzkqd.onion/guide.odt
  [724]: https://web.archive.org/web/https://help.libreoffice.org/7.1/en-US/text/shared/guide/redlining_doccompare.html
  [**https://www.youtube.com/watch?v=j02QoI4ZlnU**]: https://www.youtube.com/watch?v=j02QoI4ZlnU
  [725]: https://yewtu.be/watch?v=j02QoI4ZlnU
  [726]: https://web.archive.org/web/https://github.com/monero-project/monero/blob/master/docs/ANONYMITY_NETWORKS.md#privacy-limitations
  [727]: https://web.archive.org/web/https://www.linddun.org/
  [728]: https://wikiless.org/wiki/STRIDE_%28security%29
  [729]: https://web.archive.org/web/https://en.wikipedia.org/wiki/STRIDE_%28security%29
  [730]: https://web.archive.org/web/https://versprite.com/tag/pasta-threat-modeling/
  [731]: https://web.archive.org/web/https://insights.sei.cmu.edu/blog/threat-modeling-12-available-methods/
  [732]: https://web.archive.org/web/https://www.geeksforgeeks.org/threat-modelling/
  [733]: https://web.archive.org/web/https://www.threatmodelingmanifesto.org/
  [734]: https://web.archive.org/web/https://cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html
  ...
  [735]: https://web.archive.org/web/https://www.huntonprivacyblog.com/wp-content/uploads/sites/28/2016/02/Telemedia_Act__TMA_.pdf
  [736]: https://wikiless.org/wiki/Don%27t_be_evil
  [737]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Don%27t_be_evil
  [738]: https://yewtu.be/watch?v=6DGNZnfKYnU
  [739]: https://wikiless.org/wiki/Open-source_intelligence
  [740]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Open-source_intelligence
  [741]: https://yewtu.be/playlist?list=PLna1KTNJu3y09Tu70U6yPn28sekaNhOMY
  [742]: https://wikiless.org/wiki/4chan
  [743]: https://web.archive.org/web/https://en.wikipedia.org/wiki/4chan
  [744]: https://web.archive.org/web/https://www.privateinternetaccess.com/blog/how-does-privacy-differ-from-anonymity-and-why-are-both-important/
  [745]: https://web.archive.org/web/https://scholar.harvard.edu/files/mickens/files/thisworldofours.pdf
  [746]: https://web.archive.org/web/https://xkcd.com/538/
  [747]: https://wikiless.org/wiki/Threat_model
  [748]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Threat_model
  [749]: https://web.archive.org/web/https://www.bellingcat.com/
  [750]: https://wikiless.org/wiki/Doxing
  [751]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Doxing
  [752]: https://yewtu.be/watch?v=muoR8Td44UE
  [753]: https://web.archive.org/web/https://www.bbc.com/news/technology-50150981
  [754]: https://web.archive.org/web/https://github.com/alecmuffett/real-world-onion-sites
  [755]: https://web.archive.org/web/https://2019.www.torproject.org/about/torusers.html.en
  [756]: https://web.archive.org/web/https://www.whonix.org/wiki/Anonymity
  [757]: https://web.archive.org/web/https://geekfeminism.wikia.org/wiki/Who_is_harmed_by_a_%22Real_Names%22_policy%3F
  [758]: https://web.archive.org/web/https://www.cyberghostvpn.com/privacyhub/internet-privacy-surveillance/
  [759]: https://web.archive.org/web/https://www.privateinternetaccess.com/blog/internet-freedom-around-the-world-in-50-stats/
  [760]: https://wikiless.org/wiki/IANAL
  [761]: https://web.archive.org/web/https://en.wikipedia.org/wiki/IANAL
  [762]: https://wikiless.org/wiki/Trust,_but_verify
  [763]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Trust,_but_verify
  [764]: https://wikiless.org/wiki/IP_address
  [765]: https://web.archive.org/web/https://en.wikipedia.org/wiki/IP_address
  [766]: https://wikiless.org/wiki/Data_retention
  [767]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Data_retention
  [768]: https://wikiless.org/wiki/Tor_(anonymity_network)
  [769]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Tor_(anonymity_network)
  [770]: https://wikiless.org/wiki/Virtual_private_network
  [771]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Virtual_private_network
  [772]: https://web.archive.org/web/https://ieeexplore.ieee.org/document/8418599
  [773]: https://wikiless.org/wiki/Domain_Name_System
  [774]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Domain_Name_System
  [775]: https://wikiless.org/wiki/DNS_blocking
  [776]: https://web.archive.org/web/https://en.wikipedia.org/wiki/DNS_blocking
  [777]: https://web.archive.org/web/https://censoredplanet.org/
  [778]: https://web.archive.org/web/https://arxiv.org/pdf/2001.08288.pdf
  [779]: https://web.archive.org/web/https://labzilla.io/blog/force-dns-pihole
  [780]: https://wikiless.org/wiki/DNS_over_HTTPS
  [781]: https://web.archive.org/web/https://en.wikipedia.org/wiki/DNS_over_HTTPS
  [782]: https://wikiless.org/wiki/DNS_over_TLS
  [783]: https://web.archive.org/web/https://en.wikipedia.org/wiki/DNS_over_TLS
  [784]: https://wikiless.org/wiki/Pi-hole
  [785]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Pi-hole
  [786]: https://wikiless.org/wiki/Server_Name_Indication
  [787]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Server_Name_Indication
  [788]: https://web.archive.org/web/https://www.usenix.org/system/files/foci19-paper_chai_0.pdf
  [789]: https://wikiless.org/wiki/Content_delivery_network
  [790]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Content_delivery_network
  [791]: https://web.archive.org/web/https://blog.cloudflare.com/encrypted-client-hello/
  [792]: https://web.archive.org/web/https://www.zdnet.com/article/russia-wants-to-ban-the-use-of-secure-protocols-such-as-tls-1-3-doh-dot-esni/
  [793]: https://web.archive.org/web/https://www.zdnet.com/article/china-is-now-blocking-all-encrypted-https-traffic-using-tls-1-3-and-esni/
  [794]: https://wikiless.org/wiki/Online_Certificate_Status_Protocol
  [795]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Online_Certificate_Status_Protocol
  [796]: https://web.archive.org/web/https://madaidans-insecurities.github.io/encrypted-dns.html
  [797]: https://wikiless.org/wiki/OCSP_stapling
  [798]: https://web.archive.org/web/https://en.wikipedia.org/wiki/OCSP_stapling
  [799]: https://web.archive.org/web/https://dev.chromium.org/Home/chromium-security/crlsets
  [800]: https://web.archive.org/web/https://www.zdnet.com/article/chrome-does-certificate-revocation-better/
  [801]: https://web.archive.org/web/https://www.esat.kuleuven.be/cosic/publications/article-3153.pdf
  [802]: https://web.archive.org/web/https://www.researchgate.net/publication/332893422_Oblivious_DNS_Practical_Privacy_for_DNS_Queries
  [803]: https://web.archive.org/web/https://nymity.ch/tor-dns/
  [804]: https://wikiless.org/wiki/Near-field_communication
  [805]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Near-field_communication
  [806]: https://web.archive.org/web/https://shop.samsonite.com/accessories/rfid-accessories/
  [807]: https://web.archive.org/web/https://support.google.com/accounts/answer/3467281?hl=en
  [808]: https://web.archive.org/web/https://support.apple.com/en-us/HT207056
  [809]: https://web.archive.org/web/https://cse.buffalo.edu/~lusu/papers/MobiCom2020.pdf
  [810]: https://web.archive.org/web/https://digi.ninja/jasager/
  [811]: https://web.archive.org/web/https://shop.hak5.org/products/wifi-pineapple
  [812]: https://wikiless.org/wiki/Wi-Fi_deauthentication_attack
  [813]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Wi-Fi_deauthentication_attack
  [814]: https://wikiless.org/wiki/Captive_portal
  [815]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Captive_portal
  [816]: https://web.archive.org/web/https://www.hackerfactor.com/blog/index.php?/archives/868-Deanonymizing-Tor-Circuits.html
  [817]: https://web.archive.org/web/https://distrinet.cs.kuleuven.be/software/tor-wf-dl/
  [818]: https://web.archive.org/web/https://homes.esat.kuleuven.be/~mjuarezm/index_files/pdf/ccs18.pdf
  [819]: https://web.archive.org/web/https://www.internetsociety.org/sites/default/files/blogs-media/website-fingerprinting-internet-scale.pdf
  [820]: https://web.archive.org/web/https://www.esat.kuleuven.be/cosic/publications/article-2456.pdf
  [821]: https://web.archive.org/web/https://www.dailydot.com/unclick/tor-harvard-bomb-suspect/
  [822]: https://web.archive.org/web/https://arstechnica.com/information-technology/2015/10/how-the-nsa-can-break-trillions-of-encrypted-web-and-vpn-connections/
  [823]: https://web.archive.org/web/https://arstechnica.com/gadgets/2020/11/does-tor-provide-more-benefit-or-harm-new-paper-says-it-depends/
  [824]: https://web.archive.org/web/https://www.pnas.org/content/early/2020/11/24/2011893117
  [825]: https://web.archive.org/web/https://blog.cryptographyengineering.com/2019/06/05/how-does-apple-privately-find-your-offline-devices/
  [826]: https://web.archive.org/web/https://support.apple.com/en-us/HT210515
  [827]: https://web.archive.org/web/https://www.xda-developers.com/samsung-find-my-mobile-app-locate-galaxy-devices-offline/
  [828]: https://web.archive.org/web/https://support.apple.com/en-us/HT204756
  [829]: https://wikiless.org/wiki/Bluetooth_Low_Energy
  [830]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Bluetooth_Low_Energy
  [831]: https://wikiless.org/wiki/International_Mobile_Equipment_Identity
  [832]: https://web.archive.org/web/https://en.wikipedia.org/wiki/International_Mobile_Equipment_Identity
  [833]: https://wikiless.org/wiki/International_mobile_subscriber_identity
  [834]: https://web.archive.org/web/https://en.wikipedia.org/wiki/International_mobile_subscriber_identity
  [835]: https://web.archive.org/web/https://source.android.com/devices/tech/config/device-identifiers
  [836]: https://web.archive.org/web/https://policies.google.com/privacy/embedded?hl=en-US
  [837]: https://web.archive.org/web/https://www.bellingcat.com/news/uk-and-europe/2019/06/28/the-gru-globetrotters-mission-london/
  [838]: https://web.archive.org/web/https://www.bellingcat.com/news/uk-and-europe/2020/02/17/v-like-vympel-fsbs-secretive-department-v-behind-assassination-of-zelimkhan-khangoshvili/
  [839]: https://wikiless.org/wiki/Closed-circuit_television
  [840]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Closed-circuit_television
  [841]: https://web.archive.org/web/https://www.apple.com/legal/transparency/device-requests.html
  [842]: https://27m3p2uv7igmj6kvd4ql3cct5h3sdwrsajovkkndeufumzyfhlfev4qd.onion/2020/07/31/protests-surveillance-stingrays-dirtboxes-phone-tracking/
  [843]: https://web.archive.org/web/https://theintercept.com/2020/07/31/protests-surveillance-stingrays-dirtboxes-phone-tracking/
  [844]: https://wikiless.org/wiki/IMSI-catcher
  [845]: https://web.archive.org/web/https://en.wikipedia.org/wiki/IMSI-catcher
  [846]: https://wikiless.org/wiki/Stingray_phone_tracker
  [847]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Stingray_phone_tracker
  [848]: https://web.archive.org/web/https://gizmodo.com/american-cops-turns-to-canadian-phone-tracking-firm-aft-1845442778
  [849]: https://wikiless.org/wiki/Man-in-the-middle_attack
  [850]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Man-in-the-middle_attack
  [851]: https://web.archive.org/web/https://shop.puri.sm/shop/librem-5/
  [852]: https://wikiless.org/wiki/MAC_address
  [853]: https://web.archive.org/web/https://en.wikipedia.org/wiki/MAC_address
  [854]: https://web.archive.org/web/https://amsignalinc.com/data-sheets/Acyclica/Acyclica-RoadTrend-Product-Sheet.pdf
  [855]: https://web.archive.org/web/https://www.researchgate.net/publication/334590931_Tracking_Anonymized_Bluetooth_Devices/fulltext/5d3308db92851cd04675a469/Tracking-Anonymized-Bluetooth-Devices.pdf
  [856]: https://wikiless.org/wiki/Central_processing_unit
  [857]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Central_processing_unit
  [858]: https://wikiless.org/wiki/Intel_Management_Engine
  [859]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Intel_Management_Engine
  [860]: https://wikiless.org/wiki/AMD_Platform_Security_Processor
  [861]: https://web.archive.org/web/https://en.wikipedia.org/wiki/AMD_Platform_Security_Processor
  [862]: https://web.archive.org/web/https://libreboot.org/
  [863]: https://web.archive.org/web/https://www.apple.com/privacy/docs/Differential_Privacy_Overview.pdf
  [864]: https://wikiless.org/wiki/Differential_privacy
  [865]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Differential_privacy
  [866]: https://web.archive.org/web/https://edwardsnowden.substack.com/p/all-seeing-i
  [867]: https://web.archive.org/web/https://www.reuters.com/article/us-apple-fbi-icloud-exclusive-idUSKBN1ZK1CT
  [868]: https://web.archive.org/web/https://www.zdnet.com/article/apple-data-collection-stored-request/
  [869]: https://web.archive.org/web/https://decorrespondent.nl/8481/heres-how-we-found-the-names-and-addresses-of-soldiers-and-secret-agents-using-a-simple-fitness-app/412999257-6756ba27
  [870]: https://web.archive.org/web/https://www.websiteplanet.com/blog/gethealth-leak-report/
  [871]: https://web.archive.org/web/https://www.wired.com/story/strava-heat-map-military-bases-fitness-trackers-privacy/
  [872]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2018/01/29/strava-interpretation-guide/
  [873]: https://web.archive.org/web/https://www.theguardian.com/world/2018/jan/28/fitness-tracking-app-gives-away-location-of-secret-us-army-bases
  [874]: https://web.archive.org/web/https://www.telegraph.co.uk/technology/2018/07/08/running-app-exposes-mi6-gchq-workers-whereabouts/
  [875]: https://web.archive.org/web/https://www.washingtonpost.com/technology/2019/05/06/alexa-has-been-eavesdropping-you-this-whole-time/?itid=lk_interstitial_manual_59
  [876]: https://web.archive.org/web/https://www.washingtonpost.com/technology/2019/12/17/what-does-your-car-know-about-you-we-hacked-chevy-find-out/
  [877]: https://web.archive.org/web/https://kieranhealy.org/blog/archives/2013/06/09/using-metadata-to-find-paul-revere/
  [878]: https://wikiless.org/wiki/Sensorvault
  [879]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Sensorvault
  [880]: https://web.archive.org/web/https://nrkbeta.no/2020/12/03/my-phone-was-spying-on-me-so-i-tracked-down-the-surveillants/
  [881]: https://web.archive.org/web/https://www.nytimes.com/interactive/2019/12/19/opinion/location-tracking-cell-phone.html
  [882]: https://web.archive.org/web/https://nakedsecurity.sophos.com/2020/03/10/google-data-puts-innocent-man-at-the-scene-of-a-crime/
  [883]: https://wikiless.org/wiki/Geo-fence_warrant
  [884]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Geo-fence_warrant
  [885]: https://web.archive.org/web/https://www.vice.com/en/article/y3g97x/location-data-apps-drone-strikes-iowa-national-guard
  [886]: https://web.archive.org/web/https://techcrunch.com/2021/08/19/google-geofence-warrants/
  [887]: https://web.archive.org/web/https://www.techdirt.com/articles/20210821/10494847401/google-report-shows-reverse-warrants-are-swiftly-becoming-law-enforcements-go-to-investigative-tool.shtml
  [888]: https://wikiless.org/wiki/Room_641A
  [889]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Room_641A
  [890]: https://wikiless.org/wiki/Edward_Snowden
  [891]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Edward_Snowden
  [892]: https://wikiless.org/wiki/XKeyscore
  [893]: https://web.archive.org/web/https://en.wikipedia.org/wiki/XKeyscore
  [894]: https://web.archive.org/web/https://www.electrospaces.net/2020/10/danish-military-intelligence-uses.html
  [895]: https://web.archive.org/web/https://en.m.wikipedia.org/wiki/MUSCULAR_(surveillance_program)
  [896]: https://wikiless.org/wiki/SORM
  [897]: https://web.archive.org/web/https://en.wikipedia.org/wiki/SORM
  [898]: https://wikiless.org/wiki/Tempora
  [899]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Tempora
  [900]: https://wikiless.org/wiki/PRISM_(surveillance_program)
  [901]: https://web.archive.org/web/https://en.wikipedia.org/wiki/PRISM_(surveillance_program)
  [902]: https://web.archive.org/web/https://www.justsecurity.org/10318/video-clip-director-nsa-cia-we-kill-people-based-metadata/
  [903]: https://web.archive.org/web/https://www.imdb.com/title/tt11464826/
  [904]: https://web.archive.org/web/https://arstechnica.com/information-technology/2015/07/how-the-way-you-type-can-shatter-anonymity-even-on-tor/
  [905]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Stylometry
  [906]: https://web.archive.org/web/https://paul.reviews/behavioral-profiling-the-password-you-cant-change/
  [907]: https://wikiless.org/wiki/Sentiment_analysis
  [908]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Sentiment_analysis
  [909]: https://web.archive.org/web/https://coveryourtracks.eff.org/
  [910]: https://web.archive.org/web/https://people.eecs.berkeley.edu/~dawnsong/papers/2012%20On%20the%20Feasibility%20of%20Internet-Scale%20Author%20Identification.pdf
  ...
  [911]: https://web.archive.org/web/https://www.forbes.com/sites/thomasbrewster/2021/10/04/google-keyword-warrants-give-us-government-data-on-search-users
  [912]: https://web.archive.org/web/https://blog.securedtouch.com/behavioral-biometrics-101-an-in-depth-look-at-behavioral-biometrics-vs-behavioral-analytics
  [913]: https://web.archive.org/web/https://arstechnica.com/tech-policy/2012/03/stakeout-how-the-fbi-tracked-and-busted-a-chicago-anon/
  [914]: https://web.archive.org/web/https://www.bellingcat.com/news/uk-and-europe/2018/05/25/mh17-russian-gru-commander-orion-identified-oleg-ivannikov/
  [915]: https://web.archive.org/web/https://research.fb.com/publications/deepface-closing-the-gap-to-human-level-performance-in-face-verification/
  [916]: https://web.archive.org/web/https://www.privateinternetaccess.com/blog/putting-face-facebook-mark-zuckerberg-building-world-without-public-anonymity/
  [917]: https://web.archive.org/web/https://www.cnbc.com/2017/09/01/facebook-has-mapped-human-population-building-internet-in-space.html
  [918]: https://web.archive.org/web/https://www.technologyreview.com/2021/02/05/1017388/ai-deep-learning-facial-recognition-data-history/
  [919]: https://web.archive.org/web/https://www.bellingcat.com/resources/case-studies/2015/08/07/shadow-of-a-doubt/
  [920]: https://web.archive.org/web/https://brown.columbia.edu/open-source-investigation/
  [921]: https://web.archive.org/web/https://www.newscientist.com/article/dn27761-facebook-can-recognise-you-in-photos-even-if-youre-not-looking/
  [922]: https://web.archive.org/web/https://patents.google.com/patent/US20150242679
  [923]: https://web.archive.org/web/https://apnews.com/article/bf75dd1c26c947b7826d270a16e2658a
  [924]: https://web.archive.org/web/https://www.thesun.co.uk/news/7684204/cctv-technology-identify-body-shape-way-walk/
  [925]: https://web.archive.org/web/https://citysecuritymagazine.com/security-management/gait-recognition-identification-tool/
  [926]: https://web.archive.org/web/https://www.vice.com/en/article/bvzvdw/tech-companies-are-training-ai-to-read-your-lips
  [927]: https://web.archive.org/web/https://newatlas.com/science/science/eye-tracking-privacy/
  [928]: https://web.archive.org/web/https://techcrunch.com/2021/01/13/facial-recognition-reveals-political-party-in-troubling-new-research/
  [929]: https://web.archive.org/web/https://slate.com/technology/2018/04/facebook-collects-data-on-non-facebook-users-if-they-want-to-delete-it-they-have-to-sign-up.html
  [930]: https://web.archive.org/web/https://theconversation.com/shadow-profiles-facebook-knows-about-you-even-if-youre-not-on-facebook-94804
  [931]: https://web.archive.org/web/https://www.theverge.com/2018/4/11/17225482/facebook-shadow-profiles-zuckerberg-congress-data-privacy
  [932]: https://web.archive.org/web/https://www.zdnet.com/article/anger-mounts-after-facebooks-shadow-profiles-leak-in-bug/
  [933]: https://web.archive.org/web/https://www.cnet.com/news/shadow-profiles-facebook-has-information-you-didnt-hand-over/
  [934]: https://web.archive.org/web/https://www.anyvision.co/
  [935]: https://web.archive.org/web/https://www.buzzfeednews.com/article/ryanmac/clearview-ai-local-police-facial-recognition
  [936]: https://web.archive.org/web/https://www.wired.com/story/clearview-ai-new-tools-identify-you-photos/
  [937]: https://web.archive.org/web/https://www.nec.com/en/global/solutions/biometrics/face/neofacewatch.html
  [938]: https://web.archive.org/web/https://www.theguardian.com/uk-news/2020/feb/11/met-police-deploy-live-facial-recognition-technology
  [939]: https://yewtu.be/watch?v=lH2gMNrUuEY
  [940]: https://web.archive.org/web/https://edition.cnn.com/2021/07/23/tech/idme-unemployment-facial-recognition/index.html
  [941]: https://web.archive.org/web/https://www.washingtonpost.com/technology/2020/12/08/huawei-tested-ai-software-that-could-recognize-uighur-minorities-alert-police-report-says/
  [942]: https://27m3p2uv7igmj6kvd4ql3cct5h3sdwrsajovkkndeufumzyfhlfev4qd.onion/2016/10/13/how-a-facial-recognition-mismatch-can-ruin-your-life/
  [943]: https://web.archive.org/web/https://theintercept.com/2016/10/13/how-a-facial-recognition-mismatch-can-ruin-your-life/
  [944]: https://web.archive.org/web/https://www.vice.com/en/article/5dbywn/facial-recognition-failures-are-locking-people-out-of-unemployment-systems
  [945]: https://web.archive.org/web/https://www.bbc.com/news/uk-wales-43711477
  [946]: https://web.archive.org/web/https://edition.cnn.com/2021/05/25/uk/drug-dealer-cheese-sentenced-scli-gbr-intl/index.html
  [947]: https://web.archive.org/web/https://www.vice.com/en/article/evqk9e/photo-of-fingerprints-used-to-arrest-drug-dealers
  [948]: https://web.archive.org/web/https://patents.justia.com/patent/10891948
  [949]: https://web.archive.org/web/https://www.pymnts.com/news/biometrics/2021/iris-scan-traveler-identification-dubai-airport/
  [950]: https://web.archive.org/web/https://www.imdb.com/title/tt0119177/
  [951]: https://web.archive.org/web/https://www.imdb.com/title/tt1839578
  [952]: https://web.archive.org/web/https://www.imdb.com/title/tt0181689
  [953]: https://wikiless.org/wiki/Deepfake
  [954]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Deepfake
  [955]: https://web.archive.org/web/https://www.econotimes.com/Deepfake-Voice-Technology-The-Good-The-Bad-The-Future-1601278
  [956]: https://web.archive.org/web/https://www.forbes.com/sites/jessedamiani/2019/09/03/a-voice-deepfake-was-used-to-scam-a-ceo-out-of-243000/
  [957]: https://web.archive.org/web/https://josephsteinberg.com/how-to-prevent-facial-recognition-technology-from-identifying-you/
  [958]: https://web.archive.org/web/https://nvlpubs.nist.gov/nistpubs/ir/2020/NIST.IR.8311.pdf
  [959]: https://web.archive.org/web/https://www.bbc.com/news/technology-55573802
  [960]: https://web.archive.org/web/http://diglib.uwgb.edu/digital/api/collection/p17003coll4/id/71/download
  [961]: https://wikiless.org/wiki/Phishing
  [962]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Phishing
  [963]: https://wikiless.org/wiki/Social_engineering_(security)
  [964]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Social_engineering_(security)
  [965]: https://web.archive.org/web/https://www.bbc.com/news/technology-56071437
  [966]: https://wikiless.org/wiki/Exploit_(computer_security)
  [967]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Exploit_(computer_security)
  [968]: https://wikiless.org/wiki/Freedom_Hosting
  [969]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Freedom_Hosting
  [970]: https://web.archive.org/web/https://www.wired.com/2013/09/freedom-hosting-fbi/
  [971]: https://wikiless.org/wiki/2020_United_States_federal_government_data_breach
  [972]: https://web.archive.org/web/https://en.wikipedia.org/wiki/2020_United_States_federal_government_data_breach
  [973]: https://web.archive.org/web/https://www.bbc.com/news/blogs-china-blog-48552907
  [974]: https://27m3p2uv7igmj6kvd4ql3cct5h3sdwrsajovkkndeufumzyfhlfev4qd.onion/2021/01/29/china-uyghur-muslim-surveillance-police/
  [975]: https://web.archive.org/web/https://theintercept.com/2021/01/29/china-uyghur-muslim-surveillance-police/
  [976]: https://wikiless.org/wiki/Sandbox_(computer_security)
  [977]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Sandbox_(computer_security)
  [978]: https://web.archive.org/web/https://www.wired.com/2014/07/usb-security/
  [979]: https://wikiless.org/wiki/Stuxnet
  [980]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Stuxnet
  [981]: https://web.archive.org/web/https://superuser.com/questions/1206321/how-do-i-safely-investigate-a-usb-stick-found-in-the-parking-lot-at-work
  [982]: https://web.archive.org/web/https://www.theguardian.com/books/2014/may/12/glenn-greenwald-nsa-tampers-us-internet-routers-snowden
  [983]: https://wikiless.org/wiki/Rootkit
  [984]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Rootkit
  [985]: https://wikiless.org/wiki/User_space
  [986]: https://web.archive.org/web/https://en.wikipedia.org/wiki/User_space
  [987]: https://wikiless.org/wiki/Firmware
  [988]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Firmware
  [989]: https://wikiless.org/wiki/BIOS
  [990]: https://web.archive.org/web/https://en.wikipedia.org/wiki/BIOS
  [991]: https://wikiless.org/wiki/Unified_Extensible_Firmware_Interface
  [992]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Unified_Extensible_Firmware_Interface
  [993]: https://web.archive.org/web/https://www.bellingcat.com/news/americas/2018/10/26/joseph-mifsud-rush-exif/
  [994]: https://web.archive.org/web/https://support.zoom.us/hc/en-us/articles/209605273-Adding-a-Watermark
  [995]: https://web.archive.org/web/https://support.zoom.us/hc/en-us/articles/360021839031-Audio-Watermark
  [996]: https://web.archive.org/web/https://exchange.adobe.com/creativecloud.details.101789.imatag-invisible-watermark-and-image-monitoring.html
  [997]: https://web.archive.org/web/https://dtv.nagra.com/nexguard-forensic-watermarking
  [998]: https://web.archive.org/web/https://www.vobilegroup.com
  [999]: https://web.archive.org/web/https://www.cinavia.com/languages/english/pages/technology.html
  [1000]: https://web.archive.org/web/https://www.imatag.com/
  [1001]: https://wikiless.org/wiki/Steganography
  [1002]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Steganography
  [1003]: https://web.archive.org/web/https://ieeexplore.ieee.org/document/4428921
  [1004]: https://web.archive.org/web/https://www.sciencedirect.com/science/article/abs/pii/S0165168498000140
  [1005]: https://web.archive.org/web/https://ieeexplore.ieee.org/abstract/document/1188746
  [1006]: https://web.archive.org/web/https://scholar.google.com/scholar?q=source+camera+identification
  [1007]: https://wikiless.org/wiki/Machine_Identification_Code
  [1008]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Machine_Identification_Code
  [1009]: https://web.archive.org/web/http://seeingyellow.com/
  [1010]: https://web.archive.org/web/https://arxiv.org/abs/1107.4524
  [1011]: https://web.archive.org/web/https://www.bellingcat.com/resources/how-tos/2019/03/26/how-to-track-illegal-funding-campaigns-via-cryptocurrency/
  [1012]: https://web.archive.org/web/https://www.coindesk.com/business/2021/09/21/leaked-slides-show-how-chainalysis-flags-crypto-suspects-for-cops/
  [1013]: https://wikiless.org/wiki/Know_your_customer
  [1014]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Know_your_customer
  [1015]: https://web.archive.org/web/https://arxiv.org/pdf/1906.05754.pdf
  [1016]: https://yewtu.be/playlist?list=PLsSYUeVwrHBnAUre2G_LYDsdo-tD0ov-y
  [1017]: https://web.archive.org/web/https://monero.org/monero-vs-princeton-researchers/
  [1018]: https://wikiless.org/wiki/Cryptocurrency_tumbler
  [1019]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Cryptocurrency_tumbler
  [1020]: https://wikiless.org/wiki/Security_through_obscurity
  [1021]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Security_through_obscurity
  [1022]: https://web.archive.org/web/https://arxiv.org/abs/2009.14007
  [1023]: https://web.archive.org/web/https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3080361
  [1024]: https://web.archive.org/web/https://www.magnetforensics.com/products/magnet-axiom/cloud/
  [1025]: https://web.archive.org/web/https://www.cellebrite.com/en/ufed-cloud/
  [1026]: https://web.archive.org/web/https://sites.google.com/a/chromium.org/dev/Home/chromium-security/client-identification-mechanisms
  [1027]: https://web.archive.org/web/https://wiki.mozilla.org/Fingerprinting
  [1028]: https://web.archive.org/web/https://www.grayshift.com/
  [1029]: https://web.archive.org/web/https://securephones.io/main.pdf
  [1030]: https://web.archive.org/web/https://loup-vaillant.fr/articles/rolling-your-own-crypto
  [1031]: https://web.archive.org/web/https://soatok.blog/2021/02/09/crackpot-cryptography-and-security-theater/
  [1032]: https://web.archive.org/web/https://www.vice.com/en/article/wnx8nq/why-you-dont-roll-your-own-crypto
  [1033]: https://web.archive.org/web/https://arxiv.org/pdf/2107.04940.pdf
  [1034]: https://yewtu.be/watch?v=loy84K3AJ5Q
  [1035]: https://web.archive.org/web/https://citizenlab.ca/2020/04/move-fast-roll-your-own-crypto-a-quick-look-at-the-confidentiality-of-zoom-meetings/
  [1036]: https://web.archive.org/web/https://medium.com/@atcipher/the-myth-of-military-grade-encryption-292313ae6369
  [1037]: https://web.archive.org/web/https://blog.congruentlabs.co/military-grade-encryption/
  [1038]: https://web.archive.org/web/https://blog.ironcorelabs.com/military-grade-encryption-69aae0145588
  [1039]: https://wikiless.org/wiki/BLAKE_(hash_function)#BLAKE2
  [1040]: https://web.archive.org/web/https://en.wikipedia.org/wiki/BLAKE_(hash_function)#BLAKE2
  [1041]: https://wikiless.org/wiki/AES_instruction_set
  [1042]: https://web.archive.org/web/https://en.wikipedia.org/wiki/AES_instruction_set
  [1043]: https://wikiless.org/wiki/Salsa20#ChaCha_variant
  [1044]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Salsa20#ChaCha_variant
  [1045]: https://wikiless.org/wiki/Serpent_(cipher)
  [1046]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Serpent_(cipher)
  [1047]: https://wikiless.org/wiki/Twofish
  [1048]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Twofish
  [1049]: https://web.archive.org/web/https://latacora.singles/2019/07/16/the-pgp-problem.html
  [1050]: https://wikiless.org/wiki/Shor%27s_algorithm
  [1051]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Shor%27s_algorithm
  [1052]: https://wikiless.org/wiki/Gag_order
  [1053]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Gag_order
  [1054]: https://wikiless.org/wiki/National_security_letter
  [1055]: https://web.archive.org/web/https://en.wikipedia.org/wiki/National_security_letter
  [1056]: https://web.archive.org/web/https://techcrunch.com/2021/09/06/protonmail-logged-ip-address-of-french-activist-after-order-by-swiss-authorities/
  [1057]: https://web.archive.org/web/https://arstechnica.com/gadgets/2021/07/vpn-servers-seized-by-ukrainian-authorities-werent-encrypted/
  [1058]: https://web.archive.org/web/https://www.bleepingcomputer.com/news/security/doublevpn-servers-logs-and-account-info-seized-by-law-enforcement/
  [1059]: https://web.archive.org/web/https://www.cyberscoop.com/court-rules-encrypted-email-tutanota-monitor-messages/
  [1060]: https://web.archive.org/web/https://www.heise.de/news/Gericht-zwingt-Mailprovider-Tutanota-zu-Ueberwachungsfunktion-4972460.html
  [1061]: https://web.archive.org/web/https://www.pcmag.com/opinions/did-purevpn-cross-a-line-when-it-disclosed-user-information
  [1062]: https://web.archive.org/web/https://archive.is/XNuVw
  [1063]: https://wikiless.org/wiki/Lavabit
  [1064]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Lavabit
  [1065]: https://wikiless.org/wiki/Warrant_canary
  [1066]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Warrant_canary
  [1067]: https://web.archive.org/web/https://www.washingtonpost.com/graphics/2020/world/national-security/cia-crypto-encryption-machines-espionage/
  [1068]: https://web.archive.org/web/https://www.swissinfo.ch/eng/second-swiss-firm-allegedly-sold-encrypted-spying-devices/46186432
  [1069]: https://wikiless.org/wiki/The_Lives_of_Others
  [1070]: https://web.archive.org/web/https://en.wikipedia.org/wiki/The_Lives_of_Others
  [1071]: https://web.archive.org/web/https://www.wired.com/story/air-gap-researcher-mordechai-guri/
  [1072]: https://web.archive.org/web/https://www.scientificamerican.com/article/a-blank-wall-can-show-how-many-people-are-in-a-room-and-what-theyre-doing/
  [1073]: https://web.archive.org/web/https://www.scientificamerican.com/article/a-shiny-snack-bags-reflections-can-reconstruct-the-room-around-it/
  [1074]: https://web.archive.org/web/https://www.scientificamerican.com/article/footstep-sensors-identify-people-by-gait/
  [1075]: https://web.archive.org/web/https://www.nassiben.com/lamphone
  [1076]: https://web.archive.org/web/https://www.theguardian.com/world/2013/aug/22/gchq-warned-laser-spying-guardian-offices
  [1077]: https://web.archive.org/web/https://arstechnica.com/tech-policy/2014/05/photos-of-an-nsa-upgrade-factory-show-cisco-router-getting-implant/
  [1078]: https://wikiless.org/wiki/OONI
  [1079]: https://web.archive.org/web/https://en.wikipedia.org/wiki/OONI
  [1080]: https://web.archive.org/web/https://privacyinternational.org/long-read/3018/timeline-sim-card-registration-laws
  [1081]: https://web.archive.org/web/https://www.nytimes.com/2021/01/12/technology/bitcoin-passwords-wallets-fortunes.html
  [1082]: https://web.archive.org/web/https://www.usenix.org/system/files/conference/woot17/woot17-paper-obermaier.pdf
  [1083]: https://web.archive.org/web/https://support.torproject.org/tormobile/tormobile-3/
  [1084]: https://wikiless.org/wiki/Tails_(operating_system)
  [1085]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Tails_(operating_system)
  [1086]: https://web.archive.org/web/https://www.veracrypt.fr/en/Trim%20Operation.html
  [1087]: https://web.archive.org/web/https://www.coreboot.org/
  [1088]: https://wikiless.org/wiki/Booting
  [1089]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Booting
  [1090]: https://web.archive.org/web/https://www.wired.com/2013/12/better-data-security-nail-polish/
  [1091]: https://wikiless.org/wiki/Virtual_machine
  [1092]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Virtual_machine
  [1093]: https://wikiless.org/wiki/Plausible_deniability
  [1094]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Plausible_deniability
  [1095]: https://wikiless.org/wiki/Deniable_encryption
  [1096]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Deniable_encryption
  [1097]: https://web.archive.org/web/https://privacyguides.org/operating-systems/#win10
  [1098]: https://wikiless.org/wiki/BitLocker
  [1099]: https://web.archive.org/web/https://en.wikipedia.org/wiki/BitLocker
  [1100]: https://wikiless.org/wiki/Evil_maid_attack
  [1101]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Evil_maid_attack
  [1102]: https://wikiless.org/wiki/Cold_boot_attack
  [1103]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Cold_boot_attack
  [1104]: https://yewtu.be/watch?v=JDaicPIgn9U
  [1105]: https://web.archive.org/web/https://www.researchgate.net/publication/318155607_Defeating_Plausible_Deniability_of_VeraCrypt_Hidden_Operating_Systems
  [1106]: https://web.archive.org/web/https://www.sans.org/reading-room/whitepapers/forensics/mission-implausible-defeating-plausible-deniability-digital-forensics-39500
  [1107]: https://web.archive.org/web/https://sourceforge.net/p/veracrypt/discussion/technical/thread/53f33faf/
  [1108]: https://web.archive.org/web/https://docs.microsoft.com/en-us/windows/security/information-protection/bitlocker/bitlocker-countermeasures
  [1109]: https://web.archive.org/web/https://www.sans.org/reading-room/whitepapers/forensics/windows-shellbag-forensics-in-depth-34545
  [1110]: https://web.archive.org/web/https://eprints.whiterose.ac.uk/75046/1/Forensic_Data_Recovery_From_The_Windows_Search_Database_preprint_DIIN328.pdf
  [1111]: https://web.archive.org/web/https://cyberforensicator.com/wp-content/uploads/2017/01/1-s2.0-S1742287616300202-main.2-14.pdf
  [1112]: https://wikiless.org/wiki/Gatekeeper_(macOS)
  [1113]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Gatekeeper_(macOS)
  [1114]: https://web.archive.org/web/https://wiki.alpinelinux.org/wiki/Setting_up_a_laptop
  [1115]: https://wikiless.org/wiki/VeraCrypt
  [1116]: https://web.archive.org/web/https://en.wikipedia.org/wiki/VeraCrypt
  [1117]: https://web.archive.org/web/https://www.veracrypt.fr/en/Unencrypted%20Data%20in%20RAM.html
  [1118]: https://web.archive.org/web/https://www.veracrypt.fr/code/VeraCrypt/plain/doc/html/Data%20Leaks.html
  [1119]: https://web.archive.org/web/https://dolosgroup.io/blog/2021/7/9/from-stolen-laptop-to-inside-the-company-network
  [1120]: https://web.archive.org/web/https://trmm.net/tpm-sniffing/
  [1121]: https://nitter.fdn.fr/SecurityJon/status/1445020885472235524
  [1122]: https://web.archive.org/web/https://labs.f-secure.com/blog/sniff-there-leaks-my-bitlocker-key/
  [1123]: https://web.archive.org/web/https://www.veracrypt.fr/en/VeraCrypt%20Rescue%20Disk.html
  [1124]: https://web.archive.org/web/20211009021236/https://repository.stcloudstate.edu/cgi/viewcontent.cgi?article=1141&context=msia_etds
  [1125]: https://web.archive.org/web/https://www.windowscentral.com/how-ensure-trim-enabled-windows-10-speed-ssd-performance
  [1126]: https://web.archive.org/web/https://veracrypt.eu/en/docs/trim-operation/
  [1127]: https://web.archive.org/web/https://i.blackhat.com/eu-18/Thu-Dec-6/eu-18-Schaub-Perfectly-Deniable-Steganographic-Disk-Encryption.pdf
  [1128]: https://web.archive.org/web/http://asalor.blogspot.com/2011/08/trim-dm-crypt-problems.html
  [1129]: https://wikiless.org/wiki/VirtualBox
  [1130]: https://web.archive.org/web/https://en.wikipedia.org/wiki/VirtualBox
  [1131]: https://web.archive.org/web/https://www.virtualbox.org/ticket/17987
  [1132]: https://wikiless.org/wiki/Whonix
  [1133]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Whonix
  [1134]: https://web.archive.org/web/https://docs.oracle.com/en/virtualization/virtualbox/6.0/user/snapshots.html
  [1135]: https://wikiless.org/wiki/Spectre_(security_vulnerability)
  [1136]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Spectre_(security_vulnerability)
  [1137]: https://wikiless.org/wiki/Meltdown_(security_vulnerability)
  [1138]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Meltdown_(security_vulnerability)
  [1139]: https://web.archive.org/web/https://www.whonix.org/wiki/Stream_Isolation#By_Settings
  [1140]: https://wikiless.org/wiki/Time-based_One-time_Password_algorithm
  [1141]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Time-based_One-time_Password_algorithm
  [1142]: https://wikiless.org/wiki/Multi-factor_authentication
  [1143]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Multi-factor_authentication
  [1144]: https://web.archive.org/web/https://www.whonix.org/wiki/Whonix-Gateway_Security#Warning:_Bridged_Networking
  [1145]: https://web.archive.org/web/https://www.qubes-os.org/faq/#is-qubes-just-another-linux-distribution
  [1146]: https://web.archive.org/web/https://www.qubes-os.org/doc/system-requirements/
  [1147]: https://web.archive.org/web/https://github.com/QubesOS/qubes-issues/issues/2414
  [1148]: https://wikiless.org/wiki/AppArmor
  [1149]: https://web.archive.org/web/https://en.wikipedia.org/wiki/AppArmor
  [1150]: https://wikiless.org/wiki/Security-Enhanced_Linux
  [1151]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Security-Enhanced_Linux
  [1152]: https://wikiless.org/wiki/CAPTCHA
  [1153]: https://web.archive.org/web/https://en.wikipedia.org/wiki/CAPTCHA
  [1154]: https://wikiless.org/wiki/Turing_test
  [1155]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Turing_test
  [1156]: https://web.archive.org/web/https://www.google.com/recaptcha/about/
  [1157]: https://web.archive.org/web/https://www.hcaptcha.com/
  [1158]: https://web.archive.org/web/https://www.hcaptcha.com/post/hcaptcha-now-the-largest-independent-captcha-service
  [1159]: https://web.archive.org/web/https://nearcyan.com/you-probably-dont-need-recaptcha/
  [1160]: https://web.archive.org/web/https://arstechnica.com/gadgets/2017/03/googles-recaptcha-announces-invisible-background-captchas/
  [1161]: https://web.archive.org/web/https://www.blackhat.com/docs/asia-16/materials/asia-16-Sivakorn-Im-Not-a-Human-Breaking-the-Google-reCAPTCHA-wp.pdf
  [1162]: https://web.archive.org/web/https://security.googleblog.com/2014/12/are-you-robot-introducing-no-captcha.html
  [1163]: https://web.archive.org/web/https://blog.cloudflare.com/cloudflare-supports-privacy-pass/
  [1164]: https://wikiless.org/wiki/Device_fingerprint
  [1165]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Device_fingerprint
  [1166]: https://web.archive.org/web/https://developers.googleblog.com/2020/08/guidance-for-our-effort-to-block-less-secure-browser-and-apps.html
  [1167]: https://web.archive.org/web/https://support.google.com/accounts/answer/10071085
  [1168]: https://wikiless.org/wiki/Dark_pattern
  [1169]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Dark_pattern
  [1170]: https://web.archive.org/web/https://www.theverge.com/2020/1/23/21077423/tinder-photo-verification-blue-checkmark-safety-center-launch-noonlight
  [1171]: https://web.archive.org/web/https://www.digitalinformationworld.com/2020/03/facebook-is-now-demanding-some-users-to-create-a-video-selfie-for-identity-verification.html
  [1172]: https://web.archive.org/web/https://www.vice.com/en/article/m7a4eq/pornhub-new-verification-policy-biometric-id
  [1173]: https://web.archive.org/web/https://variety.com/2021/digital/news/china-censorship-hotline-historical-nihilism-1234950554/
  [1174]: https://wikiless.org/wiki/Zero_trust_security_model
  [1175]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Zero_trust_security_model
  [1176]: https://wikiless.org/wiki/Espionage
  [1177]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Espionage
  [1178]: https://web.archive.org/web/https://kcimc.medium.com/how-to-recognize-fake-ai-generated-images-4d1f6f9a2842
  [1179]: https://web.archive.org/web/https://blog.jayway.com/2020/03/06/using-ml-to-detect-fake-face-images-created-by-ai/
  [1180]: https://wikiless.org/wiki/SIM_swap_scam
  [1181]: https://web.archive.org/web/https://en.wikipedia.org/wiki/SIM_swap_scam
  [1182]: https://web.archive.org/web/https://www.whonix.org/wiki/Tor
  [1183]: https://web.archive.org/web/https://support.torproject.org/tbb/tbb-editing-torrc/
  [1184]: https://web.archive.org/web/https://support.google.com/accounts/answer/114129?hl=en
  [1185]: https://web.archive.org/web/https://support.google.com/google-ads/answer/7474263?hl=en
  [1186]: https://web.archive.org/web/https://support.google.com/accounts/answer/40695
  [1187]: https://web.archive.org/web/https://support.google.com/accounts/contact/disabled2
  [1188]: https://web.archive.org/web/https://support.google.com/accounts/answer/1333913?hl=en
  [1189]: https://web.archive.org/web/https://www.jumio.com/features/
  [1190]: https://web.archive.org/web/https://privacyguides.org/providers/email/
  ...
  [1191]: https://web.archive.org/web/https://protonmail.com/support/knowledge-base/human-verification/
  [1192]: https://web.archive.org/web/https://knowyourmeme.com/memes/good-luck-im-behind-7-proxies
  [1193]: https://wikiless.org/wiki/End-to-end_encryption
  [1194]: https://web.archive.org/web/https://en.wikipedia.org/wiki/End-to-end_encryption
  [1195]: https://wikiless.org/wiki/Forward_secrecy
  [1196]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Forward_secrecy
  [1197]: https://web.archive.org/web/https://protonmail.com/blog/zero-access-encryption/
  [1198]: https://wikiless.org/wiki/Facebook%E2%80%93Cambridge_Analytica_data_scandal
  [1199]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Facebook%E2%80%93Cambridge_Analytica_data_scandal
  [1200]: https://web.archive.org/web/https://signal.org/blog/sealed-sender/
  [1201]: https://web.archive.org/web/https://signal.org/blog/private-contact-discovery/
  [1202]: https://web.archive.org/web/https://signal.org/blog/signal-private-group-system/
  [1203]: https://web.archive.org/web/https://privacyguides.org/software/file-sharing/
  [1204]: https://web.archive.org/web/https://privacyguides.org/software/real-time-communication/
  [1205]: https://web.archive.org/web/https://getsession.org/session-protocol-explained/
  [1206]: https://web.archive.org/web/https://blog.quarkslab.com/audit-of-session-secure-messaging-application.html
  [1207]: https://yewtu.be/watch?v=aVwl892hqb4
  [1208]: https://wikiless.org/wiki/InterPlanetary_File_System
  [1209]: https://web.archive.org/web/https://en.wikipedia.org/wiki/InterPlanetary_File_System
  [1210]: https://web.archive.org/web/https://www.praxisfilms.org/open-letter-from-laura-poitras/
  [1211]: https://wikiless.org/wiki/SecureDrop
  [1212]: https://web.archive.org/web/https://en.wikipedia.org/wiki/SecureDrop
  [1213]: https://wikiless.org/wiki/Trusted_Platform_Module
  [1214]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Trusted_Platform_Module
  [1215]: https://wikiless.org/wiki/Pastebin
  [1216]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Pastebin
  [1217]: https://wikiless.org/wiki/Wear_leveling
  [1218]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Wear_leveling
  [1219]: https://wikiless.org/wiki/Write_amplification
  [1220]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Write_amplification
  [1221]: https://web.archive.org/web/https://techgage.com/article/too_trim_when_ssd_data_recovery_is_impossible/
  [1222]: https://web.archive.org/web/https://www.researchgate.net/publication/341761017_Live_forensics_method_for_acquisition_on_the_Solid_State_Drive_SSD_NVMe_TRIM_function
  [1223]: https://web.archive.org/web/https://blog.elcomsoft.com/2019/01/life-after-trim-using-factory-access-mode-for-imaging-ssd-drives/
  [1224]: https://web.archive.org/web/https://www.forensicfocus.com/articles/forensic-acquisition-of-solid-state-drives-with-open-source-tools/
  [1225]: https://web.archive.org/web/https://www.researchgate.net/publication/325976653_Solid_State_Drive_Forensics_Where_Do_We_Stand
  [1226]: https://wikiless.org/wiki/Parted_Magic
  [1227]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Parted_Magic
  [1228]: https://wikiless.org/wiki/Hdparm
  [1229]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Hdparm
  [1230]: https://web.archive.org/web/https://github.com/linux-nvme/nvme-cli
  [1231]: https://web.archive.org/web/https://partedmagic.com/secure-erase/
  [1232]: https://web.archive.org/web/https://partedmagic.com/nvme-secure-erase/
  [1233]: https://web.archive.org/web/https://www.ufsexplorer.com/solutions/data-recovery-on-encrypted-storage.php
  [1234]: https://web.archive.org/web/https://developer.apple.com/library/archive/documentation/FileManagement/Conceptual/APFS_Guide/FAQ/FAQ.html
  [1235]: https://web.archive.org/web/https://privacyguides.org/software/productivity/
  [1236]: https://web.archive.org/web/https://www.whonix.org/wiki/Metadata
  [1237]: https://web.archive.org/web/https://gitlab.tails.boum.org/tails/blueprints/-/wikis/doc/mat/
  [1238]: https://web.archive.org/web/https://disable-gatekeeper.github.io/
  [1239]: https://web.archive.org/web/https://help.duckduckgo.com/duckduckgo-help-pages/features/cache/
  [1240]: https://web.archive.org/web/https://help.duckduckgo.com/duckduckgo-help-pages/results/sources/
  [1241]: https://wikiless.org/wiki/Dead_drop
  [1242]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Dead_drop
  [1243]: https://wikiless.org/wiki/Obfuscation
  [1244]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Obfuscation
  [1245]: https://wikiless.org/wiki/Kleptography
  [1246]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Kleptography
  [1247]: https://wikiless.org/wiki/Koalang
  [1248]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Koalang
  [1249]: https://wikiless.org/wiki/Operations_security
  [1250]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Operations_security
  [1251]: https://web.archive.org/web/https://quoteinvestigator.com/2014/07/13/truth/
  [1252]: https://web.archive.org/web/https://privacyguides.org/operating-systems/
  [1253]: https://web.archive.org/web/https://support.brave.com/hc/en-us/articles/360018121491-What-is-a-Private-Window-with-Tor-
  [1254]: https://web.archive.org/web/https://medium.com/velociraptor-ir/the-windows-usn-journal-f0c55c9010e
  [1255]: https://web.archive.org/web/https://medium.com/velociraptor-ir/digging-into-the-system-resource-usage-monitor-srum-afbadb1a375
  [1256]: https://web.archive.org/web/https://www.sans.org/blog/timestamped-registry-ntfs-artifacts-from-unallocated-space/
  [1257]: https://web.archive.org/web/https://dban.org/
  [1258]: https://web.archive.org/web/https://crystalmark.info/en/software/crystaldiskinfo/
  [1259]: https://wikiless.org/wiki/Faraday_cage
  [1260]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Faraday_cage
  [1261]: https://web.archive.org/web/20211011220410/https://ro.ecu.edu.au/cgi/viewcontent.cgi?article=1165&context=adf
  [1262]: https://web.archive.org/web/https://arxiv.org/abs/1512.05616
  [1263]: https://web.archive.org/web/https://dl.acm.org/doi/pdf/10.1145/3309074.3309076
  [1264]: https://yewtu.be/watch?v=sO98kDLkh-M
  [1265]: https://wikiless.org/wiki/Touch_DNA
  [1266]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Touch_DNA
  [1267]: https://web.archive.org/web/https://www.yourdnaguide.com/ydgblog/dna-hair-samples-postage-stamps
  [1268]: https://web.archive.org/web/https://github.com/mhinkie/ooni-detection
  [1269]: https://wikiless.org/wiki/File_verification
  [1270]: https://web.archive.org/web/https://en.wikipedia.org/wiki/File_verification
  [1271]: https://wikiless.org/wiki/Cyclic_redundancy_check
  [1272]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Cyclic_redundancy_check
  [1273]: https://wikiless.org/wiki/MD5
  [1274]: https://web.archive.org/web/https://en.wikipedia.org/wiki/MD5
  [1275]: https://wikiless.org/wiki/Collision_(computer_science)
  [1276]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Collision_(computer_science)
  [1277]: https://wikiless.org/wiki/Secure_Hash_Algorithms
  [1278]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Secure_Hash_Algorithms
  [1279]: https://wikiless.org/wiki/SHA-2
  [1280]: https://web.archive.org/web/https://en.wikipedia.org/wiki/SHA-2
  [1281]: https://wikiless.org/wiki/Collision_resistance
  [1282]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Collision_resistance
  [1283]: https://web.archive.org/web/https://wiki.gnupg.org/Gpg4win/CheckIntegrity
  [1284]: https://web.archive.org/web/https://medium.com/@EvgeniIvanov/how-to-verify-checksum-on-mac-988f166b0c4f
  [1285]: https://wikiless.org/wiki/GNU_Privacy_Guard
  [1286]: https://web.archive.org/web/https://en.wikipedia.org/wiki/GNU_Privacy_Guard
  [1287]: https://wikiless.org/wiki/Public-key_cryptography
  [1288]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Public-key_cryptography
  [1289]: https://wikiless.org/wiki/Polymorphic_code
  [1290]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Polymorphic_code
  [1291]: https://web.archive.org/web/https://www.whonix.org/wiki/Malware_and_Firmware_Trojans
  [1292]: https://web.archive.org/web/https://forums.whonix.org/t/installation-of-antivirus-scanners-by-default/9755/8
  [1293]: https://web.archive.org/web/https://www.av-test.org/fileadmin/pdf/security_report/AV-TEST_Security_Report_2018-2019.pdf
  [1294]: https://web.archive.org/web/https://www.zdnet.com/article/eset-discovers-21-new-linux-malware-families/
  [1295]: https://web.archive.org/web/https://nakedsecurity.sophos.com/2019/07/25/evilgnome-linux-malware-aimed-at-your-laptop-not-your-servers/
  [1296]: https://web.archive.org/web/https://blog.imunify360.com/hiddenwasp-how-to-detect-malware-hidden-on-linux-iot
  [1297]: https://wikiless.org/wiki/Linux_malware
  [1298]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Linux_malware
  [https://en.wikipedia.org/wiki/macOS_malware]: https://en.wikipedia.org/wiki/MacOS_malware
  [1299]: https://wikiless.org/wiki/MacOS_malware
  [1300]: https://web.archive.org/web/https://en.wikipedia.org/wiki/MacOS_malware
  [1301]: https://web.archive.org/web/https://www.macworld.co.uk/feature/mac-viruses-list-3668354/
  [1302]: https://web.archive.org/web/https://resources.jamf.com/documents/macmalware-2020.pdf
  [1303]: https://web.archive.org/web/https://imagetragick.com/
  [1304]: https://web.archive.org/web/https://docs.oracle.com/en/virtualization/virtualbox/6.0/admin/hyperv-support.html
  [1305]: https://web.archive.org/web/https://zeltser.com/analyzing-malicious-documents/
  [1306]: https://wikiless.org/wiki/Portable_application
  [1307]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Portable_application
  [1308]: https://web.archive.org/web/https://ebin.city/~werwolf/posts/brave-is-shit/
  [1309]: https://web.archive.org/web/https://support.brave.com/hc/en-us/articles/360022973471-What-is-Shields
  [1310]: https://web.archive.org/web/https://venturebeat.com/2020/01/15/browser-benchmark-battle-january-2020-chrome-firefox-edge-brave/view-all/
  [1311]: https://web.archive.org/web/https://madaidans-insecurities.github.io/firefox-chromium.html
  [1312]: https://web.archive.org/web/https://grapheneos.org/usage#web-browsing
  [1313]: https://web.archive.org/web/https://www.researchgate.net/publication/349979628_Web_Browser_Privacy_What_Do_Browsers_Say_When_They_Phone_Home
  [1314]: https://web.archive.org/web/https://docs.microsoft.com/en-us/deployedge/microsoft-edge-security-windows-defender-application-guard
  [1315]: https://web.archive.org/web/https://www.pcmag.com/news/mozilla-signs-lucrative-3-year-google-search-deal-for-firefox
  [1316]: https://wikiless.org/wiki/Virtualization
  [1317]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Virtualization
  [1318]: https://web.archive.org/web/https://github.com/Yawning/obfs4/
  [1319]: https://web.archive.org/web/https://tb-manual.torproject.org/circumvention/
  [1320]: https://wikiless.org/wiki/Domain_fronting
  [1321]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Domain_fronting
  [1322]: https://web.archive.org/web/https://gitlab.torproject.org/tpo/applications/tor-browser/-/issues/17569
  [1323]: https://web.archive.org/web/https://www.vice.com/en/article/93ypke/the-nsa-and-cia-use-ad-blockers-because-online-advertising-is-so-dangerous
  [1324]: https://web.archive.org/web/https://www.tbstat.com/wp/uploads/2020/06/Europol-Wasabi-Wallet-Report.pdf
  [1325]: https://web.archive.org/web/https://www.sans.org/blog/nist-has-spoken-death-to-complexity-long-live-the-passphrase/
  [1326]: https://web.archive.org/web/https://www.zdnet.com/article/fbi-recommends-passphrases-over-password-complexity/
  [1327]: https://27m3p2uv7igmj6kvd4ql3cct5h3sdwrsajovkkndeufumzyfhlfev4qd.onion/2015/03/26/passphrases-can-memorize-attackers-cant-guess/
  [1328]: https://web.archive.org/web/https://theintercept.com/2015/03/26/passphrases-can-memorize-attackers-cant-guess/
  [1329]: https://web.archive.org/web/https://protonmail.com/blog/protonmail-com-blog-password-vs-passphrase/
  [1330]: https://yewtu.be/watch?v=yzGzB-yYKcc
  [1331]: https://wikiless.org/wiki/Passphrase#Passphrase_selection
  [1332]: https://web.archive.org/web/https://en.wikipedia.org/wiki/Passphrase#Passphrase_selection
  [1333]: https://web.archive.org/web/https://github.com/insight-decentralized-consensus-lab/post-quantum-monero/blob/master/writeups/technical_note.pdf
